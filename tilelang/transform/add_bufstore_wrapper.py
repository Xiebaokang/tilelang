...
def AddWrapperForSingleBufStore():
    ...
    def pass_fn(func: PrimFunc, mod, ctx):
        ...
        def is_tile_operation_loop(loop: For) -> bool:
            ...
            Returns:
                True for parallel and software-pipeline loops.
            """
            return loop.kind == ForKind.PARALLEL or any(
                key in loop.annotations
                for key in ("num_stages", "tl_pipeline_order", "tl_pipeline_stage")
            )
