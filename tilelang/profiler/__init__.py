...
from tilelang.profiler.bench import do_bench, do_bench_iterations
...
class Profiler:
    ...
    def do_bench(
        ...
        def run_bench():
            if func is None:
                ...
                ), "benchmarking function should be provided"
    ...
    def do_bench_iterations(
        ...
        """Benchmark with fixed warmup and measured iteration counts."""
        ...
        def run_bench():
            ...
            if input_tensors is not None:
                ...
                inputs = self._get_inputs(
                    dynamic_symbolic_constraints=dynamic_symbolic_constraints
                )
            else:
                inputs = self._get_inputs()
            return do_bench_iterations(
                partial(bench_target, *inputs),
                warmup=warmup,
                rep=rep,
                quantiles=quantiles,
                return_mode=return_mode,
