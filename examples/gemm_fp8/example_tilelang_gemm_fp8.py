...
def run_regression_perf():
    ...
    kernel_e4m3 = matmul.compile(M=M, N=N, K=K, block_M=128, block_N=128, block_K=128, dtype=dtype)
    ...
    #     kernel_e5m2 = matmul.compile(M=M, N=N, K=K, block_M=128, block_N=128, block_K=128, dtype=dtype)
