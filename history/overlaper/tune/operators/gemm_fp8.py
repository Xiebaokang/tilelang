"""Overlaper search kernel adapted from examples/gemm_fp8/example_tilelang_gemm_fp8.py."""
...
def build(options: Options, config: TileConfig) -> SearchWorkload:
    ...
    def main(
        ...
        with T.Kernel(
            ...
            T.clear(c_local)
            for ko in T.Pipelined(T.ceildiv(k, block_k), num_stages=2, auto_wsp=True):
