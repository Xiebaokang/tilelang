    ...
    *(float4*)(scores_max + 0) = make_float4(broadcast_var_2, broadcast_var_2, broadcast_var_2, broadcast_var_2);
    for (int k = 0; k < 128; ++k) {
      ...
      for (int i_2 = 0; i_2 < 8; ++i_2) {
        *(uint4*)(((half_t*)K_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_2 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(K + ((((((int)blockIdx.y) * 1048576) + (k * 8192)) + (i_2 * 1024)) + (((int)threadIdx.x) * 8)));
      }
      #pragma unroll
      for (int i_3 = 0; i_3 < 64; ++i_3) {
        acc_s[i_3] = 0x0p+0f/*0.000000e+00*/;
      }
      {
        ...
        for (int i_4 = 0; i_4 < 2; ++i_4) {
          ...
          for (int ki = 0; ki < 8; ++ki) {
            tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, false, 1, 1>(uint64_t(desc_a + (((((ki >> 2) * 16384) + (i_4 * 8192)) + ((ki & 3) * 32)) >> 4)), uint64_t(desc_b + ((((ki >> 2) * 8192) + ((ki & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + (i_4 * 32))), 1);
          }
        }
      ...
      *(float4*)(scores_max + 0) = make_float4(broadcast_var_3, broadcast_var_3, broadcast_var_3, broadcast_var_3);
      ...
      for (int i_5 = 0; i_5 < 4; ++i_5) {
        ...
        for (int rv = 0; rv < 16; ++rv) {
          scores_max_clear[i_5] = max(scores_max_clear[i_5], acc_s[(((((i_5 >> 1) * 32) + ((rv & 7) * 4)) + ((i_5 & 1) * 2)) + (rv >> 3))]);
        }
        scores_max_clear[i_5] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<128>>::run(scores_max_clear[i_5]);
      ...
      for (int i_8 = 0; i_8 < 64; ++i_8) {
        acc_s[i_8] = exp2f(((acc_s[i_8] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[(((i_8 >> 5) * 2) + ((i_8 & 3) >> 1))] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
      }
      #pragma unroll
      ...
      for (int i_11 = 0; i_11 < 16; ++i_11) {
        uint2 __1;
        float4 v_ = *(float4*)(acc_s + (((((i_11 & 3) >> 1) * 32) + ((i_11 >> 2) * 8)) + ((i_11 & 1) * 4)));
      ...
      for (int i_12 = 0; i_12 < 128; ++i_12) {
        acc_o[i_12] = (acc_o[i_12] * scores_scale[(((i_12 >> 6) * 2) + ((i_12 & 3) >> 1))]);
      }
      program_schedule_mbar[0].wait((k & 1));
      {
        ...
        for (int i_13 = 0; i_13 < 2; ++i_13) {
          ...
          for (int ki_1 = 0; ki_1 < 4; ++ki_1) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 128, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(acc_s_cast + ((ki_1 * 16) + (i_13 * 8))), uint64_t(desc_b_1 + ((ki_1 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc_o + (i_13 * 64)), 1);
          }
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
    ...
    for (int i_14 = 0; i_14 < 128; ++i_14) {
      acc_o[i_14] = (acc_o[i_14] / logsum[(((i_14 >> 6) * 2) + ((i_14 & 3) >> 1))]);
    }
    #pragma unroll
    for (int i_15 = 0; i_15 < 16; ++i_15) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)O_shared)[((((((i_15 >> 3) * 8192) + ((((int)threadIdx.x) >> 5) * 2048)) + ((((int)threadIdx.x) & 15) * 128)) + ((i_15 & 7) * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(((half_t)acc_o[(i_15 * 8)]), ((half_t)acc_o[((i_15 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_15 * 8) + 2)]), ((half_t)acc_o[((i_15 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_15 * 8) + 4)]), ((half_t)acc_o[((i_15 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_15 * 8) + 6)]), ((half_t)acc_o[((i_15 * 8) + 7)])));
    }
    tl::fence_proxy_async();
    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int k_1 = 0; k_1 < 128; ++k_1) {
        ...
        for (int i_16 = 0; i_16 < 8; ++i_16) {
          *(uint4*)(((half_t*)V_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_16 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(V + (((((((int)blockIdx.y) * 1048576) + (k_1 * 8192)) + (i_16 * 1024)) + (((int)threadIdx.x) * 8)) - 1024));
        }
        tl::fence_proxy_async();
