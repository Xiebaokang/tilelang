    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    ...
    if (((int)threadIdx.x) < 384) {
      ...
      for (int i_13 = 0; i_13 < 8; ++i_13) {
        *(uint4*)(((half_t*)K_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_13 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(K + ((((((int)blockIdx.y) * 1048576) + (i_13 * 1024)) + (((int)threadIdx.x) * 8)) - 2048));
      }
      tl::fence_proxy_async();
      ...
      for (int k_1 = 0; k_1 < 127; ++k_1) {
        ...
        for (int i_14 = 0; i_14 < 8; ++i_14) {
          *(uint4*)(((half_t*)K_shared) + (((((((((k_1 + 1) % 3) * 8192) + (((((int)threadIdx.x) & 15) >> 3) * 4096)) + (i_14 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(K + (((((((int)blockIdx.y) * 1048576) + (k_1 * 8192)) + (i_14 * 1024)) + (((int)threadIdx.x) * 8)) + 6144));
        }
        tl::fence_proxy_async();
        ...
        for (int i_15 = 0; i_15 < 8; ++i_15) {
          *(uint4*)(((half_t*)V_shared) + ((((((((k_1 & 1) * 8192) + (((((int)threadIdx.x) & 15) >> 3) * 4096)) + (i_15 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(V + (((((((int)blockIdx.y) * 1048576) + (k_1 * 8192)) + (i_15 * 1024)) + (((int)threadIdx.x) * 8)) - 2048));
        }
        tl::fence_proxy_async();
        program_schedule_mbar[((k_1 & 1) + 3)].arrive();
      }
      ...
      for (int i_16 = 0; i_16 < 8; ++i_16) {
        *(uint4*)(((half_t*)V_shared) + (((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_16 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)) = *(uint4*)(V + ((((((int)blockIdx.y) * 1048576) + (i_16 * 1024)) + (((int)threadIdx.x) * 8)) + 1038336));
      }
      tl::fence_proxy_async();
