...
extern "C" __global__ void main_kernel(__grid_constant__ const CUtensorMap K_desc, half_t* __restrict__ Output, const half_t* __restrict__ Q, __grid_constant__ const CUtensorMap V_desc);
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap K_desc, half_t* __restrict__ Output, const half_t* __restrict__ Q, __grid_constant__ const CUtensorMap V_desc) {
  ...
  void* Q_shared = ((void*)((char*)buf_dyn_shmem + 81920));
  __shared__ __align__(16) uint64_t program_schedule_mbar_mem[1];
  auto program_schedule_mbar = reinterpret_cast<Barrier*>(program_schedule_mbar_mem);
  float acc_o[128];
  float logsum[4];
  float scores_max[4];
  __shared__ __align__(16) uint64_t pipeline_mbar_mem[6];
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    *(float4*)(scores_max + 0) = make_float4(broadcast_var_2, broadcast_var_2, broadcast_var_2, broadcast_var_2);
    if (tl::tl_shuffle_elect<0>()) {
      ...
      pipeline_mbar[3].init(1);
      pipeline_mbar[4].init(1);
      pipeline_mbar[5].init(1);
    }
    tl::fence_barrier_init();
    ...
    if (tl::tl_shuffle_elect<128>()) {
      ...
      pipeline_mbar[2].arrive_and_expect_tx(16384);
      tl::tma_load(K_desc, pipeline_mbar[2], (&(((half_t*)K_shared)[8192])), 0, 64, ((int)blockIdx.y), 0);
      tl::tma_load(K_desc, pipeline_mbar[2], (&(((half_t*)K_shared)[12288])), 64, 64, ((int)blockIdx.y), 0);
      pipeline_mbar[1].arrive_and_expect_tx(16384);
      tl::tma_load(V_desc, pipeline_mbar[1], (&(((half_t*)V_shared)[0])), 0, 0, ((int)blockIdx.y), 0);
      tl::tma_load(V_desc, pipeline_mbar[1], (&(((half_t*)V_shared)[4096])), 64, 0, ((int)blockIdx.y), 0);
    }
    ...
    *(float4*)(scores_max + 0) = make_float4(broadcast_var_3, broadcast_var_3, broadcast_var_3, broadcast_var_3);
    ...
    for (int k = 0; k < 126; ++k) {
      if (tl::tl_shuffle_elect<128>()) {
        pipeline_mbar[(((k + 2) % 3) * 2)].arrive_and_expect_tx(16384);
        tl::tma_load(K_desc, pipeline_mbar[(((k + 2) % 3) * 2)], (&(((half_t*)K_shared)[(((k + 2) % 3) * 8192)])), 0, ((k * 64) + 128), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, pipeline_mbar[(((k + 2) % 3) * 2)], (&(((half_t*)K_shared)[((((k + 2) % 3) * 8192) + 4096)])), 64, ((k * 64) + 128), ((int)blockIdx.y), 0);
        pipeline_mbar[((((k + 1) % 3) * 2) + 1)].arrive_and_expect_tx(16384);
        tl::tma_load(V_desc, pipeline_mbar[((((k + 1) % 3) * 2) + 1)], (&(((half_t*)V_shared)[(((k + 1) & 1) * 8192)])), 0, ((k * 64) + 64), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, pipeline_mbar[((((k + 1) % 3) * 2) + 1)], (&(((half_t*)V_shared)[((((k + 1) & 1) * 8192) + 4096)])), 64, ((k * 64) + 64), ((int)blockIdx.y), 0);
      }
      pipeline_mbar[(((k % 3) * 2) + 1)].wait(((k % 6) / 3));
      {
      ...
      *(float4*)(scores_max_prev + 0) = *(float4*)(scores_max + 0);
      ...
      pipeline_mbar[(((k + 1) % 3) * 2)].wait((((k + 1) % 6) / 3));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_2, (((k + 1) % 3) * 16384));
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 64);
        tl::warpgroup_arrive();
        #pragma unroll
    ...
    if (tl::tl_shuffle_elect<128>()) {
      pipeline_mbar[3].arrive_and_expect_tx(16384);
      tl::tma_load(V_desc, pipeline_mbar[3], (&(((half_t*)V_shared)[8192])), 0, 8128, ((int)blockIdx.y), 0);
      tl::tma_load(V_desc, pipeline_mbar[3], (&(((half_t*)V_shared)[12288])), 64, 8128, ((int)blockIdx.y), 0);
    }
