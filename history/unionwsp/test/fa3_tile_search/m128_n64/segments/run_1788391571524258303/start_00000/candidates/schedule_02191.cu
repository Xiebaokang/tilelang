...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(const half_t* __restrict__ K, half_t* __restrict__ Output, const half_t* __restrict__ Q, const half_t* __restrict__ V) {
  ...
  if (tl::tl_shuffle_elect<0>()) {
    ...
    program_schedule_mbar[7].init(128);
  }
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int k = 0; k < 126; ++k) {
      ...
      *(float4*)(scores_max_prev + 0) = *(float4*)(scores_max + 0);
      ...
      program_schedule_mbar[(((k + 1) & 1) + 1)].wait((((k + 1) & 3) >> 1));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_2, (((k + 1) & 1) * 16384));
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 64);
        tl::warpgroup_arrive();
        #pragma unroll
    ...
    *(float4*)(scores_max_prev + 0) = *(float4*)(scores_max + 0);
    ...
    for (int i_23 = 0; i_23 < 64; ++i_23) {
      acc_s[i_23] = 0x0p+0f/*0.000000e+00*/;
    }
    program_schedule_mbar[2].wait(1);
    {
      ...
      for (int i_24 = 0; i_24 < 2; ++i_24) {
        ...
        for (int ki_4 = 0; ki_4 < 8; ++ki_4) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, false, 1, 1>(uint64_t(desc_a_2 + (((((ki_4 >> 2) * 16384) + (i_24 * 8192)) + ((ki_4 & 3) * 32)) >> 4)), uint64_t(desc_b_4 + ((((ki_4 >> 2) * 8192) + ((ki_4 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + (i_24 * 32))), 1);
        }
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
    ...
    *(float4*)(scores_max + 0) = make_float4(broadcast_var_5, broadcast_var_5, broadcast_var_5, broadcast_var_5);
    ...
    for (int i_25 = 0; i_25 < 4; ++i_25) {
      scores_max_clear_2[i_25] = -CUDART_INF_F;
      #pragma unroll
      for (int rv_4 = 0; rv_4 < 16; ++rv_4) {
        scores_max_clear_2[i_25] = max(scores_max_clear_2[i_25], acc_s[(((((i_25 >> 1) * 32) + ((rv_4 & 7) * 4)) + ((i_25 & 1) * 2)) + (rv_4 >> 3))]);
      }
      scores_max_clear_2[i_25] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<128>>::run(scores_max_clear_2[i_25]);
      scores_max[i_25] = max(scores_max[i_25], scores_max_clear_2[i_25]);
    }
    #pragma unroll
    ...
    for (int i_28 = 0; i_28 < 64; ++i_28) {
      acc_s[i_28] = exp2f(((acc_s[i_28] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[(((i_28 >> 5) * 2) + ((i_28 & 3) >> 1))] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
    }
    #pragma unroll
    for (int i_29 = 0; i_29 < 16; ++i_29) {
      uint2 __3;
      float4 v__2 = *(float4*)(acc_s + (((((i_29 & 3) >> 1) * 32) + ((i_29 >> 2) * 8)) + ((i_29 & 1) * 4)));
      ((half2*)(&__3))[0] = __float22half2_rn(((float2*)(&v__2))[0]);
      ((half2*)(&__3))[1] = __float22half2_rn(((float2*)(&v__2))[1]);
      *(uint2*)(acc_s_cast + (i_29 * 4)) = __3;
    }
    #pragma unroll
    for (int i_30 = 0; i_30 < 4; ++i_30) {
      ...
      for (int rv_5 = 0; rv_5 < 16; ++rv_5) {
        scores_sum[i_30] = (scores_sum[i_30] + acc_s[(((((i_30 >> 1) * 32) + ((rv_5 & 7) * 4)) + ((i_30 & 1) * 2)) + (rv_5 >> 3))]);
      }
      scores_sum[i_30] = tl::AllReduce<tl::SumOp, 4, 1, 0, tl::NamedBarrier<128>>::run(scores_sum[i_30]);
    }
    #pragma unroll
    ...
    for (int i_32 = 0; i_32 < 128; ++i_32) {
      acc_o[i_32] = (acc_o[i_32] * scores_scale[(((i_32 >> 6) * 2) + ((i_32 & 3) >> 1))]);
    }
    program_schedule_mbar[3].wait(1);
    {
      ...
      for (int i_33 = 0; i_33 < 2; ++i_33) {
        ...
        for (int ki_5 = 0; ki_5 < 4; ++ki_5) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 128, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(acc_s_cast + ((ki_5 * 16) + (i_33 * 8))), uint64_t(desc_b_5 + ((ki_5 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc_o + (i_33 * 64)), 1);
        }
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
    ...
    for (int i_34 = 0; i_34 < 128; ++i_34) {
      acc_o[i_34] = (acc_o[i_34] / logsum[(((i_34 >> 6) * 2) + ((i_34 & 3) >> 1))]);
    }
    #pragma unroll
    for (int i_35 = 0; i_35 < 16; ++i_35) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)O_shared)[((((((i_35 >> 3) * 8192) + ((((int)threadIdx.x) >> 5) * 2048)) + ((((int)threadIdx.x) & 15) * 128)) + ((i_35 & 7) * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(((half_t)acc_o[(i_35 * 8)]), ((half_t)acc_o[((i_35 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_35 * 8) + 2)]), ((half_t)acc_o[((i_35 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_35 * 8) + 4)]), ((half_t)acc_o[((i_35 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_35 * 8) + 6)]), ((half_t)acc_o[((i_35 * 8) + 7)])));
    }
    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int i_36 = 0; i_36 < 16; ++i_36) {
        *(uint4*)(((half_t*)Q_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 8192) + (i_36 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(Q + (((((((int)blockIdx.y) * 1048576) + (((int)blockIdx.x) * 16384)) + (i_36 * 1024)) + (((int)threadIdx.x) * 8)) - 1024));
      }
      tl::fence_proxy_async();
      ...
      for (int i_37 = 0; i_37 < 8; ++i_37) {
        *(uint4*)(((half_t*)K_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_37 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(K + ((((((int)blockIdx.y) * 1048576) + (i_37 * 1024)) + (((int)threadIdx.x) * 8)) - 2048));
      }
      tl::fence_proxy_async();
      program_schedule_mbar[1].arrive();
      #pragma unroll
      for (int i_38 = 0; i_38 < 8; ++i_38) {
        *(uint4*)(((half_t*)K_shared) + (((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_38 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)) = *(uint4*)(K + ((((((int)blockIdx.y) * 1048576) + (i_38 * 1024)) + (((int)threadIdx.x) * 8)) + 6144));
      }
      tl::fence_proxy_async();
      program_schedule_mbar[2].arrive();
      tl::__sync_thread_partial(3, 128);
      for (int k_1 = 0; k_1 < 126; ++k_1) {
        program_schedule_mbar[((k_1 & 1) + 5)].wait(((k_1 & 3) >> 1));
        #pragma unroll
        for (int i_39 = 0; i_39 < 8; ++i_39) {
          *(uint4*)(((half_t*)K_shared) + ((((((((k_1 & 1) * 8192) + (((((int)threadIdx.x) & 15) >> 3) * 4096)) + (i_39 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(K + (((((((int)blockIdx.y) * 1048576) + (k_1 * 8192)) + (i_39 * 1024)) + (((int)threadIdx.x) * 8)) + 14336));
        }
        tl::fence_proxy_async();
        ...
        for (int i_40 = 0; i_40 < 8; ++i_40) {
          *(uint4*)(((half_t*)V_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_40 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(V + (((((((int)blockIdx.y) * 1048576) + (k_1 * 8192)) + (i_40 * 1024)) + (((int)threadIdx.x) * 8)) - 2048));
        }
        tl::fence_proxy_async();
      ...
      for (int i_41 = 0; i_41 < 8; ++i_41) {
        *(uint4*)(((half_t*)V_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_41 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(V + ((((((int)blockIdx.y) * 1048576) + (i_41 * 1024)) + (((int)threadIdx.x) * 8)) + 1030144));
      }
      tl::fence_proxy_async();
      program_schedule_mbar[3].arrive();
      ...
      for (int i_42 = 0; i_42 < 8; ++i_42) {
        *(uint4*)(((half_t*)V_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_42 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(V + ((((((int)blockIdx.y) * 1048576) + (i_42 * 1024)) + (((int)threadIdx.x) * 8)) + 1038336));
      }
      tl::fence_proxy_async();
      program_schedule_mbar[3].arrive();
