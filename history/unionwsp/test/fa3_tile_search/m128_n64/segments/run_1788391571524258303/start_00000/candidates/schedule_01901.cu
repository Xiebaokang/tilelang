...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(const half_t* __restrict__ K, half_t* __restrict__ Output, const half_t* __restrict__ Q, const half_t* __restrict__ V) {
  ...
  void* O_shared = ((void*)((char*)buf_dyn_shmem + 98304));
  __shared__ __align__(16) uint64_t program_schedule_mbar_mem[10];
  ...
  if (tl::tl_shuffle_elect<0>()) {
    ...
    program_schedule_mbar[8].init(128);
    program_schedule_mbar[9].init(128);
  }
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    *(float4*)(scores_max + 0) = make_float4(broadcast_var_3, broadcast_var_3, broadcast_var_3, broadcast_var_3);
    ...
    for (int k = 0; k < 126; ++k) {
      program_schedule_mbar[((k & 1) + 3)].wait(((k & 3) >> 1));
      {
        tl::GmmaDescriptor desc_b_1;
        tl::initialize_wgmma_descriptor<1, 512, 64>(desc_b_1, (&(((half_t*)V_shared)[0])));
        tl::increase_descriptor_offset<int>(desc_b_1, ((k & 1) * 16384));
      ...
      program_schedule_mbar[((k & 1) + 8)].arrive();
      *(float4*)(scores_max_prev + 0) = *(float4*)(scores_max + 0);
      #pragma unroll
      ...
      program_schedule_mbar[(((k + 1) & 1) + 6)].arrive();
    ...
    program_schedule_mbar[8].arrive();
    *(float4*)(scores_max_prev + 0) = *(float4*)(scores_max + 0);
    #pragma unroll
    ...
    *(float4*)(scores_max + 0) = make_float4(broadcast_var_5, broadcast_var_5, broadcast_var_5, broadcast_var_5);
    ...
    program_schedule_mbar[4].wait(1);
    {
    ...
    program_schedule_mbar[9].arrive();
    #pragma unroll
    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int k_1 = 0; k_1 < 127; ++k_1) {
        if (1 <= k_1) {
          program_schedule_mbar[(((k_1 + 1) & 1) + 6)].wait((((k_1 + 3) & 3) >> 1));
        }
        #pragma unroll
        for (int i_38 = 0; i_38 < 8; ++i_38) {
          *(uint4*)(((half_t*)K_shared) + (((((((((k_1 + 1) & 1) * 8192) + (((((int)threadIdx.x) & 15) >> 3) * 4096)) + (i_38 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(K + (((((((int)blockIdx.y) * 1048576) + (k_1 * 8192)) + (i_38 * 1024)) + (((int)threadIdx.x) * 8)) + 6144));
        }
        tl::fence_proxy_async();
        program_schedule_mbar[(((k_1 + 1) & 1) + 1)].arrive();
        if (2 <= k_1) {
          program_schedule_mbar[((k_1 & 1) + 8)].wait((((k_1 >> 1) + 1) & 1));
        }
        #pragma unroll
        for (int i_39 = 0; i_39 < 8; ++i_39) {
          *(uint4*)(((half_t*)V_shared) + ((((((((k_1 & 1) * 8192) + (((((int)threadIdx.x) & 15) >> 3) * 4096)) + (i_39 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(V + (((((((int)blockIdx.y) * 1048576) + (k_1 * 8192)) + (i_39 * 1024)) + (((int)threadIdx.x) * 8)) - 2048));
        }
        tl::fence_proxy_async();
        program_schedule_mbar[((k_1 & 1) + 3)].arrive();
      }
      program_schedule_mbar[9].wait(0);
      tl::__sync_thread_partial(3, 128);
      #pragma unroll
      for (int i_40 = 0; i_40 < 8; ++i_40) {
        *(uint4*)(((half_t*)V_shared) + (((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_40 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)) = *(uint4*)(V + ((((((int)blockIdx.y) * 1048576) + (i_40 * 1024)) + (((int)threadIdx.x) * 8)) + 1038336));
      }
      tl::fence_proxy_async();
