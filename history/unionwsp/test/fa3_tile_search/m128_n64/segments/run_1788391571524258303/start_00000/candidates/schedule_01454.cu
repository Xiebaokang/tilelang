  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int i_3 = 0; i_3 < 2; ++i_3) {
      ...
      for (int rv = 0; rv < 16; ++rv) {
        scores_max_clear[i_3] = max(scores_max_clear[i_3], acc_s[((((rv & 7) * 4) + (i_3 * 2)) + (rv >> 3))]);
      }
      ...
      *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
      ...
      program_schedule_mbar[((k + 1) & 1)].wait((((k + 1) & 3) >> 1));
      {
        ...
        for (int ki_2 = 0; ki_2 < 8; ++ki_2) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, false, 1, 1>(uint64_t(desc_a_1 + (((((ki_2 >> 2) * 16384) + ((((int)threadIdx.x) >> 7) * 8192)) + ((ki_2 & 3) * 32)) >> 4)), uint64_t(desc_b_2 + ((((ki_2 >> 2) * 8192) + ((ki_2 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + 0)), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 64);
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
      ...
      for (int i_17 = 0; i_17 < 2; ++i_17) {
        ...
        for (int rv_3 = 0; rv_3 < 16; ++rv_3) {
          scores_sum[i_17] = (scores_sum[i_17] + acc_s[((((rv_3 & 7) * 4) + (i_17 * 2)) + (rv_3 >> 3))]);
        }
    ...
    *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
    ...
    program_schedule_mbar[1].wait(1);
    {
      ...
      for (int ki_4 = 0; ki_4 < 8; ++ki_4) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, false, 1, 1>(uint64_t(desc_a_2 + (((((ki_4 >> 2) * 16384) + ((((int)threadIdx.x) >> 7) * 8192)) + ((ki_4 & 3) * 32)) >> 4)), uint64_t(desc_b_4 + ((((ki_4 >> 2) * 8192) + ((ki_4 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 64);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
    ...
    for (int i_31 = 0; i_31 < 8; ++i_31) {
      *(uint4*)(((half_t*)K_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_31 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(K + ((((((int)blockIdx.y) * 1048576) + (i_31 * 1024)) + (((int)threadIdx.x) * 8)) - 2048));
    }
    tl::fence_proxy_async();
    program_schedule_mbar[0].arrive();
    #pragma unroll
    for (int i_32 = 0; i_32 < 8; ++i_32) {
      *(uint4*)(((half_t*)K_shared) + (((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_32 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)) = *(uint4*)(K + ((((((int)blockIdx.y) * 1048576) + (i_32 * 1024)) + (((int)threadIdx.x) * 8)) + 6144));
    }
    tl::fence_proxy_async();
    ...
    for (int k_1 = 0; k_1 < 126; ++k_1) {
      ...
      for (int i_33 = 0; i_33 < 8; ++i_33) {
        *(uint4*)(((half_t*)K_shared) + ((((((((k_1 & 1) * 8192) + (((((int)threadIdx.x) & 15) >> 3) * 4096)) + (i_33 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(K + (((((((int)blockIdx.y) * 1048576) + (k_1 * 8192)) + (i_33 * 1024)) + (((int)threadIdx.x) * 8)) + 14336));
      }
      tl::fence_proxy_async();
      ...
      for (int i_34 = 0; i_34 < 8; ++i_34) {
        *(uint4*)(((half_t*)V_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_34 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(V + (((((((int)blockIdx.y) * 1048576) + (k_1 * 8192)) + (i_34 * 1024)) + (((int)threadIdx.x) * 8)) - 2048));
      }
      tl::fence_proxy_async();
    ...
    for (int i_35 = 0; i_35 < 8; ++i_35) {
      *(uint4*)(((half_t*)V_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_35 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(V + ((((((int)blockIdx.y) * 1048576) + (i_35 * 1024)) + (((int)threadIdx.x) * 8)) + 1030144));
    }
    tl::fence_proxy_async();
    program_schedule_mbar[2].arrive();
    ...
    for (int i_36 = 0; i_36 < 8; ++i_36) {
      *(uint4*)(((half_t*)V_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_36 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(V + ((((((int)blockIdx.y) * 1048576) + (i_36 * 1024)) + (((int)threadIdx.x) * 8)) + 1038336));
    }
    tl::fence_proxy_async();
    program_schedule_mbar[2].arrive();
  }
