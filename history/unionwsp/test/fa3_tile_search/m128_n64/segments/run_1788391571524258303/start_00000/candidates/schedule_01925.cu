  ...
  if (((int)threadIdx.x) < 128) {
    ...
    *(float4*)(scores_max + 0) = make_float4(broadcast_var_2, broadcast_var_2, broadcast_var_2, broadcast_var_2);
    ...
    for (int k = 0; k < 128; ++k) {
      ...
      *(float4*)(scores_max + 0) = make_float4(broadcast_var_3, broadcast_var_3, broadcast_var_3, broadcast_var_3);
      ...
      for (int i_10 = 0; i_10 < 16; ++i_10) {
        uint2 __1;
        float4 v_ = *(float4*)(acc_s + (((((i_10 & 3) >> 1) * 32) + ((i_10 >> 2) * 8)) + ((i_10 & 1) * 4)));
    ...
    for (int i_13 = 0; i_13 < 128; ++i_13) {
      acc_o[i_13] = (acc_o[i_13] / logsum[(((i_13 >> 6) * 2) + ((i_13 & 3) >> 1))]);
    }
    #pragma unroll
    for (int i_14 = 0; i_14 < 16; ++i_14) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)O_shared)[((((((i_14 >> 3) * 8192) + ((((int)threadIdx.x) >> 5) * 2048)) + ((((int)threadIdx.x) & 15) * 128)) + ((i_14 & 7) * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(((half_t)acc_o[(i_14 * 8)]), ((half_t)acc_o[((i_14 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_14 * 8) + 2)]), ((half_t)acc_o[((i_14 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_14 * 8) + 4)]), ((half_t)acc_o[((i_14 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_14 * 8) + 6)]), ((half_t)acc_o[((i_14 * 8) + 7)])));
    }
    tl::fence_proxy_async();
