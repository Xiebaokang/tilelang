    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int k = 0; k < 127; ++k) {
      if (tl::tl_shuffle_elect<256>()) {
        ...
        tl::tma_load(K_desc, pipeline_mbar[(((k + 1) & 1) * 2)], (&(((half_t*)K_shared)[0])), 0, ((k * 64) + 64), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, pipeline_mbar[(((k + 1) & 1) * 2)], (&(((half_t*)K_shared)[4096])), 64, ((k * 64) + 64), ((int)blockIdx.y), 0);
