    ...
    *(float4*)(scores_max + 0) = make_float4(broadcast_var_5, broadcast_var_5, broadcast_var_5, broadcast_var_5);
    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int k_1 = 0; k_1 < 128; ++k_1) {
        if (3 <= k_1) {
          program_schedule_mbar[((k_1 % 3) + 5)].wait((((k_1 / 3) + 1) & 1));
        }
        #pragma unroll
        for (int i_37 = 0; i_37 < 8; ++i_37) {
          *(uint4*)(((half_t*)K_shared) + ((((((((k_1 % 3) * 8192) + (((((int)threadIdx.x) & 15) >> 3) * 4096)) + (i_37 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(K + (((((((int)blockIdx.y) * 1048576) + (k_1 * 8192)) + (i_37 * 1024)) + (((int)threadIdx.x) * 8)) - 1024));
        }
        tl::fence_proxy_async();
