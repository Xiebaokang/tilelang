...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap K_desc, half_t* __restrict__ Output, const half_t* __restrict__ Q, __grid_constant__ const CUtensorMap V_desc) {
  ...
  void* V_shared = ((void*)((char*)buf_dyn_shmem + 0));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    *(float4*)(scores_max + 0) = make_float4(broadcast_var_2, broadcast_var_2, broadcast_var_2, broadcast_var_2);
    ...
    for (int k = 0; k < 126; ++k) {
      if (tl::tl_shuffle_elect<128>()) {
        pipeline_mbar[(((k + 1) % 3) * 2)].arrive_and_expect_tx(16384);
        tl::tma_load(K_desc, pipeline_mbar[(((k + 1) % 3) * 2)], (&(((half_t*)K_shared)[(((k + 1) % 3) * 8192)])), 0, ((k * 64) + 64), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, pipeline_mbar[(((k + 1) % 3) * 2)], (&(((half_t*)K_shared)[((((k + 1) % 3) * 8192) + 4096)])), 64, ((k * 64) + 64), ((int)blockIdx.y), 0);
    ...
    if (tl::tl_shuffle_elect<128>()) {
      ...
      tl::tma_load(K_desc, pipeline_mbar[2], (&(((half_t*)K_shared)[8192])), 0, 8128, ((int)blockIdx.y), 0);
      tl::tma_load(K_desc, pipeline_mbar[2], (&(((half_t*)K_shared)[12288])), 64, 8128, ((int)blockIdx.y), 0);
    }
    *(float4*)(scores_max_prev + 0) = *(float4*)(scores_max + 0);
    #pragma unroll
