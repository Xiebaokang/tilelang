    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int i_31 = 0; i_31 < 24; ++i_31) {
        *(uint4*)(((half_t*)K_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 12288) + (i_31 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(K + ((((((int)blockIdx.y) * 1048576) + (i_31 * 1024)) + (((int)threadIdx.x) * 8)) - 1024));
      }
      tl::fence_proxy_async();
      program_schedule_mbar[1].arrive();
      #pragma unroll
      for (int i_32 = 0; i_32 < 24; ++i_32) {
        *(uint4*)(((half_t*)K_shared) + (((((((((((int)threadIdx.x) & 15) >> 3) * 12288) + (i_32 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 24576)) = *(uint4*)(K + ((((((int)blockIdx.y) * 1048576) + (i_32 * 1024)) + (((int)threadIdx.x) * 8)) + 23552));
      }
      tl::fence_proxy_async();
      ...
      for (int k_1 = 0; k_1 < 41; ++k_1) {
        ...
        for (int i_33 = 0; i_33 < 24; ++i_33) {
          ...
          uint4 condval_1;
          if ((((k_1 * 24) + i_33) < 976)) {
            condval_1 = *(uint4*)(K + (((((((int)blockIdx.y) * 1048576) + (k_1 * 24576)) + (i_33 * 1024)) + (((int)threadIdx.x) * 8)) + 48128));
          } else {
        ...
        for (int i_34 = 0; i_34 < 24; ++i_34) {
          *(uint4*)(((half_t*)V_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 12288) + (i_34 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(V + (((((((int)blockIdx.y) * 1048576) + (k_1 * 24576)) + (i_34 * 1024)) + (((int)threadIdx.x) * 8)) - 1024));
        }
        tl::fence_proxy_async();
      ...
      for (int i_35 = 0; i_35 < 24; ++i_35) {
        *(uint4*)(((half_t*)V_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 12288) + (i_35 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(V + ((((((int)blockIdx.y) * 1048576) + (i_35 * 1024)) + (((int)threadIdx.x) * 8)) + 1006592));
      }
      tl::fence_proxy_async();
      program_schedule_mbar[3].arrive();
      ...
      for (int i_36 = 0; i_36 < 24; ++i_36) {
        ...
        uint4 condval_2;
        if ((i_36 < 16)) {
          condval_2 = *(uint4*)(V + ((((((int)blockIdx.y) * 1048576) + (i_36 * 1024)) + (((int)threadIdx.x) * 8)) + 1031168));
        } else {
