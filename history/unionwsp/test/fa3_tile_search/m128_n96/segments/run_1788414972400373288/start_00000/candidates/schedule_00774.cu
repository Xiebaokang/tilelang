    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int k = 0; k < 84; ++k) {
      if (tl::tl_shuffle_elect<256>()) {
        ...
        tl::tma_load(K_desc, pipeline_mbar[(((k + 1) % 3) * 2)], (&(((half_t*)K_shared)[0])), 0, ((k * 96) + 96), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, pipeline_mbar[(((k + 1) % 3) * 2)], (&(((half_t*)K_shared)[6144])), 64, ((k * 96) + 96), ((int)blockIdx.y), 0);
    ...
    if (tl::tl_shuffle_elect<256>()) {
      ...
      tl::tma_load(K_desc, pipeline_mbar[2], (&(((half_t*)K_shared)[0])), 0, 8160, ((int)blockIdx.y), 0);
      tl::tma_load(K_desc, pipeline_mbar[2], (&(((half_t*)K_shared)[6144])), 64, 8160, ((int)blockIdx.y), 0);
    }
