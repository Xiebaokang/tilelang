...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap K_desc, half_t* __restrict__ Output, const half_t* __restrict__ Q, __grid_constant__ const CUtensorMap V_desc) {
  ...
  float logsum[2];
  float scores_max[2];
  __shared__ __align__(16) uint64_t pipeline_mbar_mem[4];
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    ...
    for (int k = 0; k < 85; ++k) {
      if (tl::tl_shuffle_elect<256>()) {
        pipeline_mbar[((k & 1) * 2)].arrive_and_expect_tx(24576);
        tl::tma_load(K_desc, pipeline_mbar[((k & 1) * 2)], (&(((half_t*)K_shared)[0])), 0, (k * 96), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, pipeline_mbar[((k & 1) * 2)], (&(((half_t*)K_shared)[6144])), 64, (k * 96), ((int)blockIdx.y), 0);
        pipeline_mbar[((((k + 1) & 1) * 2) + 1)].arrive_and_expect_tx(24576);
        tl::tma_load(V_desc, pipeline_mbar[((((k + 1) & 1) * 2) + 1)], (&(((half_t*)V_shared)[(((k + 1) & 1) * 12288)])), 0, ((k * 96) + 96), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, pipeline_mbar[((((k + 1) & 1) * 2) + 1)], (&(((half_t*)V_shared)[((((k + 1) & 1) * 12288) + 6144)])), 64, ((k * 96) + 96), ((int)blockIdx.y), 0);
      }
      *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
      ...
      pipeline_mbar[((k & 1) * 2)].wait(((k & 3) >> 1));
      {
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
      ...
      pipeline_mbar[(((k & 1) * 2) + 1)].wait(((k & 3) >> 1));
      {
