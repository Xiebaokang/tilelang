  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    ...
    for (int i_12 = 0; i_12 < 16; ++i_12) {
      *(uint4*)(((half_t*)Q_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 8192) + (i_12 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(Q + (((((((int)blockIdx.y) * 1048576) + (((int)blockIdx.x) * 16384)) + (i_12 * 1024)) + (((int)threadIdx.x) * 8)) - 2048));
    }
    tl::fence_proxy_async();
    ...
    for (int k_1 = 0; k_1 < 85; ++k_1) {
      ...
      if (1 <= k_1) {
        program_schedule_mbar[(((k_1 + 1) & 1) + 8)].wait((((k_1 + 3) & 3) >> 1));
      }
      #pragma unroll
      for (int i_15 = 0; i_15 < 12; ++i_15) {
        ...
        *(uint4*)(((half_t*)V_shared) + (((((((((k_1 + 1) & 1) * 12288) + (((((int)threadIdx.x) & 15) >> 3) * 6144)) + (i_15 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = condval_1;
      }
      tl::fence_proxy_async();
      program_schedule_mbar[(((k_1 + 1) & 1) + 3)].arrive();
    }
