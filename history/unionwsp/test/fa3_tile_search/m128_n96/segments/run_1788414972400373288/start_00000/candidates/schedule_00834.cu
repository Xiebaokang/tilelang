...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap K_desc, half_t* __restrict__ Output, const half_t* __restrict__ Q, __grid_constant__ const CUtensorMap V_desc) {
  ...
  void* K_shared = ((void*)((char*)buf_dyn_shmem + 106496));
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    ...
    if (tl::tl_shuffle_elect<256>()) {
      ...
      tl::fence_proxy_async();
      tl::tma_load(V_desc, pipeline_mbar[3], (&(((half_t*)V_shared)[12288])), 0, 96, ((int)blockIdx.y), 0);
      tl::tma_load(V_desc, pipeline_mbar[3], (&(((half_t*)V_shared)[18432])), 64, 96, ((int)blockIdx.y), 0);
    }
    tl::fence_proxy_async();
    tl::__sync_thread_partial(3, 256);
    for (int k = 0; k < 84; ++k) {
      if (tl::tl_shuffle_elect<256>()) {
        pipeline_mbar[(((k + 1) % 3) * 2)].arrive_and_expect_tx(24576);
        tl::tma_load(K_desc, pipeline_mbar[(((k + 1) % 3) * 2)], (&(((half_t*)K_shared)[(((k + 1) & 1) * 12288)])), 0, ((k * 96) + 96), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, pipeline_mbar[(((k + 1) % 3) * 2)], (&(((half_t*)K_shared)[((((k + 1) & 1) * 12288) + 6144)])), 64, ((k * 96) + 96), ((int)blockIdx.y), 0);
        pipeline_mbar[((((k + 2) % 3) * 2) + 1)].arrive_and_expect_tx(24576);
        tl::tma_load(V_desc, pipeline_mbar[((((k + 2) % 3) * 2) + 1)], (&(((half_t*)V_shared)[(((k + 2) % 3) * 12288)])), 0, ((k * 96) + 192), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, pipeline_mbar[((((k + 2) % 3) * 2) + 1)], (&(((half_t*)V_shared)[((((k + 2) % 3) * 12288) + 6144)])), 64, ((k * 96) + 192), ((int)blockIdx.y), 0);
      }
      *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
      ...
      pipeline_mbar[((k % 3) * 2)].wait(((k % 6) / 3));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b, ((k & 1) * 24576));
    ...
    if (tl::tl_shuffle_elect<256>()) {
      ...
      tl::tma_load(K_desc, pipeline_mbar[2], (&(((half_t*)K_shared)[12288])), 0, 8160, ((int)blockIdx.y), 0);
      tl::tma_load(K_desc, pipeline_mbar[2], (&(((half_t*)K_shared)[18432])), 64, 8160, ((int)blockIdx.y), 0);
    }
    *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
    #pragma unroll
