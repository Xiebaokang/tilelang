    ...
    if (((int)threadIdx.x) < 384) {
      ...
      for (int k_1 = 0; k_1 < 86; ++k_1) {
        ...
        for (int i_22 = 0; i_22 < 12; ++i_22) {
          ...
          uint4 condval_1;
          if ((((k_1 * 12) + i_22) < 1024)) {
            condval_1 = *(uint4*)(K + (((((((int)blockIdx.y) * 1048576) + (k_1 * 12288)) + (i_22 * 1024)) + (((int)threadIdx.x) * 8)) - 3072));
          } else {
        ...
        for (int i_23 = 0; i_23 < 12; ++i_23) {
          ...
          uint4 condval_2;
          if ((((k_1 * 12) + i_23) < 1024)) {
            condval_2 = *(uint4*)(V + (((((((int)blockIdx.y) * 1048576) + (k_1 * 12288)) + (i_23 * 1024)) + (((int)threadIdx.x) * 8)) - 3072));
          } else {
