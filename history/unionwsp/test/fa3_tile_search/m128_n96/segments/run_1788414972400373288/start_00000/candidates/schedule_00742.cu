...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(const half_t* __restrict__ K, half_t* __restrict__ Output, const half_t* __restrict__ Q, const half_t* __restrict__ V) {
  ...
  __shared__ __align__(16) uint64_t program_schedule_mbar_mem[6];
  ...
  if (tl::tl_shuffle_elect<0>()) {
    ...
    program_schedule_mbar[3].init(256);
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    #pragma unroll
    for (int i = 0; i < 8; ++i) {
      *(uint4*)(((half_t*)Q_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 8192) + (i * 1024)) + ((((int)threadIdx.x) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(Q + ((((((int)blockIdx.y) * 1048576) + (((int)blockIdx.x) * 16384)) + (i * 2048)) + (((int)threadIdx.x) * 8)));
    }
    #pragma unroll
    ...
    program_schedule_mbar[0].wait(0);
    {
      ...
      for (int warp_j = 0; warp_j < 3; ++warp_j) {
        ...
        for (int ki = 0; ki < 8; ++ki) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a + (((((ki >> 2) * 16384) + ((((int)threadIdx.x) >> 7) * 8192)) + ((ki & 3) * 32)) >> 4)), uint64_t(desc_b + (((((ki >> 2) * 12288) + (warp_j * 4096)) + ((ki & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + (warp_j * 16))), 1);
        }
      }
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int i_3 = 0; i_3 < 2; ++i_3) {
      ...
      scores_max_clear[i_3] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_max_clear[i_3]);
    ...
    for (int k = 0; k < 84; ++k) {
      program_schedule_mbar[2].wait((k & 1));
      {
      ...
      *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
      ...
      program_schedule_mbar[((k + 1) & 1)].wait((((k + 1) & 3) >> 1));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_2, (((k + 1) & 1) * 24576));
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 96);
        tl::warpgroup_arrive();
        #pragma unroll
        for (int warp_j_1 = 0; warp_j_1 < 3; ++warp_j_1) {
          ...
          for (int ki_2 = 0; ki_2 < 8; ++ki_2) {
            tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_1 + (((((ki_2 >> 2) * 16384) + ((((int)threadIdx.x) >> 7) * 8192)) + ((ki_2 & 3) * 32)) >> 4)), uint64_t(desc_b_2 + (((((ki_2 >> 2) * 12288) + (warp_j_1 * 4096)) + ((ki_2 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + (warp_j_1 * 16))), 1);
          }
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
      ...
      program_schedule_mbar[(((k + 1) & 1) + 3)].arrive();
    ...
    program_schedule_mbar[1].wait(0);
    {
      ...
      for (int warp_j_2 = 0; warp_j_2 < 3; ++warp_j_2) {
        ...
        for (int ki_4 = 0; ki_4 < 8; ++ki_4) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_2 + (((((ki_4 >> 2) * 16384) + ((((int)threadIdx.x) >> 7) * 8192)) + ((ki_4 & 3) * 32)) >> 4)), uint64_t(desc_b_4 + (((((ki_4 >> 2) * 12288) + (warp_j_2 * 4096)) + ((ki_4 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + (warp_j_2 * 16))), 1);
        }
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
    ...
    for (int i_21 = 0; i_21 < 2; ++i_21) {
      ...
      for (int rv_4 = 0; rv_4 < 24; ++rv_4) {
        scores_max_clear_2[i_21] = max(scores_max_clear_2[i_21], acc_s[((((rv_4 % 12) * 4) + (i_21 * 2)) + (rv_4 / 12))]);
      }
    ...
    for (int i_26 = 0; i_26 < 2; ++i_26) {
      ...
      for (int rv_5 = 0; rv_5 < 24; ++rv_5) {
        scores_sum[i_26] = (scores_sum[i_26] + acc_s[((((rv_5 % 12) * 4) + (i_26 * 2)) + (rv_5 / 12))]);
      }
      scores_sum[i_26] = tl::AllReduce<tl::SumOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_sum[i_26]);
    }
    #pragma unroll
    ...
    for (int i_31 = 0; i_31 < 12; ++i_31) {
      *(uint4*)(((half_t*)K_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 6144) + (i_31 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(K + ((((((int)blockIdx.y) * 1048576) + (i_31 * 1024)) + (((int)threadIdx.x) * 8)) - 2048));
    }
    tl::fence_proxy_async();
    program_schedule_mbar[0].arrive();
    #pragma unroll
    for (int i_32 = 0; i_32 < 12; ++i_32) {
      *(uint4*)(((half_t*)K_shared) + (((((((((((int)threadIdx.x) & 15) >> 3) * 6144) + (i_32 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 12288)) = *(uint4*)(K + ((((((int)blockIdx.y) * 1048576) + (i_32 * 1024)) + (((int)threadIdx.x) * 8)) + 10240));
    }
    tl::fence_proxy_async();
    program_schedule_mbar[1].arrive();
    tl::__sync_thread_partial(4, 128);
    for (int k_1 = 0; k_1 < 84; ++k_1) {
      program_schedule_mbar[((k_1 & 1) + 3)].wait(((k_1 & 3) >> 1));
      #pragma unroll
      for (int i_33 = 0; i_33 < 12; ++i_33) {
        half_t broadcast_var_6 = half_t(0x0p+0f/*0.000000e+00*/);
        uint4 condval_1;
        if ((((k_1 * 2) + ((i_33 + 2) / 6)) < 167)) {
          condval_1 = *(uint4*)(K + (((((((int)blockIdx.y) * 1048576) + (k_1 * 12288)) + (i_33 * 1024)) + (((int)threadIdx.x) * 8)) + 22528));
        } else {
        ...
        *(uint4*)(((half_t*)K_shared) + ((((((((k_1 & 1) * 12288) + (((((int)threadIdx.x) & 15) >> 3) * 6144)) + (i_33 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = condval_1;
      }
      tl::fence_proxy_async();
      program_schedule_mbar[(k_1 & 1)].arrive();
      if (1 <= k_1) {
        program_schedule_mbar[5].wait(((k_1 + 1) & 1));
      }
      #pragma unroll
      for (int i_34 = 0; i_34 < 12; ++i_34) {
        *(uint4*)(((half_t*)V_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 6144) + (i_34 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(V + (((((((int)blockIdx.y) * 1048576) + (k_1 * 12288)) + (i_34 * 1024)) + (((int)threadIdx.x) * 8)) - 2048));
      }
      tl::fence_proxy_async();
      program_schedule_mbar[2].arrive();
    }
    program_schedule_mbar[5].wait(1);
    tl::__sync_thread_partial(4, 128);
    #pragma unroll
    for (int i_35 = 0; i_35 < 12; ++i_35) {
      *(uint4*)(((half_t*)V_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 6144) + (i_35 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(V + ((((((int)blockIdx.y) * 1048576) + (i_35 * 1024)) + (((int)threadIdx.x) * 8)) + 1030144));
    }
    tl::fence_proxy_async();
    program_schedule_mbar[2].arrive();
    program_schedule_mbar[5].wait(0);
    tl::__sync_thread_partial(4, 128);
    #pragma unroll
    for (int i_36 = 0; i_36 < 12; ++i_36) {
      ...
      uint4 condval_2;
      if ((i_36 < 4)) {
        condval_2 = *(uint4*)(V + ((((((int)blockIdx.y) * 1048576) + (i_36 * 1024)) + (((int)threadIdx.x) * 8)) + 1042432));
      } else {
      ...
      *(uint4*)(((half_t*)V_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 6144) + (i_36 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = condval_2;
    }
    tl::fence_proxy_async();
    program_schedule_mbar[2].arrive();
  }
