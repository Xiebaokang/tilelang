    ...
    if (((int)threadIdx.x) < 384) {
      ...
      for (int k_1 = 0; k_1 < 86; ++k_1) {
        ...
        for (int i_13 = 0; i_13 < 12; ++i_13) {
          ...
          if ((((k_1 * 2) + ((i_13 + 2) / 6)) < 171)) {
            condval_1 = *(uint4*)(V + (((((((int)blockIdx.y) * 1048576) + (k_1 * 12288)) + (i_13 * 1024)) + (((int)threadIdx.x) * 8)) - 2048));
          } else {
      ...
      for (int k_2 = 0; k_2 < 86; ++k_2) {
        ...
        for (int i_14 = 0; i_14 < 12; ++i_14) {
          ...
          uint4 condval_2;
          if ((((k_2 * 12) + i_14) < 1024)) {
            condval_2 = *(uint4*)(K + (((((((int)blockIdx.y) * 1048576) + (k_2 * 12288)) + (i_14 * 1024)) + (((int)threadIdx.x) * 8)) - 3072));
          } else {
