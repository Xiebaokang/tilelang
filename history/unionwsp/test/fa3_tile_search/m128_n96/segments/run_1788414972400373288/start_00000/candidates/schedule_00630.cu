...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(const half_t* __restrict__ K, half_t* __restrict__ Output, const half_t* __restrict__ Q, __grid_constant__ const CUtensorMap V_desc) {
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    ...
    for (int k = 0; k < 84; ++k) {
      if (tl::tl_shuffle_elect<256>()) {
        pipeline_mbar[((k + 1) % 3)].arrive_and_expect_tx(24576);
        tl::tma_load(V_desc, pipeline_mbar[((k + 1) % 3)], (&(((half_t*)V_shared)[(((k + 1) & 1) * 12288)])), 0, ((k * 96) + 96), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, pipeline_mbar[((k + 1) % 3)], (&(((half_t*)V_shared)[((((k + 1) & 1) * 12288) + 6144)])), 64, ((k * 96) + 96), ((int)blockIdx.y), 0);
      }
      *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
      ...
      program_schedule_mbar[((k % 3) + 3)].arrive();
    ...
    if (tl::tl_shuffle_elect<256>()) {
      ...
      tl::tma_load(V_desc, pipeline_mbar[1], (&(((half_t*)V_shared)[12288])), 0, 8160, ((int)blockIdx.y), 0);
      tl::tma_load(V_desc, pipeline_mbar[1], (&(((half_t*)V_shared)[18432])), 64, 8160, ((int)blockIdx.y), 0);
    }
    *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
    #pragma unroll
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
    ...
    for (int k_1 = 0; k_1 < 86; ++k_1) {
      if (3 <= k_1) {
        program_schedule_mbar[((k_1 % 3) + 3)].wait((((k_1 / 3) + 1) & 1));
      }
      #pragma unroll
      for (int i_31 = 0; i_31 < 12; ++i_31) {
        ...
        *(uint4*)(((half_t*)K_shared) + ((((((((k_1 % 3) * 12288) + (((((int)threadIdx.x) & 15) >> 3) * 6144)) + (i_31 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = condval_1;
      }
      tl::fence_proxy_async();
      program_schedule_mbar[(k_1 % 3)].arrive();
    }
  }
}
