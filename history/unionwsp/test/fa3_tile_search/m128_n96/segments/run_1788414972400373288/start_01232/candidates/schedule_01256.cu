    ...
    if (((int)threadIdx.x) < 384) {
      ...
      for (int k_1 = 0; k_1 < 85; ++k_1) {
        ...
        for (int i_15 = 0; i_15 < 12; ++i_15) {
          ...
          uint4 condval_1;
          if ((((k_1 * 12) + i_15) < 1012)) {
            condval_1 = *(uint4*)(V + (((((((int)blockIdx.y) * 1048576) + (k_1 * 12288)) + (i_15 * 1024)) + (((int)threadIdx.x) * 8)) + 9216));
          } else {
      ...
      for (int i_16 = 0; i_16 < 12; ++i_16) {
        ...
        uint4 condval_2;
        if ((i_16 < 4)) {
          condval_2 = *(uint4*)(K + ((((((int)blockIdx.y) * 1048576) + (i_16 * 1024)) + (((int)threadIdx.x) * 8)) + 1041408));
        } else {
