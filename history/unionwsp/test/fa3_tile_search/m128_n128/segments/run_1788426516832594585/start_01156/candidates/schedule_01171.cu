    ...
    if (((int)threadIdx.x) < 384) {
      ...
      for (int k_1 = 0; k_1 < 64; ++k_1) {
        ...
        for (int i_13 = 0; i_13 < 16; ++i_13) {
          *(uint4*)(((half_t*)K_shared) + ((((((((k_1 & 1) * 16384) + (((((int)threadIdx.x) & 15) >> 3) * 8192)) + (i_13 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(K + (((((((int)blockIdx.y) * 1048576) + (k_1 * 16384)) + (i_13 * 1024)) + (((int)threadIdx.x) * 8)) - 2048));
        }
        tl::fence_proxy_async();
      ...
      for (int k_2 = 0; k_2 < 64; ++k_2) {
        ...
        for (int i_14 = 0; i_14 < 16; ++i_14) {
          *(uint4*)(((half_t*)V_shared) + ((((((((k_2 % 3) * 16384) + (((((int)threadIdx.x) & 15) >> 3) * 8192)) + (i_14 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(V + (((((((int)blockIdx.y) * 1048576) + (k_2 * 16384)) + (i_14 * 1024)) + (((int)threadIdx.x) * 8)) - 3072));
        }
        tl::fence_proxy_async();
