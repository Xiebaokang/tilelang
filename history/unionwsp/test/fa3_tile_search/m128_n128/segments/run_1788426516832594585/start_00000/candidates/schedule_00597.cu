...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap K_desc, half_t* __restrict__ Output, const half_t* __restrict__ Q, __grid_constant__ const CUtensorMap V_desc) {
  ...
  void* V_shared = ((void*)((char*)buf_dyn_shmem + 163840));
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    ...
    if (tl::tl_shuffle_elect<256>()) {
      ...
      pipeline_mbar[2].arrive_and_expect_tx(32768);
      tl::fence_proxy_async();
      tl::tma_load(K_desc, pipeline_mbar[2], (&(((half_t*)K_shared)[16384])), 0, 128, ((int)blockIdx.y), 0);
      tl::tma_load(K_desc, pipeline_mbar[2], (&(((half_t*)K_shared)[24576])), 64, 128, ((int)blockIdx.y), 0);
      pipeline_mbar[1].arrive_and_expect_tx(32768);
      tl::fence_proxy_async();
      tl::tma_load(V_desc, pipeline_mbar[1], (&(((half_t*)V_shared)[0])), 0, 0, ((int)blockIdx.y), 0);
      tl::tma_load(V_desc, pipeline_mbar[1], (&(((half_t*)V_shared)[8192])), 64, 0, ((int)blockIdx.y), 0);
    }
    tl::fence_proxy_async();
    tl::__sync_thread_partial(3, 256);
    for (int k = 0; k < 62; ++k) {
      if (tl::tl_shuffle_elect<256>()) {
        pipeline_mbar[(((k + 2) % 3) * 2)].arrive_and_expect_tx(32768);
        tl::tma_load(K_desc, pipeline_mbar[(((k + 2) % 3) * 2)], (&(((half_t*)K_shared)[(((k + 2) & 3) * 16384)])), 0, ((k * 128) + 256), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, pipeline_mbar[(((k + 2) % 3) * 2)], (&(((half_t*)K_shared)[((((k + 2) & 3) * 16384) + 8192)])), 64, ((k * 128) + 256), ((int)blockIdx.y), 0);
        pipeline_mbar[((((k + 1) % 3) * 2) + 1)].arrive_and_expect_tx(32768);
        tl::tma_load(V_desc, pipeline_mbar[((((k + 1) % 3) * 2) + 1)], (&(((half_t*)V_shared)[(((k + 1) & 1) * 16384)])), 0, ((k * 128) + 128), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, pipeline_mbar[((((k + 1) % 3) * 2) + 1)], (&(((half_t*)V_shared)[((((k + 1) & 1) * 16384) + 8192)])), 64, ((k * 128) + 128), ((int)blockIdx.y), 0);
      }
      *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
      ...
      pipeline_mbar[((k % 3) * 2)].wait(((k % 6) / 3));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b, ((k & 3) * 32768));
    ...
    if (tl::tl_shuffle_elect<256>()) {
      pipeline_mbar[1].arrive_and_expect_tx(32768);
      tl::tma_load(V_desc, pipeline_mbar[1], (&(((half_t*)V_shared)[16384])), 0, 8064, ((int)blockIdx.y), 0);
      tl::tma_load(V_desc, pipeline_mbar[1], (&(((half_t*)V_shared)[24576])), 64, 8064, ((int)blockIdx.y), 0);
    }
    *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
    #pragma unroll
    ...
    *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
    ...
    pipeline_mbar[0].wait(1);
    {
      ...
      tl::increase_descriptor_offset<int>(desc_b_4, 98304);
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 128);
      tl::warpgroup_arrive();
      #pragma unroll
