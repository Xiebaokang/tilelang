  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    ...
    if (tl::tl_shuffle_elect<256>()) {
      ...
      tl::fence_proxy_async();
      tl::tma_load(V_desc, pipeline_mbar[1], (&(((half_t*)V_shared)[16384])), 0, 128, ((int)blockIdx.y), 0);
      tl::tma_load(V_desc, pipeline_mbar[1], (&(((half_t*)V_shared)[24576])), 64, 128, ((int)blockIdx.y), 0);
    }
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int k = 0; k < 62; ++k) {
      if (tl::tl_shuffle_elect<256>()) {
        ...
        tl::tma_load(V_desc, pipeline_mbar[((k + 2) % 3)], (&(((half_t*)V_shared)[(((k + 2) & 3) * 16384)])), 0, ((k * 128) + 256), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, pipeline_mbar[((k + 2) % 3)], (&(((half_t*)V_shared)[((((k + 2) & 3) * 16384) + 8192)])), 64, ((k * 128) + 256), ((int)blockIdx.y), 0);
      }
