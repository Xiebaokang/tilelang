    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    ...
    for (int k = 0; k < 62; ++k) {
      if (tl::tl_shuffle_elect<256>()) {
        ...
        tl::tma_load(V_desc, pipeline_mbar[((k + 1) % 3)], (&(((half_t*)V_shared)[(((k + 1) % 3) * 16384)])), 0, ((k * 128) + 128), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, pipeline_mbar[((k + 1) % 3)], (&(((half_t*)V_shared)[((((k + 1) % 3) * 16384) + 8192)])), 64, ((k * 128) + 128), ((int)blockIdx.y), 0);
      }
    ...
    if (tl::tl_shuffle_elect<256>()) {
      ...
      tl::tma_load(V_desc, pipeline_mbar[0], (&(((half_t*)V_shared)[8192])), 64, 8064, ((int)blockIdx.y), 0);
    }
    *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
    #pragma unroll
