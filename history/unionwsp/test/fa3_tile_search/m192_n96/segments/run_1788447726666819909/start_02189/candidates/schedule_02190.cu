...
extern "C" __global__ void __launch_bounds__(640, 1) main_kernel(const half_t* __restrict__ K, __grid_constant__ const CUtensorMap Output_desc, const half_t* __restrict__ Q, const half_t* __restrict__ V) {
  ...
  void* O_shared = ((void*)((char*)buf_dyn_shmem + 122880));
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
    ...
    if (((int)threadIdx.x) < 512) {
      ...
      for (int i_31 = 0; i_31 < 12; ++i_31) {
        *(uint4*)(((half_t*)K_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 6144) + (i_31 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(K + ((((((int)blockIdx.y) * 1048576) + (i_31 * 1024)) + (((int)threadIdx.x) * 8)) - 4096));
      }
      tl::fence_proxy_async();
      program_schedule_mbar[1].arrive();
      #pragma unroll
      for (int i_32 = 0; i_32 < 12; ++i_32) {
        *(uint4*)(((half_t*)K_shared) + (((((((((((int)threadIdx.x) & 15) >> 3) * 6144) + (i_32 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 12288)) = *(uint4*)(K + ((((((int)blockIdx.y) * 1048576) + (i_32 * 1024)) + (((int)threadIdx.x) * 8)) + 8192));
      }
      tl::fence_proxy_async();
      ...
      for (int k_1 = 0; k_1 < 84; ++k_1) {
        ...
        for (int i_33 = 0; i_33 < 12; ++i_33) {
          ...
          uint4 condval_2;
          if ((((k_1 * 3) + (i_33 >> 2)) < 250)) {
            condval_2 = *(uint4*)(K + (((((((int)blockIdx.y) * 1048576) + (k_1 * 12288)) + (i_33 * 1024)) + (((int)threadIdx.x) * 8)) + 20480));
          } else {
        ...
        for (int i_34 = 0; i_34 < 12; ++i_34) {
          *(uint4*)(((half_t*)V_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 6144) + (i_34 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(V + (((((((int)blockIdx.y) * 1048576) + (k_1 * 12288)) + (i_34 * 1024)) + (((int)threadIdx.x) * 8)) - 4096));
        }
        tl::fence_proxy_async();
      ...
      for (int i_35 = 0; i_35 < 12; ++i_35) {
        *(uint4*)(((half_t*)V_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 6144) + (i_35 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(V + ((((((int)blockIdx.y) * 1048576) + (i_35 * 1024)) + (((int)threadIdx.x) * 8)) + 1028096));
      }
      tl::fence_proxy_async();
      program_schedule_mbar[3].arrive();
      ...
      for (int i_36 = 0; i_36 < 12; ++i_36) {
        ...
        uint4 condval_3;
        if ((i_36 < 4)) {
          condval_3 = *(uint4*)(V + ((((((int)blockIdx.y) * 1048576) + (i_36 * 1024)) + (((int)threadIdx.x) * 8)) + 1040384));
        } else {
