...
extern "C" __global__ void __launch_bounds__(640, 1) main_kernel(__grid_constant__ const CUtensorMap K_desc, __grid_constant__ const CUtensorMap Output_desc, const half_t* __restrict__ Q, __grid_constant__ const CUtensorMap V_desc) {
