...
extern "C" __global__ void __launch_bounds__(512, 1) main_kernel(const half_t* __restrict__ K, __grid_constant__ const CUtensorMap Output_desc, const half_t* __restrict__ Q, const half_t* __restrict__ V) {
  ...
  void* K_shared = ((void*)((char*)buf_dyn_shmem + 73728));
  void* Q_shared = ((void*)((char*)buf_dyn_shmem + 122880));
  void* O_shared = ((void*)((char*)buf_dyn_shmem + 172032));
  ...
  if (tl::tl_shuffle_elect<0>()) {
    ...
    program_schedule_mbar[9].init(384);
    program_schedule_mbar[10].init(384);
    program_schedule_mbar[11].init(384);
  }
  ...
  if (((int)threadIdx.x) < 384) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
      ...
      for (int i_6 = 0; i_6 < 2; ++i_6) {
        ...
        for (int rv_1 = 0; rv_1 < 24; ++rv_1) {
          scores_sum[i_6] = (scores_sum[i_6] + acc_s[((((rv_1 % 12) * 4) + (i_6 * 2)) + (rv_1 / 12))]);
        }
        scores_sum[i_6] = tl::AllReduce<tl::SumOp, 4, 1, 0, tl::NamedBarrier<384>>::run(scores_sum[i_6]);
      }
      #pragma unroll
    ...
    for (int i_12 = 0; i_12 < 24; ++i_12) {
      ...
      uint4 condval_1;
      if ((((((int)blockIdx.x) * 24) + i_12) < 1024)) {
        condval_1 = *(uint4*)(Q + (((((((int)blockIdx.y) * 1048576) + (((int)blockIdx.x) * 24576)) + (i_12 * 1024)) + (((int)threadIdx.x) * 8)) - 3072));
      } else {
      ...
      *(uint4*)(((half_t*)Q_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 12288) + (i_12 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = condval_1;
    }
    tl::fence_proxy_async();
    program_schedule_mbar[0].arrive();
    #pragma unroll
    for (int i_13 = 0; i_13 < 12; ++i_13) {
      *(uint4*)(((half_t*)V_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 6144) + (i_13 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(V + ((((((int)blockIdx.y) * 1048576) + (i_13 * 1024)) + (((int)threadIdx.x) * 8)) - 3072));
    }
    tl::fence_proxy_async();
    ...
    for (int k_1 = 0; k_1 < 85; ++k_1) {
      ...
      #pragma unroll
      for (int i_14 = 0; i_14 < 12; ++i_14) {
        *(uint4*)(((half_t*)K_shared) + ((((((((k_1 & 1) * 12288) + (((((int)threadIdx.x) & 15) >> 3) * 6144)) + (i_14 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(K + (((((((int)blockIdx.y) * 1048576) + (k_1 * 12288)) + (i_14 * 1024)) + (((int)threadIdx.x) * 8)) - 3072));
      }
      tl::fence_proxy_async();
      program_schedule_mbar[((k_1 & 1) + 1)].arrive();
      if (2 <= k_1) {
        program_schedule_mbar[(((k_1 + 1) % 3) + 9)].wait((((k_1 + 4) % 6) / 3));
      }
      #pragma unroll
      for (int i_15 = 0; i_15 < 12; ++i_15) {
        ...
        uint4 condval_2;
        if ((((k_1 * 12) + i_15) < 1012)) {
          condval_2 = *(uint4*)(V + (((((((int)blockIdx.y) * 1048576) + (k_1 * 12288)) + (i_15 * 1024)) + (((int)threadIdx.x) * 8)) + 9216));
        } else {
        ...
        *(uint4*)(((half_t*)V_shared) + (((((((((k_1 + 1) % 3) * 12288) + (((((int)threadIdx.x) & 15) >> 3) * 6144)) + (i_15 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = condval_2;
      }
      tl::fence_proxy_async();
      program_schedule_mbar[(((k_1 + 1) % 3) + 3)].arrive();
    }
    ...
    for (int i_16 = 0; i_16 < 12; ++i_16) {
      ...
      uint4 condval_3;
      if ((i_16 < 4)) {
        condval_3 = *(uint4*)(K + ((((((int)blockIdx.y) * 1048576) + (i_16 * 1024)) + (((int)threadIdx.x) * 8)) + 1041408));
      } else {
        condval_3 = make_uint4(__pack_half2(broadcast_var_6, broadcast_var_6), __pack_half2(broadcast_var_6, broadcast_var_6), __pack_half2(broadcast_var_6, broadcast_var_6), __pack_half2(broadcast_var_6, broadcast_var_6));
      }
      *(uint4*)(((half_t*)K_shared) + (((((((((((int)threadIdx.x) & 15) >> 3) * 6144) + (i_16 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 12288)) = condval_3;
    }
    tl::fence_proxy_async();
