    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    ...
    if (((int)threadIdx.x) < 512) {
      ...
      for (int i_13 = 0; i_13 < 12; ++i_13) {
        *(uint4*)(((half_t*)K_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 6144) + (i_13 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(K + ((((((int)blockIdx.y) * 1048576) + (i_13 * 1024)) + (((int)threadIdx.x) * 8)) - 3072));
      }
      tl::fence_proxy_async();
      ...
      for (int k_1 = 0; k_1 < 85; ++k_1) {
        ...
        for (int i_14 = 0; i_14 < 12; ++i_14) {
          ...
          uint4 condval_2;
          if ((((k_1 * 12) + i_14) < 1012)) {
            condval_2 = *(uint4*)(K + (((((((int)blockIdx.y) * 1048576) + (k_1 * 12288)) + (i_14 * 1024)) + (((int)threadIdx.x) * 8)) + 9216));
          } else {
        ...
        for (int i_15 = 0; i_15 < 12; ++i_15) {
          *(uint4*)(((half_t*)V_shared) + ((((((((k_1 & 1) * 12288) + (((((int)threadIdx.x) & 15) >> 3) * 6144)) + (i_15 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(V + (((((((int)blockIdx.y) * 1048576) + (k_1 * 12288)) + (i_15 * 1024)) + (((int)threadIdx.x) * 8)) - 3072));
        }
        tl::fence_proxy_async();
      ...
      for (int i_16 = 0; i_16 < 12; ++i_16) {
        ...
        uint4 condval_3;
        if ((i_16 < 4)) {
          condval_3 = *(uint4*)(V + ((((((int)blockIdx.y) * 1048576) + (i_16 * 1024)) + (((int)threadIdx.x) * 8)) + 1041408));
        } else {
