...
extern "C" __global__ void __launch_bounds__(512, 1) main_kernel(const half_t* __restrict__ K, __grid_constant__ const CUtensorMap Output_desc, const half_t* __restrict__ Q, const half_t* __restrict__ V) {
  ...
  void* V_shared = ((void*)((char*)buf_dyn_shmem + 73728));
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
    ...
    for (int k_1 = 0; k_1 < 85; ++k_1) {
      ...
      for (int i_33 = 0; i_33 < 12; ++i_33) {
        ...
        uint4 condval_2;
        if ((((k_1 * 12) + i_33) < 1012)) {
          condval_2 = *(uint4*)(V + (((((((int)blockIdx.y) * 1048576) + (k_1 * 12288)) + (i_33 * 1024)) + (((int)threadIdx.x) * 8)) + 9216));
        } else {
        ...
        *(uint4*)(((half_t*)V_shared) + (((((((((k_1 + 1) % 3) * 12288) + (((((int)threadIdx.x) & 15) >> 3) * 6144)) + (i_33 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = condval_2;
      }
      tl::fence_proxy_async();
    ...
    for (int i_34 = 0; i_34 < 12; ++i_34) {
      ...
      uint4 condval_3;
      if ((i_34 < 4)) {
        condval_3 = *(uint4*)(K + ((((((int)blockIdx.y) * 1048576) + (i_34 * 1024)) + (((int)threadIdx.x) * 8)) + 1041408));
      } else {
      ...
      *(uint4*)(((half_t*)K_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 6144) + (i_34 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = condval_3;
    }
    tl::fence_proxy_async();
    program_schedule_mbar[0].arrive();
