    ...
    if (((int)threadIdx.x) < 512) {
      ...
      for (int k_1 = 0; k_1 < 86; ++k_1) {
        ...
        for (int i_22 = 0; i_22 < 12; ++i_22) {
          ...
          uint4 condval_2;
          if ((((k_1 * 12) + i_22) < 1024)) {
            condval_2 = *(uint4*)(V + (((((((int)blockIdx.y) * 1048576) + (k_1 * 12288)) + (i_22 * 1024)) + (((int)threadIdx.x) * 8)) - 3072));
          } else {
          ...
          *(uint4*)(((half_t*)V_shared) + ((((((((k_1 & 1) * 12288) + (((((int)threadIdx.x) & 15) >> 3) * 6144)) + (i_22 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = condval_2;
        }
        tl::fence_proxy_async();
      ...
      for (int k_2 = 0; k_2 < 86; ++k_2) {
        ...
        for (int i_23 = 0; i_23 < 12; ++i_23) {
          ...
          uint4 condval_3;
          if ((((k_2 * 3) + (i_23 >> 2)) < 256)) {
            condval_3 = *(uint4*)(K + (((((((int)blockIdx.y) * 1048576) + (k_2 * 12288)) + (i_23 * 1024)) + (((int)threadIdx.x) * 8)) - 4096));
          } else {
          ...
          *(uint4*)(((half_t*)K_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 6144) + (i_23 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = condval_3;
        }
        tl::fence_proxy_async();
