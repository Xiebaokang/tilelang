  ...
  if (((int)threadIdx.x) < 384) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int i_12 = 0; i_12 < 8; ++i_12) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)O_shared)[(((((i_12 >> 2) * 12288) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_12 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_12 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_o[(i_12 * 8)]), ((half_t)acc_o[((i_12 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_12 * 8) + 2)]), ((half_t)acc_o[((i_12 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_12 * 8) + 4)]), ((half_t)acc_o[((i_12 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_12 * 8) + 6)]), ((half_t)acc_o[((i_12 * 8) + 7)])));
    }
    tl::fence_proxy_async();
