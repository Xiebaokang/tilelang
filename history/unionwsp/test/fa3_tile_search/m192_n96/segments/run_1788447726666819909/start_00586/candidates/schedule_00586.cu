    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    for (int k = 0; k < 86; ++k) {
      ...
      for (int i_2 = 0; i_2 < 4; ++i_2) {
        ...
        uint4 condval_1;
        if ((((k * 3) + (((i_2 * 3) + (((int)threadIdx.x) >> 7)) >> 2)) < 256)) {
          condval_1 = *(uint4*)(K + ((((((int)blockIdx.y) * 1048576) + (k * 12288)) + (i_2 * 3072)) + (((int)threadIdx.x) * 8)));
        } else {
        ...
        *(uint4*)(((half_t*)K_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 6144) + (i_2 * 1536)) + ((((int)threadIdx.x) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = condval_1;
      }
      #pragma unroll
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
      ...
      for (int i_4 = 0; i_4 < 2; ++i_4) {
        ...
        scores_max_clear[i_4] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<384>>::run(scores_max_clear[i_4]);
    ...
    for (int i_13 = 0; i_13 < 8; ++i_13) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)O_shared)[(((((i_13 >> 2) * 12288) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_13 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_13 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_o[(i_13 * 8)]), ((half_t)acc_o[((i_13 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_13 * 8) + 2)]), ((half_t)acc_o[((i_13 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_13 * 8) + 4)]), ((half_t)acc_o[((i_13 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_13 * 8) + 6)]), ((half_t)acc_o[((i_13 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 384);
