...
extern "C" __global__ void main_kernel(const half_t* __restrict__ K, __grid_constant__ const CUtensorMap Output_desc, const half_t* __restrict__ Q, const half_t* __restrict__ V);
extern "C" __global__ void __launch_bounds__(512, 1) main_kernel(const half_t* __restrict__ K, __grid_constant__ const CUtensorMap Output_desc, const half_t* __restrict__ Q, const half_t* __restrict__ V) {
  ...
  if (tl::tl_shuffle_elect<0>()) {
    ...
    program_schedule_mbar[4].init(384);
    program_schedule_mbar[5].init(384);
  }
  ...
  if (((int)threadIdx.x) < 384) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
    ...
    for (int i_21 = 0; i_21 < 2; ++i_21) {
      ...
      scores_max_clear_2[i_21] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<384>>::run(scores_max_clear_2[i_21]);
    ...
    for (int i_26 = 0; i_26 < 2; ++i_26) {
      ...
      scores_sum[i_26] = tl::AllReduce<tl::SumOp, 4, 1, 0, tl::NamedBarrier<384>>::run(scores_sum[i_26]);
    }
    #pragma unroll
    ...
    for (int i_30 = 0; i_30 < 8; ++i_30) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)O_shared)[(((((i_30 >> 2) * 12288) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_30 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_30 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_o[(i_30 * 8)]), ((half_t)acc_o[((i_30 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_30 * 8) + 2)]), ((half_t)acc_o[((i_30 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_30 * 8) + 4)]), ((half_t)acc_o[((i_30 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_30 * 8) + 6)]), ((half_t)acc_o[((i_30 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 384);
    ...
    for (int k_1 = 0; k_1 < 84; ++k_1) {
      ...
      for (int i_33 = 0; i_33 < 12; ++i_33) {
        ...
        uint4 condval_2;
        if ((((k_1 * 12) + i_33) < 1000)) {
          condval_2 = *(uint4*)(K + (((((((int)blockIdx.y) * 1048576) + (k_1 * 12288)) + (i_33 * 1024)) + (((int)threadIdx.x) * 8)) + 21504));
        } else {
        ...
        *(uint4*)(((half_t*)K_shared) + ((((((((k_1 & 1) * 12288) + (((((int)threadIdx.x) & 15) >> 3) * 6144)) + (i_33 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = condval_2;
      }
      tl::fence_proxy_async();
    ...
    for (int i_36 = 0; i_36 < 12; ++i_36) {
      ...
      uint4 condval_3;
      if ((i_36 < 4)) {
        condval_3 = *(uint4*)(V + ((((((int)blockIdx.y) * 1048576) + (i_36 * 1024)) + (((int)threadIdx.x) * 8)) + 1041408));
      } else {
        condval_3 = make_uint4(__pack_half2(broadcast_var_8, broadcast_var_8), __pack_half2(broadcast_var_8, broadcast_var_8), __pack_half2(broadcast_var_8, broadcast_var_8), __pack_half2(broadcast_var_8, broadcast_var_8));
      }
      *(uint4*)(((half_t*)V_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 6144) + (i_36 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = condval_3;
    }
    tl::fence_proxy_async();
    program_schedule_mbar[2].arrive();
  }
