    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int k_1 = 0; k_1 < 86; ++k_1) {
        ...
        for (int i_31 = 0; i_31 < 12; ++i_31) {
          ...
          uint4 condval_1;
          if ((((k_1 * 12) + i_31) < 1024)) {
            condval_1 = *(uint4*)(V + (((((((int)blockIdx.y) * 1048576) + (k_1 * 12288)) + (i_31 * 1024)) + (((int)threadIdx.x) * 8)) - 1024));
          } else {
      ...
      for (int k_2 = 0; k_2 < 86; ++k_2) {
        ...
        for (int i_32 = 0; i_32 < 12; ++i_32) {
          ...
          if ((((k_2 * 2) + ((i_32 + 2) / 6)) < 171)) {
            condval_2 = *(uint4*)(K + (((((((int)blockIdx.y) * 1048576) + (k_2 * 12288)) + (i_32 * 1024)) + (((int)threadIdx.x) * 8)) - 2048));
          } else {
