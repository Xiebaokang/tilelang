    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int k_1 = 0; k_1 < 86; ++k_1) {
        ...
        for (int i_13 = 0; i_13 < 12; ++i_13) {
          ...
          uint4 condval_1;
          if ((((k_1 * 12) + i_13) < 1024)) {
            condval_1 = *(uint4*)(V + (((((((int)blockIdx.y) * 1048576) + (k_1 * 12288)) + (i_13 * 1024)) + (((int)threadIdx.x) * 8)) - 1024));
          } else {
          ...
          *(uint4*)(((half_t*)V_shared) + ((((((((k_1 % 3) * 12288) + (((((int)threadIdx.x) & 15) >> 3) * 6144)) + (i_13 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = condval_1;
        }
        tl::fence_proxy_async();
      ...
      for (int k_2 = 0; k_2 < 86; ++k_2) {
        ...
        for (int i_14 = 0; i_14 < 12; ++i_14) {
          ...
          uint4 condval_2;
          if ((((k_2 * 2) + ((i_14 + 2) / 6)) < 171)) {
            condval_2 = *(uint4*)(K + (((((((int)blockIdx.y) * 1048576) + (k_2 * 12288)) + (i_14 * 1024)) + (((int)threadIdx.x) * 8)) - 2048));
          } else {
          ...
          *(uint4*)(((half_t*)K_shared) + ((((((((k_2 & 1) * 12288) + (((((int)threadIdx.x) & 15) >> 3) * 6144)) + (i_14 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = condval_2;
        }
        tl::fence_proxy_async();
