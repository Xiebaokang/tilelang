...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(const half_t* __restrict__ K, half_t* __restrict__ Output, const half_t* __restrict__ Q, const half_t* __restrict__ V) {
  ...
  void* O_shared = ((void*)((char*)buf_dyn_shmem + 90112));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
    ...
    program_schedule_mbar[1].wait(0);
    {
      ...
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 48);
      tl::warpgroup_arrive();
      #pragma unroll
      for (int warp_j = 0; warp_j < 3; ++warp_j) {
        #pragma unroll
        for (int ki = 0; ki < 8; ++ki) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a + ((((ki >> 2) * 8192) + ((ki & 3) * 32)) >> 4)), uint64_t(desc_b + (((((ki >> 2) * 12288) + (warp_j * 4096)) + ((ki & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + (warp_j * 16))), 1);
        }
      }
      ...
      program_schedule_mbar[(((k + 1) & 1) + 1)].wait((((k + 1) & 3) >> 1));
      {
        ...
        for (int warp_j_1 = 0; warp_j_1 < 3; ++warp_j_1) {
          ...
          for (int ki_2 = 0; ki_2 < 8; ++ki_2) {
            tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_1 + ((((ki_2 >> 2) * 8192) + ((ki_2 & 3) * 32)) >> 4)), uint64_t(desc_b_2 + (((((ki_2 >> 2) * 12288) + (warp_j_1 * 4096)) + ((ki_2 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + (warp_j_1 * 16))), 1);
          }
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
    ...
    program_schedule_mbar[2].wait(0);
    {
      ...
      for (int warp_j_2 = 0; warp_j_2 < 3; ++warp_j_2) {
        ...
        for (int ki_4 = 0; ki_4 < 8; ++ki_4) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_2 + ((((ki_4 >> 2) * 8192) + ((ki_4 & 3) * 32)) >> 4)), uint64_t(desc_b_4 + (((((ki_4 >> 2) * 12288) + (warp_j_2 * 4096)) + ((ki_4 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + (warp_j_2 * 16))), 1);
        }
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
