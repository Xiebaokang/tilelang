  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int i_21 = 0; i_21 < 8; ++i_21) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)O_shared)[(((((((int)threadIdx.x) >> 5) * 2048) + ((((int)threadIdx.x) & 15) * 128)) + (i_21 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(((half_t)acc_o[(i_21 * 8)]), ((half_t)acc_o[((i_21 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_21 * 8) + 2)]), ((half_t)acc_o[((i_21 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_21 * 8) + 4)]), ((half_t)acc_o[((i_21 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_21 * 8) + 6)]), ((half_t)acc_o[((i_21 * 8) + 7)])));
    }
    tl::fence_proxy_async();
