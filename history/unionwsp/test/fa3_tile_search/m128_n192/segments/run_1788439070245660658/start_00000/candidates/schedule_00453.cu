    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    ...
    for (int k = 0; k < 43; ++k) {
      ...
      program_schedule_mbar[(k % 3)].wait(((k % 6) / 3));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b, ((k % 3) * 49152));
    ...
    for (int k_1 = 0; k_1 < 42; ++k_1) {
      ...
      for (int i_14 = 0; i_14 < 24; ++i_14) {
        ...
        *(uint4*)(((half_t*)K_shared) + (((((((((k_1 + 1) % 3) * 24576) + (((((int)threadIdx.x) & 15) >> 3) * 12288)) + (i_14 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = condval_1;
      }
      tl::fence_proxy_async();
      program_schedule_mbar[((k_1 + 1) % 3)].arrive();
      if (1 <= k_1) {
        program_schedule_mbar[8].wait(((k_1 + 1) & 1));
      }
      #pragma unroll
      for (int i_15 = 0; i_15 < 24; ++i_15) {
        *(uint4*)(((half_t*)V_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 12288) + (i_15 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(V + (((((((int)blockIdx.y) * 1048576) + (k_1 * 24576)) + (i_15 * 1024)) + (((int)threadIdx.x) * 8)) - 2048));
      }
      tl::fence_proxy_async();
