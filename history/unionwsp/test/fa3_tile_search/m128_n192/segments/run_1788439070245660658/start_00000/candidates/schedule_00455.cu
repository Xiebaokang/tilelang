...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap K_desc, half_t* __restrict__ Output, const half_t* __restrict__ Q, const half_t* __restrict__ V) {
  ...
  void* V_shared = ((void*)((char*)buf_dyn_shmem + 147456));
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    ...
    if (tl::tl_shuffle_elect<256>()) {
      ...
      tl::tma_load(K_desc, pipeline_mbar[1], (&(((half_t*)K_shared)[24576])), 0, 192, ((int)blockIdx.y), 0);
      tl::tma_load(K_desc, pipeline_mbar[1], (&(((half_t*)K_shared)[36864])), 64, 192, ((int)blockIdx.y), 0);
    }
    tl::__sync_thread_partial(3, 256);
    for (int k = 0; k < 41; ++k) {
      if (tl::tl_shuffle_elect<256>()) {
        pipeline_mbar[((k + 2) % 3)].arrive_and_expect_tx(49152);
        tl::tma_load(K_desc, pipeline_mbar[((k + 2) % 3)], (&(((half_t*)K_shared)[(((k + 2) % 3) * 24576)])), 0, ((k * 192) + 384), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, pipeline_mbar[((k + 2) % 3)], (&(((half_t*)K_shared)[((((k + 2) % 3) * 24576) + 12288)])), 64, ((k * 192) + 384), ((int)blockIdx.y), 0);
      }
    ...
    *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
    ...
    pipeline_mbar[2].wait(1);
    {
      ...
      tl::increase_descriptor_offset<int>(desc_b_2, 98304);
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 192);
      tl::warpgroup_arrive();
      tl::__sync_thread_partial(3, 256);
      #pragma unroll
