  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int k = 0; k < 41; ++k) {
      ...
      *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
      ...
      program_schedule_mbar[(((k + 1) & 1) + 4)].arrive();
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
    ...
    for (int k_1 = 0; k_1 < 41; ++k_1) {
      program_schedule_mbar[((k_1 & 1) + 4)].wait(((k_1 & 3) >> 1));
      #pragma unroll
      ...
      if (1 <= k_1) {
        program_schedule_mbar[6].wait(((k_1 + 1) & 1));
      }
      #pragma unroll
    ...
    program_schedule_mbar[6].wait(0);
    tl::__sync_thread_partial(4, 128);
    #pragma unroll
    ...
    tl::fence_proxy_async();
    program_schedule_mbar[3].arrive();
    program_schedule_mbar[6].wait(1);
    tl::__sync_thread_partial(4, 128);
    #pragma unroll
