    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    for (int k = 0; k < 43; ++k) {
      ...
      for (int i_1 = 0; i_1 < 12; ++i_1) {
        ...
        uint4 condval;
        if ((((k * 3) + (i_1 >> 2)) < 128)) {
          condval = *(uint4*)(K + ((((((int)blockIdx.y) * 1048576) + (k * 24576)) + (i_1 * 2048)) + (((int)threadIdx.x) * 8)));
        } else {
        ...
        *(uint4*)(((half_t*)K_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 12288) + (i_1 * 1024)) + ((((int)threadIdx.x) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = condval;
      }
      #pragma unroll
    ...
    for (int i_13 = 0; i_13 < 16; ++i_13) {
      *(uint4*)(((half_t*)Q_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 8192) + (i_13 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(Q + (((((((int)blockIdx.y) * 1048576) + (((int)blockIdx.x) * 16384)) + (i_13 * 1024)) + (((int)threadIdx.x) * 8)) - 2048));
    }
    tl::fence_proxy_async();
    ...
    for (int k_1 = 0; k_1 < 43; ++k_1) {
      ...
      for (int i_14 = 0; i_14 < 24; ++i_14) {
        ...
        uint4 condval_2;
        if ((((k_1 * 4) + ((i_14 + 2) / 6)) < 171)) {
          condval_2 = *(uint4*)(V + (((((((int)blockIdx.y) * 1048576) + (k_1 * 24576)) + (i_14 * 1024)) + (((int)threadIdx.x) * 8)) - 2048));
        } else {
        ...
        *(uint4*)(((half_t*)V_shared) + ((((((((k_1 & 1) * 24576) + (((((int)threadIdx.x) & 15) >> 3) * 12288)) + (i_14 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = condval_2;
      }
      tl::fence_proxy_async();
