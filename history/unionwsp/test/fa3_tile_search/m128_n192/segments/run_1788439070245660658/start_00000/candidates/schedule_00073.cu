...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap K_desc, half_t* __restrict__ Output, const half_t* __restrict__ Q, __grid_constant__ const CUtensorMap V_desc) {
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    ...
    for (int k = 0; k < 42; ++k) {
      if (tl::tl_shuffle_elect<256>()) {
        pipeline_mbar[(((k + 1) & 1) * 2)].arrive_and_expect_tx(49152);
        tl::tma_load(K_desc, pipeline_mbar[(((k + 1) & 1) * 2)], (&(((half_t*)K_shared)[(((k + 1) & 1) * 24576)])), 0, ((k * 192) + 192), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, pipeline_mbar[(((k + 1) & 1) * 2)], (&(((half_t*)K_shared)[((((k + 1) & 1) * 24576) + 12288)])), 64, ((k * 192) + 192), ((int)blockIdx.y), 0);
        pipeline_mbar[((((k + 1) & 1) * 2) + 1)].arrive_and_expect_tx(49152);
        tl::tma_load(V_desc, pipeline_mbar[((((k + 1) & 1) * 2) + 1)], (&(((half_t*)V_shared)[(((k + 1) & 1) * 24576)])), 0, ((k * 192) + 192), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, pipeline_mbar[((((k + 1) & 1) * 2) + 1)], (&(((half_t*)V_shared)[((((k + 1) & 1) * 24576) + 12288)])), 64, ((k * 192) + 192), ((int)blockIdx.y), 0);
      }
