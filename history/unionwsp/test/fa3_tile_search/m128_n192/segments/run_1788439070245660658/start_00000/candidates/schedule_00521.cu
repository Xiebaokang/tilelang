...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(const half_t* __restrict__ K, half_t* __restrict__ Output, const half_t* __restrict__ Q, __grid_constant__ const CUtensorMap V_desc) {
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int k = 0; k < 41; ++k) {
      if (tl::tl_shuffle_elect<256>()) {
        pipeline_mbar[(k % 3)].arrive_and_expect_tx(49152);
        tl::tma_load(V_desc, pipeline_mbar[(k % 3)], (&(((half_t*)V_shared)[0])), 0, (k * 192), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, pipeline_mbar[(k % 3)], (&(((half_t*)V_shared)[12288])), 64, (k * 192), ((int)blockIdx.y), 0);
      }
    ...
    if (tl::tl_shuffle_elect<256>()) {
      ...
      tl::tma_load(V_desc, pipeline_mbar[2], (&(((half_t*)V_shared)[0])), 0, 7872, ((int)blockIdx.y), 0);
      tl::tma_load(V_desc, pipeline_mbar[2], (&(((half_t*)V_shared)[12288])), 64, 7872, ((int)blockIdx.y), 0);
    }
    pipeline_mbar[2].wait(1);
    {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
    ...
    if (tl::tl_shuffle_elect<256>()) {
      ...
      tl::tma_load(V_desc, pipeline_mbar[0], (&(((half_t*)V_shared)[0])), 0, 8064, ((int)blockIdx.y), 0);
      tl::tma_load(V_desc, pipeline_mbar[0], (&(((half_t*)V_shared)[12288])), 64, 8064, ((int)blockIdx.y), 0);
    }
    ...
    for (int k_1 = 0; k_1 < 43; ++k_1) {
      ...
      for (int i_31 = 0; i_31 < 24; ++i_31) {
        ...
        uint4 condval_1;
        if ((((k_1 * 4) + ((i_31 + 2) / 6)) < 171)) {
          condval_1 = *(uint4*)(K + (((((((int)blockIdx.y) * 1048576) + (k_1 * 24576)) + (i_31 * 1024)) + (((int)threadIdx.x) * 8)) - 2048));
        } else {
        ...
        *(uint4*)(((half_t*)K_shared) + ((((((((k_1 & 1) * 24576) + (((((int)threadIdx.x) & 15) >> 3) * 12288)) + (i_31 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = condval_1;
      }
      tl::fence_proxy_async();
