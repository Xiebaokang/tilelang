    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    ...
    for (int k = 0; k < 41; ++k) {
      if (tl::tl_shuffle_elect<256>()) {
        ...
        tl::tma_load(K_desc, pipeline_mbar[((k + 1) % 3)], (&(((half_t*)K_shared)[(((k + 1) & 1) * 24576)])), 0, ((k * 192) + 192), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, pipeline_mbar[((k + 1) % 3)], (&(((half_t*)K_shared)[((((k + 1) & 1) * 24576) + 12288)])), 64, ((k * 192) + 192), ((int)blockIdx.y), 0);
      }
