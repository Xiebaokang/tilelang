...
extern "C" __global__ void __launch_bounds__(512, 1) main_kernel(const half_t* __restrict__ K, half_t* __restrict__ Output, const half_t* __restrict__ Q, const half_t* __restrict__ V) {
  extern __shared__ __align__(1024) uchar buf_dyn_shmem[];
  void* Q_shared = ((void*)((char*)buf_dyn_shmem + 0));
  void* K_shared = ((void*)((char*)buf_dyn_shmem + 32768));
  void* V_shared = ((void*)((char*)buf_dyn_shmem + 131072));
  void* O_shared = ((void*)((char*)buf_dyn_shmem + 180224));
  __shared__ __align__(16) uint64_t program_schedule_mbar_mem[8];
  ...
  if (tl::tl_shuffle_elect<0>()) {
    ...
    program_schedule_mbar[4].init(256);
    program_schedule_mbar[5].init(256);
    program_schedule_mbar[6].init(256);
    program_schedule_mbar[7].init(256);
  }
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
    ...
    program_schedule_mbar[1].wait(0);
    {
      ...
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 192);
      tl::warpgroup_arrive();
      #pragma unroll
      for (int warp_j = 0; warp_j < 3; ++warp_j) {
        #pragma unroll
        for (int ki = 0; ki < 8; ++ki) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, false, 1, 1>(uint64_t(desc_a + (((((ki >> 2) * 16384) + ((((int)threadIdx.x) >> 7) * 8192)) + ((ki & 3) * 32)) >> 4)), uint64_t(desc_b + (((((ki >> 2) * 24576) + (warp_j * 8192)) + ((ki & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + (warp_j * 32))), 1);
        }
      }
    ...
    program_schedule_mbar[5].arrive();
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int i_2 = 0; i_2 < 2; ++i_2) {
      ...
      for (int rv = 0; rv < 48; ++rv) {
        scores_max_clear[i_2] = max(scores_max_clear[i_2], acc_s[((((rv % 24) * 4) + (i_2 * 2)) + (rv / 24))]);
      }
    ...
    for (int i_7 = 0; i_7 < 2; ++i_7) {
      ...
      for (int rv_1 = 0; rv_1 < 48; ++rv_1) {
        scores_sum[i_7] = (scores_sum[i_7] + acc_s[((((rv_1 % 24) * 4) + (i_7 * 2)) + (rv_1 / 24))]);
      }
    ...
    for (int k = 0; k < 41; ++k) {
      program_schedule_mbar[3].wait((k & 1));
      {
      ...
      program_schedule_mbar[7].arrive();
      *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
      #pragma unroll
      for (int i_10 = 0; i_10 < 96; ++i_10) {
        acc_s[i_10] = 0x0p+0f/*0.000000e+00*/;
      }
      program_schedule_mbar[(((k + 1) & 1) + 1)].wait((((k + 1) & 3) >> 1));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_2, (((k + 1) & 1) * 49152));
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 192);
        tl::warpgroup_arrive();
        #pragma unroll
        for (int warp_j_1 = 0; warp_j_1 < 3; ++warp_j_1) {
          ...
          for (int ki_2 = 0; ki_2 < 8; ++ki_2) {
            tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, false, 1, 1>(uint64_t(desc_a_1 + (((((ki_2 >> 2) * 16384) + ((((int)threadIdx.x) >> 7) * 8192)) + ((ki_2 & 3) * 32)) >> 4)), uint64_t(desc_b_2 + (((((ki_2 >> 2) * 24576) + (warp_j_1 * 8192)) + ((ki_2 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + (warp_j_1 * 32))), 1);
          }
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
      ...
      program_schedule_mbar[(((k + 1) & 1) + 5)].arrive();
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
      ...
      for (int i_11 = 0; i_11 < 2; ++i_11) {
        ...
        for (int rv_2 = 0; rv_2 < 48; ++rv_2) {
          scores_max_clear_1[i_11] = max(scores_max_clear_1[i_11], acc_s[((((rv_2 % 24) * 4) + (i_11 * 2)) + (rv_2 / 24))]);
        }
      ...
      for (int i_16 = 0; i_16 < 2; ++i_16) {
        ...
        for (int rv_3 = 0; rv_3 < 48; ++rv_3) {
          scores_sum[i_16] = (scores_sum[i_16] + acc_s[((((rv_3 % 24) * 4) + (i_16 * 2)) + (rv_3 / 24))]);
        }
    ...
    program_schedule_mbar[3].wait(1);
    {
    ...
    program_schedule_mbar[1].wait(1);
    {
      ...
      for (int warp_j_2 = 0; warp_j_2 < 3; ++warp_j_2) {
        ...
        for (int ki_4 = 0; ki_4 < 8; ++ki_4) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, false, 1, 1>(uint64_t(desc_a_2 + (((((ki_4 >> 2) * 16384) + ((((int)threadIdx.x) >> 7) * 8192)) + ((ki_4 & 3) * 32)) >> 4)), uint64_t(desc_b_4 + (((((ki_4 >> 2) * 24576) + (warp_j_2 * 8192)) + ((ki_4 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + (warp_j_2 * 32))), 1);
        }
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
    ...
    for (int i_20 = 0; i_20 < 2; ++i_20) {
      ...
      for (int rv_4 = 0; rv_4 < 48; ++rv_4) {
        scores_max_clear_2[i_20] = max(scores_max_clear_2[i_20], acc_s[((((rv_4 % 24) * 4) + (i_20 * 2)) + (rv_4 / 24))]);
      }
      scores_max_clear_2[i_20] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_20]);
    ...
    for (int i_25 = 0; i_25 < 2; ++i_25) {
      ...
      for (int rv_5 = 0; rv_5 < 48; ++rv_5) {
        scores_sum[i_25] = (scores_sum[i_25] + acc_s[((((rv_5 % 24) * 4) + (i_25 * 2)) + (rv_5 / 24))]);
      }
    ...
    if (((int)threadIdx.x) < 384) {
      ...
      for (int i_30 = 0; i_30 < 16; ++i_30) {
        *(uint4*)(((half_t*)Q_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 8192) + (i_30 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(Q + (((((((int)blockIdx.y) * 1048576) + (((int)blockIdx.x) * 16384)) + (i_30 * 1024)) + (((int)threadIdx.x) * 8)) - 2048));
      }
      tl::fence_proxy_async();
      program_schedule_mbar[0].arrive();
      #pragma unroll
      for (int i_31 = 0; i_31 < 24; ++i_31) {
        *(uint4*)(((half_t*)K_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 12288) + (i_31 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(K + ((((((int)blockIdx.y) * 1048576) + (i_31 * 1024)) + (((int)threadIdx.x) * 8)) - 2048));
      }
      tl::fence_proxy_async();
      program_schedule_mbar[1].arrive();
      #pragma unroll
      for (int i_32 = 0; i_32 < 24; ++i_32) {
        *(uint4*)(((half_t*)K_shared) + (((((((((((int)threadIdx.x) & 15) >> 3) * 12288) + (i_32 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 24576)) = *(uint4*)(K + ((((((int)blockIdx.y) * 1048576) + (i_32 * 1024)) + (((int)threadIdx.x) * 8)) + 22528));
      }
      tl::fence_proxy_async();
      program_schedule_mbar[2].arrive();
      tl::__sync_thread_partial(3, 128);
      for (int k_1 = 0; k_1 < 41; ++k_1) {
        program_schedule_mbar[((k_1 & 1) + 5)].wait(((k_1 & 3) >> 1));
        #pragma unroll
        for (int i_33 = 0; i_33 < 24; ++i_33) {
          half_t broadcast_var_6 = half_t(0x0p+0f/*0.000000e+00*/);
          uint4 condval_1;
          if ((((k_1 * 4) + ((i_33 + 2) / 6)) < 163)) {
            condval_1 = *(uint4*)(K + (((((((int)blockIdx.y) * 1048576) + (k_1 * 24576)) + (i_33 * 1024)) + (((int)threadIdx.x) * 8)) + 47104));
          } else {
          ...
          *(uint4*)(((half_t*)K_shared) + ((((((((k_1 & 1) * 24576) + (((((int)threadIdx.x) & 15) >> 3) * 12288)) + (i_33 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = condval_1;
        }
        tl::fence_proxy_async();
        program_schedule_mbar[((k_1 & 1) + 1)].arrive();
        if (1 <= k_1) {
          program_schedule_mbar[7].wait(((k_1 + 1) & 1));
        }
        #pragma unroll
        for (int i_34 = 0; i_34 < 24; ++i_34) {
          *(uint4*)(((half_t*)V_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 12288) + (i_34 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(V + (((((((int)blockIdx.y) * 1048576) + (k_1 * 24576)) + (i_34 * 1024)) + (((int)threadIdx.x) * 8)) - 2048));
        }
        tl::fence_proxy_async();
        program_schedule_mbar[3].arrive();
      }
      program_schedule_mbar[7].wait(0);
      tl::__sync_thread_partial(3, 128);
      #pragma unroll
      for (int i_35 = 0; i_35 < 24; ++i_35) {
        *(uint4*)(((half_t*)V_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 12288) + (i_35 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(V + ((((((int)blockIdx.y) * 1048576) + (i_35 * 1024)) + (((int)threadIdx.x) * 8)) + 1005568));
      }
      tl::fence_proxy_async();
      program_schedule_mbar[3].arrive();
      program_schedule_mbar[7].wait(1);
      tl::__sync_thread_partial(3, 128);
      #pragma unroll
      for (int i_36 = 0; i_36 < 24; ++i_36) {
        half_t broadcast_var_7 = half_t(0x0p+0f/*0.000000e+00*/);
        uint4 condval_2;
        if ((i_36 < 16)) {
          condval_2 = *(uint4*)(V + ((((((int)blockIdx.y) * 1048576) + (i_36 * 1024)) + (((int)threadIdx.x) * 8)) + 1030144));
        } else {
        ...
        *(uint4*)(((half_t*)V_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 12288) + (i_36 * 512)) + (((((int)threadIdx.x) & 127) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = condval_2;
      }
      tl::fence_proxy_async();
      program_schedule_mbar[3].arrive();
    } else {
      tl::warpgroup_reg_dealloc<24>();
      program_schedule_mbar[4].wait(0);
