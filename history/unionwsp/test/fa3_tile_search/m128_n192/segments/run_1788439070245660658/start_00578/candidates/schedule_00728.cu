...
extern "C" __global__ void __launch_bounds__(512, 1) main_kernel(__grid_constant__ const CUtensorMap K_desc, half_t* __restrict__ Output, const half_t* __restrict__ Q, const half_t* __restrict__ V) {
    ...
    if (((int)threadIdx.x) < 384) {
      ...
      for (int k_1 = 0; k_1 < 43; ++k_1) {
        ...
        for (int i_31 = 0; i_31 < 24; ++i_31) {
          ...
          uint4 condval_1;
          if ((((k_1 * 24) + i_31) < 1024)) {
            condval_1 = *(uint4*)(V + (((((((int)blockIdx.y) * 1048576) + (k_1 * 24576)) + (i_31 * 1024)) + (((int)threadIdx.x) * 8)) - 3072));
          } else {
