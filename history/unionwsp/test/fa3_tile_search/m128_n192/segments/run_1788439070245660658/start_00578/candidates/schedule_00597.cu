...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(const half_t* __restrict__ K, half_t* __restrict__ Output, const half_t* __restrict__ Q, __grid_constant__ const CUtensorMap V_desc) {
  ...
  __shared__ __align__(16) uint64_t program_schedule_mbar_mem[3];
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    ...
    if (tl::tl_shuffle_elect<256>()) {
      ...
      tl::tma_load(V_desc, pipeline_mbar[1], (&(((half_t*)V_shared)[24576])), 0, 192, ((int)blockIdx.y), 0);
      tl::tma_load(V_desc, pipeline_mbar[1], (&(((half_t*)V_shared)[36864])), 64, 192, ((int)blockIdx.y), 0);
    }
    tl::__sync_thread_partial(3, 256);
    for (int k = 0; k < 41; ++k) {
      if (tl::tl_shuffle_elect<256>()) {
        pipeline_mbar[((k + 2) % 3)].arrive_and_expect_tx(49152);
        tl::tma_load(V_desc, pipeline_mbar[((k + 2) % 3)], (&(((half_t*)V_shared)[(((k + 2) % 3) * 24576)])), 0, ((k * 192) + 384), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, pipeline_mbar[((k + 2) % 3)], (&(((half_t*)V_shared)[((((k + 2) % 3) * 24576) + 12288)])), 64, ((k * 192) + 384), ((int)blockIdx.y), 0);
      }
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
    ...
    for (int k_1 = 0; k_1 < 43; ++k_1) {
      if (1 <= k_1) {
        program_schedule_mbar[2].wait(((k_1 + 1) & 1));
      }
      #pragma unroll
