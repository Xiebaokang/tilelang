  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    ...
    if (tl::tl_shuffle_elect<256>()) {
      ...
      tl::tma_load(V_desc, pipeline_mbar[0], (&(((half_t*)V_shared)[12288])), 64, 0, ((int)blockIdx.y), 0);
    }
    tl::__sync_thread_partial(3, 256);
    for (int k = 0; k < 41; ++k) {
      if (tl::tl_shuffle_elect<256>()) {
        pipeline_mbar[((k + 1) % 3)].arrive_and_expect_tx(49152);
        tl::tma_load(V_desc, pipeline_mbar[((k + 1) % 3)], (&(((half_t*)V_shared)[(((k + 1) & 1) * 24576)])), 0, ((k * 192) + 192), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, pipeline_mbar[((k + 1) % 3)], (&(((half_t*)V_shared)[((((k + 1) & 1) * 24576) + 12288)])), 64, ((k * 192) + 192), ((int)blockIdx.y), 0);
      }
      *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
      ...
      program_schedule_mbar[((k & 1) + 1)].wait(((k & 3) >> 1));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b, ((k & 1) * 49152));
    ...
    *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
    ...
    program_schedule_mbar[2].wait(0);
    {
      ...
      tl::increase_descriptor_offset<int>(desc_b_2, 49152);
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 192);
      tl::warpgroup_arrive();
      #pragma unroll
