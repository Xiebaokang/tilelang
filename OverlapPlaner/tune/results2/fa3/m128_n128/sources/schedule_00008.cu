  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int k = 0; k < 63; ++k) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[(((k + 1) & 1) + 2)].arrive_and_expect_tx(32768);
        tl::tma_load(V_desc, overlap_plan_mbar[(((k + 1) & 1) + 2)], (&(((half_t*)V_shared)[(((k + 1) & 1) * 16384)])), 0, ((k * 128) + 128), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[(((k + 1) & 1) + 2)], (&(((half_t*)V_shared)[((((k + 1) & 1) * 16384) + 8192)])), 64, ((k * 128) + 128), ((int)blockIdx.y), 0);
      }
      #pragma unroll
