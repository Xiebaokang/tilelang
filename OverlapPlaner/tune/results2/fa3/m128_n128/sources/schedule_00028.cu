...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap K_desc, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc) {
  ...
  void* K_shared = ((void*)((char*)buf_dyn_shmem + 98304));
  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
  ...
  overlap_plan_mbar[1].wait(1);
  {
    ...
    for (int ki_1 = 0; ki_1 < 8; ++ki_1) {
      tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 128, 16, false, false, 1, 1>(uint64_t(desc_a_1 + (((((ki_1 >> 2) * 16384) + ((((int)threadIdx.x) >> 7) * 8192)) + ((ki_1 & 3) * 32)) >> 4)), uint64_t(desc_b_1 + ((((ki_1 >> 2) * 16384) + ((ki_1 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + 0)), 1);
    }
    tl::warpgroup_commit_batch();
    tl::warpgroup_wait<0>();
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 128);
  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
  ...
  for (int i_10 = 0; i_10 < 2; ++i_10) {
    ...
    scores_max_clear_1[i_10] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_10]);
  ...
  for (int k = 0; k < 20; ++k) {
    ...
    overlap_plan_mbar[1].wait((k & 1));
    {
      ...
      for (int ki_2 = 0; ki_2 < 8; ++ki_2) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 128, 16, false, false, 1, 1>(uint64_t(desc_a_2 + (((((ki_2 >> 2) * 16384) + ((((int)threadIdx.x) >> 7) * 8192)) + ((ki_2 & 3) * 32)) >> 4)), uint64_t(desc_b_2 + ((((ki_2 >> 2) * 16384) + ((ki_2 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 128);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
    ...
    for (int i_18 = 0; i_18 < 2; ++i_18) {
      ...
      scores_max_clear_2[i_18] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_18]);
    ...
    if (1 <= k) {
      overlap_plan_mbar[((((k * 3) + 1) & 1) + 5)].wait(((((k * 3) + 3) & 3) >> 1));
    }
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
    ...
    overlap_plan_mbar[1].wait((((k * 3) + 1) & 1));
    {
      ...
      for (int ki_4 = 0; ki_4 < 8; ++ki_4) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 128, 16, false, false, 1, 1>(uint64_t(desc_a_3 + (((((ki_4 >> 2) * 16384) + ((((int)threadIdx.x) >> 7) * 8192)) + ((ki_4 & 3) * 32)) >> 4)), uint64_t(desc_b_4 + ((((ki_4 >> 2) * 16384) + ((ki_4 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 128);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
    ...
    for (int i_27 = 0; i_27 < 2; ++i_27) {
      ...
      scores_max_clear_3[i_27] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_max_clear_3[i_27]);
    ...
    overlap_plan_mbar[1].wait((k & 1));
    {
      ...
      for (int ki_6 = 0; ki_6 < 8; ++ki_6) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 128, 16, false, false, 1, 1>(uint64_t(desc_a_4 + (((((ki_6 >> 2) * 16384) + ((((int)threadIdx.x) >> 7) * 8192)) + ((ki_6 & 3) * 32)) >> 4)), uint64_t(desc_b_6 + ((((ki_6 >> 2) * 16384) + ((ki_6 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 128);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_7, broadcast_var_7);
    ...
    for (int i_36 = 0; i_36 < 2; ++i_36) {
      ...
      scores_max_clear_4[i_36] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_max_clear_4[i_36]);
  ...
  overlap_plan_mbar[1].wait(0);
  {
    ...
    for (int ki_8 = 0; ki_8 < 8; ++ki_8) {
      tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 128, 16, false, false, 1, 1>(uint64_t(desc_a_5 + (((((ki_8 >> 2) * 16384) + ((((int)threadIdx.x) >> 7) * 8192)) + ((ki_8 & 3) * 32)) >> 4)), uint64_t(desc_b_8 + ((((ki_8 >> 2) * 16384) + ((ki_8 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + 0)), 1);
    }
    tl::warpgroup_commit_batch();
    tl::warpgroup_wait<0>();
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 128);
  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_8, broadcast_var_8);
  ...
  for (int i_45 = 0; i_45 < 2; ++i_45) {
    ...
    scores_max_clear_5[i_45] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_max_clear_5[i_45]);
  ...
  for (int i_49 = 0; i_49 < 2; ++i_49) {
    ...
    scores_sum[i_49] = tl::AllReduce<tl::SumOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_sum[i_49]);
  }
  #pragma unroll
  ...
  overlap_plan_mbar[1].wait(1);
  {
    ...
    for (int ki_10 = 0; ki_10 < 8; ++ki_10) {
      tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 128, 16, false, false, 1, 1>(uint64_t(desc_a_6 + (((((ki_10 >> 2) * 16384) + ((((int)threadIdx.x) >> 7) * 8192)) + ((ki_10 & 3) * 32)) >> 4)), uint64_t(desc_b_10 + ((((ki_10 >> 2) * 16384) + ((ki_10 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + 0)), 1);
    }
    tl::warpgroup_commit_batch();
    tl::warpgroup_wait<0>();
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 128);
  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_9, broadcast_var_9);
  ...
  for (int i_54 = 0; i_54 < 2; ++i_54) {
    ...
    scores_max_clear_6[i_54] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_max_clear_6[i_54]);
  ...
  for (int i_58 = 0; i_58 < 2; ++i_58) {
    ...
    scores_sum[i_58] = tl::AllReduce<tl::SumOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_sum[i_58]);
  }
  #pragma unroll
