  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(V_desc, overlap_plan_mbar[3], (&(((half_t*)V_shared)[0])), 0, 0, ((int)blockIdx.y), 0);
      tl::tma_load(V_desc, overlap_plan_mbar[3], (&(((half_t*)V_shared)[8192])), 64, 0, ((int)blockIdx.y), 0);
      overlap_plan_mbar[2].arrive_and_expect_tx(32768);
      tl::tma_load(K_desc, overlap_plan_mbar[2], (&(((half_t*)K_shared)[16384])), 0, 128, ((int)blockIdx.y), 0);
      tl::tma_load(K_desc, overlap_plan_mbar[2], (&(((half_t*)K_shared)[24576])), 64, 128, ((int)blockIdx.y), 0);
      overlap_plan_mbar[4].arrive_and_expect_tx(32768);
      tl::tma_load(V_desc, overlap_plan_mbar[4], (&(((half_t*)V_shared)[16384])), 0, 128, ((int)blockIdx.y), 0);
      tl::tma_load(V_desc, overlap_plan_mbar[4], (&(((half_t*)V_shared)[24576])), 64, 128, ((int)blockIdx.y), 0);
    }
    #pragma unroll
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int k = 0; k < 62; ++k) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(K_desc, overlap_plan_mbar[((k & 1) + 1)], (&(((half_t*)K_shared)[((k & 1) * 16384)])), 0, ((k * 128) + 256), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[((k & 1) + 1)], (&(((half_t*)K_shared)[(((k & 1) * 16384) + 8192)])), 64, ((k * 128) + 256), ((int)blockIdx.y), 0);
      }
      if (1 <= k) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(V_desc, overlap_plan_mbar[(((k + 2) % 3) + 3)], (&(((half_t*)V_shared)[(((k + 2) % 3) * 16384)])), 0, ((k * 128) + 256), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[(((k + 2) % 3) + 3)], (&(((half_t*)V_shared)[((((k + 2) % 3) * 16384) + 8192)])), 64, ((k * 128) + 256), ((int)blockIdx.y), 0);
      }
      #pragma unroll
    ...
    overlap_plan_mbar[5].wait(0);
    {
      ...
      tl::increase_descriptor_offset<int>(desc_b_4, 65536);
      tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(acc_s_cast + 0), 32);
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_o + 0), 128);
      tl::warpgroup_arrive();
      tl::__sync_thread_partial(3, 256);
