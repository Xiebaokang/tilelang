  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int k = 0; k < 128; ++k) {
      ...
      if (tl::tl_shuffle_elect<128>()) {
        ...
        tl::tma_load(K_desc, mbarrier[(k & 1)], (&(((half_t*)K_shared)[((k & 1) * 8192)])), 0, (k * 64), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, mbarrier[(k & 1)], (&(((half_t*)K_shared)[(((k & 1) * 8192) + 4096)])), 64, (k * 64), ((int)blockIdx.y), 0);
      }
      mbarrier[((k & 1) + 6)].wait((((k & 3) >> 1) ^ 1));
      if (tl::tl_shuffle_elect<128>()) {
        mbarrier[((k & 1) + 2)].arrive_and_expect_tx(16384);
        tl::tma_load(V_desc, mbarrier[((k & 1) + 2)], (&(((half_t*)V_shared)[((k & 1) * 8192)])), 0, (k * 64), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, mbarrier[((k & 1) + 2)], (&(((half_t*)V_shared)[(((k & 1) * 8192) + 4096)])), 64, (k * 64), ((int)blockIdx.y), 0);
      }
    }
  } else {
