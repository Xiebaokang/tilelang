    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    for (int k_1 = 0; k_1 < 64; ++k_1) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 8)) {
        ...
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[0])), 0, (k_1 * 128), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[4096])), 64, (k_1 * 128), ((int)blockIdx.y), 0);
      }
      if (1 <= k_1) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 8)) {
        ...
        tl::tma_load(V_desc, overlap_plan_mbar[8], (&(((half_t*)V_shared)[0])), 0, (k_1 * 128), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[8], (&(((half_t*)V_shared)[4096])), 64, (k_1 * 128), ((int)blockIdx.y), 0);
      }
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 8)) {
        ...
        tl::tma_load(K_desc, overlap_plan_mbar[2], (&(((half_t*)K_shared)[8192])), 0, ((k_1 * 128) + 64), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[2], (&(((half_t*)K_shared)[12288])), 64, ((k_1 * 128) + 64), ((int)blockIdx.y), 0);
      }
      if (1 <= k_1) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 8)) {
        ...
        tl::tma_load(V_desc, overlap_plan_mbar[9], (&(((half_t*)V_shared)[8192])), 0, ((k_1 * 128) + 64), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[9], (&(((half_t*)V_shared)[12288])), 64, ((k_1 * 128) + 64), ((int)blockIdx.y), 0);
      }
      *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
