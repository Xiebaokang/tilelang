    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
    ...
    for (int k = 0; k < 63; ++k) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(V_desc, overlap_plan_mbar[((((k * 2) + 2) % 3) + 2)], (&(((half_t*)V_shared)[((((k * 2) + 2) % 3) * 8192)])), 0, ((k * 128) + 128), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[((((k * 2) + 2) % 3) + 2)], (&(((half_t*)V_shared)[(((((k * 2) + 2) % 3) * 8192) + 4096)])), 64, ((k * 128) + 128), ((int)blockIdx.y), 0);
      }
      #pragma unroll
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[1].arrive_and_expect_tx(16384);
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[0])), 0, ((k * 128) + 192), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[4096])), 64, ((k * 128) + 192), ((int)blockIdx.y), 0);
      }
      overlap_plan_mbar[(((k * 2) % 3) + 7)].wait((((k % 3) * 2) / 3));
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[(((k * 2) % 3) + 2)].arrive_and_expect_tx(16384);
        tl::tma_load(V_desc, overlap_plan_mbar[(((k * 2) % 3) + 2)], (&(((half_t*)V_shared)[(((k * 2) % 3) * 8192)])), 0, ((k * 128) + 192), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[(((k * 2) % 3) + 2)], (&(((half_t*)V_shared)[((((k * 2) % 3) * 8192) + 4096)])), 64, ((k * 128) + 192), ((int)blockIdx.y), 0);
      }
      #pragma unroll
