    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    for (int k = 0; k < 128; ++k) {
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
      ...
      overlap_plan_mbar[((k % 3) + 11)].arrive();
      #pragma unroll
    ...
    for (int k_1 = 0; k_1 < 128; ++k_1) {
      ...
      if (3 <= k_1) {
        overlap_plan_mbar[((k_1 % 3) + 11)].wait((((k_1 / 3) + 1) & 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 8)) {
        overlap_plan_mbar[((k_1 % 3) + 4)].arrive_and_expect_tx(16384);
        tl::tma_load(V_desc, overlap_plan_mbar[((k_1 % 3) + 4)], (&(((half_t*)V_shared)[((k_1 % 3) * 8192)])), 0, (k_1 * 64), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[((k_1 % 3) + 4)], (&(((half_t*)V_shared)[(((k_1 % 3) * 8192) + 4096)])), 64, (k_1 * 64), ((int)blockIdx.y), 0);
      }
    }
