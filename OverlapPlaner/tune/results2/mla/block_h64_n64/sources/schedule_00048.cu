  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int k = 0; k < 63; ++k) {
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
      ...
      for (int i_11 = 0; i_11 < 2; ++i_11) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)S_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + i_11) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_s_v1[(i_11 * 8)]), ((half_t)acc_s_v1[((i_11 * 8) + 1)])), __pack_half2(((half_t)acc_s_v1[((i_11 * 8) + 2)]), ((half_t)acc_s_v1[((i_11 * 8) + 3)])), __pack_half2(((half_t)acc_s_v1[((i_11 * 8) + 4)]), ((half_t)acc_s_v1[((i_11 * 8) + 5)])), __pack_half2(((half_t)acc_s_v1[((i_11 * 8) + 6)]), ((half_t)acc_s_v1[((i_11 * 8) + 7)])));
      }
      #pragma unroll
      ...
      for (int i_13 = 0; i_13 < 2; ++i_13) {
        ...
        for (int rv_2 = 0; rv_2 < 8; ++rv_2) {
          scores_sum[i_13] = (scores_sum[i_13] + acc_s_v0[((((rv_2 & 3) * 4) + (i_13 * 2)) + (rv_2 >> 2))]);
        }
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_13] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_13], (&(((float*)workspace_7)[0])));
        scores_sum[i_13] = tl::AllReduce<tl::SumOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_sum[i_13]);
      }
      #pragma unroll
      for (int i_14 = 0; i_14 < 2; ++i_14) {
        logsum[i_14] = ((logsum[i_14] * scores_scale_v0[i_14]) + scores_sum[i_14]);
      }
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
      ...
      for (int i_15 = 0; i_15 < 2; ++i_15) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_2[i_15] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_15], (&(((float*)workspace_5)[0])));
      ...
      for (int i_19 = 0; i_19 < 2; ++i_19) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)S_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + i_19) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_s_v0[(i_19 * 8)]), ((half_t)acc_s_v0[((i_19 * 8) + 1)])), __pack_half2(((half_t)acc_s_v0[((i_19 * 8) + 2)]), ((half_t)acc_s_v0[((i_19 * 8) + 3)])), __pack_half2(((half_t)acc_s_v0[((i_19 * 8) + 4)]), ((half_t)acc_s_v0[((i_19 * 8) + 5)])), __pack_half2(((half_t)acc_s_v0[((i_19 * 8) + 6)]), ((half_t)acc_s_v0[((i_19 * 8) + 7)])));
      }
      #pragma unroll
      ...
      for (int i_21 = 0; i_21 < 2; ++i_21) {
        ...
        for (int rv_4 = 0; rv_4 < 8; ++rv_4) {
          scores_sum[i_21] = (scores_sum[i_21] + acc_s_v1[((((rv_4 & 3) * 4) + (i_21 * 2)) + (rv_4 >> 2))]);
        }
        tl::__sync_thread_partial(3, 256);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
    ...
    for (int i_23 = 0; i_23 < 2; ++i_23) {
      ...
      tl::__sync_thread_partial(3, 256);
      scores_max_clear_3[i_23] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_3[i_23], (&(((float*)workspace_4)[0])));
    ...
    for (int i_27 = 0; i_27 < 2; ++i_27) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)S_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + i_27) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_s_v1[(i_27 * 8)]), ((half_t)acc_s_v1[((i_27 * 8) + 1)])), __pack_half2(((half_t)acc_s_v1[((i_27 * 8) + 2)]), ((half_t)acc_s_v1[((i_27 * 8) + 3)])), __pack_half2(((half_t)acc_s_v1[((i_27 * 8) + 4)]), ((half_t)acc_s_v1[((i_27 * 8) + 5)])), __pack_half2(((half_t)acc_s_v1[((i_27 * 8) + 6)]), ((half_t)acc_s_v1[((i_27 * 8) + 7)])));
    }
    #pragma unroll
    ...
    for (int i_29 = 0; i_29 < 2; ++i_29) {
      ...
      for (int rv_6 = 0; rv_6 < 8; ++rv_6) {
        scores_sum[i_29] = (scores_sum[i_29] + acc_s_v0[((((rv_6 & 3) * 4) + (i_29 * 2)) + (rv_6 >> 2))]);
      }
      tl::__sync_thread_partial(3, 256);
    ...
    for (int i_30 = 0; i_30 < 2; ++i_30) {
      logsum[i_30] = ((logsum[i_30] * scores_scale_v0[i_30]) + scores_sum[i_30]);
    }
    #pragma unroll
    for (int i_31 = 0; i_31 < 2; ++i_31) {
      ...
      tl::__sync_thread_partial(3, 256);
      scores_sum[i_31] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_31], (&(((float*)workspace_6)[0])));
