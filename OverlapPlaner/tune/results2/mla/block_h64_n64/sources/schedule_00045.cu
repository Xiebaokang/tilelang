...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap KV_desc, __grid_constant__ const CUtensorMap K_pe_desc, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap Q_pe_desc) {
  ...
  void* S_shared = ((void*)((char*)buf_dyn_shmem + 163840));
  void* workspace = ((void*)((char*)buf_dyn_shmem + 172032));
  void* workspace_1 = ((void*)((char*)buf_dyn_shmem + 172032));
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    for (int k = 0; k < 128; ++k) {
      ...
      overlap_plan_mbar[((k % 3) + 3)].wait(((k % 6) / 3));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_1, ((k % 3) * 8192));
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 16);
        tl::warpgroup_arrive();
        #pragma unroll
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
      ...
      for (int i_5 = 0; i_5 < 2; ++i_5) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)S_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + i_5) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_s[(i_5 * 8)]), ((half_t)acc_s[((i_5 * 8) + 1)])), __pack_half2(((half_t)acc_s[((i_5 * 8) + 2)]), ((half_t)acc_s[((i_5 * 8) + 3)])), __pack_half2(((half_t)acc_s[((i_5 * 8) + 4)]), ((half_t)acc_s[((i_5 * 8) + 5)])), __pack_half2(((half_t)acc_s[((i_5 * 8) + 6)]), ((half_t)acc_s[((i_5 * 8) + 7)])));
      }
      #pragma unroll
      ...
      for (int i_7 = 0; i_7 < 2; ++i_7) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_7] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_7], (&(((float*)workspace_1)[0])));
    ...
    for (int k_1 = 0; k_1 < 128; ++k_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 8)) {
        overlap_plan_mbar[((k_1 % 3) + 3)].arrive_and_expect_tx(8192);
        tl::tma_load(K_pe_desc, overlap_plan_mbar[((k_1 % 3) + 3)], (&(((half_t*)K_pe_shared)[((k_1 % 3) * 4096)])), 0, (k_1 * 64), 0, 0);
      }
    }
  }
}
