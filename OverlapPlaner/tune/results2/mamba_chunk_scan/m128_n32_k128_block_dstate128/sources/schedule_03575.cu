...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* da_k_shared = ((void*)((char*)buf_dyn_shmem + 100352));
    ...
    overlap_plan_mbar[7].wait(0);
    {
      ...
      for (int i_13 = 0; i_13 < 2; ++i_13) {
        ...
        for (int ki_1 = 0; ki_1 < 8; ++ki_1) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v0 + ((ki_1 * 16) + (i_13 * 8))), uint64_t(desc_b_1 + ((ki_1 * 1024) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_13 * 16)), 1);
        }
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
  ...
  for (int i_14 = 0; i_14 < 16; ++i_14) {
    ...
    *(uint1*)(dt_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)dt_shared) + ((((((int)blockIdx.y) >> 1) * 128) + (i_14 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    float2 __19;
  ...
  if ((((int)blockIdx.y) >> 1) == 0) {
    ...
    for (int i_15 = 0; i_15 < 64; ++i_15) {
      ...
      float2 __21;
        float2 __22;
        uint1 v__14 = *(uint1*)(cb_local_v0 + (i_15 * 2));
  ...
  if ((((int)blockIdx.y) >> 1) == 0) {
    ...
    for (int i_17 = 0; i_17 < 128; ++i_17) {
      half_t condval;
      if (((((((i_17 >> 4) * 16) + (((i_17 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_17 & 1)) <= ((((((i_17 & 15) >> 3) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_17 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
        condval = cb_local_v0[i_17];
      } else {
        condval = half_t(0x0p+0f/*0.000000e+00*/);
      }
      cb_local_v0[i_17] = condval;
    }
  } else {
    #pragma unroll
    for (int i_18 = 0; i_18 < 128; ++i_18) {
      ...
      if (((((((i_18 >> 4) * 16) + (((i_18 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_18 & 1)) <= ((((((i_18 & 15) >> 3) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_18 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
        condval_1 = cb_local_v1[i_18];
      } else {
        condval_1 = half_t(0x0p+0f/*0.000000e+00*/);
      }
      cb_local_v1[i_18] = condval_1;
    }
  }
  ...
  if ((((int)blockIdx.y) >> 1) == 0) {
    {
      ...
      for (int i_19 = 0; i_19 < 2; ++i_19) {
        ...
        for (int ki_2 = 0; ki_2 < 8; ++ki_2) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v0 + ((ki_2 * 16) + (i_19 * 8))), uint64_t(desc_b_2 + ((ki_2 * 1024) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_19 * 16)), 1);
        }
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
  ...
  } else {
    {
      ...
      for (int i_20 = 0; i_20 < 2; ++i_20) {
        ...
        for (int ki_3 = 0; ki_3 < 8; ++ki_3) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v1 + ((ki_3 * 16) + (i_20 * 8))), uint64_t(desc_b_3 + ((ki_3 * 1024) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_20 * 16)), 1);
        }
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
  ...
  for (int i_21 = 0; i_21 < 16; ++i_21) {
    ...
    *(uint1*)(residual_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)residual_shared) + ((((((((i_21 >> 3) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((i_21 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_21 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_21 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    float2 __26;
    uint1 v__18 = *(uint1*)(residual_shared_local_cast_4 + 0);
    ((float2*)(&__26))[0] = __half22float2(((half2*)(&v__18))[0]);
    *(float2*)(residual_local + (i_21 * 2)) = __26;
  }
  #pragma unroll
  ...
  for (int i_23 = 0; i_23 < 4; ++i_23) {
    tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((i_23 >> 1) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + (i_23 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(((half_t)acc[(i_23 * 8)]), ((half_t)acc[((i_23 * 8) + 1)])), __pack_half2(((half_t)acc[((i_23 * 8) + 2)]), ((half_t)acc[((i_23 * 8) + 3)])), __pack_half2(((half_t)acc[((i_23 * 8) + 4)]), ((half_t)acc[((i_23 * 8) + 5)])), __pack_half2(((half_t)acc[((i_23 * 8) + 6)]), ((half_t)acc[((i_23 * 8) + 7)])));
  }
