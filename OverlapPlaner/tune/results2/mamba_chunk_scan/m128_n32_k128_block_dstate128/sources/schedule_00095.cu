...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* dt_shared = ((void*)((char*)buf_dyn_shmem + 90112));
  ...
  for (int i_13 = 0; i_13 < 128; ++i_13) {
    half_t condval;
    if (((((((i_13 >> 4) * 16) + (((i_13 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_13 & 1)) <= ((((((((int)blockIdx.y) >> 1) * 128) + (((i_13 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_13 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
  ...
  if ((((int)blockIdx.y) >> 1) == 0) {
    ...
    for (int i_17 = 0; i_17 < 128; ++i_17) {
      ...
      if (((((((i_17 >> 4) * 16) + (((i_17 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_17 & 1)) <= ((((((i_17 & 15) >> 3) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_17 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
        condval_1 = cb_local_v0[i_17];
      } else {
        condval_1 = half_t(0x0p+0f/*0.000000e+00*/);
      }
      cb_local_v0[i_17] = condval_1;
    }
  } else {
    #pragma unroll
    for (int i_18 = 0; i_18 < 128; ++i_18) {
      ...
      if (((((((i_18 >> 4) * 16) + (((i_18 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_18 & 1)) <= ((((((i_18 & 15) >> 3) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_18 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
        condval_2 = cb_local_v1[i_18];
      } else {
        condval_2 = half_t(0x0p+0f/*0.000000e+00*/);
      }
      cb_local_v1[i_18] = condval_2;
    }
  }
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    ...
    overlap_plan_mbar[6].wait(0);
    {
      ...
      for (int i_19 = 0; i_19 < 2; ++i_19) {
        ...
        for (int ki_1 = 0; ki_1 < 8; ++ki_1) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v0 + ((ki_1 * 16) + (i_19 * 8))), uint64_t(desc_b_1 + ((ki_1 * 1024) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_19 * 16)), 1);
        }
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
  ...
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    ...
    tl::tma_load(X_desc, overlap_plan_mbar[8], (&(((half_t*)residual_shared)[0])), ((((int)blockIdx.y) & 1) * 32), (((((int)blockIdx.z) >> 3) * 256) + ((((int)blockIdx.y) >> 1) * 128)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
  }
  overlap_plan_mbar[8].wait(0);
  #pragma unroll
  for (int i_22 = 0; i_22 < 16; ++i_22) {
    half_t residual_shared_local_cast_4[2];
    *(uint1*)(residual_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)residual_shared) + ((((((((i_22 >> 3) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((i_22 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_22 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_22 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    float2 __26;
