...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* acc_wsp_handoff_2 = ((void*)((char*)buf_dyn_shmem + 32768));
  void* prev_shared = ((void*)((char*)buf_dyn_shmem + 49152));
  void* da_m_shared = ((void*)((char*)buf_dyn_shmem + 57344));
  void* cb_shared = ((void*)((char*)buf_dyn_shmem + 58368));
  void* x_shared = ((void*)((char*)buf_dyn_shmem + 91136));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int i_2 = 0; i_2 < 16; ++i_2) {
      *(float2*)(acc + (i_2 * 2)) = *(float2*)(((float*)acc_wsp_handoff_2) + (((((((i_2 >> 3) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((i_2 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + (((i_2 & 7) >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    }
    #pragma unroll
    for (int i_3 = 0; i_3 < 32; ++i_3) {
      acc[i_3] = (acc[i_3] * scale_m[(((i_3 >> 4) * 2) + ((i_3 & 3) >> 1))]);
    }
    tl::fence_proxy_async();
    for (int ik = 0; ik < ((((int)blockIdx.y) >> 1) + 1); ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(CB_desc, overlap_plan_mbar[3], (&(((half_t*)cb_shared)[0])), (ik * 128), ((((int)blockIdx.y) >> 1) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
        tl::tma_load(CB_desc, overlap_plan_mbar[3], (&(((half_t*)cb_shared)[8192])), ((ik * 128) + 64), ((((int)blockIdx.y) >> 1) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      }
      if (ik == 1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(X_desc, overlap_plan_mbar[6], (&(((half_t*)x_shared)[0])), ((((int)blockIdx.y) & 1) * 32), (((((int)blockIdx.z) >> 3) * 256) + (ik * 128)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
      ...
      for (int i_9 = 0; i_9 < 128; ++i_9) {
        half_t condval;
        if (((((((ik * 128) + ((i_9 >> 4) * 16)) + (((i_9 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_9 & 1)) <= ((((((((int)blockIdx.y) >> 1) * 128) + (((i_9 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_9 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
      ...
      overlap_plan_mbar[6].wait(ik);
      {
        ...
        for (int i_10 = 0; i_10 < 2; ++i_10) {
          ...
          for (int ki = 0; ki < 8; ++ki) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local + ((ki * 16) + (i_10 * 8))), uint64_t(desc_b + ((ki * 1024) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_10 * 16)), 1);
          }
        }
    ...
    for (int i_11 = 0; i_11 < 16; ++i_11) {
      ...
      *(uint1*)(residual_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)residual_shared) + ((((((((i_11 >> 3) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((i_11 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_11 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_11 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __12;
    ...
    for (int i_13 = 0; i_13 < 4; ++i_13) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((i_13 >> 1) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + (i_13 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(((half_t)acc[(i_13 * 8)]), ((half_t)acc[((i_13 * 8) + 1)])), __pack_half2(((half_t)acc[((i_13 * 8) + 2)]), ((half_t)acc[((i_13 * 8) + 3)])), __pack_half2(((half_t)acc[((i_13 * 8) + 4)]), ((half_t)acc[((i_13 * 8) + 5)])), __pack_half2(((half_t)acc[((i_13 * 8) + 6)]), ((half_t)acc[((i_13 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 128);
    ...
    overlap_plan_mbar[1].wait(0);
    {
      ...
      for (int i_15 = 0; i_15 < 2; ++i_15) {
        ...
        for (int ki_1 = 0; ki_1 < 8; ++ki_1) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a + (((((ki_1 >> 2) * 16384) + (i_15 * 8192)) + ((ki_1 & 3) * 32)) >> 4)), uint64_t(desc_b_1 + ((((ki_1 >> 2) * 4096) + ((ki_1 & 3) * 32)) >> 4)), ((uint32_t*)(acc + (i_15 * 16))), 1);
        }
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
    ...
    for (int i_16 = 0; i_16 < 16; ++i_16) {
      *(float2*)(((float*)acc_wsp_handoff_2) + ((((((((i_16 >> 3) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((i_16 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + (((i_16 & 7) >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 2048)) = *(float2*)(acc + (i_16 * 2));
    }
    tl::fence_proxy_async();
