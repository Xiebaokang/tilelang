...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* acc_wsp_handoff_2 = ((void*)((char*)buf_dyn_shmem + 0));
  void* c_shared = ((void*)((char*)buf_dyn_shmem + 32768));
  void* prev_shared = ((void*)((char*)buf_dyn_shmem + 65536));
  void* da_m_shared = ((void*)((char*)buf_dyn_shmem + 81920));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int i_2 = 0; i_2 < 32; ++i_2) {
      *(float2*)(acc + (i_2 * 2)) = *(float2*)(((float*)acc_wsp_handoff_2) + (((((((i_2 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_2 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((i_2 & 15) >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    }
    #pragma unroll
    ...
    for (int ik = 0; ik < (((int)blockIdx.y) + 1); ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(CB_desc, overlap_plan_mbar[3], (&(((half_t*)cb_shared)[0])), (ik * 128), (((int)blockIdx.y) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
        tl::tma_load(CB_desc, overlap_plan_mbar[3], (&(((half_t*)cb_shared)[8192])), ((ik * 128) + 64), (((int)blockIdx.y) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      }
      if (ik == 1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load((&(((half_t*)da_k_shared)[0])), (&(DA[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 128))])), overlap_plan_mbar[4], 256);
      }
      if (ik == 1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load((&(((half_t*)dt_shared)[0])), (&(Dt[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 128))])), overlap_plan_mbar[5], 256);
      }
      if (ik == 1) {
      ...
      for (int i_4 = 0; i_4 < 16; ++i_4) {
        tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[((((((i_4 >> 3) * 8192) + ((i_4 & 1) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((i_4 & 7) >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((i_4 & 3) >> 1) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(cb_local[(i_4 * 8)])));
      }
      ...
      for (int i_7 = 0; i_7 < 64; ++i_7) {
        ...
        float2 __4;
          ...
          float2 __7;
            float2 __8;
              float2 v__3 = make_float2(da_m_local[((((i_7 & 7) >> 2) * 2) + (i_7 & 1))], da_m_local[((((i_7 & 7) >> 2) * 2) + (i_7 & 1))]);
              float2 v__4 = *(float2*)(da_k_local + (((i_7 >> 3) * 4) + (((i_7 & 3) >> 1) * 2)));
              __8.x = (v__3.x-v__4.x);
              __8.y = (v__3.y-v__4.y);
      ...
      for (int i_8 = 0; i_8 < 64; ++i_8) {
        ...
        float2 __10;
          ...
          float2 v__7 = *(float2*)(dt_local + (((i_8 >> 3) * 4) + (((i_8 & 3) >> 1) * 2)));
      ...
      for (int i_9 = 0; i_9 < 128; ++i_9) {
        half_t condval;
        if (((((((ik * 128) + ((i_9 >> 4) * 16)) + (((i_9 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_9 & 1)) <= (((((((int)blockIdx.y) * 128) + (((i_9 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_9 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
      ...
      overlap_plan_mbar[6].wait(ik);
      {
        ...
        for (int i_10 = 0; i_10 < 2; ++i_10) {
          ...
          for (int ki = 0; ki < 8; ++ki) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local + ((ki * 16) + (i_10 * 8))), uint64_t(desc_b + ((ki * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_10 * 32)), 1);
          }
        }
    ...
    for (int i_11 = 0; i_11 < 32; ++i_11) {
      ...
      *(uint1*)(residual_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)residual_shared) + (((((((((i_11 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_11 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_11 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_11 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_11 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __12;
      uint1 v__8 = *(uint1*)(residual_shared_local_cast_2 + 0);
      ((float2*)(&__12))[0] = __half22float2(((half2*)(&v__8))[0]);
      *(float2*)(residual_local + (i_11 * 2)) = __12;
    }
    #pragma unroll
    ...
    for (int i_13 = 0; i_13 < 8; ++i_13) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((i_13 >> 2) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_13 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_13 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc[(i_13 * 8)]), ((half_t)acc[((i_13 * 8) + 1)])), __pack_half2(((half_t)acc[((i_13 * 8) + 2)]), ((half_t)acc[((i_13 * 8) + 3)])), __pack_half2(((half_t)acc[((i_13 * 8) + 4)]), ((half_t)acc[((i_13 * 8) + 5)])), __pack_half2(((half_t)acc[((i_13 * 8) + 6)]), ((half_t)acc[((i_13 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 128);
    ...
    tl::warpgroup_reg_dealloc<64>();
    #pragma unroll
    for (int i_14 = 0; i_14 < 16; ++i_14) {
      float broadcast_var_1 = 0x0p+0f/*0.000000e+00*/;
      *(float4*)(acc + (i_14 * 4)) = make_float4(broadcast_var_1, broadcast_var_1, broadcast_var_1, broadcast_var_1);
    }
    ...
    overlap_plan_mbar[1].wait(0);
    {
      ...
      for (int i_15 = 0; i_15 < 2; ++i_15) {
        ...
        for (int ki_1 = 0; ki_1 < 8; ++ki_1) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, false, 1, 1>(uint64_t(desc_a + (((((ki_1 >> 2) * 16384) + (i_15 * 8192)) + ((ki_1 & 3) * 32)) >> 4)), uint64_t(desc_b_1 + ((((ki_1 >> 2) * 8192) + ((ki_1 & 3) * 32)) >> 4)), ((uint32_t*)(acc + (i_15 * 32))), 1);
        }
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
    ...
    for (int i_16 = 0; i_16 < 32; ++i_16) {
      *(float2*)(((float*)acc_wsp_handoff_2) + ((((((((i_16 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_16 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((i_16 & 15) >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096)) = *(float2*)(acc + (i_16 * 2));
    }
    tl::fence_proxy_async();
