  ...
  if (((int)threadIdx.x) < 128) {
    ...
    if (0 < ((int)blockIdx.y)) {
      ...
      for (int i_11 = 0; i_11 < 64; ++i_11) {
        *(uint1*)(cb_local_v1 + (i_11 * 2)) = *(uint1*)(((half_t*)cb_shared) + ((((((((((((((i_11 >> 3) * 16) + (((i_11 & 3) >> 1) * 8)) >> 6) * 8192) + (((i_11 & 7) >> 2) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_11 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((((i_11 & 31) >> 3) * 16) + (((i_11 & 3) >> 1) * 8)) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_11 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_11 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 16384));
      }
      ...
      for (int i_12 = 0; i_12 < 16; ++i_12) {
        ...
        *(uint1*)(da_k_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)da_k_shared) + (((i_12 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 128));
        float2 __12;
      ...
      for (int i_13 = 0; i_13 < 16; ++i_13) {
        ...
        *(uint1*)(dt_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)dt_shared) + (((i_13 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 128));
        float2 __13;
      ...
      for (int i_16 = 0; i_16 < 128; ++i_16) {
        half_t condval_1;
        if ((((((((i_16 >> 4) * 16) + (((i_16 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_16 & 1)) + 128) <= (((((((int)blockIdx.y) * 128) + (((i_16 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_16 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    if (((int)blockIdx.y) == 1) {
      overlap_plan_mbar[(((int)blockIdx.y) + 9)].wait((((((int)blockIdx.y) + 3) & 3) >> 1));
      {
      ...
      overlap_plan_mbar[(((int)blockIdx.y) + 20)].arrive();
    }
    overlap_plan_mbar[(((int)blockIdx.y) + 10)].wait(0);
    if (((int)blockIdx.y) == 0) {
      {
    ...
    overlap_plan_mbar[(((int)blockIdx.y) + 21)].arrive();
    d_local[0] = ((float)D[((int)blockIdx.x)]);
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[12].arrive_and_expect_tx(16384);
      tl::tma_load(X_desc, overlap_plan_mbar[12], (&(((half_t*)residual_shared)[0])), 0, (((((int)blockIdx.z) >> 3) * 256) + (((int)blockIdx.y) * 128)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      ...
      overlap_plan_mbar[8].arrive_and_expect_tx(256);
      tl::tma_load((&(((half_t*)dt_shared)[0])), (&(Dt[((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256))])), overlap_plan_mbar[8], 256);
    }
    for (int ik = 0; ik < ((int)blockIdx.y); ++ik) {
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[(ik + 3)].arrive_and_expect_tx(32768);
        tl::tma_load(CB_desc, overlap_plan_mbar[(ik + 3)], (&(((half_t*)cb_shared)[((ik * 16384) + 16384)])), ((ik * 128) + 128), (((int)blockIdx.y) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
        tl::tma_load(CB_desc, overlap_plan_mbar[(ik + 3)], (&(((half_t*)cb_shared)[((ik * 16384) + 24576)])), ((ik * 128) + 192), (((int)blockIdx.y) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
        overlap_plan_mbar[(ik + 6)].arrive_and_expect_tx(256);
        tl::tma_load((&(((half_t*)da_k_shared)[((ik * 128) + 128)])), (&(DA[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 128)) + 128)])), overlap_plan_mbar[(ik + 6)], 256);
        overlap_plan_mbar[(ik + 9)].arrive_and_expect_tx(256);
        tl::tma_load((&(((half_t*)dt_shared)[((ik * 128) + 128)])), (&(Dt[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 128)) + 128)])), overlap_plan_mbar[(ik + 9)], 256);
        overlap_plan_mbar[(ik + 10)].arrive_and_expect_tx(16384);
        tl::tma_load(X_desc, overlap_plan_mbar[(ik + 10)], (&(((half_t*)x_shared)[(ik * 8192)])), 0, (((((int)blockIdx.z) >> 3) * 256) + (ik * 128)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      overlap_plan_mbar[(((int)blockIdx.y) + 10)].arrive_and_expect_tx(16384);
      tl::tma_load(X_desc, overlap_plan_mbar[(((int)blockIdx.y) + 10)], (&(((half_t*)x_shared)[(((int)blockIdx.y) * 8192)])), 0, (((((int)blockIdx.z) >> 3) * 256) + (((int)blockIdx.y) * 128)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
  }
}
