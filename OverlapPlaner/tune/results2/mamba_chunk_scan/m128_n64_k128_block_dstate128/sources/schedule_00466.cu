...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* cb_shared = ((void*)((char*)buf_dyn_shmem + 99328));
  void* dt_shared = ((void*)((char*)buf_dyn_shmem + 132096));
  void* da_k_shared = ((void*)((char*)buf_dyn_shmem + 133120));
  void* residual_shared = ((void*)((char*)buf_dyn_shmem + 134144));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    #pragma unroll
    for (int i = 0; i < 4; ++i) {
      da_m_local[i] = ((float)((half_t*)da_m_shared)[((((((i >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + ((i & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) - 64)]);
    }
    #pragma unroll
    ...
    for (int i_5 = 0; i_5 < 16; ++i_5) {
      tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[(((((((i_5 >> 3) * 8192) + ((i_5 & 1) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((i_5 & 7) >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((i_5 & 3) >> 1) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) - 4096)])), (&(cb_local_v0[(i_5 * 8)])));
    }
    ...
    if (0 < ((int)blockIdx.y)) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        ...
        tl::tma_load(X_desc, overlap_plan_mbar[7], (&(((half_t*)x_shared)[8192])), 0, (((((int)blockIdx.z) >> 3) * 256) + 128), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
      overlap_plan_mbar[2].wait(1);
      #pragma unroll
      for (int i_8 = 0; i_8 < 16; ++i_8) {
        tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[(((((((i_8 >> 3) * 8192) + ((i_8 & 1) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((i_8 & 7) >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((i_8 & 3) >> 1) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) - 4096)])), (&(cb_local_v1[(i_8 * 8)])));
      }
      overlap_plan_mbar[10].arrive();
    }
    tl::__sync_thread_partial(3, 128);
    ...
    for (int i_12 = 0; i_12 < 64; ++i_12) {
      ...
      float2 __17;
        float2 __18;
        uint1 v__11 = *(uint1*)(cb_local_v0 + (i_12 * 2));
        ((float2*)(&__18))[0] = __half22float2(((half2*)(&v__11))[0]);
        float2 v__12 = *(float2*)(dt_local + (((i_12 >> 3) * 4) + (((i_12 & 3) >> 1) * 2)));
        __17.x = (__18.x*v__12.x);
        __17.y = (__18.y*v__12.y);
      ((half2*)(&__16))[0] = __float22half2_rn(((float2*)(&__17))[0]);
      *(uint1*)(cb_local_v0 + (i_12 * 2)) = __16;
    }
    #pragma unroll
    for (int i_13 = 0; i_13 < 128; ++i_13) {
      half_t condval;
      if ((((((((i_13 >> 4) * 16) + (((i_13 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_13 & 1)) + 64) <= (((((((int)blockIdx.y) * 128) + (((i_13 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_13 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
      ...
      overlap_plan_mbar[(((((int)blockIdx.y) + 2) % 3) + 6)].wait((((((int)blockIdx.y) + 5) % 6) / 3));
      {
        ...
        for (int i_14 = 0; i_14 < 2; ++i_14) {
          ...
          for (int ki_1 = 0; ki_1 < 8; ++ki_1) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v0 + ((ki_1 * 16) + (i_14 * 8))), uint64_t(desc_b_1 + ((ki_1 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_14 * 32)), 1);
          }
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
    ...
    overlap_plan_mbar[(((int)blockIdx.y) + 4)].wait(0);
    #pragma unroll
    for (int i_15 = 0; i_15 < 16; ++i_15) {
      half_t dt_shared_local_cast_3[2];
      *(uint1*)(dt_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)dt_shared) + (((((int)blockIdx.y) * 128) + (i_15 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __19;
      uint1 v__13 = *(uint1*)(dt_shared_local_cast_3 + 0);
      ((float2*)(&__19))[0] = __half22float2(((half2*)(&v__13))[0]);
      *(float2*)(dt_local + (i_15 * 2)) = __19;
    }
    overlap_plan_mbar[(((int)blockIdx.y) + 12)].arrive();
    if (((int)blockIdx.y) == 0) {
      #pragma unroll
      ...
      for (int i_17 = 0; i_17 < 64; ++i_17) {
        ...
        float2 __24;
          ...
          float2 v__17 = *(float2*)(dt_local + (((i_17 >> 3) * 4) + (((i_17 & 3) >> 1) * 2)));
    ...
    if (((int)blockIdx.y) == 0) {
      ...
      for (int i_18 = 0; i_18 < 128; ++i_18) {
        half_t condval_1;
        if ((((((((((int)blockIdx.y) * 128) + ((i_18 >> 4) * 16)) + (((i_18 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_18 & 1)) + 64) <= (((((((int)blockIdx.y) * 128) + (((i_18 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_18 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    overlap_plan_mbar[(((int)blockIdx.y) + 6)].wait(0);
    if (((int)blockIdx.y) == 0) {
      {
    ...
    } else {
      {
        ...
        for (int i_21 = 0; i_21 < 2; ++i_21) {
          ...
          for (int ki_3 = 0; ki_3 < 8; ++ki_3) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v1 + ((ki_3 * 16) + (i_21 * 8))), uint64_t(desc_b_3 + ((ki_3 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_21 * 32)), 1);
          }
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
    ...
    for (int i_22 = 0; i_22 < 32; ++i_22) {
      ...
      *(uint1*)(residual_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)residual_shared) + ((((((((((i_22 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_22 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_22 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_22 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_22 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
      float2 __26;
      uint1 v__18 = *(uint1*)(residual_shared_local_cast_4 + 0);
      ((float2*)(&__26))[0] = __half22float2(((half2*)(&v__18))[0]);
      *(float2*)(residual_local + (i_22 * 2)) = __26;
    }
    #pragma unroll
    ...
    for (int i_24 = 0; i_24 < 8; ++i_24) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((i_24 >> 2) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_24 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_24 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) - 4096)])), __pack_half2(((half_t)acc[(i_24 * 8)]), ((half_t)acc[((i_24 * 8) + 1)])), __pack_half2(((half_t)acc[((i_24 * 8) + 2)]), ((half_t)acc[((i_24 * 8) + 3)])), __pack_half2(((half_t)acc[((i_24 * 8) + 4)]), ((half_t)acc[((i_24 * 8) + 5)])), __pack_half2(((half_t)acc[((i_24 * 8) + 6)]), ((half_t)acc[((i_24 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 128);
