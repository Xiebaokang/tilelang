  ...
  if (((int)threadIdx.x) < 128) {
    ...
    if (0 < ((int)blockIdx.y)) {
      ...
      for (int i_9 = 0; i_9 < 16; ++i_9) {
        tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[((((((i_9 >> 3) * 8192) + ((i_9 & 1) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((i_9 & 7) >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((i_9 & 3) >> 1) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(cb_local_v1[(i_9 * 8)])));
      }
      overlap_plan_mbar[11].arrive();
    }
    tl::__sync_thread_partial(3, 128);
    ...
    if (((int)blockIdx.y) == 0) {
      ...
      for (int i_18 = 0; i_18 < 128; ++i_18) {
        half_t condval_1;
        if (((((((((int)blockIdx.y) * 128) + ((i_18 >> 4) * 16)) + (((i_18 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_18 & 1)) <= (((((((int)blockIdx.y) * 128) + (((i_18 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_18 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
      ...
      for (int i_19 = 0; i_19 < 128; ++i_19) {
        half_t condval_2;
        if (((((((((int)blockIdx.y) * 128) + ((i_19 >> 4) * 16)) + (((i_19 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_19 & 1)) <= (((((((int)blockIdx.y) * 128) + (((i_19 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_19 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    if (((int)blockIdx.y) == 0) {
      {
        ...
        for (int i_20 = 0; i_20 < 2; ++i_20) {
          ...
          for (int ki_2 = 0; ki_2 < 8; ++ki_2) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v0 + ((ki_2 * 16) + (i_20 * 8))), uint64_t(desc_b_2 + ((ki_2 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_20 * 32)), 1);
          }
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
      ...
      for (int i_21 = 0; i_21 < 32; ++i_21) {
        *(float2*)(((float*)acc_wsp_handoff_6) + (((((((i_21 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_21 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((i_21 & 15) >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(acc + (i_21 * 2));
      }
    } else {
      {
        ...
        for (int i_22 = 0; i_22 < 2; ++i_22) {
          ...
          for (int ki_3 = 0; ki_3 < 8; ++ki_3) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v1 + ((ki_3 * 16) + (i_22 * 8))), uint64_t(desc_b_3 + ((ki_3 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_22 * 32)), 1);
          }
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
      ...
      for (int i_23 = 0; i_23 < 32; ++i_23) {
        *(float2*)(((float*)acc_wsp_handoff_6) + (((((((i_23 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_23 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((i_23 & 15) >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(acc + (i_23 * 2));
      }
    }
    ...
    for (int i_24 = 0; i_24 < 32; ++i_24) {
      ...
      *(uint1*)(residual_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)residual_shared) + ((((((((((i_24 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_24 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_24 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_24 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_24 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
      float2 __26;
      uint1 v__18 = *(uint1*)(residual_shared_local_cast_4 + 0);
      ((float2*)(&__26))[0] = __half22float2(((half2*)(&v__18))[0]);
      *(float2*)(residual_local + (i_24 * 2)) = __26;
    }
    overlap_plan_mbar[8].wait(0);
    #pragma unroll
    for (int i_25 = 0; i_25 < 32; ++i_25) {
      *(float2*)(acc + (i_25 * 2)) = *(float2*)(((float*)acc_wsp_handoff_6) + ((((((((i_25 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_25 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((i_25 & 15) >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
    }
    #pragma unroll
    for (int i_26 = 0; i_26 < 64; ++i_26) {
      acc[i_26] = (acc[i_26] + (residual_local[i_26] * d_local[0]));
    }
    #pragma unroll
    for (int i_27 = 0; i_27 < 8; ++i_27) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((i_27 >> 2) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_27 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_27 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) - 4096)])), __pack_half2(((half_t)acc[(i_27 * 8)]), ((half_t)acc[((i_27 * 8) + 1)])), __pack_half2(((half_t)acc[((i_27 * 8) + 2)]), ((half_t)acc[((i_27 * 8) + 3)])), __pack_half2(((half_t)acc[((i_27 * 8) + 4)]), ((half_t)acc[((i_27 * 8) + 5)])), __pack_half2(((half_t)acc[((i_27 * 8) + 6)]), ((half_t)acc[((i_27 * 8) + 7)])));
    }
    tl::fence_proxy_async();
