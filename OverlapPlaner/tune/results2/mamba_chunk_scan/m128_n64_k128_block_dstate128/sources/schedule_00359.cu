...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* da_k_shared = ((void*)((char*)buf_dyn_shmem + 115712));
  void* dt_shared = ((void*)((char*)buf_dyn_shmem + 116736));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(X_desc, overlap_plan_mbar[7], (&(((half_t*)residual_shared)[0])), 0, (((((int)blockIdx.z) >> 3) * 256) + (((int)blockIdx.y) * 128)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
  } else {
    ...
    if (0 < ((int)blockIdx.y)) {
      ...
      for (int i_9 = 0; i_9 < 16; ++i_9) {
        tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[(((((((i_9 >> 3) * 8192) + ((i_9 & 1) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((i_9 & 7) >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((i_9 & 3) >> 1) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) - 4096)])), (&(cb_local_v1[(i_9 * 8)])));
      }
      overlap_plan_mbar[8].arrive();
    }
    tl::__sync_thread_partial(3, 128);
    ...
    if (((int)blockIdx.y) == 0) {
      ...
      for (int i_15 = 0; i_15 < 64; ++i_15) {
        ...
        float2 __21;
          ...
          float2 v__15 = *(float2*)(dt_local_v0 + (((i_15 >> 3) * 4) + (((i_15 & 3) >> 1) * 2)));
      ...
      for (int i_16 = 0; i_16 < 64; ++i_16) {
        ...
        float2 __24;
          ...
          float2 v__17 = *(float2*)(dt_local_v1 + (((i_16 >> 3) * 4) + (((i_16 & 3) >> 1) * 2)));
    ...
    for (int i_21 = 0; i_21 < 32; ++i_21) {
      ...
      *(uint1*)(residual_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)residual_shared) + ((((((((((i_21 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_21 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_21 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_21 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_21 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
      float2 __26;
    ...
    for (int i_23 = 0; i_23 < 8; ++i_23) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((i_23 >> 2) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_23 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_23 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) - 4096)])), __pack_half2(((half_t)acc[(i_23 * 8)]), ((half_t)acc[((i_23 * 8) + 1)])), __pack_half2(((half_t)acc[((i_23 * 8) + 2)]), ((half_t)acc[((i_23 * 8) + 3)])), __pack_half2(((half_t)acc[((i_23 * 8) + 4)]), ((half_t)acc[((i_23 * 8) + 5)])), __pack_half2(((half_t)acc[((i_23 * 8) + 6)]), ((half_t)acc[((i_23 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 128);
