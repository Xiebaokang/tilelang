...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* cb_local_wsp_handoff_6 = ((void*)((char*)buf_dyn_shmem + 116736));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int i_5 = 0; i_5 < 16; ++i_5) {
      tl::ptx_ldmatrix_x4((&(((half_t*)cb_local_wsp_handoff_6)[((((((i_5 & 1) * 8192) + ((((int)threadIdx.x) >> 5) * 2048)) + ((((int)threadIdx.x) & 15) * 128)) + ((i_5 >> 1) * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), (&(cb_local[(i_5 * 8)])));
    }
    #pragma unroll
    ...
    for (int ik = 0; ik < ((int)blockIdx.y); ++ik) {
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[(ik + 5)].arrive_and_expect_tx(32768);
        tl::tma_load(CB_desc, overlap_plan_mbar[(ik + 5)], (&(((half_t*)cb_shared)[((ik * 16384) + 16384)])), ((ik * 128) + 128), (((int)blockIdx.y) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
        tl::tma_load(CB_desc, overlap_plan_mbar[(ik + 5)], (&(((half_t*)cb_shared)[((ik * 16384) + 24576)])), ((ik * 128) + 192), (((int)blockIdx.y) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(X_desc, overlap_plan_mbar[10], (&(((half_t*)x_shared)[0])), 0, (((((int)blockIdx.z) >> 3) * 256) + (ik * 128)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
      ...
      for (int i_10 = 0; i_10 < 16; ++i_10) {
        tl::ptx_ldmatrix_x4((&(((half_t*)cb_local_wsp_handoff_6)[((((((i_10 & 1) * 8192) + ((((int)threadIdx.x) >> 5) * 2048)) + ((((int)threadIdx.x) & 15) * 128)) + ((i_10 >> 1) * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), (&(cb_local[(i_10 * 8)])));
      }
      #pragma unroll
      ...
      for (int i_12 = 0; i_12 < 128; ++i_12) {
        half_t condval_1;
        if ((((((((ik * 128) + ((i_12 >> 4) * 16)) + (((i_12 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_12 & 1)) + 128) <= (((((((int)blockIdx.y) * 128) + (((i_12 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_12 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    if (((int)blockIdx.y) == 1) {
      overlap_plan_mbar[17].wait((((int)blockIdx.y) - 1));
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[10].arrive_and_expect_tx(16384);
      tl::tma_load(X_desc, overlap_plan_mbar[10], (&(((half_t*)x_shared)[0])), 0, (((((int)blockIdx.z) >> 3) * 256) + (((int)blockIdx.y) * 128)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
    ...
    for (int ik_1 = 0; ik_1 < (((int)blockIdx.y) + 1); ++ik_1) {
      ...
      for (int i_20 = 0; i_20 < 64; ++i_20) {
        *(uint1*)(cb_local + (i_20 * 2)) = *(uint1*)(((half_t*)cb_shared) + (((((((((((ik_1 * 16384) + (((((i_20 >> 3) * 16) + (((i_20 & 3) >> 1) * 8)) >> 6) * 8192)) + (((i_20 & 7) >> 2) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_20 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((((i_20 & 31) >> 3) * 16) + (((i_20 & 3) >> 1) * 8)) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_20 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_20 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
      }
      ...
      for (int i_21 = 0; i_21 < 16; ++i_21) {
        ...
        *(uint1*)(da_k_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)da_k_shared) + (((ik_1 * 128) + (i_21 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __10;
      ...
      for (int i_23 = 0; i_23 < 16; ++i_23) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)cb_local_wsp_handoff_6)[(((((((i_23 & 1) * 8192) + ((((int)threadIdx.x) >> 5) * 2048)) + ((((int)threadIdx.x) & 15) * 128)) + ((i_23 >> 1) * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 8192)])), __pack_half2(cb_local[(i_23 * 8)], cb_local[((i_23 * 8) + 1)]), __pack_half2(cb_local[((i_23 * 8) + 2)], cb_local[((i_23 * 8) + 3)]), __pack_half2(cb_local[((i_23 * 8) + 4)], cb_local[((i_23 * 8) + 5)]), __pack_half2(cb_local[((i_23 * 8) + 6)], cb_local[((i_23 * 8) + 7)]));
      }
      tl::fence_proxy_async();
