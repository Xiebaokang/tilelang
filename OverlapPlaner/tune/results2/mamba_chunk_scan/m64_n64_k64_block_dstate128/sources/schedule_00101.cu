...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* dt_shared = ((void*)((char*)buf_dyn_shmem + 57344));
  ...
  for (int i_12 = 0; i_12 < 32; ++i_12) {
    half_t condval;
    if ((((((i_12 >> 2) * 8) + ((((int)threadIdx.x) & 3) * 2)) + (i_12 & 1)) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_12 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
  ...
  for (int i_25 = 0; i_25 < 8; ++i_25) {
    ...
    *(uint1*)(dt_shared_local_cast_5 + 0) = *(uint1*)(((half_t*)dt_shared) + ((((((int)blockIdx.y) & 1) * 64) + (i_25 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    float2 __39;
  ...
  if ((((int)blockIdx.y) % 3) == 0) {
    ...
    for (int i_29 = 0; i_29 < 32; ++i_29) {
      half_t condval_3;
      if ((((((((int)blockIdx.y) * 64) + ((i_29 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_29 & 1)) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_29 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    if ((((int)blockIdx.y) % 3) == 1) {
      ...
      for (int i_30 = 0; i_30 < 32; ++i_30) {
        half_t condval_4;
        if ((((((((int)blockIdx.y) * 64) + ((i_30 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_30 & 1)) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_30 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
      ...
      for (int i_31 = 0; i_31 < 32; ++i_31) {
        half_t condval_5;
        if ((((((((int)blockIdx.y) * 64) + ((i_31 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_31 & 1)) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_31 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
  ...
  if (2 <= ((int)blockIdx.y)) {
    overlap_plan_mbar[((((int)blockIdx.y) & 1) + 13)].wait(0);
  }
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
  ...
  for (int i_32 = 0; i_32 < 16; ++i_32) {
    ...
    *(uint1*)(residual_shared_local_cast_6 + 0) = *(uint1*)(((half_t*)residual_shared) + ((((((((((int)threadIdx.x) >> 5) * 1024) + ((i_32 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_32 >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_32 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_32 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    float2 __49;
  ...
  for (int i_34 = 0; i_34 < 4; ++i_34) {
    tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((int)threadIdx.x) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_34 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_34 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc[(i_34 * 8)]), ((half_t)acc[((i_34 * 8) + 1)])), __pack_half2(((half_t)acc[((i_34 * 8) + 2)]), ((half_t)acc[((i_34 * 8) + 3)])), __pack_half2(((half_t)acc[((i_34 * 8) + 4)]), ((half_t)acc[((i_34 * 8) + 5)])), __pack_half2(((half_t)acc[((i_34 * 8) + 6)]), ((half_t)acc[((i_34 * 8) + 7)])));
  }
