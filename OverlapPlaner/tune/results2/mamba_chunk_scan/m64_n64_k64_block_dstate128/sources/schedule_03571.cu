...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  for (int ik = 0; ik < (((int)blockIdx.y) - 1); ++ik) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      overlap_plan_mbar[(ik + 7)].arrive_and_expect_tx(8192);
      tl::tma_load(X_desc, overlap_plan_mbar[(ik + 7)], (&(((half_t*)x_shared)[((ik * 4096) + 4096)])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 64), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
    if (ik == 0) {
      #pragma unroll
  ...
  if (((int)blockIdx.y) == 3) {
    overlap_plan_mbar[((((int)blockIdx.y) % 3) + 14)].wait(0);
  }
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    overlap_plan_mbar[((((int)blockIdx.y) % 3) + 6)].arrive_and_expect_tx(8192);
    tl::tma_load(X_desc, overlap_plan_mbar[((((int)blockIdx.y) % 3) + 6)], (&(((half_t*)x_shared)[((((int)blockIdx.y) % 3) * 4096)])), 0, (((((int)blockIdx.z) >> 3) * 256) + (((int)blockIdx.y) * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
  }
  if (1 <= ((int)blockIdx.y)) {
    ...
    overlap_plan_mbar[(((((int)blockIdx.y) + 2) % 3) + 6)].wait((((((int)blockIdx.y) + 5) % 6) / 3));
    if (((((int)blockIdx.y) + 1) % 2) == 0) {
      {
  ...
  overlap_plan_mbar[((((int)blockIdx.y) & 1) + 4)].wait((((int)blockIdx.y) >> 1));
  #pragma unroll
  ...
  overlap_plan_mbar[((((int)blockIdx.y) % 3) + 6)].wait((((int)blockIdx.y) / 3));
  if ((((int)blockIdx.y) % 2) == 0) {
    {
  ...
  overlap_plan_mbar[((((int)blockIdx.y) % 3) + 14)].arrive();
  d_local[0] = ((float)D[((int)blockIdx.x)]);
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    overlap_plan_mbar[9].arrive_and_expect_tx(8192);
    tl::tma_load(X_desc, overlap_plan_mbar[9], (&(((half_t*)residual_shared)[0])), 0, (((((int)blockIdx.z) >> 3) * 256) + (((int)blockIdx.y) * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
  }
