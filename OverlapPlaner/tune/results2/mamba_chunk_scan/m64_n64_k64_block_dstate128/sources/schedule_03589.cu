...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* cb_shared = ((void*)((char*)buf_dyn_shmem + 58368));
  ...
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    ...
    tl::tma_load(X_desc, overlap_plan_mbar[7], (&(((half_t*)x_shared)[0])), 0, ((((int)blockIdx.z) >> 3) * 256), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
  }
  ...
  if (0 < ((int)blockIdx.y)) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load((&(((half_t*)dt_shared)[64])), (&(Dt[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + 64)])), overlap_plan_mbar[6], 128);
      overlap_plan_mbar[8].arrive_and_expect_tx(8192);
      tl::tma_load(X_desc, overlap_plan_mbar[8], (&(((half_t*)x_shared)[4096])), 0, (((((int)blockIdx.z) >> 3) * 256) + 64), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
  ...
  for (int ik = 0; ik < (((int)blockIdx.y) - 1); ++ik) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[(ik + 5)].arrive_and_expect_tx(128);
      tl::tma_load((&(((half_t*)dt_shared)[(ik * 64)])), (&(Dt[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 64)) + 128)])), overlap_plan_mbar[(ik + 5)], 128);
    }
    if (ik == 1) {
      overlap_plan_mbar[(ik + 14)].wait(0);
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[(((ik + 2) % 3) + 7)].arrive_and_expect_tx(8192);
      tl::tma_load(X_desc, overlap_plan_mbar[(((ik + 2) % 3) + 7)], (&(((half_t*)x_shared)[(((ik + 2) % 3) * 4096)])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 128), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
    if (ik == 0) {
      #pragma unroll
      ...
      for (int i_12 = 0; i_12 < 16; ++i_12) {
        ...
        float2 __20;
          float2 __21;
          uint1 v__13 = *(uint1*)(cb_local_v1 + (i_12 * 2));
          ((float2*)(&__21))[0] = __half22float2(((half2*)(&v__13))[0]);
          float2 v__14 = *(float2*)(dt_local + ((i_12 >> 1) * 2));
          __20.x = (__21.x*v__14.x);
          __20.y = (__21.y*v__14.y);
        ((half2*)(&__19))[0] = __float22half2_rn(((float2*)(&__20))[0]);
        *(uint1*)(cb_local_v1 + (i_12 * 2)) = __19;
      }
    }
    if (ik == 0) {
      #pragma unroll
      for (int i_13 = 0; i_13 < 32; ++i_13) {
        half_t condval;
        if ((((((ik * 64) + ((i_13 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_13 & 1)) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_13 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
      ...
      for (int i_14 = 0; i_14 < 32; ++i_14) {
        half_t condval_1;
        if ((((((ik * 64) + ((i_14 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_14 & 1)) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_14 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
          condval_1 = cb_local_v1[i_14];
        } else {
          condval_1 = half_t(0x0p+0f/*0.000000e+00*/);
        }
        cb_local_v1[i_14] = condval_1;
      }
    }
    ...
    if (ik == 0) {
      ...
      for (int i_15 = 0; i_15 < 4; ++i_15) {
        tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[((((((int)threadIdx.x) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_15 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_15 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(cb_local_v0[(i_15 * 8)])));
      }
    } else {
      #pragma unroll
      for (int i_16 = 0; i_16 < 4; ++i_16) {
        tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[((((((int)threadIdx.x) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_16 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_16 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(cb_local_v1[(i_16 * 8)])));
      }
    }
    overlap_plan_mbar[11].arrive();
    ...
    for (int i_17 = 0; i_17 < 8; ++i_17) {
      ...
      *(uint1*)(da_k_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)da_k_shared) + ((i_17 * 8) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __22;
      uint1 v__15 = *(uint1*)(da_k_shared_local_cast_3 + 0);
      ((float2*)(&__22))[0] = __half22float2(((half2*)(&v__15))[0]);
      *(float2*)(da_k_local + (i_17 * 2)) = __22;
    }
    overlap_plan_mbar[12].arrive();
    overlap_plan_mbar[(((ik + 1) & 1) + 5)].wait(((ik + 1) >> 1));
    #pragma unroll
    for (int i_18 = 0; i_18 < 8; ++i_18) {
      ...
      *(uint1*)(dt_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)dt_shared) + (((((ik + 1) & 1) * 64) + (i_18 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __23;
      uint1 v__16 = *(uint1*)(dt_shared_local_cast_4 + 0);
      ((float2*)(&__23))[0] = __half22float2(((half2*)(&v__16))[0]);
      *(float2*)(dt_local + (i_18 * 2)) = __23;
    }
    ...
    if (ik == 0) {
      ...
      for (int i_19 = 0; i_19 < 16; ++i_19) {
        ...
        float2 __25;
          float2 __26;
          uint1 v__17 = *(uint1*)(cb_local_v0 + (i_19 * 2));
          ((float2*)(&__26))[0] = __half22float2(((half2*)(&v__17))[0]);
          float2 __27;
          float2 __28;
            float2 __29;
              float2 v__18 = make_float2(da_m_local[(i_19 & 1)], da_m_local[(i_19 & 1)]);
              float2 v__19 = *(float2*)(da_k_local + ((i_19 >> 1) * 2));
      ...
      for (int i_20 = 0; i_20 < 16; ++i_20) {
        ...
        float2 __31;
          float2 __32;
          uint1 v__21 = *(uint1*)(cb_local_v1 + (i_20 * 2));
          ((float2*)(&__32))[0] = __half22float2(((half2*)(&v__21))[0]);
          float2 __33;
          float2 __34;
            float2 __35;
              float2 v__22 = make_float2(da_m_local[(i_20 & 1)], da_m_local[(i_20 & 1)]);
              float2 v__23 = *(float2*)(da_k_local + ((i_20 >> 1) * 2));
  ...
  if (1 <= ((int)blockIdx.y)) {
    if (((((int)blockIdx.y) + 1) % 2) == 0) {
      ...
      for (int i_22 = 0; i_22 < 16; ++i_22) {
        ...
        float2 __40;
          float2 __41;
          uint1 v__27 = *(uint1*)(cb_local_v1 + (i_22 * 2));
          ((float2*)(&__41))[0] = __half22float2(((half2*)(&v__27))[0]);
          float2 v__28 = *(float2*)(dt_local + ((i_22 >> 1) * 2));
          __40.x = (__41.x*v__28.x);
          __40.y = (__41.y*v__28.y);
        ((half2*)(&__39))[0] = __float22half2_rn(((float2*)(&__40))[0]);
        *(uint1*)(cb_local_v1 + (i_22 * 2)) = __39;
      }
    }
    overlap_plan_mbar[(((((int)blockIdx.y) + 2) % 3) + 7)].wait((((((int)blockIdx.y) + 5) % 6) / 3));
    if (((((int)blockIdx.y) + 1) % 2) == 0) {
      {
        tl::GmmaDescriptor desc_b_3;
        tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_3, (&(((half_t*)x_shared)[0])));
        tl::increase_descriptor_offset<int>(desc_b_3, (((((int)blockIdx.y) + 2) % 3) * 8192));
        tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(cb_local_v0 + 0), 16);
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 32);
        tl::warpgroup_arrive();
        #pragma unroll
    ...
    } else {
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_4, (((((int)blockIdx.y) + 2) % 3) * 8192));
        tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(cb_local_v1 + 0), 16);
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 32);
        tl::warpgroup_arrive();
        #pragma unroll
    ...
    overlap_plan_mbar[(((((int)blockIdx.y) + 2) % 3) + 15)].arrive();
  }
  overlap_plan_mbar[((((int)blockIdx.y) & 1) + 5)].wait((((int)blockIdx.y) >> 1));
  #pragma unroll
  for (int i_23 = 0; i_23 < 8; ++i_23) {
    half_t dt_shared_local_cast_5[2];
    *(uint1*)(dt_shared_local_cast_5 + 0) = *(uint1*)(((half_t*)dt_shared) + ((((((int)blockIdx.y) & 1) * 64) + (i_23 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    float2 __42;
    uint1 v__29 = *(uint1*)(dt_shared_local_cast_5 + 0);
    ((float2*)(&__42))[0] = __half22float2(((half2*)(&v__29))[0]);
    *(float2*)(dt_local + (i_23 * 2)) = __42;
  }
  overlap_plan_mbar[((((int)blockIdx.y) & 1) + 13)].arrive();
  if ((((int)blockIdx.y) % 2) == 0) {
    #pragma unroll
    for (int i_24 = 0; i_24 < 16; ++i_24) {
      uint1 __43;
      float2 __44;
        float2 __45;
        uint1 v__30 = *(uint1*)(cb_local_v0 + (i_24 * 2));
        ((float2*)(&__45))[0] = __half22float2(((half2*)(&v__30))[0]);
        float2 v__31 = *(float2*)(dt_local + ((i_24 >> 1) * 2));
        __44.x = (__45.x*v__31.x);
        __44.y = (__45.y*v__31.y);
      ((half2*)(&__43))[0] = __float22half2_rn(((float2*)(&__44))[0]);
      *(uint1*)(cb_local_v0 + (i_24 * 2)) = __43;
    }
  } else {
    #pragma unroll
  ...
  if ((((int)blockIdx.y) % 2) == 0) {
    ...
    for (int i_26 = 0; i_26 < 32; ++i_26) {
      half_t condval_2;
      if ((((((((int)blockIdx.y) * 64) + ((i_26 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_26 & 1)) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_26 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
        condval_2 = cb_local_v0[i_26];
      } else {
        condval_2 = half_t(0x0p+0f/*0.000000e+00*/);
      }
      cb_local_v0[i_26] = condval_2;
    }
  } else {
    #pragma unroll
    for (int i_27 = 0; i_27 < 32; ++i_27) {
      half_t condval_3;
      if ((((((((int)blockIdx.y) * 64) + ((i_27 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_27 & 1)) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_27 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
        condval_3 = cb_local_v1[i_27];
      } else {
        condval_3 = half_t(0x0p+0f/*0.000000e+00*/);
      }
      cb_local_v1[i_27] = condval_3;
    }
  }
  overlap_plan_mbar[((((int)blockIdx.y) % 3) + 7)].wait((((int)blockIdx.y) / 3));
  if ((((int)blockIdx.y) % 2) == 0) {
    {
      tl::GmmaDescriptor desc_b_5;
      tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_5, (&(((half_t*)x_shared)[0])));
      tl::increase_descriptor_offset<int>(desc_b_5, ((((int)blockIdx.y) % 3) * 8192));
      tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(cb_local_v0 + 0), 16);
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 32);
      tl::warpgroup_arrive();
      #pragma unroll
      for (int ki_5 = 0; ki_5 < 4; ++ki_5) {
        tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v0 + (ki_5 * 8)), uint64_t(desc_b_5 + ((ki_5 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + 0), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 32);
  ...
  } else {
    {
      ...
      tl::increase_descriptor_offset<int>(desc_b_6, ((((int)blockIdx.y) % 3) * 8192));
      tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(cb_local_v1 + 0), 16);
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 32);
      tl::warpgroup_arrive();
      #pragma unroll
      for (int ki_6 = 0; ki_6 < 4; ++ki_6) {
        tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v1 + (ki_6 * 8)), uint64_t(desc_b_6 + ((ki_6 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + 0), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 32);
  ...
  overlap_plan_mbar[((((int)blockIdx.y) % 3) + 15)].arrive();
  d_local[0] = ((float)D[((int)blockIdx.x)]);
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    overlap_plan_mbar[10].arrive_and_expect_tx(8192);
    tl::tma_load(X_desc, overlap_plan_mbar[10], (&(((half_t*)residual_shared)[0])), 0, (((((int)blockIdx.z) >> 3) * 256) + (((int)blockIdx.y) * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
  }
  overlap_plan_mbar[10].wait(0);
  #pragma unroll
  for (int i_28 = 0; i_28 < 16; ++i_28) {
    half_t residual_shared_local_cast_6[2];
    *(uint1*)(residual_shared_local_cast_6 + 0) = *(uint1*)(((half_t*)residual_shared) + ((((((((((int)threadIdx.x) >> 5) * 1024) + ((i_28 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_28 >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_28 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_28 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    float2 __49;
    uint1 v__34 = *(uint1*)(residual_shared_local_cast_6 + 0);
    ((float2*)(&__49))[0] = __half22float2(((half2*)(&v__34))[0]);
    *(float2*)(residual_local + (i_28 * 2)) = __49;
  }
  #pragma unroll
  ...
  for (int i_30 = 0; i_30 < 4; ++i_30) {
    tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((int)threadIdx.x) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_30 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_30 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc[(i_30 * 8)]), ((half_t)acc[((i_30 * 8) + 1)])), __pack_half2(((half_t)acc[((i_30 * 8) + 2)]), ((half_t)acc[((i_30 * 8) + 3)])), __pack_half2(((half_t)acc[((i_30 * 8) + 4)]), ((half_t)acc[((i_30 * 8) + 5)])), __pack_half2(((half_t)acc[((i_30 * 8) + 6)]), ((half_t)acc[((i_30 * 8) + 7)])));
  }
