...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* acc_shared = ((void*)((char*)buf_dyn_shmem + 59392));
  void* residual_shared = ((void*)((char*)buf_dyn_shmem + 67584));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(X_desc, overlap_plan_mbar[7], (&(((half_t*)residual_shared)[0])), 0, (((((int)blockIdx.z) >> 3) * 256) + (((int)blockIdx.y) * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
    ...
    if (((int)threadIdx.x) < 192) {
      ((half_t*)da_m_shared)[(((int)threadIdx.x) - 128)] = DA[(((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (((int)blockIdx.y) * 64)) + ((int)threadIdx.x)) - 128)];
    }
    tl::__sync_thread_partial(3, 128);
    #pragma unroll
    for (int i = 0; i < 2; ++i) {
      da_m_local[i] = ((float)((half_t*)da_m_shared)[(((((((int)threadIdx.x) >> 5) * 16) + (i * 8)) + ((((int)threadIdx.x) & 31) >> 2)) - 64)]);
    }
    #pragma unroll
    ...
    for (int i_4 = 0; i_4 < 4; ++i_4) {
      tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_4 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_4 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(cb_local_v0[(i_4 * 8)])));
    }
    ...
    for (int i_9 = 0; i_9 < 32; ++i_9) {
      half_t condval;
      if (((((((i_9 >> 2) * 8) + ((((int)threadIdx.x) & 3) * 2)) + (i_9 & 1)) + 64) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_9 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    if (0 < ((int)blockIdx.y)) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[2].arrive_and_expect_tx(8192);
        tl::tma_load(CB_desc, overlap_plan_mbar[2], (&(((half_t*)cb_shared)[0])), 64, (((int)blockIdx.y) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      }
      overlap_plan_mbar[2].wait(1);
      #pragma unroll
      for (int i_10 = 0; i_10 < 4; ++i_10) {
        tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_10 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_10 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(cb_local_v1[(i_10 * 8)])));
      }
      overlap_plan_mbar[9].arrive();
    ...
    if (0 < ((int)blockIdx.y)) {
      ...
      for (int i_12 = 0; i_12 < 16; ++i_12) {
        ...
        float2 __14;
          float2 __15;
          uint1 v__9 = *(uint1*)(cb_local_v1 + (i_12 * 2));
          ((float2*)(&__15))[0] = __half22float2(((half2*)(&v__9))[0]);
          float2 __16;
          float2 __17;
            float2 __18;
              float2 v__10 = make_float2(da_m_local[(i_12 & 1)], da_m_local[(i_12 & 1)]);
              float2 v__11 = *(float2*)(da_k_local + ((i_12 >> 1) * 2));
    ...
    if (0 < ((int)blockIdx.y)) {
      ...
      for (int i_13 = 0; i_13 < 8; ++i_13) {
        ...
        *(uint1*)(dt_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)dt_shared) + ((i_13 * 8) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __19;
        uint1 v__13 = *(uint1*)(dt_shared_local_cast_3 + 0);
        ((float2*)(&__19))[0] = __half22float2(((half2*)(&v__13))[0]);
        *(float2*)(dt_local + (i_13 * 2)) = __19;
      }
      overlap_plan_mbar[11].arrive();
      #pragma unroll
      for (int i_14 = 0; i_14 < 16; ++i_14) {
        ...
        float2 __21;
          float2 __22;
          uint1 v__14 = *(uint1*)(cb_local_v1 + (i_14 * 2));
        ...
        *(uint1*)(cb_local_v1 + (i_14 * 2)) = __20;
      }
      #pragma unroll
      for (int i_15 = 0; i_15 < 32; ++i_15) {
        half_t condval_1;
        if (((((((i_15 >> 2) * 8) + ((((int)threadIdx.x) & 3) * 2)) + (i_15 & 1)) + 128) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_15 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    for (int ik = 0; ik < (((int)blockIdx.y) - 1); ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[2].arrive_and_expect_tx(8192);
        tl::tma_load(CB_desc, overlap_plan_mbar[2], (&(((half_t*)cb_shared)[0])), ((ik * 64) + 128), (((int)blockIdx.y) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      }
      overlap_plan_mbar[2].wait(ik);
      if (((ik + 2) % 3) == 0) {
        #pragma unroll
        for (int i_16 = 0; i_16 < 4; ++i_16) {
          tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_16 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_16 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(cb_local_v0[(i_16 * 8)])));
        }
      } else {
        if (((ik + 2) % 3) == 1) {
          #pragma unroll
          for (int i_17 = 0; i_17 < 4; ++i_17) {
            tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_17 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_17 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(cb_local_v1[(i_17 * 8)])));
          }
        } else {
          #pragma unroll
          for (int i_18 = 0; i_18 < 4; ++i_18) {
            tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_18 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_18 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(cb_local_v2[(i_18 * 8)])));
          }
        }
      }
      overlap_plan_mbar[9].arrive();
      ...
      for (int i_19 = 0; i_19 < 8; ++i_19) {
        ...
        *(uint1*)(da_k_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)da_k_shared) + ((i_19 * 8) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __23;
        uint1 v__16 = *(uint1*)(da_k_shared_local_cast_4 + 0);
        ((float2*)(&__23))[0] = __half22float2(((half2*)(&v__16))[0]);
        *(float2*)(da_k_local + (i_19 * 2)) = __23;
      }
      overlap_plan_mbar[10].arrive();
      if (((ik + 2) % 3) == 0) {
        #pragma unroll
        for (int i_20 = 0; i_20 < 16; ++i_20) {
          ...
          float2 __25;
            float2 __26;
            uint1 v__17 = *(uint1*)(cb_local_v0 + (i_20 * 2));
            ((float2*)(&__26))[0] = __half22float2(((half2*)(&v__17))[0]);
            float2 __27;
            float2 __28;
              float2 __29;
                float2 v__18 = make_float2(da_m_local[(i_20 & 1)], da_m_local[(i_20 & 1)]);
                float2 v__19 = *(float2*)(da_k_local + ((i_20 >> 1) * 2));
                __29.x = (v__18.x-v__19.x);
                __29.y = (v__18.y-v__19.y);
              float2 v__20 = make_float2(broadcast_var_3, broadcast_var_3);
              __28.x = (__29.x*v__20.x);
              __28.y = (__29.y*v__20.y);
            __27.x = exp2f(__28.x);
            __27.y = exp2f(__28.y);
            __25.x = (__26.x*__27.x);
            __25.y = (__26.y*__27.y);
          ((half2*)(&__24))[0] = __float22half2_rn(((float2*)(&__25))[0]);
          *(uint1*)(cb_local_v0 + (i_20 * 2)) = __24;
        }
      } else {
        if (((ik + 2) % 3) == 1) {
          #pragma unroll
          for (int i_21 = 0; i_21 < 32; ++i_21) {
            cb_local_v1[i_21] = ((half_t)(((float)cb_local_v1[i_21]) * exp2f(((da_m_local[((i_21 & 3) >> 1)] - da_k_local[(((i_21 >> 2) * 2) + (i_21 & 1))]) * 0x1.7154764ee6c2fp+0f/*1.442695e+00*/))));
          }
        } else {
          #pragma unroll
          for (int i_22 = 0; i_22 < 16; ++i_22) {
            ...
            float2 __31;
              float2 __32;
              uint1 v__21 = *(uint1*)(cb_local_v2 + (i_22 * 2));
              ((float2*)(&__32))[0] = __half22float2(((half2*)(&v__21))[0]);
              float2 __33;
              float2 __34;
                float2 __35;
                  float2 v__22 = make_float2(da_m_local[(i_22 & 1)], da_m_local[(i_22 & 1)]);
                  float2 v__23 = *(float2*)(da_k_local + ((i_22 >> 1) * 2));
                  __35.x = (v__22.x-v__23.x);
                  __35.y = (v__22.y-v__23.y);
                float2 v__24 = make_float2(broadcast_var_4, broadcast_var_4);
                __34.x = (__35.x*v__24.x);
                __34.y = (__35.y*v__24.y);
              __33.x = exp2f(__34.x);
              __33.y = exp2f(__34.y);
              __31.x = (__32.x*__33.x);
              __31.y = (__32.y*__33.y);
            ((half2*)(&__30))[0] = __float22half2_rn(((float2*)(&__31))[0]);
            *(uint1*)(cb_local_v2 + (i_22 * 2)) = __30;
          }
        }
      }
      ...
      for (int i_23 = 0; i_23 < 8; ++i_23) {
        ...
        *(uint1*)(dt_shared_local_cast_5 + 0) = *(uint1*)(((half_t*)dt_shared) + ((i_23 * 8) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __36;
        uint1 v__25 = *(uint1*)(dt_shared_local_cast_5 + 0);
        ((float2*)(&__36))[0] = __half22float2(((half2*)(&v__25))[0]);
        *(float2*)(dt_local + (i_23 * 2)) = __36;
      }
      overlap_plan_mbar[11].arrive();
      if (((ik + 2) % 3) == 0) {
        #pragma unroll
        for (int i_24 = 0; i_24 < 16; ++i_24) {
          ...
          float2 __38;
            float2 __39;
            uint1 v__26 = *(uint1*)(cb_local_v0 + (i_24 * 2));
            ((float2*)(&__39))[0] = __half22float2(((half2*)(&v__26))[0]);
            float2 v__27 = *(float2*)(dt_local + ((i_24 >> 1) * 2));
            __38.x = (__39.x*v__27.x);
            __38.y = (__39.y*v__27.y);
          ((half2*)(&__37))[0] = __float22half2_rn(((float2*)(&__38))[0]);
          *(uint1*)(cb_local_v0 + (i_24 * 2)) = __37;
        }
      } else {
        if (((ik + 2) % 3) == 1) {
          #pragma unroll
          for (int i_25 = 0; i_25 < 32; ++i_25) {
            cb_local_v1[i_25] = ((half_t)(((float)cb_local_v1[i_25]) * dt_local[(((i_25 >> 2) * 2) + (i_25 & 1))]));
          }
        } else {
          #pragma unroll
          for (int i_26 = 0; i_26 < 16; ++i_26) {
            ...
            float2 __41;
              float2 __42;
              uint1 v__28 = *(uint1*)(cb_local_v2 + (i_26 * 2));
      ...
      if (((ik + 2) % 3) == 0) {
        ...
        for (int i_27 = 0; i_27 < 32; ++i_27) {
          half_t condval_2;
          if (((((((ik * 64) + ((i_27 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_27 & 1)) + 192) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_27 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
        ...
        if (((ik + 2) % 3) == 1) {
          ...
          for (int i_29 = 0; i_29 < 32; ++i_29) {
            half_t condval_4;
            if (((((((ik * 64) + ((i_29 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_29 & 1)) + 192) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_29 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
              condval_4 = cb_local_v2[i_29];
            } else {
              condval_4 = half_t(0x0p+0f/*0.000000e+00*/);
            }
            cb_local_v2[i_29] = condval_4;
          }
        }
      }
      if (ik == 1) {
      ...
      if (ik == 0) {
      ...
      } else {
        {
          ...
          for (int ki_2 = 0; ki_2 < 4; ++ki_2) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v1 + (ki_2 * 8)), uint64_t(desc_b_2 + ((ki_2 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + 0), 1);
          }
          tl::warpgroup_commit_batch();
          tl::warpgroup_wait<0>();
          tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 32);
    ...
    if (2 <= ((int)blockIdx.y)) {
      overlap_plan_mbar[((((int)blockIdx.y) & 1) + 12)].wait(0);
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      overlap_plan_mbar[((((int)blockIdx.y) & 1) + 5)].arrive_and_expect_tx(8192);
      tl::tma_load(X_desc, overlap_plan_mbar[((((int)blockIdx.y) & 1) + 5)], (&(((half_t*)x_shared)[((((int)blockIdx.y) & 1) * 4096)])), 0, (((((int)blockIdx.z) >> 3) * 256) + (((int)blockIdx.y) * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
    if (1 <= ((int)blockIdx.y)) {
      overlap_plan_mbar[(((((int)blockIdx.y) + 1) & 1) + 5)].wait((((((int)blockIdx.y) + 3) & 3) >> 1));
      if (((((int)blockIdx.y) + 2) % 3) == 0) {
        {
          tl::GmmaDescriptor desc_b_3;
          tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_3, (&(((half_t*)x_shared)[0])));
          tl::increase_descriptor_offset<int>(desc_b_3, (((((int)blockIdx.y) + 1) & 1) * 8192));
          tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(cb_local_v0 + 0), 16);
          tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 32);
          tl::warpgroup_arrive();
          #pragma unroll
          for (int ki_3 = 0; ki_3 < 4; ++ki_3) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v0 + (ki_3 * 8)), uint64_t(desc_b_3 + ((ki_3 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + 0), 1);
          }
          tl::warpgroup_commit_batch();
          tl::warpgroup_wait<0>();
          tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 32);
        ...
        if (((((int)blockIdx.y) + 2) % 3) == 1) {
          {
            tl::GmmaDescriptor desc_b_4;
            tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_4, (&(((half_t*)x_shared)[0])));
            tl::increase_descriptor_offset<int>(desc_b_4, (((((int)blockIdx.y) + 1) & 1) * 8192));
            tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(cb_local_v1 + 0), 16);
            tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 32);
            tl::warpgroup_arrive();
            #pragma unroll
            for (int ki_4 = 0; ki_4 < 4; ++ki_4) {
              tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v1 + (ki_4 * 8)), uint64_t(desc_b_4 + ((ki_4 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + 0), 1);
            }
            tl::warpgroup_commit_batch();
            tl::warpgroup_wait<0>();
            tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 32);
        ...
        } else {
          {
            ...
            tl::increase_descriptor_offset<int>(desc_b_5, (((((int)blockIdx.y) + 1) & 1) * 8192));
            tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(cb_local_v2 + 0), 16);
            tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 32);
            tl::warpgroup_arrive();
            #pragma unroll
            for (int ki_5 = 0; ki_5 < 4; ++ki_5) {
              tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v2 + (ki_5 * 8)), uint64_t(desc_b_5 + ((ki_5 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + 0), 1);
            }
            tl::warpgroup_commit_batch();
            tl::warpgroup_wait<0>();
            tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 32);
      ...
      overlap_plan_mbar[(((((int)blockIdx.y) + 1) & 1) + 12)].arrive();
    }
    overlap_plan_mbar[((((int)blockIdx.y) & 1) + 5)].wait((((int)blockIdx.y) >> 1));
    if ((((int)blockIdx.y) % 3) == 0) {
      {
        tl::GmmaDescriptor desc_b_6;
        tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_6, (&(((half_t*)x_shared)[0])));
        tl::increase_descriptor_offset<int>(desc_b_6, ((((int)blockIdx.y) & 1) * 8192));
        tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(cb_local_v0 + 0), 16);
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 32);
        tl::warpgroup_arrive();
        #pragma unroll
        for (int ki_6 = 0; ki_6 < 4; ++ki_6) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v0 + (ki_6 * 8)), uint64_t(desc_b_6 + ((ki_6 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + 0), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 32);
      ...
      if ((((int)blockIdx.y) % 3) == 1) {
        {
          tl::GmmaDescriptor desc_b_7;
          tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_7, (&(((half_t*)x_shared)[0])));
          tl::increase_descriptor_offset<int>(desc_b_7, ((((int)blockIdx.y) & 1) * 8192));
          tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(cb_local_v1 + 0), 16);
          tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 32);
          tl::warpgroup_arrive();
          #pragma unroll
          for (int ki_7 = 0; ki_7 < 4; ++ki_7) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v1 + (ki_7 * 8)), uint64_t(desc_b_7 + ((ki_7 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + 0), 1);
          }
          tl::warpgroup_commit_batch();
          tl::warpgroup_wait<0>();
          tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 32);
      ...
      } else {
        {
          ...
          tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_8, (&(((half_t*)x_shared)[0])));
          tl::increase_descriptor_offset<int>(desc_b_8, ((((int)blockIdx.y) & 1) * 8192));
          tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(cb_local_v2 + 0), 16);
          tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 32);
          tl::warpgroup_arrive();
          #pragma unroll
          for (int ki_8 = 0; ki_8 < 4; ++ki_8) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v2 + (ki_8 * 8)), uint64_t(desc_b_8 + ((ki_8 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + 0), 1);
          }
          tl::warpgroup_commit_batch();
          tl::warpgroup_wait<0>();
          tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 32);
    ...
    for (int i_30 = 0; i_30 < 16; ++i_30) {
      ...
      *(uint1*)(residual_shared_local_cast_6 + 0) = *(uint1*)(((half_t*)residual_shared) + (((((((((((int)threadIdx.x) >> 5) * 1024) + ((i_30 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_30 >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_30 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_30 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
      float2 __43;
      uint1 v__30 = *(uint1*)(residual_shared_local_cast_6 + 0);
      ((float2*)(&__43))[0] = __half22float2(((half2*)(&v__30))[0]);
      *(float2*)(residual_local + (i_30 * 2)) = __43;
    }
    #pragma unroll
    ...
    for (int i_32 = 0; i_32 < 4; ++i_32) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_32 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_32 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc[(i_32 * 8)]), ((half_t)acc[((i_32 * 8) + 1)])), __pack_half2(((half_t)acc[((i_32 * 8) + 2)]), ((half_t)acc[((i_32 * 8) + 3)])), __pack_half2(((half_t)acc[((i_32 * 8) + 4)]), ((half_t)acc[((i_32 * 8) + 5)])), __pack_half2(((half_t)acc[((i_32 * 8) + 6)]), ((half_t)acc[((i_32 * 8) + 7)])));
    }
    tl::fence_proxy_async();
