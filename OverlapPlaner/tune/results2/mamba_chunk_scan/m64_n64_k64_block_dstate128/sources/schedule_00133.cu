...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  for (int ik = 0; ik < (((int)blockIdx.y) - 1); ++ik) {
    ...
    if (ik == 0) {
      ...
      for (int i_22 = 0; i_22 < 32; ++i_22) {
        half_t condval;
        if ((((((ik * 64) + ((i_22 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_22 & 1)) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_22 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
      ...
      for (int i_23 = 0; i_23 < 32; ++i_23) {
        half_t condval_1;
        if ((((((ik * 64) + ((i_23 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_23 & 1)) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_23 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
  ...
  if ((((int)blockIdx.y) % 2) == 0) {
    ...
    for (int i_25 = 0; i_25 < 8; ++i_25) {
      ...
      *(uint1*)(dt_shared_local_cast_7 + 0) = *(uint1*)(((half_t*)dt_shared) + ((((((int)blockIdx.y) & 1) * 64) + (i_25 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __38;
  ...
  if ((((int)blockIdx.y) % 3) == 0) {
    ...
    if ((((int)blockIdx.y) % 3) == 1) {
      ...
      for (int i_35 = 0; i_35 < 32; ++i_35) {
        half_t condval_4;
        if ((((((((int)blockIdx.y) * 64) + ((i_35 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_35 & 1)) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_35 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
  ...
  for (int i_36 = 0; i_36 < 16; ++i_36) {
    ...
    *(uint1*)(residual_shared_local_cast_8 + 0) = *(uint1*)(((half_t*)residual_shared) + ((((((((((int)threadIdx.x) >> 5) * 1024) + ((i_36 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_36 >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_36 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_36 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    float2 __60;
  ...
  for (int i_38 = 0; i_38 < 4; ++i_38) {
    tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((int)threadIdx.x) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_38 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_38 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc[(i_38 * 8)]), ((half_t)acc[((i_38 * 8) + 1)])), __pack_half2(((half_t)acc[((i_38 * 8) + 2)]), ((half_t)acc[((i_38 * 8) + 3)])), __pack_half2(((half_t)acc[((i_38 * 8) + 4)]), ((half_t)acc[((i_38 * 8) + 5)])), __pack_half2(((half_t)acc[((i_38 * 8) + 6)]), ((half_t)acc[((i_38 * 8) + 7)])));
  }
