...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* acc_wsp_handoff_3 = ((void*)((char*)buf_dyn_shmem + 16384));
  void* prev_shared = ((void*)((char*)buf_dyn_shmem + 24576));
  ...
  void* residual_shared = ((void*)((char*)buf_dyn_shmem + 52224));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int i_1 = 0; i_1 < 2; ++i_1) {
      scale_m[i_1] = exp2f((da_m_local[i_1] * 0x1.7154764ee6c2fp+0f/*1.442695e+00*/));
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    ...
    for (int i_2 = 0; i_2 < 8; ++i_2) {
      *(float2*)(acc + (i_2 * 2)) = *(float2*)(((float*)acc_wsp_handoff_3) + ((((((((int)threadIdx.x) >> 5) * 512) + ((i_2 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_2 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    }
    #pragma unroll
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(CB_desc, overlap_plan_mbar[4], (&(((half_t*)cb_shared)[0])), 0, ((((int)blockIdx.y) >> 1) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
    ...
    for (int i_4 = 0; i_4 < 4; ++i_4) {
      tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[((((((int)threadIdx.x) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_4 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_4 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(cb_local[(i_4 * 8)])));
    }
      ...
      float2 __4;
        ...
        float2 __7;
          float2 __8;
            ...
            __8.x = (v__3.x-v__4.x);
            __8.y = (v__3.y-v__4.y);
          float2 v__5 = make_float2(broadcast_var, broadcast_var);
          __7.x = (__8.x*v__5.x);
          __7.y = (__8.y*v__5.y);
        __6.x = exp2f(__7.x);
        __6.y = exp2f(__7.y);
    ...
    for (int ik = 0; ik < (((int)blockIdx.y) >> 1); ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[4].arrive_and_expect_tx(8192);
        tl::tma_load(CB_desc, overlap_plan_mbar[4], (&(((half_t*)cb_shared)[0])), ((ik * 64) + 64), ((((int)blockIdx.y) >> 1) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      }
      overlap_plan_mbar[11].wait((ik & 1));
      tl::__sync_thread_partial(3, 128);
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[5].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)da_k_shared)[0])), (&(DA[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 64)) + 64)])), overlap_plan_mbar[5], 128);
      }
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[(((ik + 1) & 1) + 7)].arrive_and_expect_tx(4096);
        tl::tma_load(X_desc, overlap_plan_mbar[(((ik + 1) & 1) + 7)], (&(((half_t*)x_shared)[(((ik + 1) & 1) * 2048)])), ((((int)blockIdx.y) & 1) * 32), ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 64), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
      overlap_plan_mbar[((ik & 1) + 7)].wait((ik >> 1));
      {
        tl::GmmaDescriptor desc_b;
        tl::initialize_wgmma_descriptor<2, 0, 32>(desc_b, (&(((half_t*)x_shared)[0])));
        ...
        for (int ki = 0; ki < 4; ++ki) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local + (ki * 8)), uint64_t(desc_b + ((ki * 1024) >> 4)), reinterpret_cast<uint32_t*>(acc + 0), 1);
        }
      ...
      for (int i_10 = 0; i_10 < 4; ++i_10) {
        tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[((((((int)threadIdx.x) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_10 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_10 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(cb_local[(i_10 * 8)])));
      }
      overlap_plan_mbar[10].arrive();
      ...
      for (int i_13 = 0; i_13 < 16; ++i_13) {
        ...
        float2 __15;
          ...
          float2 __18;
            ...
            float2 v__13 = make_float2(broadcast_var_1, broadcast_var_1);
      ...
      for (int i_15 = 0; i_15 < 32; ++i_15) {
        half_t condval_1;
        if (((((((ik * 64) + ((i_15 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_15 & 1)) + 64) <= (((((((int)blockIdx.y) >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_15 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    overlap_plan_mbar[(((((int)blockIdx.y) & 3) >> 1) + 7)].wait((((int)blockIdx.y) >> 2));
    {
      tl::GmmaDescriptor desc_b_1;
      tl::initialize_wgmma_descriptor<2, 0, 32>(desc_b_1, (&(((half_t*)x_shared)[0])));
      tl::increase_descriptor_offset<int>(desc_b_1, (((((int)blockIdx.y) & 3) >> 1) * 4096));
      tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(cb_local + 0), 16);
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 16);
      tl::warpgroup_arrive();
      #pragma unroll
    ...
    for (int i_19 = 0; i_19 < 4; ++i_19) {
      ...
      *(float4*)(acc + (i_19 * 4)) = make_float4(broadcast_var_2, broadcast_var_2, broadcast_var_2, broadcast_var_2);
    }
    ...
    overlap_plan_mbar[2].wait(0);
    {
      ...
      tl::initialize_wgmma_descriptor<1, 1, 64>(desc_b_2, (&(((half_t*)prev_shared)[0])));
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 16);
      tl::warpgroup_arrive();
      #pragma unroll
      for (int ki_2 = 0; ki_2 < 8; ++ki_2) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a + ((((ki_2 >> 2) * 8192) + ((ki_2 & 3) * 32)) >> 4)), uint64_t(desc_b_2 + ((((ki_2 >> 2) * 4096) + ((ki_2 & 3) * 32)) >> 4)), ((uint32_t*)(acc + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 16);
    ...
    for (int i_20 = 0; i_20 < 8; ++i_20) {
      *(float2*)(((float*)acc_wsp_handoff_3) + (((((((((int)threadIdx.x) >> 5) * 512) + ((i_20 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_20 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 2048)) = *(float2*)(acc + (i_20 * 2));
    }
    tl::fence_proxy_async();
