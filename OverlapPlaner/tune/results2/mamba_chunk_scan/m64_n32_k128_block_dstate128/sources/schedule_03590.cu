...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc, __grid_constant__ const CUtensorMap X_desc_1) {
  ...
  for (int i_12 = 0; i_12 < 16; ++i_12) {
    ...
    *(uint1*)(dt_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)dt_shared) + ((((((int)blockIdx.y) >> 2) * 128) + (i_12 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    float2 __19;
    uint1 v__13 = *(uint1*)(dt_shared_local_cast_3 + 0);
    ((float2*)(&__19))[0] = __half22float2(((half2*)(&v__13))[0]);
    *(float2*)(dt_local + (i_12 * 2)) = __19;
  }
  ...
  if ((((int)blockIdx.y) >> 2) == 0) {
    ...
    for (int i_15 = 0; i_15 < 64; ++i_15) {
      half_t condval;
      if ((((((i_15 >> 2) * 8) + ((((int)threadIdx.x) & 3) * 2)) + (i_15 & 1)) <= (((((((int)blockIdx.y) >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_15 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
        condval = cb_local_v0[i_15];
      } else {
        condval = half_t(0x0p+0f/*0.000000e+00*/);
      }
      cb_local_v0[i_15] = condval;
    }
  } else {
    #pragma unroll
    for (int i_16 = 0; i_16 < 64; ++i_16) {
      half_t condval_1;
      if (((((((i_16 >> 2) * 8) + ((((int)threadIdx.x) & 3) * 2)) + (i_16 & 1)) + 128) <= (((((((int)blockIdx.y) >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_16 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
  ...
  for (int i_17 = 0; i_17 < 8; ++i_17) {
    ...
    *(uint1*)(residual_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)residual_shared) + (((((((((int)threadIdx.x) >> 5) * 512) + ((i_17 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_17 >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_17 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    float2 __26;
    uint1 v__18 = *(uint1*)(residual_shared_local_cast_4 + 0);
    ((float2*)(&__26))[0] = __half22float2(((half2*)(&v__18))[0]);
    *(float2*)(residual_local + (i_17 * 2)) = __26;
  }
  #pragma unroll
  for (int i_18 = 0; i_18 < 16; ++i_18) {
    acc[i_18] = (acc[i_18] + (residual_local[i_18] * d_local[0]));
  }
  __syncthreads();
  #pragma unroll
  for (int i_19 = 0; i_19 < 2; ++i_19) {
    tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + i_19) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(((half_t)acc[(i_19 * 8)]), ((half_t)acc[((i_19 * 8) + 1)])), __pack_half2(((half_t)acc[((i_19 * 8) + 2)]), ((half_t)acc[((i_19 * 8) + 3)])), __pack_half2(((half_t)acc[((i_19 * 8) + 4)]), ((half_t)acc[((i_19 * 8) + 5)])), __pack_half2(((half_t)acc[((i_19 * 8) + 6)]), ((half_t)acc[((i_19 * 8) + 7)])));
  }
