...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc, __grid_constant__ const CUtensorMap X_desc_1) {
  ...
  void* da_m_shared = ((void*)((char*)buf_dyn_shmem + 24576));
  void* cb_shared = ((void*)((char*)buf_dyn_shmem + 25600));
  void* x_shared = ((void*)((char*)buf_dyn_shmem + 58368));
  void* da_k_shared = ((void*)((char*)buf_dyn_shmem + 74752));
  void* dt_shared = ((void*)((char*)buf_dyn_shmem + 75776));
  void* acc_shared = ((void*)((char*)buf_dyn_shmem + 76800));
  void* residual_shared = ((void*)((char*)buf_dyn_shmem + 80896));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int i_4 = 0; i_4 < 32; ++i_4) {
      *(uint1*)(cb_local_v0 + (i_4 * 2)) = *(uint1*)(((half_t*)cb_shared) + (((((((((i_4 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_4 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_4 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_4 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_4 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    }
    ...
    for (int ik = 0; ik < (((int)blockIdx.y) >> 2); ++ik) {
      ...
      for (int i_10 = 0; i_10 < 32; ++i_10) {
        *(uint1*)(cb_local_v1 + (i_10 * 2)) = *(uint1*)(((half_t*)cb_shared) + ((((((((((ik * 8192) + ((i_10 >> 4) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_10 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_10 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_10 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_10 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 8192));
      }
      ...
      for (int i_11 = 0; i_11 < 16; ++i_11) {
        ...
        *(uint1*)(da_k_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)da_k_shared) + ((((ik * 128) + (i_11 * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 128));
        float2 __12;
      ...
      for (int i_13 = 0; i_13 < 16; ++i_13) {
        ...
        *(uint1*)(dt_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)dt_shared) + ((((ik * 128) + (i_13 * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 128));
        float2 __19;
        uint1 v__13 = *(uint1*)(dt_shared_local_cast_3 + 0);
        ((float2*)(&__19))[0] = __half22float2(((half2*)(&v__13))[0]);
        *(float2*)(dt_local + (i_13 * 2)) = __19;
      }
      overlap_plan_mbar[(ik + 20)].arrive();
      #pragma unroll
      ...
      for (int i_15 = 0; i_15 < 64; ++i_15) {
        half_t condval_1;
        if (((((((ik * 128) + ((i_15 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_15 & 1)) + 128) <= (((((((int)blockIdx.y) >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_15 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
      ...
      overlap_plan_mbar[(ik + 21)].arrive();
    }
    overlap_plan_mbar[((((int)blockIdx.y) >> 2) + 10)].wait(0);
    ...
    overlap_plan_mbar[((((int)blockIdx.y) >> 2) + 21)].arrive();
    ...
    for (int i_16 = 0; i_16 < 8; ++i_16) {
      ...
      *(uint1*)(residual_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)residual_shared) + (((((((((int)threadIdx.x) >> 5) * 512) + ((i_16 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_16 >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_16 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __23;
    ...
    for (int i_18 = 0; i_18 < 2; ++i_18) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + i_18) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(((half_t)acc[(i_18 * 8)]), ((half_t)acc[((i_18 * 8) + 1)])), __pack_half2(((half_t)acc[((i_18 * 8) + 2)]), ((half_t)acc[((i_18 * 8) + 3)])), __pack_half2(((half_t)acc[((i_18 * 8) + 4)]), ((half_t)acc[((i_18 * 8) + 5)])), __pack_half2(((half_t)acc[((i_18 * 8) + 6)]), ((half_t)acc[((i_18 * 8) + 7)])));
    }
    ...
    for (int ik_1 = 0; ik_1 < ((((int)blockIdx.y) >> 2) + 1); ++ik_1) {
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        ...
        tl::tma_load(CB_desc, overlap_plan_mbar[(ik_1 + 3)], (&(((half_t*)cb_shared)[(ik_1 * 8192)])), (ik_1 * 128), ((((int)blockIdx.y) >> 1) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
        tl::tma_load(CB_desc, overlap_plan_mbar[(ik_1 + 3)], (&(((half_t*)cb_shared)[((ik_1 * 8192) + 4096)])), ((ik_1 * 128) + 64), ((((int)blockIdx.y) >> 1) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
        ...
        tl::tma_load((&(((half_t*)dt_shared)[(ik_1 * 128)])), (&(Dt[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik_1 * 128))])), overlap_plan_mbar[(ik_1 + 8)], 256);
        overlap_plan_mbar[(ik_1 + 10)].arrive_and_expect_tx(8192);
        tl::tma_load(X_desc, overlap_plan_mbar[(ik_1 + 10)], (&(((half_t*)x_shared)[(ik_1 * 4096)])), ((((int)blockIdx.y) & 1) * 32), (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 128)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      overlap_plan_mbar[12].arrive_and_expect_tx(4096);
      tl::tma_load(X_desc_1, overlap_plan_mbar[12], (&(((half_t*)residual_shared)[0])), ((((int)blockIdx.y) & 1) * 32), (((((int)blockIdx.z) >> 3) * 256) + ((((int)blockIdx.y) >> 1) * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
