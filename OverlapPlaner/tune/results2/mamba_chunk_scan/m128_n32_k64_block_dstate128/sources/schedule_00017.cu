...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc, __grid_constant__ const CUtensorMap X_desc_1) {
  ...
  void* residual_shared = ((void*)((char*)buf_dyn_shmem + 75776));
  ...
  if (((int)threadIdx.x) < 128) {
      ...
      if (((ik + 2) % 3) == 0) {
        ...
        if (((ik + 2) % 3) == 1) {
          ...
          for (int i_30 = 0; i_30 < 64; ++i_30) {
            half_t condval_4;
            if ((((((((ik * 64) + ((i_30 >> 4) * 16)) + (((i_30 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_30 & 1)) + 128) <= ((((((((int)blockIdx.y) >> 1) * 128) + (((i_30 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_30 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
      ...
      if (ik == 0) {
        {
          ...
          for (int i_31 = 0; i_31 < 2; ++i_31) {
            ...
            for (int ki_1 = 0; ki_1 < 4; ++ki_1) {
              tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v0 + ((ki_1 * 16) + (i_31 * 8))), uint64_t(desc_b_1 + ((ki_1 * 1024) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_31 * 16)), 1);
            }
          }
          tl::warpgroup_commit_batch();
          tl::warpgroup_wait<0>();
      ...
      } else {
        {
          ...
          for (int i_32 = 0; i_32 < 2; ++i_32) {
            ...
            for (int ki_2 = 0; ki_2 < 4; ++ki_2) {
              tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v1 + ((ki_2 * 16) + (i_32 * 8))), uint64_t(desc_b_2 + ((ki_2 * 1024) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_32 * 16)), 1);
            }
          }
          tl::warpgroup_commit_batch();
          tl::warpgroup_wait<0>();
    ...
    if ((((int)blockIdx.y) >> 1) == 0) {
      {
        ...
        for (int i_33 = 0; i_33 < 2; ++i_33) {
          ...
          for (int ki_3 = 0; ki_3 < 4; ++ki_3) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v0 + ((ki_3 * 16) + (i_33 * 8))), uint64_t(desc_b_3 + ((ki_3 * 1024) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_33 * 16)), 1);
          }
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
    ...
    } else {
      {
        ...
        for (int i_34 = 0; i_34 < 2; ++i_34) {
          ...
          for (int ki_4 = 0; ki_4 < 4; ++ki_4) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v2 + ((ki_4 * 16) + (i_34 * 8))), uint64_t(desc_b_4 + ((ki_4 * 1024) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_34 * 16)), 1);
          }
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
    ...
    if (((((((int)blockIdx.y) >> 1) * 2) + 1) % 3) == 0) {
      {
        ...
        for (int i_35 = 0; i_35 < 2; ++i_35) {
          ...
          for (int ki_5 = 0; ki_5 < 4; ++ki_5) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v0 + ((ki_5 * 16) + (i_35 * 8))), uint64_t(desc_b_5 + ((ki_5 * 1024) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_35 * 16)), 1);
          }
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
    ...
    } else {
      {
        ...
        for (int i_36 = 0; i_36 < 2; ++i_36) {
          ...
          for (int ki_6 = 0; ki_6 < 4; ++ki_6) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v1 + ((ki_6 * 16) + (i_36 * 8))), uint64_t(desc_b_6 + ((ki_6 * 1024) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_36 * 16)), 1);
          }
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
    ...
    for (int i_37 = 0; i_37 < 16; ++i_37) {
      ...
      *(uint1*)(residual_shared_local_cast_6 + 0) = *(uint1*)(((half_t*)residual_shared) + ((((((((i_37 >> 3) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((i_37 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_37 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_37 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __43;
    ...
    for (int i_39 = 0; i_39 < 4; ++i_39) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((i_39 >> 1) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + (i_39 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(((half_t)acc[(i_39 * 8)]), ((half_t)acc[((i_39 * 8) + 1)])), __pack_half2(((half_t)acc[((i_39 * 8) + 2)]), ((half_t)acc[((i_39 * 8) + 3)])), __pack_half2(((half_t)acc[((i_39 * 8) + 4)]), ((half_t)acc[((i_39 * 8) + 5)])), __pack_half2(((half_t)acc[((i_39 * 8) + 6)]), ((half_t)acc[((i_39 * 8) + 7)])));
    }
    tl::fence_proxy_async();
