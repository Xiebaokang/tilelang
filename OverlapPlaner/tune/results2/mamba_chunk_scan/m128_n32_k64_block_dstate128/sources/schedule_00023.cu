...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc, __grid_constant__ const CUtensorMap X_desc_1) {
  ...
  void* acc_shared = ((void*)((char*)buf_dyn_shmem + 63488));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < (((((int)blockIdx.y) >> 1) * 2) + 2); ++ik) {
      ...
      for (int i_10 = 0; i_10 < 64; ++i_10) {
        half_t condval;
        if ((((((((ik * 64) + ((i_10 >> 4) * 16)) + (((i_10 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_10 & 1)) + 64) <= ((((((((int)blockIdx.y) >> 1) * 128) + (((i_10 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_10 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    for (int i_12 = 0; i_12 < 16; ++i_12) {
      ...
      *(uint1*)(residual_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)residual_shared) + (((((((((i_12 >> 3) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((i_12 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_12 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_12 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 2048));
      float2 __12;
    ...
    for (int i_14 = 0; i_14 < 4; ++i_14) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((((i_14 >> 1) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + (i_14 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8)) - 2048)])), __pack_half2(((half_t)acc[(i_14 * 8)]), ((half_t)acc[((i_14 * 8) + 1)])), __pack_half2(((half_t)acc[((i_14 * 8) + 2)]), ((half_t)acc[((i_14 * 8) + 3)])), __pack_half2(((half_t)acc[((i_14 * 8) + 4)]), ((half_t)acc[((i_14 * 8) + 5)])), __pack_half2(((half_t)acc[((i_14 * 8) + 6)]), ((half_t)acc[((i_14 * 8) + 7)])));
    }
    tl::fence_proxy_async();
