...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc, __grid_constant__ const CUtensorMap X_desc_1) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int i_5 = 0; i_5 < 32; ++i_5) {
      *(float2*)(((float*)acc_wsp_handoff_2) + (((((((i_5 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_5 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((i_5 & 15) >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(acc + (i_5 * 2));
    }
    tl::fence_proxy_async();
    ...
    for (int ik = 0; ik < ((((int)blockIdx.y) * 2) + 2); ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(CB_desc, overlap_plan_mbar[3], (&(((half_t*)cb_shared)[0])), (ik * 64), (((int)blockIdx.y) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      }
      if (1 <= ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load((&(((half_t*)da_k_shared)[0])), (&(DA[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 64))])), overlap_plan_mbar[4], 128);
      }
      if (1 <= ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load((&(((half_t*)dt_shared)[0])), (&(Dt[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 64))])), overlap_plan_mbar[5], 128);
      }
      if (ik == 3) {
        overlap_plan_mbar[((ik % 3) + 14)].wait(0);
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((ik % 3) + 7)].arrive_and_expect_tx(8192);
        tl::tma_load(X_desc, overlap_plan_mbar[((ik % 3) + 7)], (&(((half_t*)x_shared)[((ik % 3) * 4096)])), 0, (((((int)blockIdx.z) >> 3) * 256) + (ik * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
      overlap_plan_mbar[3].wait((ik & 1));
      #pragma unroll
      for (int i_6 = 0; i_6 < 8; ++i_6) {
        tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[(((((i_6 & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((i_6 >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((i_6 & 3) >> 1) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(cb_local[(i_6 * 8)])));
      }
      ...
      for (int i_11 = 0; i_11 < 64; ++i_11) {
        half_t condval;
        if (((((((ik * 64) + ((i_11 >> 4) * 16)) + (((i_11 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_11 & 1)) <= (((((((int)blockIdx.y) * 128) + (((i_11 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_11 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
      ...
      for (int i_12 = 0; i_12 < 8; ++i_12) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)cb_local_wsp_handoff_6)[((((((i_12 & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((((int)threadIdx.x) & 15) * 64)) + ((i_12 >> 1) * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(cb_local[(i_12 * 8)], cb_local[((i_12 * 8) + 1)]), __pack_half2(cb_local[((i_12 * 8) + 2)], cb_local[((i_12 * 8) + 3)]), __pack_half2(cb_local[((i_12 * 8) + 4)], cb_local[((i_12 * 8) + 5)]), __pack_half2(cb_local[((i_12 * 8) + 6)], cb_local[((i_12 * 8) + 7)]));
      }
      tl::fence_proxy_async();
    ...
    for (int ik_1 = 0; ik_1 < ((((int)blockIdx.y) * 2) + 2); ++ik_1) {
      ...
      overlap_plan_mbar[((ik_1 % 3) + 7)].wait((ik_1 / 3));
      if (ik_1 == 0) {
        #pragma unroll
        for (int i_13 = 0; i_13 < 32; ++i_13) {
          *(float2*)(acc + (i_13 * 2)) = *(float2*)(((float*)acc_wsp_handoff_2) + ((((((((i_13 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_13 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((i_13 & 15) >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
        }
      }
      #pragma unroll
      for (int i_14 = 0; i_14 < 8; ++i_14) {
        tl::ptx_ldmatrix_x4((&(((half_t*)cb_local_wsp_handoff_6)[(((((((i_14 & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((((int)threadIdx.x) & 15) * 64)) + ((i_14 >> 1) * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 4096)])), (&(cb_local[(i_14 * 8)])));
      }
      {
        tl::GmmaDescriptor desc_b_1;
        tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_1, (&(((half_t*)x_shared)[0])));
        tl::increase_descriptor_offset<int>(desc_b_1, ((ik_1 % 3) * 8192));
      ...
      overlap_plan_mbar[((ik_1 % 3) + 14)].arrive();
    }
    ...
    for (int i_16 = 0; i_16 < 32; ++i_16) {
      ...
      *(uint1*)(residual_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)residual_shared) + ((((((((((i_16 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_16 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_16 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_16 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_16 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
      float2 __12;
      uint1 v__8 = *(uint1*)(residual_shared_local_cast_2 + 0);
      ((float2*)(&__12))[0] = __half22float2(((half2*)(&v__8))[0]);
      *(float2*)(residual_local + (i_16 * 2)) = __12;
    }
    #pragma unroll
    ...
    for (int i_18 = 0; i_18 < 8; ++i_18) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((i_18 >> 2) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_18 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_18 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) - 4096)])), __pack_half2(((half_t)acc[(i_18 * 8)]), ((half_t)acc[((i_18 * 8) + 1)])), __pack_half2(((half_t)acc[((i_18 * 8) + 2)]), ((half_t)acc[((i_18 * 8) + 3)])), __pack_half2(((half_t)acc[((i_18 * 8) + 4)]), ((half_t)acc[((i_18 * 8) + 5)])), __pack_half2(((half_t)acc[((i_18 * 8) + 6)]), ((half_t)acc[((i_18 * 8) + 7)])));
    }
    tl::__sync_thread_partial(4, 128);
