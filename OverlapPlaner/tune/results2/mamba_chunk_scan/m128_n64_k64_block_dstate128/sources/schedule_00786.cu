  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < ((((int)blockIdx.y) * 2) + 2); ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::fence_proxy_async();
        tl::tma_load(CB_desc, overlap_plan_mbar[2], (&(((half_t*)cb_shared)[0])), (ik * 64), (((int)blockIdx.y) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      }
      if (1 <= ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::fence_proxy_async();
        tl::tma_load((&(((half_t*)dt_shared)[0])), (&(Dt[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 64))])), overlap_plan_mbar[4], 128);
      }
      ...
      if (ik == ((((int)blockIdx.y) * 2) + 1)) {
        #pragma unroll
        for (int i_12 = 0; i_12 < 32; ++i_12) {
          *(float2*)(((float*)acc_wsp_handoff_6) + (((((((i_12 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_12 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((i_12 & 15) >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(acc + (i_12 * 2));
        }
      }
    ...
    for (int ik_1 = 0; ik_1 < ((((int)blockIdx.y) * 2) + 2); ++ik_1) {
      if (2 <= ik_1) {
        overlap_plan_mbar[((ik_1 & 1) + 12)].wait(0);
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[((ik_1 & 1) + 5)].arrive_and_expect_tx(8192);
        tl::tma_load(X_desc, overlap_plan_mbar[((ik_1 & 1) + 5)], (&(((half_t*)x_shared)[((ik_1 & 1) * 4096)])), 0, (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
    }
    ...
    for (int i_13 = 0; i_13 < 32; ++i_13) {
      ...
      *(uint1*)(residual_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)residual_shared) + ((((((((((i_13 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_13 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_13 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_13 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_13 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
      float2 __12;
    ...
    for (int i_14 = 0; i_14 < 32; ++i_14) {
      *(float2*)(acc + (i_14 * 2)) = *(float2*)(((float*)acc_wsp_handoff_6) + ((((((((i_14 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_14 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((i_14 & 15) >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
    }
    #pragma unroll
    ...
    for (int i_16 = 0; i_16 < 8; ++i_16) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((i_16 >> 2) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_16 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_16 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) - 4096)])), __pack_half2(((half_t)acc[(i_16 * 8)]), ((half_t)acc[((i_16 * 8) + 1)])), __pack_half2(((half_t)acc[((i_16 * 8) + 2)]), ((half_t)acc[((i_16 * 8) + 3)])), __pack_half2(((half_t)acc[((i_16 * 8) + 4)]), ((half_t)acc[((i_16 * 8) + 5)])), __pack_half2(((half_t)acc[((i_16 * 8) + 6)]), ((half_t)acc[((i_16 * 8) + 7)])));
    }
    tl::__sync_thread_partial(4, 128);
