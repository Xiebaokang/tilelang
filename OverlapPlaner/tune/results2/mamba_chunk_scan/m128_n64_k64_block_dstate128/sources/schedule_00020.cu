...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc, __grid_constant__ const CUtensorMap X_desc_1) {
  ...
  void* cb_shared = ((void*)((char*)buf_dyn_shmem + 74752));
  void* da_k_shared = ((void*)((char*)buf_dyn_shmem + 91136));
  ...
  for (int i_11 = 0; i_11 < 8; ++i_11) {
    ...
    *(float2*)(dt_local_v1 + (i_11 * 2)) = __10;
  }
  overlap_plan_mbar[11].arrive();
  #pragma unroll
  for (int i_12 = 0; i_12 < 32; ++i_12) {
    ...
    float2 __12;
      float2 __13;
      uint1 v__8 = *(uint1*)(cb_local_v1 + (i_12 * 2));
      ((float2*)(&__13))[0] = __half22float2(((half2*)(&v__8))[0]);
      float2 __14;
      float2 __15;
        float2 __16;
          float2 v__9 = make_float2(da_m_local[((((i_12 & 7) >> 2) * 2) + (i_12 & 1))], da_m_local[((((i_12 & 7) >> 2) * 2) + (i_12 & 1))]);
          float2 v__10 = *(float2*)(da_k_local + (((i_12 >> 3) * 4) + (((i_12 & 3) >> 1) * 2)));
  ...
  for (int i_14 = 0; i_14 < 64; ++i_14) {
    half_t condval;
    if (((((((i_14 >> 4) * 16) + (((i_14 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_14 & 1)) <= (((((((int)blockIdx.y) * 128) + (((i_14 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_14 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
  ...
  for (int ik = 0; ik < (((int)blockIdx.y) * 2); ++ik) {
    ...
    if (ik == 0) {
      {
        ...
        for (int i_15 = 0; i_15 < 2; ++i_15) {
          ...
          for (int ki_1 = 0; ki_1 < 4; ++ki_1) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v0 + ((ki_1 * 16) + (i_15 * 8))), uint64_t(desc_b_1 + ((ki_1 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_15 * 32)), 1);
          }
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
    ...
    } else {
      {
        ...
        for (int i_16 = 0; i_16 < 2; ++i_16) {
          ...
          for (int ki_2 = 0; ki_2 < 4; ++ki_2) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v1 + ((ki_2 * 16) + (i_16 * 8))), uint64_t(desc_b_2 + ((ki_2 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_16 * 32)), 1);
          }
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
    ...
    if (ik == 0) {
      ...
      for (int i_20 = 0; i_20 < 8; ++i_20) {
        ...
        *(uint1*)(dt_shared_local_cast_5 + 0) = *(uint1*)(((half_t*)dt_shared) + ((i_20 * 8) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __21;
        uint1 v__15 = *(uint1*)(dt_shared_local_cast_5 + 0);
        ((float2*)(&__21))[0] = __half22float2(((half2*)(&v__15))[0]);
        *(float2*)(dt_local_v0 + (i_20 * 2)) = __21;
      }
    } else {
      #pragma unroll
      for (int i_21 = 0; i_21 < 8; ++i_21) {
        ...
        *(float2*)(dt_local_v1 + (i_21 * 2)) = __22;
      }
    }
    overlap_plan_mbar[11].arrive();
    if (ik == 0) {
      ...
      for (int i_22 = 0; i_22 < 32; ++i_22) {
        ...
        float2 __24;
          float2 __25;
          uint1 v__17 = *(uint1*)(cb_local_v0 + (i_22 * 2));
          ((float2*)(&__25))[0] = __half22float2(((half2*)(&v__17))[0]);
          float2 __26;
          float2 __27;
            float2 __28;
              float2 v__18 = make_float2(da_m_local[((((i_22 & 7) >> 2) * 2) + (i_22 & 1))], da_m_local[((((i_22 & 7) >> 2) * 2) + (i_22 & 1))]);
              float2 v__19 = *(float2*)(da_k_local + (((i_22 >> 3) * 4) + (((i_22 & 3) >> 1) * 2)));
      ...
      for (int i_23 = 0; i_23 < 32; ++i_23) {
        ...
        float2 __30;
          float2 __31;
          uint1 v__21 = *(uint1*)(cb_local_v1 + (i_23 * 2));
    ...
    if (((ik + 1) % 2) == 0) {
      ...
      for (int i_26 = 0; i_26 < 64; ++i_26) {
        half_t condval_1;
        if ((((((((ik * 64) + ((i_26 >> 4) * 16)) + (((i_26 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_26 & 1)) + 64) <= (((((((int)blockIdx.y) * 128) + (((i_26 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_26 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
          condval_1 = cb_local_v0[i_26];
        } else {
          condval_1 = half_t(0x0p+0f/*0.000000e+00*/);
        }
        cb_local_v0[i_26] = condval_1;
      }
    } else {
      #pragma unroll
      for (int i_27 = 0; i_27 < 64; ++i_27) {
        half_t condval_2;
        if ((((((((ik * 64) + ((i_27 >> 4) * 16)) + (((i_27 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_27 & 1)) + 64) <= (((((((int)blockIdx.y) * 128) + (((i_27 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_27 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
          condval_2 = cb_local_v1[i_27];
        } else {
          condval_2 = half_t(0x0p+0f/*0.000000e+00*/);
        }
        cb_local_v1[i_27] = condval_2;
      }
    }
  }
  overlap_plan_mbar[((((int)blockIdx.y) * 2) + 5)].wait(0);
  {
    ...
    for (int i_28 = 0; i_28 < 2; ++i_28) {
      ...
      for (int ki_3 = 0; ki_3 < 4; ++ki_3) {
        tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v0 + ((ki_3 * 16) + (i_28 * 8))), uint64_t(desc_b_3 + ((ki_3 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_28 * 32)), 1);
      }
    }
    tl::warpgroup_commit_batch();
    tl::warpgroup_wait<0>();
  ...
  overlap_plan_mbar[((((int)blockIdx.y) * 2) + 12)].arrive();
  #pragma unroll
  for (int i_29 = 0; i_29 < 32; ++i_29) {
    uint1 __41;
    float2 __42;
      float2 __43;
      uint1 v__29 = *(uint1*)(cb_local_v1 + (i_29 * 2));
      ((float2*)(&__43))[0] = __half22float2(((half2*)(&v__29))[0]);
      float2 v__30 = *(float2*)(dt_local_v1 + (((i_29 >> 3) * 4) + (((i_29 & 3) >> 1) * 2)));
      __42.x = (__43.x*v__30.x);
      __42.y = (__43.y*v__30.y);
    ((half2*)(&__41))[0] = __float22half2_rn(((float2*)(&__42))[0]);
    *(uint1*)(cb_local_v1 + (i_29 * 2)) = __41;
  }
  #pragma unroll
  for (int i_30 = 0; i_30 < 64; ++i_30) {
    half_t condval_3;
    if ((((((((((int)blockIdx.y) * 128) + ((i_30 >> 4) * 16)) + (((i_30 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_30 & 1)) + 64) <= (((((((int)blockIdx.y) * 128) + (((i_30 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_30 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
      condval_3 = cb_local_v1[i_30];
    } else {
      condval_3 = half_t(0x0p+0f/*0.000000e+00*/);
    }
    cb_local_v1[i_30] = condval_3;
  }
  overlap_plan_mbar[((((((int)blockIdx.y) * 2) + 1) % 3) + 5)].wait((((((int)blockIdx.y) * 2) + 1) / 3));
  {
    tl::GmmaDescriptor desc_b_4;
    tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_4, (&(((half_t*)x_shared)[0])));
    tl::increase_descriptor_offset<int>(desc_b_4, ((((((int)blockIdx.y) * 2) + 1) % 3) * 8192));
    tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(cb_local_v1 + 0), 32);
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 64);
    tl::warpgroup_arrive();
    #pragma unroll
    for (int i_31 = 0; i_31 < 2; ++i_31) {
      ...
      for (int ki_4 = 0; ki_4 < 4; ++ki_4) {
        tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v1 + ((ki_4 * 16) + (i_31 * 8))), uint64_t(desc_b_4 + ((ki_4 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_31 * 32)), 1);
      }
    }
    tl::warpgroup_commit_batch();
    tl::warpgroup_wait<0>();
  ...
  overlap_plan_mbar[((((((int)blockIdx.y) * 2) + 1) % 3) + 12)].arrive();
  ...
  for (int i_32 = 0; i_32 < 32; ++i_32) {
    ...
    *(uint1*)(residual_shared_local_cast_7 + 0) = *(uint1*)(((half_t*)residual_shared) + (((((((((i_32 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_32 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_32 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_32 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_32 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    float2 __44;
    uint1 v__31 = *(uint1*)(residual_shared_local_cast_7 + 0);
    ((float2*)(&__44))[0] = __half22float2(((half2*)(&v__31))[0]);
    *(float2*)(residual_local + (i_32 * 2)) = __44;
  }
  #pragma unroll
  ...
  for (int i_34 = 0; i_34 < 8; ++i_34) {
    tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((i_34 >> 2) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_34 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_34 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc[(i_34 * 8)]), ((half_t)acc[((i_34 * 8) + 1)])), __pack_half2(((half_t)acc[((i_34 * 8) + 2)]), ((half_t)acc[((i_34 * 8) + 3)])), __pack_half2(((half_t)acc[((i_34 * 8) + 4)]), ((half_t)acc[((i_34 * 8) + 5)])), __pack_half2(((half_t)acc[((i_34 * 8) + 6)]), ((half_t)acc[((i_34 * 8) + 7)])));
  }
