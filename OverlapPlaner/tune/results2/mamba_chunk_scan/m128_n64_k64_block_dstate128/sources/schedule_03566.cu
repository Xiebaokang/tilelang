...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc, __grid_constant__ const CUtensorMap X_desc_1) {
  ...
  for (int ik = 0; ik < ((((int)blockIdx.y) * 2) + 1); ++ik) {
    ...
    for (int i_7 = 0; i_7 < 32; ++i_7) {
      *(uint1*)(cb_local + (i_7 * 2)) = *(uint1*)(((half_t*)cb_shared) + ((((((((((ik & 1) * 8192) + (((i_7 & 7) >> 2) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_7 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((i_7 >> 3) * 16) + (((i_7 & 3) >> 1) * 8)) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_7 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_7 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    }
    ...
    for (int i_12 = 0; i_12 < 8; ++i_12) {
      ...
      *(uint1*)(da_k_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)da_k_shared) + (((((ik + 1) & 1) * 64) + (i_12 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __12;
  ...
  for (int i_14 = 0; i_14 < 32; ++i_14) {
    *(uint1*)(cb_local + (i_14 * 2)) = *(uint1*)(((half_t*)cb_shared) + (((((((((((i_14 & 7) >> 2) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_14 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((i_14 >> 3) * 16) + (((i_14 & 3) >> 1) * 8)) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_14 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_14 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 8192));
  }
