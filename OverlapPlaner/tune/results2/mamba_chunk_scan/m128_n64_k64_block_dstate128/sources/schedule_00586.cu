...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc, __grid_constant__ const CUtensorMap X_desc_1) {
  ...
  for (int ik = 0; ik < ((((int)blockIdx.y) * 2) + 1); ++ik) {
    ...
    __syncthreads();
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[(((ik + 1) & 1) + 2)].arrive_and_expect_tx(16384);
      tl::tma_load(CB_desc, overlap_plan_mbar[(((ik + 1) & 1) + 2)], (&(((half_t*)cb_shared)[(((ik + 1) & 1) * 8192)])), ((ik * 64) + 64), (((int)blockIdx.y) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
    }
    if (1 <= ik) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load((&(((half_t*)dt_shared)[(((ik + 1) & 1) * 64)])), (&(Dt[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 64)) + 64)])), overlap_plan_mbar[(((ik + 1) & 1) + 6)], 128);
    }
    if (1 <= ik) {
    ...
    for (int i_5 = 0; i_5 < 32; ++i_5) {
      *(uint1*)(cb_local + (i_5 * 2)) = *(uint1*)(((half_t*)cb_shared) + ((((((((((ik & 1) * 8192) + (((i_5 & 7) >> 2) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_5 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((i_5 >> 3) * 16) + (((i_5 & 3) >> 1) * 8)) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_5 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_5 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    }
    ...
    for (int i_6 = 0; i_6 < 8; ++i_6) {
      ...
      *(uint1*)(da_k_shared_local_cast + 0) = *(uint1*)(((half_t*)da_k_shared) + ((((ik & 1) * 64) + (i_6 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __1;
    ...
    overlap_plan_mbar[((ik & 1) + 6)].wait((ik >> 1));
    #pragma unroll
    for (int i_7 = 0; i_7 < 8; ++i_7) {
      half_t dt_shared_local_cast_1[2];
      *(uint1*)(dt_shared_local_cast_1 + 0) = *(uint1*)(((half_t*)dt_shared) + ((((ik & 1) * 64) + (i_7 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __2;
  ...
  for (int i_12 = 0; i_12 < 32; ++i_12) {
    *(uint1*)(cb_local + (i_12 * 2)) = *(uint1*)(((half_t*)cb_shared) + (((((((((((i_12 & 7) >> 2) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_12 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((i_12 >> 3) * 16) + (((i_12 & 3) >> 1) * 8)) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_12 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_12 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 8192));
  }
  ...
  for (int i_13 = 0; i_13 < 8; ++i_13) {
    ...
    *(uint1*)(da_k_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)da_k_shared) + (((i_13 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 64));
    float2 __12;
  ...
  for (int i_14 = 0; i_14 < 8; ++i_14) {
    ...
    *(uint1*)(dt_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)dt_shared) + (((i_14 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 64));
    float2 __13;
