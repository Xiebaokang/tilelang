...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc, __grid_constant__ const CUtensorMap X_desc_1) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < ((((int)blockIdx.y) * 2) + 1); ++ik) {
      ...
      if (((ik + 1) % 2) == 0) {
        ...
        for (int i_11 = 0; i_11 < 32; ++i_11) {
          *(uint1*)(cb_local_v0 + (i_11 * 2)) = *(uint1*)(((half_t*)cb_shared) + (((((((((((ik + 1) & 1) * 8192) + (((i_11 & 7) >> 2) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_11 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((i_11 >> 3) * 16) + (((i_11 & 3) >> 1) * 8)) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_11 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_11 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        }
      } else {
        #pragma unroll
        for (int i_12 = 0; i_12 < 32; ++i_12) {
          *(uint1*)(cb_local_v1 + (i_12 * 2)) = *(uint1*)(((half_t*)cb_shared) + (((((((((((ik + 1) & 1) * 8192) + (((i_12 & 7) >> 2) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_12 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((i_12 >> 3) * 16) + (((i_12 & 3) >> 1) * 8)) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_12 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_12 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        }
      }
      ...
      if (((ik + 1) % 2) == 0) {
        ...
        for (int i_14 = 0; i_14 < 32; ++i_14) {
          ...
          float2 __14;
            float2 __15;
            uint1 v__9 = *(uint1*)(cb_local_v0 + (i_14 * 2));
            ((float2*)(&__15))[0] = __half22float2(((half2*)(&v__9))[0]);
            float2 __16;
            float2 __17;
              float2 __18;
                float2 v__10 = make_float2(da_m_local[((((i_14 & 7) >> 2) * 2) + (i_14 & 1))], da_m_local[((((i_14 & 7) >> 2) * 2) + (i_14 & 1))]);
                float2 v__11 = *(float2*)(da_k_local + (((i_14 >> 3) * 4) + (((i_14 & 3) >> 1) * 2)));
        ...
        for (int i_15 = 0; i_15 < 32; ++i_15) {
          ...
          float2 __20;
            float2 __21;
            uint1 v__13 = *(uint1*)(cb_local_v1 + (i_15 * 2));
            ((float2*)(&__21))[0] = __half22float2(((half2*)(&v__13))[0]);
            float2 __22;
            float2 __23;
              float2 __24;
                float2 v__14 = make_float2(da_m_local[((((i_15 & 7) >> 2) * 2) + (i_15 & 1))], da_m_local[((((i_15 & 7) >> 2) * 2) + (i_15 & 1))]);
                float2 v__15 = *(float2*)(da_k_local + (((i_15 >> 3) * 4) + (((i_15 & 3) >> 1) * 2)));
      ...
      for (int i_16 = 0; i_16 < 8; ++i_16) {
        ...
        *(uint1*)(dt_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)dt_shared) + (((((ik + 1) & 1) * 64) + (i_16 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __25;
        uint1 v__17 = *(uint1*)(dt_shared_local_cast_3 + 0);
        ((float2*)(&__25))[0] = __half22float2(((half2*)(&v__17))[0]);
        *(float2*)(dt_local + (i_16 * 2)) = __25;
      }
      ...
      if (((ik + 1) % 2) == 0) {
        ...
        for (int i_19 = 0; i_19 < 64; ++i_19) {
          half_t condval_1;
          if ((((((((ik * 64) + ((i_19 >> 4) * 16)) + (((i_19 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_19 & 1)) + 64) <= (((((((int)blockIdx.y) * 128) + (((i_19 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_19 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
            condval_1 = cb_local_v0[i_19];
          } else {
            condval_1 = half_t(0x0p+0f/*0.000000e+00*/);
          }
          cb_local_v0[i_19] = condval_1;
        }
      } else {
        #pragma unroll
        for (int i_20 = 0; i_20 < 64; ++i_20) {
          half_t condval_2;
          if ((((((((ik * 64) + ((i_20 >> 4) * 16)) + (((i_20 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_20 & 1)) + 64) <= (((((((int)blockIdx.y) * 128) + (((i_20 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_20 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
            condval_2 = cb_local_v1[i_20];
          } else {
            condval_2 = half_t(0x0p+0f/*0.000000e+00*/);
          }
          cb_local_v1[i_20] = condval_2;
        }
      }
      ...
      if ((ik % 2) == 0) {
      ...
      } else {
        {
          ...
          tl::increase_descriptor_offset<int>(desc_b_2, ((ik & 1) * 8192));
          ...
          for (int i_22 = 0; i_22 < 2; ++i_22) {
            ...
            for (int ki_2 = 0; ki_2 < 4; ++ki_2) {
              tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v1 + ((ki_2 * 16) + (i_22 * 8))), uint64_t(desc_b_2 + ((ki_2 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_22 * 32)), 1);
            }
          }
          tl::warpgroup_commit_batch();
          tl::warpgroup_wait<0>();
    ...
    overlap_plan_mbar[10].wait(((int)blockIdx.y));
    {
      ...
      for (int i_23 = 0; i_23 < 2; ++i_23) {
        ...
        for (int ki_3 = 0; ki_3 < 4; ++ki_3) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v1 + ((ki_3 * 16) + (i_23 * 8))), uint64_t(desc_b_3 + ((ki_3 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_23 * 32)), 1);
        }
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
    ...
    for (int i_24 = 0; i_24 < 32; ++i_24) {
      ...
      *(uint1*)(residual_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)residual_shared) + (((((((((i_24 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_24 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_24 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_24 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_24 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __32;
      uint1 v__22 = *(uint1*)(residual_shared_local_cast_4 + 0);
      ((float2*)(&__32))[0] = __half22float2(((half2*)(&v__22))[0]);
      *(float2*)(residual_local + (i_24 * 2)) = __32;
    }
    #pragma unroll
    for (int i_25 = 0; i_25 < 64; ++i_25) {
      acc[i_25] = (acc[i_25] + (residual_local[i_25] * d_local[0]));
    }
    #pragma unroll
    for (int i_26 = 0; i_26 < 8; ++i_26) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((i_26 >> 2) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_26 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_26 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc[(i_26 * 8)]), ((half_t)acc[((i_26 * 8) + 1)])), __pack_half2(((half_t)acc[((i_26 * 8) + 2)]), ((half_t)acc[((i_26 * 8) + 3)])), __pack_half2(((half_t)acc[((i_26 * 8) + 4)]), ((half_t)acc[((i_26 * 8) + 5)])), __pack_half2(((half_t)acc[((i_26 * 8) + 6)]), ((half_t)acc[((i_26 * 8) + 7)])));
    }
    ...
    for (int ik_1 = 0; ik_1 < ((((int)blockIdx.y) * 2) + 2); ++ik_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        ...
        tl::tma_load(CB_desc, overlap_plan_mbar[((ik_1 & 1) + 3)], (&(((half_t*)cb_shared)[((ik_1 & 1) * 8192)])), (ik_1 * 64), (((int)blockIdx.y) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      }
      if (2 <= ik_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[((ik_1 & 1) + 9)].arrive_and_expect_tx(8192);
        tl::tma_load(X_desc, overlap_plan_mbar[((ik_1 & 1) + 9)], (&(((half_t*)x_shared)[((ik_1 & 1) * 4096)])), 0, (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
