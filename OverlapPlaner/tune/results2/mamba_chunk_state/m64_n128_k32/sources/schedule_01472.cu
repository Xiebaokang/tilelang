  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 3; ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(B_desc, overlap_plan_mbar[8], (&(((half_t*)b_shared)[0])), 0, (((((int)blockIdx.z) >> 3) * 256) + (ik * 64)), 0, (((int)blockIdx.z) & 7));
        tl::tma_load(B_desc, overlap_plan_mbar[8], (&(((half_t*)b_shared)[2048])), 64, (((((int)blockIdx.z) >> 3) * 256) + (ik * 64)), 0, (((int)blockIdx.z) & 7));
      }
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[8].arrive_and_expect_tx(8192);
        tl::tma_load(B_desc, overlap_plan_mbar[8], (&(((half_t*)b_shared)[0])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 32), 0, (((int)blockIdx.z) & 7));
        tl::tma_load(B_desc, overlap_plan_mbar[8], (&(((half_t*)b_shared)[2048])), 64, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 32), 0, (((int)blockIdx.z) & 7));
      }
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[8].arrive_and_expect_tx(8192);
      tl::tma_load(B_desc, overlap_plan_mbar[8], (&(((half_t*)b_shared)[0])), 0, (((((int)blockIdx.z) >> 3) * 256) + 192), 0, (((int)blockIdx.z) & 7));
      tl::tma_load(B_desc, overlap_plan_mbar[8], (&(((half_t*)b_shared)[2048])), 64, (((((int)blockIdx.z) >> 3) * 256) + 192), 0, (((int)blockIdx.z) & 7));
    }
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[8].arrive_and_expect_tx(8192);
      tl::tma_load(B_desc, overlap_plan_mbar[8], (&(((half_t*)b_shared)[0])), 0, (((((int)blockIdx.z) >> 3) * 256) + 224), 0, (((int)blockIdx.z) & 7));
      tl::tma_load(B_desc, overlap_plan_mbar[8], (&(((half_t*)b_shared)[2048])), 64, (((((int)blockIdx.z) >> 3) * 256) + 224), 0, (((int)blockIdx.z) & 7));
    }
