...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* xt_local_wsp_handoff_3 = ((void*)((char*)buf_dyn_shmem + 20480));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 8; ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(B_desc, overlap_plan_mbar[((ik & 1) + 4)], (&(((half_t*)b_shared)[((ik & 1) * 4096)])), 0, (((((int)blockIdx.z) >> 3) * 256) + (ik * 32)), 0, (((int)blockIdx.z) & 7));
        tl::tma_load(B_desc, overlap_plan_mbar[((ik & 1) + 4)], (&(((half_t*)b_shared)[(((ik & 1) * 4096) + 2048)])), 64, (((((int)blockIdx.z) >> 3) * 256) + (ik * 32)), 0, (((int)blockIdx.z) & 7));
      }
    ...
    for (int i_8 = 0; i_8 < 8; ++i_8) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((((int)threadIdx.x) >> 5) * 2048) + ((((int)threadIdx.x) & 15) * 128)) + (i_8 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 8192)])), __pack_half2(((half_t)acc[(i_8 * 8)]), ((half_t)acc[((i_8 * 8) + 1)])), __pack_half2(((half_t)acc[((i_8 * 8) + 2)]), ((half_t)acc[((i_8 * 8) + 3)])), __pack_half2(((half_t)acc[((i_8 * 8) + 4)]), ((half_t)acc[((i_8 * 8) + 5)])), __pack_half2(((half_t)acc[((i_8 * 8) + 6)]), ((half_t)acc[((i_8 * 8) + 7)])));
    }
    tl::fence_proxy_async();
