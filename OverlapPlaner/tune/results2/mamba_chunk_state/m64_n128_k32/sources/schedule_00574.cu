...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap X_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(B_desc, overlap_plan_mbar[7], (&(((half_t*)b_shared)[2048])), 64, ((((int)blockIdx.z) >> 3) * 256), 0, (((int)blockIdx.z) & 7));
    }
    ...
    for (int ik = 0; ik < 3; ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(X_desc, overlap_plan_mbar[1], (&(((half_t*)x_shared)[2048])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 32), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
      overlap_plan_mbar[12].wait(0);
      tl::__sync_thread_partial(3, 128);
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[2].arrive_and_expect_tx(64);
        tl::tma_load((&(((half_t*)da_shared)[0])), (&(DA[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 64)) + 32)])), overlap_plan_mbar[2], 64);
      }
      overlap_plan_mbar[13].wait(0);
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[3].arrive_and_expect_tx(64);
        tl::tma_load((&(((half_t*)dt_shared)[0])), (&(Dt[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 64)) + 32)])), overlap_plan_mbar[3], 64);
      }
      if (1 <= ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(B_desc, overlap_plan_mbar[8], (&(((half_t*)b_shared)[4096])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 32), 0, (((int)blockIdx.z) & 7));
        tl::tma_load(B_desc, overlap_plan_mbar[8], (&(((half_t*)b_shared)[6144])), 64, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 32), 0, (((int)blockIdx.z) & 7));
      }
      overlap_plan_mbar[5].wait((ik & 1));
      overlap_plan_mbar[7].wait((ik & 1));
      #pragma unroll
      for (int i_5 = 0; i_5 < 8; ++i_5) {
        *(uint1*)(xt_local_v0 + (i_5 * 2)) = *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + ((((((((int)threadIdx.x) >> 5) * 512) + ((i_5 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_5 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      }
      {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[7].arrive_and_expect_tx(8192);
        tl::tma_load(B_desc, overlap_plan_mbar[7], (&(((half_t*)b_shared)[0])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 64), 0, (((int)blockIdx.z) & 7));
        tl::tma_load(B_desc, overlap_plan_mbar[7], (&(((half_t*)b_shared)[2048])), 64, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 64), 0, (((int)blockIdx.z) & 7));
      }
      overlap_plan_mbar[6].wait((ik & 1));
      overlap_plan_mbar[8].wait((ik & 1));
      #pragma unroll
      for (int i_10 = 0; i_10 < 8; ++i_10) {
        *(uint1*)(xt_local_v1 + (i_10 * 2)) = *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + (((((((((int)threadIdx.x) >> 5) * 512) + ((i_10 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_10 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 2048));
      }
      {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[1].arrive_and_expect_tx(4096);
      tl::tma_load(X_desc, overlap_plan_mbar[1], (&(((half_t*)x_shared)[2048])), 0, (((((int)blockIdx.z) >> 3) * 256) + 224), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
    overlap_plan_mbar[12].wait(0);
    tl::__sync_thread_partial(3, 128);
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[2].arrive_and_expect_tx(64);
      tl::tma_load((&(((half_t*)da_shared)[0])), (&(DA[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + 224)])), overlap_plan_mbar[2], 64);
    }
    overlap_plan_mbar[13].wait(0);
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[3].arrive_and_expect_tx(64);
      tl::tma_load((&(((half_t*)dt_shared)[0])), (&(Dt[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + 224)])), overlap_plan_mbar[3], 64);
    }
    overlap_plan_mbar[15].wait(0);
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[8].arrive_and_expect_tx(8192);
      tl::tma_load(B_desc, overlap_plan_mbar[8], (&(((half_t*)b_shared)[4096])), 0, (((((int)blockIdx.z) >> 3) * 256) + 224), 0, (((int)blockIdx.z) & 7));
      tl::tma_load(B_desc, overlap_plan_mbar[8], (&(((half_t*)b_shared)[6144])), 64, (((((int)blockIdx.z) >> 3) * 256) + 224), 0, (((int)blockIdx.z) & 7));
    }
    overlap_plan_mbar[5].wait(1);
    overlap_plan_mbar[7].wait(1);
    #pragma unroll
    for (int i_15 = 0; i_15 < 8; ++i_15) {
      *(uint1*)(xt_local_v0 + (i_15 * 2)) = *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + ((((((((int)threadIdx.x) >> 5) * 512) + ((i_15 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_15 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    }
    {
    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int ik_1 = 0; ik_1 < 4; ++ik_1) {
        overlap_plan_mbar[0].wait((ik_1 & 1));
        #pragma unroll
        ...
        for (int i_25 = 0; i_25 < 8; ++i_25) {
          *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + (((((((((int)threadIdx.x) >> 5) * 512) + ((i_25 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_25 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 2048)) = *(uint1*)(xt_local_v0 + (i_25 * 2));
        }
        tl::fence_proxy_async();
        ...
        for (int i_26 = 0; i_26 < 16; ++i_26) {
          x_local[i_26] = ((half_t*)x_shared)[(((((((((i_26 >> 2) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_26 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_26 & 3) >> 1) + (i_26 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) + 2048)];
        }
        ...
        for (int i_29 = 0; i_29 < 8; ++i_29) {
          *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + ((((((((int)threadIdx.x) >> 5) * 512) + ((i_29 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_29 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(xt_local_v1 + (i_29 * 2));
        }
        tl::fence_proxy_async();
