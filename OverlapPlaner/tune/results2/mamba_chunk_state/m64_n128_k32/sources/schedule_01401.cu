...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap X_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 3; ++ik) {
      overlap_plan_mbar[(((ik * 2) + 1) % 3)].wait((((ik * 2) + 1) / 3));
      #pragma unroll
      for (int i_1 = 0; i_1 < 16; ++i_1) {
        x_local_v1[i_1] = ((half_t*)x_shared)[(((((((((((ik * 2) + 1) % 3) * 2048) + ((i_1 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_1 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_1 & 3) >> 1) + (i_1 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
      }
      overlap_plan_mbar[((((ik * 2) + 1) % 3) + 13)].arrive();
      ...
      for (int i_5 = 0; i_5 < 16; ++i_5) {
        x_local_v0[i_5] = ((half_t*)x_shared)[(((((((((((ik * 2) + 2) % 3) * 2048) + ((i_5 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_5 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_5 & 3) >> 1) + (i_5 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
      }
      overlap_plan_mbar[((((ik * 2) + 2) % 3) + 13)].arrive();
    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int ik_1 = 0; ik_1 < 3; ++ik_1) {
        if (1 <= ik_1) {
          overlap_plan_mbar[((((ik_1 * 2) + 2) % 3) + 13)].wait((((ik_1 * 2) - 1) / 3));
        }
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          overlap_plan_mbar[(((ik_1 * 2) + 2) % 3)].arrive_and_expect_tx(4096);
          tl::tma_load(X_desc, overlap_plan_mbar[(((ik_1 * 2) + 2) % 3)], (&(((half_t*)x_shared)[((((ik_1 * 2) + 2) % 3) * 2048)])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)) + 64), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
        }
        overlap_plan_mbar[16].wait(1);
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          overlap_plan_mbar[3].arrive_and_expect_tx(64);
          tl::tma_load((&(((half_t*)da_shared)[0])), (&(DA[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik_1 * 64)) + 64)])), overlap_plan_mbar[3], 64);
        }
        overlap_plan_mbar[17].wait(1);
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          overlap_plan_mbar[4].arrive_and_expect_tx(64);
          tl::tma_load((&(((half_t*)dt_shared)[0])), (&(Dt[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik_1 * 64)) + 64)])), overlap_plan_mbar[4], 64);
        }
        overlap_plan_mbar[3].wait(0);
        tl::__sync_thread_partial(4, 128);
        #pragma unroll
        ...
        overlap_plan_mbar[5].arrive();
        if (1 <= ik_1) {
          overlap_plan_mbar[((((ik_1 * 2) + 2) % 3) + 18)].wait((((ik_1 * 2) - 1) / 3));
        }
        tl::__sync_thread_partial(4, 128);
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          overlap_plan_mbar[((((ik_1 * 2) + 2) % 3) + 9)].arrive_and_expect_tx(8192);
          tl::tma_load(B_desc, overlap_plan_mbar[((((ik_1 * 2) + 2) % 3) + 9)], (&(((half_t*)b_shared)[((((ik_1 * 2) + 2) % 3) * 4096)])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)) + 64), 0, (((int)blockIdx.z) & 7));
          tl::tma_load(B_desc, overlap_plan_mbar[((((ik_1 * 2) + 2) % 3) + 9)], (&(((half_t*)b_shared)[(((((ik_1 * 2) + 2) % 3) * 4096) + 2048)])), 64, ((((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)) + 64), 0, (((int)blockIdx.z) & 7));
        }
        overlap_plan_mbar[7].wait((ik_1 & 1));
        overlap_plan_mbar[(((ik_1 * 2) % 3) + 9)].wait(((ik_1 * 2) / 3));
        #pragma unroll
        ...
        }
        {
          ...
          tl::increase_descriptor_offset<int>(desc_b, (((ik_1 * 2) % 3) * 8192));
        ...
        overlap_plan_mbar[(((ik_1 * 2) % 3) + 18)].arrive();
        overlap_plan_mbar[(((ik_1 * 2) % 3) + 13)].wait(((ik_1 * 2) / 3));
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          overlap_plan_mbar[((ik_1 * 2) % 3)].arrive_and_expect_tx(4096);
          tl::tma_load(X_desc, overlap_plan_mbar[((ik_1 * 2) % 3)], (&(((half_t*)x_shared)[(((ik_1 * 2) % 3) * 2048)])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)) + 96), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
        }
        overlap_plan_mbar[16].wait(0);
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          overlap_plan_mbar[3].arrive_and_expect_tx(64);
          tl::tma_load((&(((half_t*)da_shared)[0])), (&(DA[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik_1 * 64)) + 96)])), overlap_plan_mbar[3], 64);
        }
        overlap_plan_mbar[17].wait(0);
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          overlap_plan_mbar[4].arrive_and_expect_tx(64);
          tl::tma_load((&(((half_t*)dt_shared)[0])), (&(Dt[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik_1 * 64)) + 96)])), overlap_plan_mbar[4], 64);
        }
        overlap_plan_mbar[3].wait(1);
        tl::__sync_thread_partial(4, 128);
        #pragma unroll
        ...
        tl::fence_proxy_async();
        overlap_plan_mbar[6].arrive();
        overlap_plan_mbar[(((ik_1 * 2) % 3) + 18)].wait(((ik_1 * 2) / 3));
        tl::__sync_thread_partial(4, 128);
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          overlap_plan_mbar[(((ik_1 * 2) % 3) + 9)].arrive_and_expect_tx(8192);
          tl::tma_load(B_desc, overlap_plan_mbar[(((ik_1 * 2) % 3) + 9)], (&(((half_t*)b_shared)[(((ik_1 * 2) % 3) * 4096)])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)) + 96), 0, (((int)blockIdx.z) & 7));
          tl::tma_load(B_desc, overlap_plan_mbar[(((ik_1 * 2) % 3) + 9)], (&(((half_t*)b_shared)[((((ik_1 * 2) % 3) * 4096) + 2048)])), 64, ((((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)) + 96), 0, (((int)blockIdx.z) & 7));
        }
        overlap_plan_mbar[8].wait((ik_1 & 1));
        overlap_plan_mbar[((((ik_1 * 2) + 1) % 3) + 9)].wait((((ik_1 * 2) + 1) / 3));
        #pragma unroll
        ...
        }
        {
          ...
          tl::increase_descriptor_offset<int>(desc_b_1, ((((ik_1 * 2) + 1) % 3) * 8192));
        ...
        overlap_plan_mbar[((((ik_1 * 2) + 1) % 3) + 18)].arrive();
      }
      ...
      for (int i_37 = 0; i_37 < 8; ++i_37) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((((int)threadIdx.x) >> 5) * 2048) + ((((int)threadIdx.x) & 15) * 128)) + (i_37 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 8192)])), __pack_half2(((half_t)acc[(i_37 * 8)]), ((half_t)acc[((i_37 * 8) + 1)])), __pack_half2(((half_t)acc[((i_37 * 8) + 2)]), ((half_t)acc[((i_37 * 8) + 3)])), __pack_half2(((half_t)acc[((i_37 * 8) + 4)]), ((half_t)acc[((i_37 * 8) + 5)])), __pack_half2(((half_t)acc[((i_37 * 8) + 6)]), ((half_t)acc[((i_37 * 8) + 7)])));
      }
      tl::fence_proxy_async();
