  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 3; ++ik) {
      ...
      for (int i_9 = 0; i_9 < 16; ++i_9) {
        x_local[i_9] = ((half_t*)x_shared)[(((((((((((ik * 2) + 1) % 3) * 2048) + ((i_9 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_9 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_9 & 3) >> 1) + (i_9 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
      }
      ...
      overlap_plan_mbar[(((ik * 2) % 3) + 20)].arrive();
      ...
      for (int i_14 = 0; i_14 < 16; ++i_14) {
        x_local[i_14] = ((half_t*)x_shared)[(((((((((((ik * 2) + 2) % 3) * 2048) + ((i_14 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_14 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_14 & 3) >> 1) + (i_14 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
      }
      ...
      overlap_plan_mbar[((((ik * 2) + 1) % 3) + 20)].arrive();
    }
