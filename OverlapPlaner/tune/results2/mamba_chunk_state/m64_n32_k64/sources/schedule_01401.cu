    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int ik_1 = 0; ik_1 < 2; ++ik_1) {
        ...
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          ...
          tl::tma_load(B_desc, overlap_plan_mbar[(((ik_1 + 2) % 3) + 9)], (&(((half_t*)b_shared)[(((ik_1 + 2) % 3) * 2048)])), (((int)blockIdx.y) * 32), ((((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)) + 128), 0, (((int)blockIdx.z) & 7));
        }
        ...
        if (ik_1 == 0) {
          ...
          }
          {
            ...
            tl::increase_descriptor_offset<int>(desc_b_1, (ik_1 * 4096));
      ...
      for (int i_35 = 0; i_35 < 2; ++i_35) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((((int)threadIdx.x) & 127) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + i_35) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(((half_t)acc[(i_35 * 8)]), ((half_t)acc[((i_35 * 8) + 1)])), __pack_half2(((half_t)acc[((i_35 * 8) + 2)]), ((half_t)acc[((i_35 * 8) + 3)])), __pack_half2(((half_t)acc[((i_35 * 8) + 4)]), ((half_t)acc[((i_35 * 8) + 5)])), __pack_half2(((half_t)acc[((i_35 * 8) + 6)]), ((half_t)acc[((i_35 * 8) + 7)])));
      }
      tl::fence_proxy_async();
