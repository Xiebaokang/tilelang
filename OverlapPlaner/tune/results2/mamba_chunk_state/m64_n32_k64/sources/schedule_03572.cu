...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 2; ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[(((ik + 1) & 1) + 4)].arrive_and_expect_tx(4096);
        tl::tma_load(B_desc, overlap_plan_mbar[(((ik + 1) & 1) + 4)], (&(((half_t*)b_shared)[(((ik + 1) & 1) * 2048)])), (((int)blockIdx.y) * 32), ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 64), 0, (((int)blockIdx.z) & 7));
      }
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(B_desc, overlap_plan_mbar[5], (&(((half_t*)b_shared)[2048])), (((int)blockIdx.y) * 32), (((((int)blockIdx.z) >> 3) * 256) + 192), 0, (((int)blockIdx.z) & 7));
    }
    ...
    for (int i_17 = 0; i_17 < 2; ++i_17) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + i_17) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(((half_t)acc[(i_17 * 8)]), ((half_t)acc[((i_17 * 8) + 1)])), __pack_half2(((half_t)acc[((i_17 * 8) + 2)]), ((half_t)acc[((i_17 * 8) + 3)])), __pack_half2(((half_t)acc[((i_17 * 8) + 4)]), ((half_t)acc[((i_17 * 8) + 5)])), __pack_half2(((half_t)acc[((i_17 * 8) + 6)]), ((half_t)acc[((i_17 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 128);
