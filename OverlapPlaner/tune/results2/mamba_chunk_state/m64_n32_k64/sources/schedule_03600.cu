...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  for (int i_8 = 0; i_8 < 32; ++i_8) {
    xt_local_v0[i_8] = ((half_t)(((float)x_local[((((i_8 >> 2) * 4) + ((i_8 & 1) * 2)) + ((i_8 & 3) >> 1))]) * scale_v0[(((i_8 >> 2) * 2) + (i_8 & 1))]));
  }
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
  ...
  for (int ik = 0; ik < 2; ++ik) {
    ...
    if (ik == 0) {
      ...
      for (int i_12 = 0; i_12 < 16; ++i_12) {
        scale_v1[i_12] = (exp2f(((da_last[0] - da_local[i_12]) * 0x1.7154764ee6c2fp+0f/*1.442695e+00*/)) * dt_local[i_12]);
      }
    }
    overlap_plan_mbar[((ik + 1) & 1)].wait(((ik + 1) >> 1));
    #pragma unroll
    for (int i_13 = 0; i_13 < 32; ++i_13) {
      x_local[i_13] = ((half_t*)x_shared)[((((((((((ik + 1) & 1) * 4096) + ((i_13 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_13 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_13 & 3) >> 1) + (i_13 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
    }
    overlap_plan_mbar[(((ik + 1) & 1) + 7)].arrive();
    if (((ik + 1) % 2) == 0) {
      #pragma unroll
      for (int i_14 = 0; i_14 < 32; ++i_14) {
        xt_local_v0[i_14] = ((half_t)(((float)x_local[((((i_14 >> 2) * 4) + ((i_14 & 1) * 2)) + ((i_14 & 3) >> 1))]) * scale_v0[(((i_14 >> 2) * 2) + (i_14 & 1))]));
      }
    } else {
      #pragma unroll
      for (int i_15 = 0; i_15 < 32; ++i_15) {
        xt_local_v1[i_15] = ((half_t)(((float)x_local[((((i_15 >> 2) * 4) + ((i_15 & 1) * 2)) + ((i_15 & 3) >> 1))]) * scale_v1[(((i_15 >> 2) * 2) + (i_15 & 1))]));
      }
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
  ...
  for (int i_17 = 0; i_17 < 32; ++i_17) {
    xt_local_v1[i_17] = ((half_t)(((float)x_local[((((i_17 >> 2) * 4) + ((i_17 & 1) * 2)) + ((i_17 & 3) >> 1))]) * scale_v1[(((i_17 >> 2) * 2) + (i_17 & 1))]));
  }
