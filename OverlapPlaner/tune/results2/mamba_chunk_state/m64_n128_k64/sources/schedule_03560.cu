...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap X_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int i_5 = 0; i_5 < 8; ++i_5) {
      ...
      *(uint1*)(da_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)da_shared) + (((i_5 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 64));
      float2 __3;
    ...
    for (int i_6 = 0; i_6 < 8; ++i_6) {
      ...
      *(uint1*)(dt_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)dt_shared) + (((i_6 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 64));
      float2 __4;
    ...
    for (int i_8 = 0; i_8 < 32; ++i_8) {
      x_local_v1[i_8] = ((half_t*)x_shared)[(((((((((i_8 >> 2) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_8 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_8 & 3) >> 1) + (i_8 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) + 4096)];
    }
    ...
    for (int ik = 0; ik < 2; ++ik) {
      ...
      for (int i_10 = 0; i_10 < 8; ++i_10) {
        ...
        *(uint1*)(da_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)da_shared) + (((ik * 64) + (i_10 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __5;
      ...
      for (int i_11 = 0; i_11 < 8; ++i_11) {
        ...
        *(uint1*)(dt_shared_local_cast_5 + 0) = *(uint1*)(((half_t*)dt_shared) + (((ik * 64) + (i_11 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __6;
      ...
      if (ik == 0) {
        ...
        for (int i_14 = 0; i_14 < 32; ++i_14) {
          x_local_v0[i_14] = ((half_t*)x_shared)[((((((((ik * 4096) + ((i_14 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_14 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_14 & 3) >> 1) + (i_14 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
        }
      } else {
        #pragma unroll
        for (int i_15 = 0; i_15 < 32; ++i_15) {
          x_local_v1[i_15] = ((half_t*)x_shared)[((((((((ik * 4096) + ((i_15 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_15 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_15 & 3) >> 1) + (i_15 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
        }
      }
      ...
      if (((ik + 1) % 2) == 0) {
        ...
        for (int i_16 = 0; i_16 < 32; ++i_16) {
          xt_local_v0[i_16] = ((half_t)(((float)x_local_v0[((((i_16 >> 2) * 4) + ((i_16 & 1) * 2)) + ((i_16 & 3) >> 1))]) * scale_v0[(((i_16 >> 2) * 2) + (i_16 & 1))]));
        }
      } else {
        #pragma unroll
        for (int i_17 = 0; i_17 < 32; ++i_17) {
          xt_local_v1[i_17] = ((half_t)(((float)x_local_v1[((((i_17 >> 2) * 4) + ((i_17 & 1) * 2)) + ((i_17 & 3) >> 1))]) * scale_v1[(((i_17 >> 2) * 2) + (i_17 & 1))]));
        }
      }
    ...
    for (int i_18 = 0; i_18 < 32; ++i_18) {
      xt_local_v1[i_18] = ((half_t)(((float)x_local_v1[((((i_18 >> 2) * 4) + ((i_18 & 1) * 2)) + ((i_18 & 3) >> 1))]) * scale_v1[(((i_18 >> 2) * 2) + (i_18 & 1))]));
    }
    ...
    for (int ik_1 = 0; ik_1 < 3; ++ik_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[((ik_1 + 1) & 1)].arrive_and_expect_tx(8192);
        tl::tma_load(X_desc, overlap_plan_mbar[((ik_1 + 1) & 1)], (&(((half_t*)x_shared)[(((ik_1 + 1) & 1) * 4096)])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)) + 64), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
      if (1 <= ik_1) {
        overlap_plan_mbar[(ik_1 + 9)].wait(0);
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[(((ik_1 + 1) & 1) + 2)].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)da_shared)[(((ik_1 + 1) & 1) * 64)])), (&(DA[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik_1 * 64)) + 64)])), overlap_plan_mbar[(((ik_1 + 1) & 1) + 2)], 128);
      }
      if (1 <= ik_1) {
        overlap_plan_mbar[(ik_1 + 11)].wait(0);
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[(((ik_1 + 1) & 1) + 4)].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)dt_shared)[(((ik_1 + 1) & 1) * 64)])), (&(Dt[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik_1 * 64)) + 64)])), overlap_plan_mbar[(((ik_1 + 1) & 1) + 4)], 128);
      }
      if (ik_1 == 2) {
        overlap_plan_mbar[((ik_1 & 1) + 14)].wait(0);
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[((ik_1 & 1) + 6)].arrive_and_expect_tx(16384);
        tl::tma_load(B_desc, overlap_plan_mbar[((ik_1 & 1) + 6)], (&(((half_t*)b_shared)[((ik_1 & 1) * 8192)])), 0, (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)), 0, (((int)blockIdx.z) & 7));
        tl::tma_load(B_desc, overlap_plan_mbar[((ik_1 & 1) + 6)], (&(((half_t*)b_shared)[(((ik_1 & 1) * 8192) + 4096)])), 64, (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)), 0, (((int)blockIdx.z) & 7));
      }
    }
    overlap_plan_mbar[15].wait(0);
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      overlap_plan_mbar[7].arrive_and_expect_tx(16384);
      tl::tma_load(B_desc, overlap_plan_mbar[7], (&(((half_t*)b_shared)[8192])), 0, (((((int)blockIdx.z) >> 3) * 256) + 192), 0, (((int)blockIdx.z) & 7));
      tl::tma_load(B_desc, overlap_plan_mbar[7], (&(((half_t*)b_shared)[12288])), 64, (((((int)blockIdx.z) >> 3) * 256) + 192), 0, (((int)blockIdx.z) & 7));
    }
  }
}
