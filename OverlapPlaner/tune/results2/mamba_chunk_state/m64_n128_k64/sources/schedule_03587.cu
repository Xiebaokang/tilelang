...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* da_shared = ((void*)((char*)buf_dyn_shmem + 49152));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int i_9 = 0; i_9 < 32; ++i_9) {
      x_local[i_9] = ((half_t*)x_shared)[(((((((((i_9 >> 2) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_9 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_9 & 3) >> 1) + (i_9 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) + 4096)];
    }
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(B_desc, overlap_plan_mbar[4], (&(((half_t*)b_shared)[4096])), 64, ((((int)blockIdx.z) >> 3) * 256), 0, (((int)blockIdx.z) & 7));
    }
    for (int ik = 0; ik < 2; ++ik) {
      ...
      overlap_plan_mbar[ik].wait(1);
      #pragma unroll
      for (int i_14 = 0; i_14 < 32; ++i_14) {
        x_local[i_14] = ((half_t*)x_shared)[((((((((ik * 4096) + ((i_14 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_14 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_14 & 3) >> 1) + (i_14 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
      }
      ...
      if (((ik + 2) % 3) == 0) {
        ...
        if (((ik + 2) % 3) == 1) {
          ...
          for (int i_16 = 0; i_16 < 32; ++i_16) {
            xt_local_v1[i_16] = ((half_t)(((float)x_local[((((i_16 >> 2) * 4) + ((i_16 & 1) * 2)) + ((i_16 & 3) >> 1))]) * scale[(((i_16 >> 2) * 2) + (i_16 & 1))]));
          }
        } else {
          #pragma unroll
          for (int i_17 = 0; i_17 < 32; ++i_17) {
            xt_local_v2[i_17] = ((half_t)(((float)x_local[((((i_17 >> 2) * 4) + ((i_17 & 1) * 2)) + ((i_17 & 3) >> 1))]) * scale[(((i_17 >> 2) * 2) + (i_17 & 1))]));
          }
        }
      }
      if (ik == 1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(B_desc, overlap_plan_mbar[(((ik + 1) & 1) + 4)], (&(((half_t*)b_shared)[(((ik + 1) & 1) * 8192)])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 64), 0, (((int)blockIdx.z) & 7));
        tl::tma_load(B_desc, overlap_plan_mbar[(((ik + 1) & 1) + 4)], (&(((half_t*)b_shared)[((((ik + 1) & 1) * 8192) + 4096)])), 64, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 64), 0, (((int)blockIdx.z) & 7));
      }
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(B_desc, overlap_plan_mbar[5], (&(((half_t*)b_shared)[8192])), 0, (((((int)blockIdx.z) >> 3) * 256) + 192), 0, (((int)blockIdx.z) & 7));
      tl::tma_load(B_desc, overlap_plan_mbar[5], (&(((half_t*)b_shared)[12288])), 64, (((((int)blockIdx.z) >> 3) * 256) + 192), 0, (((int)blockIdx.z) & 7));
    }
    ...
    for (int i_18 = 0; i_18 < 8; ++i_18) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((((int)threadIdx.x) >> 5) * 2048) + ((((int)threadIdx.x) & 15) * 128)) + (i_18 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(((half_t)acc[(i_18 * 8)]), ((half_t)acc[((i_18 * 8) + 1)])), __pack_half2(((half_t)acc[((i_18 * 8) + 2)]), ((half_t)acc[((i_18 * 8) + 3)])), __pack_half2(((half_t)acc[((i_18 * 8) + 4)]), ((half_t)acc[((i_18 * 8) + 5)])), __pack_half2(((half_t)acc[((i_18 * 8) + 6)]), ((half_t)acc[((i_18 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 128);
    ...
    for (int ik_1 = 0; ik_1 < 4; ++ik_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[(ik_1 & 1)].arrive_and_expect_tx(8192);
        tl::tma_load(X_desc, overlap_plan_mbar[(ik_1 & 1)], (&(((half_t*)x_shared)[((ik_1 & 1) * 4096)])), 0, (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
    }
  }
}
