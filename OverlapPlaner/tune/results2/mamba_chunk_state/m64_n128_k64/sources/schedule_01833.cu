...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* xt_local_wsp_handoff_4 = ((void*)((char*)buf_dyn_shmem + 57344));
  void* scale_wsp_handoff_3 = ((void*)((char*)buf_dyn_shmem + 65536));
  void* da_shared = ((void*)((char*)buf_dyn_shmem + 66560));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 2; ++ik) {
      ...
      tl::fence_proxy_async();
      overlap_plan_mbar[(((ik + 2) % 3) + 5)].arrive();
      if (ik == 1) {
        overlap_plan_mbar[(ik + 16)].wait(0);
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[(((ik + 1) & 1) + 9)].arrive_and_expect_tx(16384);
        tl::tma_load(B_desc, overlap_plan_mbar[(((ik + 1) & 1) + 9)], (&(((half_t*)b_shared)[(((ik + 1) & 1) * 8192)])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 64), 0, (((int)blockIdx.z) & 7));
        tl::tma_load(B_desc, overlap_plan_mbar[(((ik + 1) & 1) + 9)], (&(((half_t*)b_shared)[((((ik + 1) & 1) * 8192) + 4096)])), 64, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 64), 0, (((int)blockIdx.z) & 7));
      }
      ...
      }
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b, (ik * 16384));
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(B_desc, overlap_plan_mbar[10], (&(((half_t*)b_shared)[8192])), 0, (((((int)blockIdx.z) >> 3) * 256) + 192), 0, (((int)blockIdx.z) & 7));
      tl::tma_load(B_desc, overlap_plan_mbar[10], (&(((half_t*)b_shared)[12288])), 64, (((((int)blockIdx.z) >> 3) * 256) + 192), 0, (((int)blockIdx.z) & 7));
    }
    ...
    for (int i_20 = 0; i_20 < 8; ++i_20) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((((int)threadIdx.x) >> 5) * 2048) + ((((int)threadIdx.x) & 15) * 128)) + (i_20 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(((half_t)acc[(i_20 * 8)]), ((half_t)acc[((i_20 * 8) + 1)])), __pack_half2(((half_t)acc[((i_20 * 8) + 2)]), ((half_t)acc[((i_20 * 8) + 3)])), __pack_half2(((half_t)acc[((i_20 * 8) + 4)]), ((half_t)acc[((i_20 * 8) + 5)])), __pack_half2(((half_t)acc[((i_20 * 8) + 6)]), ((half_t)acc[((i_20 * 8) + 7)])));
    }
    tl::fence_proxy_async();
    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int ik_1 = 0; ik_1 < 2; ++ik_1) {
        overlap_plan_mbar[((ik_1 + 2) % 3)].wait(((ik_1 + 2) / 3));
        if (((ik_1 + 2) % 3) == 0) {
          #pragma unroll
          for (int i_23 = 0; i_23 < 32; ++i_23) {
            x_local_v0[i_23] = ((half_t*)x_shared)[((((((((((ik_1 + 2) % 3) * 4096) + ((i_23 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_23 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_23 & 3) >> 1) + (i_23 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
          }
        } else {
          if (((ik_1 + 2) % 3) == 1) {
            #pragma unroll
            for (int i_24 = 0; i_24 < 32; ++i_24) {
              x_local_v1[i_24] = ((half_t*)x_shared)[((((((((((ik_1 + 2) % 3) * 4096) + ((i_24 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_24 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_24 & 3) >> 1) + (i_24 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
            }
          } else {
            #pragma unroll
            for (int i_25 = 0; i_25 < 32; ++i_25) {
              x_local_v2[i_25] = ((half_t*)x_shared)[((((((((((ik_1 + 2) % 3) * 4096) + ((i_25 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_25 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_25 & 3) >> 1) + (i_25 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
            }
          }
        }
        overlap_plan_mbar[(((ik_1 + 2) % 3) + 12)].arrive();
        overlap_plan_mbar[(ik_1 + 5)].wait(0);
