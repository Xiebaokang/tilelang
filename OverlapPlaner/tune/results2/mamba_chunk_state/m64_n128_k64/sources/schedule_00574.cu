...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* xt_local_wsp_handoff_4 = ((void*)((char*)buf_dyn_shmem + 49152));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(B_desc, overlap_plan_mbar[7], (&(((half_t*)b_shared)[0])), 0, ((((int)blockIdx.z) >> 3) * 256), 0, (((int)blockIdx.z) & 7));
      tl::tma_load(B_desc, overlap_plan_mbar[7], (&(((half_t*)b_shared)[4096])), 64, ((((int)blockIdx.z) >> 3) * 256), 0, (((int)blockIdx.z) & 7));
    }
    ...
    for (int ik = 0; ik < 1; ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(B_desc, overlap_plan_mbar[8], (&(((half_t*)b_shared)[8192])), 0, (((((int)blockIdx.z) >> 3) * 256) + 64), 0, (((int)blockIdx.z) & 7));
        tl::tma_load(B_desc, overlap_plan_mbar[8], (&(((half_t*)b_shared)[12288])), 64, (((((int)blockIdx.z) >> 3) * 256) + 64), 0, (((int)blockIdx.z) & 7));
      }
      overlap_plan_mbar[5].wait(0);
      overlap_plan_mbar[7].wait(0);
      #pragma unroll
      for (int i_5 = 0; i_5 < 16; ++i_5) {
        *(uint1*)(xt_local_v0 + (i_5 * 2)) = *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + ((((((((int)threadIdx.x) >> 5) * 1024) + ((i_5 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_5 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      }
      {
      ...
      if (((((((int)threadIdx.x) & 31) >> 2) * 4) + (((int)threadIdx.x) >> 5)) == 0) {
        ...
        for (int i_9 = 0; i_9 < 8; ++i_9) {
          *(float2*)(((float*)scale_wsp_handoff_3) + ((i_9 * 8) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(scale + (i_9 * 2));
        }
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[4].arrive();
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[0].arrive_and_expect_tx(8192);
        tl::tma_load(X_desc, overlap_plan_mbar[0], (&(((half_t*)x_shared)[0])), 0, (((((int)blockIdx.z) >> 3) * 256) + 128), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[3].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)dt_shared)[0])), (&(Dt[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + 128)])), overlap_plan_mbar[3], 128);
      }
      overlap_plan_mbar[14].wait(0);
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[7].arrive_and_expect_tx(16384);
        tl::tma_load(B_desc, overlap_plan_mbar[7], (&(((half_t*)b_shared)[0])), 0, (((((int)blockIdx.z) >> 3) * 256) + 128), 0, (((int)blockIdx.z) & 7));
        tl::tma_load(B_desc, overlap_plan_mbar[7], (&(((half_t*)b_shared)[4096])), 64, (((((int)blockIdx.z) >> 3) * 256) + 128), 0, (((int)blockIdx.z) & 7));
      }
      overlap_plan_mbar[6].wait(0);
      overlap_plan_mbar[8].wait(0);
      #pragma unroll
      for (int i_10 = 0; i_10 < 16; ++i_10) {
        *(uint1*)(xt_local_v1 + (i_10 * 2)) = *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + (((((((((int)threadIdx.x) >> 5) * 1024) + ((i_10 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_10 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 4096));
      }
      {
      ...
      if (((((((int)threadIdx.x) & 31) >> 2) * 4) + (((int)threadIdx.x) >> 5)) == 0) {
        ...
        for (int i_14 = 0; i_14 < 8; ++i_14) {
          *(float2*)(((float*)scale_wsp_handoff_3) + ((i_14 * 8) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(scale + (i_14 * 2));
        }
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[4].arrive();
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[1].arrive_and_expect_tx(8192);
      tl::tma_load(X_desc, overlap_plan_mbar[1], (&(((half_t*)x_shared)[4096])), 0, (((((int)blockIdx.z) >> 3) * 256) + 192), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
    overlap_plan_mbar[12].wait(0);
    tl::__sync_thread_partial(3, 128);
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[2].arrive_and_expect_tx(128);
      tl::tma_load((&(((half_t*)da_shared)[0])), (&(DA[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + 192)])), overlap_plan_mbar[2], 128);
    }
    overlap_plan_mbar[13].wait(0);
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[3].arrive_and_expect_tx(128);
      tl::tma_load((&(((half_t*)dt_shared)[0])), (&(Dt[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + 192)])), overlap_plan_mbar[3], 128);
    }
    overlap_plan_mbar[15].wait(0);
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[8].arrive_and_expect_tx(16384);
      tl::tma_load(B_desc, overlap_plan_mbar[8], (&(((half_t*)b_shared)[8192])), 0, (((((int)blockIdx.z) >> 3) * 256) + 192), 0, (((int)blockIdx.z) & 7));
      tl::tma_load(B_desc, overlap_plan_mbar[8], (&(((half_t*)b_shared)[12288])), 64, (((((int)blockIdx.z) >> 3) * 256) + 192), 0, (((int)blockIdx.z) & 7));
    }
    overlap_plan_mbar[5].wait(1);
    overlap_plan_mbar[7].wait(1);
    #pragma unroll
    for (int i_15 = 0; i_15 < 16; ++i_15) {
      *(uint1*)(xt_local_v0 + (i_15 * 2)) = *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + ((((((((int)threadIdx.x) >> 5) * 1024) + ((i_15 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_15 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    }
    {
    ...
    if (((((((int)threadIdx.x) & 31) >> 2) * 4) + (((int)threadIdx.x) >> 5)) == 0) {
      ...
      for (int i_19 = 0; i_19 < 8; ++i_19) {
        *(float2*)(((float*)scale_wsp_handoff_3) + ((i_19 * 8) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(scale + (i_19 * 2));
      }
    }
    tl::fence_proxy_async();
    overlap_plan_mbar[4].arrive();
    ...
    for (int i_20 = 0; i_20 < 16; ++i_20) {
      *(uint1*)(xt_local_v1 + (i_20 * 2)) = *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + (((((((((int)threadIdx.x) >> 5) * 1024) + ((i_20 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_20 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 4096));
    }
    {
    ...
    if (((int)threadIdx.x) < 256) {
      tl::warpgroup_reg_dealloc<56>();
      for (int ik_1 = 0; ik_1 < 2; ++ik_1) {
        overlap_plan_mbar[0].wait(ik_1);
        #pragma unroll
        for (int i_22 = 0; i_22 < 32; ++i_22) {
          x_local[i_22] = ((half_t*)x_shared)[((((((((i_22 >> 2) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_22 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_22 & 3) >> 1) + (i_22 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
        }
        overlap_plan_mbar[10].arrive();
        overlap_plan_mbar[4].wait(0);
        #pragma unroll
        for (int i_23 = 0; i_23 < 8; ++i_23) {
          *(float2*)(scale + (i_23 * 2)) = *(float2*)(((float*)scale_wsp_handoff_3) + ((i_23 * 8) + ((((int)threadIdx.x) & 3) * 2)));
        }
        #pragma unroll
        for (int i_24 = 0; i_24 < 32; ++i_24) {
          xt_local_v0[i_24] = ((half_t)(((float)x_local[((((i_24 >> 2) * 4) + ((i_24 & 1) * 2)) + ((i_24 & 3) >> 1))]) * scale[(((i_24 >> 2) * 2) + (i_24 & 1))]));
        }
        #pragma unroll
        for (int i_25 = 0; i_25 < 16; ++i_25) {
          *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + (((((((((int)threadIdx.x) >> 5) * 1024) + ((i_25 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_25 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096)) = *(uint1*)(xt_local_v0 + (i_25 * 2));
        }
        tl::fence_proxy_async();
        overlap_plan_mbar[5].arrive();
        overlap_plan_mbar[1].wait(ik_1);
        #pragma unroll
        for (int i_26 = 0; i_26 < 32; ++i_26) {
          x_local[i_26] = ((half_t*)x_shared)[(((((((((i_26 >> 2) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_26 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_26 & 3) >> 1) + (i_26 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) + 4096)];
        }
        overlap_plan_mbar[11].arrive();
        overlap_plan_mbar[4].wait(1);
        #pragma unroll
        for (int i_27 = 0; i_27 < 8; ++i_27) {
          *(float2*)(scale + (i_27 * 2)) = *(float2*)(((float*)scale_wsp_handoff_3) + ((i_27 * 8) + ((((int)threadIdx.x) & 3) * 2)));
        }
        #pragma unroll
        for (int i_28 = 0; i_28 < 32; ++i_28) {
          xt_local_v1[i_28] = ((half_t)(((float)x_local[((((i_28 >> 2) * 4) + ((i_28 & 1) * 2)) + ((i_28 & 3) >> 1))]) * scale[(((i_28 >> 2) * 2) + (i_28 & 1))]));
        }
        #pragma unroll
        for (int i_29 = 0; i_29 < 16; ++i_29) {
          *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + ((((((((int)threadIdx.x) >> 5) * 1024) + ((i_29 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_29 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(xt_local_v1 + (i_29 * 2));
        }
        tl::fence_proxy_async();
