...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* da_shared = ((void*)((char*)buf_dyn_shmem + 73728));
  void* dt_shared = ((void*)((char*)buf_dyn_shmem + 74752));
  void* acc_shared = ((void*)((char*)buf_dyn_shmem + 75776));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 1; ++ik) {
      ...
      for (int i_11 = 0; i_11 < 8; ++i_11) {
        ...
        *(uint1*)(da_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)da_shared) + (((i_11 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 128));
        float2 __5;
      ...
      for (int i_12 = 0; i_12 < 8; ++i_12) {
        ...
        *(uint1*)(dt_shared_local_cast_5 + 0) = *(uint1*)(((half_t*)dt_shared) + (((i_12 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 128));
        float2 __6;
      ...
      for (int i_14 = 0; i_14 < 32; ++i_14) {
        x_local[i_14] = ((half_t*)x_shared)[(((((((((i_14 >> 2) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_14 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_14 & 3) >> 1) + (i_14 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) + 8192)];
      }
    ...
    for (int ik_1 = 0; ik_1 < 4; ++ik_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[((ik_1 % 3) + 9)].arrive_and_expect_tx(16384);
        tl::tma_load(B_desc, overlap_plan_mbar[((ik_1 % 3) + 9)], (&(((half_t*)b_shared)[((ik_1 % 3) * 8192)])), 0, (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)), 0, (((int)blockIdx.z) & 7));
        tl::tma_load(B_desc, overlap_plan_mbar[((ik_1 % 3) + 9)], (&(((half_t*)b_shared)[(((ik_1 % 3) * 8192) + 4096)])), 64, (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)), 0, (((int)blockIdx.z) & 7));
      }
    }
  }
}
