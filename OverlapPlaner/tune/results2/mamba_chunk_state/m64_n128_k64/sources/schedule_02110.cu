...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap X_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int i_6 = 0; i_6 < 8; ++i_6) {
      ...
      *(uint1*)(da_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)da_shared) + (((i_6 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 64));
      float2 __3;
    ...
    for (int i_7 = 0; i_7 < 8; ++i_7) {
      ...
      *(uint1*)(dt_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)dt_shared) + (((i_7 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 64));
      float2 __4;
    ...
    for (int i_8 = 0; i_8 < 32; ++i_8) {
      x_local[i_8] = ((half_t*)x_shared)[(((((((((i_8 >> 2) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_8 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_8 & 3) >> 1) + (i_8 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) + 4096)];
    }
    ...
    for (int ik = 0; ik < 2; ++ik) {
      ...
      for (int i_11 = 0; i_11 < 8; ++i_11) {
        ...
        *(uint1*)(da_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)da_shared) + (((ik * 64) + (i_11 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __5;
      ...
      for (int i_12 = 0; i_12 < 8; ++i_12) {
        ...
        *(uint1*)(dt_shared_local_cast_5 + 0) = *(uint1*)(((half_t*)dt_shared) + (((ik * 64) + (i_12 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __6;
      ...
      for (int i_13 = 0; i_13 < 32; ++i_13) {
        x_local[i_13] = ((half_t*)x_shared)[((((((((ik * 4096) + ((i_13 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_13 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_13 & 3) >> 1) + (i_13 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
      }
    ...
    for (int i_17 = 0; i_17 < 8; ++i_17) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((((int)threadIdx.x) >> 5) * 2048) + ((((int)threadIdx.x) & 15) * 128)) + (i_17 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(((half_t)acc[(i_17 * 8)]), ((half_t)acc[((i_17 * 8) + 1)])), __pack_half2(((half_t)acc[((i_17 * 8) + 2)]), ((half_t)acc[((i_17 * 8) + 3)])), __pack_half2(((half_t)acc[((i_17 * 8) + 4)]), ((half_t)acc[((i_17 * 8) + 5)])), __pack_half2(((half_t)acc[((i_17 * 8) + 6)]), ((half_t)acc[((i_17 * 8) + 7)])));
    }
