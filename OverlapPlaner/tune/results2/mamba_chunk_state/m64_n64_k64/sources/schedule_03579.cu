  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 3; ++ik) {
      ...
      for (int i_6 = 0; i_6 < 8; ++i_6) {
        ...
        *(uint1*)(da_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)da_shared) + (((((ik + 1) & 1) * 64) + (i_6 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __3;
      ...
      for (int i_7 = 0; i_7 < 8; ++i_7) {
        ...
        *(uint1*)(dt_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)dt_shared) + (((((ik + 1) % 3) * 64) + (i_7 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __4;
        uint1 v__3 = *(uint1*)(dt_shared_local_cast_3 + 0);
        ((float2*)(&__4))[0] = __half22float2(((half2*)(&v__3))[0]);
        *(float2*)(dt_local + (i_7 * 2)) = __4;
      }
      overlap_plan_mbar[(((ik + 1) % 3) + 13)].arrive();
      overlap_plan_mbar[((ik + 1) & 1)].wait(((ik + 1) >> 1));
      #pragma unroll
      for (int i_8 = 0; i_8 < 32; ++i_8) {
        x_local[i_8] = ((half_t*)x_shared)[((((((((((ik + 1) & 1) * 4096) + ((i_8 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_8 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_8 & 3) >> 1) + (i_8 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
      }
      overlap_plan_mbar[(((ik + 1) & 1) + 9)].arrive();
      #pragma unroll
