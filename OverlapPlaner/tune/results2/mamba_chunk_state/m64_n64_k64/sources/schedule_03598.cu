...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  for (int ik = 0; ik < 1; ++ik) {
    ...
    for (int i_4 = 0; i_4 < 16; ++i_4) {
      scale[i_4] = (exp2f(((da_last[0] - da_local_v0[i_4]) * 0x1.7154764ee6c2fp+0f/*1.442695e+00*/)) * dt_local[i_4]);
    }
    overlap_plan_mbar[3].wait(1);
    #pragma unroll
    for (int i_5 = 0; i_5 < 8; ++i_5) {
      half_t dt_shared_local_cast_3[2];
      *(uint1*)(dt_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)dt_shared) + ((i_5 * 8) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __4;
      uint1 v__3 = *(uint1*)(dt_shared_local_cast_3 + 0);
      ((float2*)(&__4))[0] = __half22float2(((half2*)(&v__3))[0]);
      *(float2*)(dt_local + (i_5 * 2)) = __4;
    }
    overlap_plan_mbar[9].arrive();
    ...
    for (int i_9 = 0; i_9 < 16; ++i_9) {
      scale[i_9] = (exp2f(((da_last[0] - da_local_v1[i_9]) * 0x1.7154764ee6c2fp+0f/*1.442695e+00*/)) * dt_local[i_9]);
    }
    overlap_plan_mbar[3].wait(0);
    #pragma unroll
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[4].arrive_and_expect_tx(8192);
      tl::tma_load(B_desc, overlap_plan_mbar[4], (&(((half_t*)b_shared)[0])), (((int)blockIdx.y) * 64), (((((int)blockIdx.z) >> 3) * 256) + 128), 0, (((int)blockIdx.z) & 7));
    }
  ...
  for (int i_14 = 0; i_14 < 16; ++i_14) {
    scale[i_14] = (exp2f(((da_last[0] - da_local_v0[i_14]) * 0x1.7154764ee6c2fp+0f/*1.442695e+00*/)) * dt_local[i_14]);
  }
  overlap_plan_mbar[3].wait(1);
  #pragma unroll
  ...
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    overlap_plan_mbar[5].arrive_and_expect_tx(8192);
    tl::tma_load(B_desc, overlap_plan_mbar[5], (&(((half_t*)b_shared)[4096])), (((int)blockIdx.y) * 64), (((((int)blockIdx.z) >> 3) * 256) + 192), 0, (((int)blockIdx.z) & 7));
  }
  ...
  for (int i_18 = 0; i_18 < 16; ++i_18) {
    scale[i_18] = (exp2f(((da_last[0] - da_local_v1[i_18]) * 0x1.7154764ee6c2fp+0f/*1.442695e+00*/)) * dt_local[i_18]);
  }
