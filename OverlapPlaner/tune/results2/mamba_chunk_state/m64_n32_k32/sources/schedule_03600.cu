  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 3; ++ik) {
      ...
      for (int i_9 = 0; i_9 < 4; ++i_9) {
        ...
        *(uint1*)(da_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)da_shared) + ((((((ik * 2) + 2) % 3) * 32) + (i_9 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __5;
      ...
      overlap_plan_mbar[((((ik * 2) + 1) % 3) + 12)].arrive();
      #pragma unroll
      ...
      for (int i_14 = 0; i_14 < 4; ++i_14) {
        ...
        *(uint1*)(da_shared_local_cast_6 + 0) = *(uint1*)(((half_t*)da_shared) + (((((ik * 2) % 3) * 32) + (i_14 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __7;
    ...
    for (int ik_1 = 0; ik_1 < 7; ++ik_1) {
      ...
      if (2 <= ik_1) {
        overlap_plan_mbar[(((ik_1 + 1) % 3) + 18)].wait(((ik_1 - 2) / 3));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[(((ik_1 + 1) % 3) + 6)].arrive_and_expect_tx(64);
        tl::tma_load((&(((half_t*)dt_shared)[(((ik_1 + 1) % 3) * 32)])), (&(Dt[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik_1 * 32)) + 32)])), overlap_plan_mbar[(((ik_1 + 1) % 3) + 6)], 64);
      }
      if (3 <= ik_1) {
        overlap_plan_mbar[((ik_1 % 3) + 21)].wait(((ik_1 / 3) - 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[((ik_1 % 3) + 9)].arrive_and_expect_tx(2048);
        tl::tma_load(B_desc, overlap_plan_mbar[((ik_1 % 3) + 9)], (&(((half_t*)b_shared)[((ik_1 % 3) * 1024)])), (((int)blockIdx.y) * 32), (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 32)), 0, (((int)blockIdx.z) & 7));
      }
    }
    overlap_plan_mbar[22].wait(1);
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
