...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* scale_wsp_handoff_3 = ((void*)((char*)buf_dyn_shmem + 16384));
  void* da_shared = ((void*)((char*)buf_dyn_shmem + 17408));
  void* dt_shared = ((void*)((char*)buf_dyn_shmem + 18432));
  void* acc_shared = ((void*)((char*)buf_dyn_shmem + 19456));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    if (((int)threadIdx.x) < 256) {
      ...
      tl::__sync_thread_partial(4, 128);
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[7].arrive_and_expect_tx(2048);
      ...
      for (int ik_1 = 0; ik_1 < 7; ++ik_1) {
        ...
        tl::__sync_thread_partial(4, 128);
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          overlap_plan_mbar[(((ik_1 + 1) & 1) + 7)].arrive_and_expect_tx(2048);
          tl::tma_load(B_desc, overlap_plan_mbar[(((ik_1 + 1) & 1) + 7)], (&(((half_t*)b_shared)[(((ik_1 + 1) & 1) * 1024)])), (((int)blockIdx.y) * 32), ((((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 32)) + 32), 0, (((int)blockIdx.z) & 7));
        }
        ...
        }
        {
          ...
          tl::increase_descriptor_offset<int>(desc_b, ((ik_1 & 1) * 2048));
      ...
      for (int i_29 = 0; i_29 < 2; ++i_29) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((((int)threadIdx.x) & 127) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + i_29) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(((half_t)acc[(i_29 * 8)]), ((half_t)acc[((i_29 * 8) + 1)])), __pack_half2(((half_t)acc[((i_29 * 8) + 2)]), ((half_t)acc[((i_29 * 8) + 3)])), __pack_half2(((half_t)acc[((i_29 * 8) + 4)]), ((half_t)acc[((i_29 * 8) + 5)])), __pack_half2(((half_t)acc[((i_29 * 8) + 6)]), ((half_t)acc[((i_29 * 8) + 7)])));
      }
      tl::fence_proxy_async();
