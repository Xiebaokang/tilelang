...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(B_desc, overlap_plan_mbar[4], (&(((half_t*)b_shared)[0])), (((int)blockIdx.y) * 32), ((((int)blockIdx.z) >> 3) * 256), 0, (((int)blockIdx.z) & 7));
    }
    for (int ik = 0; ik < 2; ++ik) {
      ...
      overlap_plan_mbar[9].wait((((ik * 3) + 1) & 1));
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[3].arrive_and_expect_tx(64);
      ...
      overlap_plan_mbar[ik].wait(((ik + 1) & 1));
      #pragma unroll
      for (int i_14 = 0; i_14 < 16; ++i_14) {
        x_local[i_14] = ((half_t*)x_shared)[((((((((ik * 2048) + ((i_14 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_14 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_14 & 3) >> 1) + (i_14 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
      }
      overlap_plan_mbar[(ik + 6)].arrive();
      #pragma unroll
      for (int i_15 = 0; i_15 < 16; ++i_15) {
        xt_local_v2[i_15] = ((half_t)(((float)x_local[((((i_15 >> 2) * 4) + ((i_15 & 1) * 2)) + ((i_15 & 3) >> 1))]) * scale[(((i_15 >> 2) * 2) + (i_15 & 1))]));
      }
      if (ik == 1) {
        overlap_plan_mbar[((((ik * 3) + 1) & 1) + 10)].wait(((((ik * 3) + 3) & 3) >> 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((((ik * 3) + 1) & 1) + 4)].arrive_and_expect_tx(2048);
        tl::tma_load(B_desc, overlap_plan_mbar[((((ik * 3) + 1) & 1) + 4)], (&(((half_t*)b_shared)[((((ik * 3) + 1) & 1) * 1024)])), (((int)blockIdx.y) * 32), ((((((int)blockIdx.z) >> 3) * 256) + (ik * 96)) + 32), 0, (((int)blockIdx.z) & 7));
      }
      ...
      overlap_plan_mbar[(ik + 10)].arrive();
      ...
      overlap_plan_mbar[(((ik * 3) + 1) & 1)].wait((((((ik * 3) + 1) >> 1) + 1) & 1));
      #pragma unroll
      for (int i_19 = 0; i_19 < 16; ++i_19) {
        x_local[i_19] = ((half_t*)x_shared)[(((((((((((ik * 3) + 1) & 1) * 2048) + ((i_19 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_19 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_19 & 3) >> 1) + (i_19 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
      }
      overlap_plan_mbar[((((ik * 3) + 1) & 1) + 6)].arrive();
      #pragma unroll
      for (int i_20 = 0; i_20 < 16; ++i_20) {
        xt_local_v0[i_20] = ((half_t)(((float)x_local[((((i_20 >> 2) * 4) + ((i_20 & 1) * 2)) + ((i_20 & 3) >> 1))]) * scale[(((i_20 >> 2) * 2) + (i_20 & 1))]));
      }
      overlap_plan_mbar[(ik + 10)].wait(ik);
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[(ik + 4)].arrive_and_expect_tx(2048);
        tl::tma_load(B_desc, overlap_plan_mbar[(ik + 4)], (&(((half_t*)b_shared)[(ik * 1024)])), (((int)blockIdx.y) * 32), ((((((int)blockIdx.z) >> 3) * 256) + (ik * 96)) + 64), 0, (((int)blockIdx.z) & 7));
      }
      ...
      overlap_plan_mbar[((((ik * 3) + 1) & 1) + 10)].arrive();
      overlap_plan_mbar[8].wait((((ik * 3) + 1) & 1));
      tl::__sync_thread_partial(3, 128);
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[2].arrive_and_expect_tx(64);
      ...
      overlap_plan_mbar[ik].wait(ik);
      #pragma unroll
      for (int i_24 = 0; i_24 < 16; ++i_24) {
        x_local[i_24] = ((half_t*)x_shared)[((((((((ik * 2048) + ((i_24 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_24 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_24 & 3) >> 1) + (i_24 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
      }
      overlap_plan_mbar[(ik + 6)].arrive();
      #pragma unroll
      ...
      overlap_plan_mbar[((((ik * 3) + 1) & 1) + 10)].wait(((((ik * 3) + 1) & 3) >> 1));
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((((ik * 3) + 1) & 1) + 4)].arrive_and_expect_tx(2048);
        tl::tma_load(B_desc, overlap_plan_mbar[((((ik * 3) + 1) & 1) + 4)], (&(((half_t*)b_shared)[((((ik * 3) + 1) & 1) * 1024)])), (((int)blockIdx.y) * 32), ((((((int)blockIdx.z) >> 3) * 256) + (ik * 96)) + 96), 0, (((int)blockIdx.z) & 7));
      }
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[5].arrive_and_expect_tx(2048);
      tl::tma_load(B_desc, overlap_plan_mbar[5], (&(((half_t*)b_shared)[1024])), (((int)blockIdx.y) * 32), (((((int)blockIdx.z) >> 3) * 256) + 224), 0, (((int)blockIdx.z) & 7));
    }
    ...
    for (int ik_1 = 0; ik_1 < 8; ++ik_1) {
      if (2 <= ik_1) {
        overlap_plan_mbar[((ik_1 & 1) + 6)].wait((((ik_1 >> 1) + 1) & 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[(ik_1 & 1)].arrive_and_expect_tx(4096);
        tl::tma_load(X_desc, overlap_plan_mbar[(ik_1 & 1)], (&(((half_t*)x_shared)[((ik_1 & 1) * 2048)])), 0, (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 32)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
    }
  }
}
