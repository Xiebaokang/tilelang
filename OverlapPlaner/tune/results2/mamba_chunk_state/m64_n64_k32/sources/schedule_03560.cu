...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 2; ++ik) {
      overlap_plan_mbar[(ik + 2)].wait(((ik + 1) & 1));
      #pragma unroll
      for (int i_11 = 0; i_11 < 4; ++i_11) {
        half_t da_shared_local_cast_4[2];
        *(uint1*)(da_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)da_shared) + (((ik * 32) + (i_11 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __5;
      ...
      for (int i_12 = 0; i_12 < 4; ++i_12) {
        ...
        *(uint1*)(dt_shared_local_cast_5 + 0) = *(uint1*)(((half_t*)dt_shared) + (((ik * 32) + (i_12 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __6;
      ...
      overlap_plan_mbar[(ik + 6)].wait(ik);
      {
      ...
      overlap_plan_mbar[((((ik * 3) + 1) & 1) + 2)].wait((((((ik * 3) + 1) >> 1) + 1) & 1));
      #pragma unroll
      for (int i_16 = 0; i_16 < 4; ++i_16) {
        half_t da_shared_local_cast_6[2];
        *(uint1*)(da_shared_local_cast_6 + 0) = *(uint1*)(((half_t*)da_shared) + ((((((ik * 3) + 1) & 1) * 32) + (i_16 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __7;
      ...
      overlap_plan_mbar[((((ik * 3) + 1) & 1) + 4)].wait((((((ik * 3) + 1) >> 1) + 1) & 1));
      #pragma unroll
      for (int i_17 = 0; i_17 < 4; ++i_17) {
        half_t dt_shared_local_cast_7[2];
        *(uint1*)(dt_shared_local_cast_7 + 0) = *(uint1*)(((half_t*)dt_shared) + ((((((ik * 3) + 1) & 1) * 32) + (i_17 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __8;
        uint1 v__7 = *(uint1*)(dt_shared_local_cast_7 + 0);
        ((float2*)(&__8))[0] = __half22float2(((half2*)(&v__7))[0]);
        *(float2*)(dt_local + (i_17 * 2)) = __8;
      }
      overlap_plan_mbar[((((ik * 3) + 1) & 1) + 12)].arrive();
      #pragma unroll
      ...
      overlap_plan_mbar[((((ik * 3) + 1) & 1) + 6)].wait(((((ik * 3) + 1) & 3) >> 1));
      {
      ...
      overlap_plan_mbar[((((ik * 3) + 1) & 1) + 14)].arrive();
      overlap_plan_mbar[(ik + 2)].wait(ik);
      #pragma unroll
      for (int i_21 = 0; i_21 < 4; ++i_21) {
        half_t da_shared_local_cast_8[2];
        *(uint1*)(da_shared_local_cast_8 + 0) = *(uint1*)(((half_t*)da_shared) + (((ik * 32) + (i_21 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __9;
      ...
      for (int i_22 = 0; i_22 < 4; ++i_22) {
        ...
        *(uint1*)(dt_shared_local_cast_9 + 0) = *(uint1*)(((half_t*)dt_shared) + (((ik * 32) + (i_22 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __10;
      ...
      overlap_plan_mbar[(ik + 6)].wait(((ik + 1) & 1));
      {
