...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* x_shared = ((void*)((char*)buf_dyn_shmem + 12288));
  void* xt_local_wsp_handoff_4 = ((void*)((char*)buf_dyn_shmem + 24576));
  void* scale_wsp_handoff_3 = ((void*)((char*)buf_dyn_shmem + 32768));
  void* da_shared = ((void*)((char*)buf_dyn_shmem + 33792));
  void* dt_shared = ((void*)((char*)buf_dyn_shmem + 34816));
  void* acc_shared = ((void*)((char*)buf_dyn_shmem + 35840));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    if (((int)threadIdx.x) < 256) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        ...
        tl::tma_load(B_desc, overlap_plan_mbar[9], (&(((half_t*)b_shared)[0])), (((int)blockIdx.y) * 64), ((((int)blockIdx.z) >> 3) * 256), 0, (((int)blockIdx.z) & 7));
      }
      tl::__sync_thread_partial(3, 128);
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[10].arrive_and_expect_tx(4096);
        tl::tma_load(B_desc, overlap_plan_mbar[10], (&(((half_t*)b_shared)[2048])), (((int)blockIdx.y) * 64), (((((int)blockIdx.z) >> 3) * 256) + 32), 0, (((int)blockIdx.z) & 7));
      }
      for (int ik = 0; ik < 3; ++ik) {
        ...
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          overlap_plan_mbar[((((ik * 2) + 2) % 3) + 9)].arrive_and_expect_tx(4096);
          tl::tma_load(B_desc, overlap_plan_mbar[((((ik * 2) + 2) % 3) + 9)], (&(((half_t*)b_shared)[((((ik * 2) + 2) % 3) * 2048)])), (((int)blockIdx.y) * 64), ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 64), 0, (((int)blockIdx.z) & 7));
        }
        ...
        }
        {
          ...
          tl::increase_descriptor_offset<int>(desc_b, (((ik * 2) % 3) * 4096));
        ...
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          overlap_plan_mbar[(((ik * 2) % 3) + 9)].arrive_and_expect_tx(4096);
          tl::tma_load(B_desc, overlap_plan_mbar[(((ik * 2) % 3) + 9)], (&(((half_t*)b_shared)[(((ik * 2) % 3) * 2048)])), (((int)blockIdx.y) * 64), ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 96), 0, (((int)blockIdx.z) & 7));
        }
        ...
        }
        {
          ...
          tl::increase_descriptor_offset<int>(desc_b_1, ((((ik * 2) + 1) % 3) * 4096));
