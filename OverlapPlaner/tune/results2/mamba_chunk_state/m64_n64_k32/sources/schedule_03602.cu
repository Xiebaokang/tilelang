...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* x_shared = ((void*)((char*)buf_dyn_shmem + 20480));
  void* da_shared = ((void*)((char*)buf_dyn_shmem + 24576));
  void* dt_shared = ((void*)((char*)buf_dyn_shmem + 25600));
  void* acc_shared = ((void*)((char*)buf_dyn_shmem + 26624));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int i_2 = 0; i_2 < 8; ++i_2) {
      scale[i_2] = (exp2f(((da_last[0] - da_local[i_2]) * 0x1.7154764ee6c2fp+0f/*1.442695e+00*/)) * dt_local[i_2]);
    }
    ...
    for (int ik = 0; ik < 7; ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[0].arrive_and_expect_tx(4096);
        tl::tma_load(X_desc, overlap_plan_mbar[0], (&(((half_t*)x_shared)[0])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 32)) + 32), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
      overlap_plan_mbar[10].wait((ik & 1));
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[1].arrive_and_expect_tx(64);
        tl::tma_load((&(((half_t*)da_shared)[0])), (&(DA[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 32)) + 32)])), overlap_plan_mbar[1], 64);
      }
      overlap_plan_mbar[11].wait((ik & 1));
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[2].arrive_and_expect_tx(64);
        tl::tma_load((&(((half_t*)dt_shared)[0])), (&(Dt[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 32)) + 32)])), overlap_plan_mbar[2], 64);
      }
      ...
      if (((ik + 1) % 3) == 0) {
        ...
        for (int i_11 = 0; i_11 < 8; ++i_11) {
          *(uint1*)(((half_t*)xt_local_wsp_handoff_3) + ((((((((ik + 1) % 3) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((i_11 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_11 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(xt_local_v0 + (i_11 * 2));
        }
      } else {
        if (((ik + 1) % 3) == 1) {
          #pragma unroll
          ...
          for (int i_13 = 0; i_13 < 8; ++i_13) {
            *(uint1*)(((half_t*)xt_local_wsp_handoff_3) + ((((((((ik + 1) % 3) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((i_13 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_13 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(xt_local_v1 + (i_13 * 2));
          }
        } else {
          #pragma unroll
          ...
          for (int i_15 = 0; i_15 < 8; ++i_15) {
            *(uint1*)(((half_t*)xt_local_wsp_handoff_3) + ((((((((ik + 1) % 3) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((i_15 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_15 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(xt_local_v2 + (i_15 * 2));
          }
        }
      }
      tl::fence_proxy_async();
      ...
      if (2 <= ik) {
        overlap_plan_mbar[((ik & 1) + 12)].wait((((ik >> 1) + 1) & 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((ik & 1) + 6)].arrive_and_expect_tx(4096);
        tl::tma_load(B_desc, overlap_plan_mbar[((ik & 1) + 6)], (&(((half_t*)b_shared)[((ik & 1) * 2048)])), (((int)blockIdx.y) * 64), (((((int)blockIdx.z) >> 3) * 256) + (ik * 32)), 0, (((int)blockIdx.z) & 7));
      }
    }
    ...
    for (int ik_1 = 0; ik_1 < 2; ++ik_1) {
      ...
      overlap_plan_mbar[(ik_1 + 6)].wait(ik_1);
      #pragma unroll
      for (int i_17 = 0; i_17 < 8; ++i_17) {
        *(uint1*)(xt_local_v0 + (i_17 * 2)) = *(uint1*)(((half_t*)xt_local_wsp_handoff_3) + (((((((((int)threadIdx.x) >> 5) * 512) + ((i_17 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_17 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 2048));
      }
      {
        tl::GmmaDescriptor desc_b;
        tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b, (&(((half_t*)b_shared)[0])));
        tl::increase_descriptor_offset<int>(desc_b, (ik_1 * 4096));
      ...
      overlap_plan_mbar[(ik_1 + 12)].arrive();
      overlap_plan_mbar[4].wait(ik_1);
      overlap_plan_mbar[((((ik_1 * 3) + 1) & 1) + 6)].wait(((((ik_1 * 3) + 1) & 3) >> 1));
      #pragma unroll
      for (int i_18 = 0; i_18 < 8; ++i_18) {
        *(uint1*)(xt_local_v1 + (i_18 * 2)) = *(uint1*)(((half_t*)xt_local_wsp_handoff_3) + ((((((((int)threadIdx.x) >> 5) * 512) + ((i_18 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_18 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      }
      {
        tl::GmmaDescriptor desc_b_1;
        tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_1, (&(((half_t*)b_shared)[0])));
        tl::increase_descriptor_offset<int>(desc_b_1, ((((ik_1 * 3) + 1) & 1) * 4096));
      ...
      overlap_plan_mbar[((((ik_1 * 3) + 1) & 1) + 12)].arrive();
      overlap_plan_mbar[5].wait(ik_1);
      overlap_plan_mbar[(ik_1 + 6)].wait(((ik_1 + 1) & 1));
      #pragma unroll
      for (int i_19 = 0; i_19 < 8; ++i_19) {
        *(uint1*)(xt_local_v2 + (i_19 * 2)) = *(uint1*)(((half_t*)xt_local_wsp_handoff_3) + (((((((((int)threadIdx.x) >> 5) * 512) + ((i_19 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_19 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 2048));
      }
      {
        tl::GmmaDescriptor desc_b_2;
        tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_2, (&(((half_t*)b_shared)[0])));
        tl::increase_descriptor_offset<int>(desc_b_2, (ik_1 * 4096));
    ...
    for (int i_20 = 0; i_20 < 8; ++i_20) {
      *(uint1*)(xt_local_v0 + (i_20 * 2)) = *(uint1*)(((half_t*)xt_local_wsp_handoff_3) + (((((((((int)threadIdx.x) >> 5) * 512) + ((i_20 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_20 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 2048));
    }
    {
    ...
    for (int i_21 = 0; i_21 < 8; ++i_21) {
      *(uint1*)(xt_local_v1 + (i_21 * 2)) = *(uint1*)(((half_t*)xt_local_wsp_handoff_3) + ((((((((int)threadIdx.x) >> 5) * 512) + ((i_21 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_21 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    }
    {
    ...
    for (int i_22 = 0; i_22 < 4; ++i_22) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_22 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_22 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc[(i_22 * 8)]), ((half_t)acc[((i_22 * 8) + 1)])), __pack_half2(((half_t)acc[((i_22 * 8) + 2)]), ((half_t)acc[((i_22 * 8) + 3)])), __pack_half2(((half_t)acc[((i_22 * 8) + 4)]), ((half_t)acc[((i_22 * 8) + 5)])), __pack_half2(((half_t)acc[((i_22 * 8) + 6)]), ((half_t)acc[((i_22 * 8) + 7)])));
    }
    tl::fence_proxy_async();
