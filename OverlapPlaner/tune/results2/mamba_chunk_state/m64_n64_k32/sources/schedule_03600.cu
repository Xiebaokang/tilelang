...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 3; ++ik) {
      ...
      overlap_plan_mbar[((((ik * 2) + 1) % 3) + 10)].arrive();
      #pragma unroll
      ...
      for (int i_15 = 0; i_15 < 4; ++i_15) {
        ...
        *(uint1*)(dt_shared_local_cast_7 + 0) = *(uint1*)(((half_t*)dt_shared) + (((i_15 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 32));
        float2 __8;
      ...
      overlap_plan_mbar[((((ik * 2) + 2) % 3) + 10)].arrive();
      #pragma unroll
    ...
    for (int ik_1 = 0; ik_1 < 7; ++ik_1) {
      if (2 <= ik_1) {
        overlap_plan_mbar[(((ik_1 + 1) % 3) + 10)].wait(((ik_1 - 2) / 3));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      ...
      if (1 <= ik_1) {
        overlap_plan_mbar[(((ik_1 + 1) & 1) + 13)].wait((((ik_1 + 3) & 3) >> 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        ...
        tl::tma_load(B_desc, overlap_plan_mbar[((ik_1 % 3) + 7)], (&(((half_t*)b_shared)[((ik_1 % 3) * 2048)])), (((int)blockIdx.y) * 64), (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 32)), 0, (((int)blockIdx.z) & 7));
      }
    }
