...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* da_shared = ((void*)((char*)buf_dyn_shmem + 12288));
  void* dt_shared = ((void*)((char*)buf_dyn_shmem + 13312));
  void* acc_shared = ((void*)((char*)buf_dyn_shmem + 14336));
  ...
  for (int ik = 0; ik < 2; ++ik) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[((((ik * 3) + 1) & 1) + 3)].arrive_and_expect_tx(4096);
      tl::tma_load(B_desc, overlap_plan_mbar[((((ik * 3) + 1) & 1) + 3)], (&(((half_t*)b_shared)[((((ik * 3) + 1) & 1) * 2048)])), (((int)blockIdx.y) * 64), ((((((int)blockIdx.z) >> 3) * 256) + (ik * 96)) + 32), 0, (((int)blockIdx.z) & 7));
    }
    overlap_plan_mbar[(ik + 3)].wait(ik);
    {
      tl::GmmaDescriptor desc_b;
      tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b, (&(((half_t*)b_shared)[0])));
      tl::increase_descriptor_offset<int>(desc_b, (ik * 4096));
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[(ik + 3)].arrive_and_expect_tx(4096);
      tl::tma_load(B_desc, overlap_plan_mbar[(ik + 3)], (&(((half_t*)b_shared)[(ik * 2048)])), (((int)blockIdx.y) * 64), ((((((int)blockIdx.z) >> 3) * 256) + (ik * 96)) + 64), 0, (((int)blockIdx.z) & 7));
    }
    overlap_plan_mbar[((((ik * 3) + 1) & 1) + 3)].wait(((((ik * 3) + 1) & 3) >> 1));
    {
      tl::GmmaDescriptor desc_b_1;
      tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_1, (&(((half_t*)b_shared)[0])));
      tl::increase_descriptor_offset<int>(desc_b_1, ((((ik * 3) + 1) & 1) * 4096));
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[((((ik * 3) + 1) & 1) + 3)].arrive_and_expect_tx(4096);
      tl::tma_load(B_desc, overlap_plan_mbar[((((ik * 3) + 1) & 1) + 3)], (&(((half_t*)b_shared)[((((ik * 3) + 1) & 1) * 2048)])), (((int)blockIdx.y) * 64), ((((((int)blockIdx.z) >> 3) * 256) + (ik * 96)) + 96), 0, (((int)blockIdx.z) & 7));
    }
    overlap_plan_mbar[(ik + 3)].wait(((ik + 1) & 1));
    {
      ...
      for (int ki_2 = 0; ki_2 < 2; ++ki_2) {
        tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(xt_local_v2 + (ki_2 * 8)), uint64_t(desc_b_2 + ((ki_2 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + 0), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 32);
  ...
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    ...
    tl::tma_load(B_desc, overlap_plan_mbar[4], (&(((half_t*)b_shared)[2048])), (((int)blockIdx.y) * 64), (((((int)blockIdx.z) >> 3) * 256) + 224), 0, (((int)blockIdx.z) & 7));
  }
  overlap_plan_mbar[3].wait(1);
  {
    ...
    for (int ki_3 = 0; ki_3 < 2; ++ki_3) {
      tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(xt_local_v0 + (ki_3 * 8)), uint64_t(desc_b_3 + ((ki_3 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + 0), 1);
    }
    tl::warpgroup_commit_batch();
    tl::warpgroup_wait<0>();
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 32);
  ...
  overlap_plan_mbar[4].wait(1);
  {
    ...
    tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_4, (&(((half_t*)b_shared)[0])));
    ...
    for (int ki_4 = 0; ki_4 < 2; ++ki_4) {
      tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(xt_local_v1 + (ki_4 * 8)), uint64_t(desc_b_4 + ((ki_4 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + 0), 1);
    }
    tl::warpgroup_commit_batch();
    tl::warpgroup_wait<0>();
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 32);
  ...
  for (int i_26 = 0; i_26 < 4; ++i_26) {
    tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((int)threadIdx.x) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_26 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_26 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc[(i_26 * 8)]), ((half_t)acc[((i_26 * 8) + 1)])), __pack_half2(((half_t)acc[((i_26 * 8) + 2)]), ((half_t)acc[((i_26 * 8) + 3)])), __pack_half2(((half_t)acc[((i_26 * 8) + 4)]), ((half_t)acc[((i_26 * 8) + 5)])), __pack_half2(((half_t)acc[((i_26 * 8) + 6)]), ((half_t)acc[((i_26 * 8) + 7)])));
  }
