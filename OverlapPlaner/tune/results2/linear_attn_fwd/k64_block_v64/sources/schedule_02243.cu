...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(float* __restrict__ FinalState, __grid_constant__ const CUtensorMap K_desc, float* __restrict__ O, const half_t* __restrict__ Q, __grid_constant__ const CUtensorMap V_desc) {
  ...
  void* k = ((void*)((char*)buf_dyn_shmem + 32768));
  void* v = ((void*)((char*)buf_dyn_shmem + 57344));
  void* h_shared = ((void*)((char*)buf_dyn_shmem + 73728));
  void* q = ((void*)((char*)buf_dyn_shmem + 81920));
  void* s_shared = ((void*)((char*)buf_dyn_shmem + 90112));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    overlap_plan_mbar[3].wait(0);
    {
      ...
      for (int ki_1 = 0; ki_1 < 4; ++ki_1) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(uint64_t(desc_a_1 + ((ki_1 * 32) >> 4)), uint64_t(desc_b_1 + ((ki_1 * 2048) >> 4)), ((uint32_t*)(o_v0 + 0)), ((0 < ki_1) ? 1 : 0));
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(o_v0 + 0), 32);
    ...
    for (int ic = 0; ic < 7; ++ic) {
      ...
      for (int i_4 = 0; i_4 < 4; ++i_4) {
        ...
        *(uint4*)(Q_local_cast_3 + 0) = *(uint4*)(Q + (((((((((((int)blockIdx.z) >> 5) * 4194304) + (ic * 524288)) + (i_4 * 65536)) + ((((int)threadIdx.x) >> 3) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.y) * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 262144));
        ...
        *(uint4*)(((half_t*)q) + (((((i_4 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(q_local_cast_2 + 0);
      }
      tl::cp_async_commit();
      tl::cp_async_wait<1>();
      tl::__sync_thread_partial(3, 128);
      overlap_plan_mbar[(((ic * 2) + 1) % 3)].wait(((((ic % 3) * 2) + 1) / 3));
      {
        tl::GmmaDescriptor desc_a_4;
        tl::GmmaDescriptor desc_b_4;
        tl::initialize_wgmma_descriptor<1, 1, 64>(desc_a_4, (&(((half_t*)q)[0])));
        tl::initialize_wgmma_descriptor<1, 1, 64>(desc_b_4, (&(((half_t*)k)[0])));
        tl::increase_descriptor_offset<int>(desc_b_4, ((((ic * 2) + 1) % 3) * 8192));
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(s + 0), 32);
        tl::warpgroup_arrive();
        tl::fence_proxy_async();
        #pragma unroll
        for (int ki_4 = 0; ki_4 < 4; ++ki_4) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, false, 1, 1>(uint64_t(desc_a_4 + ((ki_4 * 32) >> 4)), uint64_t(desc_b_4 + ((ki_4 * 32) >> 4)), ((uint32_t*)(s + 0)), ((0 < ki_4) ? 1 : 0));
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(s + 0), 32);
      ...
      for (int i_5 = 0; i_5 < 32; ++i_5) {
        ...
        ((half_t*)s_shared)[(((((((((((int)threadIdx.x) >> 5) * 1024) + (((i_5 & 3) >> 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((i_5 >> 4) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_5 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((i_5 & 7) >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_5 & 1))] = ((half_t)condval_1);
      }
      overlap_plan_mbar[4].wait((ic & 1));
      {
        ...
        for (int ki_5 = 0; ki_5 < 4; ++ki_5) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(uint64_t(desc_a_5 + ((ki_5 * 32) >> 4)), uint64_t(desc_b_5 + ((ki_5 * 2048) >> 4)), ((uint32_t*)(o_v1 + 0)), ((0 < ki_5) ? 1 : 0));
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(o_v1 + 0), 32);
      ...
      for (int i_6 = 0; i_6 < 4; ++i_6) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)h_shared)[((((((int)threadIdx.x) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_6 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_6 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)h[(i_6 * 8)]), ((half_t)h[((i_6 * 8) + 1)])), __pack_half2(((half_t)h[((i_6 * 8) + 2)]), ((half_t)h[((i_6 * 8) + 3)])), __pack_half2(((half_t)h[((i_6 * 8) + 4)]), ((half_t)h[((i_6 * 8) + 5)])), __pack_half2(((half_t)h[((i_6 * 8) + 6)]), ((half_t)h[((i_6 * 8) + 7)])));
      }
      {
        tl::GmmaDescriptor desc_a_6;
        tl::GmmaDescriptor desc_b_6;
        tl::initialize_wgmma_descriptor<1, 0, 64>(desc_a_6, (&(((half_t*)k)[0])));
        tl::increase_descriptor_offset<int>(desc_a_6, ((((ic * 2) + 1) % 3) * 8192));
      ...
      overlap_plan_mbar[((((ic * 2) + 1) % 3) + 5)].arrive();
      ...
      for (int i_8 = 0; i_8 < 8; ++i_8) {
        AtomicAddx4((&(O[((((((((((int)blockIdx.z) >> 5) * 4194304) + (ic * 524288)) + (i_8 * 32768)) + ((((int)threadIdx.x) >> 4) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 15) * 4))])), *(float4*)(((float*)o_shared) + ((i_8 * 512) + (((int)threadIdx.x) * 4))));
      }
      #pragma unroll
      ...
      tl::cp_async_wait<1>();
      tl::__sync_thread_partial(3, 128);
      overlap_plan_mbar[(((ic * 2) + 2) % 3)].wait(((((ic * 2) + 2) % 6) / 3));
      {
        tl::GmmaDescriptor desc_a_8;
        tl::GmmaDescriptor desc_b_8;
        tl::initialize_wgmma_descriptor<1, 1, 64>(desc_a_8, (&(((half_t*)q)[0])));
        tl::initialize_wgmma_descriptor<1, 1, 64>(desc_b_8, (&(((half_t*)k)[0])));
        tl::increase_descriptor_offset<int>(desc_b_8, ((((ic * 2) + 2) % 3) * 8192));
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(s + 0), 32);
        tl::warpgroup_arrive();
        tl::fence_proxy_async();
        #pragma unroll
        for (int ki_8 = 0; ki_8 < 4; ++ki_8) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, false, 1, 1>(uint64_t(desc_a_8 + ((ki_8 * 32) >> 4)), uint64_t(desc_b_8 + ((ki_8 * 32) >> 4)), ((uint32_t*)(s + 0)), ((0 < ki_8) ? 1 : 0));
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(s + 0), 32);
      ...
      overlap_plan_mbar[3].wait(((ic + 1) & 1));
      {
        ...
        tl::initialize_wgmma_descriptor<1, 1, 64>(desc_a_9, (&(((half_t*)s_shared)[0])));
        ...
        for (int ki_9 = 0; ki_9 < 4; ++ki_9) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(uint64_t(desc_a_9 + ((ki_9 * 32) >> 4)), uint64_t(desc_b_9 + ((ki_9 * 2048) >> 4)), ((uint32_t*)(o_v0 + 0)), ((0 < ki_9) ? 1 : 0));
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(o_v0 + 0), 32);
      ...
      }
      {
        ...
        tl::increase_descriptor_offset<int>(desc_a_10, ((((ic * 2) + 2) % 3) * 8192));
      ...
      overlap_plan_mbar[((((ic * 2) + 2) % 3) + 5)].arrive();
      overlap_plan_mbar[8].arrive();
      {
      ...
      for (int i_12 = 0; i_12 < 16; ++i_12) {
        *(float2*)(((float*)o_shared) + (((((((((int)threadIdx.x) >> 5) * 1024) + ((i_12 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_12 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 4096)) = *(float2*)(o_v1 + (i_12 * 2));
      }
      tl::__sync_thread_partial(3, 128);
      #pragma unroll
      for (int i_13 = 0; i_13 < 8; ++i_13) {
        AtomicAddx4((&(O[(((((((((((int)blockIdx.z) >> 5) * 4194304) + (ic * 524288)) + (i_13 * 32768)) + ((((int)threadIdx.x) >> 4) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 15) * 4)) + 262144)])), *(float4*)(((float*)o_shared) + (((i_13 * 512) + (((int)threadIdx.x) * 4)) + 4096)));
      }
    }
    #pragma unroll
    for (int i_14 = 0; i_14 < 4; ++i_14) {
      ...
      *(uint4*)(Q_local_cast_7 + 0) = *(uint4*)(Q + ((((((((((int)blockIdx.z) >> 5) * 4194304) + (i_14 * 65536)) + ((((int)threadIdx.x) >> 3) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.y) * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 3932160));
      ...
      *(uint4*)(((half_t*)q) + (((((i_14 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(q_local_cast_6 + 0);
    }
    tl::cp_async_commit();
    tl::cp_async_wait<1>();
    tl::__sync_thread_partial(3, 128);
    overlap_plan_mbar[0].wait(1);
    {
      ...
      tl::initialize_wgmma_descriptor<1, 1, 64>(desc_b_12, (&(((half_t*)k)[0])));
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(s + 0), 32);
      tl::warpgroup_arrive();
      tl::fence_proxy_async();
      #pragma unroll
      for (int ki_12 = 0; ki_12 < 4; ++ki_12) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, false, 1, 1>(uint64_t(desc_a_12 + ((ki_12 * 32) >> 4)), uint64_t(desc_b_12 + ((ki_12 * 32) >> 4)), ((uint32_t*)(s + 0)), ((0 < ki_12) ? 1 : 0));
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(s + 0), 32);
    ...
    for (int i_15 = 0; i_15 < 32; ++i_15) {
      float condval_3;
      if ((((((i_15 >> 2) * 8) + ((((int)threadIdx.x) & 3) * 2)) + (i_15 & 1)) <= ((((((int)threadIdx.x) >> 5) * 16) + (((i_15 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
        condval_3 = s[i_15];
      } else {
        condval_3 = 0x0p+0f/*0.000000e+00*/;
      }
      ((half_t*)s_shared)[(((((((((((int)threadIdx.x) >> 5) * 1024) + (((i_15 & 3) >> 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((i_15 >> 4) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_15 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((i_15 & 7) >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_15 & 1))] = ((half_t)condval_3);
    }
    overlap_plan_mbar[4].wait(1);
    {
      ...
      for (int ki_13 = 0; ki_13 < 4; ++ki_13) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(uint64_t(desc_a_13 + ((ki_13 * 32) >> 4)), uint64_t(desc_b_13 + ((ki_13 * 2048) >> 4)), ((uint32_t*)(o_v1 + 0)), ((0 < ki_13) ? 1 : 0));
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(o_v1 + 0), 32);
    ...
    for (int i_16 = 0; i_16 < 4; ++i_16) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)h_shared)[((((((int)threadIdx.x) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_16 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_16 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)h[(i_16 * 8)]), ((half_t)h[((i_16 * 8) + 1)])), __pack_half2(((half_t)h[((i_16 * 8) + 2)]), ((half_t)h[((i_16 * 8) + 3)])), __pack_half2(((half_t)h[((i_16 * 8) + 4)]), ((half_t)h[((i_16 * 8) + 5)])), __pack_half2(((half_t)h[((i_16 * 8) + 6)]), ((half_t)h[((i_16 * 8) + 7)])));
    }
    {
      tl::GmmaDescriptor desc_a_14;
      tl::GmmaDescriptor desc_b_14;
      tl::initialize_wgmma_descriptor<1, 0, 64>(desc_a_14, (&(((half_t*)k)[0])));
      ...
      for (int ki_14 = 0; ki_14 < 4; ++ki_14) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, true, true, 1, 1>(uint64_t(desc_a_14 + ((ki_14 * 2048) >> 4)), uint64_t(desc_b_14 + ((ki_14 * 2048) >> 4)), ((uint32_t*)(h + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(h + 0), 32);
    ...
    for (int i_17 = 0; i_17 < 16; ++i_17) {
      *(float2*)(((float*)o_shared) + ((((((((int)threadIdx.x) >> 5) * 1024) + ((i_17 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_17 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(o_v0 + (i_17 * 2));
    }
    tl::__sync_thread_partial(3, 128);
    #pragma unroll
    for (int i_18 = 0; i_18 < 8; ++i_18) {
      AtomicAddx4((&(O[((((((((((int)blockIdx.z) >> 5) * 4194304) + (i_18 * 32768)) + ((((int)threadIdx.x) >> 4) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 15) * 4)) + 3670016)])), *(float4*)(((float*)o_shared) + ((i_18 * 512) + (((int)threadIdx.x) * 4))));
    }
    #pragma unroll
    for (int i_19 = 0; i_19 < 16; ++i_19) {
      *(float2*)(((float*)o_shared) + (((((((((int)threadIdx.x) >> 5) * 1024) + ((i_19 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_19 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 4096)) = *(float2*)(o_v1 + (i_19 * 2));
    }
    tl::__sync_thread_partial(3, 128);
    #pragma unroll
    for (int i_20 = 0; i_20 < 8; ++i_20) {
      AtomicAddx4((&(O[((((((((((int)blockIdx.z) >> 5) * 4194304) + (i_20 * 32768)) + ((((int)threadIdx.x) >> 4) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 15) * 4)) + 3932160)])), *(float4*)(((float*)o_shared) + (((i_20 * 512) + (((int)threadIdx.x) * 4)) + 4096)));
    }
    #pragma unroll
    ...
    for (int ic_1 = 0; ic_1 < 16; ++ic_1) {
      if (3 <= ic_1) {
        overlap_plan_mbar[((ic_1 % 3) + 5)].wait((((ic_1 / 3) + 1) & 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[(ic_1 % 3)].arrive_and_expect_tx(8192);
        tl::tma_load(K_desc, overlap_plan_mbar[(ic_1 % 3)], (&(((half_t*)k)[((ic_1 % 3) * 4096)])), (((int)blockIdx.y) * 64), (ic_1 * 64), (((int)blockIdx.z) & 31), (((int)blockIdx.z) >> 5));
      }
      if (2 <= ic_1) {
        overlap_plan_mbar[((ic_1 & 1) + 8)].wait((((ic_1 >> 1) + 1) & 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[((ic_1 & 1) + 3)].arrive_and_expect_tx(8192);
        tl::tma_load(V_desc, overlap_plan_mbar[((ic_1 & 1) + 3)], (&(((half_t*)v)[((ic_1 & 1) * 4096)])), (((int)blockIdx.x) * 64), (ic_1 * 64), (((int)blockIdx.z) & 31), (((int)blockIdx.z) >> 5));
      }
    }
  }
}
