...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(float* __restrict__ FinalState, __grid_constant__ const CUtensorMap K_desc, float* __restrict__ O, const half_t* __restrict__ Q, __grid_constant__ const CUtensorMap V_desc) {
  ...
  void* s_wsp_handoff_4 = ((void*)((char*)buf_dyn_shmem + 73728));
  void* v = ((void*)((char*)buf_dyn_shmem + 90112));
  void* k = ((void*)((char*)buf_dyn_shmem + 106496));
  void* s_shared = ((void*)((char*)buf_dyn_shmem + 114688));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ic = 0; ic < 16; ++ic) {
      if (1 <= ic) {
        overlap_plan_mbar[14].wait(((ic + 1) & 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[3].arrive_and_expect_tx(8192);
        tl::tma_load(K_desc, overlap_plan_mbar[3], (&(((half_t*)k)[0])), (((int)blockIdx.y) * 64), (ic * 64), (((int)blockIdx.z) & 31), (((int)blockIdx.z) >> 5));
      }
      if (2 <= ic) {
        overlap_plan_mbar[((ic & 1) + 15)].wait((((ic >> 1) + 1) & 1));
        overlap_plan_mbar[((ic & 1) + 17)].wait((((ic >> 1) + 1) & 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((ic & 1) + 4)].arrive_and_expect_tx(8192);
        tl::tma_load(V_desc, overlap_plan_mbar[((ic & 1) + 4)], (&(((half_t*)v)[((ic & 1) * 4096)])), (((int)blockIdx.x) * 64), (ic * 64), (((int)blockIdx.z) & 31), (((int)blockIdx.z) >> 5));
      }
      if (2 <= ic) {
        overlap_plan_mbar[((ic & 1) + 19)].wait((((ic >> 1) + 1) & 1));
      }
      #pragma unroll
      ...
      overlap_plan_mbar[((ic & 1) + 15)].arrive();
      if (3 <= ic) {
        overlap_plan_mbar[((ic % 3) + 11)].wait((((ic / 3) + 1) & 1));
      }
      #pragma unroll
      for (int i_2 = 0; i_2 < 4; ++i_2) {
        ...
        *(uint4*)(((half_t*)q) + (((((((ic % 3) * 4096) + (i_2 * 1024)) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(q_local_cast_1 + 0);
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[(ic % 3)].arrive();
      {
        tl::GmmaDescriptor desc_a_1;
        tl::GmmaDescriptor desc_b_1;
        tl::initialize_wgmma_descriptor<1, 1, 64>(desc_a_1, (&(((half_t*)q)[0])));
        tl::increase_descriptor_offset<int>(desc_a_1, ((ic % 3) * 8192));
      ...
      for (int i_3 = 0; i_3 < 16; ++i_3) {
        *(float2*)(((float*)s_wsp_handoff_4) + ((((((((int)threadIdx.x) >> 5) * 1024) + ((i_3 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_3 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(s + (i_3 * 2));
      }
      tl::fence_proxy_async();
      ...
      for (int i_4 = 0; i_4 < 8; ++i_4) {
        AtomicAddx4((&(O[((((((((((int)blockIdx.z) >> 5) * 4194304) + (ic * 262144)) + (i_4 * 32768)) + ((((int)threadIdx.x) >> 4) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 15) * 4))])), *(float4*)(((float*)o_shared) + ((((ic & 1) * 4096) + (i_4 * 512)) + (((int)threadIdx.x) * 4))));
      }
      overlap_plan_mbar[((ic & 1) + 21)].arrive();
    }
    #pragma unroll
    for (int i_5 = 0; i_5 < 16; ++i_5) {
      *(float2*)(FinalState + ((((((((((int)blockIdx.z) * 16384) + (((int)blockIdx.y) * 8192)) + ((((int)threadIdx.x) >> 5) * 2048)) + ((i_5 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + (((int)blockIdx.x) * 64)) + ((i_5 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(h + (i_5 * 2));
    }
  } else {
    ...
    for (int ic_1 = 0; ic_1 < 16; ++ic_1) {
      ...
      for (int i_6 = 0; i_6 < 16; ++i_6) {
        *(float2*)(s + (i_6 * 2)) = *(float2*)(((float*)s_wsp_handoff_4) + (((((((((int)threadIdx.x) >> 5) * 1024) + ((i_6 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_6 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
      }
      #pragma unroll
      for (int i_7 = 0; i_7 < 32; ++i_7) {
        float condval;
        if (((((((i_7 >> 2) * 8) + ((((int)threadIdx.x) & 3) * 2)) + (i_7 & 1)) + 64) <= ((((((int)threadIdx.x) >> 5) * 16) + (((i_7 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
          condval = s[i_7];
        } else {
          condval = 0x0p+0f/*0.000000e+00*/;
        }
        ((half_t*)s_shared)[((((((((((((int)threadIdx.x) >> 5) * 1024) + (((i_7 & 3) >> 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((i_7 >> 4) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_7 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((i_7 & 7) >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_7 & 1)) - 4096)] = ((half_t)condval);
      }
      ...
      overlap_plan_mbar[((ic_1 & 1) + 17)].arrive();
      ...
      overlap_plan_mbar[((ic_1 & 1) + 7)].wait(((ic_1 & 3) >> 1));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_a_3, ((ic_1 % 3) * 8192));
      ...
      overlap_plan_mbar[((ic_1 % 3) + 11)].arrive();
      overlap_plan_mbar[((ic_1 & 1) + 19)].arrive();
      if (2 <= ic_1) {
        overlap_plan_mbar[((ic_1 & 1) + 21)].wait((((ic_1 >> 1) + 1) & 1));
      }
      #pragma unroll
