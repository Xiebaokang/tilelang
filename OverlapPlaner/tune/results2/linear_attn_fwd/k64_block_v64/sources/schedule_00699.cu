...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(float* __restrict__ FinalState, __grid_constant__ const CUtensorMap K_desc, float* __restrict__ O, const half_t* __restrict__ Q, __grid_constant__ const CUtensorMap V_desc) {
  ...
  void* h_shared = ((void*)((char*)buf_dyn_shmem + 57344));
  void* s_shared = ((void*)((char*)buf_dyn_shmem + 73728));
  void* v = ((void*)((char*)buf_dyn_shmem + 90112));
  void* k = ((void*)((char*)buf_dyn_shmem + 106496));
  ...
  if (tl::tl_shuffle_elect<0>()) {
    ...
    overlap_plan_mbar[24].init(128);
    overlap_plan_mbar[25].init(128);
  }
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(K_desc, overlap_plan_mbar[3], (&(((half_t*)k)[0])), (((int)blockIdx.y) * 64), 0, (((int)blockIdx.z) & 31), (((int)blockIdx.z) >> 5));
    ...
    for (int i_1 = 0; i_1 < 16; ++i_1) {
      half_t h_shared_local_cast[2];
      uint1 __1;
      float2 v_ = *(float2*)(h + (i_1 * 2));
      ((half2*)(&__1))[0] = __float22half2_rn(((float2*)(&v_))[0]);
      *(uint1*)(h_shared_local_cast + 0) = __1;
      *(uint1*)(((half_t*)h_shared) + ((((((((((int)threadIdx.x) >> 5) * 1024) + ((i_1 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_1 >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_1 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_1 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(h_shared_local_cast + 0);
    }
    ...
    for (int i_2 = 0; i_2 < 4; ++i_2) {
      ...
      *(uint4*)(Q_local_cast_2 + 0) = *(uint4*)(Q + (((((((((int)blockIdx.z) >> 5) * 4194304) + (i_2 * 65536)) + ((((int)threadIdx.x) >> 3) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.y) * 64)) + ((((int)threadIdx.x) & 7) * 8)));
      for (int vec = 0; vec < 2; ++vec) {
        float broadcast_var_1 = 0x1.6a09e667f3bcdp-4f/*8.838835e-02*/;
        uint2 __2;
        float4 __3;
          float4 __4;
          uint2 v__1 = *(uint2*)(Q_local_cast_2 + (vec * 4));
        ...
        *(uint2*)(q_local_cast_1 + (vec * 4)) = __2;
      }
      *(uint4*)(((half_t*)q) + (((((i_2 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(q_local_cast_1 + 0);
    }
    tl::fence_proxy_async();
    ...
    for (int ic = 0; ic < 15; ++ic) {
      overlap_plan_mbar[15].wait((ic & 1));
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[3].arrive_and_expect_tx(8192);
        tl::tma_load(K_desc, overlap_plan_mbar[3], (&(((half_t*)k)[0])), (((int)blockIdx.y) * 64), ((ic * 64) + 64), (((int)blockIdx.z) & 31), (((int)blockIdx.z) >> 5));
      }
      if (1 <= ic) {
      ...
      for (int i_4 = 0; i_4 < 16; ++i_4) {
        half_t h_shared_local_cast_3[2];
        uint1 __5;
        float2 v__3 = *(float2*)(h + (i_4 * 2));
        ((half2*)(&__5))[0] = __float22half2_rn(((float2*)(&v__3))[0]);
        *(uint1*)(h_shared_local_cast_3 + 0) = __5;
        *(uint1*)(((half_t*)h_shared) + ((((((((((ic + 1) & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_4 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_4 >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_4 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_4 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(h_shared_local_cast_3 + 0);
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[(((ic + 1) & 1) + 8)].arrive();
      overlap_plan_mbar[3].wait(((ic + 1) & 1));
      overlap_plan_mbar[(((ic + 1) & 1) + 4)].wait((((ic + 1) & 3) >> 1));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_2, (((ic + 1) & 1) * 8192));
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(h + 0), 32);
        tl::warpgroup_arrive();
        #pragma unroll
      ...
      overlap_plan_mbar[(((ic + 1) & 1) + 16)].arrive();
      if (2 <= ic) {
        overlap_plan_mbar[(((ic + 1) % 3) + 12)].wait((((ic + 4) % 6) / 3));
      }
      #pragma unroll
      for (int i_5 = 0; i_5 < 4; ++i_5) {
        half_t Q_local_cast_5[8];
        half_t q_local_cast_4[8];
        *(uint4*)(Q_local_cast_5 + 0) = *(uint4*)(Q + (((((((((((int)blockIdx.z) >> 5) * 4194304) + (ic * 262144)) + (i_5 * 65536)) + ((((int)threadIdx.x) >> 3) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.y) * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 262144));
        for (int vec_1 = 0; vec_1 < 2; ++vec_1) {
          float broadcast_var_2 = 0x1.6a09e667f3bcdp-4f/*8.838835e-02*/;
          uint2 __6;
          float4 __7;
            float4 __8;
            uint2 v__4 = *(uint2*)(Q_local_cast_5 + (vec_1 * 4));
            ((float2*)(&__8))[0] = __half22float2(((half2*)(&v__4))[0]);
            ((float2*)(&__8))[1] = __half22float2(((half2*)(&v__4))[1]);
            float4 v__5 = make_float4(broadcast_var_2, broadcast_var_2, broadcast_var_2, broadcast_var_2);
            __7.x = (__8.x*v__5.x);
            __7.y = (__8.y*v__5.y);
            __7.z = (__8.z*v__5.z);
            __7.w = (__8.w*v__5.w);
          ...
          *(uint2*)(q_local_cast_4 + (vec_1 * 4)) = __6;
        }
        *(uint4*)(((half_t*)q) + ((((((((ic + 1) % 3) * 4096) + (i_5 * 1024)) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(q_local_cast_4 + 0);
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[((ic + 1) % 3)].arrive();
      {
        tl::GmmaDescriptor desc_a_3;
        tl::GmmaDescriptor desc_b_3;
        tl::initialize_wgmma_descriptor<1, 1, 64>(desc_a_3, (&(((half_t*)q)[0])));
        tl::increase_descriptor_offset<int>(desc_a_3, (((ic + 1) % 3) * 8192));
      ...
      for (int i_6 = 0; i_6 < 32; ++i_6) {
        ...
        ((half_t*)s_shared)[(((((((((((ic + 1) & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((i_6 & 3) >> 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((i_6 >> 4) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_6 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((i_6 & 7) >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_6 & 1))] = ((half_t)condval_1);
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[(((ic + 1) & 1) + 6)].arrive();
      overlap_plan_mbar[((ic & 1) + 10)].wait(((ic & 3) >> 1));
      #pragma unroll
      for (int i_7 = 0; i_7 < 8; ++i_7) {
        AtomicAddx4((&(O[((((((((((int)blockIdx.z) >> 5) * 4194304) + (ic * 262144)) + (i_7 * 32768)) + ((((int)threadIdx.x) >> 4) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 15) * 4))])), *(float4*)(((float*)o_shared) + ((((ic & 1) * 4096) + (i_7 * 512)) + (((int)threadIdx.x) * 4))));
      }
      overlap_plan_mbar[((ic & 1) + 24)].arrive();
    }
    overlap_plan_mbar[11].wait(1);
    #pragma unroll
    for (int i_8 = 0; i_8 < 8; ++i_8) {
      AtomicAddx4((&(O[((((((((((int)blockIdx.z) >> 5) * 4194304) + (i_8 * 32768)) + ((((int)threadIdx.x) >> 4) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 15) * 4)) + 3932160)])), *(float4*)(((float*)o_shared) + (((i_8 * 512) + (((int)threadIdx.x) * 4)) + 4096)));
    }
    overlap_plan_mbar[25].arrive();
    #pragma unroll
    for (int i_9 = 0; i_9 < 16; ++i_9) {
      *(float2*)(FinalState + ((((((((((int)blockIdx.z) * 16384) + (((int)blockIdx.y) * 8192)) + ((((int)threadIdx.x) >> 5) * 2048)) + ((i_9 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + (((int)blockIdx.x) * 64)) + ((i_9 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(h + (i_9 * 2));
    }
  } else {
    ...
    for (int ic_1 = 0; ic_1 < 16; ++ic_1) {
      ...
      overlap_plan_mbar[(ic_1 % 3)].wait(((ic_1 % 6) / 3));
      overlap_plan_mbar[((ic_1 & 1) + 8)].wait(((ic_1 & 3) >> 1));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_a_5, ((ic_1 % 3) * 8192));
      ...
      overlap_plan_mbar[((ic_1 % 3) + 12)].arrive();
      ...
      for (int i_10 = 0; i_10 < 16; ++i_10) {
        *(float2*)(((float*)o_shared) + ((((((((ic_1 & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_10 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_10 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096)) = *(float2*)(o + (i_10 * 2));
      }
      tl::fence_proxy_async();
