...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(float* __restrict__ FinalState, __grid_constant__ const CUtensorMap K_desc, float* __restrict__ O, const half_t* __restrict__ Q, __grid_constant__ const CUtensorMap V_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(V_desc, overlap_plan_mbar[3], (&(((half_t*)v)[0])), (((int)blockIdx.x) * 64), 0, (((int)blockIdx.z) & 31), (((int)blockIdx.z) >> 5));
    }
    #pragma unroll
    ...
    for (int ic = 0; ic < 15; ++ic) {
      overlap_plan_mbar[13].wait((ic & 1));
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[2].arrive_and_expect_tx(8192);
        tl::tma_load(K_desc, overlap_plan_mbar[2], (&(((half_t*)k)[0])), (((int)blockIdx.y) * 64), ((ic * 64) + 64), (((int)blockIdx.z) & 31), (((int)blockIdx.z) >> 5));
      }
      if (1 <= ic) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[(((ic + 1) & 1) + 3)].arrive_and_expect_tx(8192);
        tl::tma_load(V_desc, overlap_plan_mbar[(((ic + 1) & 1) + 3)], (&(((half_t*)v)[(((ic + 1) & 1) * 4096)])), (((int)blockIdx.x) * 64), ((ic * 64) + 64), (((int)blockIdx.z) & 31), (((int)blockIdx.z) >> 5));
      }
      if (1 <= ic) {
      ...
      tl::fence_proxy_async();
      overlap_plan_mbar[(((ic + 1) & 1) + 7)].arrive();
      overlap_plan_mbar[2].wait(((ic + 1) & 1));
      overlap_plan_mbar[(((ic + 1) & 1) + 3)].wait((((ic + 1) & 3) >> 1));
      {
      ...
      overlap_plan_mbar[(((ic + 1) & 1) + 14)].arrive();
      if (1 <= ic) {
        overlap_plan_mbar[(((ic + 1) & 1) + 11)].wait((((ic + 3) & 3) >> 1));
      }
      #pragma unroll
      for (int i_5 = 0; i_5 < 4; ++i_5) {
        ...
        *(uint4*)(((half_t*)q) + ((((((((ic + 1) & 1) * 4096) + (i_5 * 1024)) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(q_local_cast_4 + 0);
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[((ic + 1) & 1)].arrive();
      {
        ...
        tl::increase_descriptor_offset<int>(desc_a_3, (((ic + 1) & 1) * 8192));
      ...
      tl::fence_proxy_async();
      overlap_plan_mbar[(((ic + 1) & 1) + 5)].arrive();
      overlap_plan_mbar[((ic & 1) + 9)].wait(((ic & 3) >> 1));
      #pragma unroll
      ...
      overlap_plan_mbar[((ic & 1) + 22)].arrive();
    }
