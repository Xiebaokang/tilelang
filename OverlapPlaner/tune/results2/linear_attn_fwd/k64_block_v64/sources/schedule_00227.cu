...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(float* __restrict__ FinalState, __grid_constant__ const CUtensorMap K_desc, float* __restrict__ O, const half_t* __restrict__ Q, __grid_constant__ const CUtensorMap V_desc) {
  ...
  for (int ic = 0; ic < 7; ++ic) {
    ...
    for (int i_12 = 0; i_12 < 16; ++i_12) {
      *(float2*)(((float*)o_shared) + ((((((((int)threadIdx.x) >> 5) * 1024) + ((i_12 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_12 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(o_v1 + (i_12 * 2));
    }
    __syncthreads();
    #pragma unroll
    for (int i_13 = 0; i_13 < 8; ++i_13) {
      AtomicAddx4((&(O[(((((((((((int)blockIdx.z) >> 5) * 4194304) + (ic * 524288)) + (i_13 * 32768)) + ((((int)threadIdx.x) >> 4) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 15) * 4)) + 262144)])), *(float4*)(((float*)o_shared) + ((i_13 * 512) + (((int)threadIdx.x) * 4))));
    }
  }
  #pragma unroll
  ...
  for (int i_19 = 0; i_19 < 16; ++i_19) {
    *(float2*)(((float*)o_shared) + ((((((((int)threadIdx.x) >> 5) * 1024) + ((i_19 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_19 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(o_v1 + (i_19 * 2));
  }
  __syncthreads();
  #pragma unroll
