...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(float* __restrict__ FinalState, __grid_constant__ const CUtensorMap K_desc, float* __restrict__ O, const half_t* __restrict__ Q, __grid_constant__ const CUtensorMap V_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ic = 0; ic < 16; ++ic) {
      if (1 <= ic) {
        overlap_plan_mbar[4].wait(((ic + 1) & 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[0].arrive_and_expect_tx(8192);
        tl::tma_load(K_desc, overlap_plan_mbar[0], (&(((half_t*)k)[0])), (((int)blockIdx.y) * 64), (ic * 64), (((int)blockIdx.z) & 31), (((int)blockIdx.z) >> 5));
      }
      if (1 <= ic) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(V_desc, overlap_plan_mbar[1], (&(((half_t*)v)[0])), (((int)blockIdx.x) * 64), (ic * 64), (((int)blockIdx.z) & 31), (((int)blockIdx.z) >> 5));
      }
      #pragma unroll
      ...
      if (2 <= ic) {
        overlap_plan_mbar[((ic & 1) + 6)].wait((((ic >> 1) + 1) & 1));
      }
      #pragma unroll
      for (int i_4 = 0; i_4 < 16; ++i_4) {
        *(float2*)(((float*)o_shared) + (((((((ic & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_4 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_4 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(o + (i_4 * 2));
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[((ic & 1) + 2)].arrive();
    }
    #pragma unroll
    ...
    for (int ic_1 = 0; ic_1 < 16; ++ic_1) {
      ...
      for (int i_6 = 0; i_6 < 4; ++i_6) {
        AtomicAddx4((&(O[(((((((((((int)blockIdx.z) >> 5) * 4194304) + (ic_1 * 262144)) + (i_6 * 65536)) + ((((int)threadIdx.x) >> 4) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 15) * 4)) - 32768)])), *(float4*)(((float*)o_shared) + (((((ic_1 & 1) * 4096) + (i_6 * 1024)) + (((int)threadIdx.x) * 4)) - 512)));
      }
