...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(float* __restrict__ FinalState, __grid_constant__ const CUtensorMap K_desc, float* __restrict__ O, const half_t* __restrict__ Q, __grid_constant__ const CUtensorMap V_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int i_12 = 0; i_12 < 4; ++i_12) {
      ...
      *(uint4*)(((half_t*)q) + (((((i_12 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(q_local_cast_6 + 0);
    }
    tl::cp_async_commit();
    overlap_plan_mbar[4].wait(0);
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    ...
    for (int i_13 = 0; i_13 < 32; ++i_13) {
      float condval_3;
      if ((((((i_13 >> 2) * 8) + ((((int)threadIdx.x) & 3) * 2)) + (i_13 & 1)) <= ((((((int)threadIdx.x) >> 5) * 16) + (((i_13 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
        condval_3 = s[i_13];
      } else {
        condval_3 = 0x0p+0f/*0.000000e+00*/;
      }
      ((half_t*)s_shared)[(((((((((((int)threadIdx.x) >> 5) * 1024) + (((i_13 & 3) >> 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((i_13 >> 4) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_13 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((i_13 & 7) >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_13 & 1))] = ((half_t)condval_3);
    }
    overlap_plan_mbar[1].wait(1);
    {
    ...
    for (int i_14 = 0; i_14 < 4; ++i_14) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)h_shared)[((((((int)threadIdx.x) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_14 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_14 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)h[(i_14 * 8)]), ((half_t)h[((i_14 * 8) + 1)])), __pack_half2(((half_t)h[((i_14 * 8) + 2)]), ((half_t)h[((i_14 * 8) + 3)])), __pack_half2(((half_t)h[((i_14 * 8) + 4)]), ((half_t)h[((i_14 * 8) + 5)])), __pack_half2(((half_t)h[((i_14 * 8) + 6)]), ((half_t)h[((i_14 * 8) + 7)])));
    }
    {
    ...
    for (int ic_1 = 0; ic_1 < 16; ++ic_1) {
      ...
      for (int i_18 = 0; i_18 < 4; ++i_18) {
        AtomicAddx4((&(O[(((((((((((int)blockIdx.z) >> 5) * 4194304) + (ic_1 * 262144)) + (i_18 * 65536)) + ((((int)threadIdx.x) >> 4) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 15) * 4)) - 32768)])), *(float4*)(((float*)o_shared) + (((((ic_1 & 1) * 4096) + (i_18 * 1024)) + (((int)threadIdx.x) * 4)) - 512)));
      }
