  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ic = 0; ic < 16; ++ic) {
      ...
      for (int i_1 = 0; i_1 < 16; ++i_1) {
        ...
        *(uint1*)(((half_t*)h_shared) + (((((((((ic & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_1 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_1 >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_1 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_1 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(h_shared_local_cast + 0);
      }
      ...
      overlap_plan_mbar[((ic & 1) + 3)].wait(((ic & 3) >> 1));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b, ((ic & 1) * 8192));
      ...
      for (int i_2 = 0; i_2 < 4; ++i_2) {
        ...
        *(uint4*)(Q_local_cast_2 + 0) = *(uint4*)(Q + ((((((((((int)blockIdx.z) >> 5) * 4194304) + (ic * 262144)) + (i_2 * 65536)) + ((((int)threadIdx.x) >> 3) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.y) * 64)) + ((((int)threadIdx.x) & 7) * 8)));
        ...
        *(uint4*)(((half_t*)q) + (((((((ic & 1) * 4096) + (i_2 * 1024)) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(q_local_cast_1 + 0);
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[(ic & 1)].arrive();
      {
        ...
        tl::increase_descriptor_offset<int>(desc_a_1, ((ic & 1) * 8192));
      ...
      for (int i_3 = 0; i_3 < 32; ++i_3) {
        ...
        ((half_t*)s_shared)[((((((((((ic & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((i_3 & 3) >> 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((i_3 >> 4) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_3 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((i_3 & 7) >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_3 & 1))] = ((half_t)condval);
      }
      tl::fence_proxy_async();
    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int ic_1 = 0; ic_1 < 7; ++ic_1) {
        overlap_plan_mbar[4].wait((ic_1 & 1));
        overlap_plan_mbar[6].wait((ic_1 & 1));
        {
          ...
          for (int ki_4 = 0; ki_4 < 4; ++ki_4) {
            tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(uint64_t(desc_a_4 + ((ki_4 * 32) >> 4)), uint64_t(desc_b_4 + ((ki_4 * 2048) >> 4)), ((uint32_t*)(o_v1 + 0)), ((0 < ki_4) ? 1 : 0));
          }
          tl::warpgroup_commit_batch();
          tl::warpgroup_wait<0>();
          tl::warpgroup_fence_operand(reinterpret_cast<float*>(o_v1 + 0), 32);
        ...
        overlap_plan_mbar[1].wait((ic_1 & 1));
        overlap_plan_mbar[8].wait((ic_1 & 1));
        {
          ...
          for (int ki_5 = 0; ki_5 < 4; ++ki_5) {
            tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(uint64_t(desc_a_5 + ((ki_5 * 32) >> 4)), uint64_t(desc_b_5 + ((ki_5 * 2048) >> 4)), ((uint32_t*)(o_v1 + 0)), 1);
          }
          tl::warpgroup_commit_batch();
          tl::warpgroup_wait<0>();
          tl::warpgroup_fence_operand(reinterpret_cast<float*>(o_v1 + 0), 32);
        ...
        if (1 <= ic_1) {
          overlap_plan_mbar[22].wait(((ic_1 + 1) & 1));
        }
        #pragma unroll
        for (int i_5 = 0; i_5 < 16; ++i_5) {
          *(float2*)(((float*)o_shared) + (((((((((int)threadIdx.x) >> 5) * 1024) + ((i_5 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_5 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096)) = *(float2*)(o_v0 + (i_5 * 2));
        }
        tl::fence_proxy_async();
        overlap_plan_mbar[9].arrive();
        overlap_plan_mbar[3].wait(((ic_1 + 1) & 1));
        overlap_plan_mbar[5].wait(((ic_1 + 1) & 1));
        {
          ...
          for (int ki_6 = 0; ki_6 < 4; ++ki_6) {
            tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(uint64_t(desc_a_6 + ((ki_6 * 32) >> 4)), uint64_t(desc_b_6 + ((ki_6 * 2048) >> 4)), ((uint32_t*)(o_v0 + 0)), ((0 < ki_6) ? 1 : 0));
          }
          tl::warpgroup_commit_batch();
          tl::warpgroup_wait<0>();
          tl::warpgroup_fence_operand(reinterpret_cast<float*>(o_v0 + 0), 32);
        ...
        overlap_plan_mbar[16].arrive();
        overlap_plan_mbar[18].arrive();
        overlap_plan_mbar[0].wait(((ic_1 + 1) & 1));
        overlap_plan_mbar[7].wait(((ic_1 + 1) & 1));
        {
          ...
          for (int ki_7 = 0; ki_7 < 4; ++ki_7) {
            tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(uint64_t(desc_a_7 + ((ki_7 * 32) >> 4)), uint64_t(desc_b_7 + ((ki_7 * 2048) >> 4)), ((uint32_t*)(o_v0 + 0)), 1);
          }
          tl::warpgroup_commit_batch();
          tl::warpgroup_wait<0>();
          tl::warpgroup_fence_operand(reinterpret_cast<float*>(o_v0 + 0), 32);
        ...
        overlap_plan_mbar[20].arrive();
        if (1 <= ic_1) {
          overlap_plan_mbar[23].wait(((ic_1 + 1) & 1));
        }
        #pragma unroll
        for (int i_6 = 0; i_6 < 16; ++i_6) {
          *(float2*)(((float*)o_shared) + ((((((((int)threadIdx.x) >> 5) * 1024) + ((i_6 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_6 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(o_v1 + (i_6 * 2));
        }
        tl::fence_proxy_async();
      ...
      overlap_plan_mbar[6].wait(1);
      {
        ...
        for (int ki_8 = 0; ki_8 < 4; ++ki_8) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(uint64_t(desc_a_8 + ((ki_8 * 32) >> 4)), uint64_t(desc_b_8 + ((ki_8 * 2048) >> 4)), ((uint32_t*)(o_v1 + 0)), ((0 < ki_8) ? 1 : 0));
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(o_v1 + 0), 32);
      ...
      overlap_plan_mbar[8].wait(1);
      {
        ...
        for (int ki_9 = 0; ki_9 < 4; ++ki_9) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(uint64_t(desc_a_9 + ((ki_9 * 32) >> 4)), uint64_t(desc_b_9 + ((ki_9 * 2048) >> 4)), ((uint32_t*)(o_v1 + 0)), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(o_v1 + 0), 32);
      ...
      overlap_plan_mbar[12].arrive();
      overlap_plan_mbar[21].arrive();
      overlap_plan_mbar[22].wait(0);
      tl::__sync_thread_partial(4, 128);
      #pragma unroll
      for (int i_7 = 0; i_7 < 16; ++i_7) {
        *(float2*)(((float*)o_shared) + (((((((((int)threadIdx.x) >> 5) * 1024) + ((i_7 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_7 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096)) = *(float2*)(o_v0 + (i_7 * 2));
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[9].arrive();
      overlap_plan_mbar[23].wait(0);
      #pragma unroll
      for (int i_8 = 0; i_8 < 16; ++i_8) {
        *(float2*)(((float*)o_shared) + ((((((((int)threadIdx.x) >> 5) * 1024) + ((i_8 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_8 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(o_v1 + (i_8 * 2));
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[10].arrive();
    } else {
      ...
      for (int ic_2 = 0; ic_2 < 16; ++ic_2) {
        ...
        for (int i_9 = 0; i_9 < 8; ++i_9) {
          AtomicAddx4((&(O[(((((((((((int)blockIdx.z) >> 5) * 4194304) + (ic_2 * 262144)) + (i_9 * 32768)) + ((((int)threadIdx.x) >> 4) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 15) * 4)) - 65536)])), *(float4*)(((float*)o_shared) + (((((ic_2 & 1) * 4096) + (i_9 * 512)) + (((int)threadIdx.x) * 4)) - 1024)));
        }
