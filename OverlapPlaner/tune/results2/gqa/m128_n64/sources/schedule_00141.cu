...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap K_desc, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc) {
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[1].arrive_and_expect_tx(16384);
      tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[0])), 0, 64, (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[4096])), 64, 64, (((int)blockIdx.y) >> 3), 0);
    }
    #pragma unroll
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
    ...
    for (int k = 0; k < 20; ++k) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[1].arrive_and_expect_tx(16384);
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[0])), 0, ((k * 192) + 128), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[4096])), 64, ((k * 192) + 128), (((int)blockIdx.y) >> 3), 0);
      }
      #pragma unroll
      ...
      overlap_plan_mbar[1].wait((k & 1));
      {
        ...
        for (int ki_2 = 0; ki_2 < 8; ++ki_2) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, false, 1, 1>(uint64_t(desc_a_2 + (((((ki_2 >> 2) * 16384) + ((((int)threadIdx.x) >> 7) * 8192)) + ((ki_2 & 3) * 32)) >> 4)), uint64_t(desc_b_2 + ((((ki_2 >> 2) * 8192) + ((ki_2 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + 0)), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 64);
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
      ...
      for (int i_18 = 0; i_18 < 2; ++i_18) {
        ...
        for (int rv_4 = 0; rv_4 < 16; ++rv_4) {
          scores_max_clear_2[i_18] = max(scores_max_clear_2[i_18], acc_s[((((rv_4 & 7) * 4) + (i_18 * 2)) + (rv_4 >> 3))]);
        }
      ...
      for (int i_22 = 0; i_22 < 2; ++i_22) {
        ...
        for (int rv_5 = 0; rv_5 < 16; ++rv_5) {
          scores_sum[i_22] = (scores_sum[i_22] + acc_s[((((rv_5 & 7) * 4) + (i_22 * 2)) + (rv_5 >> 3))]);
        }
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((((k * 3) + 1) & 1) + 2)].arrive_and_expect_tx(16384);
        tl::tma_load(V_desc, overlap_plan_mbar[((((k * 3) + 1) & 1) + 2)], (&(((half_t*)V_shared)[((((k * 3) + 1) & 1) * 8192)])), 0, ((k * 192) + 64), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[((((k * 3) + 1) & 1) + 2)], (&(((half_t*)V_shared)[(((((k * 3) + 1) & 1) * 8192) + 4096)])), 64, ((k * 192) + 64), (((int)blockIdx.y) >> 3), 0);
      }
      overlap_plan_mbar[((k & 1) + 2)].wait((((k * 3) & 3) >> 1));
      {
        tl::GmmaDescriptor desc_b_3;
        tl::initialize_wgmma_descriptor<1, 512, 64>(desc_b_3, (&(((half_t*)V_shared)[0])));
        tl::increase_descriptor_offset<int>(desc_b_3, ((k & 1) * 16384));
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[1].arrive_and_expect_tx(16384);
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[0])), 0, ((k * 192) + 192), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[4096])), 64, ((k * 192) + 192), (((int)blockIdx.y) >> 3), 0);
      }
      #pragma unroll
      ...
      overlap_plan_mbar[1].wait((((k * 3) + 1) & 1));
      {
        ...
        for (int ki_4 = 0; ki_4 < 8; ++ki_4) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, false, 1, 1>(uint64_t(desc_a_3 + (((((ki_4 >> 2) * 16384) + ((((int)threadIdx.x) >> 7) * 8192)) + ((ki_4 & 3) * 32)) >> 4)), uint64_t(desc_b_4 + ((((ki_4 >> 2) * 8192) + ((ki_4 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + 0)), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 64);
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
      ...
      for (int i_27 = 0; i_27 < 2; ++i_27) {
        ...
        for (int rv_6 = 0; rv_6 < 16; ++rv_6) {
          scores_max_clear_3[i_27] = max(scores_max_clear_3[i_27], acc_s[((((rv_6 & 7) * 4) + (i_27 * 2)) + (rv_6 >> 3))]);
        }
      ...
      for (int i_31 = 0; i_31 < 2; ++i_31) {
        ...
        for (int rv_7 = 0; rv_7 < 16; ++rv_7) {
          scores_sum[i_31] = (scores_sum[i_31] + acc_s[((((rv_7 & 7) * 4) + (i_31 * 2)) + (rv_7 >> 3))]);
        }
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((k & 1) + 2)].arrive_and_expect_tx(16384);
        tl::tma_load(V_desc, overlap_plan_mbar[((k & 1) + 2)], (&(((half_t*)V_shared)[((k & 1) * 8192)])), 0, ((k * 192) + 128), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[((k & 1) + 2)], (&(((half_t*)V_shared)[(((k & 1) * 8192) + 4096)])), 64, ((k * 192) + 128), (((int)blockIdx.y) >> 3), 0);
      }
      overlap_plan_mbar[((((k * 3) + 1) & 1) + 2)].wait(((((k * 3) + 1) & 3) >> 1));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_5, ((((k * 3) + 1) & 1) * 16384));
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[1].arrive_and_expect_tx(16384);
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[0])), 0, ((k * 192) + 256), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[4096])), 64, ((k * 192) + 256), (((int)blockIdx.y) >> 3), 0);
      }
      #pragma unroll
      ...
      overlap_plan_mbar[1].wait((k & 1));
      {
        ...
        for (int ki_6 = 0; ki_6 < 8; ++ki_6) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, false, 1, 1>(uint64_t(desc_a_4 + (((((ki_6 >> 2) * 16384) + ((((int)threadIdx.x) >> 7) * 8192)) + ((ki_6 & 3) * 32)) >> 4)), uint64_t(desc_b_6 + ((((ki_6 >> 2) * 8192) + ((ki_6 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + 0)), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 64);
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_7, broadcast_var_7);
      ...
      for (int i_36 = 0; i_36 < 2; ++i_36) {
        ...
        for (int rv_8 = 0; rv_8 < 16; ++rv_8) {
          scores_max_clear_4[i_36] = max(scores_max_clear_4[i_36], acc_s[((((rv_8 & 7) * 4) + (i_36 * 2)) + (rv_8 >> 3))]);
        }
      ...
      for (int i_40 = 0; i_40 < 2; ++i_40) {
        ...
        for (int rv_9 = 0; rv_9 < 16; ++rv_9) {
          scores_sum[i_40] = (scores_sum[i_40] + acc_s[((((rv_9 & 7) * 4) + (i_40 * 2)) + (rv_9 >> 3))]);
        }
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((((k * 3) + 1) & 1) + 2)].arrive_and_expect_tx(16384);
        tl::tma_load(V_desc, overlap_plan_mbar[((((k * 3) + 1) & 1) + 2)], (&(((half_t*)V_shared)[((((k * 3) + 1) & 1) * 8192)])), 0, ((k * 192) + 192), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[((((k * 3) + 1) & 1) + 2)], (&(((half_t*)V_shared)[(((((k * 3) + 1) & 1) * 8192) + 4096)])), 64, ((k * 192) + 192), (((int)blockIdx.y) >> 3), 0);
      }
      overlap_plan_mbar[((k & 1) + 2)].wait(((((k * 3) >> 1) + 1) & 1));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_7, ((k & 1) * 16384));
    ...
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[1].arrive_and_expect_tx(16384);
      tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[0])), 0, 3968, (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[4096])), 64, 3968, (((int)blockIdx.y) >> 3), 0);
    }
    #pragma unroll
    ...
    overlap_plan_mbar[1].wait(0);
    {
      ...
      for (int ki_8 = 0; ki_8 < 8; ++ki_8) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, false, 1, 1>(uint64_t(desc_a_5 + (((((ki_8 >> 2) * 16384) + ((((int)threadIdx.x) >> 7) * 8192)) + ((ki_8 & 3) * 32)) >> 4)), uint64_t(desc_b_8 + ((((ki_8 >> 2) * 8192) + ((ki_8 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 64);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_8, broadcast_var_8);
    ...
    for (int i_45 = 0; i_45 < 2; ++i_45) {
      ...
      for (int rv_10 = 0; rv_10 < 16; ++rv_10) {
        scores_max_clear_5[i_45] = max(scores_max_clear_5[i_45], acc_s[((((rv_10 & 7) * 4) + (i_45 * 2)) + (rv_10 >> 3))]);
      }
    ...
    for (int i_49 = 0; i_49 < 2; ++i_49) {
      ...
      for (int rv_11 = 0; rv_11 < 16; ++rv_11) {
        scores_sum[i_49] = (scores_sum[i_49] + acc_s[((((rv_11 & 7) * 4) + (i_49 * 2)) + (rv_11 >> 3))]);
      }
    ...
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(V_desc, overlap_plan_mbar[3], (&(((half_t*)V_shared)[8192])), 0, 3904, (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(V_desc, overlap_plan_mbar[3], (&(((half_t*)V_shared)[12288])), 64, 3904, (((int)blockIdx.y) >> 3), 0);
    }
    ...
    overlap_plan_mbar[1].wait(1);
    {
      ...
      for (int ki_10 = 0; ki_10 < 8; ++ki_10) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, false, 1, 1>(uint64_t(desc_a_6 + (((((ki_10 >> 2) * 16384) + ((((int)threadIdx.x) >> 7) * 8192)) + ((ki_10 & 3) * 32)) >> 4)), uint64_t(desc_b_10 + ((((ki_10 >> 2) * 8192) + ((ki_10 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 64);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_9, broadcast_var_9);
    ...
    for (int i_54 = 0; i_54 < 2; ++i_54) {
      ...
      for (int rv_12 = 0; rv_12 < 16; ++rv_12) {
        scores_max_clear_6[i_54] = max(scores_max_clear_6[i_54], acc_s[((((rv_12 & 7) * 4) + (i_54 * 2)) + (rv_12 >> 3))]);
      }
    ...
    for (int i_58 = 0; i_58 < 2; ++i_58) {
      ...
      for (int rv_13 = 0; rv_13 < 16; ++rv_13) {
        scores_sum[i_58] = (scores_sum[i_58] + acc_s[((((rv_13 & 7) * 4) + (i_58 * 2)) + (rv_13 >> 3))]);
      }
    ...
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[2].arrive_and_expect_tx(16384);
      tl::tma_load(V_desc, overlap_plan_mbar[2], (&(((half_t*)V_shared)[0])), 0, 3968, (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(V_desc, overlap_plan_mbar[2], (&(((half_t*)V_shared)[4096])), 64, 3968, (((int)blockIdx.y) >> 3), 0);
    }
    ...
    overlap_plan_mbar[2].wait(1);
    {
      ...
      tl::initialize_wgmma_descriptor<1, 512, 64>(desc_b_12, (&(((half_t*)V_shared)[0])));
      tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(acc_s_cast_v2 + 0), 16);
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_o + 0), 128);
      tl::warpgroup_arrive();
      #pragma unroll
    ...
    overlap_plan_mbar[3].wait(1);
    {
      ...
      tl::increase_descriptor_offset<int>(desc_b_13, 16384);
      tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(acc_s_cast_v0 + 0), 16);
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_o + 0), 128);
      tl::warpgroup_arrive();
      #pragma unroll
    ...
    for (int i_65 = 0; i_65 < 8; ++i_65) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)O_shared)[(((((i_65 >> 2) * 8192) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_65 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_65 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_o[(i_65 * 8)]), ((half_t)acc_o[((i_65 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_65 * 8) + 2)]), ((half_t)acc_o[((i_65 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_65 * 8) + 4)]), ((half_t)acc_o[((i_65 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_65 * 8) + 6)]), ((half_t)acc_o[((i_65 * 8) + 7)])));
    }
