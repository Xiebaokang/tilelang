...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap K_desc, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc) {
  ...
  void* K_shared = ((void*)((char*)buf_dyn_shmem + 131072));
  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
  ...
  if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
    ...
    tl::tma_load(V_desc, overlap_plan_mbar[2], (&(((half_t*)V_shared)[8192])), 64, 0, (((int)blockIdx.y) >> 3), 0);
  }
  overlap_plan_mbar[5].wait(0);
  if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
    overlap_plan_mbar[1].arrive_and_expect_tx(32768);
    tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[0])), 0, 128, (((int)blockIdx.y) >> 3), 0);
    tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[8192])), 64, 128, (((int)blockIdx.y) >> 3), 0);
  }
  #pragma unroll
  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
  ...
  if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
    ...
    tl::tma_load(V_desc, overlap_plan_mbar[3], (&(((half_t*)V_shared)[16384])), 0, 128, (((int)blockIdx.y) >> 3), 0);
    tl::tma_load(V_desc, overlap_plan_mbar[3], (&(((half_t*)V_shared)[24576])), 64, 128, (((int)blockIdx.y) >> 3), 0);
  }
  #pragma unroll
  ...
  for (int k = 0; k < 5; ++k) {
    ...
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[1].arrive_and_expect_tx(32768);
      tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[0])), 0, ((k * 768) + 256), (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[8192])), 64, ((k * 768) + 256), (((int)blockIdx.y) >> 3), 0);
    }
    #pragma unroll
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
    ...
    for (int i_19 = 0; i_19 < 2; ++i_19) {
      ...
      for (int rv_4 = 0; rv_4 < 32; ++rv_4) {
        scores_max_clear_2[i_19] = max(scores_max_clear_2[i_19], acc_s[((((rv_4 & 15) * 4) + (i_19 * 2)) + (rv_4 >> 4))]);
      }
      scores_max_clear_2[i_19] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_19]);
    ...
    for (int i_23 = 0; i_23 < 2; ++i_23) {
      ...
      for (int rv_5 = 0; rv_5 < 32; ++rv_5) {
        scores_sum[i_23] = (scores_sum[i_23] + acc_s[((((rv_5 & 15) * 4) + (i_23 * 2)) + (rv_5 >> 4))]);
      }
    ...
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[4].arrive_and_expect_tx(32768);
      tl::tma_load(V_desc, overlap_plan_mbar[4], (&(((half_t*)V_shared)[32768])), 0, ((k * 768) + 256), (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(V_desc, overlap_plan_mbar[4], (&(((half_t*)V_shared)[40960])), 64, ((k * 768) + 256), (((int)blockIdx.y) >> 3), 0);
    }
    ...
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[1].arrive_and_expect_tx(32768);
      tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[0])), 0, ((k * 768) + 384), (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[8192])), 64, ((k * 768) + 384), (((int)blockIdx.y) >> 3), 0);
    }
    #pragma unroll
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
    ...
    for (int i_28 = 0; i_28 < 2; ++i_28) {
      ...
      for (int rv_6 = 0; rv_6 < 32; ++rv_6) {
        scores_max_clear_3[i_28] = max(scores_max_clear_3[i_28], acc_s[((((rv_6 & 15) * 4) + (i_28 * 2)) + (rv_6 >> 4))]);
      }
      scores_max_clear_3[i_28] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_max_clear_3[i_28]);
    ...
    for (int i_32 = 0; i_32 < 2; ++i_32) {
      ...
      for (int rv_7 = 0; rv_7 < 32; ++rv_7) {
        scores_sum[i_32] = (scores_sum[i_32] + acc_s[((((rv_7 & 15) * 4) + (i_32 * 2)) + (rv_7 >> 4))]);
      }
    ...
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[2].arrive_and_expect_tx(32768);
      tl::tma_load(V_desc, overlap_plan_mbar[2], (&(((half_t*)V_shared)[0])), 0, ((k * 768) + 384), (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(V_desc, overlap_plan_mbar[2], (&(((half_t*)V_shared)[8192])), 64, ((k * 768) + 384), (((int)blockIdx.y) >> 3), 0);
    }
    overlap_plan_mbar[3].wait(0);
    {
      tl::GmmaDescriptor desc_b_5;
      tl::initialize_wgmma_descriptor<1, 1024, 64>(desc_b_5, (&(((half_t*)V_shared)[0])));
      tl::increase_descriptor_offset<int>(desc_b_5, 32768);
    ...
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[1].arrive_and_expect_tx(32768);
      tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[0])), 0, ((k * 768) + 512), (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[8192])), 64, ((k * 768) + 512), (((int)blockIdx.y) >> 3), 0);
    }
    #pragma unroll
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_7, broadcast_var_7);
    ...
    for (int i_37 = 0; i_37 < 2; ++i_37) {
      ...
      for (int rv_8 = 0; rv_8 < 32; ++rv_8) {
        scores_max_clear_4[i_37] = max(scores_max_clear_4[i_37], acc_s[((((rv_8 & 15) * 4) + (i_37 * 2)) + (rv_8 >> 4))]);
      }
      scores_max_clear_4[i_37] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_max_clear_4[i_37]);
    ...
    for (int i_41 = 0; i_41 < 2; ++i_41) {
      ...
      for (int rv_9 = 0; rv_9 < 32; ++rv_9) {
        scores_sum[i_41] = (scores_sum[i_41] + acc_s[((((rv_9 & 15) * 4) + (i_41 * 2)) + (rv_9 >> 4))]);
      }
      scores_sum[i_41] = tl::AllReduce<tl::SumOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_sum[i_41]);
    }
    #pragma unroll
    ...
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[3].arrive_and_expect_tx(32768);
      tl::tma_load(V_desc, overlap_plan_mbar[3], (&(((half_t*)V_shared)[16384])), 0, ((k * 768) + 512), (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(V_desc, overlap_plan_mbar[3], (&(((half_t*)V_shared)[24576])), 64, ((k * 768) + 512), (((int)blockIdx.y) >> 3), 0);
    }
    ...
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[1].arrive_and_expect_tx(32768);
      tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[0])), 0, ((k * 768) + 640), (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[8192])), 64, ((k * 768) + 640), (((int)blockIdx.y) >> 3), 0);
    }
    #pragma unroll
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_8, broadcast_var_8);
    ...
    for (int i_46 = 0; i_46 < 2; ++i_46) {
      ...
      for (int rv_10 = 0; rv_10 < 32; ++rv_10) {
        scores_max_clear_5[i_46] = max(scores_max_clear_5[i_46], acc_s[((((rv_10 & 15) * 4) + (i_46 * 2)) + (rv_10 >> 4))]);
      }
      scores_max_clear_5[i_46] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_max_clear_5[i_46]);
    ...
    for (int i_50 = 0; i_50 < 2; ++i_50) {
      ...
      for (int rv_11 = 0; rv_11 < 32; ++rv_11) {
        scores_sum[i_50] = (scores_sum[i_50] + acc_s[((((rv_11 & 15) * 4) + (i_50 * 2)) + (rv_11 >> 4))]);
      }
    ...
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[4].arrive_and_expect_tx(32768);
      tl::tma_load(V_desc, overlap_plan_mbar[4], (&(((half_t*)V_shared)[32768])), 0, ((k * 768) + 640), (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(V_desc, overlap_plan_mbar[4], (&(((half_t*)V_shared)[40960])), 64, ((k * 768) + 640), (((int)blockIdx.y) >> 3), 0);
    }
    ...
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[1].arrive_and_expect_tx(32768);
      tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[0])), 0, ((k * 768) + 768), (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[8192])), 64, ((k * 768) + 768), (((int)blockIdx.y) >> 3), 0);
    }
    #pragma unroll
    for (int i_54 = 0; i_54 < 64; ++i_54) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_9, broadcast_var_9);
    ...
    for (int i_55 = 0; i_55 < 2; ++i_55) {
      ...
      for (int rv_12 = 0; rv_12 < 32; ++rv_12) {
        scores_max_clear_6[i_55] = max(scores_max_clear_6[i_55], acc_s[((((rv_12 & 15) * 4) + (i_55 * 2)) + (rv_12 >> 4))]);
      }
      scores_max_clear_6[i_55] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_max_clear_6[i_55]);
    ...
    for (int i_59 = 0; i_59 < 2; ++i_59) {
      ...
      for (int rv_13 = 0; rv_13 < 32; ++rv_13) {
        scores_sum[i_59] = (scores_sum[i_59] + acc_s[((((rv_13 & 15) * 4) + (i_59 * 2)) + (rv_13 >> 4))]);
      }
      scores_sum[i_59] = tl::AllReduce<tl::SumOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_sum[i_59]);
    }
    #pragma unroll
    ...
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[2].arrive_and_expect_tx(32768);
      tl::tma_load(V_desc, overlap_plan_mbar[2], (&(((half_t*)V_shared)[0])), 0, ((k * 768) + 768), (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(V_desc, overlap_plan_mbar[2], (&(((half_t*)V_shared)[8192])), 64, ((k * 768) + 768), (((int)blockIdx.y) >> 3), 0);
    }
    ...
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[1].arrive_and_expect_tx(32768);
      tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[0])), 0, ((k * 768) + 896), (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[8192])), 64, ((k * 768) + 896), (((int)blockIdx.y) >> 3), 0);
    }
    #pragma unroll
    ...
    overlap_plan_mbar[1].wait(1);
    {
      ...
      for (int ki_12 = 0; ki_12 < 8; ++ki_12) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 128, 16, false, false, 1, 1>(uint64_t(desc_a_7 + (((((ki_12 >> 2) * 16384) + ((((int)threadIdx.x) >> 7) * 8192)) + ((ki_12 & 3) * 32)) >> 4)), uint64_t(desc_b_12 + ((((ki_12 >> 2) * 16384) + ((ki_12 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 128);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_10, broadcast_var_10);
    ...
    for (int i_64 = 0; i_64 < 2; ++i_64) {
      ...
      #pragma unroll
      for (int rv_14 = 0; rv_14 < 32; ++rv_14) {
        scores_max_clear_7[i_64] = max(scores_max_clear_7[i_64], acc_s[((((rv_14 & 15) * 4) + (i_64 * 2)) + (rv_14 >> 4))]);
      }
      scores_max_clear_7[i_64] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_max_clear_7[i_64]);
    ...
    for (int i_68 = 0; i_68 < 2; ++i_68) {
      ...
      #pragma unroll
      for (int rv_15 = 0; rv_15 < 32; ++rv_15) {
        scores_sum[i_68] = (scores_sum[i_68] + acc_s[((((rv_15 & 15) * 4) + (i_68 * 2)) + (rv_15 >> 4))]);
      }
      scores_sum[i_68] = tl::AllReduce<tl::SumOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_sum[i_68]);
    }
    #pragma unroll
    ...
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[3].arrive_and_expect_tx(32768);
      tl::tma_load(V_desc, overlap_plan_mbar[3], (&(((half_t*)V_shared)[16384])), 0, ((k * 768) + 896), (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(V_desc, overlap_plan_mbar[3], (&(((half_t*)V_shared)[24576])), 64, ((k * 768) + 896), (((int)blockIdx.y) >> 3), 0);
    }
    overlap_plan_mbar[4].wait(1);
    {
      ...
      tl::increase_descriptor_offset<int>(desc_b_13, 65536);
      tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(acc_s_cast_v2 + 0), 32);
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_o + 0), 128);
      tl::warpgroup_arrive();
      #pragma unroll
  ...
  overlap_plan_mbar[2].wait(0);
  {
    ...
    tl::initialize_wgmma_descriptor<1, 1024, 64>(desc_b_14, (&(((half_t*)V_shared)[0])));
    tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(acc_s_cast_v0 + 0), 32);
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_o + 0), 128);
    tl::warpgroup_arrive();
    #pragma unroll
    for (int ki_14 = 0; ki_14 < 8; ++ki_14) {
  ...
  overlap_plan_mbar[3].wait(0);
  {
    ...
    tl::initialize_wgmma_descriptor<1, 1024, 64>(desc_b_15, (&(((half_t*)V_shared)[0])));
    tl::increase_descriptor_offset<int>(desc_b_15, 32768);
    tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(acc_s_cast_v1 + 0), 32);
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_o + 0), 128);
    tl::warpgroup_arrive();
    #pragma unroll
    for (int ki_15 = 0; ki_15 < 8; ++ki_15) {
  ...
  for (int i_74 = 0; i_74 < 8; ++i_74) {
    tl::ptx_stmatrix_m8n8_x4((&(((half_t*)O_shared)[(((((i_74 >> 2) * 8192) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_74 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_74 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_o[(i_74 * 8)]), ((half_t)acc_o[((i_74 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_74 * 8) + 2)]), ((half_t)acc_o[((i_74 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_74 * 8) + 4)]), ((half_t)acc_o[((i_74 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_74 * 8) + 6)]), ((half_t)acc_o[((i_74 * 8) + 7)])));
  }
