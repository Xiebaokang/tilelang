    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int k_1 = 0; k_1 < 31; ++k_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 8)) {
        ...
        tl::tma_load(K_desc, overlap_plan_mbar[(((k_1 + 1) & 1) + 1)], (&(((half_t*)K_shared)[(((k_1 + 1) & 1) * 16384)])), 0, ((k_1 * 128) + 128), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[(((k_1 + 1) & 1) + 1)], (&(((half_t*)K_shared)[((((k_1 + 1) & 1) * 16384) + 8192)])), 64, ((k_1 * 128) + 128), (((int)blockIdx.y) >> 3), 0);
      }
      if (2 <= k_1) {
