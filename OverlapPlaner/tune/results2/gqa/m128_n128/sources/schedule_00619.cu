  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(K_desc, overlap_plan_mbar[2], (&(((half_t*)K_shared)[16384])), 0, 128, (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(K_desc, overlap_plan_mbar[2], (&(((half_t*)K_shared)[24576])), 64, 128, (((int)blockIdx.y) >> 3), 0);
      overlap_plan_mbar[4].arrive_and_expect_tx(32768);
      tl::tma_load(V_desc, overlap_plan_mbar[4], (&(((half_t*)V_shared)[16384])), 0, 128, (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(V_desc, overlap_plan_mbar[4], (&(((half_t*)V_shared)[24576])), 64, 128, (((int)blockIdx.y) >> 3), 0);
    }
    #pragma unroll
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int k = 0; k < 30; ++k) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((k & 1) + 1)].arrive_and_expect_tx(32768);
        tl::tma_load(K_desc, overlap_plan_mbar[((k & 1) + 1)], (&(((half_t*)K_shared)[((k & 1) * 16384)])), 0, ((k * 128) + 256), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[((k & 1) + 1)], (&(((half_t*)K_shared)[(((k & 1) * 16384) + 8192)])), 64, ((k * 128) + 256), (((int)blockIdx.y) >> 3), 0);
      }
      if (1 <= k) {
        overlap_plan_mbar[(((k + 2) % 3) + 9)].wait((((k + 5) % 6) / 3));
      }
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[(((k + 2) % 3) + 3)].arrive_and_expect_tx(32768);
        tl::tma_load(V_desc, overlap_plan_mbar[(((k + 2) % 3) + 3)], (&(((half_t*)V_shared)[(((k + 2) % 3) * 16384)])), 0, ((k * 128) + 256), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[(((k + 2) % 3) + 3)], (&(((half_t*)V_shared)[((((k + 2) % 3) * 16384) + 8192)])), 64, ((k * 128) + 256), (((int)blockIdx.y) >> 3), 0);
      }
      #pragma unroll
      ...
      overlap_plan_mbar[(((k + 1) & 1) + 7)].arrive();
      overlap_plan_mbar[((k % 3) + 3)].wait(((k % 6) / 3));
      {
        tl::GmmaDescriptor desc_b_2;
        tl::initialize_wgmma_descriptor<1, 1024, 64>(desc_b_2, (&(((half_t*)V_shared)[0])));
        tl::increase_descriptor_offset<int>(desc_b_2, ((k % 3) * 32768));
