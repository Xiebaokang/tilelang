    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int k_1 = 0; k_1 < 31; ++k_1) {
        ...
        for (int i_56 = 0; i_56 < 32; ++i_56) {
          *(float2*)(acc_o_v1 + (i_56 * 2)) = *(float2*)(((float*)acc_o_wsp_handoff_3) + ((((((((int)threadIdx.x) >> 5) * 2048) + ((i_56 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_56 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        }
        {
        ...
        for (int i_57 = 0; i_57 < 32; ++i_57) {
          *(float2*)(((float*)acc_o_wsp_handoff_5) + (((((((((int)threadIdx.x) >> 5) * 2048) + ((i_57 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_57 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 8192)) = *(float2*)(acc_o_v1 + (i_57 * 2));
        }
        tl::fence_proxy_async();
        overlap_plan_mbar[7].arrive();
      ...
      for (int i_62 = 0; i_62 < 32; ++i_62) {
        *(float2*)(acc_o_v1 + (i_62 * 2)) = *(float2*)(((float*)acc_o_wsp_handoff_3) + ((((((((int)threadIdx.x) >> 5) * 2048) + ((i_62 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_62 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      }
      {
      ...
      for (int i_63 = 0; i_63 < 32; ++i_63) {
        *(float2*)(((float*)acc_o_wsp_handoff_5) + (((((((((int)threadIdx.x) >> 5) * 2048) + ((i_63 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_63 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 8192)) = *(float2*)(acc_o_v1 + (i_63 * 2));
      }
      #pragma unroll
