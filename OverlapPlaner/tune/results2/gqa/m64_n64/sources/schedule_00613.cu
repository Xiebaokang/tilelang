...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(__grid_constant__ const CUtensorMap K_desc, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc) {
  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    ...
    tl::tma_load(V_desc, overlap_plan_mbar[3], (&(((half_t*)V_shared)[4096])), 64, 0, (((int)blockIdx.y) >> 3), 0);
  }
  for (int k = 0; k < 63; ++k) {
    if (1 <= k) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[(((k + 1) & 1) + 1)].arrive_and_expect_tx(16384);
      tl::tma_load(K_desc, overlap_plan_mbar[(((k + 1) & 1) + 1)], (&(((half_t*)K_shared)[(((k + 1) & 1) * 8192)])), 0, ((k * 64) + 64), (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(K_desc, overlap_plan_mbar[(((k + 1) & 1) + 1)], (&(((half_t*)K_shared)[((((k + 1) & 1) * 8192) + 4096)])), 64, ((k * 64) + 64), (((int)blockIdx.y) >> 3), 0);
    }
    if (1 <= k) {
      overlap_plan_mbar[(((k + 1) & 1) + 7)].wait((((k + 3) & 3) >> 1));
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[(((k + 1) & 1) + 3)].arrive_and_expect_tx(16384);
      tl::tma_load(V_desc, overlap_plan_mbar[(((k + 1) & 1) + 3)], (&(((half_t*)V_shared)[(((k + 1) & 1) * 8192)])), 0, ((k * 64) + 64), (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(V_desc, overlap_plan_mbar[(((k + 1) & 1) + 3)], (&(((half_t*)V_shared)[((((k + 1) & 1) * 8192) + 4096)])), 64, ((k * 64) + 64), (((int)blockIdx.y) >> 3), 0);
    }
