    ...
    for (int k = 0; k < 32; ++k) {
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
      ...
      for (int i_9 = 0; i_9 < 32; ++i_9) {
        *(float2*)(acc_o_v0 + (i_9 * 2)) = *(float2*)(((float*)acc_o_wsp_handoff_5) + (((((((((int)threadIdx.x) >> 5) * 2048) + ((i_9 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_9 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 8192));
      }
      #pragma unroll
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(V_desc, overlap_plan_mbar[4], (&(((half_t*)V_shared)[0])), 0, (k * 128), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[4], (&(((half_t*)V_shared)[4096])), 64, (k * 128), (((int)blockIdx.y) >> 3), 0);
      }
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
      ...
      for (int i_22 = 0; i_22 < 32; ++i_22) {
        *(float2*)(((float*)acc_o_wsp_handoff_3) + ((((((((int)threadIdx.x) >> 5) * 2048) + ((i_22 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_22 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(acc_o_v1 + (i_22 * 2));
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[3].arrive();
      if (1 <= k) {
