...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap K_desc, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var, broadcast_var);
    for (int k = 0; k < 32; ++k) {
      if (2 <= k) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(K_desc, overlap_plan_mbar[((k & 1) + 1)], (&(((half_t*)K_shared)[((k & 1) * 16384)])), 0, (k * 128), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[((k & 1) + 1)], (&(((half_t*)K_shared)[(((k & 1) * 16384) + 8192)])), 64, (k * 128), (((int)blockIdx.y) >> 3), 0);
      }
      if (2 <= k) {
        overlap_plan_mbar[((k & 1) + 11)].wait((((k >> 1) + 1) & 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((k & 1) + 6)].arrive_and_expect_tx(32768);
        tl::tma_load(V_desc, overlap_plan_mbar[((k & 1) + 6)], (&(((half_t*)V_shared)[((k & 1) * 16384)])), 0, (k * 128), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[((k & 1) + 6)], (&(((half_t*)V_shared)[(((k & 1) * 16384) + 8192)])), 64, (k * 128), (((int)blockIdx.y) >> 3), 0);
      }
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_1, broadcast_var_1);
      ...
      #pragma unroll
      for (int i = 0; i < 32; ++i) {
        *(float2*)(acc_s + (i * 2)) = *(float2*)(((float*)acc_s_wsp_handoff_2) + ((((((((int)threadIdx.x) >> 5) * 2048) + ((i & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      }
      #pragma unroll
      for (int i_1 = 0; i_1 < 2; ++i_1) {
        ...
        for (int rv = 0; rv < 32; ++rv) {
          scores_max_clear[i_1] = max(scores_max_clear[i_1], acc_s[((((rv & 15) * 4) + (i_1 * 2)) + (rv >> 4))]);
        }
        scores_max_clear[i_1] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<128>>::run(scores_max_clear[i_1]);
      ...
      for (int i_6 = 0; i_6 < 32; ++i_6) {
        *(float2*)(((float*)acc_s_wsp_handoff_4) + ((((((((int)threadIdx.x) >> 5) * 2048) + ((i_6 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_6 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(acc_s + (i_6 * 2));
      }
      tl::fence_proxy_async();
    ...
    *(float2*)(logsum + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    for (int k_1 = 0; k_1 < 32; ++k_1) {
      ...
      overlap_plan_mbar[((k_1 & 1) + 1)].wait(((k_1 & 3) >> 1));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b, ((k_1 & 1) * 32768));
      ...
      for (int i_9 = 0; i_9 < 32; ++i_9) {
        *(float2*)(((float*)acc_s_wsp_handoff_2) + (((((((((int)threadIdx.x) >> 5) * 2048) + ((i_9 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_9 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 8192)) = *(float2*)(acc_s + (i_9 * 2));
      }
      tl::fence_proxy_async();
      ...
      for (int i_10 = 0; i_10 < 32; ++i_10) {
        *(float2*)(acc_s + (i_10 * 2)) = *(float2*)(((float*)acc_s_wsp_handoff_4) + (((((((((int)threadIdx.x) >> 5) * 2048) + ((i_10 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_10 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 8192));
      }
      #pragma unroll
      for (int i_11 = 0; i_11 < 16; ++i_11) {
        uint2 __1;
        float4 v_ = *(float4*)(acc_s + (i_11 * 4));
        ((half2*)(&__1))[0] = __float22half2_rn(((float2*)(&v_))[0]);
        ((half2*)(&__1))[1] = __float22half2_rn(((float2*)(&v_))[1]);
        *(uint2*)(acc_s_cast + (i_11 * 4)) = __1;
      }
      overlap_plan_mbar[4].wait((k_1 & 1));
      #pragma unroll
      for (int i_12 = 0; i_12 < 2; ++i_12) {
        scores_scale[i_12] = ((float*)scores_scale_wsp_handoff_3)[(((((((int)threadIdx.x) >> 5) * 16) + (i_12 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) - 64)];
      }
      #pragma unroll
      ...
      overlap_plan_mbar[((k_1 & 1) + 6)].wait(((k_1 & 3) >> 1));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_1, ((k_1 & 1) * 32768));
      ...
      for (int i_14 = 0; i_14 < 2; ++i_14) {
        ...
        for (int rv_1 = 0; rv_1 < 32; ++rv_1) {
          scores_sum[i_14] = (scores_sum[i_14] + acc_s[((((rv_1 & 15) * 4) + (i_14 * 2)) + (rv_1 >> 4))]);
        }
    ...
    for (int i_17 = 0; i_17 < 8; ++i_17) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)O_shared)[(((((i_17 >> 2) * 4096) + (((((int)threadIdx.x) & 127) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_17 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_17 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_o[(i_17 * 8)]), ((half_t)acc_o[((i_17 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_17 * 8) + 2)]), ((half_t)acc_o[((i_17 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_17 * 8) + 4)]), ((half_t)acc_o[((i_17 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_17 * 8) + 6)]), ((half_t)acc_o[((i_17 * 8) + 7)])));
    }
    tl::fence_proxy_async();
