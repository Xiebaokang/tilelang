...
extern "C" __global__ void __launch_bounds__(512, 1) main_kernel(const float* __restrict__ Delta, __grid_constant__ const CUtensorMap K_desc, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc, __grid_constant__ const CUtensorMap dK_desc, __grid_constant__ const CUtensorMap dO_desc, float* __restrict__ dQ, __grid_constant__ const CUtensorMap dV_desc, const float* __restrict__ lse) {
  ...
  void* dq_wsp_handoff_6 = ((void*)((char*)buf_dyn_shmem + 32768));
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int k = 0; k < 32; ++k) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((k & 1) + 5)].arrive_and_expect_tx(128);
        tl::tma_load((&(((float*)delta)[((k & 1) * 32)])), (&(Delta[((((int)blockIdx.x) * 1024) + (k * 32))])), overlap_plan_mbar[((k & 1) + 5)], 128);
      }
      overlap_plan_mbar[7].wait((k & 1));
      #pragma unroll
      for (int i = 0; i < 4; ++i) {
        *(float2*)(dq + (i * 2)) = *(float2*)(((float*)dq_wsp_handoff_6) + ((((((((((int)threadIdx.x) & 63) >> 5) * 1024) + ((i & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((int)threadIdx.x) >> 6) * 16)) + ((i >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      }
      #pragma unroll
    ...
    for (int k_1 = 0; k_1 < 32; ++k_1) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 8)) {
        ...
        tl::tma_load(dO_desc, overlap_plan_mbar[4], (&(((half_t*)do_1)[0])), 0, (k_1 * 32), ((int)blockIdx.x), 0);
      }
      #pragma unroll
      ...
      overlap_plan_mbar[((k_1 & 1) + 5)].wait(((k_1 & 3) >> 1));
      #pragma unroll
      for (int i_8 = 0; i_8 < 8; ++i_8) {
        float delta_local_cast[2];
        *(float2*)(delta_local_cast + 0) = *(float2*)(((float*)delta) + ((((k_1 & 1) * 32) + ((i_8 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      ...
      for (int i_9 = 0; i_9 < 2; ++i_9) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)dsT_shared)[((((((((int)threadIdx.x) & 255) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + i_9) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(dsT_cast[(i_9 * 8)], dsT_cast[((i_9 * 8) + 1)]), __pack_half2(dsT_cast[((i_9 * 8) + 2)], dsT_cast[((i_9 * 8) + 3)]), __pack_half2(dsT_cast[((i_9 * 8) + 4)], dsT_cast[((i_9 * 8) + 5)]), __pack_half2(dsT_cast[((i_9 * 8) + 6)], dsT_cast[((i_9 * 8) + 7)]));
      }
      #pragma unroll
      ...
      for (int i_11 = 0; i_11 < 4; ++i_11) {
        *(float2*)(((float*)dq_wsp_handoff_6) + (((((((((((int)threadIdx.x) & 63) >> 5) * 1024) + ((i_11 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((int)threadIdx.x) >> 6) * 16)) + ((i_11 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 64)) = *(float2*)(dq + (i_11 * 2));
      }
    ...
    for (int i_12 = 0; i_12 < 4; ++i_12) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)gradient_shared)[(((((((int)threadIdx.x) & 255) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_12 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_12 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)dv[(i_12 * 8)]), ((half_t)dv[((i_12 * 8) + 1)])), __pack_half2(((half_t)dv[((i_12 * 8) + 2)]), ((half_t)dv[((i_12 * 8) + 3)])), __pack_half2(((half_t)dv[((i_12 * 8) + 4)]), ((half_t)dv[((i_12 * 8) + 5)])), __pack_half2(((half_t)dv[((i_12 * 8) + 6)]), ((half_t)dv[((i_12 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 256);
