...
extern "C" __global__ void __launch_bounds__(512, 1) main_kernel(const float* __restrict__ Delta, __grid_constant__ const CUtensorMap K_desc, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc, __grid_constant__ const CUtensorMap dK_desc, __grid_constant__ const CUtensorMap dO_desc, float* __restrict__ dQ, __grid_constant__ const CUtensorMap dV_desc, const float* __restrict__ lse) {
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int i_5 = 0; i_5 < 4; ++i_5) {
      ...
      *(float4*)(dsT + (i_5 * 4)) = make_float4(broadcast_var_4, broadcast_var_4, broadcast_var_4, broadcast_var_4);
    }
    overlap_plan_mbar[1].wait(0);
    {
      ...
      for (int ki_2 = 0; ki_2 < 4; ++ki_2) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_1 + ((((((int)threadIdx.x) >> 7) * 8192) + (ki_2 * 32)) >> 4)), uint64_t(desc_b_2 + ((ki_2 * 32) >> 4)), ((uint32_t*)(dsT + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dsT + 0), 32);
    ...
    for (int i_9 = 0; i_9 < 4; ++i_9) {
      *(float2*)(((float*)dq_wsp_handoff_7) + ((((((((((int)threadIdx.x) & 63) >> 5) * 1024) + ((i_9 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((int)threadIdx.x) >> 6) * 16)) + ((i_9 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(dq + (i_9 * 2));
    }
    ...
    for (int k = 0; k < 15; ++k) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(Q_desc, overlap_plan_mbar[3], (&(((half_t*)q)[2048])), 0, ((k * 64) + 32), ((int)blockIdx.x), 0);
      }
      overlap_plan_mbar[10].wait(0);
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[4].arrive_and_expect_tx(128);
        tl::tma_load((&(((float*)lse_shared)[0])), (&(lse[(((((int)blockIdx.x) * 1024) + (k * 64)) + 32)])), overlap_plan_mbar[4], 128);
      }
      overlap_plan_mbar[11].wait(0);
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[5].arrive_and_expect_tx(4096);
        tl::tma_load(dO_desc, overlap_plan_mbar[5], (&(((half_t*)do_1)[0])), 0, ((k * 64) + 32), ((int)blockIdx.x), 0);
      }
      ...
      for (int i_13 = 0; i_13 < 4; ++i_13) {
        ...
        *(float4*)(dsT + (i_13 * 4)) = make_float4(broadcast_var_9, broadcast_var_9, broadcast_var_9, broadcast_var_9);
      }
      {
        ...
        for (int ki_6 = 0; ki_6 < 4; ++ki_6) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_3 + ((((((int)threadIdx.x) >> 7) * 8192) + (ki_6 * 32)) >> 4)), uint64_t(desc_b_5 + ((ki_6 * 32) >> 4)), ((uint32_t*)(dsT + 0)), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(dsT + 0), 32);
      ...
      for (int i_14 = 0; i_14 < 8; ++i_14) {
        ...
        *(float2*)(delta_local_cast_1 + 0) = *(float2*)(((float*)delta) + (((i_14 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)));
        float broadcast_var_10 = 0x1p-3f/*1.250000e-01*/;
        uint1 __13;
        float2 __14;
          float2 __15;
            float2 v__12 = *(float2*)(qkT + (i_14 * 2));
            float2 __16;
              float2 v__13 = *(float2*)(dsT + (i_14 * 2));
        ...
        *(uint1*)(dsT_cast_v1 + (i_14 * 2)) = __13;
      }
      overlap_plan_mbar[12].arrive();
      #pragma unroll
      for (int i_15 = 0; i_15 < 2; ++i_15) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)dsT_shared)[(((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + i_15) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(dsT_cast_v1[(i_15 * 8)], dsT_cast_v1[((i_15 * 8) + 1)]), __pack_half2(dsT_cast_v1[((i_15 * 8) + 2)], dsT_cast_v1[((i_15 * 8) + 3)]), __pack_half2(dsT_cast_v1[((i_15 * 8) + 4)], dsT_cast_v1[((i_15 * 8) + 5)]), __pack_half2(dsT_cast_v1[((i_15 * 8) + 6)], dsT_cast_v1[((i_15 * 8) + 7)]));
      }
      #pragma unroll
      ...
      for (int i_17 = 0; i_17 < 4; ++i_17) {
        *(float2*)(((float*)dq_wsp_handoff_7) + ((((((((((int)threadIdx.x) & 63) >> 5) * 1024) + ((i_17 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((int)threadIdx.x) >> 6) * 16)) + ((i_17 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(dq + (i_17 * 2));
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[7].arrive();
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[2].arrive_and_expect_tx(4096);
        tl::tma_load(Q_desc, overlap_plan_mbar[2], (&(((half_t*)q)[0])), 0, ((k * 64) + 64), ((int)blockIdx.x), 0);
      }
      overlap_plan_mbar[10].wait(1);
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[4].arrive_and_expect_tx(128);
        tl::tma_load((&(((float*)lse_shared)[0])), (&(lse[(((((int)blockIdx.x) * 1024) + (k * 64)) + 64)])), overlap_plan_mbar[4], 128);
      }
      overlap_plan_mbar[11].wait(1);
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[5].arrive_and_expect_tx(4096);
        tl::tma_load(dO_desc, overlap_plan_mbar[5], (&(((half_t*)do_1)[0])), 0, ((k * 64) + 64), ((int)blockIdx.x), 0);
      }
      ...
      for (int i_18 = 0; i_18 < 4; ++i_18) {
        ...
        *(float4*)(qkT + (i_18 * 4)) = make_float4(broadcast_var_12, broadcast_var_12, broadcast_var_12, broadcast_var_12);
      }
      ...
      for (int i_21 = 0; i_21 < 4; ++i_21) {
        ...
        *(float4*)(dsT + (i_21 * 4)) = make_float4(broadcast_var_14, broadcast_var_14, broadcast_var_14, broadcast_var_14);
      }
      {
        ...
        for (int ki_11 = 0; ki_11 < 4; ++ki_11) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_5 + ((((((int)threadIdx.x) >> 7) * 8192) + (ki_11 * 32)) >> 4)), uint64_t(desc_b_9 + ((ki_11 * 32) >> 4)), ((uint32_t*)(dsT + 0)), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(dsT + 0), 32);
      ...
      for (int i_22 = 0; i_22 < 8; ++i_22) {
        ...
        *(float2*)(delta_local_cast_2 + 0) = *(float2*)(((float*)delta) + (((i_22 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)));
        float broadcast_var_15 = 0x1p-3f/*1.250000e-01*/;
        uint1 __21;
        float2 __22;
          float2 __23;
            float2 v__20 = *(float2*)(qkT + (i_22 * 2));
            float2 __24;
              float2 v__21 = *(float2*)(dsT + (i_22 * 2));
        ...
        *(uint1*)(dsT_cast_v0 + (i_22 * 2)) = __21;
      }
      overlap_plan_mbar[12].arrive();
      #pragma unroll
      for (int i_23 = 0; i_23 < 2; ++i_23) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)dsT_shared)[(((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + i_23) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(dsT_cast_v0[(i_23 * 8)], dsT_cast_v0[((i_23 * 8) + 1)]), __pack_half2(dsT_cast_v0[((i_23 * 8) + 2)], dsT_cast_v0[((i_23 * 8) + 3)]), __pack_half2(dsT_cast_v0[((i_23 * 8) + 4)], dsT_cast_v0[((i_23 * 8) + 5)]), __pack_half2(dsT_cast_v0[((i_23 * 8) + 6)], dsT_cast_v0[((i_23 * 8) + 7)]));
      }
      #pragma unroll
      for (int i_24 = 0; i_24 < 2; ++i_24) {
        float broadcast_var_16 = 0x0p+0f/*0.000000e+00*/;
        *(float4*)(dq + (i_24 * 4)) = make_float4(broadcast_var_16, broadcast_var_16, broadcast_var_16, broadcast_var_16);
      }
      {
        half_t A_local_2[8];
        half_t B_local_2[8];
        ...
        for (int ki_12 = 0; ki_12 < 8; ++ki_12) {
          ...
          tl::ptx_ldmatrix_x4_trans((&(((half_t*)K_shared)[(((ki_12 * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_2[0])));
      ...
      for (int i_25 = 0; i_25 < 4; ++i_25) {
        *(float2*)(((float*)dq_wsp_handoff_7) + ((((((((((int)threadIdx.x) & 63) >> 5) * 1024) + ((i_25 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((int)threadIdx.x) >> 6) * 16)) + ((i_25 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(dq + (i_25 * 2));
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[7].arrive();
      overlap_plan_mbar[3].wait((k & 1));
    ...
    for (int i_26 = 0; i_26 < 4; ++i_26) {
      ...
      *(float4*)(qkT + (i_26 * 4)) = make_float4(broadcast_var_17, broadcast_var_17, broadcast_var_17, broadcast_var_17);
    }
    ...
    for (int i_29 = 0; i_29 < 4; ++i_29) {
      ...
      *(float4*)(dsT + (i_29 * 4)) = make_float4(broadcast_var_19, broadcast_var_19, broadcast_var_19, broadcast_var_19);
    }
    {
      ...
      for (int ki_16 = 0; ki_16 < 4; ++ki_16) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_7 + ((((((int)threadIdx.x) >> 7) * 8192) + (ki_16 * 32)) >> 4)), uint64_t(desc_b_13 + ((ki_16 * 32) >> 4)), ((uint32_t*)(dsT + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dsT + 0), 32);
    ...
    for (int i_30 = 0; i_30 < 8; ++i_30) {
      ...
      *(float2*)(delta_local_cast_3 + 0) = *(float2*)(((float*)delta) + (((i_30 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)));
      float broadcast_var_20 = 0x1p-3f/*1.250000e-01*/;
      uint1 __29;
      float2 __30;
        float2 __31;
          float2 v__28 = *(float2*)(qkT + (i_30 * 2));
          float2 __32;
            float2 v__29 = *(float2*)(dsT + (i_30 * 2));
      ...
      *(uint1*)(dsT_cast_v1 + (i_30 * 2)) = __29;
    }
    overlap_plan_mbar[12].arrive();
    #pragma unroll
    for (int i_31 = 0; i_31 < 2; ++i_31) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)dsT_shared)[(((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + i_31) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(dsT_cast_v1[(i_31 * 8)], dsT_cast_v1[((i_31 * 8) + 1)]), __pack_half2(dsT_cast_v1[((i_31 * 8) + 2)], dsT_cast_v1[((i_31 * 8) + 3)]), __pack_half2(dsT_cast_v1[((i_31 * 8) + 4)], dsT_cast_v1[((i_31 * 8) + 5)]), __pack_half2(dsT_cast_v1[((i_31 * 8) + 6)], dsT_cast_v1[((i_31 * 8) + 7)]));
    }
    #pragma unroll
    for (int i_32 = 0; i_32 < 2; ++i_32) {
      float broadcast_var_21 = 0x0p+0f/*0.000000e+00*/;
      *(float4*)(dq + (i_32 * 4)) = make_float4(broadcast_var_21, broadcast_var_21, broadcast_var_21, broadcast_var_21);
    }
    {
      half_t A_local_3[8];
      half_t B_local_3[8];
      ...
      for (int ki_17 = 0; ki_17 < 8; ++ki_17) {
        ...
        tl::ptx_ldmatrix_x4_trans((&(((half_t*)K_shared)[(((ki_17 * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_3[0])));
    ...
    for (int i_33 = 0; i_33 < 4; ++i_33) {
      *(float2*)(((float*)dq_wsp_handoff_7) + ((((((((((int)threadIdx.x) & 63) >> 5) * 1024) + ((i_33 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((int)threadIdx.x) >> 6) * 16)) + ((i_33 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(dq + (i_33 * 2));
    }
    tl::fence_proxy_async();
    overlap_plan_mbar[7].arrive();
    ...
    for (int k_1 = 0; k_1 < 32; ++k_1) {
      ...
      for (int i_36 = 0; i_36 < 4; ++i_36) {
        *(float2*)(dq + (i_36 * 2)) = *(float2*)(((float*)dq_wsp_handoff_7) + (((((((((((int)threadIdx.x) & 63) >> 5) * 1024) + ((i_36 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((int)threadIdx.x) >> 6) * 16)) + ((i_36 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 64));
      }
      #pragma unroll
      for (int i_37 = 0; i_37 < 8; ++i_37) {
        AtomicAdd((&(dQ[(((((((((k_1 * 32768) + (((((int)threadIdx.x) & 63) >> 5) * 16384)) + (((i_37 & 3) >> 1) * 8192)) + (((int)blockIdx.x) * 512)) + ((((int)threadIdx.x) >> 6) * 128)) + ((i_37 >> 2) * 64)) + ((i_37 & 1) * 32)) + (((int)threadIdx.x) & 31)) - 512)])), dq[i_37]);
      }
    }
  }
}
