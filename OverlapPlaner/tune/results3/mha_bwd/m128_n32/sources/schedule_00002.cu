...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(const float* __restrict__ Delta, __grid_constant__ const CUtensorMap K_desc, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc, __grid_constant__ const CUtensorMap dK_desc, __grid_constant__ const CUtensorMap dO_desc, float* __restrict__ dQ, __grid_constant__ const CUtensorMap dV_desc, const float* __restrict__ lse) {
  ...
  for (int k = 0; k < 15; ++k) {
    ...
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(Q_desc, overlap_plan_mbar[2], (&(((half_t*)q)[0])), 0, ((k * 64) + 32), ((int)blockIdx.x), 0);
    }
    overlap_plan_mbar[7].wait(0);
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[3].arrive_and_expect_tx(128);
      tl::fence_proxy_async();
      tl::tma_load((&(((float*)lse_shared)[0])), (&(lse[(((((int)blockIdx.x) * 1024) + (k * 64)) + 32)])), overlap_plan_mbar[3], 128);
    }
    ...
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[5].arrive_and_expect_tx(128);
      tl::fence_proxy_async();
      tl::tma_load((&(((float*)delta)[0])), (&(Delta[(((((int)blockIdx.x) * 1024) + (k * 64)) + 32)])), overlap_plan_mbar[5], 128);
    }
    #pragma unroll
    ...
    overlap_plan_mbar[2].wait(1);
    {
      ...
      for (int ki_5 = 0; ki_5 < 4; ++ki_5) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_2 + ((((((int)threadIdx.x) >> 7) * 8192) + (ki_5 * 32)) >> 4)), uint64_t(desc_b_4 + ((ki_5 * 32) >> 4)), ((uint32_t*)(qkT + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(qkT + 0), 32);
    ...
    for (int i_12 = 0; i_12 < 4; ++i_12) {
      ...
      *(float4*)(dsT + (i_12 * 4)) = make_float4(broadcast_var_9, broadcast_var_9, broadcast_var_9, broadcast_var_9);
    }
    {
      ...
      for (int ki_7 = 0; ki_7 < 4; ++ki_7) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_3 + ((((((int)threadIdx.x) >> 7) * 8192) + (ki_7 * 32)) >> 4)), uint64_t(desc_b_6 + ((ki_7 * 32) >> 4)), ((uint32_t*)(dsT + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dsT + 0), 32);
    ...
    overlap_plan_mbar[9].arrive();
    {
      ...
      for (int ki_8 = 0; ki_8 < 2; ++ki_8) {
        tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(dsT_cast + (ki_8 * 8)), uint64_t(desc_b_7 + ((ki_8 * 2048) >> 4)), reinterpret_cast<uint32_t*>(dk + 0), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dk + 0), 64);
    ...
    overlap_plan_mbar[2].wait(0);
    {
      ...
      for (int ki_10 = 0; ki_10 < 4; ++ki_10) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_4 + ((((((int)threadIdx.x) >> 7) * 8192) + (ki_10 * 32)) >> 4)), uint64_t(desc_b_8 + ((ki_10 * 32) >> 4)), ((uint32_t*)(qkT + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(qkT + 0), 32);
    ...
    for (int i_20 = 0; i_20 < 4; ++i_20) {
      ...
      *(float4*)(dsT + (i_20 * 4)) = make_float4(broadcast_var_14, broadcast_var_14, broadcast_var_14, broadcast_var_14);
    }
    {
      ...
      for (int ki_12 = 0; ki_12 < 4; ++ki_12) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_5 + ((((((int)threadIdx.x) >> 7) * 8192) + (ki_12 * 32)) >> 4)), uint64_t(desc_b_10 + ((ki_12 * 32) >> 4)), ((uint32_t*)(dsT + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dsT + 0), 32);
    ...
    overlap_plan_mbar[9].arrive();
    {
      ...
      for (int ki_13 = 0; ki_13 < 2; ++ki_13) {
        tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(dsT_cast + (ki_13 * 8)), uint64_t(desc_b_11 + ((ki_13 * 2048) >> 4)), reinterpret_cast<uint32_t*>(dk + 0), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dk + 0), 64);
    ...
    for (int i_22 = 0; i_22 < 2; ++i_22) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)dsT_shared)[(((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + i_22) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(dsT_cast[(i_22 * 8)], dsT_cast[((i_22 * 8) + 1)]), __pack_half2(dsT_cast[((i_22 * 8) + 2)], dsT_cast[((i_22 * 8) + 3)]), __pack_half2(dsT_cast[((i_22 * 8) + 4)], dsT_cast[((i_22 * 8) + 5)]), __pack_half2(dsT_cast[((i_22 * 8) + 6)], dsT_cast[((i_22 * 8) + 7)]));
    }
    #pragma unroll
    ...
    }
    {
      ...
      for (int ki_14 = 0; ki_14 < 8; ++ki_14) {
        tl::ptx_ldmatrix_x4_trans((&(((half_t*)dsT_shared)[(((((ki_14 * 512) + (((((int)threadIdx.x) & 31) >> 4) * 256)) + ((((int)threadIdx.x) & 7) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), (&(A_local_2[0])));
        tl::ptx_ldmatrix_x4_trans((&(((half_t*)K_shared)[(((ki_14 * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_2[0])));
  ...
  if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
    overlap_plan_mbar[2].arrive_and_expect_tx(4096);
    tl::fence_proxy_async();
    tl::tma_load(Q_desc, overlap_plan_mbar[2], (&(((half_t*)q)[0])), 0, 992, ((int)blockIdx.x), 0);
  }
  overlap_plan_mbar[7].wait(0);
  if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
    overlap_plan_mbar[3].arrive_and_expect_tx(128);
    tl::fence_proxy_async();
    tl::tma_load((&(((float*)lse_shared)[0])), (&(lse[((((int)blockIdx.x) * 1024) + 992)])), overlap_plan_mbar[3], 128);
  }
  overlap_plan_mbar[8].wait(0);
  if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
    overlap_plan_mbar[4].arrive_and_expect_tx(4096);
  ...
  if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
    overlap_plan_mbar[5].arrive_and_expect_tx(128);
    tl::fence_proxy_async();
    tl::tma_load((&(((float*)delta)[0])), (&(Delta[((((int)blockIdx.x) * 1024) + 992)])), overlap_plan_mbar[5], 128);
  }
  #pragma unroll
  ...
  overlap_plan_mbar[2].wait(1);
  {
    ...
    for (int ki_15 = 0; ki_15 < 4; ++ki_15) {
      tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_6 + ((((((int)threadIdx.x) >> 7) * 8192) + (ki_15 * 32)) >> 4)), uint64_t(desc_b_12 + ((ki_15 * 32) >> 4)), ((uint32_t*)(qkT + 0)), 1);
    }
    tl::warpgroup_commit_batch();
    tl::warpgroup_wait<0>();
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(qkT + 0), 32);
  ...
  for (int i_28 = 0; i_28 < 4; ++i_28) {
    ...
    *(float4*)(dsT + (i_28 * 4)) = make_float4(broadcast_var_19, broadcast_var_19, broadcast_var_19, broadcast_var_19);
  }
  {
    ...
    for (int ki_17 = 0; ki_17 < 4; ++ki_17) {
      tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_7 + ((((((int)threadIdx.x) >> 7) * 8192) + (ki_17 * 32)) >> 4)), uint64_t(desc_b_14 + ((ki_17 * 32) >> 4)), ((uint32_t*)(dsT + 0)), 1);
    }
    tl::warpgroup_commit_batch();
    tl::warpgroup_wait<0>();
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(dsT + 0), 32);
  ...
  overlap_plan_mbar[9].arrive();
  {
    ...
    for (int ki_18 = 0; ki_18 < 2; ++ki_18) {
      tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(dsT_cast + (ki_18 * 8)), uint64_t(desc_b_15 + ((ki_18 * 2048) >> 4)), reinterpret_cast<uint32_t*>(dk + 0), 1);
    }
    tl::warpgroup_commit_batch();
    tl::warpgroup_wait<0>();
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(dk + 0), 64);
  ...
  for (int i_30 = 0; i_30 < 2; ++i_30) {
    tl::ptx_stmatrix_m8n8_x4((&(((half_t*)dsT_shared)[(((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + i_30) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(dsT_cast[(i_30 * 8)], dsT_cast[((i_30 * 8) + 1)]), __pack_half2(dsT_cast[((i_30 * 8) + 2)], dsT_cast[((i_30 * 8) + 3)]), __pack_half2(dsT_cast[((i_30 * 8) + 4)], dsT_cast[((i_30 * 8) + 5)]), __pack_half2(dsT_cast[((i_30 * 8) + 6)], dsT_cast[((i_30 * 8) + 7)]));
  }
  #pragma unroll
