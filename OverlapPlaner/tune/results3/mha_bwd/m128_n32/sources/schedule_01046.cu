  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int k = 0; k < 32; ++k) {
      ...
      for (int i_9 = 0; i_9 < 4; ++i_9) {
        *(float2*)(((float*)dq_wsp_handoff_6) + ((((((((((int)threadIdx.x) & 63) >> 5) * 1024) + ((i_9 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((int)threadIdx.x) >> 6) * 16)) + ((i_9 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(dq + (i_9 * 2));
      }
    ...
    for (int k_1 = 0; k_1 < 32; ++k_1) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 8)) {
        ...
        tl::tma_load((&(((float*)delta)[((k_1 & 1) * 32)])), (&(Delta[((((int)blockIdx.x) * 1024) + (k_1 * 32))])), overlap_plan_mbar[((k_1 & 1) + 5)], 128);
      }
      overlap_plan_mbar[7].wait((k_1 & 1));
      #pragma unroll
      for (int i_12 = 0; i_12 < 4; ++i_12) {
        *(float2*)(dq + (i_12 * 2)) = *(float2*)(((float*)dq_wsp_handoff_6) + (((((((((((int)threadIdx.x) & 63) >> 5) * 1024) + ((i_12 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((int)threadIdx.x) >> 6) * 16)) + ((i_12 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 64));
      }
      #pragma unroll
      for (int i_13 = 0; i_13 < 8; ++i_13) {
        AtomicAdd((&(dQ[(((((((((k_1 * 32768) + (((((int)threadIdx.x) & 63) >> 5) * 16384)) + (((i_13 & 3) >> 1) * 8192)) + (((int)blockIdx.x) * 512)) + ((((int)threadIdx.x) >> 6) * 128)) + ((i_13 >> 2) * 64)) + ((i_13 & 1) * 32)) + (((int)threadIdx.x) & 31)) - 512)])), dq[i_13]);
      }
    }
  }
}
