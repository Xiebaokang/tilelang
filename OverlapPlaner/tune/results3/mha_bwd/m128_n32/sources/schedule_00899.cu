...
extern "C" __global__ void __launch_bounds__(512, 1) main_kernel(const float* __restrict__ Delta, __grid_constant__ const CUtensorMap K_desc, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc, __grid_constant__ const CUtensorMap dK_desc, __grid_constant__ const CUtensorMap dO_desc, float* __restrict__ dQ, __grid_constant__ const CUtensorMap dV_desc, const float* __restrict__ lse) {
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int i_6 = 0; i_6 < 4; ++i_6) {
      ...
      *(float4*)(dsT + (i_6 * 4)) = make_float4(broadcast_var_4, broadcast_var_4, broadcast_var_4, broadcast_var_4);
    }
    ...
    for (int k_1 = 0; k_1 < 15; ++k_1) {
      ...
      for (int i_14 = 0; i_14 < 4; ++i_14) {
        ...
        *(float4*)(dsT + (i_14 * 4)) = make_float4(broadcast_var_9, broadcast_var_9, broadcast_var_9, broadcast_var_9);
      }
      overlap_plan_mbar[5].wait(1);
      {
        ...
        for (int ki_5 = 0; ki_5 < 4; ++ki_5) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_3 + (((((((int)threadIdx.x) & 255) >> 7) * 8192) + (ki_5 * 32)) >> 4)), uint64_t(desc_b_4 + ((ki_5 * 32) >> 4)), ((uint32_t*)(dsT + 0)), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(dsT + 0), 32);
      ...
      }
      {
        ...
        for (int ki_8 = 0; ki_8 < 8; ++ki_8) {
          ...
          tl::ptx_ldmatrix_x4_trans((&(((half_t*)K_shared)[(((ki_8 * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 255) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_1[0])));
      ...
      for (int i_22 = 0; i_22 < 4; ++i_22) {
        ...
        *(float4*)(dsT + (i_22 * 4)) = make_float4(broadcast_var_14, broadcast_var_14, broadcast_var_14, broadcast_var_14);
      }
      overlap_plan_mbar[5].wait(0);
      {
        ...
        for (int ki_10 = 0; ki_10 < 4; ++ki_10) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_5 + (((((((int)threadIdx.x) & 255) >> 7) * 8192) + (ki_10 * 32)) >> 4)), uint64_t(desc_b_8 + ((ki_10 * 32) >> 4)), ((uint32_t*)(dsT + 0)), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(dsT + 0), 32);
      ...
      }
      {
        ...
        for (int ki_13 = 0; ki_13 < 8; ++ki_13) {
          ...
          tl::ptx_ldmatrix_x4_trans((&(((half_t*)K_shared)[(((ki_13 * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 255) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_2[0])));
    ...
    for (int i_30 = 0; i_30 < 4; ++i_30) {
      ...
      *(float4*)(dsT + (i_30 * 4)) = make_float4(broadcast_var_19, broadcast_var_19, broadcast_var_19, broadcast_var_19);
    }
    overlap_plan_mbar[5].wait(1);
    {
      ...
      for (int ki_15 = 0; ki_15 < 4; ++ki_15) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_7 + (((((((int)threadIdx.x) & 255) >> 7) * 8192) + (ki_15 * 32)) >> 4)), uint64_t(desc_b_12 + ((ki_15 * 32) >> 4)), ((uint32_t*)(dsT + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dsT + 0), 32);
    ...
    }
    {
      ...
      for (int ki_18 = 0; ki_18 < 8; ++ki_18) {
        ...
        tl::ptx_ldmatrix_x4_trans((&(((half_t*)K_shared)[(((ki_18 * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 255) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_3[0])));
