...
extern "C" __global__ void __launch_bounds__(512, 1) main_kernel(const float* __restrict__ Delta, __grid_constant__ const CUtensorMap K_desc, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc, __grid_constant__ const CUtensorMap dK_desc, __grid_constant__ const CUtensorMap dO_desc, float* __restrict__ dQ, __grid_constant__ const CUtensorMap dV_desc, const float* __restrict__ lse) {
  ...
  void* qkT_wsp_handoff_4 = ((void*)((char*)buf_dyn_shmem + 32768));
  void* do_1 = ((void*)((char*)buf_dyn_shmem + 49152));
  void* dsT_shared = ((void*)((char*)buf_dyn_shmem + 57344));
  void* q = ((void*)((char*)buf_dyn_shmem + 65536));
  void* delta = ((void*)((char*)buf_dyn_shmem + 69632));
  void* lse_shared = ((void*)((char*)buf_dyn_shmem + 70656));
  void* gradient_shared = ((void*)((char*)buf_dyn_shmem + 71680));
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int i = 0; i < 8; ++i) {
      ...
      *(float4*)(dk + (i * 4)) = make_float4(broadcast_var, broadcast_var, broadcast_var, broadcast_var);
    }
    for (int k = 0; k < 32; ++k) {
      if (1 <= k) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load((&(((float*)lse_shared)[0])), (&(lse[((((int)blockIdx.x) * 1024) + (k * 32))])), overlap_plan_mbar[3], 128);
      }
      ...
      for (int i_3 = 0; i_3 < 8; ++i_3) {
        *(float2*)(((float*)qkT_wsp_handoff_4) + ((((((((int)threadIdx.x) >> 5) * 512) + ((i_3 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_3 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(qkT + (i_3 * 2));
      }
      tl::fence_proxy_async();
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((k & 1) + 5)].arrive_and_expect_tx(4096);
        tl::tma_load(dO_desc, overlap_plan_mbar[((k & 1) + 5)], (&(((half_t*)do_1)[((k & 1) * 2048)])), 0, (k * 32), ((int)blockIdx.x), 0);
      }
      #pragma unroll
        ...
        *(float2*)(delta_local_cast + 0) = *(float2*)(((float*)delta) + (((i_5 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)));
        ...
        float2 __5;
          float2 __6;
            ...
            __6.x = (v__3.x*__7.x);
            __6.y = (v__3.y*__7.y);
          float2 v__6 = make_float2(broadcast_var_4, broadcast_var_4);
          __5.x = (__6.x*v__6.x);
          __5.y = (__6.y*v__6.y);
      ...
      for (int i_7 = 0; i_7 < 2; ++i_7) {
        ...
        *(float4*)(dq + (i_7 * 4)) = make_float4(broadcast_var_5, broadcast_var_5, broadcast_var_5, broadcast_var_5);
      }
      {
        half_t A_local[8];
        half_t B_local[8];
      ...
      for (int i_8 = 0; i_8 < 8; ++i_8) {
        AtomicAdd((&(dQ[((((((((k * 32768) + (((((int)threadIdx.x) & 63) >> 5) * 16384)) + (((i_8 & 3) >> 1) * 8192)) + (((int)blockIdx.x) * 512)) + ((((int)threadIdx.x) >> 6) * 128)) + ((i_8 >> 2) * 64)) + ((i_8 & 1) * 32)) + (((int)threadIdx.x) & 31))])), dq[i_8]);
      }
    }
    ...
    for (int i_9 = 0; i_9 < 4; ++i_9) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)gradient_shared)[((((((int)threadIdx.x) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_9 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_9 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)dk[(i_9 * 8)]), ((half_t)dk[((i_9 * 8) + 1)])), __pack_half2(((half_t)dk[((i_9 * 8) + 2)]), ((half_t)dk[((i_9 * 8) + 3)])), __pack_half2(((half_t)dk[((i_9 * 8) + 4)]), ((half_t)dk[((i_9 * 8) + 5)])), __pack_half2(((half_t)dk[((i_9 * 8) + 6)]), ((half_t)dk[((i_9 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 256);
    if (tl::tl_shuffle_elect<256>()) {
      tl::fence_proxy_async();
    ...
    for (int i_10 = 0; i_10 < 8; ++i_10) {
      ...
      *(float4*)(dv + (i_10 * 4)) = make_float4(broadcast_var_6, broadcast_var_6, broadcast_var_6, broadcast_var_6);
    }
    for (int k_1 = 0; k_1 < 32; ++k_1) {
      overlap_plan_mbar[4].wait((k_1 & 1));
      #pragma unroll
      for (int i_11 = 0; i_11 < 8; ++i_11) {
        *(float2*)(qkT + (i_11 * 2)) = *(float2*)(((float*)qkT_wsp_handoff_4) + (((((((((int)threadIdx.x) >> 5) * 512) + ((i_11 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_11 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
      }
      #pragma unroll
      ...
      overlap_plan_mbar[((k_1 & 1) + 5)].wait(((k_1 & 3) >> 1));
      {
        ...
        tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_3, (&(((half_t*)do_1)[0])));
        ...
        for (int ki_4 = 0; ki_4 < 2; ++ki_4) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(qkT_cast + (ki_4 * 8)), uint64_t(desc_b_3 + ((ki_4 * 2048) >> 4)), reinterpret_cast<uint32_t*>(dv + 0), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(dv + 0), 64);
    ...
    for (int i_13 = 0; i_13 < 4; ++i_13) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)gradient_shared)[(((((((int)threadIdx.x) & 255) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_13 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_13 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)dv[(i_13 * 8)]), ((half_t)dv[((i_13 * 8) + 1)])), __pack_half2(((half_t)dv[((i_13 * 8) + 2)]), ((half_t)dv[((i_13 * 8) + 3)])), __pack_half2(((half_t)dv[((i_13 * 8) + 4)]), ((half_t)dv[((i_13 * 8) + 5)])), __pack_half2(((half_t)dv[((i_13 * 8) + 6)]), ((half_t)dv[((i_13 * 8) + 7)])));
    }
    tl::fence_proxy_async();
