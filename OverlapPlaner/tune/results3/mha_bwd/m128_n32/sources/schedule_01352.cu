  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int k = 0; k < 32; ++k) {
      ...
      for (int i_4 = 0; i_4 < 8; ++i_4) {
        *(float2*)(((float*)qkT_wsp_handoff_4) + ((((((((int)threadIdx.x) >> 5) * 512) + ((i_4 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_4 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(qkT + (i_4 * 2));
      }
      ...
      for (int i_7 = 0; i_7 < 8; ++i_7) {
        *(float2*)(((float*)dsT_wsp_handoff_6) + ((((((((int)threadIdx.x) >> 5) * 512) + ((i_7 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_7 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(dsT + (i_7 * 2));
      }
      tl::fence_proxy_async();
    ...
    for (int k_1 = 0; k_1 < 32; ++k_1) {
      ...
      for (int i_13 = 0; i_13 < 8; ++i_13) {
        *(float2*)(qkT + (i_13 * 2)) = *(float2*)(((float*)qkT_wsp_handoff_4) + (((((((((int)threadIdx.x) >> 5) * 512) + ((i_13 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_13 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
      }
      #pragma unroll
      for (int i_14 = 0; i_14 < 8; ++i_14) {
        *(float2*)(dsT + (i_14 * 2)) = *(float2*)(((float*)dsT_wsp_handoff_6) + (((((((((int)threadIdx.x) >> 5) * 512) + ((i_14 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_14 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
      }
      tl::__sync_thread_partial(4, 256);
      #pragma unroll
