...
extern "C" __global__ void __launch_bounds__(512, 1) main_kernel(const float* __restrict__ Delta, __grid_constant__ const CUtensorMap K_desc, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc, __grid_constant__ const CUtensorMap dK_desc, __grid_constant__ const CUtensorMap dO_desc, float* __restrict__ dQ, __grid_constant__ const CUtensorMap dV_desc, const float* __restrict__ lse) {
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int i_5 = 0; i_5 < 4; ++i_5) {
      ...
      *(float4*)(dsT + (i_5 * 4)) = make_float4(broadcast_var_3, broadcast_var_3, broadcast_var_3, broadcast_var_3);
    }
    ...
    for (int i_6 = 0; i_6 < 8; ++i_6) {
      ...
      float2 __2;
        float2 __3;
          float2 v_ = *(float2*)(qkT + (i_6 * 2));
          float2 v__1 = make_float2(broadcast_var_4, broadcast_var_4);
          __3.x = (v_.x*v__1.x);
          __3.y = (v_.y*v__1.y);
        float2 v__2 = *(float2*)(((float*)lse_shared) + (((i_6 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)));
        __2.x = (__3.x-v__2.x);
        __2.y = (__3.y-v__2.y);
      __1.x = exp2f(__2.x);
      __1.y = exp2f(__2.y);
      *(float2*)(qkT + (i_6 * 2)) = __1;
    }
    ...
    for (int k_1 = 0; k_1 < 15; ++k_1) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 8)) {
        overlap_plan_mbar[4].arrive_and_expect_tx(4096);
        tl::tma_load(dO_desc, overlap_plan_mbar[4], (&(((half_t*)do_1)[0])), 0, ((k_1 * 64) + 32), ((int)blockIdx.x), 0);
      }
      #pragma unroll
      for (int i_13 = 0; i_13 < 4; ++i_13) {
        float broadcast_var_8 = 0x0p+0f/*0.000000e+00*/;
        *(float4*)(dsT + (i_13 * 4)) = make_float4(broadcast_var_8, broadcast_var_8, broadcast_var_8, broadcast_var_8);
      }
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 8)) {
        overlap_plan_mbar[5].arrive_and_expect_tx(128);
        tl::tma_load((&(((float*)lse_shared)[0])), (&(lse[(((((int)blockIdx.x) * 1024) + (k_1 * 64)) + 32)])), overlap_plan_mbar[5], 128);
      }
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 8)) {
        overlap_plan_mbar[4].arrive_and_expect_tx(4096);
        tl::tma_load(dO_desc, overlap_plan_mbar[4], (&(((half_t*)do_1)[0])), 0, ((k_1 * 64) + 64), ((int)blockIdx.x), 0);
      }
      #pragma unroll
      for (int i_21 = 0; i_21 < 4; ++i_21) {
        float broadcast_var_13 = 0x0p+0f/*0.000000e+00*/;
        *(float4*)(dsT + (i_21 * 4)) = make_float4(broadcast_var_13, broadcast_var_13, broadcast_var_13, broadcast_var_13);
      }
      overlap_plan_mbar[4].wait(0);
      {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 8)) {
        overlap_plan_mbar[5].arrive_and_expect_tx(128);
        tl::tma_load((&(((float*)lse_shared)[0])), (&(lse[(((((int)blockIdx.x) * 1024) + (k_1 * 64)) + 64)])), overlap_plan_mbar[5], 128);
      }
      overlap_plan_mbar[5].wait(0);
      tl::__sync_thread_partial(3, 256);
      #pragma unroll
    ...
    for (int i_29 = 0; i_29 < 4; ++i_29) {
      ...
      *(float4*)(dsT + (i_29 * 4)) = make_float4(broadcast_var_18, broadcast_var_18, broadcast_var_18, broadcast_var_18);
    }
    overlap_plan_mbar[4].wait(1);
    {
