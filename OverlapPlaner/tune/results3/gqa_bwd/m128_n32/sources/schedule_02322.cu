...
extern "C" __global__ void __launch_bounds__(512, 1) main_kernel(const float* __restrict__ Delta, __grid_constant__ const CUtensorMap K_desc, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc, __grid_constant__ const CUtensorMap dK_desc, __grid_constant__ const CUtensorMap dO_desc, float* __restrict__ dQ, __grid_constant__ const CUtensorMap dV_desc, const float* __restrict__ lse) {
  ...
  void* dsT_wsp_handoff_5 = ((void*)((char*)buf_dyn_shmem + 32768));
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int k = 0; k < 32; ++k) {
      ...
      for (int i_5 = 0; i_5 < 8; ++i_5) {
        *(float2*)(dsT + (i_5 * 2)) = *(float2*)(((float*)dsT_wsp_handoff_5) + ((((((((int)threadIdx.x) >> 5) * 512) + ((i_5 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_5 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      }
      tl::__sync_thread_partial(3, 256);
      #pragma unroll
    ...
    for (int k_1 = 0; k_1 < 32; ++k_1) {
      ...
      for (int i_12 = 0; i_12 < 4; ++i_12) {
        ...
        *(float4*)(dsT + (i_12 * 4)) = make_float4(broadcast_var_6, broadcast_var_6, broadcast_var_6, broadcast_var_6);
      }
      if (k_1 == 0) {
      ...
      overlap_plan_mbar[((k_1 & 1) + 3)].wait(((k_1 & 3) >> 1));
      {
        ...
        for (int ki_4 = 0; ki_4 < 4; ++ki_4) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_1 + (((((((int)threadIdx.x) & 255) >> 7) * 8192) + (ki_4 * 32)) >> 4)), uint64_t(desc_b_3 + ((ki_4 * 32) >> 4)), ((uint32_t*)(dsT + 0)), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(dsT + 0), 32);
      ...
      for (int i_13 = 0; i_13 < 8; ++i_13) {
        *(float2*)(((float*)dsT_wsp_handoff_5) + (((((((((int)threadIdx.x) >> 5) * 512) + ((i_13 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_13 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096)) = *(float2*)(dsT + (i_13 * 2));
      }
      tl::fence_proxy_async();
