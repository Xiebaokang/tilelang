  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int k_1 = 0; k_1 < 32; ++k_1) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 8)) {
        ...
        tl::tma_load(dO_desc, overlap_plan_mbar[3], (&(((half_t*)do_1)[0])), 0, (k_1 * 32), ((int)blockIdx.x), 0);
      }
      if (1 <= k_1) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 8)) {
        ...
        tl::tma_load((&(((float*)lse_shared)[0])), (&(lse[((((int)blockIdx.x) * 1024) + (k_1 * 32))])), overlap_plan_mbar[4], 128);
      }
      #pragma unroll
