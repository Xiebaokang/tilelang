  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int k = 0; k < 63; ++k) {
      ...
      for (int i_8 = 0; i_8 < 2; ++i_8) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)S_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + i_8) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_s_v0[(i_8 * 8)]), ((half_t)acc_s_v0[((i_8 * 8) + 1)])), __pack_half2(((half_t)acc_s_v0[((i_8 * 8) + 2)]), ((half_t)acc_s_v0[((i_8 * 8) + 3)])), __pack_half2(((half_t)acc_s_v0[((i_8 * 8) + 4)]), ((half_t)acc_s_v0[((i_8 * 8) + 5)])), __pack_half2(((half_t)acc_s_v0[((i_8 * 8) + 6)]), ((half_t)acc_s_v0[((i_8 * 8) + 7)])));
      }
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
      ...
      for (int i_9 = 0; i_9 < 2; ++i_9) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_1[i_9] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_9], (&(((float*)workspace_2)[0])));
      ...
      for (int i_13 = 0; i_13 < 2; ++i_13) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_13] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_13], (&(((float*)workspace_5)[0])));
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
      ...
      for (int i_17 = 0; i_17 < 2; ++i_17) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_2[i_17] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_17], (&(((float*)workspace)[0])));
      ...
      for (int i_21 = 0; i_21 < 2; ++i_21) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_21] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_21], (&(((float*)workspace_1)[0])));
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
    ...
    for (int i_25 = 0; i_25 < 2; ++i_25) {
      ...
      tl::__sync_thread_partial(3, 256);
      scores_max_clear_3[i_25] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_3[i_25], (&(((float*)workspace_3)[0])));
    ...
    for (int i_29 = 0; i_29 < 2; ++i_29) {
      ...
      tl::__sync_thread_partial(3, 256);
      scores_sum[i_29] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_29], (&(((float*)workspace_4)[0])));
