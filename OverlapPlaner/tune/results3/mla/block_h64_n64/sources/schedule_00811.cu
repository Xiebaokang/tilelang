  ...
  if (((int)threadIdx.x) < 128) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    ...
    overlap_plan_mbar[2].wait(0);
    {
      ...
      for (int ki = 0; ki < 32; ++ki) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a + ((((ki >> 2) * 8192) + ((ki & 3) * 32)) >> 4)), uint64_t(desc_b + (((((ki >> 2) * 8192) + ((((((int)threadIdx.x) >> 7) + 1) & 1) * 4096)) + ((ki & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + 0)), ((0 < ki) ? 1 : 0));
      }
    ...
    overlap_plan_mbar[4].wait(0);
    {
      ...
      for (int ki_1 = 0; ki_1 < 4; ++ki_1) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_1 + ((ki_1 * 32) >> 4)), uint64_t(desc_b_1 + ((((((((int)threadIdx.x) >> 7) + 1) & 1) * 4096) + (ki_1 * 32)) >> 4)), ((uint32_t*)(acc_s + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 16);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int i_1 = 0; i_1 < 2; ++i_1) {
      ...
      scores_max_clear[i_1] = tl::AllReduce<tl::MaxOp, 256, 128, 128, tl::NamedBarrier<256>>::run(scores_max_clear[i_1], (&(((float*)workspace_3)[0])));
    ...
    for (int i_4 = 0; i_4 < 2; ++i_4) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)S_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) + 1) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + i_4) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_s[(i_4 * 8)]), ((half_t)acc_s[((i_4 * 8) + 1)])), __pack_half2(((half_t)acc_s[((i_4 * 8) + 2)]), ((half_t)acc_s[((i_4 * 8) + 3)])), __pack_half2(((half_t)acc_s[((i_4 * 8) + 4)]), ((half_t)acc_s[((i_4 * 8) + 5)])), __pack_half2(((half_t)acc_s[((i_4 * 8) + 6)]), ((half_t)acc_s[((i_4 * 8) + 7)])));
    }
    #pragma unroll
    ...
    for (int i_6 = 0; i_6 < 2; ++i_6) {
      ...
      tl::__sync_thread_partial(3, 256);
      scores_sum[i_6] = tl::AllReduce<tl::SumOp, 256, 128, 128, tl::NamedBarrier<256>>::run(scores_sum[i_6], (&(((float*)workspace)[0])));
    ...
    for (int k_1 = 0; k_1 < 127; ++k_1) {
      overlap_plan_mbar[(((k_1 + 1) & 1) + 2)].wait((((k_1 + 1) & 3) >> 1));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_2, (((k_1 + 1) & 1) * 65536));
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 16);
        tl::warpgroup_arrive();
        ...
        for (int ki_2 = 0; ki_2 < 32; ++ki_2) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_2 + ((((ki_2 >> 2) * 8192) + ((ki_2 & 3) * 32)) >> 4)), uint64_t(desc_b_2 + (((((ki_2 >> 2) * 8192) + ((((((int)threadIdx.x) >> 7) + 1) & 1) * 4096)) + ((ki_2 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + 0)), ((0 < ki_2) ? 1 : 0));
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 16);
      }
      overlap_plan_mbar[(((k_1 + 1) & 1) + 4)].wait((((k_1 + 1) & 3) >> 1));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_3, (((k_1 + 1) & 1) * 8192));
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 16);
        tl::warpgroup_arrive();
        #pragma unroll
        for (int ki_3 = 0; ki_3 < 4; ++ki_3) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_3 + ((ki_3 * 32) >> 4)), uint64_t(desc_b_3 + ((((((((int)threadIdx.x) >> 7) + 1) & 1) * 4096) + (ki_3 * 32)) >> 4)), ((uint32_t*)(acc_s + 0)), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 16);
      }
      overlap_plan_mbar[(((k_1 + 1) & 1) + 8)].arrive();
      overlap_plan_mbar[((k_1 & 1) + 2)].wait(((k_1 & 3) >> 1));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_4, ((k_1 & 1) * 65536));
      ...
      overlap_plan_mbar[((k_1 & 1) + 6)].arrive();
      *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
      ...
      for (int i_9 = 0; i_9 < 2; ++i_9) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_1[i_9] = tl::AllReduce<tl::MaxOp, 256, 128, 128, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_9], (&(((float*)workspace_1)[0])));
      ...
      for (int i_12 = 0; i_12 < 2; ++i_12) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)S_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) + 1) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + i_12) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_s[(i_12 * 8)]), ((half_t)acc_s[((i_12 * 8) + 1)])), __pack_half2(((half_t)acc_s[((i_12 * 8) + 2)]), ((half_t)acc_s[((i_12 * 8) + 3)])), __pack_half2(((half_t)acc_s[((i_12 * 8) + 4)]), ((half_t)acc_s[((i_12 * 8) + 5)])), __pack_half2(((half_t)acc_s[((i_12 * 8) + 6)]), ((half_t)acc_s[((i_12 * 8) + 7)])));
      }
      #pragma unroll
      ...
      for (int i_14 = 0; i_14 < 2; ++i_14) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_14] = tl::AllReduce<tl::SumOp, 256, 128, 128, tl::NamedBarrier<256>>::run(scores_sum[i_14], (&(((float*)workspace_2)[0])));
        scores_sum[i_14] = tl::AllReduce<tl::SumOp, 4, 1, 128, tl::NamedBarrier<256>>::run(scores_sum[i_14]);
      }
      #pragma unroll
    ...
    overlap_plan_mbar[3].wait(1);
    {
      ...
      for (int ki_5 = 0; ki_5 < 4; ++ki_5) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 256, 16, false, true, 1, 1>(uint64_t(desc_a_5 + ((ki_5 * 32) >> 4)), uint64_t(desc_b_5 + ((((((((int)threadIdx.x) >> 7) + 1) & 1) * 32768) + (ki_5 * 2048)) >> 4)), ((uint32_t*)(acc_o + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_o + 0), 128);
    ...
    for (int i_18 = 0; i_18 < 16; ++i_18) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)O_shared)[((((((((((int)threadIdx.x) & 127) >> 5) * 8192) + ((((int)threadIdx.x) & 15) * 512)) + ((((int)threadIdx.x) >> 7) * 256)) + (i_18 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 256)])), __pack_half2(((half_t)acc_o[(i_18 * 8)]), ((half_t)acc_o[((i_18 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_18 * 8) + 2)]), ((half_t)acc_o[((i_18 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_18 * 8) + 4)]), ((half_t)acc_o[((i_18 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_18 * 8) + 6)]), ((half_t)acc_o[((i_18 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 256);
