  ...
  if (((int)threadIdx.x) < 128) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int i_1 = 0; i_1 < 2; ++i_1) {
      ...
      scores_max_clear[i_1] = tl::AllReduce<tl::MaxOp, 256, 128, 128, tl::NamedBarrier<256>>::run(scores_max_clear[i_1], (&(((float*)workspace_7)[0])));
    ...
    for (int k_1 = 0; k_1 < 63; ++k_1) {
      ...
      for (int i_8 = 0; i_8 < 2; ++i_8) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)S_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) + 1) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + i_8) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_s_v0[(i_8 * 8)]), ((half_t)acc_s_v0[((i_8 * 8) + 1)])), __pack_half2(((half_t)acc_s_v0[((i_8 * 8) + 2)]), ((half_t)acc_s_v0[((i_8 * 8) + 3)])), __pack_half2(((half_t)acc_s_v0[((i_8 * 8) + 4)]), ((half_t)acc_s_v0[((i_8 * 8) + 5)])), __pack_half2(((half_t)acc_s_v0[((i_8 * 8) + 6)]), ((half_t)acc_s_v0[((i_8 * 8) + 7)])));
      }
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
      ...
      for (int i_9 = 0; i_9 < 2; ++i_9) {
        ...
        for (int rv_2 = 0; rv_2 < 8; ++rv_2) {
          scores_max_clear_1[i_9] = max(scores_max_clear_1[i_9], acc_s_v1[((((rv_2 & 3) * 4) + (i_9 * 2)) + (rv_2 >> 2))]);
        }
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_1[i_9] = tl::AllReduce<tl::MaxOp, 256, 128, 128, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_9], (&(((float*)workspace_3)[0])));
        scores_max_clear_1[i_9] = tl::AllReduce<tl::MaxOp, 4, 1, 128, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_9]);
      ...
      for (int i_12 = 0; i_12 < 16; ++i_12) {
        acc_s_v1[i_12] = exp2f(((acc_s_v1[i_12] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[((i_12 & 3) >> 1)] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
      }
      #pragma unroll
      for (int i_13 = 0; i_13 < 2; ++i_13) {
        ...
        for (int rv_3 = 0; rv_3 < 8; ++rv_3) {
          scores_sum[i_13] = (scores_sum[i_13] + acc_s_v1[((((rv_3 & 3) * 4) + (i_13 * 2)) + (rv_3 >> 2))]);
        }
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_13] = tl::AllReduce<tl::SumOp, 256, 128, 128, tl::NamedBarrier<256>>::run(scores_sum[i_13], (&(((float*)workspace)[0])));
        scores_sum[i_13] = tl::AllReduce<tl::SumOp, 4, 1, 128, tl::NamedBarrier<256>>::run(scores_sum[i_13]);
      }
      #pragma unroll
      ...
      for (int i_16 = 0; i_16 < 2; ++i_16) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)S_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) + 1) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + i_16) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_s_v1[(i_16 * 8)]), ((half_t)acc_s_v1[((i_16 * 8) + 1)])), __pack_half2(((half_t)acc_s_v1[((i_16 * 8) + 2)]), ((half_t)acc_s_v1[((i_16 * 8) + 3)])), __pack_half2(((half_t)acc_s_v1[((i_16 * 8) + 4)]), ((half_t)acc_s_v1[((i_16 * 8) + 5)])), __pack_half2(((half_t)acc_s_v1[((i_16 * 8) + 6)]), ((half_t)acc_s_v1[((i_16 * 8) + 7)])));
      }
      overlap_plan_mbar[3].wait((k_1 & 1));
      {
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
      ...
      for (int i_17 = 0; i_17 < 2; ++i_17) {
        ...
        for (int rv_4 = 0; rv_4 < 8; ++rv_4) {
          scores_max_clear_2[i_17] = max(scores_max_clear_2[i_17], acc_s_v0[((((rv_4 & 3) * 4) + (i_17 * 2)) + (rv_4 >> 2))]);
        }
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_2[i_17] = tl::AllReduce<tl::MaxOp, 256, 128, 128, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_17], (&(((float*)workspace_1)[0])));
        scores_max_clear_2[i_17] = tl::AllReduce<tl::MaxOp, 4, 1, 128, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_17]);
      ...
      for (int i_19 = 0; i_19 < 2; ++i_19) {
        scores_scale[i_19] = exp2f(((scores_max_prev[i_19] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[i_19] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
      }
      #pragma unroll
      for (int i_20 = 0; i_20 < 16; ++i_20) {
        acc_s_v0[i_20] = exp2f(((acc_s_v0[i_20] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[((i_20 & 3) >> 1)] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
      }
      #pragma unroll
      for (int i_21 = 0; i_21 < 2; ++i_21) {
        ...
        for (int rv_5 = 0; rv_5 < 8; ++rv_5) {
          scores_sum[i_21] = (scores_sum[i_21] + acc_s_v0[((((rv_5 & 3) * 4) + (i_21 * 2)) + (rv_5 >> 2))]);
        }
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_21] = tl::AllReduce<tl::SumOp, 256, 128, 128, tl::NamedBarrier<256>>::run(scores_sum[i_21], (&(((float*)workspace_2)[0])));
        scores_sum[i_21] = tl::AllReduce<tl::SumOp, 4, 1, 128, tl::NamedBarrier<256>>::run(scores_sum[i_21]);
      }
      #pragma unroll
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
    ...
    for (int i_25 = 0; i_25 < 2; ++i_25) {
      ...
      for (int rv_6 = 0; rv_6 < 8; ++rv_6) {
        scores_max_clear_3[i_25] = max(scores_max_clear_3[i_25], acc_s_v1[((((rv_6 & 3) * 4) + (i_25 * 2)) + (rv_6 >> 2))]);
      }
      tl::__sync_thread_partial(3, 256);
      scores_max_clear_3[i_25] = tl::AllReduce<tl::MaxOp, 256, 128, 128, tl::NamedBarrier<256>>::run(scores_max_clear_3[i_25], (&(((float*)workspace_6)[0])));
      scores_max_clear_3[i_25] = tl::AllReduce<tl::MaxOp, 4, 1, 128, tl::NamedBarrier<256>>::run(scores_max_clear_3[i_25]);
    ...
    for (int i_27 = 0; i_27 < 2; ++i_27) {
      scores_scale[i_27] = exp2f(((scores_max_prev[i_27] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[i_27] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
    }
    #pragma unroll
    for (int i_28 = 0; i_28 < 16; ++i_28) {
      acc_s_v1[i_28] = exp2f(((acc_s_v1[i_28] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[((i_28 & 3) >> 1)] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
    }
    #pragma unroll
    for (int i_29 = 0; i_29 < 2; ++i_29) {
      ...
      for (int rv_7 = 0; rv_7 < 8; ++rv_7) {
        scores_sum[i_29] = (scores_sum[i_29] + acc_s_v1[((((rv_7 & 3) * 4) + (i_29 * 2)) + (rv_7 >> 2))]);
      }
      tl::__sync_thread_partial(3, 256);
      scores_sum[i_29] = tl::AllReduce<tl::SumOp, 256, 128, 128, tl::NamedBarrier<256>>::run(scores_sum[i_29], (&(((float*)workspace_5)[0])));
      scores_sum[i_29] = tl::AllReduce<tl::SumOp, 4, 1, 128, tl::NamedBarrier<256>>::run(scores_sum[i_29]);
    }
    #pragma unroll
