...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap KV_desc, __grid_constant__ const CUtensorMap K_pe_desc, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap Q_pe_desc) {
  ...
  void* workspace_8 = ((void*)((char*)buf_dyn_shmem + 229376));
  void* workspace_9 = ((void*)((char*)buf_dyn_shmem + 229376));
  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
  ...
  for (int i_1 = 0; i_1 < 2; ++i_1) {
    ...
    __syncthreads();
    scores_max_clear[i_1] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear[i_1], (&(((float*)workspace_6)[0])));
  ...
  for (int i_5 = 0; i_5 < 8; ++i_5) {
    ...
    uint1 __1;
    float2 v_ = *(float2*)(acc_s_v0 + (i_5 * 2));
    ((half2*)(&__1))[0] = __float22half2_rn(((float2*)(&v_))[0]);
    *(uint1*)(S_shared_local_cast + 0) = __1;
    *(uint1*)(((half_t*)S_shared) + (((((((((((int)threadIdx.x) & 127) >> 5) * 1024) + ((i_5 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + (i_5 >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_5 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(S_shared_local_cast + 0);
  }
  if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
  ...
  for (int i_6 = 0; i_6 < 2; ++i_6) {
    scores_max_clear_1[i_6] = -CUDART_INF_F;
    #pragma unroll
    for (int rv_1 = 0; rv_1 < 8; ++rv_1) {
      scores_max_clear_1[i_6] = max(scores_max_clear_1[i_6], acc_s_v1[((((rv_1 & 3) * 4) + (i_6 * 2)) + (rv_1 >> 2))]);
    }
    __syncthreads();
    scores_max_clear_1[i_6] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_6], (&(((float*)workspace_8)[0])));
    scores_max_clear_1[i_6] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_6]);
    scores_max[i_6] = max(scores_max[i_6], scores_max_clear_1[i_6]);
  }
  #pragma unroll
  ...
  for (int i_8 = 0; i_8 < 2; ++i_8) {
    scores_scale_v1[i_8] = exp2f(((scores_max_prev[i_8] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[i_8] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
  }
  #pragma unroll
  ...
  for (int i_10 = 0; i_10 < 8; ++i_10) {
    ...
    uint1 __2;
    float2 v__1 = *(float2*)(acc_s_v1 + (i_10 * 2));
    ((half2*)(&__2))[0] = __float22half2_rn(((float2*)(&v__1))[0]);
    *(uint1*)(S_shared_local_cast_1 + 0) = __2;
    *(uint1*)(((half_t*)S_shared) + ((((((((((((int)threadIdx.x) & 127) >> 5) * 1024) + ((i_10 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + (i_10 >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_10 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 4096)) = *(uint1*)(S_shared_local_cast_1 + 0);
  }
  #pragma unroll
  ...
  for (int k = 0; k < 42; ++k) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
    ...
    for (int i_12 = 0; i_12 < 2; ++i_12) {
      scores_max_clear_2[i_12] = -CUDART_INF_F;
      #pragma unroll
      for (int rv_2 = 0; rv_2 < 8; ++rv_2) {
        scores_max_clear_2[i_12] = max(scores_max_clear_2[i_12], acc_s_v2[((((rv_2 & 3) * 4) + (i_12 * 2)) + (rv_2 >> 2))]);
      }
      __syncthreads();
      scores_max_clear_2[i_12] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_12], (&(((float*)workspace_9)[0])));
      scores_max_clear_2[i_12] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_12]);
      scores_max[i_12] = max(scores_max[i_12], scores_max_clear_2[i_12]);
    }
    #pragma unroll
    ...
    for (int i_14 = 0; i_14 < 2; ++i_14) {
      scores_scale_v2[i_14] = exp2f(((scores_max_prev[i_14] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[i_14] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
    }
    #pragma unroll
    ...
    for (int i_16 = 0; i_16 < 2; ++i_16) {
      ...
      for (int rv_3 = 0; rv_3 < 8; ++rv_3) {
        scores_sum[i_16] = (scores_sum[i_16] + acc_s_v0[((((rv_3 & 3) * 4) + (i_16 * 2)) + (rv_3 >> 2))]);
      }
      __syncthreads();
      scores_sum[i_16] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_16], (&(((float*)workspace_3)[0])));
    ...
    for (int i_17 = 0; i_17 < 8; ++i_17) {
      ...
      uint1 __3;
      float2 v__2 = *(float2*)(acc_s_v2 + (i_17 * 2));
      ((half2*)(&__3))[0] = __float22half2_rn(((float2*)(&v__2))[0]);
      *(uint1*)(S_shared_local_cast_2 + 0) = __3;
      *(uint1*)(((half_t*)S_shared) + (((((((((k & 1) * 4096) + (((((int)threadIdx.x) & 127) >> 5) * 1024)) + ((i_17 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + (i_17 >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_17 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(S_shared_local_cast_2 + 0);
    }
    #pragma unroll
    for (int i_18 = 0; i_18 < 2; ++i_18) {
      logsum[i_18] = ((logsum[i_18] * scores_scale_v0[i_18]) + scores_sum[i_18]);
    }
    #pragma unroll
    for (int i_19 = 0; i_19 < 128; ++i_19) {
      acc_o[i_19] = (acc_o[i_19] * scores_scale_v1[((i_19 & 3) >> 1)]);
    }
    overlap_plan_mbar[((((k * 3) + 1) & 1) + 2)].wait(((((k * 3) + 1) & 3) >> 1));
    {
      ...
      tl::increase_descriptor_offset<int>(desc_a_7, ((((k * 3) + 1) & 1) * 8192));
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
    ...
    for (int i_20 = 0; i_20 < 2; ++i_20) {
      scores_max_clear_3[i_20] = -CUDART_INF_F;
      #pragma unroll
      for (int rv_4 = 0; rv_4 < 8; ++rv_4) {
        scores_max_clear_3[i_20] = max(scores_max_clear_3[i_20], acc_s_v0[((((rv_4 & 3) * 4) + (i_20 * 2)) + (rv_4 >> 2))]);
      }
      __syncthreads();
      scores_max_clear_3[i_20] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_3[i_20], (&(((float*)workspace_2)[0])));
      scores_max_clear_3[i_20] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_max_clear_3[i_20]);
      scores_max[i_20] = max(scores_max[i_20], scores_max_clear_3[i_20]);
    }
    #pragma unroll
    ...
    for (int i_22 = 0; i_22 < 2; ++i_22) {
      scores_scale_v0[i_22] = exp2f(((scores_max_prev[i_22] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[i_22] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
    }
    #pragma unroll
    ...
    for (int i_24 = 0; i_24 < 2; ++i_24) {
      ...
      for (int rv_5 = 0; rv_5 < 8; ++rv_5) {
        scores_sum[i_24] = (scores_sum[i_24] + acc_s_v1[((((rv_5 & 3) * 4) + (i_24 * 2)) + (rv_5 >> 2))]);
      }
      __syncthreads();
      scores_sum[i_24] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_24], (&(((float*)workspace_1)[0])));
    ...
    for (int i_25 = 0; i_25 < 8; ++i_25) {
      ...
      uint1 __4;
      float2 v__3 = *(float2*)(acc_s_v0 + (i_25 * 2));
      ((half2*)(&__4))[0] = __float22half2_rn(((float2*)(&v__3))[0]);
      *(uint1*)(S_shared_local_cast_3 + 0) = __4;
      *(uint1*)(((half_t*)S_shared) + (((((((((((k * 3) + 1) & 1) * 4096) + (((((int)threadIdx.x) & 127) >> 5) * 1024)) + ((i_25 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + (i_25 >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_25 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(S_shared_local_cast_3 + 0);
    }
    #pragma unroll
    for (int i_26 = 0; i_26 < 2; ++i_26) {
      logsum[i_26] = ((logsum[i_26] * scores_scale_v1[i_26]) + scores_sum[i_26]);
    }
    #pragma unroll
    for (int i_27 = 0; i_27 < 128; ++i_27) {
      acc_o[i_27] = (acc_o[i_27] * scores_scale_v2[((i_27 & 3) >> 1)]);
    }
    overlap_plan_mbar[((k & 1) + 2)].wait(((((k * 3) >> 1) + 1) & 1));
    {
      ...
      tl::increase_descriptor_offset<int>(desc_a_10, ((k & 1) * 8192));
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_7, broadcast_var_7);
    ...
    for (int i_28 = 0; i_28 < 2; ++i_28) {
      scores_max_clear_4[i_28] = -CUDART_INF_F;
      #pragma unroll
      for (int rv_6 = 0; rv_6 < 8; ++rv_6) {
        scores_max_clear_4[i_28] = max(scores_max_clear_4[i_28], acc_s_v1[((((rv_6 & 3) * 4) + (i_28 * 2)) + (rv_6 >> 2))]);
      }
      __syncthreads();
      scores_max_clear_4[i_28] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_4[i_28], (&(((float*)workspace)[0])));
      scores_max_clear_4[i_28] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_max_clear_4[i_28]);
      scores_max[i_28] = max(scores_max[i_28], scores_max_clear_4[i_28]);
    }
    #pragma unroll
    ...
    for (int i_32 = 0; i_32 < 2; ++i_32) {
      ...
      for (int rv_7 = 0; rv_7 < 8; ++rv_7) {
        scores_sum[i_32] = (scores_sum[i_32] + acc_s_v2[((((rv_7 & 3) * 4) + (i_32 * 2)) + (rv_7 >> 2))]);
      }
      __syncthreads();
      scores_sum[i_32] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_32], (&(((float*)workspace_4)[0])));
    ...
    for (int i_33 = 0; i_33 < 8; ++i_33) {
      ...
      uint1 __5;
      float2 v__4 = *(float2*)(acc_s_v1 + (i_33 * 2));
      ((half2*)(&__5))[0] = __float22half2_rn(((float2*)(&v__4))[0]);
      *(uint1*)(S_shared_local_cast_4 + 0) = __5;
      *(uint1*)(((half_t*)S_shared) + (((((((((k & 1) * 4096) + (((((int)threadIdx.x) & 127) >> 5) * 1024)) + ((i_33 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + (i_33 >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_33 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(S_shared_local_cast_4 + 0);
    }
    #pragma unroll
    for (int i_34 = 0; i_34 < 2; ++i_34) {
      logsum[i_34] = ((logsum[i_34] * scores_scale_v2[i_34]) + scores_sum[i_34]);
    }
    #pragma unroll
    ...
    overlap_plan_mbar[((((k * 3) + 1) & 1) + 2)].wait(((((k * 3) + 3) & 3) >> 1));
    {
      ...
      tl::increase_descriptor_offset<int>(desc_a_13, ((((k * 3) + 1) & 1) * 8192));
  ...
  for (int i_36 = 0; i_36 < 2; ++i_36) {
    ...
    for (int rv_8 = 0; rv_8 < 8; ++rv_8) {
      scores_sum[i_36] = (scores_sum[i_36] + acc_s_v0[((((rv_8 & 3) * 4) + (i_36 * 2)) + (rv_8 >> 2))]);
    }
    __syncthreads();
    scores_sum[i_36] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_36], (&(((float*)workspace_7)[0])));
  ...
  overlap_plan_mbar[3].wait(1);
  {
    ...
    tl::increase_descriptor_offset<int>(desc_a_14, 8192);
  ...
  for (int i_39 = 0; i_39 < 2; ++i_39) {
    ...
    __syncthreads();
    scores_sum[i_39] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_39], (&(((float*)workspace_5)[0])));
