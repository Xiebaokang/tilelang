  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int i_5 = 0; i_5 < 2; ++i_5) {
      ...
      tl::__sync_thread_partial(3, 256);
      scores_sum[i_5] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_5], (&(((float*)workspace_4)[0])));
    ...
    for (int k = 0; k < 63; ++k) {
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
      ...
      for (int i_8 = 0; i_8 < 2; ++i_8) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_1[i_8] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_8], (&(((float*)workspace_5)[0])));
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
      ...
      for (int i_16 = 0; i_16 < 2; ++i_16) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_2[i_16] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_16], (&(((float*)workspace_7)[0])));
      ...
      for (int i_20 = 0; i_20 < 2; ++i_20) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_20] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_20], (&(((float*)workspace)[0])));
        scores_sum[i_20] = tl::AllReduce<tl::SumOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_sum[i_20]);
      }
      #pragma unroll
      for (int i_21 = 0; i_21 < 2; ++i_21) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)S_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + i_21) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_s_v1[(i_21 * 8)]), ((half_t)acc_s_v1[((i_21 * 8) + 1)])), __pack_half2(((half_t)acc_s_v1[((i_21 * 8) + 2)]), ((half_t)acc_s_v1[((i_21 * 8) + 3)])), __pack_half2(((half_t)acc_s_v1[((i_21 * 8) + 4)]), ((half_t)acc_s_v1[((i_21 * 8) + 5)])), __pack_half2(((half_t)acc_s_v1[((i_21 * 8) + 6)]), ((half_t)acc_s_v1[((i_21 * 8) + 7)])));
      }
      #pragma unroll
    ...
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[5].arrive_and_expect_tx(8192);
      tl::tma_load(K_pe_desc, overlap_plan_mbar[5], (&(((half_t*)K_pe_shared)[4096])), 0, 8128, 0, 0);
    }
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
    ...
    for (int i_24 = 0; i_24 < 2; ++i_24) {
      ...
      tl::__sync_thread_partial(3, 256);
      scores_max_clear_3[i_24] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_3[i_24], (&(((float*)workspace_2)[0])));
    ...
    for (int i_28 = 0; i_28 < 2; ++i_28) {
      ...
      tl::__sync_thread_partial(3, 256);
      scores_sum[i_28] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_28], (&(((float*)workspace_3)[0])));
      scores_sum[i_28] = tl::AllReduce<tl::SumOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_sum[i_28]);
    }
    #pragma unroll
    for (int i_29 = 0; i_29 < 2; ++i_29) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)S_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + i_29) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_s_v0[(i_29 * 8)]), ((half_t)acc_s_v0[((i_29 * 8) + 1)])), __pack_half2(((half_t)acc_s_v0[((i_29 * 8) + 2)]), ((half_t)acc_s_v0[((i_29 * 8) + 3)])), __pack_half2(((half_t)acc_s_v0[((i_29 * 8) + 4)]), ((half_t)acc_s_v0[((i_29 * 8) + 5)])), __pack_half2(((half_t)acc_s_v0[((i_29 * 8) + 6)]), ((half_t)acc_s_v0[((i_29 * 8) + 7)])));
    }
    #pragma unroll
