    ...
    for (int k_1 = 0; k_1 < 128; ++k_1) {
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
      ...
      for (int i_7 = 0; i_7 < 2; ++i_7) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)S_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) + 1) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + i_7) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_s[(i_7 * 8)]), ((half_t)acc_s[((i_7 * 8) + 1)])), __pack_half2(((half_t)acc_s[((i_7 * 8) + 2)]), ((half_t)acc_s[((i_7 * 8) + 3)])), __pack_half2(((half_t)acc_s[((i_7 * 8) + 4)]), ((half_t)acc_s[((i_7 * 8) + 5)])), __pack_half2(((half_t)acc_s[((i_7 * 8) + 6)]), ((half_t)acc_s[((i_7 * 8) + 7)])));
      }
      #pragma unroll
