  ...
  for (int k = 0; k < 42; ++k) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
    ...
    for (int i_21 = 0; i_21 < 2; ++i_21) {
      ...
      __syncthreads();
      scores_max_clear_3[i_21] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_3[i_21], (&(((float*)workspace_8)[0])));
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_7, broadcast_var_7);
    ...
    for (int i_29 = 0; i_29 < 2; ++i_29) {
      ...
      __syncthreads();
      scores_max_clear_4[i_29] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_4[i_29], (&(((float*)workspace_4)[0])));
