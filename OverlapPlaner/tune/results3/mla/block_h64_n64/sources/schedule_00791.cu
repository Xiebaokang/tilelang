  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max_prev_v1 + 0) = *(float2*)(scores_max + 0);
    ...
    for (int i_6 = 0; i_6 < 2; ++i_6) {
      ...
      tl::__sync_thread_partial(3, 256);
      scores_sum[i_6] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_6], (&(((float*)workspace_4)[0])));
    ...
    for (int k = 0; k < 63; ++k) {
      ...
      *(float2*)(scores_max_prev_v0 + 0) = *(float2*)(scores_max + 0);
      ...
      for (int i_14 = 0; i_14 < 2; ++i_14) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_14] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_14], (&(((float*)workspace_5)[0])));
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
      ...
      for (int i_17 = 0; i_17 < 2; ++i_17) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_2[i_17] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_17], (&(((float*)workspace_6)[0])));
      ...
      *(float2*)(scores_max_prev_v1 + 0) = *(float2*)(scores_max + 0);
      ...
      for (int i_22 = 0; i_22 < 2; ++i_22) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_22] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_22], (&(((float*)workspace_7)[0])));
