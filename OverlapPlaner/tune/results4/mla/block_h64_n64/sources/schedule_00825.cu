  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int i_6 = 0; i_6 < 2; ++i_6) {
      ...
      tl::__sync_thread_partial(3, 256);
      scores_sum[i_6] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_6], (&(((float*)workspace)[0])));
    ...
    for (int k = 0; k < 127; ++k) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[(((k + 1) & 1) + 4)].arrive_and_expect_tx(8192);
        tl::fence_proxy_async();
        tl::tma_load(K_pe_desc, overlap_plan_mbar[(((k + 1) & 1) + 4)], (&(((half_t*)K_pe_shared)[(((k + 1) & 1) * 4096)])), 0, ((k * 64) + 64), 0, 0);
      }
      ...
      overlap_plan_mbar[(((k + 1) & 1) + 4)].wait((((k + 1) & 3) >> 1));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_3, (((k + 1) & 1) * 8192));
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 16);
        tl::warpgroup_arrive();
        #pragma unroll
      ...
      overlap_plan_mbar[(((k + 1) & 1) + 9)].arrive();
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
      ...
      for (int i_9 = 0; i_9 < 2; ++i_9) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_1[i_9] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_9], (&(((float*)workspace_1)[0])));
      ...
      for (int i_14 = 0; i_14 < 2; ++i_14) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_14] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_14], (&(((float*)workspace_2)[0])));
