    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    for (int k = 0; k < 128; ++k) {
      ...
      overlap_plan_mbar[((k & 1) + 2)].wait(((k & 3) >> 1));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b, ((k & 1) * 65536));
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
      ...
      }
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_2, ((k & 1) * 65536));
      ...
      for (int i_7 = 0; i_7 < 2; ++i_7) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_7] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_7], (&(((float*)workspace)[0])));
