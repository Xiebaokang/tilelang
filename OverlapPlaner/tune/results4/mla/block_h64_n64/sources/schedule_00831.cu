  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int i_5 = 0; i_5 < 2; ++i_5) {
      ...
      tl::__sync_thread_partial(3, 256);
      scores_sum[i_5] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_5], (&(((float*)workspace_5)[0])));
    ...
    for (int k = 0; k < 63; ++k) {
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
      ...
      for (int i_8 = 0; i_8 < 2; ++i_8) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_1[i_8] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_8], (&(((float*)workspace_6)[0])));
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
      ...
      for (int i_16 = 0; i_16 < 2; ++i_16) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_2[i_16] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_16], (&(((float*)workspace_4)[0])));
      ...
      for (int i_20 = 0; i_20 < 2; ++i_20) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_20] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_20], (&(((float*)workspace_2)[0])));
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
    ...
    for (int i_24 = 0; i_24 < 2; ++i_24) {
      ...
      tl::__sync_thread_partial(3, 256);
      scores_max_clear_3[i_24] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_3[i_24], (&(((float*)workspace)[0])));
    ...
    for (int i_28 = 0; i_28 < 2; ++i_28) {
      ...
      tl::__sync_thread_partial(3, 256);
      scores_sum[i_28] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_28], (&(((float*)workspace_1)[0])));
