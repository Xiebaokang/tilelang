  ...
  if (((int)threadIdx.x) < 128) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int i_6 = 0; i_6 < 2; ++i_6) {
      ...
      tl::__sync_thread_partial(3, 256);
      scores_sum[i_6] = tl::AllReduce<tl::SumOp, 256, 128, 128, tl::NamedBarrier<256>>::run(scores_sum[i_6], (&(((float*)workspace_1)[0])));
    ...
    for (int k_1 = 0; k_1 < 127; ++k_1) {
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
      ...
      for (int i_9 = 0; i_9 < 2; ++i_9) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_1[i_9] = tl::AllReduce<tl::MaxOp, 256, 128, 128, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_9], (&(((float*)workspace_2)[0])));
      ...
      for (int i_14 = 0; i_14 < 2; ++i_14) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_14] = tl::AllReduce<tl::SumOp, 256, 128, 128, tl::NamedBarrier<256>>::run(scores_sum[i_14], (&(((float*)workspace_3)[0])));
