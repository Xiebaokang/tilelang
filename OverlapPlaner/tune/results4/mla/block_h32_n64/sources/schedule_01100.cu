    ...
    *(float4*)(logsum + 0) = make_float4(broadcast_var_1, broadcast_var_1, broadcast_var_1, broadcast_var_1);
    for (int k = 0; k < 64; ++k) {
      ...
      for (int i_8 = 0; i_8 < 4; ++i_8) {
        *(float2*)(acc_s_v0 + (i_8 * 2)) = *(float2*)(((float*)acc_s_wsp_handoff_7) + ((((i_8 * 512) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((int)threadIdx.x) >> 5) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      }
      #pragma unroll
      for (int i_9 = 0; i_9 < 4; ++i_9) {
        ...
        for (int rv = 0; rv < 2; ++rv) {
          scores_sum[i_9] = (scores_sum[i_9] + acc_s_v0[((i_9 * 2) + rv)]);
        }
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_9] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_9], (&(((float*)workspace)[0])));
        scores_sum[i_9] = tl::AllReduce<tl::SumOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_sum[i_9]);
      }
      overlap_plan_mbar[7].wait(0);
      #pragma unroll
      for (int i_10 = 0; i_10 < 4; ++i_10) {
        scores_scale[i_10] = ((float*)scores_scale_wsp_handoff_5)[((i_10 * 8) + ((((int)threadIdx.x) & 31) >> 2))];
      }
      #pragma unroll
      ...
      overlap_plan_mbar[11].wait((k & 1));
      {
        ...
        for (int ki_2 = 0; ki_2 < 4; ++ki_2) {
          ...
          for (int i_14 = 0; i_14 < 4; ++i_14) {
            tl::ptx_ldmatrix_x4_trans((&(((half_t*)KV_shared)[(((((((int)threadIdx.x) >> 5) * 4096) + (ki_2 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_14 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_14 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_2[(i_14 * 8)])));
          }
      ...
      for (int i_23 = 0; i_23 < 4; ++i_23) {
        *(float2*)(acc_s_v1 + (i_23 * 2)) = *(float2*)(((float*)acc_s_wsp_handoff_7) + ((((i_23 * 512) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((int)threadIdx.x) >> 5) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      }
      #pragma unroll
      for (int i_24 = 0; i_24 < 4; ++i_24) {
        ...
        for (int rv_1 = 0; rv_1 < 2; ++rv_1) {
          scores_sum[i_24] = (scores_sum[i_24] + acc_s_v1[((i_24 * 2) + rv_1)]);
        }
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_24] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_24], (&(((float*)workspace_1)[0])));
      ...
      for (int i_25 = 0; i_25 < 4; ++i_25) {
        scores_scale[i_25] = ((float*)scores_scale_wsp_handoff_5)[((i_25 * 8) + ((((int)threadIdx.x) & 31) >> 2))];
      }
      #pragma unroll
      ...
      overlap_plan_mbar[12].wait((k & 1));
      {
        ...
        for (int ki_5 = 0; ki_5 < 4; ++ki_5) {
          for (int i_28 = 0; i_28 < 2; ++i_28) {
            tl::ptx_ldmatrix_x4((&(((half_t*)S_shared)[((((i_28 * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (ki_5 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_5 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 2048)])), (&(A_local_5[(i_28 * 8)])));
          }
