  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int k = 0; k < 63; ++k) {
      ...
      *(float4*)(scores_max + 0) = make_float4(broadcast_var_6, broadcast_var_6, broadcast_var_6, broadcast_var_6);
      ...
      for (int i_21 = 0; i_21 < 4; ++i_21) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_1[i_21] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_21], (&(((float*)workspace_6)[0])));
      ...
      for (int i_25 = 0; i_25 < 4; ++i_25) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_25] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_25], (&(((float*)workspace_7)[0])));
      ...
      *(float4*)(scores_max + 0) = make_float4(broadcast_var_8, broadcast_var_8, broadcast_var_8, broadcast_var_8);
      ...
      for (int i_36 = 0; i_36 < 4; ++i_36) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_2[i_36] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_36], (&(((float*)workspace)[0])));
      ...
      for (int i_40 = 0; i_40 < 4; ++i_40) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_40] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_40], (&(((float*)workspace_3)[0])));
    ...
    *(float4*)(scores_max + 0) = make_float4(broadcast_var_10, broadcast_var_10, broadcast_var_10, broadcast_var_10);
    ...
    for (int i_51 = 0; i_51 < 4; ++i_51) {
      ...
      tl::__sync_thread_partial(3, 256);
      scores_max_clear_3[i_51] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_3[i_51], (&(((float*)workspace_4)[0])));
    ...
    for (int i_55 = 0; i_55 < 4; ++i_55) {
      ...
      tl::__sync_thread_partial(3, 256);
      scores_sum[i_55] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_55], (&(((float*)workspace_5)[0])));
