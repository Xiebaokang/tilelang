...
extern "C" __global__ void __launch_bounds__(512, 1) main_kernel(__grid_constant__ const CUtensorMap KV_desc, __grid_constant__ const CUtensorMap K_pe_desc, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap Q_pe_desc) {
  ...
  void* scores_scale_wsp_handoff_5 = ((void*)((char*)buf_dyn_shmem + 192512));
  void* workspace = ((void*)((char*)buf_dyn_shmem + 192640));
  void* workspace_1 = ((void*)((char*)buf_dyn_shmem + 193664));
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float4*)(scores_max + 0) = make_float4(broadcast_var, broadcast_var, broadcast_var, broadcast_var);
    for (int k = 0; k < 128; ++k) {
      if (2 <= k) {
        overlap_plan_mbar[((k & 1) + 10)].wait((((k >> 1) + 1) & 1));
        overlap_plan_mbar[((k & 1) + 12)].wait((((k >> 1) + 1) & 1));
      }
      ...
      *(float4*)(scores_max + 0) = make_float4(broadcast_var_2, broadcast_var_2, broadcast_var_2, broadcast_var_2);
      ...
      for (int i_11 = 0; i_11 < 4; ++i_11) {
        ...
        *(uint1*)(((half_t*)S_shared) + ((((((((k & 1) * 2048) + (i_11 * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(S_shared_local_cast + 0);
      }
      tl::fence_proxy_async();
    ...
    *(float4*)(logsum + 0) = make_float4(broadcast_var_4, broadcast_var_4, broadcast_var_4, broadcast_var_4);
    for (int k_1 = 0; k_1 < 128; ++k_1) {
      ...
      for (int i_13 = 0; i_13 < 4; ++i_13) {
        *(float2*)(acc_s + (i_13 * 2)) = *(float2*)(((float*)acc_s_wsp_handoff_6) + (((((i_13 * 512) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((int)threadIdx.x) >> 5) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 64));
      }
      #pragma unroll
      for (int i_14 = 0; i_14 < 4; ++i_14) {
        ...
        scores_sum[i_14] = tl::AllReduce<tl::SumOp, 256, 32, 256, tl::NamedBarrier<256>>::run(scores_sum[i_14], (&(((float*)workspace_1)[0])));
        scores_sum[i_14] = tl::AllReduce<tl::SumOp, 4, 1, 256, tl::NamedBarrier<256>>::run(scores_sum[i_14]);
      }
      overlap_plan_mbar[5].wait((k_1 & 1));
      #pragma unroll
      for (int i_15 = 0; i_15 < 4; ++i_15) {
        scores_scale[i_15] = ((float*)scores_scale_wsp_handoff_5)[((i_15 * 8) + ((((int)threadIdx.x) & 31) >> 2))];
      }
      #pragma unroll
      ...
      for (int i_17 = 0; i_17 < 64; ++i_17) {
        acc_o[i_17] = (acc_o[i_17] * scores_scale[(((i_17 >> 5) * 2) + ((i_17 & 3) >> 1))]);
      }
      overlap_plan_mbar[((k_1 & 1) + 2)].wait(((k_1 & 3) >> 1));
      overlap_plan_mbar[((k_1 & 1) + 7)].wait(((k_1 & 3) >> 1));
      {
        half_t A_local_2[16];
        half_t B_local_2[32];
        tl::__sync_thread_partial(4, 256);
        for (int ki_2 = 0; ki_2 < 4; ++ki_2) {
          for (int i_18 = 0; i_18 < 2; ++i_18) {
            tl::ptx_ldmatrix_x4((&(((half_t*)S_shared)[(((((k_1 & 1) * 2048) + (i_18 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (ki_2 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_2 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(A_local_2[(i_18 * 8)])));
          }
          for (int i_19 = 0; i_19 < 4; ++i_19) {
            tl::ptx_ldmatrix_x4_trans((&(((half_t*)KV_shared)[((((((k_1 & 1) * 32768) + (((((int)threadIdx.x) & 255) >> 5) * 4096)) + (ki_2 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_19 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_19 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_2[(i_19 * 8)])));
          }
          for (int i_20 = 0; i_20 < 2; ++i_20) {
            for (int j = 0; j < 4; ++j) {
              tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_o + ((i_20 * 32) + (j * 8))), reinterpret_cast<const unsigned*>(A_local_2 + (i_20 * 8)), reinterpret_cast<const unsigned*>(B_local_2 + (j * 8)));
              tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_o + (((i_20 * 32) + (j * 8)) + 4)), reinterpret_cast<const unsigned*>(A_local_2 + (i_20 * 8)), reinterpret_cast<const unsigned*>(B_local_2 + ((j * 8) + 4)));
            }
          }
        }
      }
      overlap_plan_mbar[((k_1 & 1) + 12)].arrive();
