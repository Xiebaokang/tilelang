  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float4*)(scores_max + 0) = make_float4(broadcast_var_4, broadcast_var_4, broadcast_var_4, broadcast_var_4);
    ...
    for (int i_13 = 0; i_13 < 64; ++i_13) {
      acc_o[i_13] = (acc_o[i_13] * scores_scale[(((i_13 >> 5) * 2) + ((i_13 & 3) >> 1))]);
    }
    tl::__sync_thread_partial(3, 256);
    for (int k = 0; k < 127; ++k) {
      overlap_plan_mbar[(((k + 1) & 1) + 2)].wait((((k + 1) & 3) >> 1));
      {
        ...
        for (int i_14 = 0; i_14 < 2; ++i_14) {
          ...
          *(float4*)(acc_s + (i_14 * 4)) = make_float4(broadcast_var_5, broadcast_var_5, broadcast_var_5, broadcast_var_5);
        }
        for (int ki_2 = 0; ki_2 < 32; ++ki_2) {
          for (int i_15 = 0; i_15 < 2; ++i_15) {
            tl::ptx_ldmatrix_x4((&(((half_t*)Q_shared)[(((((ki_2 >> 2) * 2048) + (i_15 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki_2 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_2 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(A_local_2[(i_15 * 8)])));
          }
          ...
          for (int i_16 = 0; i_16 < 2; ++i_16) {
            tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_s + (i_16 * 4)), reinterpret_cast<const unsigned*>(A_local_2 + (i_16 * 8)), reinterpret_cast<const unsigned*>(B_local_2 + 0));
          }
        }
      }
      overlap_plan_mbar[(((k + 1) % 3) + 4)].wait((((k + 1) % 6) / 3));
      {
        ...
        for (int ki_3 = 0; ki_3 < 4; ++ki_3) {
          for (int i_17 = 0; i_17 < 2; ++i_17) {
            tl::ptx_ldmatrix_x4((&(((half_t*)Q_pe_shared)[(((i_17 * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (ki_3 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_3 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(A_local_3[(i_17 * 8)])));
          }
          ...
          for (int i_18 = 0; i_18 < 2; ++i_18) {
            tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_s + (i_18 * 4)), reinterpret_cast<const unsigned*>(A_local_3 + (i_18 * 8)), reinterpret_cast<const unsigned*>(B_local_3 + 0));
          }
        }
      }
      ...
      *(float4*)(scores_max + 0) = make_float4(broadcast_var_6, broadcast_var_6, broadcast_var_6, broadcast_var_6);
      ...
      for (int i_19 = 0; i_19 < 4; ++i_19) {
        ...
        for (int rv_2 = 0; rv_2 < 2; ++rv_2) {
          scores_max_clear_1[i_19] = max(scores_max_clear_1[i_19], acc_s[((i_19 * 2) + rv_2)]);
        }
        tl::__sync_thread_partial(3, 256);
      ...
      for (int i_22 = 0; i_22 < 8; ++i_22) {
        acc_s[i_22] = exp2f(((acc_s[i_22] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[(i_22 >> 1)] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
      }
      #pragma unroll
      for (int i_23 = 0; i_23 < 4; ++i_23) {
        ...
        for (int rv_3 = 0; rv_3 < 2; ++rv_3) {
          scores_sum[i_23] = (scores_sum[i_23] + acc_s[((i_23 * 2) + rv_3)]);
        }
        tl::__sync_thread_partial(3, 256);
      ...
      for (int i_24 = 0; i_24 < 4; ++i_24) {
        ...
        *(uint1*)(((half_t*)S_shared) + (((((((((k + 1) & 1) * 2048) + (i_24 * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(S_shared_local_cast_1 + 0);
      }
      #pragma unroll
      ...
      overlap_plan_mbar[((k & 1) + 2)].wait(((k & 3) >> 1));
      {
        ...
        for (int ki_4 = 0; ki_4 < 4; ++ki_4) {
          for (int i_26 = 0; i_26 < 2; ++i_26) {
            tl::ptx_ldmatrix_x4((&(((half_t*)S_shared)[(((((k & 1) * 2048) + (i_26 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (ki_4 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_4 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(A_local_4[(i_26 * 8)])));
          }
          for (int i_27 = 0; i_27 < 4; ++i_27) {
            tl::ptx_ldmatrix_x4_trans((&(((half_t*)KV_shared)[((((((k & 1) * 32768) + ((((int)threadIdx.x) >> 5) * 4096)) + (ki_4 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_27 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_27 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_4[(i_27 * 8)])));
          }
      ...
      for (int i_29 = 0; i_29 < 64; ++i_29) {
        acc_o[i_29] = (acc_o[i_29] * scores_scale[(((i_29 >> 5) * 2) + ((i_29 & 3) >> 1))]);
      }
    }
    overlap_plan_mbar[3].wait(1);
    {
      ...
      for (int ki_5 = 0; ki_5 < 4; ++ki_5) {
        for (int i_30 = 0; i_30 < 2; ++i_30) {
          tl::ptx_ldmatrix_x4((&(((half_t*)S_shared)[((((i_30 * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (ki_5 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_5 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 2048)])), (&(A_local_5[(i_30 * 8)])));
        }
        for (int i_31 = 0; i_31 < 4; ++i_31) {
          tl::ptx_ldmatrix_x4_trans((&(((half_t*)KV_shared)[((((((((int)threadIdx.x) >> 5) * 4096) + (ki_5 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_31 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_31 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 32768)])), (&(B_local_5[(i_31 * 8)])));
        }
        for (int i_32 = 0; i_32 < 2; ++i_32) {
          for (int j_1 = 0; j_1 < 4; ++j_1) {
            tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_o + ((i_32 * 32) + (j_1 * 8))), reinterpret_cast<const unsigned*>(A_local_5 + (i_32 * 8)), reinterpret_cast<const unsigned*>(B_local_5 + (j_1 * 8)));
            tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_o + (((i_32 * 32) + (j_1 * 8)) + 4)), reinterpret_cast<const unsigned*>(A_local_5 + (i_32 * 8)), reinterpret_cast<const unsigned*>(B_local_5 + ((j_1 * 8) + 4)));
          }
        }
      }
    }
    ...
    for (int i_33 = 0; i_33 < 64; ++i_33) {
      acc_o[i_33] = (acc_o[i_33] / logsum[(((i_33 >> 5) * 2) + ((i_33 & 3) >> 1))]);
    }
    #pragma unroll
    for (int i_34 = 0; i_34 < 8; ++i_34) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)O_shared)[((((((i_34 >> 2) * 8192) + ((((int)threadIdx.x) & 15) * 512)) + ((((int)threadIdx.x) >> 5) * 64)) + ((i_34 & 3) * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(((half_t)acc_o[(i_34 * 8)]), ((half_t)acc_o[((i_34 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_34 * 8) + 2)]), ((half_t)acc_o[((i_34 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_34 * 8) + 4)]), ((half_t)acc_o[((i_34 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_34 * 8) + 6)]), ((half_t)acc_o[((i_34 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 256);
