...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap KV_desc, __grid_constant__ const CUtensorMap K_pe_desc, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap Q_pe_desc) {
  ...
  void* S_shared = ((void*)((char*)buf_dyn_shmem + 174080));
  void* workspace = ((void*)((char*)buf_dyn_shmem + 178176));
  void* workspace_1 = ((void*)((char*)buf_dyn_shmem + 178176));
  void* workspace_2 = ((void*)((char*)buf_dyn_shmem + 178176));
  void* workspace_3 = ((void*)((char*)buf_dyn_shmem + 178176));
  void* workspace_4 = ((void*)((char*)buf_dyn_shmem + 178176));
  void* workspace_5 = ((void*)((char*)buf_dyn_shmem + 178176));
  void* workspace_6 = ((void*)((char*)buf_dyn_shmem + 178176));
  void* workspace_7 = ((void*)((char*)buf_dyn_shmem + 178176));
    ...
    for (int k = 0; k < 63; ++k) {
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
      ...
      for (int i_7 = 0; i_7 < 2; ++i_7) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_1[i_7] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_7], (&(((float*)workspace_4)[0])));
      ...
      for (int i_11 = 0; i_11 < 2; ++i_11) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_11] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_11], (&(((float*)workspace_7)[0])));
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_8, broadcast_var_8);
      ...
      for (int i_16 = 0; i_16 < 2; ++i_16) {
        ...
        for (int rv_4 = 0; rv_4 < 2; ++rv_4) {
          scores_max_clear_2[i_16] = max(scores_max_clear_2[i_16], acc_s_v0[((i_16 * 2) + rv_4)]);
        }
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_2[i_16] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_16], (&(((float*)workspace_3)[0])));
      ...
      for (int i_19 = 0; i_19 < 4; ++i_19) {
        acc_s_v0[i_19] = exp2f(((acc_s_v0[i_19] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[(i_19 >> 1)] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
      }
      #pragma unroll
      for (int i_20 = 0; i_20 < 2; ++i_20) {
        ...
        for (int rv_5 = 0; rv_5 < 2; ++rv_5) {
          scores_sum[i_20] = (scores_sum[i_20] + acc_s_v0[((i_20 * 2) + rv_5)]);
        }
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_20] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_20], (&(((float*)workspace_2)[0])));
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_10, broadcast_var_10);
    ...
    for (int i_25 = 0; i_25 < 2; ++i_25) {
      ...
      for (int rv_6 = 0; rv_6 < 2; ++rv_6) {
        scores_max_clear_3[i_25] = max(scores_max_clear_3[i_25], acc_s_v1[((i_25 * 2) + rv_6)]);
      }
      tl::__sync_thread_partial(3, 256);
      scores_max_clear_3[i_25] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_3[i_25], (&(((float*)workspace_1)[0])));
    ...
    for (int i_27 = 0; i_27 < 2; ++i_27) {
      scores_scale_v1[i_27] = exp2f(((scores_max_prev[i_27] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[i_27] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
    }
    #pragma unroll
    for (int i_28 = 0; i_28 < 4; ++i_28) {
      acc_s_v1[i_28] = exp2f(((acc_s_v1[i_28] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[(i_28 >> 1)] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
    }
    #pragma unroll
    for (int i_29 = 0; i_29 < 2; ++i_29) {
      ...
      for (int rv_7 = 0; rv_7 < 2; ++rv_7) {
        scores_sum[i_29] = (scores_sum[i_29] + acc_s_v1[((i_29 * 2) + rv_7)]);
      }
      tl::__sync_thread_partial(3, 256);
      scores_sum[i_29] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_29], (&(((float*)workspace_5)[0])));
