...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap KV_desc, __grid_constant__ const CUtensorMap K_pe_desc, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap Q_pe_desc) {
  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
  ...
  for (int i_3 = 0; i_3 < 4; ++i_3) {
    acc_s[i_3] = exp2f(((acc_s[i_3] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[(i_3 >> 1)] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
  }
  #pragma unroll
  for (int i_4 = 0; i_4 < 2; ++i_4) {
    half_t S_shared_local_cast[2];
    uint1 __1;
    float2 v_ = *(float2*)(acc_s + (i_4 * 2));
    ((half2*)(&__1))[0] = __float22half2_rn(((float2*)(&v_))[0]);
    *(uint1*)(S_shared_local_cast + 0) = __1;
    *(uint1*)(((half_t*)S_shared) + ((((((i_4 * 512) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(S_shared_local_cast + 0);
  }
  #pragma unroll
  ...
  for (int i_6 = 0; i_6 < 2; ++i_6) {
    ...
    __syncthreads();
    scores_sum[i_6] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_6], (&(((float*)workspace_2)[0])));
  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
  ...
  for (int i_8 = 0; i_8 < 2; ++i_8) {
    ...
    __syncthreads();
    scores_max_clear_1[i_8] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_8], (&(((float*)workspace_4)[0])));
  ...
  for (int i_10 = 0; i_10 < 4; ++i_10) {
    acc_s[i_10] = exp2f(((acc_s[i_10] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[(i_10 >> 1)] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
  }
  #pragma unroll
  for (int i_11 = 0; i_11 < 2; ++i_11) {
    half_t S_shared_local_cast_1[2];
    uint1 __2;
    float2 v__1 = *(float2*)(acc_s + (i_11 * 2));
    ((half2*)(&__2))[0] = __float22half2_rn(((float2*)(&v__1))[0]);
    *(uint1*)(S_shared_local_cast_1 + 0) = __2;
    *(uint1*)(((half_t*)S_shared) + (((((((i_11 * 512) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 1024)) = *(uint1*)(S_shared_local_cast_1 + 0);
  }
  #pragma unroll
  for (int i_12 = 0; i_12 < 2; ++i_12) {
    scores_scale_v1[i_12] = exp2f(((scores_max_prev[i_12] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[i_12] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
  }
  #pragma unroll
  for (int i_13 = 0; i_13 < 2; ++i_13) {
    ...
    for (int rv_3 = 0; rv_3 < 2; ++rv_3) {
      scores_sum[i_13] = (scores_sum[i_13] + acc_s[((i_13 * 2) + rv_3)]);
    }
    __syncthreads();
    scores_sum[i_13] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_13], (&(((float*)workspace_3)[0])));
  ...
  for (int k = 0; k < 63; ++k) {
    if (1 <= k) {
      overlap_plan_mbar[((((k * 2) + 2) % 3) + 6)].wait(((((k * 2) + 5) % 6) / 3));
    }
    __syncthreads();
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[((((k * 2) + 2) % 3) + 2)].arrive_and_expect_tx(65536);
      tl::fence_proxy_async();
      tl::tma_load(KV_desc, overlap_plan_mbar[((((k * 2) + 2) % 3) + 2)], (&(((half_t*)KV_shared)[((((k * 2) + 2) % 3) * 32768)])), 0, ((k * 128) + 128), 0, 0);
      tl::tma_load(KV_desc, overlap_plan_mbar[((((k * 2) + 2) % 3) + 2)], (&(((half_t*)KV_shared)[(((((k * 2) + 2) % 3) * 32768) + 4096)])), 64, ((k * 128) + 128), 0, 0);
      tl::tma_load(KV_desc, overlap_plan_mbar[((((k * 2) + 2) % 3) + 2)], (&(((half_t*)KV_shared)[(((((k * 2) + 2) % 3) * 32768) + 8192)])), 128, ((k * 128) + 128), 0, 0);
      tl::tma_load(KV_desc, overlap_plan_mbar[((((k * 2) + 2) % 3) + 2)], (&(((half_t*)KV_shared)[(((((k * 2) + 2) % 3) * 32768) + 12288)])), 192, ((k * 128) + 128), 0, 0);
      tl::tma_load(KV_desc, overlap_plan_mbar[((((k * 2) + 2) % 3) + 2)], (&(((half_t*)KV_shared)[(((((k * 2) + 2) % 3) * 32768) + 16384)])), 256, ((k * 128) + 128), 0, 0);
      tl::tma_load(KV_desc, overlap_plan_mbar[((((k * 2) + 2) % 3) + 2)], (&(((half_t*)KV_shared)[(((((k * 2) + 2) % 3) * 32768) + 20480)])), 320, ((k * 128) + 128), 0, 0);
      tl::tma_load(KV_desc, overlap_plan_mbar[((((k * 2) + 2) % 3) + 2)], (&(((half_t*)KV_shared)[(((((k * 2) + 2) % 3) * 32768) + 24576)])), 384, ((k * 128) + 128), 0, 0);
      tl::tma_load(KV_desc, overlap_plan_mbar[((((k * 2) + 2) % 3) + 2)], (&(((half_t*)KV_shared)[(((((k * 2) + 2) % 3) * 32768) + 28672)])), 448, ((k * 128) + 128), 0, 0);
    }
    overlap_plan_mbar[9].wait(1);
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[5].arrive_and_expect_tx(8192);
      tl::fence_proxy_async();
      tl::tma_load(K_pe_desc, overlap_plan_mbar[5], (&(((half_t*)K_pe_shared)[0])), 0, ((k * 128) + 128), 0, 0);
    }
    overlap_plan_mbar[((((k * 2) + 2) % 3) + 2)].wait(((((k * 2) + 2) % 6) / 3));
    {
      half_t A_local_4[8];
      half_t B_local_4[4];
      ...
      *(float4*)(acc_s + 0) = make_float4(broadcast_var_7, broadcast_var_7, broadcast_var_7, broadcast_var_7);
      for (int ki_4 = 0; ki_4 < 32; ++ki_4) {
        ...
        tl::ptx_ldmatrix_x2((&(((half_t*)KV_shared)[((((((((((((((int)threadIdx.x) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) >> 3) + (((k * 2) + 2) % 3)) % 3) * 32768) + ((ki_4 >> 2) * 4096)) + ((((((int)threadIdx.x) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 7) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki_4 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_4 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(B_local_4[0])));
        tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_s + 0), reinterpret_cast<const unsigned*>(A_local_4 + 0), reinterpret_cast<const unsigned*>(B_local_4 + 0));
      }
    }
    overlap_plan_mbar[5].wait(0);
    {
    ...
    overlap_plan_mbar[9].arrive();
    overlap_plan_mbar[(((k * 2) % 3) + 2)].wait((((k % 3) * 2) / 3));
    {
      half_t A_local_6[8];
      half_t B_local_6[32];
      for (int ki_6 = 0; ki_6 < 4; ++ki_6) {
        ...
        for (int i_16 = 0; i_16 < 4; ++i_16) {
          tl::ptx_ldmatrix_x4_trans((&(((half_t*)KV_shared)[(((((((k * 2) % 3) * 32768) + ((((int)threadIdx.x) >> 5) * 4096)) + (ki_6 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_16 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_16 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_6[(i_16 * 8)])));
        }
        for (int j = 0; j < 4; ++j) {
    ...
    overlap_plan_mbar[(((k * 2) % 3) + 6)].arrive();
    *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_8, broadcast_var_8);
    ...
    for (int i_17 = 0; i_17 < 2; ++i_17) {
      ...
      __syncthreads();
      scores_max_clear_2[i_17] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_17], (&(((float*)workspace_7)[0])));
    ...
    for (int i_19 = 0; i_19 < 4; ++i_19) {
      acc_s[i_19] = exp2f(((acc_s[i_19] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[(i_19 >> 1)] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
    }
    #pragma unroll
    for (int i_20 = 0; i_20 < 2; ++i_20) {
      half_t S_shared_local_cast_2[2];
      uint1 __3;
      float2 v__2 = *(float2*)(acc_s + (i_20 * 2));
      ((half2*)(&__3))[0] = __float22half2_rn(((float2*)(&v__2))[0]);
      *(uint1*)(S_shared_local_cast_2 + 0) = __3;
      *(uint1*)(((half_t*)S_shared) + ((((((i_20 * 512) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(S_shared_local_cast_2 + 0);
    }
    #pragma unroll
    for (int i_21 = 0; i_21 < 2; ++i_21) {
      scores_scale_v0[i_21] = exp2f(((scores_max_prev[i_21] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[i_21] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
    }
    #pragma unroll
    for (int i_22 = 0; i_22 < 2; ++i_22) {
      ...
      for (int rv_5 = 0; rv_5 < 2; ++rv_5) {
        scores_sum[i_22] = (scores_sum[i_22] + acc_s[((i_22 * 2) + rv_5)]);
      }
      __syncthreads();
    ...
    overlap_plan_mbar[(((k * 2) % 3) + 6)].wait((((k % 3) * 2) / 3));
    __syncthreads();
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[(((k * 2) % 3) + 2)].arrive_and_expect_tx(65536);
      tl::fence_proxy_async();
      tl::tma_load(KV_desc, overlap_plan_mbar[(((k * 2) % 3) + 2)], (&(((half_t*)KV_shared)[(((k * 2) % 3) * 32768)])), 0, ((k * 128) + 192), 0, 0);
      tl::tma_load(KV_desc, overlap_plan_mbar[(((k * 2) % 3) + 2)], (&(((half_t*)KV_shared)[((((k * 2) % 3) * 32768) + 4096)])), 64, ((k * 128) + 192), 0, 0);
      tl::tma_load(KV_desc, overlap_plan_mbar[(((k * 2) % 3) + 2)], (&(((half_t*)KV_shared)[((((k * 2) % 3) * 32768) + 8192)])), 128, ((k * 128) + 192), 0, 0);
      tl::tma_load(KV_desc, overlap_plan_mbar[(((k * 2) % 3) + 2)], (&(((half_t*)KV_shared)[((((k * 2) % 3) * 32768) + 12288)])), 192, ((k * 128) + 192), 0, 0);
      tl::tma_load(KV_desc, overlap_plan_mbar[(((k * 2) % 3) + 2)], (&(((half_t*)KV_shared)[((((k * 2) % 3) * 32768) + 16384)])), 256, ((k * 128) + 192), 0, 0);
      tl::tma_load(KV_desc, overlap_plan_mbar[(((k * 2) % 3) + 2)], (&(((half_t*)KV_shared)[((((k * 2) % 3) * 32768) + 20480)])), 320, ((k * 128) + 192), 0, 0);
      tl::tma_load(KV_desc, overlap_plan_mbar[(((k * 2) % 3) + 2)], (&(((half_t*)KV_shared)[((((k * 2) % 3) * 32768) + 24576)])), 384, ((k * 128) + 192), 0, 0);
      tl::tma_load(KV_desc, overlap_plan_mbar[(((k * 2) % 3) + 2)], (&(((half_t*)KV_shared)[((((k * 2) % 3) * 32768) + 28672)])), 448, ((k * 128) + 192), 0, 0);
    }
    overlap_plan_mbar[9].wait(0);
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[5].arrive_and_expect_tx(8192);
      tl::fence_proxy_async();
      tl::tma_load(K_pe_desc, overlap_plan_mbar[5], (&(((half_t*)K_pe_shared)[0])), 0, ((k * 128) + 192), 0, 0);
    }
    overlap_plan_mbar[(((k * 2) % 3) + 2)].wait(((((k * 2) / 3) + 1) & 1));
    {
      half_t A_local_7[8];
      half_t B_local_7[4];
      ...
      *(float4*)(acc_s + 0) = make_float4(broadcast_var_9, broadcast_var_9, broadcast_var_9, broadcast_var_9);
      for (int ki_7 = 0; ki_7 < 32; ++ki_7) {
        ...
        tl::ptx_ldmatrix_x2((&(((half_t*)KV_shared)[((((((((((((((int)threadIdx.x) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) >> 3) + ((k * 2) % 3)) % 3) * 32768) + ((ki_7 >> 2) * 4096)) + ((((((int)threadIdx.x) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 7) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki_7 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_7 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(B_local_7[0])));
        tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_s + 0), reinterpret_cast<const unsigned*>(A_local_7 + 0), reinterpret_cast<const unsigned*>(B_local_7 + 0));
      }
    }
    overlap_plan_mbar[5].wait(1);
    {
    ...
    overlap_plan_mbar[9].arrive();
    overlap_plan_mbar[((((k * 2) + 1) % 3) + 2)].wait(((((k % 3) * 2) + 1) / 3));
    {
      half_t A_local_9[8];
      half_t B_local_9[32];
      for (int ki_9 = 0; ki_9 < 4; ++ki_9) {
        ...
        for (int i_25 = 0; i_25 < 4; ++i_25) {
          tl::ptx_ldmatrix_x4_trans((&(((half_t*)KV_shared)[((((((((k * 2) + 1) % 3) * 32768) + ((((int)threadIdx.x) >> 5) * 4096)) + (ki_9 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_25 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_25 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_9[(i_25 * 8)])));
        }
    ...
    overlap_plan_mbar[((((k * 2) + 1) % 3) + 6)].arrive();
    *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_10, broadcast_var_10);
    ...
    for (int i_26 = 0; i_26 < 2; ++i_26) {
      ...
      __syncthreads();
      scores_max_clear_3[i_26] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_3[i_26], (&(((float*)workspace)[0])));
    ...
    for (int i_28 = 0; i_28 < 4; ++i_28) {
      acc_s[i_28] = exp2f(((acc_s[i_28] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[(i_28 >> 1)] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
    }
    #pragma unroll
    for (int i_29 = 0; i_29 < 2; ++i_29) {
      ...
      *(uint1*)(((half_t*)S_shared) + (((((((i_29 * 512) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 1024)) = *(uint1*)(S_shared_local_cast_3 + 0);
    }
    #pragma unroll
    for (int i_30 = 0; i_30 < 2; ++i_30) {
      scores_scale_v1[i_30] = exp2f(((scores_max_prev[i_30] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[i_30] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
    }
    #pragma unroll
    for (int i_31 = 0; i_31 < 2; ++i_31) {
      ...
      for (int rv_7 = 0; rv_7 < 2; ++rv_7) {
        scores_sum[i_31] = (scores_sum[i_31] + acc_s[((i_31 * 2) + rv_7)]);
      }
      __syncthreads();
      scores_sum[i_31] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_31], (&(((float*)workspace_5)[0])));
