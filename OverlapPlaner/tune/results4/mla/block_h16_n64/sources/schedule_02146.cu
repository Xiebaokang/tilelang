...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap KV_desc, __grid_constant__ const CUtensorMap K_pe_desc, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap Q_pe_desc) {
  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
  ...
  for (int k = 0; k < 127; ++k) {
    ...
    overlap_plan_mbar[((k & 1) + 2)].wait(((k & 3) >> 1));
    {
      ...
      for (int ki_4 = 0; ki_4 < 4; ++ki_4) {
        tl::ptx_ldmatrix_x4((&(((half_t*)S_shared)[((((k & 1) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (ki_4 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_4 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(A_local_4[0])));
        for (int i_9 = 0; i_9 < 4; ++i_9) {
          tl::ptx_ldmatrix_x4_trans((&(((half_t*)KV_shared)[((((((k & 1) * 32768) + ((((int)threadIdx.x) >> 5) * 4096)) + (ki_4 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_9 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_9 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_4[(i_9 * 8)])));
        }
        for (int j = 0; j < 4; ++j) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
    ...
    for (int i_10 = 0; i_10 < 2; ++i_10) {
      ...
      for (int rv_2 = 0; rv_2 < 2; ++rv_2) {
        scores_max_clear_1[i_10] = max(scores_max_clear_1[i_10], acc_s[((i_10 * 2) + rv_2)]);
      }
      __syncthreads();
      scores_max_clear_1[i_10] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_10], (&(((float*)workspace_1)[0])));
    ...
    for (int i_12 = 0; i_12 < 4; ++i_12) {
      acc_s[i_12] = exp2f(((acc_s[i_12] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[(i_12 >> 1)] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
    }
    #pragma unroll
    for (int i_13 = 0; i_13 < 2; ++i_13) {
      ...
      *(uint1*)(((half_t*)S_shared) + (((((((((k + 1) & 1) * 1024) + (i_13 * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(S_shared_local_cast_1 + 0);
    }
    #pragma unroll
    for (int i_14 = 0; i_14 < 2; ++i_14) {
      scores_scale[i_14] = exp2f(((scores_max_prev[i_14] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[i_14] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
    }
    #pragma unroll
    for (int i_15 = 0; i_15 < 2; ++i_15) {
      ...
      for (int rv_3 = 0; rv_3 < 2; ++rv_3) {
        scores_sum[i_15] = (scores_sum[i_15] + acc_s[((i_15 * 2) + rv_3)]);
      }
      __syncthreads();
      scores_sum[i_15] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_15], (&(((float*)workspace_3)[0])));
  ...
  overlap_plan_mbar[3].wait(1);
  {
    ...
    for (int ki_5 = 0; ki_5 < 4; ++ki_5) {
      ...
      for (int i_18 = 0; i_18 < 4; ++i_18) {
        tl::ptx_ldmatrix_x4_trans((&(((half_t*)KV_shared)[((((((((int)threadIdx.x) >> 5) * 4096) + (ki_5 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_18 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_18 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 32768)])), (&(B_local_5[(i_18 * 8)])));
      }
  ...
  for (int i_20 = 0; i_20 < 4; ++i_20) {
    tl::ptx_stmatrix_m8n8_x4((&(((half_t*)O_shared)[(((((((int)threadIdx.x) & 15) * 512) + ((((int)threadIdx.x) >> 5) * 64)) + (i_20 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(((half_t)acc_o[(i_20 * 8)]), ((half_t)acc_o[((i_20 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_20 * 8) + 2)]), ((half_t)acc_o[((i_20 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_20 * 8) + 4)]), ((half_t)acc_o[((i_20 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_20 * 8) + 6)]), ((half_t)acc_o[((i_20 * 8) + 7)])));
  }
