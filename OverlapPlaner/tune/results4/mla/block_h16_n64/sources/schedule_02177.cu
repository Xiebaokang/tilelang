  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
    ...
    for (int i_1 = 0; i_1 < 2; ++i_1) {
      ...
      scores_max_clear[i_1] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear[i_1], (&(((float*)workspace_7)[0])));
    ...
    for (int k = 0; k < 63; ++k) {
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
      ...
      for (int i_7 = 0; i_7 < 2; ++i_7) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_1[i_7] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_7], (&(((float*)workspace_1)[0])));
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_8, broadcast_var_8);
      ...
      for (int i_16 = 0; i_16 < 2; ++i_16) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_2[i_16] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_16], (&(((float*)workspace)[0])));
      ...
      for (int i_20 = 0; i_20 < 2; ++i_20) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_20] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_20], (&(((float*)workspace_4)[0])));
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_10, broadcast_var_10);
    ...
    for (int i_29 = 0; i_29 < 2; ++i_29) {
      ...
      tl::__sync_thread_partial(3, 256);
      scores_sum[i_29] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_29], (&(((float*)workspace_6)[0])));
