...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap KV_desc, __grid_constant__ const CUtensorMap K_pe_desc, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap Q_pe_desc) {
  ...
  void* workspace = ((void*)((char*)buf_dyn_shmem + 161792));
  void* workspace_1 = ((void*)((char*)buf_dyn_shmem + 161792));
  void* workspace_2 = ((void*)((char*)buf_dyn_shmem + 161792));
  void* workspace_3 = ((void*)((char*)buf_dyn_shmem + 161792));
  void* workspace_4 = ((void*)((char*)buf_dyn_shmem + 161792));
  void* workspace_5 = ((void*)((char*)buf_dyn_shmem + 161792));
  void* workspace_6 = ((void*)((char*)buf_dyn_shmem + 161792));
  void* workspace_7 = ((void*)((char*)buf_dyn_shmem + 161792));
  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
  ...
  for (int i_1 = 0; i_1 < 2; ++i_1) {
    ...
    __syncthreads();
    scores_max_clear[i_1] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear[i_1], (&(((float*)workspace_5)[0])));
  ...
  for (int i_5 = 0; i_5 < 2; ++i_5) {
    ...
    __syncthreads();
    scores_sum[i_5] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_5], (&(((float*)workspace_6)[0])));
  ...
  for (int k = 0; k < 63; ++k) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
    ...
    for (int i_8 = 0; i_8 < 2; ++i_8) {
      ...
      __syncthreads();
      scores_max_clear_1[i_8] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_8], (&(((float*)workspace_7)[0])));
    ...
    for (int i_13 = 0; i_13 < 2; ++i_13) {
      ...
      uint1 __1;
      float2 v_ = *(float2*)(acc_s_v0 + (i_13 * 2));
      ((half2*)(&__1))[0] = __float22half2_rn(((float2*)(&v_))[0]);
      *(uint1*)(S_shared_local_cast + 0) = __1;
      *(uint1*)(((half_t*)S_shared) + ((((((i_13 * 512) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(S_shared_local_cast + 0);
    }
    #pragma unroll
    ...
    overlap_plan_mbar[2].wait((k & 1));
    {
      ...
      for (int ki_4 = 0; ki_4 < 4; ++ki_4) {
        ...
        for (int i_15 = 0; i_15 < 4; ++i_15) {
          tl::ptx_ldmatrix_x4_trans((&(((half_t*)KV_shared)[(((((((int)threadIdx.x) >> 5) * 4096) + (ki_4 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_15 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_15 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_4[(i_15 * 8)])));
        }
        for (int j = 0; j < 4; ++j) {
    ...
    overlap_plan_mbar[4].wait(0);
    {
      ...
      for (int ki_6 = 0; ki_6 < 4; ++ki_6) {
        ...
        tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_s_v0 + 0), reinterpret_cast<const unsigned*>(A_local_6 + 0), reinterpret_cast<const unsigned*>(B_local_6 + 0));
      }
    }
    overlap_plan_mbar[7].arrive();
    *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_8, broadcast_var_8);
    ...
    for (int i_17 = 0; i_17 < 2; ++i_17) {
      ...
      __syncthreads();
      scores_max_clear_2[i_17] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_17], (&(((float*)workspace_2)[0])));
    ...
    for (int i_22 = 0; i_22 < 2; ++i_22) {
      ...
      uint1 __2;
      float2 v__1 = *(float2*)(acc_s_v1 + (i_22 * 2));
      ((half2*)(&__2))[0] = __float22half2_rn(((float2*)(&v__1))[0]);
      *(uint1*)(S_shared_local_cast_1 + 0) = __2;
      *(uint1*)(((half_t*)S_shared) + (((((((i_22 * 512) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 1024)) = *(uint1*)(S_shared_local_cast_1 + 0);
    }
    #pragma unroll
    ...
    overlap_plan_mbar[3].wait((k & 1));
    {
      ...
      for (int ki_7 = 0; ki_7 < 4; ++ki_7) {
        ...
        for (int i_24 = 0; i_24 < 4; ++i_24) {
          tl::ptx_ldmatrix_x4_trans((&(((half_t*)KV_shared)[((((((((int)threadIdx.x) >> 5) * 4096) + (ki_7 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_24 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_24 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 32768)])), (&(B_local_7[(i_24 * 8)])));
        }
    ...
    for (int i_25 = 0; i_25 < 32; ++i_25) {
      acc_o[i_25] = (acc_o[i_25] * scores_scale[((i_25 & 3) >> 1)]);
    }
  }
  ...
  overlap_plan_mbar[4].wait(1);
  {
    ...
    for (int ki_9 = 0; ki_9 < 4; ++ki_9) {
      ...
      tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_s_v1 + 0), reinterpret_cast<const unsigned*>(A_local_9 + 0), reinterpret_cast<const unsigned*>(B_local_9 + 0));
    }
  }
  overlap_plan_mbar[7].arrive();
  *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_10, broadcast_var_10);
  ...
  for (int i_26 = 0; i_26 < 2; ++i_26) {
    ...
    __syncthreads();
    scores_max_clear_3[i_26] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_3[i_26], (&(((float*)workspace_1)[0])));
  ...
  for (int i_28 = 0; i_28 < 2; ++i_28) {
    scores_scale[i_28] = exp2f(((scores_max_prev[i_28] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[i_28] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
  }
  #pragma unroll
  ...
  for (int i_30 = 0; i_30 < 2; ++i_30) {
    ...
    __syncthreads();
    scores_sum[i_30] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_30], (&(((float*)workspace_4)[0])));
  ...
  for (int i_31 = 0; i_31 < 2; ++i_31) {
    ...
    uint1 __3;
    float2 v__2 = *(float2*)(acc_s_v0 + (i_31 * 2));
    ((half2*)(&__3))[0] = __float22half2_rn(((float2*)(&v__2))[0]);
    *(uint1*)(S_shared_local_cast_2 + 0) = __3;
    *(uint1*)(((half_t*)S_shared) + ((((((i_31 * 512) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(S_shared_local_cast_2 + 0);
  }
  #pragma unroll
  ...
  for (int i_35 = 0; i_35 < 2; ++i_35) {
    ...
    uint1 __4;
    float2 v__3 = *(float2*)(acc_s_v1 + (i_35 * 2));
    ((half2*)(&__4))[0] = __float22half2_rn(((float2*)(&v__3))[0]);
    *(uint1*)(S_shared_local_cast_3 + 0) = __4;
    *(uint1*)(((half_t*)S_shared) + (((((((i_35 * 512) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 1024)) = *(uint1*)(S_shared_local_cast_3 + 0);
  }
  overlap_plan_mbar[3].wait(1);
  {
    half_t A_local_11[8];
