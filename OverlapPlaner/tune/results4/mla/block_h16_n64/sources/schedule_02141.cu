...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap KV_desc, __grid_constant__ const CUtensorMap K_pe_desc, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap Q_pe_desc) {
  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
    ...
    overlap_plan_mbar[2].wait((k & 1));
    {
      ...
      for (int ki_4 = 0; ki_4 < 4; ++ki_4) {
        ...
        for (int i_9 = 0; i_9 < 4; ++i_9) {
          tl::ptx_ldmatrix_x4_trans((&(((half_t*)KV_shared)[(((((((int)threadIdx.x) >> 5) * 4096) + (ki_4 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_9 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_9 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_4[(i_9 * 8)])));
        }
        for (int j = 0; j < 4; ++j) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
    ...
    for (int i_10 = 0; i_10 < 2; ++i_10) {
      ...
      for (int rv_2 = 0; rv_2 < 2; ++rv_2) {
        scores_max_clear_1[i_10] = max(scores_max_clear_1[i_10], acc_s_v1[((i_10 * 2) + rv_2)]);
      }
      __syncthreads();
      scores_max_clear_1[i_10] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_10], (&(((float*)workspace_5)[0])));
    ...
    for (int i_13 = 0; i_13 < 4; ++i_13) {
      acc_s_v1[i_13] = exp2f(((acc_s_v1[i_13] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[(i_13 >> 1)] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
    }
    #pragma unroll
    for (int i_14 = 0; i_14 < 2; ++i_14) {
      ...
      for (int rv_3 = 0; rv_3 < 2; ++rv_3) {
        scores_sum[i_14] = (scores_sum[i_14] + acc_s_v1[((i_14 * 2) + rv_3)]);
      }
      __syncthreads();
      scores_sum[i_14] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_14], (&(((float*)workspace_6)[0])));
    ...
    for (int i_17 = 0; i_17 < 32; ++i_17) {
      acc_o[i_17] = (acc_o[i_17] * scores_scale[((i_17 & 3) >> 1)]);
    }
    overlap_plan_mbar[3].wait((k & 1));
    {
      half_t A_local_7[8];
      ...
      for (int ki_7 = 0; ki_7 < 4; ++ki_7) {
        ...
        for (int i_18 = 0; i_18 < 4; ++i_18) {
          tl::ptx_ldmatrix_x4_trans((&(((half_t*)KV_shared)[((((((((int)threadIdx.x) >> 5) * 4096) + (ki_7 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_18 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_18 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 32768)])), (&(B_local_7[(i_18 * 8)])));
        }
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_8, broadcast_var_8);
    ...
    for (int i_19 = 0; i_19 < 2; ++i_19) {
      ...
      for (int rv_4 = 0; rv_4 < 2; ++rv_4) {
        scores_max_clear_2[i_19] = max(scores_max_clear_2[i_19], acc_s_v0[((i_19 * 2) + rv_4)]);
      }
      __syncthreads();
      scores_max_clear_2[i_19] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_19], (&(((float*)workspace_7)[0])));
    ...
    for (int i_21 = 0; i_21 < 2; ++i_21) {
      scores_scale[i_21] = exp2f(((scores_max_prev[i_21] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[i_21] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
    }
    #pragma unroll
    for (int i_22 = 0; i_22 < 4; ++i_22) {
      acc_s_v0[i_22] = exp2f(((acc_s_v0[i_22] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[(i_22 >> 1)] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
    }
    #pragma unroll
    for (int i_23 = 0; i_23 < 2; ++i_23) {
      ...
      for (int rv_5 = 0; rv_5 < 2; ++rv_5) {
        scores_sum[i_23] = (scores_sum[i_23] + acc_s_v0[((i_23 * 2) + rv_5)]);
      }
      __syncthreads();
  ...
  for (int i_26 = 0; i_26 < 32; ++i_26) {
    acc_o[i_26] = (acc_o[i_26] * scores_scale[((i_26 & 3) >> 1)]);
  }
  overlap_plan_mbar[2].wait(1);
  {
    ...
    for (int ki_10 = 0; ki_10 < 4; ++ki_10) {
      ...
      for (int i_27 = 0; i_27 < 4; ++i_27) {
        tl::ptx_ldmatrix_x4_trans((&(((half_t*)KV_shared)[(((((((int)threadIdx.x) >> 5) * 4096) + (ki_10 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_27 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_27 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_10[(i_27 * 8)])));
      }
  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_10, broadcast_var_10);
  ...
  for (int i_28 = 0; i_28 < 2; ++i_28) {
    ...
    for (int rv_6 = 0; rv_6 < 2; ++rv_6) {
      scores_max_clear_3[i_28] = max(scores_max_clear_3[i_28], acc_s_v1[((i_28 * 2) + rv_6)]);
    }
    __syncthreads();
    scores_max_clear_3[i_28] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_3[i_28], (&(((float*)workspace_2)[0])));
  ...
  for (int i_30 = 0; i_30 < 2; ++i_30) {
    scores_scale[i_30] = exp2f(((scores_max_prev[i_30] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[i_30] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
  }
  #pragma unroll
  for (int i_31 = 0; i_31 < 4; ++i_31) {
    acc_s_v1[i_31] = exp2f(((acc_s_v1[i_31] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[(i_31 >> 1)] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
  }
  #pragma unroll
  for (int i_32 = 0; i_32 < 2; ++i_32) {
    ...
    for (int rv_7 = 0; rv_7 < 2; ++rv_7) {
      scores_sum[i_32] = (scores_sum[i_32] + acc_s_v1[((i_32 * 2) + rv_7)]);
    }
    __syncthreads();
    scores_sum[i_32] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_32], (&(((float*)workspace)[0])));
  ...
  for (int i_35 = 0; i_35 < 32; ++i_35) {
    acc_o[i_35] = (acc_o[i_35] * scores_scale[((i_35 & 3) >> 1)]);
  }
  overlap_plan_mbar[3].wait(1);
  {
    half_t A_local_11[8];
