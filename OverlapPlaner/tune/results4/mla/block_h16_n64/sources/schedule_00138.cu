...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap KV_desc, __grid_constant__ const CUtensorMap K_pe_desc, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap Q_pe_desc) {
  ...
  void* S_shared = ((void*)((char*)buf_dyn_shmem + 100352));
  void* workspace = ((void*)((char*)buf_dyn_shmem + 102400));
  void* workspace_1 = ((void*)((char*)buf_dyn_shmem + 102400));
      ...
      }
      {
        ...
        for (int ki_2 = 0; ki_2 < 4; ++ki_2) {
          ...
          for (int i_6 = 0; i_6 < 4; ++i_6) {
            tl::ptx_ldmatrix_x4_trans((&(((half_t*)KV_shared)[(((((((int)threadIdx.x) >> 5) * 4096) + (ki_2 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_6 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_6 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_2[(i_6 * 8)])));
          }
          for (int j = 0; j < 4; ++j) {
