...
extern "C" __global__ void __launch_bounds__(512, 1) main_kernel(__grid_constant__ const CUtensorMap KV_desc, __grid_constant__ const CUtensorMap K_pe_desc, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap Q_pe_desc) {
  ...
  void* acc_s_wsp_handoff_6 = ((void*)((char*)buf_dyn_shmem + 165888));
  void* S_shared = ((void*)((char*)buf_dyn_shmem + 174080));
  void* acc_s_wsp_handoff_4 = ((void*)((char*)buf_dyn_shmem + 178176));
  void* acc_s_wsp_handoff_7 = ((void*)((char*)buf_dyn_shmem + 182272));
  void* scores_scale_wsp_handoff_5 = ((void*)((char*)buf_dyn_shmem + 186368));
  void* workspace = ((void*)((char*)buf_dyn_shmem + 186432));
  void* workspace_1 = ((void*)((char*)buf_dyn_shmem + 186432));
  void* workspace_2 = ((void*)((char*)buf_dyn_shmem + 187456));
  void* workspace_3 = ((void*)((char*)buf_dyn_shmem + 187456));
    ...
    *(float2*)(logsum + 0) = make_float2(broadcast_var_1, broadcast_var_1);
    for (int k = 0; k < 64; ++k) {
      ...
      for (int i_4 = 0; i_4 < 2; ++i_4) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_4] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_4], (&(((float*)workspace)[0])));
      ...
      for (int i_12 = 0; i_12 < 2; ++i_12) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_12] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_12], (&(((float*)workspace_1)[0])));
