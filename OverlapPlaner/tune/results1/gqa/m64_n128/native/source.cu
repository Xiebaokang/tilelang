  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int k = 0; k < 32; ++k) {
      ...
      if (tl::tl_shuffle_elect<128>()) {
        ...
        tl::tma_load(K_desc, mbarrier[(k & 1)], (&(((half_t*)K_shared)[((k & 1) * 16384)])), 0, (k * 128), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(K_desc, mbarrier[(k & 1)], (&(((half_t*)K_shared)[(((k & 1) * 16384) + 8192)])), 64, (k * 128), (((int)blockIdx.y) >> 3), 0);
      }
      mbarrier[((k & 1) + 6)].wait((((k & 3) >> 1) ^ 1));
      if (tl::tl_shuffle_elect<128>()) {
        mbarrier[((k & 1) + 2)].arrive_and_expect_tx(32768);
        tl::tma_load(V_desc, mbarrier[((k & 1) + 2)], (&(((half_t*)V_shared)[((k & 1) * 16384)])), 0, (k * 128), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(V_desc, mbarrier[((k & 1) + 2)], (&(((half_t*)V_shared)[(((k & 1) * 16384) + 8192)])), 64, (k * 128), (((int)blockIdx.y) >> 3), 0);
      }
    }
  } else {
