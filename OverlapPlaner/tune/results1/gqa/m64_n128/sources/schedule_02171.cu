    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int k_1 = 0; k_1 < 32; ++k_1) {
        ...
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          ...
          tl::tma_load(K_desc, overlap_plan_mbar[((k_1 % 3) + 1)], (&(((half_t*)K_shared)[((k_1 % 3) * 16384)])), 0, (k_1 * 128), (((int)blockIdx.y) >> 3), 0);
          tl::tma_load(K_desc, overlap_plan_mbar[((k_1 % 3) + 1)], (&(((half_t*)K_shared)[(((k_1 % 3) * 16384) + 8192)])), 64, (k_1 * 128), (((int)blockIdx.y) >> 3), 0);
        }
        if (2 <= k_1) {
