...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap K_desc, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc) {
  ...
  void* O_shared = ((void*)((char*)buf_dyn_shmem + 214016));
    ...
    *(float2*)(logsum + 0) = make_float2(broadcast_var_1, broadcast_var_1);
    for (int k = 0; k < 32; ++k) {
      ...
      for (int i_6 = 0; i_6 < 64; ++i_6) {
        acc_o[i_6] = (acc_o[i_6] * scores_scale[((i_6 & 3) >> 1)]);
      }
      ...
      for (int i_7 = 0; i_7 < 2; ++i_7) {
        ...
        for (int rv = 0; rv < 32; ++rv) {
          scores_sum[i_7] = (scores_sum[i_7] + acc_s[((((rv & 15) * 4) + (i_7 * 2)) + (rv >> 4))]);
        }
    ...
    for (int i_10 = 0; i_10 < 8; ++i_10) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)O_shared)[(((((i_10 >> 2) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_10 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_10 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_o[(i_10 * 8)]), ((half_t)acc_o[((i_10 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_10 * 8) + 2)]), ((half_t)acc_o[((i_10 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_10 * 8) + 4)]), ((half_t)acc_o[((i_10 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_10 * 8) + 6)]), ((half_t)acc_o[((i_10 * 8) + 7)])));
    }
    tl::fence_proxy_async();
    ...
    for (int k_1 = 0; k_1 < 32; ++k_1) {
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
      ...
      for (int i_11 = 0; i_11 < 32; ++i_11) {
        *(float2*)(acc_s + (i_11 * 2)) = *(float2*)(((float*)acc_s_wsp_handoff_2) + (((((((((int)threadIdx.x) >> 5) * 2048) + ((i_11 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_11 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 8192));
      }
      #pragma unroll
      for (int i_12 = 0; i_12 < 2; ++i_12) {
        ...
        for (int rv_1 = 0; rv_1 < 32; ++rv_1) {
          scores_max_clear[i_12] = max(scores_max_clear[i_12], acc_s[((((rv_1 & 15) * 4) + (i_12 * 2)) + (rv_1 >> 4))]);
        }
        scores_max_clear[i_12] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<128>>::run(scores_max_clear[i_12]);
      ...
      if ((((int)threadIdx.x) % 4) == 0) {
        ...
        for (int i_15 = 0; i_15 < 2; ++i_15) {
          ((float*)scores_scale_wsp_handoff_3)[(((((((int)threadIdx.x) >> 5) * 16) + (i_15 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) - 64)] = scores_scale[i_15];
        }
      }
      tl::fence_proxy_async();
      ...
      for (int i_17 = 0; i_17 < 32; ++i_17) {
        *(float2*)(((float*)acc_s_wsp_handoff_4) + (((((((((int)threadIdx.x) >> 5) * 2048) + ((i_17 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_17 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 8192)) = *(float2*)(acc_s + (i_17 * 2));
      }
      tl::fence_proxy_async();
