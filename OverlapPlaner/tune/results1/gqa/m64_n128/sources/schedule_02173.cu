...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap K_desc, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc) {
  ...
  void* acc_s_wsp_handoff_2 = ((void*)((char*)buf_dyn_shmem + 147456));
  void* acc_s_wsp_handoff_4 = ((void*)((char*)buf_dyn_shmem + 180224));
  void* scores_scale_wsp_handoff_3 = ((void*)((char*)buf_dyn_shmem + 212992));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    *(float2*)(logsum + 0) = make_float2(broadcast_var_1, broadcast_var_1);
    ...
    for (int i_2 = 0; i_2 < 32; ++i_2) {
      *(float2*)(((float*)acc_s_wsp_handoff_2) + ((((((((int)threadIdx.x) >> 5) * 2048) + ((i_2 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_2 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(acc_s + (i_2 * 2));
    }
    ...
    for (int i_3 = 0; i_3 < 32; ++i_3) {
      *(float2*)(acc_s + (i_3 * 2)) = *(float2*)(((float*)acc_s_wsp_handoff_4) + ((((((((int)threadIdx.x) >> 5) * 2048) + ((i_3 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_3 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    }
    #pragma unroll
    ...
    for (int i_5 = 0; i_5 < 2; ++i_5) {
      ...
      for (int rv = 0; rv < 32; ++rv) {
        scores_sum[i_5] = (scores_sum[i_5] + acc_s[((((rv & 15) * 4) + (i_5 * 2)) + (rv >> 4))]);
      }
    ...
    for (int k = 0; k < 31; ++k) {
      ...
      overlap_plan_mbar[(((k + 1) & 1) + 1)].wait((((k + 1) & 3) >> 1));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_1, (((k + 1) & 1) * 32768));
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 64);
        tl::warpgroup_arrive();
        #pragma unroll
      ...
      for (int i_10 = 0; i_10 < 32; ++i_10) {
        *(float2*)(((float*)acc_s_wsp_handoff_2) + ((((((((int)threadIdx.x) >> 5) * 2048) + ((i_10 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_10 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(acc_s + (i_10 * 2));
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[3].arrive();
      overlap_plan_mbar[(((k + 1) & 1) + 8)].arrive();
      overlap_plan_mbar[((k & 1) + 6)].wait(((k & 3) >> 1));
      {
      ...
      for (int i_11 = 0; i_11 < 32; ++i_11) {
        *(float2*)(acc_s + (i_11 * 2)) = *(float2*)(((float*)acc_s_wsp_handoff_4) + ((((((((int)threadIdx.x) >> 5) * 2048) + ((i_11 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_11 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      }
      #pragma unroll
      ...
      for (int i_13 = 0; i_13 < 2; ++i_13) {
        ...
        for (int rv_1 = 0; rv_1 < 32; ++rv_1) {
          scores_sum[i_13] = (scores_sum[i_13] + acc_s[((((rv_1 & 15) * 4) + (i_13 * 2)) + (rv_1 >> 4))]);
        }
    ...
    for (int i_18 = 0; i_18 < 8; ++i_18) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)O_shared)[(((((i_18 >> 2) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_18 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_18 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_o[(i_18 * 8)]), ((half_t)acc_o[((i_18 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_18 * 8) + 2)]), ((half_t)acc_o[((i_18 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_18 * 8) + 4)]), ((half_t)acc_o[((i_18 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_18 * 8) + 6)]), ((half_t)acc_o[((i_18 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 128);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    for (int k_1 = 0; k_1 < 32; ++k_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        ...
        tl::tma_load(K_desc, overlap_plan_mbar[((k_1 & 1) + 1)], (&(((half_t*)K_shared)[((k_1 & 1) * 16384)])), 0, (k_1 * 128), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[((k_1 & 1) + 1)], (&(((half_t*)K_shared)[(((k_1 & 1) * 16384) + 8192)])), 64, (k_1 * 128), (((int)blockIdx.y) >> 3), 0);
      }
      if (2 <= k_1) {
        overlap_plan_mbar[((k_1 & 1) + 10)].wait((((k_1 >> 1) + 1) & 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[((k_1 & 1) + 6)].arrive_and_expect_tx(32768);
        tl::tma_load(V_desc, overlap_plan_mbar[((k_1 & 1) + 6)], (&(((half_t*)V_shared)[((k_1 & 1) * 16384)])), 0, (k_1 * 128), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[((k_1 & 1) + 6)], (&(((half_t*)V_shared)[(((k_1 & 1) * 16384) + 8192)])), 64, (k_1 * 128), (((int)blockIdx.y) >> 3), 0);
      }
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
      ...
      for (int i_19 = 0; i_19 < 32; ++i_19) {
        *(float2*)(acc_s + (i_19 * 2)) = *(float2*)(((float*)acc_s_wsp_handoff_2) + (((((((((int)threadIdx.x) >> 5) * 2048) + ((i_19 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_19 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 8192));
      }
      #pragma unroll
      for (int i_20 = 0; i_20 < 2; ++i_20) {
        ...
        for (int rv_2 = 0; rv_2 < 32; ++rv_2) {
          scores_max_clear[i_20] = max(scores_max_clear[i_20], acc_s[((((rv_2 & 15) * 4) + (i_20 * 2)) + (rv_2 >> 4))]);
        }
      ...
      for (int i_23 = 0; i_23 < 32; ++i_23) {
        *(float2*)(((float*)acc_s_wsp_handoff_4) + (((((((((int)threadIdx.x) >> 5) * 2048) + ((i_23 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_23 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 8192)) = *(float2*)(acc_s + (i_23 * 2));
      }
      tl::fence_proxy_async();
