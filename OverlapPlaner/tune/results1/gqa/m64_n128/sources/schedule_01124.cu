  ...
  if (((int)threadIdx.x) < 128) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int i_1 = 0; i_1 < 32; ++i_1) {
      *(float2*)(acc_s + (i_1 * 2)) = *(float2*)(((float*)acc_s_wsp_handoff_2) + ((((((((int)threadIdx.x) >> 5) * 2048) + ((i_1 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_1 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    }
    #pragma unroll
    ...
    for (int k = 0; k < 31; ++k) {
      overlap_plan_mbar[((k & 1) + 4)].wait(((k & 3) >> 1));
      {
        ...
        tl::initialize_wgmma_descriptor<1, 1024, 64>(desc_b, (&(((half_t*)V_shared)[0])));
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
      ...
      for (int i_10 = 0; i_10 < 32; ++i_10) {
        *(float2*)(acc_s + (i_10 * 2)) = *(float2*)(((float*)acc_s_wsp_handoff_2) + ((((((((int)threadIdx.x) >> 5) * 2048) + ((i_10 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_10 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      }
      #pragma unroll
    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int k_1 = 0; k_1 < 32; ++k_1) {
        ...
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          overlap_plan_mbar[((k_1 & 1) + 4)].arrive_and_expect_tx(32768);
          tl::tma_load(V_desc, overlap_plan_mbar[((k_1 & 1) + 4)], (&(((half_t*)V_shared)[((k_1 & 1) * 16384)])), 0, (k_1 * 128), (((int)blockIdx.y) >> 3), 0);
          tl::tma_load(V_desc, overlap_plan_mbar[((k_1 & 1) + 4)], (&(((half_t*)V_shared)[(((k_1 & 1) * 16384) + 8192)])), 64, (k_1 * 128), (((int)blockIdx.y) >> 3), 0);
        }
        #pragma unroll
        for (int i_21 = 0; i_21 < 64; ++i_21) {
          acc_s[i_21] = 0x0p+0f/*0.000000e+00*/;
        }
        if (k_1 == 0) {
        ...
        overlap_plan_mbar[((k_1 & 1) + 1)].wait(((k_1 & 3) >> 1));
        {
          ...
          tl::increase_descriptor_offset<int>(desc_b_2, ((k_1 & 1) * 32768));
          tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 64);
          tl::warpgroup_arrive();
          #pragma unroll
          for (int ki_2 = 0; ki_2 < 8; ++ki_2) {
            tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 128, 16, false, false, 1, 1>(uint64_t(desc_a + ((((ki_2 >> 2) * 8192) + ((ki_2 & 3) * 32)) >> 4)), uint64_t(desc_b_2 + ((((ki_2 >> 2) * 16384) + ((ki_2 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + 0)), 1);
          }
          tl::warpgroup_commit_batch();
          tl::warpgroup_wait<0>();
          tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 64);
        ...
        for (int i_22 = 0; i_22 < 32; ++i_22) {
          *(float2*)(((float*)acc_s_wsp_handoff_2) + (((((((((int)threadIdx.x) >> 5) * 2048) + ((i_22 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_22 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 8192)) = *(float2*)(acc_s + (i_22 * 2));
        }
        tl::fence_proxy_async();
