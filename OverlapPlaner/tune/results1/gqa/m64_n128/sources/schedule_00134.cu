  ...
  if (((int)threadIdx.x) < 128) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
    ...
    for (int k = 0; k < 10; ++k) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[1].arrive_and_expect_tx(32768);
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[0])), 0, ((k * 384) + 256), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[8192])), 64, ((k * 384) + 256), (((int)blockIdx.y) >> 3), 0);
      }
      #pragma unroll
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(V_desc, overlap_plan_mbar[((((k * 3) + 1) & 1) + 2)], (&(((half_t*)V_shared)[((((k * 3) + 1) & 1) * 16384)])), 0, ((k * 384) + 128), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[((((k * 3) + 1) & 1) + 2)], (&(((half_t*)V_shared)[(((((k * 3) + 1) & 1) * 16384) + 8192)])), 64, ((k * 384) + 128), (((int)blockIdx.y) >> 3), 0);
      }
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[1].arrive_and_expect_tx(32768);
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[0])), 0, ((k * 384) + 384), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[8192])), 64, ((k * 384) + 384), (((int)blockIdx.y) >> 3), 0);
      }
      #pragma unroll
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(V_desc, overlap_plan_mbar[((k & 1) + 2)], (&(((half_t*)V_shared)[((k & 1) * 16384)])), 0, ((k * 384) + 256), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[((k & 1) + 2)], (&(((half_t*)V_shared)[(((k & 1) * 16384) + 8192)])), 64, ((k * 384) + 256), (((int)blockIdx.y) >> 3), 0);
      }
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[1].arrive_and_expect_tx(32768);
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[0])), 0, ((k * 384) + 512), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[8192])), 64, ((k * 384) + 512), (((int)blockIdx.y) >> 3), 0);
      }
      #pragma unroll
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_7, broadcast_var_7);
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((((k * 3) + 1) & 1) + 2)].arrive_and_expect_tx(32768);
        tl::tma_load(V_desc, overlap_plan_mbar[((((k * 3) + 1) & 1) + 2)], (&(((half_t*)V_shared)[((((k * 3) + 1) & 1) * 16384)])), 0, ((k * 384) + 384), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[((((k * 3) + 1) & 1) + 2)], (&(((half_t*)V_shared)[(((((k * 3) + 1) & 1) * 16384) + 8192)])), 64, ((k * 384) + 384), (((int)blockIdx.y) >> 3), 0);
      }
    ...
    for (int i_44 = 0; i_44 < 64; ++i_44) {
      acc_o[i_44] = (acc_o[i_44] * scores_scale_v0[((i_44 & 3) >> 1)]);
    }
    overlap_plan_mbar[7].wait(0);
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[3].arrive_and_expect_tx(32768);
      tl::tma_load(V_desc, overlap_plan_mbar[3], (&(((half_t*)V_shared)[16384])), 0, 3968, (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(V_desc, overlap_plan_mbar[3], (&(((half_t*)V_shared)[24576])), 64, 3968, (((int)blockIdx.y) >> 3), 0);
    }
    overlap_plan_mbar[2].wait(1);
    {
      tl::GmmaDescriptor desc_b_8;
      tl::initialize_wgmma_descriptor<1, 1024, 64>(desc_b_8, (&(((half_t*)V_shared)[0])));
      tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(acc_s_cast_v0 + 0), 32);
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_o + 0), 64);
      tl::warpgroup_arrive();
      #pragma unroll
      for (int ki_8 = 0; ki_8 < 8; ++ki_8) {
        tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 128, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(acc_s_cast_v0 + (ki_8 * 8)), uint64_t(desc_b_8 + ((ki_8 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc_o + 0), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_o + 0), 64);
    ...
    for (int i_46 = 0; i_46 < 64; ++i_46) {
      acc_o[i_46] = (acc_o[i_46] / logsum[((i_46 & 3) >> 1)]);
    }
    #pragma unroll
    for (int i_47 = 0; i_47 < 8; ++i_47) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)O_shared)[(((((i_47 >> 2) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_47 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_47 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_o[(i_47 * 8)]), ((half_t)acc_o[((i_47 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_47 * 8) + 2)]), ((half_t)acc_o[((i_47 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_47 * 8) + 4)]), ((half_t)acc_o[((i_47 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_47 * 8) + 6)]), ((half_t)acc_o[((i_47 * 8) + 7)])));
    }
