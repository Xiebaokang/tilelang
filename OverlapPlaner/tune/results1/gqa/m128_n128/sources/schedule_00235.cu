  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max_prev_v0 + 0) = *(float2*)(scores_max + 0);
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(V_desc, overlap_plan_mbar[3], (&(((half_t*)V_shared)[0])), 0, 0, (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(V_desc, overlap_plan_mbar[3], (&(((half_t*)V_shared)[8192])), 64, 0, (((int)blockIdx.y) >> 3), 0);
    }
    for (int k = 0; k < 15; ++k) {
      if (1 <= k) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(K_desc, overlap_plan_mbar[2], (&(((half_t*)K_shared)[16384])), 0, ((k * 256) + 128), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[2], (&(((half_t*)K_shared)[24576])), 64, ((k * 256) + 128), (((int)blockIdx.y) >> 3), 0);
      }
      #pragma unroll
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
      ...
      for (int i_3 = 0; i_3 < 2; ++i_3) {
        scores_max[i_3] = max(scores_max[i_3], scores_max_prev_v0[i_3]);
      }
      *(float2*)(scores_max_prev_v1 + 0) = *(float2*)(scores_max + 0);
      #pragma unroll
      for (int i_4 = 0; i_4 < 2; ++i_4) {
        scores_scale[i_4] = exp2f(((scores_max_prev_v0[i_4] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[i_4] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
      }
      #pragma unroll
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(V_desc, overlap_plan_mbar[4], (&(((half_t*)V_shared)[16384])), 0, ((k * 256) + 128), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[4], (&(((half_t*)V_shared)[24576])), 64, ((k * 256) + 128), (((int)blockIdx.y) >> 3), 0);
      }
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
      ...
      for (int i_12 = 0; i_12 < 2; ++i_12) {
        scores_max[i_12] = max(scores_max[i_12], scores_max_prev_v1[i_12]);
      }
      *(float2*)(scores_max_prev_v0 + 0) = *(float2*)(scores_max + 0);
      #pragma unroll
      for (int i_13 = 0; i_13 < 2; ++i_13) {
        scores_scale[i_13] = exp2f(((scores_max_prev_v1[i_13] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[i_13] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
      }
      #pragma unroll
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[3].arrive_and_expect_tx(32768);
        tl::tma_load(V_desc, overlap_plan_mbar[3], (&(((half_t*)V_shared)[0])), 0, ((k * 256) + 256), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[3], (&(((half_t*)V_shared)[8192])), 64, ((k * 256) + 256), (((int)blockIdx.y) >> 3), 0);
      }
    ...
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[2].arrive_and_expect_tx(32768);
      tl::tma_load(K_desc, overlap_plan_mbar[2], (&(((half_t*)K_shared)[16384])), 0, 3968, (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(K_desc, overlap_plan_mbar[2], (&(((half_t*)K_shared)[24576])), 64, 3968, (((int)blockIdx.y) >> 3), 0);
    }
    #pragma unroll
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
    ...
    for (int i_21 = 0; i_21 < 2; ++i_21) {
      scores_max[i_21] = max(scores_max[i_21], scores_max_prev_v0[i_21]);
    }
    *(float2*)(scores_max_prev_v1 + 0) = *(float2*)(scores_max + 0);
    #pragma unroll
    for (int i_22 = 0; i_22 < 2; ++i_22) {
      scores_scale[i_22] = exp2f(((scores_max_prev_v0[i_22] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[i_22] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
    }
    #pragma unroll
    ...
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[4].arrive_and_expect_tx(32768);
      tl::tma_load(V_desc, overlap_plan_mbar[4], (&(((half_t*)V_shared)[16384])), 0, 3968, (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(V_desc, overlap_plan_mbar[4], (&(((half_t*)V_shared)[24576])), 64, 3968, (((int)blockIdx.y) >> 3), 0);
    }
    ...
    overlap_plan_mbar[2].wait(1);
    {
      ...
      tl::increase_descriptor_offset<int>(desc_b_6, 32768);
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 128);
      tl::warpgroup_arrive();
      #pragma unroll
      for (int ki_6 = 0; ki_6 < 8; ++ki_6) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 128, 16, false, false, 1, 1>(uint64_t(desc_a_3 + (((((ki_6 >> 2) * 16384) + ((((int)threadIdx.x) >> 7) * 8192)) + ((ki_6 & 3) * 32)) >> 4)), uint64_t(desc_b_6 + ((((ki_6 >> 2) * 16384) + ((ki_6 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 128);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
    ...
    for (int i_29 = 0; i_29 < 2; ++i_29) {
      ...
      for (int rv_6 = 0; rv_6 < 32; ++rv_6) {
        scores_max_clear_3[i_29] = max(scores_max_clear_3[i_29], acc_s[((((rv_6 & 15) * 4) + (i_29 * 2)) + (rv_6 >> 4))]);
      }
      scores_max_clear_3[i_29] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_max_clear_3[i_29]);
      scores_max[i_29] = max(scores_max[i_29], scores_max_clear_3[i_29]);
    }
    #pragma unroll
    for (int i_30 = 0; i_30 < 2; ++i_30) {
      scores_max[i_30] = max(scores_max[i_30], scores_max_prev_v1[i_30]);
    }
    #pragma unroll
    for (int i_31 = 0; i_31 < 2; ++i_31) {
      scores_scale[i_31] = exp2f(((scores_max_prev_v1[i_31] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[i_31] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
    }
    #pragma unroll
