...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap K_desc, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc) {
  ...
  for (int k = 0; k < 15; ++k) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
    ...
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(V_desc, overlap_plan_mbar[2], (&(((half_t*)V_shared)[0])), 0, (k * 256), (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(V_desc, overlap_plan_mbar[2], (&(((half_t*)V_shared)[8192])), 64, (k * 256), (((int)blockIdx.y) >> 3), 0);
    }
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
    ...
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[2].arrive_and_expect_tx(32768);
      tl::tma_load(V_desc, overlap_plan_mbar[2], (&(((half_t*)V_shared)[0])), 0, ((k * 256) + 128), (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(V_desc, overlap_plan_mbar[2], (&(((half_t*)V_shared)[8192])), 64, ((k * 256) + 128), (((int)blockIdx.y) >> 3), 0);
    }
  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
  ...
  if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
    overlap_plan_mbar[2].arrive_and_expect_tx(32768);
    tl::tma_load(V_desc, overlap_plan_mbar[2], (&(((half_t*)V_shared)[0])), 0, 3840, (((int)blockIdx.y) >> 3), 0);
    tl::tma_load(V_desc, overlap_plan_mbar[2], (&(((half_t*)V_shared)[8192])), 64, 3840, (((int)blockIdx.y) >> 3), 0);
  }
  overlap_plan_mbar[2].wait(0);
  {
  ...
  if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
    ...
    tl::tma_load(V_desc, overlap_plan_mbar[2], (&(((half_t*)V_shared)[8192])), 64, 3968, (((int)blockIdx.y) >> 3), 0);
  }
  overlap_plan_mbar[2].wait(1);
  {
