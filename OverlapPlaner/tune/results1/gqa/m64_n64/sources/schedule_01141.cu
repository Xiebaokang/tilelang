    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int k = 0; k < 31; ++k) {
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
      ...
      overlap_plan_mbar[(((k * 2) % 3) + 3)].wait((((k % 3) * 2) / 3));
      {
        tl::GmmaDescriptor desc_b_2;
        tl::initialize_wgmma_descriptor<1, 512, 64>(desc_b_2, (&(((half_t*)V_shared)[0])));
        tl::increase_descriptor_offset<int>(desc_b_2, (((k * 2) % 3) * 16384));
      ...
      overlap_plan_mbar[(((k * 2) % 3) + 8)].arrive();
      #pragma unroll
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
      ...
      overlap_plan_mbar[((((k * 2) + 1) % 3) + 3)].wait(((((k % 3) * 2) + 1) / 3));
      {
        tl::GmmaDescriptor desc_b_4;
        tl::initialize_wgmma_descriptor<1, 512, 64>(desc_b_4, (&(((half_t*)V_shared)[0])));
        tl::increase_descriptor_offset<int>(desc_b_4, ((((k * 2) + 1) % 3) * 16384));
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
    ...
    for (int k_1 = 0; k_1 < 64; ++k_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        ...
        tl::tma_load(V_desc, overlap_plan_mbar[((k_1 % 3) + 3)], (&(((half_t*)V_shared)[((k_1 % 3) * 8192)])), 0, (k_1 * 64), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[((k_1 % 3) + 3)], (&(((half_t*)V_shared)[(((k_1 % 3) * 8192) + 4096)])), 64, (k_1 * 64), (((int)blockIdx.y) >> 3), 0);
      }
    }
  }
}
