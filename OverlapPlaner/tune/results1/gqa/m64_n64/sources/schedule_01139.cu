...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap K_desc, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc) {
  ...
  void* acc_s_wsp_handoff_5 = ((void*)((char*)buf_dyn_shmem + 81920));
  void* scores_scale_wsp_handoff_4 = ((void*)((char*)buf_dyn_shmem + 98304));
  void* scores_scale_wsp_handoff_3 = ((void*)((char*)buf_dyn_shmem + 98816));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    *(float2*)(logsum + 0) = make_float2(broadcast_var_1, broadcast_var_1);
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(V_desc, overlap_plan_mbar[7], (&(((half_t*)V_shared)[0])), 0, 0, (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(V_desc, overlap_plan_mbar[7], (&(((half_t*)V_shared)[4096])), 64, 0, (((int)blockIdx.y) >> 3), 0);
    }
    #pragma unroll
    ...
    for (int k = 0; k < 31; ++k) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(V_desc, overlap_plan_mbar[8], (&(((half_t*)V_shared)[8192])), 0, ((k * 128) + 64), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[8], (&(((half_t*)V_shared)[12288])), 64, ((k * 128) + 64), (((int)blockIdx.y) >> 3), 0);
      }
      #pragma unroll
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[7].arrive_and_expect_tx(16384);
        tl::tma_load(V_desc, overlap_plan_mbar[7], (&(((half_t*)V_shared)[0])), 0, ((k * 128) + 128), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[7], (&(((half_t*)V_shared)[4096])), 64, ((k * 128) + 128), (((int)blockIdx.y) >> 3), 0);
      }
      #pragma unroll
      ...
      for (int i_19 = 0; i_19 < 2; ++i_19) {
        scores_scale_v1[i_19] = ((float*)scores_scale_wsp_handoff_4)[(((((((int)threadIdx.x) >> 5) * 16) + (i_19 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) + 64)];
      }
      #pragma unroll
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[8].arrive_and_expect_tx(16384);
      tl::tma_load(V_desc, overlap_plan_mbar[8], (&(((half_t*)V_shared)[8192])), 0, 4032, (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(V_desc, overlap_plan_mbar[8], (&(((half_t*)V_shared)[12288])), 64, 4032, (((int)blockIdx.y) >> 3), 0);
    }
    #pragma unroll
    ...
    for (int i_35 = 0; i_35 < 2; ++i_35) {
      scores_scale_v1[i_35] = ((float*)scores_scale_wsp_handoff_4)[(((((((int)threadIdx.x) >> 5) * 16) + (i_35 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) + 64)];
    }
    #pragma unroll
    ...
    for (int k_1 = 0; k_1 < 32; ++k_1) {
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
      ...
      for (int i_39 = 0; i_39 < 16; ++i_39) {
        *(float2*)(acc_s + (i_39 * 2)) = *(float2*)(((float*)acc_s_wsp_handoff_2) + (((((((((int)threadIdx.x) >> 5) * 1024) + ((i_39 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_39 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
      }
      #pragma unroll
      for (int i_40 = 0; i_40 < 2; ++i_40) {
        ...
        scores_max_clear[i_40] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<128>>::run(scores_max_clear[i_40]);
      ...
      for (int i_43 = 0; i_43 < 16; ++i_43) {
        *(float2*)(((float*)acc_s_wsp_handoff_5) + (((((((((int)threadIdx.x) >> 5) * 1024) + ((i_43 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_43 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096)) = *(float2*)(acc_s + (i_43 * 2));
      }
      tl::fence_proxy_async();
      ...
      if ((((int)threadIdx.x) % 4) == 0) {
        ...
        for (int i_45 = 0; i_45 < 2; ++i_45) {
          ((float*)scores_scale_wsp_handoff_3)[(((((((int)threadIdx.x) >> 5) * 16) + (i_45 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) - 64)] = scores_scale_v0[i_45];
        }
        #pragma unroll
        for (int i_46 = 0; i_46 < 2; ++i_46) {
          ((float*)scores_scale_wsp_handoff_4)[(((((((int)threadIdx.x) >> 5) * 16) + (i_46 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) - 64)] = scores_scale_v0[i_46];
        }
      }
      tl::fence_proxy_async();
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
      ...
      for (int i_47 = 0; i_47 < 16; ++i_47) {
        *(float2*)(acc_s + (i_47 * 2)) = *(float2*)(((float*)acc_s_wsp_handoff_2) + (((((((((int)threadIdx.x) >> 5) * 1024) + ((i_47 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_47 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
      }
      #pragma unroll
      for (int i_48 = 0; i_48 < 2; ++i_48) {
        ...
        scores_max_clear_1[i_48] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<128>>::run(scores_max_clear_1[i_48]);
      ...
      for (int i_51 = 0; i_51 < 16; ++i_51) {
        *(float2*)(((float*)acc_s_wsp_handoff_5) + (((((((((int)threadIdx.x) >> 5) * 1024) + ((i_51 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_51 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096)) = *(float2*)(acc_s + (i_51 * 2));
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[6].arrive();
      #pragma unroll
      ...
      if ((((int)threadIdx.x) % 4) == 0) {
        ...
        for (int i_53 = 0; i_53 < 2; ++i_53) {
          ((float*)scores_scale_wsp_handoff_3)[(((((((int)threadIdx.x) >> 5) * 16) + (i_53 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) - 64)] = scores_scale_v1[i_53];
        }
        #pragma unroll
