    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
    ...
    for (int k_1 = 0; k_1 < 64; ++k_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 8)) {
        ...
        tl::tma_load(V_desc, overlap_plan_mbar[((k_1 & 1) + 3)], (&(((half_t*)V_shared)[((k_1 & 1) * 8192)])), 0, (k_1 * 64), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[((k_1 & 1) + 3)], (&(((half_t*)V_shared)[(((k_1 & 1) * 8192) + 4096)])), 64, (k_1 * 64), (((int)blockIdx.y) >> 3), 0);
      }
    }
  }
}
