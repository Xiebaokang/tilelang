  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int k = 0; k < 64; ++k) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[0])), 0, (k * 64), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[4096])), 64, (k * 64), (((int)blockIdx.y) >> 3), 0);
      }
      if (1 <= k) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::fence_proxy_async();
        tl::tma_load(V_desc, overlap_plan_mbar[5], (&(((half_t*)V_shared)[0])), 0, (k * 64), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[5], (&(((half_t*)V_shared)[4096])), 64, (k * 64), (((int)blockIdx.y) >> 3), 0);
      }
      #pragma unroll
      ...
      if (k == 63) {
        ...
        for (int i_7 = 0; i_7 < 32; ++i_7) {
          *(float2*)(((float*)acc_o_wsp_handoff_6) + ((((((((int)threadIdx.x) >> 5) * 2048) + ((i_7 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_7 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(acc_o + (i_7 * 2));
        }
      }
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    for (int k_1 = 0; k_1 < 64; ++k_1) {
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
      ...
      for (int i_8 = 0; i_8 < 16; ++i_8) {
        *(float2*)(acc_s + (i_8 * 2)) = *(float2*)(((float*)acc_s_wsp_handoff_2) + (((((((((int)threadIdx.x) >> 5) * 1024) + ((i_8 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_8 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 8192));
      }
      #pragma unroll
      for (int i_9 = 0; i_9 < 2; ++i_9) {
        ...
        for (int rv = 0; rv < 16; ++rv) {
          scores_max_clear[i_9] = max(scores_max_clear[i_9], acc_s[((((rv & 7) * 4) + (i_9 * 2)) + (rv >> 3))]);
        }
        scores_max_clear[i_9] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_max_clear[i_9]);
      ...
      if ((((int)threadIdx.x) % 4) == 0) {
        ...
        for (int i_12 = 0; i_12 < 2; ++i_12) {
          ((float*)scores_scale_wsp_handoff_3)[(((((((int)threadIdx.x) >> 5) * 16) + (i_12 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) - 128)] = scores_scale[i_12];
        }
      }
      tl::fence_proxy_async();
      ...
      for (int i_14 = 0; i_14 < 16; ++i_14) {
        *(float2*)(((float*)acc_s_wsp_handoff_4) + (((((((((int)threadIdx.x) >> 5) * 1024) + ((i_14 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_14 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 8192)) = *(float2*)(acc_s + (i_14 * 2));
      }
      tl::fence_proxy_async();
    ...
    for (int i_17 = 0; i_17 < 32; ++i_17) {
      *(float2*)(acc_o + (i_17 * 2)) = *(float2*)(((float*)acc_o_wsp_handoff_6) + (((((((((int)threadIdx.x) >> 5) * 2048) + ((i_17 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_17 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 16384));
    }
    #pragma unroll
    for (int i_18 = 0; i_18 < 64; ++i_18) {
      acc_o[i_18] = (acc_o[i_18] / logsum[((i_18 & 3) >> 1)]);
    }
    #pragma unroll
    for (int i_19 = 0; i_19 < 8; ++i_19) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)O_shared)[(((((i_19 >> 2) * 8192) + (((((int)threadIdx.x) & 255) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_19 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_19 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_o[(i_19 * 8)]), ((half_t)acc_o[((i_19 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_19 * 8) + 2)]), ((half_t)acc_o[((i_19 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_19 * 8) + 4)]), ((half_t)acc_o[((i_19 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_19 * 8) + 6)]), ((half_t)acc_o[((i_19 * 8) + 7)])));
    }
    tl::fence_proxy_async();
