    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int k_1 = 0; k_1 < 64; ++k_1) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 8)) {
        ...
        tl::tma_load(K_desc, overlap_plan_mbar[((k_1 & 1) + 1)], (&(((half_t*)K_shared)[((k_1 & 1) * 8192)])), 0, (k_1 * 64), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[((k_1 & 1) + 1)], (&(((half_t*)K_shared)[(((k_1 & 1) * 8192) + 4096)])), 64, (k_1 * 64), (((int)blockIdx.y) >> 3), 0);
      }
      if (2 <= k_1) {
        overlap_plan_mbar[((k_1 & 1) + 8)].wait((((k_1 >> 1) + 1) & 1));
      }
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 8)) {
        overlap_plan_mbar[((k_1 & 1) + 4)].arrive_and_expect_tx(16384);
        tl::tma_load(V_desc, overlap_plan_mbar[((k_1 & 1) + 4)], (&(((half_t*)V_shared)[((k_1 & 1) * 8192)])), 0, (k_1 * 64), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[((k_1 & 1) + 4)], (&(((half_t*)V_shared)[(((k_1 & 1) * 8192) + 4096)])), 64, (k_1 * 64), (((int)blockIdx.y) >> 3), 0);
      }
      #pragma unroll
      ...
      overlap_plan_mbar[((k_1 & 1) + 1)].wait(((k_1 & 3) >> 1));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_2, ((k_1 & 1) * 16384));
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 64);
        tl::warpgroup_arrive();
        #pragma unroll
        for (int ki_2 = 0; ki_2 < 8; ++ki_2) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, false, 1, 1>(uint64_t(desc_a + (((((ki_2 >> 2) * 16384) + (((((int)threadIdx.x) & 255) >> 7) * 8192)) + ((ki_2 & 3) * 32)) >> 4)), uint64_t(desc_b_2 + ((((ki_2 >> 2) * 8192) + ((ki_2 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + 0)), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 64);
      ...
      for (int i_22 = 0; i_22 < 16; ++i_22) {
        *(float2*)(((float*)acc_s_wsp_handoff_2) + (((((((((int)threadIdx.x) >> 5) * 1024) + ((i_22 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_22 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 8192)) = *(float2*)(acc_s + (i_22 * 2));
      }
      tl::fence_proxy_async();
