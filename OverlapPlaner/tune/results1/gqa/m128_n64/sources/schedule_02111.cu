  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    ...
    for (int k_1 = 0; k_1 < 63; ++k_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 8)) {
        overlap_plan_mbar[(((k_1 + 1) & 1) + 1)].arrive_and_expect_tx(16384);
        tl::tma_load(K_desc, overlap_plan_mbar[(((k_1 + 1) & 1) + 1)], (&(((half_t*)K_shared)[(((k_1 + 1) & 1) * 8192)])), 0, ((k_1 * 64) + 64), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[(((k_1 + 1) & 1) + 1)], (&(((half_t*)K_shared)[((((k_1 + 1) & 1) * 8192) + 4096)])), 64, ((k_1 * 64) + 64), (((int)blockIdx.y) >> 3), 0);
      }
      if (2 <= k_1) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 8)) {
      ...
      tl::tma_load(V_desc, overlap_plan_mbar[4], (&(((half_t*)V_shared)[8192])), 0, 4032, (((int)blockIdx.y) >> 3), 0);
      tl::tma_load(V_desc, overlap_plan_mbar[4], (&(((half_t*)V_shared)[12288])), 64, 4032, (((int)blockIdx.y) >> 3), 0);
    }
  }
}
