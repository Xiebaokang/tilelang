  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int k = 0; k < 31; ++k) {
      ...
      overlap_plan_mbar[((((k * 2) + 1) % 3) + 1)].wait(((((k % 3) * 2) + 1) / 3));
      {
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
      ...
      overlap_plan_mbar[((((k * 2) + 2) % 3) + 1)].wait(((((k * 2) + 2) % 6) / 3));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_3, ((((k * 2) + 2) % 3) * 16384));
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 64);
        tl::warpgroup_arrive();
        #pragma unroll
      ...
      overlap_plan_mbar[((((k * 2) + 2) % 3) + 6)].arrive();
      *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
    ...
    for (int k_1 = 0; k_1 < 64; ++k_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 8)) {
        overlap_plan_mbar[((k_1 % 3) + 1)].arrive_and_expect_tx(16384);
        tl::tma_load(K_desc, overlap_plan_mbar[((k_1 % 3) + 1)], (&(((half_t*)K_shared)[((k_1 % 3) * 8192)])), 0, (k_1 * 64), (((int)blockIdx.y) >> 3), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[((k_1 % 3) + 1)], (&(((half_t*)K_shared)[(((k_1 % 3) * 8192) + 4096)])), 64, (k_1 * 64), (((int)blockIdx.y) >> 3), 0);
      }
      if (2 <= k_1) {
