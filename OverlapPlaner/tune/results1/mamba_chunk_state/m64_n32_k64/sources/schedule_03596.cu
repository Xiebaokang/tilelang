...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  for (int ik = 0; ik < 2; ++ik) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      overlap_plan_mbar[(ik + 5)].arrive_and_expect_tx(4096);
      tl::tma_load(B_desc, overlap_plan_mbar[(ik + 5)], (&(((half_t*)b_shared)[((ik * 2048) + 2048)])), (((int)blockIdx.y) * 32), ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 64), 0, (((int)blockIdx.z) & 7));
    }
    ...
    overlap_plan_mbar[10].arrive();
    overlap_plan_mbar[((ik + 1) & 1)].wait(((ik + 1) >> 1));
    #pragma unroll
    for (int i_11 = 0; i_11 < 32; ++i_11) {
      x_local[i_11] = ((half_t*)x_shared)[((((((((((ik + 1) & 1) * 4096) + ((i_11 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_11 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_11 & 3) >> 1) + (i_11 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
    }
    overlap_plan_mbar[(((ik + 1) & 1) + 7)].arrive();
    if (ik == 0) {
      #pragma unroll
    ...
    if (((ik + 1) % 2) == 0) {
      ...
      for (int i_14 = 0; i_14 < 32; ++i_14) {
        xt_local[i_14] = ((half_t)(((float)x_local[((((i_14 >> 2) * 4) + ((i_14 & 1) * 2)) + ((i_14 & 3) >> 1))]) * scale_v0[(((i_14 >> 2) * 2) + (i_14 & 1))]));
      }
    } else {
      #pragma unroll
      for (int i_15 = 0; i_15 < 32; ++i_15) {
        xt_local[i_15] = ((half_t)(((float)x_local[((((i_15 >> 2) * 4) + ((i_15 & 1) * 2)) + ((i_15 & 3) >> 1))]) * scale_v1[(((i_15 >> 2) * 2) + (i_15 & 1))]));
      }
    }
  }
  ...
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    overlap_plan_mbar[4].arrive_and_expect_tx(4096);
    tl::tma_load(B_desc, overlap_plan_mbar[4], (&(((half_t*)b_shared)[0])), (((int)blockIdx.y) * 32), (((((int)blockIdx.z) >> 3) * 256) + 192), 0, (((int)blockIdx.z) & 7));
  }
  ...
  for (int i_16 = 0; i_16 < 32; ++i_16) {
    x_local[i_16] = ((half_t*)x_shared)[(((((((((i_16 >> 2) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_16 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_16 & 3) >> 1) + (i_16 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) + 4096)];
  }
  overlap_plan_mbar[8].arrive();
  #pragma unroll
  for (int i_17 = 0; i_17 < 32; ++i_17) {
    xt_local[i_17] = ((half_t)(((float)x_local[((((i_17 >> 2) * 4) + ((i_17 & 1) * 2)) + ((i_17 & 3) >> 1))]) * scale_v1[(((i_17 >> 2) * 2) + (i_17 & 1))]));
  }
