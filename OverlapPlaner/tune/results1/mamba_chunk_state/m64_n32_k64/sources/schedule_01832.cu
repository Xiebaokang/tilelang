...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load((&(((half_t*)dt_shared)[0])), (&(Dt[((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256))])), overlap_plan_mbar[3], 128);
    }
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[2].arrive_and_expect_tx(128);
      tl::tma_load((&(((half_t*)da_shared)[0])), (&(DA[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + 64)])), overlap_plan_mbar[2], 128);
    }
    overlap_plan_mbar[14].wait(0);
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[3].arrive_and_expect_tx(128);
      tl::tma_load((&(((half_t*)dt_shared)[0])), (&(Dt[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + 64)])), overlap_plan_mbar[3], 128);
    }
    ...
    for (int ik = 0; ik < 2; ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[ik].arrive_and_expect_tx(8192);
        tl::tma_load(X_desc, overlap_plan_mbar[ik], (&(((half_t*)x_shared)[(ik * 4096)])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 128), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
      overlap_plan_mbar[13].wait(((ik + 1) & 1));
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[2].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)da_shared)[0])), (&(DA[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 64)) + 128)])), overlap_plan_mbar[2], 128);
      }
      overlap_plan_mbar[14].wait(((ik + 1) & 1));
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[3].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)dt_shared)[0])), (&(Dt[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 64)) + 128)])), overlap_plan_mbar[3], 128);
      }
      ...
      if (((ik + 2) % 3) == 0) {
        ...
        if (((((((int)threadIdx.x) & 31) >> 2) * 4) + (((int)threadIdx.x) >> 5)) == 0) {
          ...
          for (int i_12 = 0; i_12 < 8; ++i_12) {
            *(float2*)(((float*)scale_wsp_handoff_3) + (((((ik + 2) % 3) * 64) + (i_12 * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(scale_v0 + (i_12 * 2));
          }
        }
      } else {
        if (((ik + 2) % 3) == 1) {
          ...
          for (int i_14 = 0; i_14 < 16; ++i_14) {
            ((float*)scale_wsp_handoff_3)[((((((ik + 2) % 3) * 64) + ((i_14 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_14 & 1))] = scale_v1[i_14];
          }
        } else {
          #pragma unroll
          for (int i_15 = 0; i_15 < 16; ++i_15) {
            scale_v2[i_15] = (exp2f(((da_last[0] - da_local[i_15]) * 0x1.7154764ee6c2fp+0f/*1.442695e+00*/)) * dt_local[i_15]);
          }
          if (((((((int)threadIdx.x) & 31) >> 2) * 4) + (((int)threadIdx.x) >> 5)) == 0) {
            #pragma unroll
            for (int i_16 = 0; i_16 < 8; ++i_16) {
              *(float2*)(((float*)scale_wsp_handoff_3) + (((((ik + 2) % 3) * 64) + (i_16 * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(scale_v2 + (i_16 * 2));
            }
          }
        }
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[(((ik + 2) % 3) + 4)].arrive();
      if (ik == 1) {
        overlap_plan_mbar[(ik + 14)].wait(0);
      }
      tl::__sync_thread_partial(3, 128);
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[(((ik + 1) & 1) + 8)].arrive_and_expect_tx(4096);
        tl::tma_load(B_desc, overlap_plan_mbar[(((ik + 1) & 1) + 8)], (&(((half_t*)b_shared)[(((ik + 1) & 1) * 2048)])), (((int)blockIdx.y) * 32), ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 64), 0, (((int)blockIdx.z) & 7));
      }
      overlap_plan_mbar[7].wait(ik);
      overlap_plan_mbar[(ik + 8)].wait(0);
      #pragma unroll
      for (int i_17 = 0; i_17 < 4; ++i_17) {
        tl::ptx_ldmatrix_x4((&(((half_t*)xt_local_wsp_handoff_4)[(((((((int)threadIdx.x) >> 5) * 1024) + ((((int)threadIdx.x) & 15) * 64)) + (i_17 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), (&(xt_local[(i_17 * 8)])));
      }
      {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(B_desc, overlap_plan_mbar[9], (&(((half_t*)b_shared)[2048])), (((int)blockIdx.y) * 32), (((((int)blockIdx.z) >> 3) * 256) + 192), 0, (((int)blockIdx.z) & 7));
    }
    overlap_plan_mbar[7].wait(0);
    overlap_plan_mbar[8].wait(1);
    #pragma unroll
    for (int i_18 = 0; i_18 < 4; ++i_18) {
      tl::ptx_ldmatrix_x4((&(((half_t*)xt_local_wsp_handoff_4)[(((((((int)threadIdx.x) >> 5) * 1024) + ((((int)threadIdx.x) & 15) * 64)) + (i_18 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), (&(xt_local[(i_18 * 8)])));
    }
    {
    ...
    for (int i_19 = 0; i_19 < 4; ++i_19) {
      tl::ptx_ldmatrix_x4((&(((half_t*)xt_local_wsp_handoff_4)[(((((((int)threadIdx.x) >> 5) * 1024) + ((((int)threadIdx.x) & 15) * 64)) + (i_19 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), (&(xt_local[(i_19 * 8)])));
    }
    {
      ...
      for (int ki_2 = 0; ki_2 < 4; ++ki_2) {
        tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(xt_local + (ki_2 * 8)), uint64_t(desc_b_2 + ((ki_2 * 1024) >> 4)), reinterpret_cast<uint32_t*>(acc + 0), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 16);
    ...
    for (int i_20 = 0; i_20 < 2; ++i_20) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + i_20) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(((half_t)acc[(i_20 * 8)]), ((half_t)acc[((i_20 * 8) + 1)])), __pack_half2(((half_t)acc[((i_20 * 8) + 2)]), ((half_t)acc[((i_20 * 8) + 3)])), __pack_half2(((half_t)acc[((i_20 * 8) + 4)]), ((half_t)acc[((i_20 * 8) + 5)])), __pack_half2(((half_t)acc[((i_20 * 8) + 6)]), ((half_t)acc[((i_20 * 8) + 7)])));
    }
    tl::fence_proxy_async();
    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int i_21 = 0; i_21 < 32; ++i_21) {
        x_local_v0[i_21] = ((half_t*)x_shared)[((((((((i_21 >> 2) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_21 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_21 & 3) >> 1) + (i_21 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
      }
      overlap_plan_mbar[11].arrive();
      overlap_plan_mbar[1].wait(0);
      #pragma unroll
      for (int i_22 = 0; i_22 < 32; ++i_22) {
        x_local_v1[i_22] = ((half_t*)x_shared)[(((((((((i_22 >> 2) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_22 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_22 & 3) >> 1) + (i_22 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) + 4096)];
      }
      overlap_plan_mbar[12].arrive();
      for (int ik_1 = 0; ik_1 < 2; ++ik_1) {
        overlap_plan_mbar[ik_1].wait(1);
        if (((ik_1 + 2) % 3) == 0) {
          #pragma unroll
          for (int i_23 = 0; i_23 < 32; ++i_23) {
            x_local_v0[i_23] = ((half_t*)x_shared)[((((((((ik_1 * 4096) + ((i_23 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_23 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_23 & 3) >> 1) + (i_23 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
          }
        } else {
          if (((ik_1 + 2) % 3) == 1) {
            #pragma unroll
            for (int i_24 = 0; i_24 < 32; ++i_24) {
              x_local_v1[i_24] = ((half_t*)x_shared)[((((((((ik_1 * 4096) + ((i_24 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_24 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_24 & 3) >> 1) + (i_24 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
            }
          } else {
            #pragma unroll
            for (int i_25 = 0; i_25 < 32; ++i_25) {
              x_local_v2[i_25] = ((half_t*)x_shared)[((((((((ik_1 * 4096) + ((i_25 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_25 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_25 & 3) >> 1) + (i_25 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
            }
          }
        }
        overlap_plan_mbar[(ik_1 + 11)].arrive();
        overlap_plan_mbar[(ik_1 + 4)].wait(0);
        tl::__sync_thread_partial(4, 128);
        if (ik_1 == 0) {
          #pragma unroll
          for (int i_26 = 0; i_26 < 8; ++i_26) {
            *(float2*)(scale_v0 + (i_26 * 2)) = *(float2*)(((float*)scale_wsp_handoff_3) + (((ik_1 * 64) + (i_26 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
          }
          #pragma unroll
          for (int i_27 = 0; i_27 < 32; ++i_27) {
            xt_local[i_27] = ((half_t)(((float)x_local_v0[((((i_27 >> 2) * 4) + ((i_27 & 1) * 2)) + ((i_27 & 3) >> 1))]) * scale_v0[(((i_27 >> 2) * 2) + (i_27 & 1))]));
          }
          #pragma unroll
          for (int i_28 = 0; i_28 < 4; ++i_28) {
            tl::ptx_stmatrix_m8n8_x4((&(((half_t*)xt_local_wsp_handoff_4)[((((((((int)threadIdx.x) >> 5) * 1024) + ((((int)threadIdx.x) & 15) * 64)) + (i_28 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 4096)])), __pack_half2(xt_local[(i_28 * 8)], xt_local[((i_28 * 8) + 1)]), __pack_half2(xt_local[((i_28 * 8) + 2)], xt_local[((i_28 * 8) + 3)]), __pack_half2(xt_local[((i_28 * 8) + 4)], xt_local[((i_28 * 8) + 5)]), __pack_half2(xt_local[((i_28 * 8) + 6)], xt_local[((i_28 * 8) + 7)]));
          }
        } else {
          #pragma unroll
          for (int i_29 = 0; i_29 < 8; ++i_29) {
            *(float2*)(scale_v1 + (i_29 * 2)) = *(float2*)(((float*)scale_wsp_handoff_3) + (((ik_1 * 64) + (i_29 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
          }
          #pragma unroll
          for (int i_30 = 0; i_30 < 32; ++i_30) {
            xt_local[i_30] = ((half_t)(((float)x_local_v1[((((i_30 >> 2) * 4) + ((i_30 & 1) * 2)) + ((i_30 & 3) >> 1))]) * scale_v1[(((i_30 >> 2) * 2) + (i_30 & 1))]));
          }
          #pragma unroll
          for (int i_31 = 0; i_31 < 4; ++i_31) {
            tl::ptx_stmatrix_m8n8_x4((&(((half_t*)xt_local_wsp_handoff_4)[((((((((int)threadIdx.x) >> 5) * 1024) + ((((int)threadIdx.x) & 15) * 64)) + (i_31 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 4096)])), __pack_half2(xt_local[(i_31 * 8)], xt_local[((i_31 * 8) + 1)]), __pack_half2(xt_local[((i_31 * 8) + 2)], xt_local[((i_31 * 8) + 3)]), __pack_half2(xt_local[((i_31 * 8) + 4)], xt_local[((i_31 * 8) + 5)]), __pack_half2(xt_local[((i_31 * 8) + 6)], xt_local[((i_31 * 8) + 7)]));
          }
        }
        tl::fence_proxy_async();
      ...
      for (int i_32 = 0; i_32 < 8; ++i_32) {
        *(float2*)(scale_v2 + (i_32 * 2)) = *(float2*)(((float*)scale_wsp_handoff_3) + (((i_32 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 128));
      }
      #pragma unroll
      for (int i_33 = 0; i_33 < 32; ++i_33) {
        xt_local[i_33] = ((half_t)(((float)x_local_v2[((((i_33 >> 2) * 4) + ((i_33 & 1) * 2)) + ((i_33 & 3) >> 1))]) * scale_v2[(((i_33 >> 2) * 2) + (i_33 & 1))]));
      }
      tl::__sync_thread_partial(4, 128);
      #pragma unroll
      for (int i_34 = 0; i_34 < 4; ++i_34) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)xt_local_wsp_handoff_4)[((((((((int)threadIdx.x) >> 5) * 1024) + ((((int)threadIdx.x) & 15) * 64)) + (i_34 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 4096)])), __pack_half2(xt_local[(i_34 * 8)], xt_local[((i_34 * 8) + 1)]), __pack_half2(xt_local[((i_34 * 8) + 2)], xt_local[((i_34 * 8) + 3)]), __pack_half2(xt_local[((i_34 * 8) + 4)], xt_local[((i_34 * 8) + 5)]), __pack_half2(xt_local[((i_34 * 8) + 6)], xt_local[((i_34 * 8) + 7)]));
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[7].arrive();
      ...
      for (int i_35 = 0; i_35 < 8; ++i_35) {
        *(float2*)(scale_v0 + (i_35 * 2)) = *(float2*)(((float*)scale_wsp_handoff_3) + ((i_35 * 8) + ((((int)threadIdx.x) & 3) * 2)));
      }
      #pragma unroll
      for (int i_36 = 0; i_36 < 32; ++i_36) {
        xt_local[i_36] = ((half_t)(((float)x_local_v0[((((i_36 >> 2) * 4) + ((i_36 & 1) * 2)) + ((i_36 & 3) >> 1))]) * scale_v0[(((i_36 >> 2) * 2) + (i_36 & 1))]));
      }
      tl::__sync_thread_partial(4, 128);
      #pragma unroll
      for (int i_37 = 0; i_37 < 4; ++i_37) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)xt_local_wsp_handoff_4)[((((((((int)threadIdx.x) >> 5) * 1024) + ((((int)threadIdx.x) & 15) * 64)) + (i_37 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 4096)])), __pack_half2(xt_local[(i_37 * 8)], xt_local[((i_37 * 8) + 1)]), __pack_half2(xt_local[((i_37 * 8) + 2)], xt_local[((i_37 * 8) + 3)]), __pack_half2(xt_local[((i_37 * 8) + 4)], xt_local[((i_37 * 8) + 5)]), __pack_half2(xt_local[((i_37 * 8) + 6)], xt_local[((i_37 * 8) + 7)]));
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[7].arrive();
    } else {
