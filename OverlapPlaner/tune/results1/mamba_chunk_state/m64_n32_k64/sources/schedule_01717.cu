...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* scale_wsp_handoff_3 = ((void*)((char*)buf_dyn_shmem + 53248));
  void* da_shared = ((void*)((char*)buf_dyn_shmem + 54272));
  void* dt_shared = ((void*)((char*)buf_dyn_shmem + 55296));
  void* acc_shared = ((void*)((char*)buf_dyn_shmem + 56320));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    if (((int)threadIdx.x) < 256) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        ...
        tl::tma_load(B_desc, overlap_plan_mbar[10], (&(((half_t*)b_shared)[2048])), (((int)blockIdx.y) * 32), (((((int)blockIdx.z) >> 3) * 256) + 64), 0, (((int)blockIdx.z) & 7));
      }
      for (int ik = 0; ik < 2; ++ik) {
        ...
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          ...
          tl::tma_load(B_desc, overlap_plan_mbar[(((ik + 2) % 3) + 9)], (&(((half_t*)b_shared)[(((ik + 2) % 3) * 2048)])), (((int)blockIdx.y) * 32), ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 128), 0, (((int)blockIdx.z) & 7));
        }
      ...
      for (int i_19 = 0; i_19 < 2; ++i_19) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((((int)threadIdx.x) & 127) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + i_19) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(((half_t)acc[(i_19 * 8)]), ((half_t)acc[((i_19 * 8) + 1)])), __pack_half2(((half_t)acc[((i_19 * 8) + 2)]), ((half_t)acc[((i_19 * 8) + 3)])), __pack_half2(((half_t)acc[((i_19 * 8) + 4)]), ((half_t)acc[((i_19 * 8) + 5)])), __pack_half2(((half_t)acc[((i_19 * 8) + 6)]), ((half_t)acc[((i_19 * 8) + 7)])));
      }
      tl::fence_proxy_async();
