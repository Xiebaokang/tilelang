  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 4; ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>()) {
        ...
        tl::tma_load(B_desc, mbarrier[((ik & 1) + 6)], (&(((half_t*)b_shared)[((ik & 1) * 2048)])), (((int)blockIdx.y) * 32), (((((int)blockIdx.z) >> 3) * 256) + (ik * 64)), 0, (((int)blockIdx.z) & 7));
      }
    }
  } else {
    ...
    for (int i_6 = 0; i_6 < 2; ++i_6) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((((int)threadIdx.x) & 127) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + i_6) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(((half_t)acc[(i_6 * 8)]), ((half_t)acc[((i_6 * 8) + 1)])), __pack_half2(((half_t)acc[((i_6 * 8) + 2)]), ((half_t)acc[((i_6 * 8) + 3)])), __pack_half2(((half_t)acc[((i_6 * 8) + 4)]), ((half_t)acc[((i_6 * 8) + 5)])), __pack_half2(((half_t)acc[((i_6 * 8) + 6)]), ((half_t)acc[((i_6 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 128);
    if (tl::tl_shuffle_elect<128>()) {
