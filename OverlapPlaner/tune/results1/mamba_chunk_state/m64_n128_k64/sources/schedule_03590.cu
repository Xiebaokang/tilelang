  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 4; ++ik) {
      ...
      for (int i_1 = 0; i_1 < 8; ++i_1) {
        ...
        *(uint1*)(da_shared_local_cast + 0) = *(uint1*)(((half_t*)da_shared) + ((((ik % 3) * 64) + (i_1 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __1;
      ...
      for (int i_2 = 0; i_2 < 8; ++i_2) {
        ...
        *(uint1*)(dt_shared_local_cast_1 + 0) = *(uint1*)(((half_t*)dt_shared) + ((((ik % 3) * 64) + (i_2 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __2;
      ...
      overlap_plan_mbar[(ik % 3)].wait((ik / 3));
      #pragma unroll
      for (int i_3 = 0; i_3 < 32; ++i_3) {
        x_local[i_3] = ((half_t*)x_shared)[(((((((((ik % 3) * 4096) + ((i_3 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_3 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_3 & 3) >> 1) + (i_3 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
      }
      ...
      overlap_plan_mbar[((ik % 3) + 9)].wait((ik / 3));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b, ((ik % 3) * 16384));
      ...
      overlap_plan_mbar[((ik % 3) + 21)].arrive();
    }
    #pragma unroll
