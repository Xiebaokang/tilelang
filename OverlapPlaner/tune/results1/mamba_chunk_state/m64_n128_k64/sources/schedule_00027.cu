  ...
  for (int ik = 0; ik < 2; ++ik) {
    ...
    if (ik == 0) {
      ...
      for (int i_15 = 0; i_15 < 32; ++i_15) {
        x_local_v1[i_15] = ((half_t*)x_shared)[((((((((i_15 >> 2) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_15 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_15 & 3) >> 1) + (i_15 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
      }
    }
    overlap_plan_mbar[6].arrive();
    if (((ik + 1) % 2) == 0) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[(((ik + 2) % 3) + 3)].arrive_and_expect_tx(16384);
      tl::tma_load(B_desc, overlap_plan_mbar[(((ik + 2) % 3) + 3)], (&(((half_t*)b_shared)[(((ik + 2) % 3) * 8192)])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 128), 0, (((int)blockIdx.z) & 7));
      tl::tma_load(B_desc, overlap_plan_mbar[(((ik + 2) % 3) + 3)], (&(((half_t*)b_shared)[((((ik + 2) % 3) * 8192) + 4096)])), 64, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 128), 0, (((int)blockIdx.z) & 7));
    }
