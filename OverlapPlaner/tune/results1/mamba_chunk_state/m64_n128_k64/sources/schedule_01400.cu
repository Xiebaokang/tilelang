...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap X_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int i_9 = 0; i_9 < 32; ++i_9) {
      x_local_v1[i_9] = ((half_t*)x_shared)[(((((((((i_9 >> 2) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_9 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_9 & 3) >> 1) + (i_9 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) + 4096)];
    }
    overlap_plan_mbar[13].arrive();
    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int ik_1 = 0; ik_1 < 2; ++ik_1) {
        ...
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          overlap_plan_mbar[ik_1].arrive_and_expect_tx(8192);
          tl::tma_load(X_desc, overlap_plan_mbar[ik_1], (&(((half_t*)x_shared)[(ik_1 * 4096)])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)) + 128), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
        }
        overlap_plan_mbar[14].wait(((ik_1 + 1) & 1));
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          overlap_plan_mbar[2].arrive_and_expect_tx(128);
          tl::tma_load((&(((half_t*)da_shared)[0])), (&(DA[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik_1 * 64)) + 128)])), overlap_plan_mbar[2], 128);
        }
        overlap_plan_mbar[15].wait(((ik_1 + 1) & 1));
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          overlap_plan_mbar[3].arrive_and_expect_tx(128);
          tl::tma_load((&(((half_t*)dt_shared)[0])), (&(Dt[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik_1 * 64)) + 128)])), overlap_plan_mbar[3], 128);
        }
        ...
        tl::fence_proxy_async();
        overlap_plan_mbar[(ik_1 + 4)].arrive();
        if (ik_1 == 1) {
          overlap_plan_mbar[(ik_1 + 15)].wait(0);
        }
        tl::__sync_thread_partial(4, 128);
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          overlap_plan_mbar[(((ik_1 + 2) % 3) + 8)].arrive_and_expect_tx(16384);
          tl::tma_load(B_desc, overlap_plan_mbar[(((ik_1 + 2) % 3) + 8)], (&(((half_t*)b_shared)[(((ik_1 + 2) % 3) * 8192)])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)) + 128), 0, (((int)blockIdx.z) & 7));
          tl::tma_load(B_desc, overlap_plan_mbar[(((ik_1 + 2) % 3) + 8)], (&(((half_t*)b_shared)[((((ik_1 + 2) % 3) * 8192) + 4096)])), 64, ((((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)) + 128), 0, (((int)blockIdx.z) & 7));
        }
        ...
        overlap_plan_mbar[(ik_1 + 16)].arrive();
      }
