...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* scale_wsp_handoff_3 = ((void*)((char*)buf_dyn_shmem + 57344));
  void* da_shared = ((void*)((char*)buf_dyn_shmem + 58368));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 3; ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((ik + 1) & 1)].arrive_and_expect_tx(8192);
        tl::tma_load(X_desc, overlap_plan_mbar[((ik + 1) & 1)], (&(((half_t*)x_shared)[(((ik + 1) & 1) * 4096)])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 64), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
      overlap_plan_mbar[12].wait((ik & 1));
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[2].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)da_shared)[0])), (&(DA[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 64)) + 64)])), overlap_plan_mbar[2], 128);
      }
      overlap_plan_mbar[13].wait((ik & 1));
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[3].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)dt_shared)[0])), (&(Dt[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 64)) + 64)])), overlap_plan_mbar[3], 128);
      }
      ...
      if (((ik + 1) % 2) == 0) {
        ...
        if (((((((int)threadIdx.x) & 31) >> 2) * 4) + (((int)threadIdx.x) >> 5)) == 0) {
          ...
          for (int i_8 = 0; i_8 < 8; ++i_8) {
            *(float2*)(((float*)scale_wsp_handoff_3) + (((((ik + 1) & 1) * 64) + (i_8 * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(scale_v0 + (i_8 * 2));
          }
        }
      } else {
        #pragma unroll
        ...
        if (((((((int)threadIdx.x) & 31) >> 2) * 4) + (((int)threadIdx.x) >> 5)) == 0) {
          ...
          for (int i_10 = 0; i_10 < 8; ++i_10) {
            *(float2*)(((float*)scale_wsp_handoff_3) + (((((ik + 1) & 1) * 64) + (i_10 * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(scale_v1 + (i_10 * 2));
          }
        }
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[(((ik + 1) & 1) + 4)].arrive();
      if (1 <= ik) {
        overlap_plan_mbar[(ik + 13)].wait(0);
      }
      tl::__sync_thread_partial(3, 128);
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[(((ik + 1) & 1) + 7)].arrive_and_expect_tx(16384);
        tl::tma_load(B_desc, overlap_plan_mbar[(((ik + 1) & 1) + 7)], (&(((half_t*)b_shared)[(((ik + 1) & 1) * 8192)])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 64), 0, (((int)blockIdx.z) & 7));
        tl::tma_load(B_desc, overlap_plan_mbar[(((ik + 1) & 1) + 7)], (&(((half_t*)b_shared)[((((ik + 1) & 1) * 8192) + 4096)])), 64, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 64), 0, (((int)blockIdx.z) & 7));
      }
      overlap_plan_mbar[6].wait((ik & 1));
      overlap_plan_mbar[((ik & 1) + 7)].wait((ik >> 1));
      #pragma unroll
      for (int i_11 = 0; i_11 < 4; ++i_11) {
        tl::ptx_ldmatrix_x4((&(((half_t*)xt_local_wsp_handoff_4)[(((((((int)threadIdx.x) >> 5) * 1024) + ((((int)threadIdx.x) & 15) * 64)) + (i_11 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), (&(xt_local[(i_11 * 8)])));
      }
      {
    ...
    for (int i_12 = 0; i_12 < 4; ++i_12) {
      tl::ptx_ldmatrix_x4((&(((half_t*)xt_local_wsp_handoff_4)[(((((((int)threadIdx.x) >> 5) * 1024) + ((((int)threadIdx.x) & 15) * 64)) + (i_12 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), (&(xt_local[(i_12 * 8)])));
    }
    {
    ...
    for (int i_13 = 0; i_13 < 8; ++i_13) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((((int)threadIdx.x) >> 5) * 2048) + ((((int)threadIdx.x) & 15) * 128)) + (i_13 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(((half_t)acc[(i_13 * 8)]), ((half_t)acc[((i_13 * 8) + 1)])), __pack_half2(((half_t)acc[((i_13 * 8) + 2)]), ((half_t)acc[((i_13 * 8) + 3)])), __pack_half2(((half_t)acc[((i_13 * 8) + 4)]), ((half_t)acc[((i_13 * 8) + 5)])), __pack_half2(((half_t)acc[((i_13 * 8) + 6)]), ((half_t)acc[((i_13 * 8) + 7)])));
    }
    tl::fence_proxy_async();
    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int ik_1 = 0; ik_1 < 1; ++ik_1) {
        ...
        for (int i_15 = 0; i_15 < 32; ++i_15) {
          x_local_v1[i_15] = ((half_t*)x_shared)[(((((((((i_15 >> 2) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_15 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_15 & 3) >> 1) + (i_15 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) + 4096)];
        }
        ...
        for (int i_18 = 0; i_18 < 4; ++i_18) {
          tl::ptx_stmatrix_m8n8_x4((&(((half_t*)xt_local_wsp_handoff_4)[((((((((int)threadIdx.x) >> 5) * 1024) + ((((int)threadIdx.x) & 15) * 64)) + (i_18 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 4096)])), __pack_half2(xt_local[(i_18 * 8)], xt_local[((i_18 * 8) + 1)]), __pack_half2(xt_local[((i_18 * 8) + 2)], xt_local[((i_18 * 8) + 3)]), __pack_half2(xt_local[((i_18 * 8) + 4)], xt_local[((i_18 * 8) + 5)]), __pack_half2(xt_local[((i_18 * 8) + 6)], xt_local[((i_18 * 8) + 7)]));
        }
        tl::fence_proxy_async();
        ...
        for (int i_19 = 0; i_19 < 32; ++i_19) {
          x_local_v0[i_19] = ((half_t*)x_shared)[((((((((i_19 >> 2) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_19 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_19 & 3) >> 1) + (i_19 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
        }
        overlap_plan_mbar[10].arrive();
        overlap_plan_mbar[5].wait(0);
        #pragma unroll
        for (int i_20 = 0; i_20 < 8; ++i_20) {
          *(float2*)(scale_v1 + (i_20 * 2)) = *(float2*)(((float*)scale_wsp_handoff_3) + (((i_20 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 64));
        }
        #pragma unroll
        ...
        for (int i_22 = 0; i_22 < 4; ++i_22) {
          tl::ptx_stmatrix_m8n8_x4((&(((half_t*)xt_local_wsp_handoff_4)[((((((((int)threadIdx.x) >> 5) * 1024) + ((((int)threadIdx.x) & 15) * 64)) + (i_22 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 4096)])), __pack_half2(xt_local[(i_22 * 8)], xt_local[((i_22 * 8) + 1)]), __pack_half2(xt_local[((i_22 * 8) + 2)], xt_local[((i_22 * 8) + 3)]), __pack_half2(xt_local[((i_22 * 8) + 4)], xt_local[((i_22 * 8) + 5)]), __pack_half2(xt_local[((i_22 * 8) + 6)], xt_local[((i_22 * 8) + 7)]));
        }
        tl::fence_proxy_async();
        overlap_plan_mbar[6].arrive();
      }
      ...
      for (int i_23 = 0; i_23 < 32; ++i_23) {
        x_local_v1[i_23] = ((half_t*)x_shared)[(((((((((i_23 >> 2) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_23 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_23 & 3) >> 1) + (i_23 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) + 4096)];
      }
      overlap_plan_mbar[11].arrive();
      ...
      for (int i_26 = 0; i_26 < 4; ++i_26) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)xt_local_wsp_handoff_4)[((((((((int)threadIdx.x) >> 5) * 1024) + ((((int)threadIdx.x) & 15) * 64)) + (i_26 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 4096)])), __pack_half2(xt_local[(i_26 * 8)], xt_local[((i_26 * 8) + 1)]), __pack_half2(xt_local[((i_26 * 8) + 2)], xt_local[((i_26 * 8) + 3)]), __pack_half2(xt_local[((i_26 * 8) + 4)], xt_local[((i_26 * 8) + 5)]), __pack_half2(xt_local[((i_26 * 8) + 6)], xt_local[((i_26 * 8) + 7)]));
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[6].arrive();
      ...
      for (int i_27 = 0; i_27 < 8; ++i_27) {
        *(float2*)(scale_v1 + (i_27 * 2)) = *(float2*)(((float*)scale_wsp_handoff_3) + (((i_27 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 64));
      }
      #pragma unroll
      ...
      for (int i_29 = 0; i_29 < 4; ++i_29) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)xt_local_wsp_handoff_4)[((((((((int)threadIdx.x) >> 5) * 1024) + ((((int)threadIdx.x) & 15) * 64)) + (i_29 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 4096)])), __pack_half2(xt_local[(i_29 * 8)], xt_local[((i_29 * 8) + 1)]), __pack_half2(xt_local[((i_29 * 8) + 2)], xt_local[((i_29 * 8) + 3)]), __pack_half2(xt_local[((i_29 * 8) + 4)], xt_local[((i_29 * 8) + 5)]), __pack_half2(xt_local[((i_29 * 8) + 6)], xt_local[((i_29 * 8) + 7)]));
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[6].arrive();
    } else {
