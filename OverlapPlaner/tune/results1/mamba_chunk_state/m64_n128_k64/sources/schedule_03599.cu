...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap X_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 3; ++ik) {
      ...
      overlap_plan_mbar[(((ik + 1) % 3) + 3)].wait(((ik + 1) / 3));
      #pragma unroll
      for (int i_6 = 0; i_6 < 8; ++i_6) {
        half_t da_shared_local_cast_2[2];
        *(uint1*)(da_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)da_shared) + (((((ik + 1) % 3) * 64) + (i_6 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __3;
      ...
      for (int i_7 = 0; i_7 < 8; ++i_7) {
        ...
        *(uint1*)(dt_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)dt_shared) + (((((ik + 1) & 1) * 64) + (i_7 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __4;
      ...
      overlap_plan_mbar[((ik + 1) % 3)].wait(((ik + 1) / 3));
      #pragma unroll
      for (int i_8 = 0; i_8 < 32; ++i_8) {
        x_local[i_8] = ((half_t*)x_shared)[((((((((((ik + 1) % 3) * 4096) + ((i_8 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_8 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_8 & 3) >> 1) + (i_8 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
      }
      overlap_plan_mbar[(((ik + 1) % 3) + 11)].arrive();
      #pragma unroll
    ...
    for (int ik_1 = 0; ik_1 < 4; ++ik_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[((ik_1 % 3) + 8)].arrive_and_expect_tx(16384);
        tl::tma_load(B_desc, overlap_plan_mbar[((ik_1 % 3) + 8)], (&(((half_t*)b_shared)[((ik_1 % 3) * 8192)])), 0, (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)), 0, (((int)blockIdx.z) & 7));
        tl::tma_load(B_desc, overlap_plan_mbar[((ik_1 % 3) + 8)], (&(((half_t*)b_shared)[(((ik_1 % 3) * 8192) + 4096)])), 64, (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)), 0, (((int)blockIdx.z) & 7));
      }
    }
  }
}
