  ...
  if (((int)threadIdx.x) < 128) {
    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int ik = 0; ik < 2; ++ik) {
        ...
        if (ik == 0) {
          ...
          for (int i_15 = 0; i_15 < 16; ++i_15) {
            *(uint1*)(xt_local_v0 + (i_15 * 2)) = *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + (((((((ik * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_15 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_15 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
          }
          {
          ...
          for (int i_16 = 0; i_16 < 16; ++i_16) {
            *(uint1*)(xt_local_v1 + (i_16 * 2)) = *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + (((((((ik * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_16 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_16 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
          }
          {
      ...
      for (int i_17 = 0; i_17 < 16; ++i_17) {
        *(uint1*)(xt_local_v0 + (i_17 * 2)) = *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + (((((((((int)threadIdx.x) >> 5) * 1024) + ((i_17 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_17 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
      }
      {
      ...
      for (int i_18 = 0; i_18 < 16; ++i_18) {
        *(uint1*)(xt_local_v1 + (i_18 * 2)) = *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + ((((((((int)threadIdx.x) >> 5) * 1024) + ((i_18 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_18 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      }
      {
      ...
      for (int i_19 = 0; i_19 < 8; ++i_19) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((((int)threadIdx.x) >> 5) * 2048) + ((((int)threadIdx.x) & 15) * 128)) + (i_19 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 8192)])), __pack_half2(((half_t)acc[(i_19 * 8)]), ((half_t)acc[((i_19 * 8) + 1)])), __pack_half2(((half_t)acc[((i_19 * 8) + 2)]), ((half_t)acc[((i_19 * 8) + 3)])), __pack_half2(((half_t)acc[((i_19 * 8) + 4)]), ((half_t)acc[((i_19 * 8) + 5)])), __pack_half2(((half_t)acc[((i_19 * 8) + 6)]), ((half_t)acc[((i_19 * 8) + 7)])));
      }
      tl::fence_proxy_async();
