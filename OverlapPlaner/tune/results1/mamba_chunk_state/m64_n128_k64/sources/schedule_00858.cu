...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* xt_local_wsp_handoff_4 = ((void*)((char*)buf_dyn_shmem + 65536));
  void* scale_wsp_handoff_3 = ((void*)((char*)buf_dyn_shmem + 81920));
  void* da_shared = ((void*)((char*)buf_dyn_shmem + 82944));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(B_desc, overlap_plan_mbar[8], (&(((half_t*)b_shared)[4096])), 64, ((((int)blockIdx.z) >> 3) * 256), 0, (((int)blockIdx.z) & 7));
    }
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(B_desc, overlap_plan_mbar[9], (&(((half_t*)b_shared)[8192])), 0, (((((int)blockIdx.z) >> 3) * 256) + 64), 0, (((int)blockIdx.z) & 7));
      tl::tma_load(B_desc, overlap_plan_mbar[9], (&(((half_t*)b_shared)[12288])), 64, (((((int)blockIdx.z) >> 3) * 256) + 64), 0, (((int)blockIdx.z) & 7));
    }
    ...
    for (int ik = 0; ik < 2; ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[(((ik + 2) % 3) + 8)].arrive_and_expect_tx(16384);
        tl::tma_load(B_desc, overlap_plan_mbar[(((ik + 2) % 3) + 8)], (&(((half_t*)b_shared)[(((ik + 2) % 3) * 8192)])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 128), 0, (((int)blockIdx.z) & 7));
        tl::tma_load(B_desc, overlap_plan_mbar[(((ik + 2) % 3) + 8)], (&(((half_t*)b_shared)[((((ik + 2) % 3) * 8192) + 4096)])), 64, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 128), 0, (((int)blockIdx.z) & 7));
      }
      ...
      if (ik == 0) {
        ...
        for (int i_9 = 0; i_9 < 16; ++i_9) {
          *(uint1*)(xt_local_v0 + (i_9 * 2)) = *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + ((((((ik * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_9 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_9 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        }
        {
        ...
        for (int i_10 = 0; i_10 < 16; ++i_10) {
          *(uint1*)(xt_local_v1 + (i_10 * 2)) = *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + ((((((ik * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_10 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_10 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        }
        {
      ...
      if (ik == 0) {
        ...
        if (((((((int)threadIdx.x) & 31) >> 2) * 4) + (((int)threadIdx.x) >> 5)) == 0) {
          ...
          for (int i_14 = 0; i_14 < 8; ++i_14) {
            *(float2*)(((float*)scale_wsp_handoff_3) + (((ik * 64) + (i_14 * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(scale_v0 + (i_14 * 2));
          }
        }
      } else {
        #pragma unroll
        ...
        if (((((((int)threadIdx.x) & 31) >> 2) * 4) + (((int)threadIdx.x) >> 5)) == 0) {
          ...
          for (int i_16 = 0; i_16 < 8; ++i_16) {
            *(float2*)(((float*)scale_wsp_handoff_3) + (((ik * 64) + (i_16 * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(scale_v1 + (i_16 * 2));
          }
        }
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[(ik + 4)].arrive();
    }
    ...
    for (int i_19 = 0; i_19 < 8; ++i_19) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((((int)threadIdx.x) >> 5) * 2048) + ((((int)threadIdx.x) & 15) * 128)) + (i_19 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(((half_t)acc[(i_19 * 8)]), ((half_t)acc[((i_19 * 8) + 1)])), __pack_half2(((half_t)acc[((i_19 * 8) + 2)]), ((half_t)acc[((i_19 * 8) + 3)])), __pack_half2(((half_t)acc[((i_19 * 8) + 4)]), ((half_t)acc[((i_19 * 8) + 5)])), __pack_half2(((half_t)acc[((i_19 * 8) + 6)]), ((half_t)acc[((i_19 * 8) + 7)])));
    }
    tl::fence_proxy_async();
    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int ik_1 = 0; ik_1 < 1; ++ik_1) {
        ...
        for (int i_24 = 0; i_24 < 16; ++i_24) {
          *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + (((((((((int)threadIdx.x) >> 5) * 1024) + ((i_24 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_24 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096)) = *(uint1*)(xt_local_v0 + (i_24 * 2));
        }
        tl::fence_proxy_async();
        ...
        for (int i_25 = 0; i_25 < 32; ++i_25) {
          x_local_v0[i_25] = ((half_t*)x_shared)[((((((((i_25 >> 2) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_25 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_25 & 3) >> 1) + (i_25 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
        }
        overlap_plan_mbar[12].arrive();
        ...
        for (int i_28 = 0; i_28 < 16; ++i_28) {
          *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + ((((((((int)threadIdx.x) >> 5) * 1024) + ((i_28 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_28 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(xt_local_v1 + (i_28 * 2));
        }
        tl::fence_proxy_async();
      ...
      for (int i_29 = 0; i_29 < 32; ++i_29) {
        x_local_v1[i_29] = ((half_t*)x_shared)[(((((((((i_29 >> 2) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_29 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_29 & 3) >> 1) + (i_29 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) + 4096)];
      }
      overlap_plan_mbar[13].arrive();
      ...
      for (int i_32 = 0; i_32 < 16; ++i_32) {
        *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + (((((((((int)threadIdx.x) >> 5) * 1024) + ((i_32 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_32 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096)) = *(uint1*)(xt_local_v0 + (i_32 * 2));
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[6].arrive();
      ...
      for (int i_35 = 0; i_35 < 16; ++i_35) {
        *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + ((((((((int)threadIdx.x) >> 5) * 1024) + ((i_35 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_35 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(xt_local_v1 + (i_35 * 2));
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[7].arrive();
    } else {
