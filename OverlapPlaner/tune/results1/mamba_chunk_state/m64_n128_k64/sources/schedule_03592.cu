...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* da_shared = ((void*)((char*)buf_dyn_shmem + 65536));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(B_desc, overlap_plan_mbar[5], (&(((half_t*)b_shared)[8192])), 0, (((((int)blockIdx.z) >> 3) * 256) + 64), 0, (((int)blockIdx.z) & 7));
      tl::tma_load(B_desc, overlap_plan_mbar[5], (&(((half_t*)b_shared)[12288])), 64, (((((int)blockIdx.z) >> 3) * 256) + 64), 0, (((int)blockIdx.z) & 7));
    }
    ...
    for (int i_7 = 0; i_7 < 32; ++i_7) {
      x_local_v1[i_7] = ((half_t*)x_shared)[(((((((((i_7 >> 2) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_7 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_7 & 3) >> 1) + (i_7 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) + 4096)];
    }
    ...
    for (int ik = 0; ik < 2; ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[(((ik + 2) % 3) + 4)].arrive_and_expect_tx(16384);
        tl::tma_load(B_desc, overlap_plan_mbar[(((ik + 2) % 3) + 4)], (&(((half_t*)b_shared)[(((ik + 2) % 3) * 8192)])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 128), 0, (((int)blockIdx.z) & 7));
        tl::tma_load(B_desc, overlap_plan_mbar[(((ik + 2) % 3) + 4)], (&(((half_t*)b_shared)[((((ik + 2) % 3) * 8192) + 4096)])), 64, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 128), 0, (((int)blockIdx.z) & 7));
      }
      ...
      if (ik == 0) {
        ...
        for (int i_12 = 0; i_12 < 32; ++i_12) {
          x_local_v0[i_12] = ((half_t*)x_shared)[((((((((ik * 4096) + ((i_12 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_12 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_12 & 3) >> 1) + (i_12 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
        }
      } else {
        #pragma unroll
        for (int i_13 = 0; i_13 < 32; ++i_13) {
          x_local_v1[i_13] = ((half_t*)x_shared)[((((((((ik * 4096) + ((i_13 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_13 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_13 & 3) >> 1) + (i_13 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
        }
      }
      overlap_plan_mbar[(ik + 7)].arrive();
      if (ik == 0) {
        #pragma unroll
