...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* scale_wsp_handoff_3 = ((void*)((char*)buf_dyn_shmem + 18432));
  void* da_shared = ((void*)((char*)buf_dyn_shmem + 19456));
  void* dt_shared = ((void*)((char*)buf_dyn_shmem + 20480));
  void* acc_shared = ((void*)((char*)buf_dyn_shmem + 21504));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 3; ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(B_desc, overlap_plan_mbar[8], (&(((half_t*)b_shared)[0])), (((int)blockIdx.y) * 32), (((((int)blockIdx.z) >> 3) * 256) + (ik * 64)), 0, (((int)blockIdx.z) & 7));
      }
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[8].arrive_and_expect_tx(2048);
        tl::tma_load(B_desc, overlap_plan_mbar[8], (&(((half_t*)b_shared)[0])), (((int)blockIdx.y) * 32), ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 32), 0, (((int)blockIdx.z) & 7));
      }
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[8].arrive_and_expect_tx(2048);
      tl::tma_load(B_desc, overlap_plan_mbar[8], (&(((half_t*)b_shared)[0])), (((int)blockIdx.y) * 32), (((((int)blockIdx.z) >> 3) * 256) + 192), 0, (((int)blockIdx.z) & 7));
    }
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[8].arrive_and_expect_tx(2048);
      tl::tma_load(B_desc, overlap_plan_mbar[8], (&(((half_t*)b_shared)[0])), (((int)blockIdx.y) * 32), (((((int)blockIdx.z) >> 3) * 256) + 224), 0, (((int)blockIdx.z) & 7));
    }
