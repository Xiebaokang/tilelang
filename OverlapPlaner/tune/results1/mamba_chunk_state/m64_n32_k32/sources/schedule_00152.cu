...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* scale_wsp_handoff_3 = ((void*)((char*)buf_dyn_shmem + 14336));
  void* da_shared = ((void*)((char*)buf_dyn_shmem + 15360));
  void* dt_shared = ((void*)((char*)buf_dyn_shmem + 16384));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 8; ++ik) {
      if (2 <= ik) {
        overlap_plan_mbar[((ik & 1) + 8)].wait((((ik >> 1) + 1) & 1));
      }
      tl::__sync_thread_partial(3, 128);
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[(ik & 1)].arrive_and_expect_tx(4096);
        tl::tma_load(X_desc, overlap_plan_mbar[(ik & 1)], (&(((half_t*)x_shared)[((ik & 1) * 2048)])), 0, (((((int)blockIdx.z) >> 3) * 256) + (ik * 32)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
      if (1 <= ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load((&(((half_t*)da_shared)[0])), (&(DA[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 32))])), overlap_plan_mbar[2], 64);
      }
      if (1 <= ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load((&(((half_t*)dt_shared)[0])), (&(Dt[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 32))])), overlap_plan_mbar[3], 64);
      }
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[6].arrive_and_expect_tx(2048);
        tl::tma_load(B_desc, overlap_plan_mbar[6], (&(((half_t*)b_shared)[0])), (((int)blockIdx.y) * 32), (((((int)blockIdx.z) >> 3) * 256) + (ik * 32)), 0, (((int)blockIdx.z) & 7));
      }
      overlap_plan_mbar[5].wait((ik & 1));
      overlap_plan_mbar[6].wait((ik & 1));
      #pragma unroll
      for (int i_5 = 0; i_5 < 2; ++i_5) {
        tl::ptx_ldmatrix_x4((&(((half_t*)xt_local_wsp_handoff_4)[(((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (i_5 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), (&(xt_local[(i_5 * 8)])));
      }
      {
    ...
    for (int i_6 = 0; i_6 < 2; ++i_6) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + i_6) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(((half_t)acc[(i_6 * 8)]), ((half_t)acc[((i_6 * 8) + 1)])), __pack_half2(((half_t)acc[((i_6 * 8) + 2)]), ((half_t)acc[((i_6 * 8) + 3)])), __pack_half2(((half_t)acc[((i_6 * 8) + 4)]), ((half_t)acc[((i_6 * 8) + 5)])), __pack_half2(((half_t)acc[((i_6 * 8) + 6)]), ((half_t)acc[((i_6 * 8) + 7)])));
    }
    tl::fence_proxy_async();
    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int ik_1 = 0; ik_1 < 8; ++ik_1) {
        overlap_plan_mbar[(ik_1 & 1)].wait(((ik_1 & 3) >> 1));
        #pragma unroll
        for (int i_7 = 0; i_7 < 16; ++i_7) {
          x_local[i_7] = ((half_t*)x_shared)[(((((((((ik_1 & 1) * 2048) + ((i_7 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_7 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_7 & 3) >> 1) + (i_7 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
        }
        ...
        for (int i_10 = 0; i_10 < 2; ++i_10) {
          tl::ptx_stmatrix_m8n8_x4((&(((half_t*)xt_local_wsp_handoff_4)[((((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (i_10 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 2048)])), __pack_half2(xt_local[(i_10 * 8)], xt_local[((i_10 * 8) + 1)]), __pack_half2(xt_local[((i_10 * 8) + 2)], xt_local[((i_10 * 8) + 3)]), __pack_half2(xt_local[((i_10 * 8) + 4)], xt_local[((i_10 * 8) + 5)]), __pack_half2(xt_local[((i_10 * 8) + 6)], xt_local[((i_10 * 8) + 7)]));
        }
        tl::fence_proxy_async();
