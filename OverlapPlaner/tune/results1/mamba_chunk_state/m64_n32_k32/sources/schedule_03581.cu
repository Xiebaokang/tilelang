...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* scale_wsp_handoff_4 = ((void*)((char*)buf_dyn_shmem + 10368));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int i_7 = 0; i_7 < 2; ++i_7) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + i_7) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(((half_t)acc[(i_7 * 8)]), ((half_t)acc[((i_7 * 8) + 1)])), __pack_half2(((half_t)acc[((i_7 * 8) + 2)]), ((half_t)acc[((i_7 * 8) + 3)])), __pack_half2(((half_t)acc[((i_7 * 8) + 4)]), ((half_t)acc[((i_7 * 8) + 5)])), __pack_half2(((half_t)acc[((i_7 * 8) + 6)]), ((half_t)acc[((i_7 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 128);
