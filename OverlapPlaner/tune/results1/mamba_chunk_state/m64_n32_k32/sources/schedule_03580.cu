  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 2; ++ik) {
      ...
      for (int i_11 = 0; i_11 < 4; ++i_11) {
        ...
        *(uint1*)(da_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)da_shared) + (((i_11 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 64));
        float2 __5;
      ...
      for (int i_12 = 0; i_12 < 4; ++i_12) {
        ...
        *(uint1*)(dt_shared_local_cast_5 + 0) = *(uint1*)(((half_t*)dt_shared) + (((i_12 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 64));
        float2 __6;
      ...
      overlap_plan_mbar[((((ik * 3) + 1) & 1) + 18)].arrive();
      overlap_plan_mbar[3].wait(((ik + 1) & 1));
      #pragma unroll
      for (int i_21 = 0; i_21 < 4; ++i_21) {
        half_t da_shared_local_cast_8[2];
        *(uint1*)(da_shared_local_cast_8 + 0) = *(uint1*)(((half_t*)da_shared) + (((i_21 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 32));
        float2 __9;
      ...
      for (int i_22 = 0; i_22 < 4; ++i_22) {
        ...
        *(uint1*)(dt_shared_local_cast_9 + 0) = *(uint1*)(((half_t*)dt_shared) + (((i_22 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 32));
        float2 __10;
      ...
      overlap_plan_mbar[(ik + 8)].wait(((ik + 1) & 1));
      {
    ...
    for (int ik_1 = 0; ik_1 < 7; ++ik_1) {
      ...
      if (2 <= ik_1) {
        overlap_plan_mbar[(((ik_1 + 1) % 3) + 15)].wait(((ik_1 - 2) / 3));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[(((ik_1 + 1) % 3) + 5)].arrive_and_expect_tx(64);
        tl::tma_load((&(((half_t*)dt_shared)[(((ik_1 + 1) % 3) * 32)])), (&(Dt[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik_1 * 32)) + 32)])), overlap_plan_mbar[(((ik_1 + 1) % 3) + 5)], 64);
      }
      if (2 <= ik_1) {
        overlap_plan_mbar[((ik_1 & 1) + 18)].wait((((ik_1 >> 1) + 1) & 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[((ik_1 & 1) + 8)].arrive_and_expect_tx(2048);
        tl::tma_load(B_desc, overlap_plan_mbar[((ik_1 & 1) + 8)], (&(((half_t*)b_shared)[((ik_1 & 1) * 1024)])), (((int)blockIdx.y) * 32), (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 32)), 0, (((int)blockIdx.z) & 7));
      }
    }
    overlap_plan_mbar[19].wait(0);
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
