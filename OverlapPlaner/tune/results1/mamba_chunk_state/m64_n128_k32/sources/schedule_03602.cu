...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* xt_local_wsp_handoff_3 = ((void*)((char*)buf_dyn_shmem + 36864));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 7; ++ik) {
      ...
      for (int i_4 = 0; i_4 < 16; ++i_4) {
        xt_local[i_4] = ((half_t)(((float)x_local[((((i_4 >> 2) * 4) + ((i_4 & 1) * 2)) + ((i_4 & 3) >> 1))]) * scale[(((i_4 >> 2) * 2) + (i_4 & 1))]));
      }
      tl::__sync_thread_partial(3, 128);
      #pragma unroll
      for (int i_5 = 0; i_5 < 2; ++i_5) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)xt_local_wsp_handoff_3)[(((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (i_5 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(xt_local[(i_5 * 8)], xt_local[((i_5 * 8) + 1)]), __pack_half2(xt_local[((i_5 * 8) + 2)], xt_local[((i_5 * 8) + 3)]), __pack_half2(xt_local[((i_5 * 8) + 4)], xt_local[((i_5 * 8) + 5)]), __pack_half2(xt_local[((i_5 * 8) + 6)], xt_local[((i_5 * 8) + 7)]));
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[9].arrive();
      overlap_plan_mbar[(((ik + 1) % 3) + 3)].wait((((ik + 1) % 6) / 3));
      #pragma unroll
      ...
      overlap_plan_mbar[(((ik + 1) % 3) + 17)].arrive();
      overlap_plan_mbar[(((ik + 1) % 3) + 6)].wait((((ik + 1) % 6) / 3));
      #pragma unroll
      for (int i_7 = 0; i_7 < 4; ++i_7) {
        half_t dt_shared_local_cast_3[2];
        *(uint1*)(dt_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)dt_shared) + (((((ik + 1) % 3) * 32) + (i_7 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __4;
        uint1 v__3 = *(uint1*)(dt_shared_local_cast_3 + 0);
        ((float2*)(&__4))[0] = __half22float2(((half2*)(&v__3))[0]);
        *(float2*)(dt_local + (i_7 * 2)) = __4;
      }
      overlap_plan_mbar[(((ik + 1) % 3) + 20)].arrive();
      overlap_plan_mbar[((ik + 1) % 3)].wait((((ik + 1) % 6) / 3));
      #pragma unroll
    ...
    for (int i_11 = 0; i_11 < 2; ++i_11) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)xt_local_wsp_handoff_3)[(((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (i_11 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(xt_local[(i_11 * 8)], xt_local[((i_11 * 8) + 1)]), __pack_half2(xt_local[((i_11 * 8) + 2)], xt_local[((i_11 * 8) + 3)]), __pack_half2(xt_local[((i_11 * 8) + 4)], xt_local[((i_11 * 8) + 5)]), __pack_half2(xt_local[((i_11 * 8) + 6)], xt_local[((i_11 * 8) + 7)]));
    }
    tl::fence_proxy_async();
    overlap_plan_mbar[9].arrive();
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      ...
      tl::tma_load(B_desc, overlap_plan_mbar[10], (&(((half_t*)b_shared)[0])), 0, ((((int)blockIdx.z) >> 3) * 256), 0, (((int)blockIdx.z) & 7));
      tl::tma_load(B_desc, overlap_plan_mbar[10], (&(((half_t*)b_shared)[2048])), 64, ((((int)blockIdx.z) >> 3) * 256), 0, (((int)blockIdx.z) & 7));
    }
    for (int ik_1 = 0; ik_1 < 7; ++ik_1) {
      ...
      if (2 <= ik_1) {
        overlap_plan_mbar[(((ik_1 + 1) % 3) + 17)].wait(((ik_1 - 2) / 3));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      ...
      if (2 <= ik_1) {
        overlap_plan_mbar[(((ik_1 + 1) % 3) + 20)].wait(((ik_1 - 2) / 3));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      ...
      if (2 <= ik_1) {
        overlap_plan_mbar[(((ik_1 + 1) % 3) + 23)].wait(((ik_1 - 2) / 3));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[(((ik_1 + 1) % 3) + 10)].arrive_and_expect_tx(8192);
        tl::tma_load(B_desc, overlap_plan_mbar[(((ik_1 + 1) % 3) + 10)], (&(((half_t*)b_shared)[(((ik_1 + 1) % 3) * 4096)])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 32)) + 32), 0, (((int)blockIdx.z) & 7));
        tl::tma_load(B_desc, overlap_plan_mbar[(((ik_1 + 1) % 3) + 10)], (&(((half_t*)b_shared)[((((ik_1 + 1) % 3) * 4096) + 2048)])), 64, ((((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 32)) + 32), 0, (((int)blockIdx.z) & 7));
      }
      overlap_plan_mbar[9].wait((ik_1 & 1));
      overlap_plan_mbar[((ik_1 % 3) + 10)].wait(((ik_1 % 6) / 3));
      #pragma unroll
      for (int i_13 = 0; i_13 < 2; ++i_13) {
        tl::ptx_ldmatrix_x4((&(((half_t*)xt_local_wsp_handoff_3)[((((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (i_13 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 2048)])), (&(xt_local[(i_13 * 8)])));
      }
      {
        tl::GmmaDescriptor desc_b;
        tl::initialize_wgmma_descriptor<1, 256, 64>(desc_b, (&(((half_t*)b_shared)[0])));
        tl::increase_descriptor_offset<int>(desc_b, ((ik_1 % 3) * 8192));
      ...
      overlap_plan_mbar[((ik_1 % 3) + 23)].arrive();
    }
    overlap_plan_mbar[9].wait(1);
    overlap_plan_mbar[11].wait(0);
    #pragma unroll
    for (int i_14 = 0; i_14 < 2; ++i_14) {
      tl::ptx_ldmatrix_x4((&(((half_t*)xt_local_wsp_handoff_3)[((((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (i_14 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 2048)])), (&(xt_local[(i_14 * 8)])));
    }
    {
