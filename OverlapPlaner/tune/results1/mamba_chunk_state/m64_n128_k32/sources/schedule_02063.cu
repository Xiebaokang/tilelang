...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* scale_wsp_handoff_4 = ((void*)((char*)buf_dyn_shmem + 22656));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int i_3 = 0; i_3 < 16; ++i_3) {
      xt_local[i_3] = ((half_t)(((float)x_local[((((i_3 >> 2) * 4) + ((i_3 & 1) * 2)) + ((i_3 & 3) >> 1))]) * scale[(((i_3 >> 2) * 2) + (i_3 & 1))]));
    }
    ...
    for (int ik = 0; ik < 7; ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[1].arrive_and_expect_tx(4096);
        tl::tma_load(X_desc, overlap_plan_mbar[1], (&(((half_t*)x_shared)[0])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 32)) + 32), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
      if (1 <= ik) {
        overlap_plan_mbar[(((ik + 1) & 1) + 10)].wait((((ik + 3) & 3) >> 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[(((ik + 1) & 1) + 2)].arrive_and_expect_tx(64);
        tl::tma_load((&(((half_t*)da_shared)[(((ik + 1) & 1) * 32)])), (&(DA[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 32)) + 32)])), overlap_plan_mbar[(((ik + 1) & 1) + 2)], 64);
      }
      if (1 <= ik) {
        overlap_plan_mbar[(((ik + 1) & 1) + 12)].wait((((ik + 3) & 3) >> 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[(((ik + 1) & 1) + 4)].arrive_and_expect_tx(64);
        tl::tma_load((&(((half_t*)dt_shared)[(((ik + 1) & 1) * 32)])), (&(Dt[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 32)) + 32)])), overlap_plan_mbar[(((ik + 1) & 1) + 4)], 64);
      }
      if (1 <= ik) {
      ...
      for (int i_6 = 0; i_6 < 16; ++i_6) {
        xt_local[i_6] = ((half_t)(((float)x_local[((((i_6 >> 2) * 4) + ((i_6 & 1) * 2)) + ((i_6 & 3) >> 1))]) * scale[(((i_6 >> 2) * 2) + (i_6 & 1))]));
      }
    }
    ...
    for (int i_7 = 0; i_7 < 8; ++i_7) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((((int)threadIdx.x) >> 5) * 2048) + ((((int)threadIdx.x) & 15) * 128)) + (i_7 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(((half_t)acc[(i_7 * 8)]), ((half_t)acc[((i_7 * 8) + 1)])), __pack_half2(((half_t)acc[((i_7 * 8) + 2)]), ((half_t)acc[((i_7 * 8) + 3)])), __pack_half2(((half_t)acc[((i_7 * 8) + 4)]), ((half_t)acc[((i_7 * 8) + 5)])), __pack_half2(((half_t)acc[((i_7 * 8) + 6)]), ((half_t)acc[((i_7 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 128);
    ...
    for (int ik_1 = 0; ik_1 < 8; ++ik_1) {
      ...
      for (int i_8 = 0; i_8 < 4; ++i_8) {
        ...
        *(uint1*)(da_shared_local_cast + 0) = *(uint1*)(((half_t*)da_shared) + ((((ik_1 & 1) * 32) + (i_8 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __1;
        uint1 v_ = *(uint1*)(da_shared_local_cast + 0);
        ((float2*)(&__1))[0] = __half22float2(((half2*)(&v_))[0]);
        *(float2*)(da_local + (i_8 * 2)) = __1;
      }
      ...
      for (int i_9 = 0; i_9 < 4; ++i_9) {
        ...
        *(uint1*)(dt_shared_local_cast_1 + 0) = *(uint1*)(((half_t*)dt_shared) + ((((ik_1 & 1) * 32) + (i_9 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __2;
        uint1 v__1 = *(uint1*)(dt_shared_local_cast_1 + 0);
        ((float2*)(&__2))[0] = __half22float2(((half2*)(&v__1))[0]);
        *(float2*)(dt_local + (i_9 * 2)) = __2;
      }
      ...
      for (int i_10 = 0; i_10 < 8; ++i_10) {
        scale[i_10] = (exp2f(((da_last[0] - da_local[i_10]) * 0x1.7154764ee6c2fp+0f/*1.442695e+00*/)) * dt_local[i_10]);
      }
      if (((((((int)threadIdx.x) & 31) >> 2) * 4) + (((int)threadIdx.x) >> 5)) == 4) {
        #pragma unroll
        for (int i_11 = 0; i_11 < 4; ++i_11) {
          *(float2*)(((float*)scale_wsp_handoff_4) + ((i_11 * 8) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(scale + (i_11 * 2));
        }
      }
      tl::fence_proxy_async();
