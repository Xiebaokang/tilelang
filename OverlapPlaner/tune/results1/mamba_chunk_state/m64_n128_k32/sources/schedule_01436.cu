...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap X_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 7; ++ik) {
      if (1 <= ik) {
        overlap_plan_mbar[(((ik + 1) & 1) + 10)].wait((((ik + 3) & 3) >> 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((ik + 1) & 1)].arrive_and_expect_tx(4096);
        tl::tma_load(X_desc, overlap_plan_mbar[((ik + 1) & 1)], (&(((half_t*)x_shared)[(((ik + 1) & 1) * 2048)])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 32)) + 32), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
      overlap_plan_mbar[12].wait((ik & 1));
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[2].arrive_and_expect_tx(64);
        tl::tma_load((&(((half_t*)da_shared)[0])), (&(DA[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 32)) + 32)])), overlap_plan_mbar[2], 64);
      }
      overlap_plan_mbar[13].wait((ik & 1));
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[3].arrive_and_expect_tx(64);
        tl::tma_load((&(((half_t*)dt_shared)[0])), (&(Dt[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 32)) + 32)])), overlap_plan_mbar[3], 64);
      }
      ...
      if (1 <= ik) {
        overlap_plan_mbar[(((ik + 1) & 1) + 14)].wait((((ik + 3) & 3) >> 1));
      }
      tl::__sync_thread_partial(3, 128);
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[(((ik + 1) & 1) + 7)].arrive_and_expect_tx(8192);
        tl::tma_load(B_desc, overlap_plan_mbar[(((ik + 1) & 1) + 7)], (&(((half_t*)b_shared)[(((ik + 1) & 1) * 4096)])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 32)) + 32), 0, (((int)blockIdx.z) & 7));
        tl::tma_load(B_desc, overlap_plan_mbar[(((ik + 1) & 1) + 7)], (&(((half_t*)b_shared)[((((ik + 1) & 1) * 4096) + 2048)])), 64, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 32)) + 32), 0, (((int)blockIdx.z) & 7));
      }
      overlap_plan_mbar[6].wait((ik & 1));
      overlap_plan_mbar[((ik & 1) + 7)].wait(((ik & 3) >> 1));
      #pragma unroll
    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int ik_1 = 0; ik_1 < 3; ++ik_1) {
        ...
        for (int i_15 = 0; i_15 < 16; ++i_15) {
          x_local_v1[i_15] = ((half_t*)x_shared)[(((((((((i_15 >> 2) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_15 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_15 & 3) >> 1) + (i_15 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) + 2048)];
        }
        ...
        for (int i_18 = 0; i_18 < 2; ++i_18) {
          tl::ptx_stmatrix_m8n8_x4((&(((half_t*)xt_local_wsp_handoff_4)[((((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (i_18 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 4096)])), __pack_half2(xt_local[(i_18 * 8)], xt_local[((i_18 * 8) + 1)]), __pack_half2(xt_local[((i_18 * 8) + 2)], xt_local[((i_18 * 8) + 3)]), __pack_half2(xt_local[((i_18 * 8) + 4)], xt_local[((i_18 * 8) + 5)]), __pack_half2(xt_local[((i_18 * 8) + 6)], xt_local[((i_18 * 8) + 7)]));
        }
        tl::fence_proxy_async();
        ...
        for (int i_22 = 0; i_22 < 2; ++i_22) {
          tl::ptx_stmatrix_m8n8_x4((&(((half_t*)xt_local_wsp_handoff_4)[((((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (i_22 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 4096)])), __pack_half2(xt_local[(i_22 * 8)], xt_local[((i_22 * 8) + 1)]), __pack_half2(xt_local[((i_22 * 8) + 2)], xt_local[((i_22 * 8) + 3)]), __pack_half2(xt_local[((i_22 * 8) + 4)], xt_local[((i_22 * 8) + 5)]), __pack_half2(xt_local[((i_22 * 8) + 6)], xt_local[((i_22 * 8) + 7)]));
        }
        tl::fence_proxy_async();
        overlap_plan_mbar[6].arrive();
      }
      ...
      for (int i_26 = 0; i_26 < 2; ++i_26) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)xt_local_wsp_handoff_4)[((((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (i_26 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 4096)])), __pack_half2(xt_local[(i_26 * 8)], xt_local[((i_26 * 8) + 1)]), __pack_half2(xt_local[((i_26 * 8) + 2)], xt_local[((i_26 * 8) + 3)]), __pack_half2(xt_local[((i_26 * 8) + 4)], xt_local[((i_26 * 8) + 5)]), __pack_half2(xt_local[((i_26 * 8) + 6)], xt_local[((i_26 * 8) + 7)]));
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[6].arrive();
      ...
      for (int i_29 = 0; i_29 < 2; ++i_29) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)xt_local_wsp_handoff_4)[((((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (i_29 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 4096)])), __pack_half2(xt_local[(i_29 * 8)], xt_local[((i_29 * 8) + 1)]), __pack_half2(xt_local[((i_29 * 8) + 2)], xt_local[((i_29 * 8) + 3)]), __pack_half2(xt_local[((i_29 * 8) + 4)], xt_local[((i_29 * 8) + 5)]), __pack_half2(xt_local[((i_29 * 8) + 6)], xt_local[((i_29 * 8) + 7)]));
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[6].arrive();
    }
