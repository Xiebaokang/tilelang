    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int ik_1 = 0; ik_1 < 3; ++ik_1) {
        ...
        for (int i_26 = 0; i_26 < 8; ++i_26) {
          *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + (((((((((int)threadIdx.x) >> 5) * 512) + ((i_26 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_26 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 2048)) = *(uint1*)(xt_local_v0 + (i_26 * 2));
        }
        tl::fence_proxy_async();
        ...
        for (int i_30 = 0; i_30 < 8; ++i_30) {
          *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + ((((((((int)threadIdx.x) >> 5) * 512) + ((i_30 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_30 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(xt_local_v1 + (i_30 * 2));
        }
        tl::fence_proxy_async();
      ...
      for (int i_34 = 0; i_34 < 8; ++i_34) {
        *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + (((((((((int)threadIdx.x) >> 5) * 512) + ((i_34 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_34 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 2048)) = *(uint1*)(xt_local_v0 + (i_34 * 2));
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[7].arrive();
      ...
      for (int i_37 = 0; i_37 < 8; ++i_37) {
        *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + ((((((((int)threadIdx.x) >> 5) * 512) + ((i_37 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_37 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(xt_local_v1 + (i_37 * 2));
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[8].arrive();
    } else {
