...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap X_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 7; ++ik) {
      ...
      overlap_plan_mbar[(((ik + 1) & 1) + 2)].wait((((ik + 1) & 3) >> 1));
      #pragma unroll
      for (int i_6 = 0; i_6 < 4; ++i_6) {
        half_t da_shared_local_cast_2[2];
        *(uint1*)(da_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)da_shared) + (((((ik + 1) & 1) * 32) + (i_6 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __3;
      ...
      overlap_plan_mbar[((ik + 1) & 1)].wait((((ik + 1) & 3) >> 1));
      #pragma unroll
      for (int i_8 = 0; i_8 < 16; ++i_8) {
        x_local[i_8] = ((half_t*)x_shared)[((((((((((ik + 1) & 1) * 2048) + ((i_8 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_8 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_8 & 3) >> 1) + (i_8 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
      }
    ...
    for (int ik_1 = 0; ik_1 < 8; ++ik_1) {
      ...
      if (2 <= ik_1) {
        overlap_plan_mbar[((ik_1 & 1) + 11)].wait((((ik_1 >> 1) + 1) & 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        ...
        tl::tma_load((&(((half_t*)dt_shared)[((ik_1 % 3) * 32)])), (&(Dt[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik_1 * 32))])), overlap_plan_mbar[((ik_1 % 3) + 4)], 64);
      }
      if (2 <= ik_1) {
        overlap_plan_mbar[((ik_1 & 1) + 16)].wait((((ik_1 >> 1) + 1) & 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[((ik_1 & 1) + 7)].arrive_and_expect_tx(8192);
        tl::tma_load(B_desc, overlap_plan_mbar[((ik_1 & 1) + 7)], (&(((half_t*)b_shared)[((ik_1 & 1) * 4096)])), 0, (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 32)), 0, (((int)blockIdx.z) & 7));
        tl::tma_load(B_desc, overlap_plan_mbar[((ik_1 & 1) + 7)], (&(((half_t*)b_shared)[(((ik_1 & 1) * 4096) + 2048)])), 64, (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 32)), 0, (((int)blockIdx.z) & 7));
      }
    }
  }
}
