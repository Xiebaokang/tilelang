  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 3; ++ik) {
      ...
      for (int i_3 = 0; i_3 < 16; ++i_3) {
        xt_local[i_3] = ((half_t)(((float)x_local_v0[((((i_3 >> 2) * 4) + ((i_3 & 1) * 2)) + ((i_3 & 3) >> 1))]) * scale_v0[(((i_3 >> 2) * 2) + (i_3 & 1))]));
      }
      tl::__sync_thread_partial(3, 128);
      #pragma unroll
      for (int i_4 = 0; i_4 < 2; ++i_4) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)xt_local_wsp_handoff_4)[(((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (i_4 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(xt_local[(i_4 * 8)], xt_local[((i_4 * 8) + 1)]), __pack_half2(xt_local[((i_4 * 8) + 2)], xt_local[((i_4 * 8) + 3)]), __pack_half2(xt_local[((i_4 * 8) + 4)], xt_local[((i_4 * 8) + 5)]), __pack_half2(xt_local[((i_4 * 8) + 6)], xt_local[((i_4 * 8) + 7)]));
      }
      ...
      for (int i_8 = 0; i_8 < 2; ++i_8) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)xt_local_wsp_handoff_4)[(((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (i_8 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(xt_local[(i_8 * 8)], xt_local[((i_8 * 8) + 1)]), __pack_half2(xt_local[((i_8 * 8) + 2)], xt_local[((i_8 * 8) + 3)]), __pack_half2(xt_local[((i_8 * 8) + 4)], xt_local[((i_8 * 8) + 5)]), __pack_half2(xt_local[((i_8 * 8) + 6)], xt_local[((i_8 * 8) + 7)]));
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[6].arrive();
    }
    ...
    for (int i_11 = 0; i_11 < 16; ++i_11) {
      xt_local[i_11] = ((half_t)(((float)x_local_v0[((((i_11 >> 2) * 4) + ((i_11 & 1) * 2)) + ((i_11 & 3) >> 1))]) * scale_v0[(((i_11 >> 2) * 2) + (i_11 & 1))]));
    }
    tl::__sync_thread_partial(3, 128);
    #pragma unroll
    for (int i_12 = 0; i_12 < 2; ++i_12) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)xt_local_wsp_handoff_4)[(((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (i_12 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(xt_local[(i_12 * 8)], xt_local[((i_12 * 8) + 1)]), __pack_half2(xt_local[((i_12 * 8) + 2)], xt_local[((i_12 * 8) + 3)]), __pack_half2(xt_local[((i_12 * 8) + 4)], xt_local[((i_12 * 8) + 5)]), __pack_half2(xt_local[((i_12 * 8) + 6)], xt_local[((i_12 * 8) + 7)]));
    }
    tl::fence_proxy_async();
    overlap_plan_mbar[6].arrive();
    ...
    for (int i_15 = 0; i_15 < 2; ++i_15) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)xt_local_wsp_handoff_4)[(((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (i_15 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(xt_local[(i_15 * 8)], xt_local[((i_15 * 8) + 1)]), __pack_half2(xt_local[((i_15 * 8) + 2)], xt_local[((i_15 * 8) + 3)]), __pack_half2(xt_local[((i_15 * 8) + 4)], xt_local[((i_15 * 8) + 5)]), __pack_half2(xt_local[((i_15 * 8) + 6)], xt_local[((i_15 * 8) + 7)]));
    }
    tl::fence_proxy_async();
    overlap_plan_mbar[6].arrive();
  } else {
    if (((int)threadIdx.x) < 256) {
      ...
      for (int ik_1 = 0; ik_1 < 7; ++ik_1) {
        ...
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          overlap_plan_mbar[2].arrive_and_expect_tx(64);
          tl::tma_load((&(((half_t*)da_shared)[0])), (&(DA[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik_1 * 32)) + 32)])), overlap_plan_mbar[2], 64);
        }
        overlap_plan_mbar[13].wait((ik_1 & 1));
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          overlap_plan_mbar[3].arrive_and_expect_tx(64);
          tl::tma_load((&(((half_t*)dt_shared)[0])), (&(Dt[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik_1 * 32)) + 32)])), overlap_plan_mbar[3], 64);
        }
        overlap_plan_mbar[2].wait(((ik_1 + 1) & 1));
        tl::__sync_thread_partial(4, 128);
        #pragma unroll
        ...
        overlap_plan_mbar[12].arrive();
        overlap_plan_mbar[3].wait(((ik_1 + 1) & 1));
        #pragma unroll
        ...
        if (((ik_1 + 1) % 2) == 0) {
          ...
          for (int i_23 = 0; i_23 < 8; ++i_23) {
            scale_v0[i_23] = (exp2f(((da_last[0] - da_local[i_23]) * 0x1.7154764ee6c2fp+0f/*1.442695e+00*/)) * dt_local[i_23]);
          }
          if (((((((int)threadIdx.x) & 31) >> 2) * 4) + (((int)threadIdx.x) >> 5)) == 4) {
            #pragma unroll
            for (int i_24 = 0; i_24 < 4; ++i_24) {
              *(float2*)(((float*)scale_wsp_handoff_3) + (((((ik_1 + 1) & 1) * 32) + (i_24 * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(scale_v0 + (i_24 * 2));
            }
          }
        } else {
          #pragma unroll
          for (int i_25 = 0; i_25 < 8; ++i_25) {
            scale_v1[i_25] = (exp2f(((da_last[0] - da_local[i_25]) * 0x1.7154764ee6c2fp+0f/*1.442695e+00*/)) * dt_local[i_25]);
          }
          if (((((((int)threadIdx.x) & 31) >> 2) * 4) + (((int)threadIdx.x) >> 5)) == 4) {
            #pragma unroll
            for (int i_26 = 0; i_26 < 4; ++i_26) {
              *(float2*)(((float*)scale_wsp_handoff_3) + (((((ik_1 + 1) & 1) * 32) + (i_26 * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(scale_v1 + (i_26 * 2));
            }
          }
        }
        tl::fence_proxy_async();
        overlap_plan_mbar[(((ik_1 + 1) & 1) + 4)].arrive();
        if (1 <= ik_1) {
          overlap_plan_mbar[(((ik_1 + 1) & 1) + 14)].wait((((ik_1 + 3) & 3) >> 1));
        }
        tl::__sync_thread_partial(4, 128);
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          overlap_plan_mbar[(((ik_1 + 1) & 1) + 7)].arrive_and_expect_tx(8192);
          tl::tma_load(B_desc, overlap_plan_mbar[(((ik_1 + 1) & 1) + 7)], (&(((half_t*)b_shared)[(((ik_1 + 1) & 1) * 4096)])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 32)) + 32), 0, (((int)blockIdx.z) & 7));
          tl::tma_load(B_desc, overlap_plan_mbar[(((ik_1 + 1) & 1) + 7)], (&(((half_t*)b_shared)[((((ik_1 + 1) & 1) * 4096) + 2048)])), 64, ((((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 32)) + 32), 0, (((int)blockIdx.z) & 7));
        }
        overlap_plan_mbar[6].wait((ik_1 & 1));
        overlap_plan_mbar[((ik_1 & 1) + 7)].wait(((ik_1 & 3) >> 1));
        #pragma unroll
        for (int i_27 = 0; i_27 < 2; ++i_27) {
          tl::ptx_ldmatrix_x4((&(((half_t*)xt_local_wsp_handoff_4)[((((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (i_27 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 2048)])), (&(xt_local[(i_27 * 8)])));
        }
        {
      ...
      for (int i_28 = 0; i_28 < 2; ++i_28) {
        tl::ptx_ldmatrix_x4((&(((half_t*)xt_local_wsp_handoff_4)[((((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (i_28 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 2048)])), (&(xt_local[(i_28 * 8)])));
      }
      {
      ...
      for (int i_29 = 0; i_29 < 8; ++i_29) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((((int)threadIdx.x) >> 5) * 2048) + ((((int)threadIdx.x) & 15) * 128)) + (i_29 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 8192)])), __pack_half2(((half_t)acc[(i_29 * 8)]), ((half_t)acc[((i_29 * 8) + 1)])), __pack_half2(((half_t)acc[((i_29 * 8) + 2)]), ((half_t)acc[((i_29 * 8) + 3)])), __pack_half2(((half_t)acc[((i_29 * 8) + 4)]), ((half_t)acc[((i_29 * 8) + 5)])), __pack_half2(((half_t)acc[((i_29 * 8) + 6)]), ((half_t)acc[((i_29 * 8) + 7)])));
      }
      tl::fence_proxy_async();
