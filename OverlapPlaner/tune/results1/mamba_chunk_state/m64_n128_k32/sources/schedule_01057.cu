  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 3; ++ik) {
      ...
      for (int i_13 = 0; i_13 < 8; ++i_13) {
        *(uint1*)(xt_local_v0 + (i_13 * 2)) = *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + ((((((((int)threadIdx.x) >> 5) * 512) + ((i_13 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_13 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      }
      {
      ...
      for (int i_18 = 0; i_18 < 8; ++i_18) {
        *(uint1*)(xt_local_v1 + (i_18 * 2)) = *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + (((((((((int)threadIdx.x) >> 5) * 512) + ((i_18 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_18 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 2048));
      }
      {
    ...
    for (int i_19 = 0; i_19 < 8; ++i_19) {
      *(uint1*)(xt_local_v0 + (i_19 * 2)) = *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + ((((((((int)threadIdx.x) >> 5) * 512) + ((i_19 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_19 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    }
    {
    ...
    for (int i_20 = 0; i_20 < 8; ++i_20) {
      *(uint1*)(xt_local_v1 + (i_20 * 2)) = *(uint1*)(((half_t*)xt_local_wsp_handoff_4) + (((((((((int)threadIdx.x) >> 5) * 512) + ((i_20 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_20 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 2048));
    }
    {
