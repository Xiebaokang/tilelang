  ...
  if (((int)threadIdx.x) < 128) {
    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int ik_1 = 0; ik_1 < 7; ++ik_1) {
        ...
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          overlap_plan_mbar[(((ik_1 + 1) & 1) + 7)].arrive_and_expect_tx(4096);
          tl::tma_load(B_desc, overlap_plan_mbar[(((ik_1 + 1) & 1) + 7)], (&(((half_t*)b_shared)[(((ik_1 + 1) & 1) * 2048)])), (((int)blockIdx.y) * 64), ((((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 32)) + 32), 0, (((int)blockIdx.z) & 7));
        }
        ...
        }
        {
          ...
          tl::increase_descriptor_offset<int>(desc_b, ((ik_1 & 1) * 4096));
      ...
      for (int i_29 = 0; i_29 < 4; ++i_29) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_29 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_29 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc[(i_29 * 8)]), ((half_t)acc[((i_29 * 8) + 1)])), __pack_half2(((half_t)acc[((i_29 * 8) + 2)]), ((half_t)acc[((i_29 * 8) + 3)])), __pack_half2(((half_t)acc[((i_29 * 8) + 4)]), ((half_t)acc[((i_29 * 8) + 5)])), __pack_half2(((half_t)acc[((i_29 * 8) + 6)]), ((half_t)acc[((i_29 * 8) + 7)])));
      }
      tl::fence_proxy_async();
