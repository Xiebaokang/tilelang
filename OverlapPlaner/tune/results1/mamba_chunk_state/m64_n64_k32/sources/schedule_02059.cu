...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* xt_local_wsp_handoff_3 = ((void*)((char*)buf_dyn_shmem + 12288));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 8; ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(X_desc, overlap_plan_mbar[0], (&(((half_t*)x_shared)[0])), 0, (((((int)blockIdx.z) >> 3) * 256) + (ik * 32)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
      if (1 <= ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load((&(((half_t*)da_shared)[0])), (&(DA[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 32))])), overlap_plan_mbar[1], 64);
      }
      if (1 <= ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load((&(((half_t*)dt_shared)[0])), (&(Dt[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 32))])), overlap_plan_mbar[2], 64);
      }
      if (2 <= ik) {
        overlap_plan_mbar[((ik & 1) + 10)].wait((((ik >> 1) + 1) & 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((ik & 1) + 4)].arrive_and_expect_tx(4096);
        tl::tma_load(B_desc, overlap_plan_mbar[((ik & 1) + 4)], (&(((half_t*)b_shared)[((ik & 1) * 2048)])), (((int)blockIdx.y) * 64), (((((int)blockIdx.z) >> 3) * 256) + (ik * 32)), 0, (((int)blockIdx.z) & 7));
      }
    ...
    for (int ik_1 = 0; ik_1 < 8; ++ik_1) {
      ...
      for (int i_7 = 0; i_7 < 2; ++i_7) {
        tl::ptx_ldmatrix_x4((&(((half_t*)xt_local_wsp_handoff_3)[((((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (i_7 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 2048)])), (&(xt_local[(i_7 * 8)])));
      }
      {
    ...
    for (int i_8 = 0; i_8 < 4; ++i_8) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_8 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_8 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc[(i_8 * 8)]), ((half_t)acc[((i_8 * 8) + 1)])), __pack_half2(((half_t)acc[((i_8 * 8) + 2)]), ((half_t)acc[((i_8 * 8) + 3)])), __pack_half2(((half_t)acc[((i_8 * 8) + 4)]), ((half_t)acc[((i_8 * 8) + 5)])), __pack_half2(((half_t)acc[((i_8 * 8) + 6)]), ((half_t)acc[((i_8 * 8) + 7)])));
    }
    tl::fence_proxy_async();
