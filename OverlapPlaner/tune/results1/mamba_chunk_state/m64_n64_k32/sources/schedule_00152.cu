  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 8; ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(B_desc, overlap_plan_mbar[6], (&(((half_t*)b_shared)[0])), (((int)blockIdx.y) * 64), (((((int)blockIdx.z) >> 3) * 256) + (ik * 32)), 0, (((int)blockIdx.z) & 7));
      }
    ...
    for (int i_6 = 0; i_6 < 4; ++i_6) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((int)threadIdx.x) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_6 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_6 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc[(i_6 * 8)]), ((half_t)acc[((i_6 * 8) + 1)])), __pack_half2(((half_t)acc[((i_6 * 8) + 2)]), ((half_t)acc[((i_6 * 8) + 3)])), __pack_half2(((half_t)acc[((i_6 * 8) + 4)]), ((half_t)acc[((i_6 * 8) + 5)])), __pack_half2(((half_t)acc[((i_6 * 8) + 6)]), ((half_t)acc[((i_6 * 8) + 7)])));
    }
    tl::fence_proxy_async();
