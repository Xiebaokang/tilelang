  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 3; ++ik) {
      ...
      for (int i_12 = 0; i_12 < 16; ++i_12) {
        x_local[i_12] = ((half_t*)x_shared)[(((((((((((ik * 2) + 1) % 3) * 2048) + ((i_12 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_12 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_12 & 3) >> 1) + (i_12 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
      }
      overlap_plan_mbar[((((ik * 2) + 1) % 3) + 11)].arrive();
      #pragma unroll
      for (int i_13 = 0; i_13 < 16; ++i_13) {
        xt_local_v1[i_13] = ((half_t)(((float)x_local[((((i_13 >> 2) * 4) + ((i_13 & 1) * 2)) + ((i_13 & 3) >> 1))]) * scale_v1[(((i_13 >> 2) * 2) + (i_13 & 1))]));
      }
      ...
      for (int i_17 = 0; i_17 < 16; ++i_17) {
        x_local[i_17] = ((half_t*)x_shared)[(((((((((((ik * 2) + 2) % 3) * 2048) + ((i_17 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_17 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_17 & 3) >> 1) + (i_17 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
      }
      overlap_plan_mbar[((((ik * 2) + 2) % 3) + 11)].arrive();
      #pragma unroll
      for (int i_18 = 0; i_18 < 16; ++i_18) {
        xt_local_v0[i_18] = ((half_t)(((float)x_local[((((i_18 >> 2) * 4) + ((i_18 & 1) * 2)) + ((i_18 & 3) >> 1))]) * scale_v0[(((i_18 >> 2) * 2) + (i_18 & 1))]));
      }
    ...
    for (int i_20 = 0; i_20 < 16; ++i_20) {
      xt_local_v1[i_20] = ((half_t)(((float)x_local[((((i_20 >> 2) * 4) + ((i_20 & 1) * 2)) + ((i_20 & 3) >> 1))]) * scale_v1[(((i_20 >> 2) * 2) + (i_20 & 1))]));
    }
