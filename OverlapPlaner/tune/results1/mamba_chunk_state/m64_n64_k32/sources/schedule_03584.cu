  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 3; ++ik) {
      ...
      for (int i_12 = 0; i_12 < 4; ++i_12) {
        ...
        *(uint1*)(dt_shared_local_cast_5 + 0) = *(uint1*)(((half_t*)dt_shared) + ((((((ik * 2) + 2) % 3) * 32) + (i_12 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __6;
      ...
      for (int i_13 = 0; i_13 < 16; ++i_13) {
        x_local[i_13] = ((half_t*)x_shared)[(((((((((((ik * 2) + 2) % 3) * 2048) + ((i_13 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_13 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_13 & 3) >> 1) + (i_13 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
      }
      ...
      for (int i_17 = 0; i_17 < 4; ++i_17) {
        ...
        *(uint1*)(dt_shared_local_cast_7 + 0) = *(uint1*)(((half_t*)dt_shared) + (((((ik * 2) % 3) * 32) + (i_17 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __8;
      ...
      for (int i_18 = 0; i_18 < 16; ++i_18) {
        x_local[i_18] = ((half_t*)x_shared)[((((((((((ik * 2) % 3) * 2048) + ((i_18 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_18 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_18 & 3) >> 1) + (i_18 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
      }
