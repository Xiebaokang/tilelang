  ...
  if (((int)threadIdx.x) < 128) {
    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int ik_1 = 0; ik_1 < 3; ++ik_1) {
        ...
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          overlap_plan_mbar[((((ik_1 * 2) + 2) % 3) + 9)].arrive_and_expect_tx(4096);
          tl::tma_load(B_desc, overlap_plan_mbar[((((ik_1 * 2) + 2) % 3) + 9)], (&(((half_t*)b_shared)[((((ik_1 * 2) + 2) % 3) * 2048)])), (((int)blockIdx.y) * 64), ((((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)) + 64), 0, (((int)blockIdx.z) & 7));
        }
        ...
        }
        {
          ...
          tl::increase_descriptor_offset<int>(desc_b, (((ik_1 * 2) % 3) * 4096));
        ...
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          overlap_plan_mbar[(((ik_1 * 2) % 3) + 9)].arrive_and_expect_tx(4096);
          tl::tma_load(B_desc, overlap_plan_mbar[(((ik_1 * 2) % 3) + 9)], (&(((half_t*)b_shared)[(((ik_1 * 2) % 3) * 2048)])), (((int)blockIdx.y) * 64), ((((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)) + 96), 0, (((int)blockIdx.z) & 7));
        }
        ...
        }
        {
          ...
          tl::increase_descriptor_offset<int>(desc_b_1, ((((ik_1 * 2) + 1) % 3) * 4096));
