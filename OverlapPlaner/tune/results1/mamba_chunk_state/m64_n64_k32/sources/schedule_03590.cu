...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int i_4 = 0; i_4 < 4; ++i_4) {
      ...
      *(uint1*)(da_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)da_shared) + (((i_4 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 32));
      float2 __3;
    ...
    for (int i_5 = 0; i_5 < 4; ++i_5) {
      ...
      *(uint1*)(dt_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)dt_shared) + (((i_5 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 32));
      float2 __4;
    ...
    for (int ik = 0; ik < 3; ++ik) {
      ...
      overlap_plan_mbar[14].arrive();
      overlap_plan_mbar[((((ik * 2) + 2) % 3) + 5)].wait(((((ik * 2) + 2) % 6) / 3));
      #pragma unroll
      for (int i_10 = 0; i_10 < 4; ++i_10) {
        half_t dt_shared_local_cast_5[2];
        *(uint1*)(dt_shared_local_cast_5 + 0) = *(uint1*)(((half_t*)dt_shared) + ((((((ik * 2) + 2) % 3) * 32) + (i_10 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __6;
        uint1 v__5 = *(uint1*)(dt_shared_local_cast_5 + 0);
        ((float2*)(&__6))[0] = __half22float2(((half2*)(&v__5))[0]);
        *(float2*)(dt_local + (i_10 * 2)) = __6;
      }
      overlap_plan_mbar[((((ik * 2) + 2) % 3) + 16)].arrive();
      overlap_plan_mbar[(((ik * 2) + 1) % 3)].wait((((ik * 2) + 1) / 3));
      #pragma unroll
      for (int i_11 = 0; i_11 < 16; ++i_11) {
        x_local[i_11] = ((half_t*)x_shared)[(((((((((((ik * 2) + 1) % 3) * 2048) + ((i_11 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_11 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_11 & 3) >> 1) + (i_11 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
      }
      overlap_plan_mbar[((((ik * 2) + 1) % 3) + 11)].arrive();
      #pragma unroll
      ...
      for (int i_14 = 0; i_14 < 4; ++i_14) {
        ...
        *(uint1*)(da_shared_local_cast_6 + 0) = *(uint1*)(((half_t*)da_shared) + (((i_14 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 32));
        float2 __7;
      ...
      overlap_plan_mbar[15].arrive();
      overlap_plan_mbar[(((ik * 2) % 3) + 5)].wait(((((ik * 2) / 3) + 1) & 1));
      #pragma unroll
      for (int i_15 = 0; i_15 < 4; ++i_15) {
        half_t dt_shared_local_cast_7[2];
        *(uint1*)(dt_shared_local_cast_7 + 0) = *(uint1*)(((half_t*)dt_shared) + (((((ik * 2) % 3) * 32) + (i_15 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __8;
      ...
      for (int i_16 = 0; i_16 < 16; ++i_16) {
        x_local[i_16] = ((half_t*)x_shared)[(((((((((((ik * 2) + 2) % 3) * 2048) + ((i_16 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_16 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_16 & 3) >> 1) + (i_16 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
      }
    ...
    for (int ik_1 = 0; ik_1 < 7; ++ik_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[(((ik_1 + 1) & 1) + 3)].arrive_and_expect_tx(64);
        tl::tma_load((&(((half_t*)da_shared)[(((ik_1 + 1) & 1) * 32)])), (&(DA[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik_1 * 32)) + 32)])), overlap_plan_mbar[(((ik_1 + 1) & 1) + 3)], 64);
      }
      if (2 <= ik_1) {
        overlap_plan_mbar[(((ik_1 + 1) % 3) + 16)].wait(((ik_1 - 2) / 3));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[((ik_1 % 3) + 8)].arrive_and_expect_tx(4096);
        tl::tma_load(B_desc, overlap_plan_mbar[((ik_1 % 3) + 8)], (&(((half_t*)b_shared)[((ik_1 % 3) * 2048)])), (((int)blockIdx.y) * 64), (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 32)), 0, (((int)blockIdx.z) & 7));
      }
    }
