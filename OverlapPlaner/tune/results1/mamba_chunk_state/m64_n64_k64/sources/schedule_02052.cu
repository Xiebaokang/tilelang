...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 2; ++ik) {
      ...
      overlap_plan_mbar[((ik + 2) % 3)].wait(((ik + 2) / 3));
      if (ik == 0) {
        #pragma unroll
        for (int i_14 = 0; i_14 < 32; ++i_14) {
          x_local_v0[i_14] = ((half_t*)x_shared)[(((((((((ik * 4096) + ((i_14 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_14 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_14 & 3) >> 1) + (i_14 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) + 8192)];
        }
      } else {
        #pragma unroll
        for (int i_15 = 0; i_15 < 32; ++i_15) {
          x_local_v1[i_15] = ((half_t*)x_shared)[((((((((((ik + 2) % 3) * 4096) + ((i_15 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_15 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_15 & 3) >> 1) + (i_15 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
        }
      }
      overlap_plan_mbar[(((ik + 2) % 3) + 9)].arrive();
      if (((ik + 1) % 2) == 0) {
        #pragma unroll
    ...
    for (int ik_1 = 0; ik_1 < 4; ++ik_1) {
      if (ik_1 == 3) {
        overlap_plan_mbar[((ik_1 % 3) + 9)].wait(0);
      }
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[((ik_1 & 1) + 3)].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)da_shared)[((ik_1 & 1) * 64)])), (&(DA[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik_1 * 64))])), overlap_plan_mbar[((ik_1 & 1) + 3)], 128);
      }
      if (2 <= ik_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[((ik_1 & 1) + 7)].arrive_and_expect_tx(8192);
        tl::tma_load(B_desc, overlap_plan_mbar[((ik_1 & 1) + 7)], (&(((half_t*)b_shared)[((ik_1 & 1) * 4096)])), (((int)blockIdx.y) * 64), (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)), 0, (((int)blockIdx.z) & 7));
      }
    }
  }
}
