...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* scale_wsp_handoff_4 = ((void*)((char*)buf_dyn_shmem + 41984));
  void* da_shared = ((void*)((char*)buf_dyn_shmem + 43008));
  void* dt_shared = ((void*)((char*)buf_dyn_shmem + 44032));
  void* acc_shared = ((void*)((char*)buf_dyn_shmem + 45056));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 1; ++ik) {
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(X_desc, overlap_plan_mbar[2], (&(((half_t*)x_shared)[4096])), 0, (((((int)blockIdx.z) >> 3) * 256) + 64), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
        overlap_plan_mbar[4].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)da_shared)[64])), (&(DA[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + 64)])), overlap_plan_mbar[4], 128);
      ...
      for (int i_2 = 0; i_2 < 8; ++i_2) {
        *(float2*)(scale_v0 + (i_2 * 2)) = *(float2*)(((float*)scale_wsp_handoff_4) + ((i_2 * 8) + ((((int)threadIdx.x) & 3) * 2)));
      }
      #pragma unroll
      for (int i_3 = 0; i_3 < 32; ++i_3) {
        xt_local[i_3] = ((half_t)(((float)x_local[((((i_3 >> 2) * 4) + ((i_3 & 1) * 2)) + ((i_3 & 3) >> 1))]) * scale_v0[(((i_3 >> 2) * 2) + (i_3 & 1))]));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[10].arrive_and_expect_tx(8192);
        tl::tma_load(B_desc, overlap_plan_mbar[10], (&(((half_t*)b_shared)[4096])), (((int)blockIdx.y) * 64), (((((int)blockIdx.z) >> 3) * 256) + 64), 0, (((int)blockIdx.z) & 7));
      }
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[3].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)da_shared)[0])), (&(DA[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + 128)])), overlap_plan_mbar[3], 128);
      }
      overlap_plan_mbar[16].wait(0);
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[5].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)dt_shared)[0])), (&(Dt[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + 128)])), overlap_plan_mbar[5], 128);
      }
      overlap_plan_mbar[2].wait(0);
      #pragma unroll
      for (int i_4 = 0; i_4 < 32; ++i_4) {
        x_local[i_4] = ((half_t*)x_shared)[(((((((((i_4 >> 2) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_4 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_4 & 3) >> 1) + (i_4 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) + 4096)];
      }
      overlap_plan_mbar[13].arrive();
      overlap_plan_mbar[8].wait(0);
      #pragma unroll
      for (int i_5 = 0; i_5 < 8; ++i_5) {
        *(float2*)(scale_v1 + (i_5 * 2)) = *(float2*)(((float*)scale_wsp_handoff_4) + (((i_5 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 64));
      }
      #pragma unroll
      for (int i_6 = 0; i_6 < 32; ++i_6) {
        xt_local[i_6] = ((half_t)(((float)x_local[((((i_6 >> 2) * 4) + ((i_6 & 1) * 2)) + ((i_6 & 3) >> 1))]) * scale_v1[(((i_6 >> 2) * 2) + (i_6 & 1))]));
      }
      tl::__sync_thread_partial(3, 128);
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[11].arrive_and_expect_tx(8192);
        tl::tma_load(B_desc, overlap_plan_mbar[11], (&(((half_t*)b_shared)[8192])), (((int)blockIdx.y) * 64), (((((int)blockIdx.z) >> 3) * 256) + 128), 0, (((int)blockIdx.z) & 7));
      }
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[2].arrive_and_expect_tx(8192);
      tl::tma_load(X_desc, overlap_plan_mbar[2], (&(((half_t*)x_shared)[4096])), 0, (((((int)blockIdx.z) >> 3) * 256) + 192), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
    overlap_plan_mbar[15].wait(0);
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[4].arrive_and_expect_tx(128);
      tl::tma_load((&(((half_t*)da_shared)[64])), (&(DA[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + 192)])), overlap_plan_mbar[4], 128);
    }
    overlap_plan_mbar[17].wait(0);
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[6].arrive_and_expect_tx(128);
      tl::tma_load((&(((half_t*)dt_shared)[64])), (&(Dt[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + 192)])), overlap_plan_mbar[6], 128);
    }
    ...
    for (int i_8 = 0; i_8 < 8; ++i_8) {
      *(float2*)(scale_v0 + (i_8 * 2)) = *(float2*)(((float*)scale_wsp_handoff_4) + ((i_8 * 8) + ((((int)threadIdx.x) & 3) * 2)));
    }
    #pragma unroll
    for (int i_9 = 0; i_9 < 32; ++i_9) {
      xt_local[i_9] = ((half_t)(((float)x_local[((((i_9 >> 2) * 4) + ((i_9 & 1) * 2)) + ((i_9 & 3) >> 1))]) * scale_v0[(((i_9 >> 2) * 2) + (i_9 & 1))]));
    }
    ...
    for (int i_10 = 0; i_10 < 32; ++i_10) {
      x_local[i_10] = ((half_t*)x_shared)[(((((((((i_10 >> 2) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_10 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_10 & 3) >> 1) + (i_10 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) + 4096)];
    }
    overlap_plan_mbar[13].arrive();
    ...
    for (int i_12 = 0; i_12 < 32; ++i_12) {
      xt_local[i_12] = ((half_t)(((float)x_local[((((i_12 >> 2) * 4) + ((i_12 & 1) * 2)) + ((i_12 & 3) >> 1))]) * scale_v1[(((i_12 >> 2) * 2) + (i_12 & 1))]));
    }
