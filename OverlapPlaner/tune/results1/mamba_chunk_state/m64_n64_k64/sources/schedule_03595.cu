...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  float da_last[1];
  float acc[32];
  float da_local_v0[16];
  float dt_local_v0[16];
  float da_local_v1[16];
  ...
  for (int ik = 0; ik < 1; ++ik) {
    ...
    for (int i_3 = 0; i_3 < 8; ++i_3) {
      ...
      *(uint1*)(da_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)da_shared) + ((i_3 * 8) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __3;
      uint1 v__2 = *(uint1*)(da_shared_local_cast_2 + 0);
      ((float2*)(&__3))[0] = __half22float2(((half2*)(&v__2))[0]);
      *(float2*)(da_local_v1 + (i_3 * 2)) = __3;
    }
    overlap_plan_mbar[9].arrive();
    ...
    for (int i_4 = 0; i_4 < 8; ++i_4) {
      ...
      *(uint1*)(dt_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)dt_shared) + ((i_4 * 8) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __4;
      uint1 v__3 = *(uint1*)(dt_shared_local_cast_3 + 0);
      ((float2*)(&__4))[0] = __half22float2(((half2*)(&v__3))[0]);
      *(float2*)(dt_local_v1 + (i_4 * 2)) = __4;
    }
    overlap_plan_mbar[10].arrive();
    #pragma unroll
    for (int i_5 = 0; i_5 < 16; ++i_5) {
      scale[i_5] = (exp2f(((da_last[0] - da_local_v0[i_5]) * 0x1.7154764ee6c2fp+0f/*1.442695e+00*/)) * dt_local_v0[i_5]);
    }
    overlap_plan_mbar[0].wait(0);
    #pragma unroll
    for (int i_6 = 0; i_6 < 32; ++i_6) {
      x_local[i_6] = ((half_t*)x_shared)[((((((((i_6 >> 2) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_6 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_6 & 3) >> 1) + (i_6 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
    }
    overlap_plan_mbar[7].arrive();
    #pragma unroll
    for (int i_7 = 0; i_7 < 32; ++i_7) {
      xt_local[i_7] = ((half_t)(((float)x_local[((((i_7 >> 2) * 4) + ((i_7 & 1) * 2)) + ((i_7 & 3) >> 1))]) * scale[(((i_7 >> 2) * 2) + (i_7 & 1))]));
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[5].arrive_and_expect_tx(8192);
      tl::tma_load(B_desc, overlap_plan_mbar[5], (&(((half_t*)b_shared)[4096])), (((int)blockIdx.y) * 64), (((((int)blockIdx.z) >> 3) * 256) + 64), 0, (((int)blockIdx.z) & 7));
    }
    ...
    for (int i_8 = 0; i_8 < 8; ++i_8) {
      ...
      *(uint1*)(da_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)da_shared) + ((i_8 * 8) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __5;
      uint1 v__4 = *(uint1*)(da_shared_local_cast_4 + 0);
      ((float2*)(&__5))[0] = __half22float2(((half2*)(&v__4))[0]);
      *(float2*)(da_local_v0 + (i_8 * 2)) = __5;
    }
    overlap_plan_mbar[9].arrive();
    overlap_plan_mbar[3].wait(0);
    #pragma unroll
    for (int i_9 = 0; i_9 < 8; ++i_9) {
      ...
      *(uint1*)(dt_shared_local_cast_5 + 0) = *(uint1*)(((half_t*)dt_shared) + ((i_9 * 8) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __6;
      uint1 v__5 = *(uint1*)(dt_shared_local_cast_5 + 0);
      ((float2*)(&__6))[0] = __half22float2(((half2*)(&v__5))[0]);
      *(float2*)(dt_local_v0 + (i_9 * 2)) = __6;
    }
    overlap_plan_mbar[10].arrive();
    #pragma unroll
    for (int i_10 = 0; i_10 < 16; ++i_10) {
      scale[i_10] = (exp2f(((da_last[0] - da_local_v1[i_10]) * 0x1.7154764ee6c2fp+0f/*1.442695e+00*/)) * dt_local_v1[i_10]);
    }
    overlap_plan_mbar[1].wait(0);
    #pragma unroll
    for (int i_11 = 0; i_11 < 32; ++i_11) {
      x_local[i_11] = ((half_t*)x_shared)[(((((((((i_11 >> 2) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_11 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_11 & 3) >> 1) + (i_11 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) + 4096)];
    }
    overlap_plan_mbar[8].arrive();
    #pragma unroll
    for (int i_12 = 0; i_12 < 32; ++i_12) {
      xt_local[i_12] = ((half_t)(((float)x_local[((((i_12 >> 2) * 4) + ((i_12 & 1) * 2)) + ((i_12 & 3) >> 1))]) * scale[(((i_12 >> 2) * 2) + (i_12 & 1))]));
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[6].arrive_and_expect_tx(8192);
      tl::tma_load(B_desc, overlap_plan_mbar[6], (&(((half_t*)b_shared)[8192])), (((int)blockIdx.y) * 64), (((((int)blockIdx.z) >> 3) * 256) + 128), 0, (((int)blockIdx.z) & 7));
    }
  ...
  for (int i_13 = 0; i_13 < 8; ++i_13) {
    ...
    *(uint1*)(da_shared_local_cast_6 + 0) = *(uint1*)(((half_t*)da_shared) + ((i_13 * 8) + ((((int)threadIdx.x) & 3) * 2)));
    float2 __7;
    uint1 v__6 = *(uint1*)(da_shared_local_cast_6 + 0);
    ((float2*)(&__7))[0] = __half22float2(((half2*)(&v__6))[0]);
    *(float2*)(da_local_v1 + (i_13 * 2)) = __7;
  }
  overlap_plan_mbar[9].arrive();
  overlap_plan_mbar[3].wait(1);
  #pragma unroll
  for (int i_14 = 0; i_14 < 8; ++i_14) {
    ...
    *(uint1*)(dt_shared_local_cast_7 + 0) = *(uint1*)(((half_t*)dt_shared) + ((i_14 * 8) + ((((int)threadIdx.x) & 3) * 2)));
    float2 __8;
    uint1 v__7 = *(uint1*)(dt_shared_local_cast_7 + 0);
    ((float2*)(&__8))[0] = __half22float2(((half2*)(&v__7))[0]);
    *(float2*)(dt_local_v1 + (i_14 * 2)) = __8;
  }
  overlap_plan_mbar[10].arrive();
  #pragma unroll
  for (int i_15 = 0; i_15 < 16; ++i_15) {
    scale[i_15] = (exp2f(((da_last[0] - da_local_v0[i_15]) * 0x1.7154764ee6c2fp+0f/*1.442695e+00*/)) * dt_local_v0[i_15]);
  }
  overlap_plan_mbar[0].wait(1);
  #pragma unroll
  for (int i_16 = 0; i_16 < 32; ++i_16) {
    x_local[i_16] = ((half_t*)x_shared)[((((((((i_16 >> 2) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_16 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_16 & 3) >> 1) + (i_16 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
  }
  overlap_plan_mbar[7].arrive();
  #pragma unroll
  for (int i_17 = 0; i_17 < 32; ++i_17) {
    xt_local[i_17] = ((half_t)(((float)x_local[((((i_17 >> 2) * 4) + ((i_17 & 1) * 2)) + ((i_17 & 3) >> 1))]) * scale[(((i_17 >> 2) * 2) + (i_17 & 1))]));
  }
  overlap_plan_mbar[11].wait(0);
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    overlap_plan_mbar[4].arrive_and_expect_tx(8192);
    tl::tma_load(B_desc, overlap_plan_mbar[4], (&(((half_t*)b_shared)[0])), (((int)blockIdx.y) * 64), (((((int)blockIdx.z) >> 3) * 256) + 192), 0, (((int)blockIdx.z) & 7));
  }
  ...
  for (int i_18 = 0; i_18 < 16; ++i_18) {
    scale[i_18] = (exp2f(((da_last[0] - da_local_v1[i_18]) * 0x1.7154764ee6c2fp+0f/*1.442695e+00*/)) * dt_local_v1[i_18]);
  }
  overlap_plan_mbar[1].wait(1);
  #pragma unroll
  for (int i_19 = 0; i_19 < 32; ++i_19) {
    x_local[i_19] = ((half_t*)x_shared)[(((((((((i_19 >> 2) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_19 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_19 & 3) >> 1) + (i_19 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) + 4096)];
  }
  overlap_plan_mbar[8].arrive();
  #pragma unroll
  for (int i_20 = 0; i_20 < 32; ++i_20) {
    xt_local[i_20] = ((half_t)(((float)x_local[((((i_20 >> 2) * 4) + ((i_20 & 1) * 2)) + ((i_20 & 3) >> 1))]) * scale[(((i_20 >> 2) * 2) + (i_20 & 1))]));
  }
