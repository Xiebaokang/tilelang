  ...
  if (((int)threadIdx.x) < 128) {
    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int ik_1 = 0; ik_1 < 2; ++ik_1) {
        ...
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          overlap_plan_mbar[(((ik_1 + 2) % 3) + 8)].arrive_and_expect_tx(8192);
          tl::tma_load(B_desc, overlap_plan_mbar[(((ik_1 + 2) % 3) + 8)], (&(((half_t*)b_shared)[(((ik_1 + 2) % 3) * 4096)])), (((int)blockIdx.y) * 64), ((((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)) + 128), 0, (((int)blockIdx.z) & 7));
        }
        ...
        if (ik_1 == 0) {
          ...
          }
          {
            ...
            tl::increase_descriptor_offset<int>(desc_b, (ik_1 * 8192));
          ...
          }
          {
            ...
            tl::increase_descriptor_offset<int>(desc_b_1, (ik_1 * 8192));
      ...
      for (int i_35 = 0; i_35 < 4; ++i_35) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_35 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_35 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc[(i_35 * 8)]), ((half_t)acc[((i_35 * 8) + 1)])), __pack_half2(((half_t)acc[((i_35 * 8) + 2)]), ((half_t)acc[((i_35 * 8) + 3)])), __pack_half2(((half_t)acc[((i_35 * 8) + 4)]), ((half_t)acc[((i_35 * 8) + 5)])), __pack_half2(((half_t)acc[((i_35 * 8) + 6)]), ((half_t)acc[((i_35 * 8) + 7)])));
      }
      tl::fence_proxy_async();
