...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    ...
    tl::tma_load(B_desc, overlap_plan_mbar[5], (&(((half_t*)b_shared)[0])), (((int)blockIdx.y) * 64), ((((int)blockIdx.z) >> 3) * 256), 0, (((int)blockIdx.z) & 7));
  }
  ...
  for (int i_1 = 0; i_1 < 8; ++i_1) {
    ...
    *(uint1*)(dt_shared_local_cast + 0) = *(uint1*)(((half_t*)dt_shared) + ((i_1 * 8) + ((((int)threadIdx.x) & 3) * 2)));
    float2 __1;
    uint1 v_ = *(uint1*)(dt_shared_local_cast + 0);
    ((float2*)(&__1))[0] = __half22float2(((half2*)(&v_))[0]);
    *(float2*)(dt_local + (i_1 * 2)) = __1;
  }
  ...
  for (int ik = 0; ik < 3; ++ik) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[(((ik + 1) & 1) + 2)].arrive_and_expect_tx(128);
      tl::tma_load((&(((half_t*)da_shared)[(((ik + 1) & 1) * 64)])), (&(DA[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 64)) + 64)])), overlap_plan_mbar[(((ik + 1) & 1) + 2)], 128);
    }
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[(((ik + 1) % 3) + 5)].arrive_and_expect_tx(8192);
      tl::tma_load(B_desc, overlap_plan_mbar[(((ik + 1) % 3) + 5)], (&(((half_t*)b_shared)[(((ik + 1) % 3) * 4096)])), (((int)blockIdx.y) * 64), ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 64), 0, (((int)blockIdx.z) & 7));
    }
    overlap_plan_mbar[((ik & 1) + 2)].wait((ik >> 1));
    #pragma unroll
    for (int i_2 = 0; i_2 < 8; ++i_2) {
      half_t da_shared_local_cast_1[2];
      *(uint1*)(da_shared_local_cast_1 + 0) = *(uint1*)(((half_t*)da_shared) + ((((ik & 1) * 64) + (i_2 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __2;
      uint1 v__1 = *(uint1*)(da_shared_local_cast_1 + 0);
      ((float2*)(&__2))[0] = __half22float2(((half2*)(&v__1))[0]);
      *(float2*)(da_local + (i_2 * 2)) = __2;
    }
    overlap_plan_mbar[((ik & 1) + 10)].arrive();
    overlap_plan_mbar[(ik & 1)].wait((ik >> 1));
    #pragma unroll
    for (int i_3 = 0; i_3 < 32; ++i_3) {
      x_local[i_3] = ((half_t*)x_shared)[(((((((((ik & 1) * 4096) + ((i_3 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_3 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_3 & 3) >> 1) + (i_3 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
    }
    ...
    for (int i_6 = 0; i_6 < 8; ++i_6) {
      ...
      *(uint1*)(dt_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)dt_shared) + ((i_6 * 8) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __3;
      uint1 v__2 = *(uint1*)(dt_shared_local_cast_2 + 0);
      ((float2*)(&__3))[0] = __half22float2(((half2*)(&v__2))[0]);
      *(float2*)(dt_local + (i_6 * 2)) = __3;
    }
    overlap_plan_mbar[12].arrive();
  }
  ...
  for (int i_7 = 0; i_7 < 8; ++i_7) {
    half_t da_shared_local_cast_3[2];
    *(uint1*)(da_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)da_shared) + (((i_7 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 64));
    float2 __4;
    uint1 v__3 = *(uint1*)(da_shared_local_cast_3 + 0);
    ((float2*)(&__4))[0] = __half22float2(((half2*)(&v__3))[0]);
    *(float2*)(da_local + (i_7 * 2)) = __4;
  }
  ...
  for (int i_11 = 0; i_11 < 4; ++i_11) {
    tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((int)threadIdx.x) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_11 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_11 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc[(i_11 * 8)]), ((half_t)acc[((i_11 * 8) + 1)])), __pack_half2(((half_t)acc[((i_11 * 8) + 2)]), ((half_t)acc[((i_11 * 8) + 3)])), __pack_half2(((half_t)acc[((i_11 * 8) + 4)]), ((half_t)acc[((i_11 * 8) + 5)])), __pack_half2(((half_t)acc[((i_11 * 8) + 6)]), ((half_t)acc[((i_11 * 8) + 7)])));
  }
