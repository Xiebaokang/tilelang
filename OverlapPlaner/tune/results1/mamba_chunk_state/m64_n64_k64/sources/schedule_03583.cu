...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(__grid_constant__ const CUtensorMap B_desc, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  for (int ik = 0; ik < 1; ++ik) {
    ...
    for (int i_4 = 0; i_4 < 8; ++i_4) {
      ...
      *(uint1*)(da_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)da_shared) + ((i_4 * 8) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __3;
      uint1 v__2 = *(uint1*)(da_shared_local_cast_2 + 0);
      ((float2*)(&__3))[0] = __half22float2(((half2*)(&v__2))[0]);
      *(float2*)(da_local + (i_4 * 2)) = __3;
    }
    overlap_plan_mbar[7].arrive();
    ...
    for (int i_6 = 0; i_6 < 16; ++i_6) {
      scale_v1[i_6] = (exp2f(((da_last[0] - da_local[i_6]) * 0x1.7154764ee6c2fp+0f/*1.442695e+00*/)) * dt_local[i_6]);
    }
    ...
    for (int i_8 = 0; i_8 < 32; ++i_8) {
      xt_local[i_8] = ((half_t)(((float)x_local[((((i_8 >> 2) * 4) + ((i_8 & 1) * 2)) + ((i_8 & 3) >> 1))]) * scale_v0[(((i_8 >> 2) * 2) + (i_8 & 1))]));
    }
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[4].arrive_and_expect_tx(8192);
      tl::tma_load(B_desc, overlap_plan_mbar[4], (&(((half_t*)b_shared)[0])), (((int)blockIdx.y) * 64), (((((int)blockIdx.z) >> 3) * 256) + 64), 0, (((int)blockIdx.z) & 7));
    }
    ...
    for (int i_12 = 0; i_12 < 32; ++i_12) {
      x_local[i_12] = ((half_t*)x_shared)[(((((((((i_12 >> 2) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_12 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_12 & 3) >> 1) + (i_12 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) + 4096)];
    }
    overlap_plan_mbar[6].arrive();
    #pragma unroll
    for (int i_13 = 0; i_13 < 32; ++i_13) {
      xt_local[i_13] = ((half_t)(((float)x_local[((((i_13 >> 2) * 4) + ((i_13 & 1) * 2)) + ((i_13 & 3) >> 1))]) * scale_v1[(((i_13 >> 2) * 2) + (i_13 & 1))]));
    }
  ...
  for (int i_17 = 0; i_17 < 32; ++i_17) {
    x_local[i_17] = ((half_t*)x_shared)[((((((((i_17 >> 2) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_17 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_17 & 3) >> 1) + (i_17 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
  }
  overlap_plan_mbar[5].arrive();
  #pragma unroll
  for (int i_18 = 0; i_18 < 32; ++i_18) {
    xt_local[i_18] = ((half_t)(((float)x_local[((((i_18 >> 2) * 4) + ((i_18 & 1) * 2)) + ((i_18 & 3) >> 1))]) * scale_v0[(((i_18 >> 2) * 2) + (i_18 & 1))]));
  }
  overlap_plan_mbar[4].wait(0);
  {
  ...
  for (int i_20 = 0; i_20 < 32; ++i_20) {
    xt_local[i_20] = ((half_t)(((float)x_local[((((i_20 >> 2) * 4) + ((i_20 & 1) * 2)) + ((i_20 & 3) >> 1))]) * scale_v1[(((i_20 >> 2) * 2) + (i_20 & 1))]));
  }
  overlap_plan_mbar[4].wait(1);
  {
