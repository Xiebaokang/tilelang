  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < 4; ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>()) {
        ...
        tl::tma_load(X_desc, mbarrier[(ik & 1)], (&(((half_t*)x_shared)[((ik & 1) * 4096)])), 0, (((((int)blockIdx.z) >> 3) * 256) + (ik * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
      mbarrier[((ik & 1) + 10)].wait(((ik >> 1) ^ 1));
      if (tl::tl_shuffle_elect<128>()) {
        mbarrier[((ik & 1) + 2)].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)da_shared)[((ik & 1) * 64)])), (&(DA[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 64))])), mbarrier[((ik & 1) + 2)], 128);
      }
      ...
      if (tl::tl_shuffle_elect<128>()) {
        ...
        tl::tma_load(B_desc, mbarrier[((ik & 1) + 6)], (&(((half_t*)b_shared)[((ik & 1) * 4096)])), (((int)blockIdx.y) * 64), (((((int)blockIdx.z) >> 3) * 256) + (ik * 64)), 0, (((int)blockIdx.z) & 7));
      }
    }
  } else {
    ...
    for (int ik_1 = 0; ik_1 < 4; ++ik_1) {
      ...
      for (int i_1 = 0; i_1 < 8; ++i_1) {
        ...
        *(uint1*)(da_shared_local_cast + 0) = *(uint1*)(((half_t*)da_shared) + ((((ik_1 & 1) * 64) + (i_1 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __1;
      ...
      for (int i_2 = 0; i_2 < 8; ++i_2) {
        ...
        *(uint1*)(dt_shared_local_cast_1 + 0) = *(uint1*)(((half_t*)dt_shared) + ((((ik_1 & 1) * 64) + (i_2 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __2;
      ...
      for (int i_4 = 0; i_4 < 32; ++i_4) {
        x_local[i_4] = ((half_t*)x_shared)[(((((((((ik_1 & 1) * 4096) + ((i_4 >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_4 & 3) >> 1) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_4 & 3) >> 1) + (i_4 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
      }
