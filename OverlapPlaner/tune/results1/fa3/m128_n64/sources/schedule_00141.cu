  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
    ...
    for (int k = 0; k < 42; ++k) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[1].arrive_and_expect_tx(16384);
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[0])), 0, ((k * 192) + 128), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[4096])), 64, ((k * 192) + 128), ((int)blockIdx.y), 0);
      }
      #pragma unroll
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(V_desc, overlap_plan_mbar[((((k * 3) + 1) & 1) + 2)], (&(((half_t*)V_shared)[((((k * 3) + 1) & 1) * 8192)])), 0, ((k * 192) + 64), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[((((k * 3) + 1) & 1) + 2)], (&(((half_t*)V_shared)[(((((k * 3) + 1) & 1) * 8192) + 4096)])), 64, ((k * 192) + 64), ((int)blockIdx.y), 0);
      }
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[1].arrive_and_expect_tx(16384);
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[0])), 0, ((k * 192) + 192), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[4096])), 64, ((k * 192) + 192), ((int)blockIdx.y), 0);
      }
      #pragma unroll
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(V_desc, overlap_plan_mbar[((k & 1) + 2)], (&(((half_t*)V_shared)[((k & 1) * 8192)])), 0, ((k * 192) + 128), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[((k & 1) + 2)], (&(((half_t*)V_shared)[(((k & 1) * 8192) + 4096)])), 64, ((k * 192) + 128), ((int)blockIdx.y), 0);
      }
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[1].arrive_and_expect_tx(16384);
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[0])), 0, ((k * 192) + 256), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[4096])), 64, ((k * 192) + 256), ((int)blockIdx.y), 0);
      }
      #pragma unroll
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_7, broadcast_var_7);
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((((k * 3) + 1) & 1) + 2)].arrive_and_expect_tx(16384);
        tl::tma_load(V_desc, overlap_plan_mbar[((((k * 3) + 1) & 1) + 2)], (&(((half_t*)V_shared)[((((k * 3) + 1) & 1) * 8192)])), 0, ((k * 192) + 192), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[((((k * 3) + 1) & 1) + 2)], (&(((half_t*)V_shared)[(((((k * 3) + 1) & 1) * 8192) + 4096)])), 64, ((k * 192) + 192), ((int)blockIdx.y), 0);
      }
    ...
    overlap_plan_mbar[2].wait(1);
    {
      ...
      tl::initialize_wgmma_descriptor<1, 512, 64>(desc_b_8, (&(((half_t*)V_shared)[0])));
      tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(acc_s_cast_v0 + 0), 16);
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_o + 0), 128);
      tl::warpgroup_arrive();
      #pragma unroll
    ...
    overlap_plan_mbar[3].wait(1);
    {
      ...
      tl::increase_descriptor_offset<int>(desc_b_9, 16384);
      tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(acc_s_cast_v1 + 0), 16);
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_o + 0), 128);
      tl::warpgroup_arrive();
      #pragma unroll
    ...
    for (int i_47 = 0; i_47 < 8; ++i_47) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)O_shared)[(((((((int)threadIdx.x) >> 5) * 2048) + ((((int)threadIdx.x) & 15) * 128)) + (i_47 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(((half_t)acc_o[(i_47 * 8)]), ((half_t)acc_o[((i_47 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_47 * 8) + 2)]), ((half_t)acc_o[((i_47 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_47 * 8) + 4)]), ((half_t)acc_o[((i_47 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_47 * 8) + 6)]), ((half_t)acc_o[((i_47 * 8) + 7)])));
    }
