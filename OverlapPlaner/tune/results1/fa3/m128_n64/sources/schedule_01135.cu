    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
      ...
      for (int i_10 = 0; i_10 < 2; ++i_10) {
        ...
        for (int rv_2 = 0; rv_2 < 16; ++rv_2) {
          scores_max_clear_1[i_10] = max(scores_max_clear_1[i_10], acc_s_v1[((((rv_2 & 7) * 4) + (i_10 * 2)) + (rv_2 >> 3))]);
        }
      ...
      for (int i_14 = 0; i_14 < 2; ++i_14) {
        ...
        for (int rv_3 = 0; rv_3 < 16; ++rv_3) {
          scores_sum[i_14] = (scores_sum[i_14] + acc_s_v1[((((rv_3 & 7) * 4) + (i_14 * 2)) + (rv_3 >> 3))]);
        }
      ...
      overlap_plan_mbar[1].wait(((k + 1) & 1));
      {
        ...
        for (int ki_3 = 0; ki_3 < 8; ++ki_3) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, false, 1, 1>(uint64_t(desc_a_2 + (((((ki_3 >> 2) * 16384) + ((((int)threadIdx.x) >> 7) * 8192)) + ((ki_3 & 3) * 32)) >> 4)), uint64_t(desc_b_3 + ((((ki_3 >> 2) * 8192) + ((ki_3 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s_v0 + 0)), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s_v0 + 0), 64);
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
      ...
      for (int i_19 = 0; i_19 < 2; ++i_19) {
        ...
        for (int rv_4 = 0; rv_4 < 16; ++rv_4) {
          scores_max_clear_2[i_19] = max(scores_max_clear_2[i_19], acc_s_v0[((((rv_4 & 7) * 4) + (i_19 * 2)) + (rv_4 >> 3))]);
        }
      ...
      for (int i_23 = 0; i_23 < 2; ++i_23) {
        ...
        for (int rv_5 = 0; rv_5 < 16; ++rv_5) {
          scores_sum[i_23] = (scores_sum[i_23] + acc_s_v0[((((rv_5 & 7) * 4) + (i_23 * 2)) + (rv_5 >> 3))]);
        }
    ...
    overlap_plan_mbar[2].wait(1);
    {
      ...
      for (int ki_5 = 0; ki_5 < 8; ++ki_5) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, false, 1, 1>(uint64_t(desc_a_3 + (((((ki_5 >> 2) * 16384) + ((((int)threadIdx.x) >> 7) * 8192)) + ((ki_5 & 3) * 32)) >> 4)), uint64_t(desc_b_5 + ((((ki_5 >> 2) * 8192) + ((ki_5 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s_v1 + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s_v1 + 0), 64);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
    ...
    for (int i_28 = 0; i_28 < 2; ++i_28) {
      ...
      for (int rv_6 = 0; rv_6 < 16; ++rv_6) {
        scores_max_clear_3[i_28] = max(scores_max_clear_3[i_28], acc_s_v1[((((rv_6 & 7) * 4) + (i_28 * 2)) + (rv_6 >> 3))]);
      }
    ...
    for (int i_32 = 0; i_32 < 2; ++i_32) {
      ...
      for (int rv_7 = 0; rv_7 < 16; ++rv_7) {
        scores_sum[i_32] = (scores_sum[i_32] + acc_s_v1[((((rv_7 & 7) * 4) + (i_32 * 2)) + (rv_7 >> 3))]);
      }
    ...
    for (int k_1 = 0; k_1 < 128; ++k_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 8)) {
        overlap_plan_mbar[((k_1 & 1) + 1)].arrive_and_expect_tx(16384);
        tl::tma_load(K_desc, overlap_plan_mbar[((k_1 & 1) + 1)], (&(((half_t*)K_shared)[((k_1 & 1) * 8192)])), 0, (k_1 * 64), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[((k_1 & 1) + 1)], (&(((half_t*)K_shared)[(((k_1 & 1) * 8192) + 4096)])), 64, (k_1 * 64), ((int)blockIdx.y), 0);
      }
      if (2 <= k_1) {
        overlap_plan_mbar[((k_1 & 1) + 7)].wait((((k_1 >> 1) + 1) & 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 8)) {
        overlap_plan_mbar[((k_1 & 1) + 3)].arrive_and_expect_tx(16384);
        tl::tma_load(V_desc, overlap_plan_mbar[((k_1 & 1) + 3)], (&(((half_t*)V_shared)[((k_1 & 1) * 8192)])), 0, (k_1 * 64), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[((k_1 & 1) + 3)], (&(((half_t*)V_shared)[(((k_1 & 1) * 8192) + 4096)])), 64, (k_1 * 64), ((int)blockIdx.y), 0);
      }
    }
  }
}
