  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int k = 0; k < 128; ++k) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[0])), 0, (k * 64), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[4096])), 64, (k * 64), ((int)blockIdx.y), 0);
      }
      #pragma unroll
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(V_desc, overlap_plan_mbar[5], (&(((half_t*)V_shared)[0])), 0, (k * 64), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[5], (&(((half_t*)V_shared)[4096])), 64, (k * 64), ((int)blockIdx.y), 0);
      }
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    ...
    for (int i_19 = 0; i_19 < 8; ++i_19) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)O_shared)[((((((((int)threadIdx.x) >> 5) * 2048) + ((((int)threadIdx.x) & 15) * 128)) + (i_19 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 16384)])), __pack_half2(((half_t)acc_o[(i_19 * 8)]), ((half_t)acc_o[((i_19 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_19 * 8) + 2)]), ((half_t)acc_o[((i_19 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_19 * 8) + 4)]), ((half_t)acc_o[((i_19 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_19 * 8) + 6)]), ((half_t)acc_o[((i_19 * 8) + 7)])));
    }
    tl::fence_proxy_async();
