...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap K_desc, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int k = 0; k < 128; ++k) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((k % 3) + 1)].arrive_and_expect_tx(16384);
        tl::tma_load(K_desc, overlap_plan_mbar[((k % 3) + 1)], (&(((half_t*)K_shared)[((k % 3) * 8192)])), 0, (k * 64), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[((k % 3) + 1)], (&(((half_t*)K_shared)[(((k % 3) * 8192) + 4096)])), 64, (k * 64), ((int)blockIdx.y), 0);
      }
      if (3 <= k) {
        overlap_plan_mbar[((k % 3) + 11)].wait((((k / 3) + 1) & 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((k % 3) + 4)].arrive_and_expect_tx(16384);
        tl::tma_load(V_desc, overlap_plan_mbar[((k % 3) + 4)], (&(((half_t*)V_shared)[((k % 3) * 8192)])), 0, (k * 64), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[((k % 3) + 4)], (&(((half_t*)V_shared)[(((k % 3) * 8192) + 4096)])), 64, (k * 64), ((int)blockIdx.y), 0);
      }
    }
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    for (int k_1 = 0; k_1 < 128; ++k_1) {
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
      ...
      overlap_plan_mbar[((k_1 % 3) + 4)].wait(((k_1 % 6) / 3));
      {
      ...
      overlap_plan_mbar[((k_1 % 3) + 11)].arrive();
      #pragma unroll
