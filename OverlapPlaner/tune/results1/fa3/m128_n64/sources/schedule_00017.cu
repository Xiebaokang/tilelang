    ...
    if (((int)threadIdx.x) < 384) {
      ...
      for (int k_1 = 0; k_1 < 128; ++k_1) {
        ...
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 8)) {
          overlap_plan_mbar[((k_1 % 3) + 2)].arrive_and_expect_tx(16384);
          tl::tma_load(V_desc, overlap_plan_mbar[((k_1 % 3) + 2)], (&(((half_t*)V_shared)[((k_1 % 3) * 8192)])), 0, (k_1 * 64), ((int)blockIdx.y), 0);
          tl::tma_load(V_desc, overlap_plan_mbar[((k_1 % 3) + 2)], (&(((half_t*)V_shared)[(((k_1 % 3) * 8192) + 4096)])), 64, (k_1 * 64), ((int)blockIdx.y), 0);
        }
      }
    } else {
      tl::warpgroup_reg_dealloc<24>();
