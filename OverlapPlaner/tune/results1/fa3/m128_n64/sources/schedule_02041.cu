    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_1, broadcast_var_1);
    ...
    for (int k_1 = 0; k_1 < 128; ++k_1) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 8)) {
        ...
        tl::tma_load(V_desc, overlap_plan_mbar[5], (&(((half_t*)V_shared)[0])), 0, (k_1 * 64), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[5], (&(((half_t*)V_shared)[4096])), 64, (k_1 * 64), ((int)blockIdx.y), 0);
      }
