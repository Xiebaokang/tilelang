    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
    ...
    for (int k_1 = 0; k_1 < 128; ++k_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 8)) {
        ...
        tl::tma_load(K_desc, overlap_plan_mbar[((k_1 % 3) + 1)], (&(((half_t*)K_shared)[((k_1 % 3) * 8192)])), 0, (k_1 * 64), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[((k_1 % 3) + 1)], (&(((half_t*)K_shared)[(((k_1 % 3) * 8192) + 4096)])), 64, (k_1 * 64), ((int)blockIdx.y), 0);
      }
      if (2 <= k_1) {
