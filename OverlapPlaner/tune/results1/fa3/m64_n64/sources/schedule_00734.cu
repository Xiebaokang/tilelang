  ...
  if (((int)threadIdx.x) < 128) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(V_desc, overlap_plan_mbar[4], (&(((half_t*)V_shared)[0])), 0, 0, ((int)blockIdx.y), 0);
      tl::tma_load(V_desc, overlap_plan_mbar[4], (&(((half_t*)V_shared)[4096])), 64, 0, ((int)blockIdx.y), 0);
    }
    for (int k = 0; k < 63; ++k) {
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[4].arrive_and_expect_tx(16384);
        tl::tma_load(V_desc, overlap_plan_mbar[4], (&(((half_t*)V_shared)[0])), 0, ((k * 128) + 128), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[4], (&(((half_t*)V_shared)[4096])), 64, ((k * 128) + 128), ((int)blockIdx.y), 0);
      }
    }
    overlap_plan_mbar[10].wait(0);
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[5].arrive_and_expect_tx(16384);
      tl::tma_load(V_desc, overlap_plan_mbar[5], (&(((half_t*)V_shared)[8192])), 0, 8128, ((int)blockIdx.y), 0);
      tl::tma_load(V_desc, overlap_plan_mbar[5], (&(((half_t*)V_shared)[12288])), 64, 8128, ((int)blockIdx.y), 0);
    }
