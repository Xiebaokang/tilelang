    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int k = 0; k < 63; ++k) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(K_desc, overlap_plan_mbar[2], (&(((half_t*)K_shared)[8192])), 0, ((k * 128) + 64), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[2], (&(((half_t*)K_shared)[12288])), 64, ((k * 128) + 64), ((int)blockIdx.y), 0);
      }
      *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[2].arrive_and_expect_tx(16384);
      tl::tma_load(K_desc, overlap_plan_mbar[2], (&(((half_t*)K_shared)[8192])), 0, 8128, ((int)blockIdx.y), 0);
      tl::tma_load(K_desc, overlap_plan_mbar[2], (&(((half_t*)K_shared)[12288])), 64, 8128, ((int)blockIdx.y), 0);
    }
    *(float2*)(scores_max_prev + 0) = *(float2*)(scores_max + 0);
