    ...
    *(float2*)(scores_max_prev_v0 + 0) = *(float2*)(scores_max + 0);
    for (int k = 0; k < 31; ++k) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(K_desc, overlap_plan_mbar[2], (&(((half_t*)K_shared)[16384])), 0, ((k * 256) + 128), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[2], (&(((half_t*)K_shared)[24576])), 64, ((k * 256) + 128), ((int)blockIdx.y), 0);
      }
      #pragma unroll
    ...
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[2].arrive_and_expect_tx(32768);
      tl::tma_load(K_desc, overlap_plan_mbar[2], (&(((half_t*)K_shared)[16384])), 0, 8064, ((int)blockIdx.y), 0);
      tl::tma_load(K_desc, overlap_plan_mbar[2], (&(((half_t*)K_shared)[24576])), 64, 8064, ((int)blockIdx.y), 0);
    }
    #pragma unroll
