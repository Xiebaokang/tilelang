    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    ...
    overlap_plan_mbar[1].wait(0);
    {
      ...
      for (int ki = 0; ki < 8; ++ki) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 128, 16, false, false, 1, 1>(uint64_t(desc_a + ((((ki >> 2) * 8192) + ((ki & 3) * 32)) >> 4)), uint64_t(desc_b + ((((ki >> 2) * 16384) + ((ki & 3) * 32)) >> 4)), ((uint32_t*)(acc_s_v0 + 0)), 1);
      }
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int i_2 = 0; i_2 < 2; ++i_2) {
      ...
      for (int rv = 0; rv < 32; ++rv) {
        scores_max_clear[i_2] = max(scores_max_clear[i_2], acc_s_v0[((((rv & 15) * 4) + (i_2 * 2)) + (rv >> 4))]);
      }
    ...
    for (int i_6 = 0; i_6 < 2; ++i_6) {
      ...
      for (int rv_1 = 0; rv_1 < 32; ++rv_1) {
        scores_sum[i_6] = (scores_sum[i_6] + acc_s_v0[((((rv_1 & 15) * 4) + (i_6 * 2)) + (rv_1 >> 4))]);
      }
    ...
    for (int k = 0; k < 31; ++k) {
      ...
      for (int i_9 = 0; i_9 < 64; ++i_9) {
        acc_s_v1[i_9] = 0x0p+0f/*0.000000e+00*/;
      }
      overlap_plan_mbar[2].wait((k & 1));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_1, 32768);
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s_v1 + 0), 64);
        tl::warpgroup_arrive();
        #pragma unroll
        for (int ki_1 = 0; ki_1 < 8; ++ki_1) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 128, 16, false, false, 1, 1>(uint64_t(desc_a_1 + ((((ki_1 >> 2) * 8192) + ((ki_1 & 3) * 32)) >> 4)), uint64_t(desc_b_1 + ((((ki_1 >> 2) * 16384) + ((ki_1 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s_v1 + 0)), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s_v1 + 0), 64);
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
      ...
      for (int i_10 = 0; i_10 < 2; ++i_10) {
        ...
        for (int rv_2 = 0; rv_2 < 32; ++rv_2) {
          scores_max_clear_1[i_10] = max(scores_max_clear_1[i_10], acc_s_v1[((((rv_2 & 15) * 4) + (i_10 * 2)) + (rv_2 >> 4))]);
        }
      ...
      for (int i_13 = 0; i_13 < 64; ++i_13) {
        acc_s_v1[i_13] = exp2f(((acc_s_v1[i_13] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[((i_13 & 3) >> 1)] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
      }
      #pragma unroll
      for (int i_14 = 0; i_14 < 2; ++i_14) {
        ...
        for (int rv_3 = 0; rv_3 < 32; ++rv_3) {
          scores_sum[i_14] = (scores_sum[i_14] + acc_s_v1[((((rv_3 & 15) * 4) + (i_14 * 2)) + (rv_3 >> 4))]);
        }
      ...
      for (int i_16 = 0; i_16 < 16; ++i_16) {
        uint2 __1;
        float4 v_ = *(float4*)(acc_s_v0 + (i_16 * 4));
      ...
      overlap_plan_mbar[3].wait((k & 1));
      {
        ...
        tl::initialize_wgmma_descriptor<1, 1024, 64>(desc_b_2, (&(((half_t*)V_shared)[0])));
      ...
      for (int i_18 = 0; i_18 < 64; ++i_18) {
        acc_s_v0[i_18] = 0x0p+0f/*0.000000e+00*/;
      }
      overlap_plan_mbar[1].wait(((k + 1) & 1));
      {
        ...
        for (int ki_3 = 0; ki_3 < 8; ++ki_3) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 128, 16, false, false, 1, 1>(uint64_t(desc_a_2 + ((((ki_3 >> 2) * 8192) + ((ki_3 & 3) * 32)) >> 4)), uint64_t(desc_b_3 + ((((ki_3 >> 2) * 16384) + ((ki_3 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s_v0 + 0)), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s_v0 + 0), 64);
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
      ...
      for (int i_19 = 0; i_19 < 2; ++i_19) {
        ...
        for (int rv_4 = 0; rv_4 < 32; ++rv_4) {
          scores_max_clear_2[i_19] = max(scores_max_clear_2[i_19], acc_s_v0[((((rv_4 & 15) * 4) + (i_19 * 2)) + (rv_4 >> 4))]);
        }
      ...
      for (int i_22 = 0; i_22 < 64; ++i_22) {
        acc_s_v0[i_22] = exp2f(((acc_s_v0[i_22] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[((i_22 & 3) >> 1)] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
      }
      #pragma unroll
      for (int i_23 = 0; i_23 < 2; ++i_23) {
        ...
        for (int rv_5 = 0; rv_5 < 32; ++rv_5) {
          scores_sum[i_23] = (scores_sum[i_23] + acc_s_v0[((((rv_5 & 15) * 4) + (i_23 * 2)) + (rv_5 >> 4))]);
        }
    ...
    for (int i_27 = 0; i_27 < 64; ++i_27) {
      acc_s_v1[i_27] = 0x0p+0f/*0.000000e+00*/;
    }
    overlap_plan_mbar[2].wait(1);
    {
      ...
      for (int ki_5 = 0; ki_5 < 8; ++ki_5) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 128, 16, false, false, 1, 1>(uint64_t(desc_a_3 + ((((ki_5 >> 2) * 8192) + ((ki_5 & 3) * 32)) >> 4)), uint64_t(desc_b_5 + ((((ki_5 >> 2) * 16384) + ((ki_5 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s_v1 + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s_v1 + 0), 64);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
    ...
    for (int i_28 = 0; i_28 < 2; ++i_28) {
      ...
      for (int rv_6 = 0; rv_6 < 32; ++rv_6) {
        scores_max_clear_3[i_28] = max(scores_max_clear_3[i_28], acc_s_v1[((((rv_6 & 15) * 4) + (i_28 * 2)) + (rv_6 >> 4))]);
      }
    ...
    for (int i_30 = 0; i_30 < 2; ++i_30) {
      scores_scale[i_30] = exp2f(((scores_max_prev[i_30] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[i_30] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
    }
    #pragma unroll
    for (int i_31 = 0; i_31 < 64; ++i_31) {
      acc_s_v1[i_31] = exp2f(((acc_s_v1[i_31] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[((i_31 & 3) >> 1)] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
    }
    #pragma unroll
    for (int i_32 = 0; i_32 < 2; ++i_32) {
      ...
      for (int rv_7 = 0; rv_7 < 32; ++rv_7) {
        scores_sum[i_32] = (scores_sum[i_32] + acc_s_v1[((((rv_7 & 15) * 4) + (i_32 * 2)) + (rv_7 >> 4))]);
      }
    ...
    for (int k_1 = 0; k_1 < 64; ++k_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[((k_1 & 1) + 1)].arrive_and_expect_tx(32768);
        tl::tma_load(K_desc, overlap_plan_mbar[((k_1 & 1) + 1)], (&(((half_t*)K_shared)[((k_1 & 1) * 16384)])), 0, (k_1 * 128), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[((k_1 & 1) + 1)], (&(((half_t*)K_shared)[(((k_1 & 1) * 16384) + 8192)])), 64, (k_1 * 128), ((int)blockIdx.y), 0);
      }
      if (2 <= k_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        ...
        tl::tma_load(V_desc, overlap_plan_mbar[((k_1 & 1) + 3)], (&(((half_t*)V_shared)[((k_1 & 1) * 16384)])), 0, (k_1 * 128), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[((k_1 & 1) + 3)], (&(((half_t*)V_shared)[(((k_1 & 1) * 16384) + 8192)])), 64, (k_1 * 128), ((int)blockIdx.y), 0);
      }
    }
  }
}
