  ...
  if (((int)threadIdx.x) < 128) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    ...
    for (int k_1 = 0; k_1 < 63; ++k_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[(((k_1 + 1) & 1) + 3)].arrive_and_expect_tx(32768);
        tl::tma_load(V_desc, overlap_plan_mbar[(((k_1 + 1) & 1) + 3)], (&(((half_t*)V_shared)[(((k_1 + 1) & 1) * 16384)])), 0, ((k_1 * 128) + 128), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[(((k_1 + 1) & 1) + 3)], (&(((half_t*)V_shared)[((((k_1 + 1) & 1) * 16384) + 8192)])), 64, ((k_1 * 128) + 128), ((int)blockIdx.y), 0);
      }
      if (2 <= k_1) {
