    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int k_1 = 0; k_1 < 64; ++k_1) {
        ...
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          overlap_plan_mbar[((k_1 % 3) + 4)].arrive_and_expect_tx(32768);
          tl::tma_load(V_desc, overlap_plan_mbar[((k_1 % 3) + 4)], (&(((half_t*)V_shared)[((k_1 % 3) * 16384)])), 0, (k_1 * 128), ((int)blockIdx.y), 0);
          tl::tma_load(V_desc, overlap_plan_mbar[((k_1 % 3) + 4)], (&(((half_t*)V_shared)[(((k_1 % 3) * 16384) + 8192)])), 64, (k_1 * 128), ((int)blockIdx.y), 0);
        }
      }
    } else {
      tl::warpgroup_reg_dealloc<24>();
      for (int k_2 = 0; k_2 < 64; ++k_2) {
        if (3 <= k_2) {
          overlap_plan_mbar[((k_2 % 3) + 7)].wait((((k_2 / 3) + 1) & 1));
        }
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 8)) {
          overlap_plan_mbar[((k_2 % 3) + 1)].arrive_and_expect_tx(32768);
          tl::tma_load(K_desc, overlap_plan_mbar[((k_2 % 3) + 1)], (&(((half_t*)K_shared)[((k_2 % 3) * 16384)])), 0, (k_2 * 128), ((int)blockIdx.y), 0);
          tl::tma_load(K_desc, overlap_plan_mbar[((k_2 % 3) + 1)], (&(((half_t*)K_shared)[(((k_2 % 3) * 16384) + 8192)])), 64, (k_2 * 128), ((int)blockIdx.y), 0);
        }
      }
    }
  }
