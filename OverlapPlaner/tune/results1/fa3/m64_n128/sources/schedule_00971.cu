    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int k_2 = 0; k_2 < 64; ++k_2) {
        if (3 <= k_2) {
          overlap_plan_mbar[((k_2 % 3) + 10)].wait((((k_2 / 3) + 1) & 1));
        }
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 8)) {
          overlap_plan_mbar[((k_2 % 3) + 4)].arrive_and_expect_tx(32768);
          tl::tma_load(V_desc, overlap_plan_mbar[((k_2 % 3) + 4)], (&(((half_t*)V_shared)[((k_2 % 3) * 16384)])), 0, (k_2 * 128), ((int)blockIdx.y), 0);
          tl::tma_load(V_desc, overlap_plan_mbar[((k_2 % 3) + 4)], (&(((half_t*)V_shared)[(((k_2 % 3) * 16384) + 8192)])), 64, (k_2 * 128), ((int)blockIdx.y), 0);
        }
      }
    }
  }
