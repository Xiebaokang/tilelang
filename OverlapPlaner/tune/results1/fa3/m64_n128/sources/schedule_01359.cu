  ...
  if (((int)threadIdx.x) < 128) {
    ...
    *(float2*)(logsum + 0) = make_float2(broadcast_var_1, broadcast_var_1);
    ...
    for (int i_10 = 0; i_10 < 8; ++i_10) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)O_shared)[(((((((int)threadIdx.x) >> 5) * 2048) + ((((int)threadIdx.x) & 15) * 128)) + (i_10 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(((half_t)acc_o[(i_10 * 8)]), ((half_t)acc_o[((i_10 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_10 * 8) + 2)]), ((half_t)acc_o[((i_10 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_10 * 8) + 4)]), ((half_t)acc_o[((i_10 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_10 * 8) + 6)]), ((half_t)acc_o[((i_10 * 8) + 7)])));
    }
    tl::fence_proxy_async();
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    for (int k_1 = 0; k_1 < 64; ++k_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        ...
        tl::tma_load(V_desc, overlap_plan_mbar[((k_1 & 1) + 6)], (&(((half_t*)V_shared)[((k_1 & 1) * 16384)])), 0, (k_1 * 128), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[((k_1 & 1) + 6)], (&(((half_t*)V_shared)[(((k_1 & 1) * 16384) + 8192)])), 64, (k_1 * 128), ((int)blockIdx.y), 0);
      }
