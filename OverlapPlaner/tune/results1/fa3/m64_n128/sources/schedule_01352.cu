  ...
  if (((int)threadIdx.x) < 128) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var, broadcast_var);
    for (int k = 0; k < 64; ++k) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(K_desc, overlap_plan_mbar[((k & 1) + 1)], (&(((half_t*)K_shared)[((k & 1) * 16384)])), 0, (k * 128), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[((k & 1) + 1)], (&(((half_t*)K_shared)[(((k & 1) * 16384) + 8192)])), 64, (k * 128), ((int)blockIdx.y), 0);
      }
      if (2 <= k) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(V_desc, overlap_plan_mbar[((k & 1) + 6)], (&(((half_t*)V_shared)[((k & 1) * 16384)])), 0, (k * 128), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[((k & 1) + 6)], (&(((half_t*)V_shared)[(((k & 1) * 16384) + 8192)])), 64, (k * 128), ((int)blockIdx.y), 0);
      }
    ...
    *(float2*)(logsum + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int i_17 = 0; i_17 < 8; ++i_17) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)O_shared)[((((((((int)threadIdx.x) >> 5) * 2048) + ((((int)threadIdx.x) & 15) * 128)) + (i_17 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 8192)])), __pack_half2(((half_t)acc_o[(i_17 * 8)]), ((half_t)acc_o[((i_17 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_17 * 8) + 2)]), ((half_t)acc_o[((i_17 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_17 * 8) + 4)]), ((half_t)acc_o[((i_17 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_17 * 8) + 6)]), ((half_t)acc_o[((i_17 * 8) + 7)])));
    }
    tl::fence_proxy_async();
