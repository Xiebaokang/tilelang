...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap K_desc, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc) {
  ...
  void* O_shared = ((void*)((char*)buf_dyn_shmem + 114688));
  ...
  float scores_sum[2];
  half_t acc_s_cast_v0[64];
  float scores_scale_v1[2];
  half_t acc_s_cast_v1[64];
  float scores_scale_v2[2];
  half_t acc_s_cast_v2[64];
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[8192])), 64, 0, ((int)blockIdx.y), 0);
    }
    #pragma unroll
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[1].arrive_and_expect_tx(32768);
      tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[0])), 0, 128, ((int)blockIdx.y), 0);
      tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[8192])), 64, 128, ((int)blockIdx.y), 0);
    }
    #pragma unroll
    ...
    overlap_plan_mbar[1].wait(1);
    {
      ...
      for (int ki_1 = 0; ki_1 < 8; ++ki_1) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 128, 16, false, false, 1, 1>(uint64_t(desc_a_1 + ((((ki_1 >> 2) * 8192) + ((ki_1 & 3) * 32)) >> 4)), uint64_t(desc_b_1 + ((((ki_1 >> 2) * 16384) + ((ki_1 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 64);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
    ...
    for (int i_10 = 0; i_10 < 2; ++i_10) {
      ...
      for (int rv_2 = 0; rv_2 < 32; ++rv_2) {
        scores_max_clear_1[i_10] = max(scores_max_clear_1[i_10], acc_s[((((rv_2 & 15) * 4) + (i_10 * 2)) + (rv_2 >> 4))]);
      }
    ...
    for (int i_14 = 0; i_14 < 2; ++i_14) {
      ...
      for (int rv_3 = 0; rv_3 < 32; ++rv_3) {
        scores_sum[i_14] = (scores_sum[i_14] + acc_s[((((rv_3 & 15) * 4) + (i_14 * 2)) + (rv_3 >> 4))]);
      }
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(V_desc, overlap_plan_mbar[2], (&(((half_t*)V_shared)[8192])), 64, 0, ((int)blockIdx.y), 0);
    }
    for (int k = 0; k < 20; ++k) {
      overlap_plan_mbar[5].wait((((k * 3) + 1) & 1));
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[1].arrive_and_expect_tx(32768);
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[0])), 0, ((k * 384) + 256), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[8192])), 64, ((k * 384) + 256), ((int)blockIdx.y), 0);
      }
      #pragma unroll
      ...
      overlap_plan_mbar[1].wait((k & 1));
      {
        ...
        for (int ki_2 = 0; ki_2 < 8; ++ki_2) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 128, 16, false, false, 1, 1>(uint64_t(desc_a_2 + ((((ki_2 >> 2) * 8192) + ((ki_2 & 3) * 32)) >> 4)), uint64_t(desc_b_2 + ((((ki_2 >> 2) * 16384) + ((ki_2 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + 0)), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 64);
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
      ...
      for (int i_18 = 0; i_18 < 2; ++i_18) {
        scores_max_clear_2[i_18] = -CUDART_INF_F;
        #pragma unroll
        for (int rv_4 = 0; rv_4 < 32; ++rv_4) {
          scores_max_clear_2[i_18] = max(scores_max_clear_2[i_18], acc_s[((((rv_4 & 15) * 4) + (i_18 * 2)) + (rv_4 >> 4))]);
        }
        scores_max_clear_2[i_18] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<128>>::run(scores_max_clear_2[i_18]);
        scores_max[i_18] = max(scores_max[i_18], scores_max_clear_2[i_18]);
      }
      #pragma unroll
      ...
      for (int i_20 = 0; i_20 < 2; ++i_20) {
        scores_scale_v2[i_20] = exp2f(((scores_max_prev[i_20] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[i_20] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
      }
      #pragma unroll
      for (int i_21 = 0; i_21 < 64; ++i_21) {
        acc_s[i_21] = exp2f(((acc_s[i_21] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[((i_21 & 3) >> 1)] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
      }
      #pragma unroll
      for (int i_22 = 0; i_22 < 2; ++i_22) {
        ...
        for (int rv_5 = 0; rv_5 < 32; ++rv_5) {
          scores_sum[i_22] = (scores_sum[i_22] + acc_s[((((rv_5 & 15) * 4) + (i_22 * 2)) + (rv_5 >> 4))]);
        }
        scores_sum[i_22] = tl::AllReduce<tl::SumOp, 4, 1, 0, tl::NamedBarrier<128>>::run(scores_sum[i_22]);
      }
      #pragma unroll
      for (int i_23 = 0; i_23 < 2; ++i_23) {
        logsum[i_23] = ((logsum[i_23] * scores_scale_v2[i_23]) + scores_sum[i_23]);
      }
      #pragma unroll
      for (int i_24 = 0; i_24 < 16; ++i_24) {
        ...
        *(uint2*)(acc_s_cast_v2 + (i_24 * 4)) = __3;
      }
      #pragma unroll
      for (int i_25 = 0; i_25 < 64; ++i_25) {
        acc_o[i_25] = (acc_o[i_25] * scores_scale_v0[((i_25 & 3) >> 1)]);
      }
      if (1 <= k) {
        overlap_plan_mbar[((((k * 3) + 1) & 1) + 6)].wait(((((k * 3) + 3) & 3) >> 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((((k * 3) + 1) & 1) + 2)].arrive_and_expect_tx(32768);
        tl::tma_load(V_desc, overlap_plan_mbar[((((k * 3) + 1) & 1) + 2)], (&(((half_t*)V_shared)[((((k * 3) + 1) & 1) * 16384)])), 0, ((k * 384) + 128), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[((((k * 3) + 1) & 1) + 2)], (&(((half_t*)V_shared)[(((((k * 3) + 1) & 1) * 16384) + 8192)])), 64, ((k * 384) + 128), ((int)blockIdx.y), 0);
      }
      overlap_plan_mbar[((k & 1) + 2)].wait((((k * 3) & 3) >> 1));
      {
        tl::GmmaDescriptor desc_b_3;
        tl::initialize_wgmma_descriptor<1, 1024, 64>(desc_b_3, (&(((half_t*)V_shared)[0])));
        tl::increase_descriptor_offset<int>(desc_b_3, ((k & 1) * 32768));
        tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(acc_s_cast_v0 + 0), 32);
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[8192])), 64, ((k * 384) + 384), ((int)blockIdx.y), 0);
      }
      #pragma unroll
      for (int i_26 = 0; i_26 < 64; ++i_26) {
        acc_s[i_26] = 0x0p+0f/*0.000000e+00*/;
      }
      overlap_plan_mbar[1].wait((((k * 3) + 1) & 1));
      {
        ...
        for (int ki_4 = 0; ki_4 < 8; ++ki_4) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 128, 16, false, false, 1, 1>(uint64_t(desc_a_3 + ((((ki_4 >> 2) * 8192) + ((ki_4 & 3) * 32)) >> 4)), uint64_t(desc_b_4 + ((((ki_4 >> 2) * 16384) + ((ki_4 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + 0)), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 64);
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
      ...
      for (int i_27 = 0; i_27 < 2; ++i_27) {
        scores_max_clear_3[i_27] = -CUDART_INF_F;
        #pragma unroll
        for (int rv_6 = 0; rv_6 < 32; ++rv_6) {
          scores_max_clear_3[i_27] = max(scores_max_clear_3[i_27], acc_s[((((rv_6 & 15) * 4) + (i_27 * 2)) + (rv_6 >> 4))]);
        }
        scores_max_clear_3[i_27] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<128>>::run(scores_max_clear_3[i_27]);
        scores_max[i_27] = max(scores_max[i_27], scores_max_clear_3[i_27]);
      }
      #pragma unroll
      ...
      for (int i_29 = 0; i_29 < 2; ++i_29) {
        scores_scale_v0[i_29] = exp2f(((scores_max_prev[i_29] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[i_29] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
      }
      #pragma unroll
      ...
      for (int i_31 = 0; i_31 < 2; ++i_31) {
        ...
        #pragma unroll
        for (int rv_7 = 0; rv_7 < 32; ++rv_7) {
          scores_sum[i_31] = (scores_sum[i_31] + acc_s[((((rv_7 & 15) * 4) + (i_31 * 2)) + (rv_7 >> 4))]);
        }
        scores_sum[i_31] = tl::AllReduce<tl::SumOp, 4, 1, 0, tl::NamedBarrier<128>>::run(scores_sum[i_31]);
      }
      #pragma unroll
      for (int i_32 = 0; i_32 < 2; ++i_32) {
        logsum[i_32] = ((logsum[i_32] * scores_scale_v0[i_32]) + scores_sum[i_32]);
      }
      #pragma unroll
      for (int i_33 = 0; i_33 < 16; ++i_33) {
        uint2 __4;
        float4 v__3 = *(float4*)(acc_s + (i_33 * 4));
        ((half2*)(&__4))[0] = __float22half2_rn(((float2*)(&v__3))[0]);
        ((half2*)(&__4))[1] = __float22half2_rn(((float2*)(&v__3))[1]);
        *(uint2*)(acc_s_cast_v0 + (i_33 * 4)) = __4;
      }
      #pragma unroll
      for (int i_34 = 0; i_34 < 64; ++i_34) {
        acc_o[i_34] = (acc_o[i_34] * scores_scale_v1[((i_34 & 3) >> 1)]);
      }
      overlap_plan_mbar[((k & 1) + 6)].wait((((k * 3) & 3) >> 1));
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((k & 1) + 2)].arrive_and_expect_tx(32768);
        tl::tma_load(V_desc, overlap_plan_mbar[((k & 1) + 2)], (&(((half_t*)V_shared)[((k & 1) * 16384)])), 0, ((k * 384) + 256), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[((k & 1) + 2)], (&(((half_t*)V_shared)[(((k & 1) * 16384) + 8192)])), 64, ((k * 384) + 256), ((int)blockIdx.y), 0);
      }
      overlap_plan_mbar[((((k * 3) + 1) & 1) + 2)].wait(((((k * 3) + 1) & 3) >> 1));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_5, ((((k * 3) + 1) & 1) * 32768));
        tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(acc_s_cast_v1 + 0), 32);
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_o + 0), 64);
        tl::warpgroup_arrive();
        #pragma unroll
      ...
      overlap_plan_mbar[((((k * 3) + 1) & 1) + 6)].arrive();
      overlap_plan_mbar[5].wait((((k * 3) + 1) & 1));
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[1].arrive_and_expect_tx(32768);
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[0])), 0, ((k * 384) + 512), ((int)blockIdx.y), 0);
        tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[8192])), 64, ((k * 384) + 512), ((int)blockIdx.y), 0);
      }
      #pragma unroll
      for (int i_35 = 0; i_35 < 64; ++i_35) {
        acc_s[i_35] = 0x0p+0f/*0.000000e+00*/;
      }
      overlap_plan_mbar[1].wait((k & 1));
      {
        ...
        for (int ki_6 = 0; ki_6 < 8; ++ki_6) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 128, 16, false, false, 1, 1>(uint64_t(desc_a_4 + ((((ki_6 >> 2) * 8192) + ((ki_6 & 3) * 32)) >> 4)), uint64_t(desc_b_6 + ((((ki_6 >> 2) * 16384) + ((ki_6 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + 0)), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 64);
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_7, broadcast_var_7);
      ...
      for (int i_36 = 0; i_36 < 2; ++i_36) {
        scores_max_clear_4[i_36] = -CUDART_INF_F;
        #pragma unroll
        for (int rv_8 = 0; rv_8 < 32; ++rv_8) {
          scores_max_clear_4[i_36] = max(scores_max_clear_4[i_36], acc_s[((((rv_8 & 15) * 4) + (i_36 * 2)) + (rv_8 >> 4))]);
        }
        scores_max_clear_4[i_36] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<128>>::run(scores_max_clear_4[i_36]);
        scores_max[i_36] = max(scores_max[i_36], scores_max_clear_4[i_36]);
      }
      #pragma unroll
      ...
      for (int i_38 = 0; i_38 < 2; ++i_38) {
        scores_scale_v1[i_38] = exp2f(((scores_max_prev[i_38] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[i_38] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
      }
      #pragma unroll
      for (int i_39 = 0; i_39 < 64; ++i_39) {
        acc_s[i_39] = exp2f(((acc_s[i_39] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[((i_39 & 3) >> 1)] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
      }
      #pragma unroll
      for (int i_40 = 0; i_40 < 2; ++i_40) {
        scores_sum[i_40] = 0x0p+0f/*0.000000e+00*/;
        #pragma unroll
        for (int rv_9 = 0; rv_9 < 32; ++rv_9) {
          scores_sum[i_40] = (scores_sum[i_40] + acc_s[((((rv_9 & 15) * 4) + (i_40 * 2)) + (rv_9 >> 4))]);
        }
        scores_sum[i_40] = tl::AllReduce<tl::SumOp, 4, 1, 0, tl::NamedBarrier<128>>::run(scores_sum[i_40]);
      }
      #pragma unroll
      for (int i_41 = 0; i_41 < 2; ++i_41) {
        logsum[i_41] = ((logsum[i_41] * scores_scale_v1[i_41]) + scores_sum[i_41]);
      }
      #pragma unroll
      for (int i_42 = 0; i_42 < 16; ++i_42) {
        uint2 __5;
        float4 v__4 = *(float4*)(acc_s + (i_42 * 4));
        ((half2*)(&__5))[0] = __float22half2_rn(((float2*)(&v__4))[0]);
        ((half2*)(&__5))[1] = __float22half2_rn(((float2*)(&v__4))[1]);
        *(uint2*)(acc_s_cast_v1 + (i_42 * 4)) = __5;
      }
      #pragma unroll
      for (int i_43 = 0; i_43 < 64; ++i_43) {
        acc_o[i_43] = (acc_o[i_43] * scores_scale_v2[((i_43 & 3) >> 1)]);
      }
      overlap_plan_mbar[((((k * 3) + 1) & 1) + 6)].wait(((((k * 3) + 1) & 3) >> 1));
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((((k * 3) + 1) & 1) + 2)].arrive_and_expect_tx(32768);
        tl::tma_load(V_desc, overlap_plan_mbar[((((k * 3) + 1) & 1) + 2)], (&(((half_t*)V_shared)[((((k * 3) + 1) & 1) * 16384)])), 0, ((k * 384) + 384), ((int)blockIdx.y), 0);
        tl::tma_load(V_desc, overlap_plan_mbar[((((k * 3) + 1) & 1) + 2)], (&(((half_t*)V_shared)[(((((k * 3) + 1) & 1) * 16384) + 8192)])), 64, ((k * 384) + 384), ((int)blockIdx.y), 0);
      }
      overlap_plan_mbar[((k & 1) + 2)].wait(((((k * 3) >> 1) + 1) & 1));
      {
        tl::GmmaDescriptor desc_b_7;
        tl::initialize_wgmma_descriptor<1, 1024, 64>(desc_b_7, (&(((half_t*)V_shared)[0])));
        tl::increase_descriptor_offset<int>(desc_b_7, ((k & 1) * 32768));
        tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(acc_s_cast_v2 + 0), 32);
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_o + 0), 64);
        tl::warpgroup_arrive();
        #pragma unroll
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[1].arrive_and_expect_tx(32768);
      tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[0])), 0, 7936, ((int)blockIdx.y), 0);
      tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[8192])), 64, 7936, ((int)blockIdx.y), 0);
    }
    #pragma unroll
    for (int i_44 = 0; i_44 < 64; ++i_44) {
      acc_s[i_44] = 0x0p+0f/*0.000000e+00*/;
    }
    overlap_plan_mbar[1].wait(0);
    {
      ...
      for (int ki_8 = 0; ki_8 < 8; ++ki_8) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 128, 16, false, false, 1, 1>(uint64_t(desc_a_5 + ((((ki_8 >> 2) * 8192) + ((ki_8 & 3) * 32)) >> 4)), uint64_t(desc_b_8 + ((((ki_8 >> 2) * 16384) + ((ki_8 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 64);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_8, broadcast_var_8);
    ...
    for (int i_45 = 0; i_45 < 2; ++i_45) {
      scores_max_clear_5[i_45] = -CUDART_INF_F;
      #pragma unroll
      for (int rv_10 = 0; rv_10 < 32; ++rv_10) {
        scores_max_clear_5[i_45] = max(scores_max_clear_5[i_45], acc_s[((((rv_10 & 15) * 4) + (i_45 * 2)) + (rv_10 >> 4))]);
      }
      scores_max_clear_5[i_45] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<128>>::run(scores_max_clear_5[i_45]);
      scores_max[i_45] = max(scores_max[i_45], scores_max_clear_5[i_45]);
    }
    #pragma unroll
    ...
    for (int i_47 = 0; i_47 < 2; ++i_47) {
      scores_scale_v2[i_47] = exp2f(((scores_max_prev[i_47] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[i_47] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
    }
    #pragma unroll
    for (int i_48 = 0; i_48 < 64; ++i_48) {
    ...
    for (int i_49 = 0; i_49 < 2; ++i_49) {
      ...
      #pragma unroll
      for (int rv_11 = 0; rv_11 < 32; ++rv_11) {
        scores_sum[i_49] = (scores_sum[i_49] + acc_s[((((rv_11 & 15) * 4) + (i_49 * 2)) + (rv_11 >> 4))]);
      }
      scores_sum[i_49] = tl::AllReduce<tl::SumOp, 4, 1, 0, tl::NamedBarrier<128>>::run(scores_sum[i_49]);
    }
    #pragma unroll
    for (int i_50 = 0; i_50 < 2; ++i_50) {
      logsum[i_50] = ((logsum[i_50] * scores_scale_v2[i_50]) + scores_sum[i_50]);
    }
    #pragma unroll
    for (int i_51 = 0; i_51 < 16; ++i_51) {
      uint2 __6;
      float4 v__5 = *(float4*)(acc_s + (i_51 * 4));
      ((half2*)(&__6))[0] = __float22half2_rn(((float2*)(&v__5))[0]);
      ((half2*)(&__6))[1] = __float22half2_rn(((float2*)(&v__5))[1]);
      *(uint2*)(acc_s_cast_v2 + (i_51 * 4)) = __6;
    }
    #pragma unroll
    for (int i_52 = 0; i_52 < 64; ++i_52) {
      acc_o[i_52] = (acc_o[i_52] * scores_scale_v0[((i_52 & 3) >> 1)]);
    }
    overlap_plan_mbar[7].wait(1);
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[3].arrive_and_expect_tx(32768);
      tl::tma_load(V_desc, overlap_plan_mbar[3], (&(((half_t*)V_shared)[16384])), 0, 7808, ((int)blockIdx.y), 0);
      tl::tma_load(V_desc, overlap_plan_mbar[3], (&(((half_t*)V_shared)[24576])), 64, 7808, ((int)blockIdx.y), 0);
    }
    overlap_plan_mbar[2].wait(0);
    {
      tl::GmmaDescriptor desc_b_9;
      tl::initialize_wgmma_descriptor<1, 1024, 64>(desc_b_9, (&(((half_t*)V_shared)[0])));
      tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(acc_s_cast_v0 + 0), 32);
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_o + 0), 64);
      tl::warpgroup_arrive();
      #pragma unroll
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[1].arrive_and_expect_tx(32768);
      tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[0])), 0, 8064, ((int)blockIdx.y), 0);
      tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)K_shared)[8192])), 64, 8064, ((int)blockIdx.y), 0);
    }
    #pragma unroll
    for (int i_53 = 0; i_53 < 64; ++i_53) {
      acc_s[i_53] = 0x0p+0f/*0.000000e+00*/;
    }
    overlap_plan_mbar[1].wait(1);
    {
      ...
      for (int ki_10 = 0; ki_10 < 8; ++ki_10) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 128, 16, false, false, 1, 1>(uint64_t(desc_a_6 + ((((ki_10 >> 2) * 8192) + ((ki_10 & 3) * 32)) >> 4)), uint64_t(desc_b_10 + ((((ki_10 >> 2) * 16384) + ((ki_10 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s + 0), 64);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_9, broadcast_var_9);
    ...
    for (int i_54 = 0; i_54 < 2; ++i_54) {
      scores_max_clear_6[i_54] = -CUDART_INF_F;
      #pragma unroll
      for (int rv_12 = 0; rv_12 < 32; ++rv_12) {
        scores_max_clear_6[i_54] = max(scores_max_clear_6[i_54], acc_s[((((rv_12 & 15) * 4) + (i_54 * 2)) + (rv_12 >> 4))]);
      }
      scores_max_clear_6[i_54] = tl::AllReduce<tl::MaxOp, 4, 1, 0, tl::NamedBarrier<128>>::run(scores_max_clear_6[i_54]);
      scores_max[i_54] = max(scores_max[i_54], scores_max_clear_6[i_54]);
    }
    #pragma unroll
    for (int i_55 = 0; i_55 < 2; ++i_55) {
      scores_max[i_55] = max(scores_max[i_55], scores_max_prev[i_55]);
    }
    #pragma unroll
    for (int i_56 = 0; i_56 < 2; ++i_56) {
      scores_scale_v0[i_56] = exp2f(((scores_max_prev[i_56] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[i_56] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
    }
    #pragma unroll
    for (int i_57 = 0; i_57 < 64; ++i_57) {
      acc_s[i_57] = exp2f(((acc_s[i_57] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[((i_57 & 3) >> 1)] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
    }
    #pragma unroll
    for (int i_58 = 0; i_58 < 2; ++i_58) {
      scores_sum[i_58] = 0x0p+0f/*0.000000e+00*/;
      #pragma unroll
      for (int rv_13 = 0; rv_13 < 32; ++rv_13) {
        scores_sum[i_58] = (scores_sum[i_58] + acc_s[((((rv_13 & 15) * 4) + (i_58 * 2)) + (rv_13 >> 4))]);
      }
      scores_sum[i_58] = tl::AllReduce<tl::SumOp, 4, 1, 0, tl::NamedBarrier<128>>::run(scores_sum[i_58]);
    }
    #pragma unroll
    for (int i_59 = 0; i_59 < 2; ++i_59) {
      logsum[i_59] = ((logsum[i_59] * scores_scale_v0[i_59]) + scores_sum[i_59]);
    }
    #pragma unroll
    for (int i_60 = 0; i_60 < 16; ++i_60) {
      uint2 __7;
      float4 v__6 = *(float4*)(acc_s + (i_60 * 4));
      ((half2*)(&__7))[0] = __float22half2_rn(((float2*)(&v__6))[0]);
      ((half2*)(&__7))[1] = __float22half2_rn(((float2*)(&v__6))[1]);
      *(uint2*)(acc_s_cast_v0 + (i_60 * 4)) = __7;
    }
    #pragma unroll
    for (int i_61 = 0; i_61 < 64; ++i_61) {
      acc_o[i_61] = (acc_o[i_61] * scores_scale_v1[((i_61 & 3) >> 1)]);
    }
    overlap_plan_mbar[6].wait(0);
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[2].arrive_and_expect_tx(32768);
      tl::tma_load(V_desc, overlap_plan_mbar[2], (&(((half_t*)V_shared)[0])), 0, 7936, ((int)blockIdx.y), 0);
      tl::tma_load(V_desc, overlap_plan_mbar[2], (&(((half_t*)V_shared)[8192])), 64, 7936, ((int)blockIdx.y), 0);
    }
    overlap_plan_mbar[3].wait(0);
    {
      tl::GmmaDescriptor desc_b_11;
      tl::initialize_wgmma_descriptor<1, 1024, 64>(desc_b_11, (&(((half_t*)V_shared)[0])));
      tl::increase_descriptor_offset<int>(desc_b_11, 32768);
      tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(acc_s_cast_v1 + 0), 32);
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_o + 0), 64);
      tl::warpgroup_arrive();
      #pragma unroll
    ...
    for (int i_62 = 0; i_62 < 64; ++i_62) {
      acc_o[i_62] = (acc_o[i_62] * scores_scale_v2[((i_62 & 3) >> 1)]);
    }
    overlap_plan_mbar[7].wait(0);
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[3].arrive_and_expect_tx(32768);
      tl::tma_load(V_desc, overlap_plan_mbar[3], (&(((half_t*)V_shared)[16384])), 0, 8064, ((int)blockIdx.y), 0);
      tl::tma_load(V_desc, overlap_plan_mbar[3], (&(((half_t*)V_shared)[24576])), 64, 8064, ((int)blockIdx.y), 0);
    }
    overlap_plan_mbar[2].wait(1);
    {
      tl::GmmaDescriptor desc_b_12;
      tl::initialize_wgmma_descriptor<1, 1024, 64>(desc_b_12, (&(((half_t*)V_shared)[0])));
      tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(acc_s_cast_v2 + 0), 32);
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_o + 0), 64);
      tl::warpgroup_arrive();
      #pragma unroll
      for (int ki_12 = 0; ki_12 < 8; ++ki_12) {
        tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 128, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(acc_s_cast_v2 + (ki_12 * 8)), uint64_t(desc_b_12 + ((ki_12 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc_o + 0), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_o + 0), 64);
    ...
    overlap_plan_mbar[6].arrive();
    #pragma unroll
    for (int i_63 = 0; i_63 < 64; ++i_63) {
      acc_o[i_63] = (acc_o[i_63] * scores_scale_v0[((i_63 & 3) >> 1)]);
    }
    overlap_plan_mbar[3].wait(1);
    {
      tl::GmmaDescriptor desc_b_13;
      tl::initialize_wgmma_descriptor<1, 1024, 64>(desc_b_13, (&(((half_t*)V_shared)[0])));
      ...
      for (int ki_13 = 0; ki_13 < 8; ++ki_13) {
        tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 128, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(acc_s_cast_v0 + (ki_13 * 8)), uint64_t(desc_b_13 + ((ki_13 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc_o + 0), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_o + 0), 64);
    ...
    overlap_plan_mbar[7].arrive();
    #pragma unroll
    for (int i_64 = 0; i_64 < 64; ++i_64) {
      acc_o[i_64] = (acc_o[i_64] / logsum[((i_64 & 3) >> 1)]);
    }
    #pragma unroll
    for (int i_65 = 0; i_65 < 8; ++i_65) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)O_shared)[(((((((int)threadIdx.x) >> 5) * 2048) + ((((int)threadIdx.x) & 15) * 128)) + (i_65 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(((half_t)acc_o[(i_65 * 8)]), ((half_t)acc_o[((i_65 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_65 * 8) + 2)]), ((half_t)acc_o[((i_65 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_65 * 8) + 4)]), ((half_t)acc_o[((i_65 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_65 * 8) + 6)]), ((half_t)acc_o[((i_65 * 8) + 7)])));
    }
