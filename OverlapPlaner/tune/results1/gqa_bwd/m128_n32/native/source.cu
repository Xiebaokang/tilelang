...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(const float* __restrict__ Delta, __grid_constant__ const CUtensorMap K_desc, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc, __grid_constant__ const CUtensorMap dK_desc, __grid_constant__ const CUtensorMap dO_desc, float* __restrict__ dQ, __grid_constant__ const CUtensorMap dV_desc, const float* __restrict__ lse) {
  ...
  if (tl::tl_shuffle_elect<384>()) {
    ...
    tl::tma_load(K_desc, mbarrier[16], (&(((half_t*)K_shared)[0])), 0, (((int)blockIdx.y) * 128), (((int)blockIdx.x) >> 2), 0);
    mbarrier[17].arrive_and_expect_tx(16384);
    tl::tma_load(V_desc, mbarrier[17], (&(((half_t*)V_shared)[0])), 0, (((int)blockIdx.y) * 128), (((int)blockIdx.x) >> 2), 0);
  }
  if (((int)threadIdx.x) < 128) {
    ...
    for (int k = 0; k < 32; ++k) {
      ...
      if (tl::tl_shuffle_elect<128>()) {
        mbarrier[((k & 1) + 2)].arrive_and_expect_tx(4096);
        tl::tma_load(dO_desc, mbarrier[((k & 1) + 2)], (&(((half_t*)do_1)[((k & 1) * 2048)])), 0, (k * 32), ((int)blockIdx.x), 0);
      }
      mbarrier[((k & 1) + 12)].wait((((k & 3) >> 1) ^ 1));
      if (tl::tl_shuffle_elect<128>()) {
        mbarrier[((k & 1) + 4)].arrive_and_expect_tx(128);
        tl::tma_load((&(((float*)lse_shared)[((k & 1) * 32)])), (&(lse[((((int)blockIdx.x) * 1024) + (k * 32))])), mbarrier[((k & 1) + 4)], 128);
      }
      ...
      for (int i_4 = 0; i_4 < 8; ++i_4) {
        ...
        float2 __2;
          float2 __3;
            ...
            __3.x = (v_.x*v__1.x);
            __3.y = (v_.y*v__1.y);
          float2 v__2 = *(float2*)(((float*)lse_shared) + ((((k_1 & 1) * 32) + ((i_4 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
          __2.x = (__3.x-v__2.x);
          __2.y = (__3.y-v__2.y);
        __1.x = exp2f(__2.x);
        __1.y = exp2f(__2.y);
