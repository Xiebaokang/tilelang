...
extern "C" __global__ void __launch_bounds__(512, 1) main_kernel(const float* __restrict__ Delta, __grid_constant__ const CUtensorMap K_desc, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc, __grid_constant__ const CUtensorMap dK_desc, __grid_constant__ const CUtensorMap dO_desc, float* __restrict__ dQ, __grid_constant__ const CUtensorMap dV_desc, const float* __restrict__ lse) {
  ...
  void* qkT_wsp_handoff_6 = ((void*)((char*)buf_dyn_shmem + 32768));
  ...
  void* dv_shared = ((void*)((char*)buf_dyn_shmem + 71680));
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int k = 0; k < 32; ++k) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((k & 1) + 3)].arrive_and_expect_tx(4096);
        tl::tma_load(dO_desc, overlap_plan_mbar[((k & 1) + 3)], (&(((half_t*)do_1)[((k & 1) * 2048)])), 0, (k * 32), ((int)blockIdx.x), 0);
      }
      #pragma unroll
      for (int i_2 = 0; i_2 < 4; ++i_2) {
        float broadcast_var_2 = 0x0p+0f/*0.000000e+00*/;
        *(float4*)(dsT + (i_2 * 4)) = make_float4(broadcast_var_2, broadcast_var_2, broadcast_var_2, broadcast_var_2);
      }
      if (k == 0) {
      ...
      for (int i_4 = 0; i_4 < 8; ++i_4) {
        *(float2*)(((float*)qkT_wsp_handoff_6) + ((((((((int)threadIdx.x) >> 5) * 512) + ((i_4 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_4 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(qkT + (i_4 * 2));
      }
      tl::fence_proxy_async();
    ...
    for (int k_1 = 0; k_1 < 32; ++k_1) {
      ...
      for (int i_11 = 0; i_11 < 8; ++i_11) {
        *(float2*)(qkT + (i_11 * 2)) = *(float2*)(((float*)qkT_wsp_handoff_6) + (((((((((int)threadIdx.x) >> 5) * 512) + ((i_11 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_11 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
      }
      #pragma unroll
      ...
      overlap_plan_mbar[((k_1 & 1) + 3)].wait(((k_1 & 3) >> 1));
      {
