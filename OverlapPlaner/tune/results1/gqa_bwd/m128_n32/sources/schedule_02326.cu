...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(const float* __restrict__ Delta, __grid_constant__ const CUtensorMap K_desc, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc, __grid_constant__ const CUtensorMap dK_desc, __grid_constant__ const CUtensorMap dO_desc, float* __restrict__ dQ, __grid_constant__ const CUtensorMap dV_desc, const float* __restrict__ lse) {
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int k = 0; k < 15; ++k) {
      ...
      for (int i_12 = 0; i_12 < 8; ++i_12) {
        ...
        *(float2*)(delta_local_cast_1 + 0) = *(float2*)(((float*)delta) + (((i_12 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)));
        ...
        float2 __13;
          float2 __14;
            float2 v__11 = *(float2*)(qkT + (i_12 * 2));
            float2 __15;
      ...
      for (int i_20 = 0; i_20 < 8; ++i_20) {
        ...
        *(float2*)(delta_local_cast_2 + 0) = *(float2*)(((float*)delta) + (((i_20 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)));
        ...
        float2 __21;
          float2 __22;
            float2 v__19 = *(float2*)(qkT + (i_20 * 2));
            float2 __23;
      ...
      overlap_plan_mbar[13].arrive();
      {
        ...
        for (int ki_11 = 0; ki_11 < 2; ++ki_11) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(dsT_cast + (ki_11 * 8)), uint64_t(desc_b_9 + ((ki_11 * 2048) >> 4)), reinterpret_cast<uint32_t*>(dk + 0), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(dk + 0), 64);
      ...
      overlap_plan_mbar[5].wait((k & 1));
      {
        ...
        for (int ki_13 = 0; ki_13 < 2; ++ki_13) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(qkT_cast + (ki_13 * 8)), uint64_t(desc_b_10 + ((ki_13 * 2048) >> 4)), reinterpret_cast<uint32_t*>(dv + 0), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(dv + 0), 64);
      ...
      for (int i_23 = 0; i_23 < 4; ++i_23) {
        uint2 __24;
        float4 v__23 = *(float4*)(qkT + (i_23 * 4));
        ((half2*)(&__24))[0] = __float22half2_rn(((float2*)(&v__23))[0]);
        ((half2*)(&__24))[1] = __float22half2_rn(((float2*)(&v__23))[1]);
        *(uint2*)(qkT_cast + (i_23 * 4)) = __24;
      }
      #pragma unroll
    ...
    for (int i_28 = 0; i_28 < 8; ++i_28) {
      ...
      *(float2*)(delta_local_cast_3 + 0) = *(float2*)(((float*)delta) + (((i_28 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)));
      float broadcast_var_20 = 0x1p-3f/*1.250000e-01*/;
      uint1 __28;
      float2 __29;
        float2 __30;
          float2 v__27 = *(float2*)(qkT + (i_28 * 2));
          float2 __31;
    ...
    overlap_plan_mbar[13].arrive();
    {
      ...
      for (int ki_16 = 0; ki_16 < 2; ++ki_16) {
        tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(dsT_cast + (ki_16 * 8)), uint64_t(desc_b_13 + ((ki_16 * 2048) >> 4)), reinterpret_cast<uint32_t*>(dk + 0), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dk + 0), 64);
    ...
    overlap_plan_mbar[4].wait(1);
    {
      ...
      for (int ki_18 = 0; ki_18 < 2; ++ki_18) {
        tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(qkT_cast + (ki_18 * 8)), uint64_t(desc_b_14 + ((ki_18 * 2048) >> 4)), reinterpret_cast<uint32_t*>(dv + 0), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dv + 0), 64);
