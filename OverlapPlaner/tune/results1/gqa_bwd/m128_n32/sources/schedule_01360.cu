...
extern "C" __global__ void __launch_bounds__(512, 1) main_kernel(const float* __restrict__ Delta, __grid_constant__ const CUtensorMap K_desc, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc, __grid_constant__ const CUtensorMap dK_desc, __grid_constant__ const CUtensorMap dO_desc, float* __restrict__ dQ, __grid_constant__ const CUtensorMap dV_desc, const float* __restrict__ lse) {
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int k = 0; k < 32; ++k) {
      ...
      #pragma unroll
      for (int i = 0; i < 8; ++i) {
        *(float2*)(dsT + (i * 2)) = *(float2*)(((float*)dsT_wsp_handoff_4) + ((((((((int)threadIdx.x) >> 5) * 512) + ((i & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      }
      #pragma unroll
      for (int i_1 = 0; i_1 < 8; ++i_1) {
        *(float2*)(qkT + (i_1 * 2)) = *(float2*)(((float*)qkT_wsp_handoff_6) + ((((((((int)threadIdx.x) >> 5) * 512) + ((i_1 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_1 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      }
      tl::__sync_thread_partial(3, 256);
      #pragma unroll
    ...
    for (int k_1 = 0; k_1 < 32; ++k_1) {
      ...
      for (int i_8 = 0; i_8 < 4; ++i_8) {
        ...
        *(float4*)(dsT + (i_8 * 4)) = make_float4(broadcast_var_4, broadcast_var_4, broadcast_var_4, broadcast_var_4);
      }
      if (k_1 == 0) {
      ...
      for (int i_9 = 0; i_9 < 8; ++i_9) {
        *(float2*)(((float*)dsT_wsp_handoff_4) + (((((((((int)threadIdx.x) >> 5) * 512) + ((i_9 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_9 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096)) = *(float2*)(dsT + (i_9 * 2));
      }
      tl::fence_proxy_async();
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 8)) {
        ...
        tl::tma_load((&(((float*)lse_shared)[0])), (&(lse[((((int)blockIdx.x) * 1024) + (k_1 * 32))])), overlap_plan_mbar[5], 128);
      }
      ...
      for (int i_10 = 0; i_10 < 8; ++i_10) {
        ...
        float2 __6;
          float2 __7;
            float2 v__4 = *(float2*)(qkT + (i_10 * 2));
            float2 v__5 = make_float2(broadcast_var_5, broadcast_var_5);
            __7.x = (v__4.x*v__5.x);
            __7.y = (v__4.y*v__5.y);
          float2 v__6 = *(float2*)(((float*)lse_shared) + (((i_10 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)));
          __6.x = (__7.x-v__6.x);
          __6.y = (__7.y-v__6.y);
        __5.x = exp2f(__6.x);
        __5.y = exp2f(__6.y);
        *(float2*)(qkT + (i_10 * 2)) = __5;
      }
      #pragma unroll
      for (int i_11 = 0; i_11 < 8; ++i_11) {
        *(float2*)(((float*)qkT_wsp_handoff_6) + (((((((((int)threadIdx.x) >> 5) * 512) + ((i_11 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_11 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096)) = *(float2*)(qkT + (i_11 * 2));
      }
      tl::fence_proxy_async();
