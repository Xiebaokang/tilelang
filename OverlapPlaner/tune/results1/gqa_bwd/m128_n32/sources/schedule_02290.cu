  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int k = 0; k < 15; ++k) {
      ...
      for (int i_9 = 0; i_9 < 4; ++i_9) {
        ...
        *(float4*)(dsT + (i_9 * 4)) = make_float4(broadcast_var_8, broadcast_var_8, broadcast_var_8, broadcast_var_8);
      }
      ...
      for (int i_10 = 0; i_10 < 8; ++i_10) {
        ...
        float2 __9;
          float2 __10;
            float2 v__7 = *(float2*)(qkT_v1 + (i_10 * 2));
            float2 v__8 = make_float2(broadcast_var_9, broadcast_var_9);
            __10.x = (v__7.x*v__8.x);
            __10.y = (v__7.y*v__8.y);
          float2 v__9 = *(float2*)(((float*)lse_shared) + ((((i_10 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)) + 32));
          __9.x = (__10.x-v__9.x);
          __9.y = (__10.y-v__9.y);
        __8.x = exp2f(__9.x);
        __8.y = exp2f(__9.y);
        *(float2*)(qkT_v1 + (i_10 * 2)) = __8;
      }
      ...
      for (int i_18 = 0; i_18 < 8; ++i_18) {
        ...
        float2 __17;
          float2 __18;
            float2 v__15 = *(float2*)(qkT_v0 + (i_18 * 2));
            float2 v__16 = make_float2(broadcast_var_14, broadcast_var_14);
            __18.x = (v__15.x*v__16.x);
            __18.y = (v__15.y*v__16.y);
          float2 v__17 = *(float2*)(((float*)lse_shared) + (((i_18 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)));
          __17.x = (__18.x-v__17.x);
          __17.y = (__18.y-v__17.y);
        __16.x = exp2f(__17.x);
        __16.y = exp2f(__17.y);
        *(float2*)(qkT_v0 + (i_18 * 2)) = __16;
      }
      overlap_plan_mbar[16].arrive();
      #pragma unroll
    ...
    for (int i_26 = 0; i_26 < 8; ++i_26) {
      ...
      float2 __25;
        float2 __26;
          float2 v__23 = *(float2*)(qkT_v1 + (i_26 * 2));
          float2 v__24 = make_float2(broadcast_var_19, broadcast_var_19);
          __26.x = (v__23.x*v__24.x);
          __26.y = (v__23.y*v__24.y);
        float2 v__25 = *(float2*)(((float*)lse_shared) + ((((i_26 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)) + 32));
        __25.x = (__26.x-v__25.x);
        __25.y = (__26.y-v__25.y);
      __24.x = exp2f(__25.x);
      __24.y = exp2f(__25.y);
      *(float2*)(qkT_v1 + (i_26 * 2)) = __24;
    }
    overlap_plan_mbar[17].arrive();
    #pragma unroll
