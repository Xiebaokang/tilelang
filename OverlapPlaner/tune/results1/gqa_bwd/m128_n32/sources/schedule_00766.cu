  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int k = 0; k < 15; ++k) {
      ...
      for (int i_19 = 0; i_19 < 4; ++i_19) {
        ...
        *(float4*)(dsT + (i_19 * 4)) = make_float4(broadcast_var_13, broadcast_var_13, broadcast_var_13, broadcast_var_13);
      }
      overlap_plan_mbar[4].wait(0);
      {
    ...
    for (int i_27 = 0; i_27 < 4; ++i_27) {
      ...
      *(float4*)(dsT + (i_27 * 4)) = make_float4(broadcast_var_18, broadcast_var_18, broadcast_var_18, broadcast_var_18);
    }
    overlap_plan_mbar[4].wait(1);
    {
