  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int k = 0; k < 15; ++k) {
      ...
      overlap_plan_mbar[(((k * 2) % 3) + 4)].wait((((k % 3) * 2) / 3));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_5, (((k * 2) % 3) * 4096));
      ...
      overlap_plan_mbar[(((k * 2) % 3) + 15)].arrive();
      ...
      overlap_plan_mbar[((((k * 2) + 1) % 3) + 4)].wait(((((k % 3) * 2) + 1) / 3));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_9, ((((k * 2) + 1) % 3) * 4096));
      ...
      overlap_plan_mbar[((((k * 2) + 1) % 3) + 15)].arrive();
    ...
    for (int k_1 = 0; k_1 < 32; ++k_1) {
      ...
      if (3 <= k_1) {
        overlap_plan_mbar[((k_1 % 3) + 15)].wait((((k_1 / 3) + 1) & 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 8)) {
        overlap_plan_mbar[((k_1 % 3) + 4)].arrive_and_expect_tx(4096);
        tl::tma_load(dO_desc, overlap_plan_mbar[((k_1 % 3) + 4)], (&(((half_t*)do_1)[((k_1 % 3) * 2048)])), 0, (k_1 * 32), ((int)blockIdx.x), 0);
      }
      if (2 <= k_1) {
