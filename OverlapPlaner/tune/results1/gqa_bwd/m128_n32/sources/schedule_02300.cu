  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int k = 0; k < 15; ++k) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(dO_desc, overlap_plan_mbar[5], (&(((half_t*)do_1)[2048])), 0, ((k * 64) + 32), ((int)blockIdx.x), 0);
      }
      #pragma unroll
      ...
      overlap_plan_mbar[4].wait((k & 1));
      {
        ...
        for (int ki_6 = 0; ki_6 < 2; ++ki_6) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(qkT_cast_v0 + (ki_6 * 8)), uint64_t(desc_b_5 + ((ki_6 * 2048) >> 4)), reinterpret_cast<uint32_t*>(dv + 0), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(dv + 0), 64);
      ...
      for (int i_15 = 0; i_15 < 2; ++i_15) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)dsT_shared)[(((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + i_15) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(dsT_cast[(i_15 * 8)], dsT_cast[((i_15 * 8) + 1)]), __pack_half2(dsT_cast[((i_15 * 8) + 2)], dsT_cast[((i_15 * 8) + 3)]), __pack_half2(dsT_cast[((i_15 * 8) + 4)], dsT_cast[((i_15 * 8) + 5)]), __pack_half2(dsT_cast[((i_15 * 8) + 6)], dsT_cast[((i_15 * 8) + 7)]));
      }
      #pragma unroll
      ...
      for (int i_17 = 0; i_17 < 8; ++i_17) {
        AtomicAdd((&(dQ[(((((((((k * 65536) + (((((int)threadIdx.x) & 63) >> 5) * 16384)) + (((i_17 & 3) >> 1) * 8192)) + (((int)blockIdx.x) * 512)) + ((((int)threadIdx.x) >> 6) * 128)) + ((i_17 >> 2) * 64)) + ((i_17 & 1) * 32)) + (((int)threadIdx.x) & 31)) + 32768)])), dq[i_17]);
      }
      #pragma unroll
      ...
      overlap_plan_mbar[5].wait((k & 1));
      {
        ...
        for (int ki_11 = 0; ki_11 < 2; ++ki_11) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(qkT_cast_v1 + (ki_11 * 8)), uint64_t(desc_b_9 + ((ki_11 * 2048) >> 4)), reinterpret_cast<uint32_t*>(dv + 0), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(dv + 0), 64);
      ...
      for (int i_23 = 0; i_23 < 2; ++i_23) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)dsT_shared)[(((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + i_23) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(dsT_cast[(i_23 * 8)], dsT_cast[((i_23 * 8) + 1)]), __pack_half2(dsT_cast[((i_23 * 8) + 2)], dsT_cast[((i_23 * 8) + 3)]), __pack_half2(dsT_cast[((i_23 * 8) + 4)], dsT_cast[((i_23 * 8) + 5)]), __pack_half2(dsT_cast[((i_23 * 8) + 6)], dsT_cast[((i_23 * 8) + 7)]));
      }
      #pragma unroll
      ...
      for (int i_25 = 0; i_25 < 8; ++i_25) {
        AtomicAdd((&(dQ[(((((((((k * 65536) + (((((int)threadIdx.x) & 63) >> 5) * 16384)) + (((i_25 & 3) >> 1) * 8192)) + (((int)blockIdx.x) * 512)) + ((((int)threadIdx.x) >> 6) * 128)) + ((i_25 >> 2) * 64)) + ((i_25 & 1) * 32)) + (((int)threadIdx.x) & 31)) + 65536)])), dq[i_25]);
      }
    }
    #pragma unroll
    ...
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[5].arrive_and_expect_tx(4096);
      tl::tma_load(dO_desc, overlap_plan_mbar[5], (&(((half_t*)do_1)[2048])), 0, 992, ((int)blockIdx.x), 0);
    }
    #pragma unroll
    ...
    overlap_plan_mbar[4].wait(1);
    {
      ...
      for (int ki_16 = 0; ki_16 < 2; ++ki_16) {
        tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(qkT_cast_v0 + (ki_16 * 8)), uint64_t(desc_b_13 + ((ki_16 * 2048) >> 4)), reinterpret_cast<uint32_t*>(dv + 0), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dv + 0), 64);
    ...
    for (int i_31 = 0; i_31 < 2; ++i_31) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)dsT_shared)[(((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + i_31) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(dsT_cast[(i_31 * 8)], dsT_cast[((i_31 * 8) + 1)]), __pack_half2(dsT_cast[((i_31 * 8) + 2)], dsT_cast[((i_31 * 8) + 3)]), __pack_half2(dsT_cast[((i_31 * 8) + 4)], dsT_cast[((i_31 * 8) + 5)]), __pack_half2(dsT_cast[((i_31 * 8) + 6)], dsT_cast[((i_31 * 8) + 7)]));
    }
    #pragma unroll
    ...
    for (int i_33 = 0; i_33 < 8; ++i_33) {
      AtomicAdd((&(dQ[((((((((((((int)threadIdx.x) & 63) >> 5) * 16384) + (((i_33 & 3) >> 1) * 8192)) + (((int)blockIdx.x) * 512)) + ((((int)threadIdx.x) >> 6) * 128)) + ((i_33 >> 2) * 64)) + ((i_33 & 1) * 32)) + (((int)threadIdx.x) & 31)) + 1015808)])), dq[i_33]);
    }
    overlap_plan_mbar[5].wait(1);
    {
      ...
      for (int ki_19 = 0; ki_19 < 2; ++ki_19) {
        tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(qkT_cast_v1 + (ki_19 * 8)), uint64_t(desc_b_15 + ((ki_19 * 2048) >> 4)), reinterpret_cast<uint32_t*>(dv + 0), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dv + 0), 64);
