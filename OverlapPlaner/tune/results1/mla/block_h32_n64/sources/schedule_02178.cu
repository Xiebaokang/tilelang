  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int k = 0; k < 63; ++k) {
      ...
      *(float4*)(scores_max + 0) = make_float4(broadcast_var_6, broadcast_var_6, broadcast_var_6, broadcast_var_6);
      ...
      for (int i_17 = 0; i_17 < 4; ++i_17) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_1[i_17] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_17], (&(((float*)workspace)[0])));
      ...
      *(float4*)(scores_max + 0) = make_float4(broadcast_var_8, broadcast_var_8, broadcast_var_8, broadcast_var_8);
      ...
      for (int i_32 = 0; i_32 < 4; ++i_32) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_2[i_32] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_32], (&(((float*)workspace_4)[0])));
      ...
      for (int i_36 = 0; i_36 < 4; ++i_36) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_36] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_36], (&(((float*)workspace_5)[0])));
    ...
    *(float4*)(scores_max + 0) = make_float4(broadcast_var_10, broadcast_var_10, broadcast_var_10, broadcast_var_10);
    ...
    for (int i_51 = 0; i_51 < 4; ++i_51) {
      ...
      tl::__sync_thread_partial(3, 256);
      scores_sum[i_51] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_51], (&(((float*)workspace_1)[0])));
