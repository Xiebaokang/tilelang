...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap KV_desc, __grid_constant__ const CUtensorMap K_pe_desc, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap Q_pe_desc) {
  ...
  void* workspace = ((void*)((char*)buf_dyn_shmem + 192512));
  void* workspace_1 = ((void*)((char*)buf_dyn_shmem + 192512));
  void* workspace_2 = ((void*)((char*)buf_dyn_shmem + 192512));
  void* workspace_3 = ((void*)((char*)buf_dyn_shmem + 192512));
  void* workspace_4 = ((void*)((char*)buf_dyn_shmem + 192512));
  void* workspace_5 = ((void*)((char*)buf_dyn_shmem + 192512));
  void* workspace_6 = ((void*)((char*)buf_dyn_shmem + 192512));
  void* workspace_7 = ((void*)((char*)buf_dyn_shmem + 192512));
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float4*)(scores_max + 0) = make_float4(broadcast_var_4, broadcast_var_4, broadcast_var_4, broadcast_var_4);
    ...
    for (int i_6 = 0; i_6 < 4; ++i_6) {
      ...
      scores_max_clear[i_6] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear[i_6], (&(((float*)workspace_4)[0])));
    ...
    for (int k = 0; k < 63; ++k) {
      ...
      *(float4*)(scores_max + 0) = make_float4(broadcast_var_6, broadcast_var_6, broadcast_var_6, broadcast_var_6);
      ...
      for (int i_17 = 0; i_17 < 4; ++i_17) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_1[i_17] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_17], (&(((float*)workspace_2)[0])));
      ...
      *(float4*)(scores_max + 0) = make_float4(broadcast_var_8, broadcast_var_8, broadcast_var_8, broadcast_var_8);
      ...
      for (int i_33 = 0; i_33 < 4; ++i_33) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_2[i_33] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_33], (&(((float*)workspace_7)[0])));
      ...
      for (int i_37 = 0; i_37 < 4; ++i_37) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_37] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_37], (&(((float*)workspace)[0])));
    ...
    *(float4*)(scores_max + 0) = make_float4(broadcast_var_10, broadcast_var_10, broadcast_var_10, broadcast_var_10);
    ...
    for (int i_49 = 0; i_49 < 4; ++i_49) {
      ...
      tl::__sync_thread_partial(3, 256);
      scores_max_clear_3[i_49] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_3[i_49], (&(((float*)workspace_1)[0])));
    ...
    for (int i_53 = 0; i_53 < 4; ++i_53) {
      ...
      tl::__sync_thread_partial(3, 256);
      scores_sum[i_53] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_53], (&(((float*)workspace_3)[0])));
