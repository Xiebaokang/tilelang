      ...
      overlap_plan_mbar[((k_1 & 1) + 7)].wait(((k_1 & 3) >> 1));
      {
        ...
        for (int ki_2 = 0; ki_2 < 4; ++ki_2) {
          for (int i_15 = 0; i_15 < 2; ++i_15) {
            tl::ptx_ldmatrix_x4((&(((half_t*)S_shared)[(((((k_1 & 1) * 2048) + (i_15 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (ki_2 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_2 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(A_local_2[(i_15 * 8)])));
          }
