...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap KV_desc, __grid_constant__ const CUtensorMap K_pe_desc, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap Q_pe_desc) {
  ...
  void* workspace_4 = ((void*)((char*)buf_dyn_shmem + 196608));
  void* workspace_5 = ((void*)((char*)buf_dyn_shmem + 196608));
  void* workspace_6 = ((void*)((char*)buf_dyn_shmem + 196608));
  void* workspace_7 = ((void*)((char*)buf_dyn_shmem + 196608));
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float4*)(scores_max + 0) = make_float4(broadcast_var_4, broadcast_var_4, broadcast_var_4, broadcast_var_4);
    ...
    for (int i_6 = 0; i_6 < 4; ++i_6) {
      ...
      scores_max_clear[i_6] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear[i_6], (&(((float*)workspace_2)[0])));
    ...
    for (int i_10 = 0; i_10 < 4; ++i_10) {
      ...
      tl::__sync_thread_partial(3, 256);
      scores_sum[i_10] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_10], (&(((float*)workspace_5)[0])));
    ...
    for (int k = 0; k < 63; ++k) {
      ...
      overlap_plan_mbar[((((k * 2) + 1) % 3) + 9)].arrive();
      *(float4*)(scores_max_prev + 0) = *(float4*)(scores_max + 0);
      ...
      *(float4*)(scores_max + 0) = make_float4(broadcast_var_6, broadcast_var_6, broadcast_var_6, broadcast_var_6);
      ...
      for (int i_17 = 0; i_17 < 4; ++i_17) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_1[i_17] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_17], (&(((float*)workspace_7)[0])));
      ...
      for (int i_21 = 0; i_21 < 4; ++i_21) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_21] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_21], (&(((float*)workspace_6)[0])));
      ...
      for (int i_22 = 0; i_22 < 4; ++i_22) {
        logsum[i_22] = ((logsum[i_22] * scores_scale_v1[i_22]) + scores_sum[i_22]);
      }
      #pragma unroll
      for (int i_23 = 0; i_23 < 64; ++i_23) {
        acc_o[i_23] = (acc_o[i_23] * scores_scale_v0[(((i_23 >> 5) * 2) + ((i_23 & 3) >> 1))]);
      }
      overlap_plan_mbar[2].wait((k & 1));
      {
        ...
        for (int ki_4 = 0; ki_4 < 4; ++ki_4) {
          for (int i_24 = 0; i_24 < 2; ++i_24) {
            tl::ptx_ldmatrix_x4((&(((half_t*)S_shared)[(((i_24 * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (ki_4 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_4 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(A_local_4[(i_24 * 8)])));
          }
          for (int i_25 = 0; i_25 < 4; ++i_25) {
            tl::ptx_ldmatrix_x4_trans((&(((half_t*)KV_shared)[(((((((int)threadIdx.x) >> 5) * 4096) + (ki_4 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_25 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_25 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_4[(i_25 * 8)])));
          }
          for (int i_26 = 0; i_26 < 2; ++i_26) {
            for (int j = 0; j < 4; ++j) {
              tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_o + ((i_26 * 32) + (j * 8))), reinterpret_cast<const unsigned*>(A_local_4 + (i_26 * 8)), reinterpret_cast<const unsigned*>(B_local_4 + (j * 8)));
              tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_o + (((i_26 * 32) + (j * 8)) + 4)), reinterpret_cast<const unsigned*>(A_local_4 + (i_26 * 8)), reinterpret_cast<const unsigned*>(B_local_4 + ((j * 8) + 4)));
            }
          }
        }
      }
      ...
      overlap_plan_mbar[2].wait(((k + 1) & 1));
      {
        ...
        for (int i_27 = 0; i_27 < 2; ++i_27) {
          ...
          *(float4*)(acc_s_v0 + (i_27 * 4)) = make_float4(broadcast_var_7, broadcast_var_7, broadcast_var_7, broadcast_var_7);
        }
        for (int ki_5 = 0; ki_5 < 32; ++ki_5) {
          for (int i_28 = 0; i_28 < 2; ++i_28) {
            tl::ptx_ldmatrix_x4((&(((half_t*)Q_shared)[(((((ki_5 >> 2) * 2048) + (i_28 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki_5 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_5 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(A_local_5[(i_28 * 8)])));
          }
          ...
          for (int i_29 = 0; i_29 < 2; ++i_29) {
            tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_s_v0 + (i_29 * 4)), reinterpret_cast<const unsigned*>(A_local_5 + (i_29 * 8)), reinterpret_cast<const unsigned*>(B_local_5 + 0));
          }
        }
      }
      overlap_plan_mbar[((((k * 2) + 2) % 3) + 4)].wait(((((k * 2) + 2) % 6) / 3));
      {
        ...
        for (int ki_6 = 0; ki_6 < 4; ++ki_6) {
          for (int i_30 = 0; i_30 < 2; ++i_30) {
            tl::ptx_ldmatrix_x4((&(((half_t*)Q_pe_shared)[(((i_30 * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (ki_6 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_6 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(A_local_6[(i_30 * 8)])));
          }
          ...
          for (int i_31 = 0; i_31 < 2; ++i_31) {
            tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_s_v0 + (i_31 * 4)), reinterpret_cast<const unsigned*>(A_local_6 + (i_31 * 8)), reinterpret_cast<const unsigned*>(B_local_6 + 0));
          }
        }
      }
      overlap_plan_mbar[((((k * 2) + 2) % 3) + 9)].arrive();
      *(float4*)(scores_max_prev + 0) = *(float4*)(scores_max + 0);
      ...
      *(float4*)(scores_max + 0) = make_float4(broadcast_var_8, broadcast_var_8, broadcast_var_8, broadcast_var_8);
      ...
      for (int i_32 = 0; i_32 < 4; ++i_32) {
        ...
        for (int rv_4 = 0; rv_4 < 2; ++rv_4) {
          scores_max_clear_2[i_32] = max(scores_max_clear_2[i_32], acc_s_v0[((i_32 * 2) + rv_4)]);
        }
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_2[i_32] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_32], (&(((float*)workspace)[0])));
      ...
      for (int i_34 = 0; i_34 < 4; ++i_34) {
        scores_scale_v0[i_34] = exp2f(((scores_max_prev[i_34] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[i_34] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
      }
      #pragma unroll
      ...
      for (int i_36 = 0; i_36 < 4; ++i_36) {
        ...
        for (int rv_5 = 0; rv_5 < 2; ++rv_5) {
          scores_sum[i_36] = (scores_sum[i_36] + acc_s_v0[((i_36 * 2) + rv_5)]);
        }
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_36] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_36], (&(((float*)workspace_3)[0])));
      ...
      for (int i_37 = 0; i_37 < 4; ++i_37) {
        logsum[i_37] = ((logsum[i_37] * scores_scale_v0[i_37]) + scores_sum[i_37]);
      }
      #pragma unroll
      for (int i_38 = 0; i_38 < 64; ++i_38) {
        acc_o[i_38] = (acc_o[i_38] * scores_scale_v1[(((i_38 >> 5) * 2) + ((i_38 & 3) >> 1))]);
      }
      overlap_plan_mbar[3].wait((k & 1));
      {
        half_t A_local_7[16];
        ...
        for (int ki_7 = 0; ki_7 < 4; ++ki_7) {
          for (int i_39 = 0; i_39 < 2; ++i_39) {
            tl::ptx_ldmatrix_x4((&(((half_t*)S_shared)[(((i_39 * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (ki_7 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_7 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(A_local_7[(i_39 * 8)])));
          }
          for (int i_40 = 0; i_40 < 4; ++i_40) {
            tl::ptx_ldmatrix_x4_trans((&(((half_t*)KV_shared)[((((((((int)threadIdx.x) >> 5) * 4096) + (ki_7 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_40 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_40 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 32768)])), (&(B_local_7[(i_40 * 8)])));
          }
          for (int i_41 = 0; i_41 < 2; ++i_41) {
            for (int j_1 = 0; j_1 < 4; ++j_1) {
              tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_o + ((i_41 * 32) + (j_1 * 8))), reinterpret_cast<const unsigned*>(A_local_7 + (i_41 * 8)), reinterpret_cast<const unsigned*>(B_local_7 + (j_1 * 8)));
              tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_o + (((i_41 * 32) + (j_1 * 8)) + 4)), reinterpret_cast<const unsigned*>(A_local_7 + (i_41 * 8)), reinterpret_cast<const unsigned*>(B_local_7 + ((j_1 * 8) + 4)));
            }
          }
        }
      }
    ...
    overlap_plan_mbar[3].wait(1);
    {
      ...
      for (int i_42 = 0; i_42 < 2; ++i_42) {
        ...
        *(float4*)(acc_s_v1 + (i_42 * 4)) = make_float4(broadcast_var_9, broadcast_var_9, broadcast_var_9, broadcast_var_9);
      }
      for (int ki_8 = 0; ki_8 < 32; ++ki_8) {
        for (int i_43 = 0; i_43 < 2; ++i_43) {
          tl::ptx_ldmatrix_x4((&(((half_t*)Q_shared)[(((((ki_8 >> 2) * 2048) + (i_43 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki_8 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_8 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(A_local_8[(i_43 * 8)])));
        }
        ...
        for (int i_44 = 0; i_44 < 2; ++i_44) {
          tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_s_v1 + (i_44 * 4)), reinterpret_cast<const unsigned*>(A_local_8 + (i_44 * 8)), reinterpret_cast<const unsigned*>(B_local_8 + 0));
        }
      }
    }
    overlap_plan_mbar[5].wait(0);
    {
      ...
      for (int ki_9 = 0; ki_9 < 4; ++ki_9) {
        for (int i_45 = 0; i_45 < 2; ++i_45) {
          tl::ptx_ldmatrix_x4((&(((half_t*)Q_pe_shared)[(((i_45 * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (ki_9 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_9 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(A_local_9[(i_45 * 8)])));
        }
        ...
        for (int i_46 = 0; i_46 < 2; ++i_46) {
          tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_s_v1 + (i_46 * 4)), reinterpret_cast<const unsigned*>(A_local_9 + (i_46 * 8)), reinterpret_cast<const unsigned*>(B_local_9 + 0));
        }
      }
    }
    ...
    *(float4*)(scores_max + 0) = make_float4(broadcast_var_10, broadcast_var_10, broadcast_var_10, broadcast_var_10);
    ...
    for (int i_47 = 0; i_47 < 4; ++i_47) {
      ...
      for (int rv_6 = 0; rv_6 < 2; ++rv_6) {
        scores_max_clear_3[i_47] = max(scores_max_clear_3[i_47], acc_s_v1[((i_47 * 2) + rv_6)]);
      }
      tl::__sync_thread_partial(3, 256);
      scores_max_clear_3[i_47] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_3[i_47], (&(((float*)workspace_1)[0])));
    ...
    for (int i_49 = 0; i_49 < 4; ++i_49) {
      scores_scale_v1[i_49] = exp2f(((scores_max_prev[i_49] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[i_49] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
    }
    #pragma unroll
    for (int i_50 = 0; i_50 < 8; ++i_50) {
      acc_s_v1[i_50] = exp2f(((acc_s_v1[i_50] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[(i_50 >> 1)] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
    }
    #pragma unroll
    for (int i_51 = 0; i_51 < 4; ++i_51) {
      scores_sum[i_51] = 0x0p+0f/*0.000000e+00*/;
      #pragma unroll
      for (int rv_7 = 0; rv_7 < 2; ++rv_7) {
        scores_sum[i_51] = (scores_sum[i_51] + acc_s_v1[((i_51 * 2) + rv_7)]);
      }
      tl::__sync_thread_partial(3, 256);
      scores_sum[i_51] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_51], (&(((float*)workspace_4)[0])));
      scores_sum[i_51] = tl::AllReduce<tl::SumOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_sum[i_51]);
    }
    tl::ptx_stmatrix_m8n8_x4((&(((half_t*)S_shared)[((((((int)threadIdx.x) & 31) >> 3) * 512) + ((((((((int)threadIdx.x) & 31) * 64) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_s_v0[0]), ((half_t)acc_s_v0[1])), __pack_half2(((half_t)acc_s_v0[2]), ((half_t)acc_s_v0[3])), __pack_half2(((half_t)acc_s_v0[4]), ((half_t)acc_s_v0[5])), __pack_half2(((half_t)acc_s_v0[6]), ((half_t)acc_s_v0[7])));
    #pragma unroll
    ...
    for (int i_53 = 0; i_53 < 64; ++i_53) {
      acc_o[i_53] = (acc_o[i_53] * scores_scale_v0[(((i_53 >> 5) * 2) + ((i_53 & 3) >> 1))]);
    }
    overlap_plan_mbar[2].wait(1);
    {
      ...
      for (int ki_10 = 0; ki_10 < 4; ++ki_10) {
        for (int i_54 = 0; i_54 < 2; ++i_54) {
          tl::ptx_ldmatrix_x4((&(((half_t*)S_shared)[(((i_54 * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (ki_10 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_10 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(A_local_10[(i_54 * 8)])));
        }
        for (int i_55 = 0; i_55 < 4; ++i_55) {
          tl::ptx_ldmatrix_x4_trans((&(((half_t*)KV_shared)[(((((((int)threadIdx.x) >> 5) * 4096) + (ki_10 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_55 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_55 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_10[(i_55 * 8)])));
        }
    ...
    for (int i_57 = 0; i_57 < 64; ++i_57) {
      acc_o[i_57] = (acc_o[i_57] * scores_scale_v1[(((i_57 >> 5) * 2) + ((i_57 & 3) >> 1))]);
    }
    overlap_plan_mbar[3].wait(1);
    {
    ...
    for (int k_1 = 0; k_1 < 128; ++k_1) {
      ...
      if (3 <= k_1) {
        overlap_plan_mbar[((k_1 % 3) + 9)].wait((((k_1 / 3) + 1) & 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 8)) {
