    ...
    *(float4*)(logsum + 0) = make_float4(broadcast_var_1, broadcast_var_1, broadcast_var_1, broadcast_var_1);
    for (int k = 0; k < 128; ++k) {
      ...
      for (int i_1 = 0; i_1 < 4; ++i_1) {
        *(float2*)(acc_s + (i_1 * 2)) = *(float2*)(((float*)acc_s_wsp_handoff_6) + ((((i_1 * 512) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((int)threadIdx.x) >> 5) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      }
      #pragma unroll
      for (int i_2 = 0; i_2 < 4; ++i_2) {
        scores_sum[i_2] = 0x0p+0f/*0.000000e+00*/;
        #pragma unroll
        for (int rv = 0; rv < 2; ++rv) {
          scores_sum[i_2] = (scores_sum[i_2] + acc_s[((i_2 * 2) + rv)]);
        }
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_2] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_2], (&(((float*)workspace)[0])));
        scores_sum[i_2] = tl::AllReduce<tl::SumOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_sum[i_2]);
      }
      ...
      for (int i_4 = 0; i_4 < 4; ++i_4) {
        logsum[i_4] = ((logsum[i_4] * scores_scale[i_4]) + scores_sum[i_4]);
      }
      #pragma unroll
      for (int i_5 = 0; i_5 < 64; ++i_5) {
        acc_o[i_5] = (acc_o[i_5] * scores_scale[(((i_5 >> 5) * 2) + ((i_5 & 3) >> 1))]);
      }
      ...
      overlap_plan_mbar[((k & 1) + 7)].wait(((k & 3) >> 1));
      {
        ...
        for (int ki = 0; ki < 4; ++ki) {
          for (int i_6 = 0; i_6 < 2; ++i_6) {
            tl::ptx_ldmatrix_x4((&(((half_t*)S_shared)[(((((k & 1) * 2048) + (i_6 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (ki >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(A_local[(i_6 * 8)])));
          }
          for (int i_7 = 0; i_7 < 4; ++i_7) {
            tl::ptx_ldmatrix_x4_trans((&(((half_t*)KV_shared)[((((((k & 1) * 32768) + ((((int)threadIdx.x) >> 5) * 4096)) + (ki * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_7 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_7 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local[(i_7 * 8)])));
          }
          for (int i_8 = 0; i_8 < 2; ++i_8) {
            for (int j = 0; j < 4; ++j) {
              tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_o + ((i_8 * 32) + (j * 8))), reinterpret_cast<const unsigned*>(A_local + (i_8 * 8)), reinterpret_cast<const unsigned*>(B_local + (j * 8)));
              tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_o + (((i_8 * 32) + (j * 8)) + 4)), reinterpret_cast<const unsigned*>(A_local + (i_8 * 8)), reinterpret_cast<const unsigned*>(B_local + ((j * 8) + 4)));
            }
          }
        }
      }
    ...
    for (int i_9 = 0; i_9 < 64; ++i_9) {
      acc_o[i_9] = (acc_o[i_9] / logsum[(((i_9 >> 5) * 2) + ((i_9 & 3) >> 1))]);
    }
    #pragma unroll
    for (int i_10 = 0; i_10 < 8; ++i_10) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)O_shared)[((((((i_10 >> 2) * 8192) + ((((int)threadIdx.x) & 15) * 512)) + ((((int)threadIdx.x) >> 5) * 64)) + ((i_10 & 3) * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(((half_t)acc_o[(i_10 * 8)]), ((half_t)acc_o[((i_10 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_10 * 8) + 2)]), ((half_t)acc_o[((i_10 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_10 * 8) + 4)]), ((half_t)acc_o[((i_10 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_10 * 8) + 6)]), ((half_t)acc_o[((i_10 * 8) + 7)])));
    }
    ...
    for (int k_1 = 0; k_1 < 128; ++k_1) {
      ...
      overlap_plan_mbar[((k_1 & 1) + 2)].wait(((k_1 & 3) >> 1));
      {
        ...
        for (int i_11 = 0; i_11 < 2; ++i_11) {
          ...
          *(float4*)(acc_s + (i_11 * 4)) = make_float4(broadcast_var_3, broadcast_var_3, broadcast_var_3, broadcast_var_3);
        }
        for (int ki_1 = 0; ki_1 < 32; ++ki_1) {
          for (int i_12 = 0; i_12 < 2; ++i_12) {
            tl::ptx_ldmatrix_x4((&(((half_t*)Q_shared)[(((((ki_1 >> 2) * 2048) + (i_12 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki_1 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_1 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(A_local_1[(i_12 * 8)])));
          }
          ...
          for (int i_13 = 0; i_13 < 2; ++i_13) {
            tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_s + (i_13 * 4)), reinterpret_cast<const unsigned*>(A_local_1 + (i_13 * 8)), reinterpret_cast<const unsigned*>(B_local_1 + 0));
          }
        }
      }
      ...
      overlap_plan_mbar[4].wait((k_1 & 1));
      {
        ...
        for (int ki_2 = 0; ki_2 < 4; ++ki_2) {
          for (int i_14 = 0; i_14 < 2; ++i_14) {
            tl::ptx_ldmatrix_x4((&(((half_t*)Q_pe_shared)[(((i_14 * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (ki_2 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_2 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(A_local_2[(i_14 * 8)])));
          }
      ...
      *(float4*)(scores_max + 0) = make_float4(broadcast_var_4, broadcast_var_4, broadcast_var_4, broadcast_var_4);
      ...
      for (int i_16 = 0; i_16 < 4; ++i_16) {
        scores_max_clear[i_16] = -CUDART_INF_F;
        #pragma unroll
        for (int rv_1 = 0; rv_1 < 2; ++rv_1) {
          scores_max_clear[i_16] = max(scores_max_clear[i_16], acc_s[((i_16 * 2) + rv_1)]);
        }
        tl::__sync_thread_partial(4, 256);
        scores_max_clear[i_16] = tl::AllReduce<tl::MaxOp, 256, 32, 256, tl::NamedBarrier<256>>::run(scores_max_clear[i_16], (&(((float*)workspace_1)[0])));
        scores_max_clear[i_16] = tl::AllReduce<tl::MaxOp, 4, 1, 256, tl::NamedBarrier<256>>::run(scores_max_clear[i_16]);
        scores_max[i_16] = max(scores_max[i_16], scores_max_clear[i_16]);
      }
      #pragma unroll
      ...
      if ((((((int)threadIdx.x) & 3) * 8) + (((int)threadIdx.x) >> 5)) == 8) {
        ...
        for (int i_19 = 0; i_19 < 4; ++i_19) {
          ((float*)scores_scale_wsp_handoff_5)[((i_19 * 8) + ((((int)threadIdx.x) & 31) >> 2))] = scores_scale[i_19];
        }
      }
      tl::fence_proxy_async();
      ...
      for (int i_21 = 0; i_21 < 4; ++i_21) {
        *(float2*)(((float*)acc_s_wsp_handoff_6) + (((((i_21 * 512) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((int)threadIdx.x) >> 5) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 64)) = *(float2*)(acc_s + (i_21 * 2));
      }
      tl::fence_proxy_async();
      ...
      for (int i_22 = 0; i_22 < 4; ++i_22) {
        ...
        *(uint1*)(((half_t*)S_shared) + ((((((((k_1 & 1) * 2048) + (i_22 * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(S_shared_local_cast + 0);
      }
      tl::fence_proxy_async();
