...
extern "C" __global__ void __launch_bounds__(512, 1) main_kernel(__grid_constant__ const CUtensorMap KV_desc, __grid_constant__ const CUtensorMap K_pe_desc, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap Q_pe_desc) {
  ...
  void* S_shared = ((void*)((char*)buf_dyn_shmem + 167936));
  void* K_pe_shared = ((void*)((char*)buf_dyn_shmem + 180224));
  void* acc_s_wsp_handoff_6 = ((void*)((char*)buf_dyn_shmem + 188416));
  void* scores_scale_wsp_handoff_5 = ((void*)((char*)buf_dyn_shmem + 196608));
  void* workspace = ((void*)((char*)buf_dyn_shmem + 196736));
  void* workspace_1 = ((void*)((char*)buf_dyn_shmem + 197760));
    ...
    *(float4*)(scores_max + 0) = make_float4(broadcast_var, broadcast_var, broadcast_var, broadcast_var);
    for (int k = 0; k < 128; ++k) {
      if (2 <= k) {
        ...
        overlap_plan_mbar[((k & 1) + 13)].wait((((k >> 1) + 1) & 1));
      }
      ...
      overlap_plan_mbar[((k & 1) + 2)].wait(((k & 3) >> 1));
      {
        ...
        for (int i = 0; i < 2; ++i) {
          ...
          *(float4*)(acc_s + (i * 4)) = make_float4(broadcast_var_1, broadcast_var_1, broadcast_var_1, broadcast_var_1);
        }
        for (int ki = 0; ki < 32; ++ki) {
          for (int i_1 = 0; i_1 < 2; ++i_1) {
            tl::ptx_ldmatrix_x4((&(((half_t*)Q_shared)[(((((ki >> 2) * 2048) + (i_1 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(A_local[(i_1 * 8)])));
          }
          ...
          for (int i_2 = 0; i_2 < 2; ++i_2) {
            tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_s + (i_2 * 4)), reinterpret_cast<const unsigned*>(A_local + (i_2 * 8)), reinterpret_cast<const unsigned*>(B_local + 0));
          }
        }
      }
      overlap_plan_mbar[((k & 1) + 11)].arrive();
      if (k == 0) {
      ...
      overlap_plan_mbar[4].wait((k & 1));
      {
        ...
        for (int ki_1 = 0; ki_1 < 4; ++ki_1) {
          for (int i_3 = 0; i_3 < 2; ++i_3) {
            tl::ptx_ldmatrix_x4((&(((half_t*)Q_pe_shared)[(((i_3 * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (ki_1 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_1 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(A_local_1[(i_3 * 8)])));
          }
          ...
          for (int i_4 = 0; i_4 < 2; ++i_4) {
            tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_s + (i_4 * 4)), reinterpret_cast<const unsigned*>(A_local_1 + (i_4 * 8)), reinterpret_cast<const unsigned*>(B_local_1 + 0));
          }
        }
      }
      ...
      *(float4*)(scores_max + 0) = make_float4(broadcast_var_2, broadcast_var_2, broadcast_var_2, broadcast_var_2);
      ...
      for (int i_5 = 0; i_5 < 4; ++i_5) {
        ...
        for (int rv = 0; rv < 2; ++rv) {
          scores_max_clear[i_5] = max(scores_max_clear[i_5], acc_s[((i_5 * 2) + rv)]);
        }
        tl::__sync_thread_partial(3, 256);
        scores_max_clear[i_5] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear[i_5], (&(((float*)workspace)[0])));
      ...
      for (int i_7 = 0; i_7 < 4; ++i_7) {
        scores_scale[i_7] = exp2f(((scores_max_prev[i_7] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[i_7] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
      }
      if ((((((int)threadIdx.x) & 3) * 8) + (((int)threadIdx.x) >> 5)) == 0) {
        #pragma unroll
        for (int i_8 = 0; i_8 < 4; ++i_8) {
          ((float*)scores_scale_wsp_handoff_5)[((i_8 * 8) + ((((int)threadIdx.x) & 31) >> 2))] = scores_scale[i_8];
        }
      }
      ...
      for (int i_10 = 0; i_10 < 4; ++i_10) {
        *(float2*)(((float*)acc_s_wsp_handoff_6) + ((((i_10 * 512) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((int)threadIdx.x) >> 5) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(acc_s + (i_10 * 2));
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[6].arrive();
      if (3 <= k) {
        overlap_plan_mbar[((k % 3) + 16)].wait((((k / 3) + 1) & 1));
      }
      #pragma unroll
      for (int i_11 = 0; i_11 < 4; ++i_11) {
        ...
        *(uint1*)(((half_t*)S_shared) + ((((((((k % 3) * 2048) + (i_11 * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(S_shared_local_cast + 0);
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[((k % 3) + 7)].arrive();
    }
    ...
    *(float4*)(logsum + 0) = make_float4(broadcast_var_4, broadcast_var_4, broadcast_var_4, broadcast_var_4);
    for (int k_1 = 0; k_1 < 128; ++k_1) {
      ...
      for (int i_14 = 0; i_14 < 64; ++i_14) {
        acc_o[i_14] = (acc_o[i_14] * scores_scale[(((i_14 >> 5) * 2) + ((i_14 & 3) >> 1))]);
      }
      overlap_plan_mbar[((k_1 & 1) + 2)].wait(((k_1 & 3) >> 1));
      overlap_plan_mbar[((k_1 % 3) + 7)].wait(((k_1 % 6) / 3));
      {
        half_t A_local_2[16];
        half_t B_local_2[32];
        ...
        for (int ki_2 = 0; ki_2 < 4; ++ki_2) {
          for (int i_15 = 0; i_15 < 2; ++i_15) {
            tl::ptx_ldmatrix_x4((&(((half_t*)S_shared)[(((((k_1 % 3) * 2048) + (i_15 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (ki_2 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_2 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(A_local_2[(i_15 * 8)])));
          }
          for (int i_16 = 0; i_16 < 4; ++i_16) {
            tl::ptx_ldmatrix_x4_trans((&(((half_t*)KV_shared)[((((((k_1 & 1) * 32768) + (((((int)threadIdx.x) & 255) >> 5) * 4096)) + (ki_2 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_16 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_16 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_2[(i_16 * 8)])));
          }
          for (int i_17 = 0; i_17 < 2; ++i_17) {
            for (int j = 0; j < 4; ++j) {
              tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_o + ((i_17 * 32) + (j * 8))), reinterpret_cast<const unsigned*>(A_local_2 + (i_17 * 8)), reinterpret_cast<const unsigned*>(B_local_2 + (j * 8)));
              tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_o + (((i_17 * 32) + (j * 8)) + 4)), reinterpret_cast<const unsigned*>(A_local_2 + (i_17 * 8)), reinterpret_cast<const unsigned*>(B_local_2 + ((j * 8) + 4)));
            }
          }
        }
      }
      overlap_plan_mbar[((k_1 & 1) + 13)].arrive();
      overlap_plan_mbar[((k_1 % 3) + 16)].arrive();
      overlap_plan_mbar[6].wait((k_1 & 1));
      #pragma unroll
      for (int i_18 = 0; i_18 < 4; ++i_18) {
        *(float2*)(acc_s + (i_18 * 2)) = *(float2*)(((float*)acc_s_wsp_handoff_6) + (((((i_18 * 512) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((int)threadIdx.x) >> 5) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 64));
      }
      #pragma unroll
      for (int i_19 = 0; i_19 < 4; ++i_19) {
        ...
        for (int rv_1 = 0; rv_1 < 2; ++rv_1) {
          scores_sum[i_19] = (scores_sum[i_19] + acc_s[((i_19 * 2) + rv_1)]);
        }
        tl::__sync_thread_partial(4, 256);
        scores_sum[i_19] = tl::AllReduce<tl::SumOp, 256, 32, 256, tl::NamedBarrier<256>>::run(scores_sum[i_19], (&(((float*)workspace_1)[0])));
    ...
    for (int i_22 = 0; i_22 < 8; ++i_22) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)O_shared)[(((((((i_22 >> 2) * 8192) + ((((int)threadIdx.x) & 15) * 512)) + ((((int)threadIdx.x) >> 5) * 64)) + ((i_22 & 3) * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 512)])), __pack_half2(((half_t)acc_o[(i_22 * 8)]), ((half_t)acc_o[((i_22 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_22 * 8) + 2)]), ((half_t)acc_o[((i_22 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_22 * 8) + 4)]), ((half_t)acc_o[((i_22 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_22 * 8) + 6)]), ((half_t)acc_o[((i_22 * 8) + 7)])));
    }
    tl::fence_proxy_async();
