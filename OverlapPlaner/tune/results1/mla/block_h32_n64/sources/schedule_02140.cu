  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int k = 0; k < 63; ++k) {
      ...
      *(float4*)(scores_max + 0) = make_float4(broadcast_var_6, broadcast_var_6, broadcast_var_6, broadcast_var_6);
      ...
      for (int i_18 = 0; i_18 < 4; ++i_18) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_1[i_18] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_18], (&(((float*)workspace_4)[0])));
      ...
      *(float4*)(scores_max + 0) = make_float4(broadcast_var_8, broadcast_var_8, broadcast_var_8, broadcast_var_8);
      ...
      for (int i_34 = 0; i_34 < 4; ++i_34) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_2[i_34] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_34], (&(((float*)workspace_1)[0])));
      ...
      for (int i_38 = 0; i_38 < 4; ++i_38) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_38] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_38], (&(((float*)workspace_5)[0])));
    ...
    *(float4*)(scores_max + 0) = make_float4(broadcast_var_10, broadcast_var_10, broadcast_var_10, broadcast_var_10);
    ...
    for (int i_54 = 0; i_54 < 4; ++i_54) {
      ...
      tl::__sync_thread_partial(3, 256);
      scores_sum[i_54] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_54], (&(((float*)workspace_6)[0])));
