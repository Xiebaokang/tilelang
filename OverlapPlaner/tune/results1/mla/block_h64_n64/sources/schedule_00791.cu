  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int k = 0; k < 63; ++k) {
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
      ...
      for (int i_17 = 0; i_17 < 2; ++i_17) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_2[i_17] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_17], (&(((float*)workspace_7)[0])));
      ...
      *(float2*)(scores_max_prev_v1 + 0) = *(float2*)(scores_max + 0);
      ...
      for (int i_22 = 0; i_22 < 2; ++i_22) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_22] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_22], (&(((float*)workspace)[0])));
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
    ...
    for (int i_30 = 0; i_30 < 2; ++i_30) {
      ...
      tl::__sync_thread_partial(3, 256);
      scores_sum[i_30] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_30], (&(((float*)workspace_6)[0])));
