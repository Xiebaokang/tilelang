...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap KV_desc, __grid_constant__ const CUtensorMap K_pe_desc, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap Q_pe_desc) {
  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
  ...
  for (int i_6 = 0; i_6 < 2; ++i_6) {
    ...
    __syncthreads();
    scores_max_clear_1[i_6] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_6], (&(((float*)workspace_1)[0])));
  ...
  for (int k = 0; k < 42; ++k) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
    ...
    for (int i_12 = 0; i_12 < 2; ++i_12) {
      ...
      __syncthreads();
      scores_max_clear_2[i_12] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_12], (&(((float*)workspace_5)[0])));
    ...
    for (int i_16 = 0; i_16 < 2; ++i_16) {
      ...
      __syncthreads();
      scores_sum[i_16] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_16], (&(((float*)workspace_6)[0])));
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
    ...
    for (int i_20 = 0; i_20 < 2; ++i_20) {
      ...
      __syncthreads();
      scores_max_clear_3[i_20] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_3[i_20], (&(((float*)workspace_3)[0])));
    ...
    for (int i_24 = 0; i_24 < 2; ++i_24) {
      ...
      __syncthreads();
      scores_sum[i_24] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_24], (&(((float*)workspace_4)[0])));
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_7, broadcast_var_7);
    ...
    for (int i_28 = 0; i_28 < 2; ++i_28) {
      ...
      __syncthreads();
      scores_max_clear_4[i_28] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_4[i_28], (&(((float*)workspace_2)[0])));
    ...
    for (int i_32 = 0; i_32 < 2; ++i_32) {
      ...
      __syncthreads();
      scores_sum[i_32] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_32], (&(((float*)workspace)[0])));
  ...
  for (int i_36 = 0; i_36 < 2; ++i_36) {
    ...
    __syncthreads();
    scores_sum[i_36] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_36], (&(((float*)workspace_8)[0])));
