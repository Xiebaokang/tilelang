...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap KV_desc, __grid_constant__ const CUtensorMap K_pe_desc, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap Q_pe_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int k = 0; k < 128; ++k) {
      if (2 <= k) {
        overlap_plan_mbar[((k & 1) + 6)].wait((((k >> 1) + 1) & 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      if (2 <= k) {
        overlap_plan_mbar[((k & 1) + 8)].wait((((k >> 1) + 1) & 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((k & 1) + 4)].arrive_and_expect_tx(8192);
        tl::tma_load(K_pe_desc, overlap_plan_mbar[((k & 1) + 4)], (&(((half_t*)K_pe_shared)[((k & 1) * 4096)])), 0, (k * 64), 0, 0);
      }
    }
  } else {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    ...
    overlap_plan_mbar[2].wait(0);
    {
      ...
      for (int ki = 0; ki < 32; ++ki) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a + ((((ki >> 2) * 8192) + ((ki & 3) * 32)) >> 4)), uint64_t(desc_b + (((((ki >> 2) * 8192) + ((((((int)threadIdx.x) >> 7) + 1) & 1) * 4096)) + ((ki & 3) * 32)) >> 4)), ((uint32_t*)(acc_s_v0 + 0)), ((0 < ki) ? 1 : 0));
      }
    ...
    overlap_plan_mbar[4].wait(0);
    {
      ...
      for (int ki_1 = 0; ki_1 < 4; ++ki_1) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_1 + ((ki_1 * 32) >> 4)), uint64_t(desc_b_1 + ((((((((int)threadIdx.x) >> 7) + 1) & 1) * 4096) + (ki_1 * 32)) >> 4)), ((uint32_t*)(acc_s_v0 + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s_v0 + 0), 16);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int i_1 = 0; i_1 < 2; ++i_1) {
      ...
      scores_max_clear[i_1] = tl::AllReduce<tl::MaxOp, 256, 128, 128, tl::NamedBarrier<256>>::run(scores_max_clear[i_1], (&(((float*)workspace_2)[0])));
    ...
    for (int i_5 = 0; i_5 < 2; ++i_5) {
      ...
      for (int rv_1 = 0; rv_1 < 8; ++rv_1) {
        scores_sum[i_5] = (scores_sum[i_5] + acc_s_v0[((((rv_1 & 3) * 4) + (i_5 * 2)) + (rv_1 >> 2))]);
      }
      tl::__sync_thread_partial(3, 256);
      scores_sum[i_5] = tl::AllReduce<tl::SumOp, 256, 128, 128, tl::NamedBarrier<256>>::run(scores_sum[i_5], (&(((float*)workspace_4)[0])));
    ...
    for (int k_1 = 0; k_1 < 63; ++k_1) {
      overlap_plan_mbar[3].wait((k_1 & 1));
      {
        ...
        for (int ki_2 = 0; ki_2 < 32; ++ki_2) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_2 + ((((ki_2 >> 2) * 8192) + ((ki_2 & 3) * 32)) >> 4)), uint64_t(desc_b_2 + (((((ki_2 >> 2) * 8192) + ((((((int)threadIdx.x) >> 7) + 1) & 1) * 4096)) + ((ki_2 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s_v1 + 0)), ((0 < ki_2) ? 1 : 0));
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s_v1 + 0), 16);
      ...
      overlap_plan_mbar[5].wait((k_1 & 1));
      {
        ...
        for (int ki_3 = 0; ki_3 < 4; ++ki_3) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_3 + ((ki_3 * 32) >> 4)), uint64_t(desc_b_3 + ((((((((int)threadIdx.x) >> 7) + 1) & 1) * 4096) + (ki_3 * 32)) >> 4)), ((uint32_t*)(acc_s_v1 + 0)), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s_v1 + 0), 16);
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
      ...
      for (int i_8 = 0; i_8 < 2; ++i_8) {
        ...
        for (int rv_2 = 0; rv_2 < 8; ++rv_2) {
          scores_max_clear_1[i_8] = max(scores_max_clear_1[i_8], acc_s_v1[((((rv_2 & 3) * 4) + (i_8 * 2)) + (rv_2 >> 2))]);
        }
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_1[i_8] = tl::AllReduce<tl::MaxOp, 256, 128, 128, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_8], (&(((float*)workspace_5)[0])));
        scores_max_clear_1[i_8] = tl::AllReduce<tl::MaxOp, 4, 1, 128, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_8]);
      ...
      for (int i_10 = 0; i_10 < 2; ++i_10) {
        scores_scale[i_10] = exp2f(((scores_max_prev[i_10] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[i_10] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
      }
      #pragma unroll
      for (int i_11 = 0; i_11 < 16; ++i_11) {
        acc_s_v1[i_11] = exp2f(((acc_s_v1[i_11] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[((i_11 & 3) >> 1)] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
      }
      #pragma unroll
      for (int i_12 = 0; i_12 < 2; ++i_12) {
        ...
        for (int rv_3 = 0; rv_3 < 8; ++rv_3) {
          scores_sum[i_12] = (scores_sum[i_12] + acc_s_v1[((((rv_3 & 3) * 4) + (i_12 * 2)) + (rv_3 >> 2))]);
        }
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_12] = tl::AllReduce<tl::SumOp, 256, 128, 128, tl::NamedBarrier<256>>::run(scores_sum[i_12], (&(((float*)workspace_6)[0])));
        scores_sum[i_12] = tl::AllReduce<tl::SumOp, 4, 1, 128, tl::NamedBarrier<256>>::run(scores_sum[i_12]);
      }
      #pragma unroll
      for (int i_13 = 0; i_13 < 2; ++i_13) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)S_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) + 1) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + i_13) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_s_v0[(i_13 * 8)]), ((half_t)acc_s_v0[((i_13 * 8) + 1)])), __pack_half2(((half_t)acc_s_v0[((i_13 * 8) + 2)]), ((half_t)acc_s_v0[((i_13 * 8) + 3)])), __pack_half2(((half_t)acc_s_v0[((i_13 * 8) + 4)]), ((half_t)acc_s_v0[((i_13 * 8) + 5)])), __pack_half2(((half_t)acc_s_v0[((i_13 * 8) + 6)]), ((half_t)acc_s_v0[((i_13 * 8) + 7)])));
      }
      #pragma unroll
      ...
      overlap_plan_mbar[2].wait((k_1 & 1));
      {
        ...
        for (int ki_4 = 0; ki_4 < 4; ++ki_4) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 256, 16, false, true, 1, 1>(uint64_t(desc_a_4 + ((ki_4 * 32) >> 4)), uint64_t(desc_b_4 + ((((((((int)threadIdx.x) >> 7) + 1) & 1) * 32768) + (ki_4 * 2048)) >> 4)), ((uint32_t*)(acc_o + 0)), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_o + 0), 128);
      ...
      overlap_plan_mbar[2].wait(((k_1 + 1) & 1));
      {
        ...
        for (int ki_5 = 0; ki_5 < 32; ++ki_5) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_5 + ((((ki_5 >> 2) * 8192) + ((ki_5 & 3) * 32)) >> 4)), uint64_t(desc_b_5 + (((((ki_5 >> 2) * 8192) + ((((((int)threadIdx.x) >> 7) + 1) & 1) * 4096)) + ((ki_5 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s_v0 + 0)), ((0 < ki_5) ? 1 : 0));
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s_v0 + 0), 16);
      }
      overlap_plan_mbar[4].wait(((k_1 + 1) & 1));
      {
        ...
        for (int ki_6 = 0; ki_6 < 4; ++ki_6) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_6 + ((ki_6 * 32) >> 4)), uint64_t(desc_b_6 + ((((((((int)threadIdx.x) >> 7) + 1) & 1) * 4096) + (ki_6 * 32)) >> 4)), ((uint32_t*)(acc_s_v0 + 0)), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s_v0 + 0), 16);
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
      ...
      for (int i_16 = 0; i_16 < 2; ++i_16) {
        ...
        for (int rv_4 = 0; rv_4 < 8; ++rv_4) {
          scores_max_clear_2[i_16] = max(scores_max_clear_2[i_16], acc_s_v0[((((rv_4 & 3) * 4) + (i_16 * 2)) + (rv_4 >> 2))]);
        }
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_2[i_16] = tl::AllReduce<tl::MaxOp, 256, 128, 128, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_16], (&(((float*)workspace_1)[0])));
        scores_max_clear_2[i_16] = tl::AllReduce<tl::MaxOp, 4, 1, 128, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_16]);
      ...
      for (int i_18 = 0; i_18 < 2; ++i_18) {
        scores_scale[i_18] = exp2f(((scores_max_prev[i_18] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[i_18] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
      }
      #pragma unroll
      for (int i_19 = 0; i_19 < 16; ++i_19) {
        acc_s_v0[i_19] = exp2f(((acc_s_v0[i_19] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[((i_19 & 3) >> 1)] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
      }
      #pragma unroll
      for (int i_20 = 0; i_20 < 2; ++i_20) {
        ...
        for (int rv_5 = 0; rv_5 < 8; ++rv_5) {
          scores_sum[i_20] = (scores_sum[i_20] + acc_s_v0[((((rv_5 & 3) * 4) + (i_20 * 2)) + (rv_5 >> 2))]);
        }
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_20] = tl::AllReduce<tl::SumOp, 256, 128, 128, tl::NamedBarrier<256>>::run(scores_sum[i_20], (&(((float*)workspace_7)[0])));
        scores_sum[i_20] = tl::AllReduce<tl::SumOp, 4, 1, 128, tl::NamedBarrier<256>>::run(scores_sum[i_20]);
      }
      #pragma unroll
      for (int i_21 = 0; i_21 < 2; ++i_21) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)S_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) + 1) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + i_21) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_s_v1[(i_21 * 8)]), ((half_t)acc_s_v1[((i_21 * 8) + 1)])), __pack_half2(((half_t)acc_s_v1[((i_21 * 8) + 2)]), ((half_t)acc_s_v1[((i_21 * 8) + 3)])), __pack_half2(((half_t)acc_s_v1[((i_21 * 8) + 4)]), ((half_t)acc_s_v1[((i_21 * 8) + 5)])), __pack_half2(((half_t)acc_s_v1[((i_21 * 8) + 6)]), ((half_t)acc_s_v1[((i_21 * 8) + 7)])));
      }
      #pragma unroll
      ...
      overlap_plan_mbar[3].wait((k_1 & 1));
      {
        ...
        for (int ki_7 = 0; ki_7 < 4; ++ki_7) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 256, 16, false, true, 1, 1>(uint64_t(desc_a_7 + ((ki_7 * 32) >> 4)), uint64_t(desc_b_7 + ((((((((int)threadIdx.x) >> 7) + 1) & 1) * 32768) + (ki_7 * 2048)) >> 4)), ((uint32_t*)(acc_o + 0)), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_o + 0), 128);
    ...
    overlap_plan_mbar[3].wait(1);
    {
      ...
      for (int ki_8 = 0; ki_8 < 32; ++ki_8) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_8 + ((((ki_8 >> 2) * 8192) + ((ki_8 & 3) * 32)) >> 4)), uint64_t(desc_b_8 + (((((ki_8 >> 2) * 8192) + ((((((int)threadIdx.x) >> 7) + 1) & 1) * 4096)) + ((ki_8 & 3) * 32)) >> 4)), ((uint32_t*)(acc_s_v1 + 0)), ((0 < ki_8) ? 1 : 0));
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s_v1 + 0), 16);
    ...
    overlap_plan_mbar[5].wait(1);
    {
      ...
      for (int ki_9 = 0; ki_9 < 4; ++ki_9) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_9 + ((ki_9 * 32) >> 4)), uint64_t(desc_b_9 + ((((((((int)threadIdx.x) >> 7) + 1) & 1) * 4096) + (ki_9 * 32)) >> 4)), ((uint32_t*)(acc_s_v1 + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_s_v1 + 0), 16);
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
    ...
    for (int i_24 = 0; i_24 < 2; ++i_24) {
      ...
      for (int rv_6 = 0; rv_6 < 8; ++rv_6) {
        scores_max_clear_3[i_24] = max(scores_max_clear_3[i_24], acc_s_v1[((((rv_6 & 3) * 4) + (i_24 * 2)) + (rv_6 >> 2))]);
      }
      tl::__sync_thread_partial(3, 256);
      scores_max_clear_3[i_24] = tl::AllReduce<tl::MaxOp, 256, 128, 128, tl::NamedBarrier<256>>::run(scores_max_clear_3[i_24], (&(((float*)workspace)[0])));
      scores_max_clear_3[i_24] = tl::AllReduce<tl::MaxOp, 4, 1, 128, tl::NamedBarrier<256>>::run(scores_max_clear_3[i_24]);
    ...
    for (int i_26 = 0; i_26 < 2; ++i_26) {
      scores_scale[i_26] = exp2f(((scores_max_prev[i_26] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[i_26] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
    }
    #pragma unroll
    for (int i_27 = 0; i_27 < 16; ++i_27) {
      acc_s_v1[i_27] = exp2f(((acc_s_v1[i_27] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[((i_27 & 3) >> 1)] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
    }
    #pragma unroll
    for (int i_28 = 0; i_28 < 2; ++i_28) {
      ...
      for (int rv_7 = 0; rv_7 < 8; ++rv_7) {
        scores_sum[i_28] = (scores_sum[i_28] + acc_s_v1[((((rv_7 & 3) * 4) + (i_28 * 2)) + (rv_7 >> 2))]);
      }
      tl::__sync_thread_partial(3, 256);
      scores_sum[i_28] = tl::AllReduce<tl::SumOp, 256, 128, 128, tl::NamedBarrier<256>>::run(scores_sum[i_28], (&(((float*)workspace_3)[0])));
      scores_sum[i_28] = tl::AllReduce<tl::SumOp, 4, 1, 128, tl::NamedBarrier<256>>::run(scores_sum[i_28]);
    }
    #pragma unroll
    for (int i_29 = 0; i_29 < 2; ++i_29) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)S_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) + 1) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + i_29) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_s_v0[(i_29 * 8)]), ((half_t)acc_s_v0[((i_29 * 8) + 1)])), __pack_half2(((half_t)acc_s_v0[((i_29 * 8) + 2)]), ((half_t)acc_s_v0[((i_29 * 8) + 3)])), __pack_half2(((half_t)acc_s_v0[((i_29 * 8) + 4)]), ((half_t)acc_s_v0[((i_29 * 8) + 5)])), __pack_half2(((half_t)acc_s_v0[((i_29 * 8) + 6)]), ((half_t)acc_s_v0[((i_29 * 8) + 7)])));
    }
    #pragma unroll
    ...
    overlap_plan_mbar[2].wait(1);
    {
      ...
      for (int ki_10 = 0; ki_10 < 4; ++ki_10) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 256, 16, false, true, 1, 1>(uint64_t(desc_a_10 + ((ki_10 * 32) >> 4)), uint64_t(desc_b_10 + ((((((((int)threadIdx.x) >> 7) + 1) & 1) * 32768) + (ki_10 * 2048)) >> 4)), ((uint32_t*)(acc_o + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_o + 0), 128);
    ...
    for (int i_32 = 0; i_32 < 2; ++i_32) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)S_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) + 1) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + i_32) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_s_v1[(i_32 * 8)]), ((half_t)acc_s_v1[((i_32 * 8) + 1)])), __pack_half2(((half_t)acc_s_v1[((i_32 * 8) + 2)]), ((half_t)acc_s_v1[((i_32 * 8) + 3)])), __pack_half2(((half_t)acc_s_v1[((i_32 * 8) + 4)]), ((half_t)acc_s_v1[((i_32 * 8) + 5)])), __pack_half2(((half_t)acc_s_v1[((i_32 * 8) + 6)]), ((half_t)acc_s_v1[((i_32 * 8) + 7)])));
    }
    overlap_plan_mbar[3].wait(1);
    {
      ...
      for (int ki_11 = 0; ki_11 < 4; ++ki_11) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 256, 16, false, true, 1, 1>(uint64_t(desc_a_11 + ((ki_11 * 32) >> 4)), uint64_t(desc_b_11 + ((((((((int)threadIdx.x) >> 7) + 1) & 1) * 32768) + (ki_11 * 2048)) >> 4)), ((uint32_t*)(acc_o + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_o + 0), 128);
    ...
    for (int i_34 = 0; i_34 < 16; ++i_34) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)O_shared)[((((((((((int)threadIdx.x) & 127) >> 5) * 8192) + ((((int)threadIdx.x) & 15) * 512)) + ((((int)threadIdx.x) >> 7) * 256)) + (i_34 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 256)])), __pack_half2(((half_t)acc_o[(i_34 * 8)]), ((half_t)acc_o[((i_34 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_34 * 8) + 2)]), ((half_t)acc_o[((i_34 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_34 * 8) + 4)]), ((half_t)acc_o[((i_34 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_34 * 8) + 6)]), ((half_t)acc_o[((i_34 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 256);
