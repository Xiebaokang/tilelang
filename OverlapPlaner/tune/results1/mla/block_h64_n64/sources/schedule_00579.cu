  ...
  if (((int)threadIdx.x) < 128) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    for (int k_1 = 0; k_1 < 128; ++k_1) {
      ...
      overlap_plan_mbar[((k_1 & 1) + 8)].arrive();
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
      ...
      for (int i_5 = 0; i_5 < 2; ++i_5) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)S_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) + 1) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + i_5) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_s[(i_5 * 8)]), ((half_t)acc_s[((i_5 * 8) + 1)])), __pack_half2(((half_t)acc_s[((i_5 * 8) + 2)]), ((half_t)acc_s[((i_5 * 8) + 3)])), __pack_half2(((half_t)acc_s[((i_5 * 8) + 4)]), ((half_t)acc_s[((i_5 * 8) + 5)])), __pack_half2(((half_t)acc_s[((i_5 * 8) + 6)]), ((half_t)acc_s[((i_5 * 8) + 7)])));
      }
      #pragma unroll
      ...
      for (int i_7 = 0; i_7 < 2; ++i_7) {
        ...
        for (int rv_1 = 0; rv_1 < 8; ++rv_1) {
          scores_sum[i_7] = (scores_sum[i_7] + acc_s[((((rv_1 & 3) * 4) + (i_7 * 2)) + (rv_1 >> 2))]);
        }
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_7] = tl::AllReduce<tl::SumOp, 256, 128, 128, tl::NamedBarrier<256>>::run(scores_sum[i_7], (&(((float*)workspace)[0])));
        scores_sum[i_7] = tl::AllReduce<tl::SumOp, 4, 1, 128, tl::NamedBarrier<256>>::run(scores_sum[i_7]);
      }
      #pragma unroll
