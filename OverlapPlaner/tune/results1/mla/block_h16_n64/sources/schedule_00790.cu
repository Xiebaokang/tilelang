    ...
    *(float2*)(logsum + 0) = make_float2(broadcast_var_4, broadcast_var_4);
    for (int k_1 = 0; k_1 < 64; ++k_1) {
      ...
      for (int i_27 = 0; i_27 < 2; ++i_27) {
        *(float2*)(acc_s_v0 + (i_27 * 2)) = *(float2*)(((float*)acc_s_wsp_handoff_7) + (((((i_27 * 512) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((int)threadIdx.x) >> 5) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 64));
      }
      #pragma unroll
      for (int i_28 = 0; i_28 < 2; ++i_28) {
        ...
        for (int rv_2 = 0; rv_2 < 2; ++rv_2) {
          scores_sum[i_28] = (scores_sum[i_28] + acc_s_v0[((i_28 * 2) + rv_2)]);
        }
        tl::__sync_thread_partial(4, 256);
        scores_sum[i_28] = tl::AllReduce<tl::SumOp, 256, 32, 256, tl::NamedBarrier<256>>::run(scores_sum[i_28], (&(((float*)workspace_2)[0])));
        scores_sum[i_28] = tl::AllReduce<tl::SumOp, 4, 1, 256, tl::NamedBarrier<256>>::run(scores_sum[i_28]);
      }
      overlap_plan_mbar[6].wait(0);
      #pragma unroll
      for (int i_29 = 0; i_29 < 2; ++i_29) {
        scores_scale[i_29] = ((float*)scores_scale_wsp_handoff_5)[((i_29 * 8) + ((((int)threadIdx.x) & 31) >> 2))];
      }
      #pragma unroll
      ...
      for (int i_31 = 0; i_31 < 16; ++i_31) {
        *(float2*)(acc_o_v0 + (i_31 * 2)) = *(float2*)(((float*)acc_o_wsp_handoff_9) + (((((((i_31 & 1) * 4096) + (((((int)threadIdx.x) & 31) >> 2) * 512)) + ((((int)threadIdx.x) >> 5) * 64)) + ((i_31 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 512));
      }
      {
        half_t A_local_2[8];
        half_t B_local_2[32];
      ...
      for (int i_33 = 0; i_33 < 16; ++i_33) {
        *(float2*)(((float*)acc_o_wsp_handoff_10) + (((((((i_33 & 1) * 4096) + (((((int)threadIdx.x) & 31) >> 2) * 512)) + ((((int)threadIdx.x) >> 5) * 64)) + ((i_33 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 512)) = *(float2*)(acc_o_v0 + (i_33 * 2));
      }
      tl::fence_proxy_async();
      ...
      for (int i_36 = 0; i_36 < 2; ++i_36) {
        *(float2*)(acc_s_v1 + (i_36 * 2)) = *(float2*)(((float*)acc_s_wsp_handoff_7) + (((((i_36 * 512) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((int)threadIdx.x) >> 5) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 64));
      }
      #pragma unroll
      for (int i_37 = 0; i_37 < 2; ++i_37) {
        ...
        for (int rv_3 = 0; rv_3 < 2; ++rv_3) {
          scores_sum[i_37] = (scores_sum[i_37] + acc_s_v1[((i_37 * 2) + rv_3)]);
        }
        tl::__sync_thread_partial(4, 256);
        scores_sum[i_37] = tl::AllReduce<tl::SumOp, 256, 32, 256, tl::NamedBarrier<256>>::run(scores_sum[i_37], (&(((float*)workspace_3)[0])));
        scores_sum[i_37] = tl::AllReduce<tl::SumOp, 4, 1, 256, tl::NamedBarrier<256>>::run(scores_sum[i_37]);
      }
      overlap_plan_mbar[6].wait(1);
      #pragma unroll
      for (int i_38 = 0; i_38 < 2; ++i_38) {
        scores_scale[i_38] = ((float*)scores_scale_wsp_handoff_5)[((i_38 * 8) + ((((int)threadIdx.x) & 31) >> 2))];
      }
      #pragma unroll
      for (int i_39 = 0; i_39 < 2; ++i_39) {
        logsum[i_39] = ((logsum[i_39] * scores_scale[i_39]) + scores_sum[i_39]);
      }
      overlap_plan_mbar[11].wait((k_1 & 1));
      overlap_plan_mbar[12].wait(1);
      #pragma unroll
      for (int i_40 = 0; i_40 < 16; ++i_40) {
        *(float2*)(acc_o_v1 + (i_40 * 2)) = *(float2*)(((float*)acc_o_wsp_handoff_9) + (((((((i_40 & 1) * 4096) + (((((int)threadIdx.x) & 31) >> 2) * 512)) + ((((int)threadIdx.x) >> 5) * 64)) + ((i_40 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 512));
      }
      {
        half_t A_local_5[8];
        half_t B_local_5[32];
        for (int ki_5 = 0; ki_5 < 4; ++ki_5) {
          ...
          for (int i_41 = 0; i_41 < 4; ++i_41) {
            tl::ptx_ldmatrix_x4_trans((&(((half_t*)KV_shared)[((((((((int)threadIdx.x) & 255) >> 5) * 4096) + (ki_5 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_41 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_41 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_5[(i_41 * 8)])));
          }
      ...
      for (int i_42 = 0; i_42 < 16; ++i_42) {
        *(float2*)(((float*)acc_o_wsp_handoff_10) + (((((((i_42 & 1) * 4096) + (((((int)threadIdx.x) & 31) >> 2) * 512)) + ((((int)threadIdx.x) >> 5) * 64)) + ((i_42 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 7680)) = *(float2*)(acc_o_v1 + (i_42 * 2));
      }
      tl::fence_proxy_async();
