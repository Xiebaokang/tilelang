...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap KV_desc, __grid_constant__ const CUtensorMap K_pe_desc, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap Q_pe_desc) {
  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
  ...
  for (int k = 0; k < 63; ++k) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
    ...
    for (int i_10 = 0; i_10 < 2; ++i_10) {
      ...
      __syncthreads();
      scores_max_clear_1[i_10] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_10], (&(((float*)workspace_3)[0])));
    ...
    for (int i_14 = 0; i_14 < 2; ++i_14) {
      ...
      __syncthreads();
      scores_sum[i_14] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_14], (&(((float*)workspace_5)[0])));
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_8, broadcast_var_8);
    ...
    for (int i_19 = 0; i_19 < 2; ++i_19) {
      ...
      __syncthreads();
      scores_max_clear_2[i_19] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_19], (&(((float*)workspace_6)[0])));
    ...
    for (int i_23 = 0; i_23 < 2; ++i_23) {
      ...
      __syncthreads();
      scores_sum[i_23] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_23], (&(((float*)workspace_7)[0])));
  ...
  for (int i_26 = 0; i_26 < 2; ++i_26) {
    ...
    uint1 __3;
    float2 v__2 = *(float2*)(acc_s_v0 + (i_26 * 2));
    ((half2*)(&__3))[0] = __float22half2_rn(((float2*)(&v__2))[0]);
    *(uint1*)(S_shared_local_cast_2 + 0) = __3;
    *(uint1*)(((half_t*)S_shared) + ((((((i_26 * 512) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(S_shared_local_cast_2 + 0);
  }
  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_10, broadcast_var_10);
  ...
  for (int i_28 = 0; i_28 < 2; ++i_28) {
    ...
    __syncthreads();
    scores_max_clear_3[i_28] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_3[i_28], (&(((float*)workspace)[0])));
  ...
  for (int i_32 = 0; i_32 < 2; ++i_32) {
    ...
    __syncthreads();
    scores_sum[i_32] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_32], (&(((float*)workspace_1)[0])));
