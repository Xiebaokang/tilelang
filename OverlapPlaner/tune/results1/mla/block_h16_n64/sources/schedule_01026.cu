    ...
    for (int k_1 = 0; k_1 < 64; ++k_1) {
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
      ...
      for (int i_13 = 0; i_13 < 2; ++i_13) {
        ...
        scores_max_clear[i_13] = tl::AllReduce<tl::MaxOp, 256, 32, 256, tl::NamedBarrier<256>>::run(scores_max_clear[i_13], (&(((float*)workspace_2)[0])));
      ...
      for (int i_19 = 0; i_19 < 2; ++i_19) {
        ...
        uint1 __1;
        float2 v_ = *(float2*)(acc_s_v0 + (i_19 * 2));
        ((half2*)(&__1))[0] = __float22half2_rn(((float2*)(&v_))[0]);
        *(uint1*)(S_shared_local_cast + 0) = __1;
        *(uint1*)(((half_t*)S_shared) + ((((((i_19 * 512) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(S_shared_local_cast + 0);
      }
      tl::fence_proxy_async();
      ...
      for (int i_20 = 0; i_20 < 2; ++i_20) {
        ...
        for (int rv_1 = 0; rv_1 < 2; ++rv_1) {
          scores_sum[i_20] = (scores_sum[i_20] + acc_s_v0[((i_20 * 2) + rv_1)]);
        }
        tl::__sync_thread_partial(4, 256);
        scores_sum[i_20] = tl::AllReduce<tl::SumOp, 256, 32, 256, tl::NamedBarrier<256>>::run(scores_sum[i_20], (&(((float*)workspace_1)[0])));
        scores_sum[i_20] = tl::AllReduce<tl::SumOp, 4, 1, 256, tl::NamedBarrier<256>>::run(scores_sum[i_20]);
      }
      #pragma unroll
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
      ...
      for (int i_23 = 0; i_23 < 2; ++i_23) {
        ...
        tl::__sync_thread_partial(4, 256);
        scores_max_clear_1[i_23] = tl::AllReduce<tl::MaxOp, 256, 32, 256, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_23], (&(((float*)workspace)[0])));
      ...
      for (int i_29 = 0; i_29 < 2; ++i_29) {
        ...
        uint1 __2;
        float2 v__1 = *(float2*)(acc_s_v1 + (i_29 * 2));
        ((half2*)(&__2))[0] = __float22half2_rn(((float2*)(&v__1))[0]);
        *(uint1*)(S_shared_local_cast_1 + 0) = __2;
        *(uint1*)(((half_t*)S_shared) + (((((((i_29 * 512) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 1024)) = *(uint1*)(S_shared_local_cast_1 + 0);
      }
      tl::fence_proxy_async();
      ...
      for (int i_30 = 0; i_30 < 2; ++i_30) {
        ...
        for (int rv_3 = 0; rv_3 < 2; ++rv_3) {
          scores_sum[i_30] = (scores_sum[i_30] + acc_s_v1[((i_30 * 2) + rv_3)]);
        }
        tl::__sync_thread_partial(4, 256);
        scores_sum[i_30] = tl::AllReduce<tl::SumOp, 256, 32, 256, tl::NamedBarrier<256>>::run(scores_sum[i_30], (&(((float*)workspace_3)[0])));
        scores_sum[i_30] = tl::AllReduce<tl::SumOp, 4, 1, 256, tl::NamedBarrier<256>>::run(scores_sum[i_30]);
      }
      #pragma unroll
