...
extern "C" __global__ void __launch_bounds__(512, 1) main_kernel(__grid_constant__ const CUtensorMap KV_desc, __grid_constant__ const CUtensorMap K_pe_desc, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap Q_pe_desc) {
  ...
  void* acc_s_wsp_handoff_4 = ((void*)((char*)buf_dyn_shmem + 186368));
  void* acc_s_wsp_handoff_7 = ((void*)((char*)buf_dyn_shmem + 190464));
  ...
  void* workspace_2 = ((void*)((char*)buf_dyn_shmem + 195648));
  void* workspace_3 = ((void*)((char*)buf_dyn_shmem + 195648));
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(logsum + 0) = make_float2(broadcast_var_1, broadcast_var_1);
    for (int k = 0; k < 64; ++k) {
      ...
      overlap_plan_mbar[(((k * 2) % 3) + 17)].arrive();
      ...
      for (int i_6 = 0; i_6 < 2; ++i_6) {
        *(float2*)(acc_s_v0 + (i_6 * 2)) = *(float2*)(((float*)acc_s_wsp_handoff_7) + ((((i_6 * 512) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((int)threadIdx.x) >> 5) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      }
      #pragma unroll
      for (int i_7 = 0; i_7 < 2; ++i_7) {
        ...
        for (int rv = 0; rv < 2; ++rv) {
          scores_sum[i_7] = (scores_sum[i_7] + acc_s_v0[((i_7 * 2) + rv)]);
        }
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_7] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_7], (&(((float*)workspace_1)[0])));
      ...
      for (int i_11 = 0; i_11 < 2; ++i_11) {
        scores_scale[i_11] = ((float*)scores_scale_wsp_handoff_5)[((i_11 * 8) + ((((int)threadIdx.x) & 31) >> 2))];
      }
      #pragma unroll
      ...
      overlap_plan_mbar[13].wait((k & 1));
      {
        ...
        for (int ki_5 = 0; ki_5 < 4; ++ki_5) {
          ...
          for (int i_13 = 0; i_13 < 4; ++i_13) {
            tl::ptx_ldmatrix_x4_trans((&(((half_t*)KV_shared)[((((((((int)threadIdx.x) >> 5) * 4096) + (ki_5 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_13 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_13 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 32768)])), (&(B_local_5[(i_13 * 8)])));
          }
      ...
      for (int i_15 = 0; i_15 < 2; ++i_15) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_15] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_15], (&(((float*)workspace)[0])));
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
    for (int k_1 = 0; k_1 < 64; ++k_1) {
      ...
      if (2 <= k_1) {
        overlap_plan_mbar[(((k_1 * 2) % 3) + 17)].wait(((((k_1 * 2) / 3) + 1) & 1));
      }
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 8)) {
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
      ...
      for (int i_27 = 0; i_27 < 2; ++i_27) {
        ...
        *(uint1*)(((half_t*)S_shared) + ((((((i_27 * 512) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(S_shared_local_cast + 0);
      }
      tl::fence_proxy_async();
      ...
      if (1 <= k_1) {
        overlap_plan_mbar[((((k_1 * 2) + 1) % 3) + 17)].wait((((((k_1 * 2) + 1) / 3) + 1) & 1));
      }
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 8)) {
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
      ...
      overlap_plan_mbar[11].arrive();
      if (1 <= k_1) {
        overlap_plan_mbar[21].wait(((k_1 + 1) & 1));
      }
      #pragma unroll
      for (int i_36 = 0; i_36 < 2; ++i_36) {
        ...
        *(uint1*)(((half_t*)S_shared) + (((((((i_36 * 512) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 1024)) = *(uint1*)(S_shared_local_cast_1 + 0);
      }
      tl::fence_proxy_async();
