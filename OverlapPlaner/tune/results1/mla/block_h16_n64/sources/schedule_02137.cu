...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap KV_desc, __grid_constant__ const CUtensorMap K_pe_desc, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap Q_pe_desc) {
  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
  ...
  for (int i_5 = 0; i_5 < 2; ++i_5) {
    ...
    __syncthreads();
    scores_sum[i_5] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_5], (&(((float*)workspace_5)[0])));
  ...
  for (int k = 0; k < 63; ++k) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
    ...
    for (int i_7 = 0; i_7 < 2; ++i_7) {
      ...
      __syncthreads();
      scores_max_clear_1[i_7] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_7], (&(((float*)workspace_6)[0])));
    ...
    for (int i_11 = 0; i_11 < 2; ++i_11) {
      ...
      __syncthreads();
      scores_sum[i_11] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_11], (&(((float*)workspace_4)[0])));
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_8, broadcast_var_8);
    ...
    for (int i_16 = 0; i_16 < 2; ++i_16) {
      ...
      __syncthreads();
      scores_max_clear_2[i_16] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_16], (&(((float*)workspace_1)[0])));
  ...
  *(float2*)(scores_max + 0) = make_float2(broadcast_var_10, broadcast_var_10);
  ...
  for (int i_25 = 0; i_25 < 2; ++i_25) {
    ...
    __syncthreads();
    scores_max_clear_3[i_25] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_3[i_25], (&(((float*)workspace_3)[0])));
  ...
  for (int i_29 = 0; i_29 < 2; ++i_29) {
    ...
    __syncthreads();
    scores_sum[i_29] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_29], (&(((float*)workspace_7)[0])));
