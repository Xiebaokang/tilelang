    ...
    *(float2*)(logsum + 0) = make_float2(broadcast_var, broadcast_var);
    for (int k = 0; k < 64; ++k) {
      ...
      for (int i_2 = 0; i_2 < 16; ++i_2) {
        *(float2*)(acc_o_v0 + (i_2 * 2)) = *(float2*)(((float*)acc_o_wsp_handoff_9) + ((((((i_2 & 1) * 4096) + (((((int)threadIdx.x) & 31) >> 2) * 512)) + ((((int)threadIdx.x) >> 5) * 64)) + ((i_2 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      }
      {
        half_t A_local_2[8];
        half_t B_local_2[32];
        for (int ki_2 = 0; ki_2 < 4; ++ki_2) {
          ...
          for (int i_3 = 0; i_3 < 4; ++i_3) {
            tl::ptx_ldmatrix_x4_trans((&(((half_t*)KV_shared)[(((((((int)threadIdx.x) >> 5) * 4096) + (ki_2 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_3 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_3 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_2[(i_3 * 8)])));
          }
          for (int j = 0; j < 4; ++j) {
      ...
      for (int i_4 = 0; i_4 < 16; ++i_4) {
        *(float2*)(((float*)acc_o_wsp_handoff_10) + ((((((i_4 & 1) * 4096) + (((((int)threadIdx.x) & 31) >> 2) * 512)) + ((((int)threadIdx.x) >> 5) * 64)) + ((i_4 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(acc_o_v0 + (i_4 * 2));
      }
      tl::fence_proxy_async();
      ...
      for (int i_5 = 0; i_5 < 2; ++i_5) {
        *(float2*)(acc_s_v0 + (i_5 * 2)) = *(float2*)(((float*)acc_s_wsp_handoff_7) + ((((i_5 * 512) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((int)threadIdx.x) >> 5) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      }
      #pragma unroll
      for (int i_6 = 0; i_6 < 2; ++i_6) {
        ...
        for (int rv = 0; rv < 2; ++rv) {
          scores_sum[i_6] = (scores_sum[i_6] + acc_s_v0[((i_6 * 2) + rv)]);
        }
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_6] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_6], (&(((float*)workspace)[0])));
        scores_sum[i_6] = tl::AllReduce<tl::SumOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_sum[i_6]);
      }
      overlap_plan_mbar[6].wait(0);
      #pragma unroll
      for (int i_7 = 0; i_7 < 2; ++i_7) {
        scores_scale[i_7] = ((float*)scores_scale_wsp_handoff_5)[((i_7 * 8) + ((((int)threadIdx.x) & 31) >> 2))];
      }
      #pragma unroll
      ...
      for (int i_11 = 0; i_11 < 16; ++i_11) {
        *(float2*)(acc_o_v1 + (i_11 * 2)) = *(float2*)(((float*)acc_o_wsp_handoff_9) + ((((((i_11 & 1) * 4096) + (((((int)threadIdx.x) & 31) >> 2) * 512)) + ((((int)threadIdx.x) >> 5) * 64)) + ((i_11 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      }
      {
        half_t A_local_5[8];
        half_t B_local_5[32];
        for (int ki_5 = 0; ki_5 < 4; ++ki_5) {
          ...
          for (int i_12 = 0; i_12 < 4; ++i_12) {
            tl::ptx_ldmatrix_x4_trans((&(((half_t*)KV_shared)[(((((((int)threadIdx.x) >> 5) * 4096) + (ki_5 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_12 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_12 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_5[(i_12 * 8)])));
          }
      ...
      for (int i_13 = 0; i_13 < 16; ++i_13) {
        *(float2*)(((float*)acc_o_wsp_handoff_10) + (((((((i_13 & 1) * 4096) + (((((int)threadIdx.x) & 31) >> 2) * 512)) + ((((int)threadIdx.x) >> 5) * 64)) + ((i_13 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 8192)) = *(float2*)(acc_o_v1 + (i_13 * 2));
      }
      tl::fence_proxy_async();
      ...
      for (int i_14 = 0; i_14 < 2; ++i_14) {
        *(float2*)(acc_s_v1 + (i_14 * 2)) = *(float2*)(((float*)acc_s_wsp_handoff_7) + ((((i_14 * 512) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((int)threadIdx.x) >> 5) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      }
      #pragma unroll
      for (int i_15 = 0; i_15 < 2; ++i_15) {
        ...
        for (int rv_1 = 0; rv_1 < 2; ++rv_1) {
          scores_sum[i_15] = (scores_sum[i_15] + acc_s_v1[((i_15 * 2) + rv_1)]);
        }
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_15] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_15], (&(((float*)workspace_1)[0])));
        scores_sum[i_15] = tl::AllReduce<tl::SumOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_sum[i_15]);
      }
      overlap_plan_mbar[6].wait(1);
      #pragma unroll
      for (int i_16 = 0; i_16 < 2; ++i_16) {
        scores_scale[i_16] = ((float*)scores_scale_wsp_handoff_5)[((i_16 * 8) + ((((int)threadIdx.x) & 31) >> 2))];
      }
      #pragma unroll
    ...
    for (int k_1 = 0; k_1 < 64; ++k_1) {
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
      ...
      for (int i_22 = 0; i_22 < 2; ++i_22) {
        ...
        scores_max_clear[i_22] = tl::AllReduce<tl::MaxOp, 256, 32, 256, tl::NamedBarrier<256>>::run(scores_max_clear[i_22], (&(((float*)workspace_3)[0])));
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
      ...
      for (int i_34 = 0; i_34 < 2; ++i_34) {
        ...
        tl::__sync_thread_partial(4, 256);
        scores_max_clear_1[i_34] = tl::AllReduce<tl::MaxOp, 256, 32, 256, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_34], (&(((float*)workspace_2)[0])));
