...
extern "C" __global__ void __launch_bounds__(512, 1) main_kernel(__grid_constant__ const CUtensorMap KV_desc, __grid_constant__ const CUtensorMap K_pe_desc, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap Q_pe_desc) {
  ...
  void* acc_s_wsp_handoff_6 = ((void*)((char*)buf_dyn_shmem + 163840));
  void* scores_scale_wsp_handoff_5 = ((void*)((char*)buf_dyn_shmem + 167936));
  void* workspace = ((void*)((char*)buf_dyn_shmem + 168000));
  void* workspace_1 = ((void*)((char*)buf_dyn_shmem + 169024));
    ...
    *(float2*)(logsum + 0) = make_float2(broadcast_var_1, broadcast_var_1);
    for (int k = 0; k < 128; ++k) {
      ...
      for (int i_5 = 0; i_5 < 32; ++i_5) {
        acc_o[i_5] = (acc_o[i_5] * scores_scale[((i_5 & 3) >> 1)]);
      }
      overlap_plan_mbar[((k & 1) + 2)].wait(((k & 3) >> 1));
      overlap_plan_mbar[((k % 3) + 7)].wait(((k % 6) / 3));
      {
        half_t A_local[8];
        half_t B_local[32];
        tl::__sync_thread_partial(3, 256);
        for (int ki = 0; ki < 4; ++ki) {
          tl::ptx_ldmatrix_x4((&(((half_t*)S_shared)[((((k % 3) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (ki >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(A_local[0])));
          for (int i_6 = 0; i_6 < 4; ++i_6) {
            tl::ptx_ldmatrix_x4_trans((&(((half_t*)KV_shared)[((((((k & 1) * 32768) + ((((int)threadIdx.x) >> 5) * 4096)) + (ki * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_6 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_6 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local[(i_6 * 8)])));
          }
          for (int j = 0; j < 4; ++j) {
      ...
      overlap_plan_mbar[((k % 3) + 16)].arrive();
    }
    #pragma unroll
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    for (int k_1 = 0; k_1 < 128; ++k_1) {
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
      ...
      if (3 <= k_1) {
        overlap_plan_mbar[((k_1 % 3) + 16)].wait((((k_1 / 3) + 1) & 1));
      }
      #pragma unroll
      for (int i_15 = 0; i_15 < 2; ++i_15) {
        ...
        *(uint1*)(((half_t*)S_shared) + ((((((((k_1 % 3) * 1024) + (i_15 * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(S_shared_local_cast + 0);
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[((k_1 % 3) + 7)].arrive();
    }
