...
extern "C" __global__ void __launch_bounds__(512, 1) main_kernel(__grid_constant__ const CUtensorMap KV_desc, __grid_constant__ const CUtensorMap K_pe_desc, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap Q_pe_desc) {
  ...
  void* acc_o_wsp_handoff_6 = ((void*)((char*)buf_dyn_shmem + 149504));
  void* K_pe_shared = ((void*)((char*)buf_dyn_shmem + 182272));
  void* acc_s_wsp_handoff_5 = ((void*)((char*)buf_dyn_shmem + 206848));
  void* S_shared = ((void*)((char*)buf_dyn_shmem + 210944));
  void* scores_scale_wsp_handoff_4 = ((void*)((char*)buf_dyn_shmem + 212992));
  void* workspace = ((void*)((char*)buf_dyn_shmem + 213056));
  void* workspace_1 = ((void*)((char*)buf_dyn_shmem + 214080));
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_1, broadcast_var_1);
    for (int k = 0; k < 128; ++k) {
      ...
      overlap_plan_mbar[((k % 3) + 4)].wait(((k % 6) / 3));
      {
        half_t A_local_1[8];
        half_t B_local_1[4];
        for (int ki_1 = 0; ki_1 < 4; ++ki_1) {
          ...
          tl::ptx_ldmatrix_x2((&(((half_t*)K_pe_shared)[(((((((((((((int)threadIdx.x) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) >> 3) + (k % 3)) % 3) * 4096) + ((((((int)threadIdx.x) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 7) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + (ki_1 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_1 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(B_local_1[0])));
      ...
      overlap_plan_mbar[((k % 3) + 13)].arrive();
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
      ...
      if ((((((int)threadIdx.x) & 3) * 8) + (((int)threadIdx.x) >> 5)) == 0) {
        ...
        for (int i_4 = 0; i_4 < 2; ++i_4) {
          ((float*)scores_scale_wsp_handoff_4)[((i_4 * 8) + ((((int)threadIdx.x) & 31) >> 2))] = scores_scale[i_4];
        }
      }
      ...
      for (int i_5 = 0; i_5 < 4; ++i_5) {
        acc_s[i_5] = exp2f(((acc_s[i_5] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/) - (scores_max[(i_5 >> 1)] * 0x1.ec709dbe8903ep-5f/*6.011229e-02*/)));
      }
      #pragma unroll
      for (int i_6 = 0; i_6 < 2; ++i_6) {
        *(float2*)(((float*)acc_s_wsp_handoff_5) + ((((i_6 * 512) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((int)threadIdx.x) >> 5) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(acc_s + (i_6 * 2));
      }
      tl::fence_proxy_async();
      ...
      }
      {
        ...
        for (int ki_2 = 0; ki_2 < 4; ++ki_2) {
          ...
          for (int i_8 = 0; i_8 < 4; ++i_8) {
            tl::ptx_ldmatrix_x4_trans((&(((half_t*)KV_shared)[((((((k & 1) * 32768) + ((((int)threadIdx.x) >> 5) * 4096)) + (ki_2 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_8 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_8 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_2[(i_8 * 8)])));
          }
          for (int j = 0; j < 4; ++j) {
      ...
      if (k == 127) {
        ...
        for (int i_9 = 0; i_9 < 16; ++i_9) {
          *(float2*)(((float*)acc_o_wsp_handoff_6) + ((((((i_9 & 1) * 4096) + (((((int)threadIdx.x) & 31) >> 2) * 512)) + ((((int)threadIdx.x) >> 5) * 64)) + ((i_9 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(acc_o + (i_9 * 2));
        }
      }
    ...
    *(float2*)(logsum + 0) = make_float2(broadcast_var_4, broadcast_var_4);
    for (int k_1 = 0; k_1 < 128; ++k_1) {
      if (2 <= k_1) {
        overlap_plan_mbar[((k_1 & 1) + 11)].wait((((k_1 >> 1) + 1) & 1));
      }
      ...
      for (int i_10 = 0; i_10 < 2; ++i_10) {
        *(float2*)(acc_s + (i_10 * 2)) = *(float2*)(((float*)acc_s_wsp_handoff_5) + (((((i_10 * 512) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((int)threadIdx.x) >> 5) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 64));
      }
      #pragma unroll
      for (int i_11 = 0; i_11 < 2; ++i_11) {
        ...
        for (int rv_1 = 0; rv_1 < 2; ++rv_1) {
          scores_sum[i_11] = (scores_sum[i_11] + acc_s[((i_11 * 2) + rv_1)]);
        }
        tl::__sync_thread_partial(4, 256);
        scores_sum[i_11] = tl::AllReduce<tl::SumOp, 256, 32, 256, tl::NamedBarrier<256>>::run(scores_sum[i_11], (&(((float*)workspace_1)[0])));
        scores_sum[i_11] = tl::AllReduce<tl::SumOp, 4, 1, 256, tl::NamedBarrier<256>>::run(scores_sum[i_11]);
      }
      overlap_plan_mbar[7].wait((k_1 & 1));
      #pragma unroll
      for (int i_12 = 0; i_12 < 2; ++i_12) {
        scores_scale[i_12] = ((float*)scores_scale_wsp_handoff_4)[((i_12 * 8) + ((((int)threadIdx.x) & 31) >> 2))];
      }
      #pragma unroll
    ...
    for (int i_14 = 0; i_14 < 16; ++i_14) {
      *(float2*)(acc_o + (i_14 * 2)) = *(float2*)(((float*)acc_o_wsp_handoff_6) + (((((((i_14 & 1) * 4096) + (((((int)threadIdx.x) & 31) >> 2) * 512)) + ((((int)threadIdx.x) >> 5) * 64)) + ((i_14 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 512));
    }
    #pragma unroll
    for (int i_15 = 0; i_15 < 32; ++i_15) {
      acc_o[i_15] = (acc_o[i_15] / logsum[((i_15 & 3) >> 1)]);
    }
    #pragma unroll
    for (int i_16 = 0; i_16 < 4; ++i_16) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)O_shared)[((((((((int)threadIdx.x) & 15) * 512) + ((((int)threadIdx.x) >> 5) * 64)) + (i_16 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 512)])), __pack_half2(((half_t)acc_o[(i_16 * 8)]), ((half_t)acc_o[((i_16 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_16 * 8) + 2)]), ((half_t)acc_o[((i_16 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_16 * 8) + 4)]), ((half_t)acc_o[((i_16 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_16 * 8) + 6)]), ((half_t)acc_o[((i_16 * 8) + 7)])));
    }
    tl::fence_proxy_async();
