      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
      ...
      }
      {
        ...
        for (int ki_2 = 0; ki_2 < 4; ++ki_2) {
          ...
          for (int i_6 = 0; i_6 < 4; ++i_6) {
            tl::ptx_ldmatrix_x4_trans((&(((half_t*)KV_shared)[((((((k & 1) * 32768) + ((((int)threadIdx.x) >> 5) * 4096)) + (ki_2 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_6 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_6 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_2[(i_6 * 8)])));
          }
          for (int j = 0; j < 4; ++j) {
      ...
      for (int i_7 = 0; i_7 < 2; ++i_7) {
        ...
        for (int rv_1 = 0; rv_1 < 2; ++rv_1) {
          scores_sum[i_7] = (scores_sum[i_7] + acc_s[((i_7 * 2) + rv_1)]);
        }
        tl::__sync_thread_partial(3, 256);
