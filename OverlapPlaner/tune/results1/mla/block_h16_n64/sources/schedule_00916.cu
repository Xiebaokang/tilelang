  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int k = 0; k < 63; ++k) {
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
      ...
      for (int i_12 = 0; i_12 < 2; ++i_12) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_12] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_12], (&(((float*)workspace_7)[0])));
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_8, broadcast_var_8);
      ...
      for (int i_17 = 0; i_17 < 2; ++i_17) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_2[i_17] = tl::AllReduce<tl::MaxOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_17], (&(((float*)workspace_4)[0])));
      ...
      for (int i_21 = 0; i_21 < 2; ++i_21) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_21] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_21], (&(((float*)workspace_5)[0])));
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_10, broadcast_var_10);
    ...
    for (int i_30 = 0; i_30 < 2; ++i_30) {
      ...
      tl::__sync_thread_partial(3, 256);
      scores_sum[i_30] = tl::AllReduce<tl::SumOp, 256, 32, 0, tl::NamedBarrier<256>>::run(scores_sum[i_30], (&(((float*)workspace_2)[0])));
