...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap KV_desc, __grid_constant__ const CUtensorMap K_pe_desc, half_t* __restrict__ Output, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap Q_pe_desc) {
  ...
  void* workspace = ((void*)((char*)buf_dyn_shmem + 167936));
  void* workspace_1 = ((void*)((char*)buf_dyn_shmem + 168960));
  ...
  if (tl::tl_shuffle_elect<384>()) {
    mbarrier[8].arrive_and_expect_tx(16384);
    tl::tma_load(Q_desc, mbarrier[8], (&(((half_t*)Q_shared)[0])), 0, (((int)blockIdx.x) * 16), 0);
    tl::tma_load(Q_desc, mbarrier[8], (&(((half_t*)Q_shared)[1024])), 64, (((int)blockIdx.x) * 16), 0);
    tl::tma_load(Q_desc, mbarrier[8], (&(((half_t*)Q_shared)[2048])), 128, (((int)blockIdx.x) * 16), 0);
    tl::tma_load(Q_desc, mbarrier[8], (&(((half_t*)Q_shared)[3072])), 192, (((int)blockIdx.x) * 16), 0);
    tl::tma_load(Q_desc, mbarrier[8], (&(((half_t*)Q_shared)[4096])), 256, (((int)blockIdx.x) * 16), 0);
    tl::tma_load(Q_desc, mbarrier[8], (&(((half_t*)Q_shared)[5120])), 320, (((int)blockIdx.x) * 16), 0);
    tl::tma_load(Q_desc, mbarrier[8], (&(((half_t*)Q_shared)[6144])), 384, (((int)blockIdx.x) * 16), 0);
    tl::tma_load(Q_desc, mbarrier[8], (&(((half_t*)Q_shared)[7168])), 448, (((int)blockIdx.x) * 16), 0);
    mbarrier[9].arrive_and_expect_tx(2048);
    tl::tma_load(Q_pe_desc, mbarrier[9], (&(((half_t*)Q_pe_shared)[0])), 0, (((int)blockIdx.x) * 16), 0);
  }
  if (((int)threadIdx.x) < 128) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_2, broadcast_var_2);
    for (int k_1 = 0; k_1 < 128; ++k_1) {
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
      ...
      for (int i_1 = 0; i_1 < 2; ++i_1) {
        ...
        scores_max_clear[i_1] = tl::AllReduce<tl::MaxOp, 256, 32, 128, tl::NamedBarrier<256>>::run(scores_max_clear[i_1], (&(((float*)workspace_1)[0])));
      ...
      for (int i_5 = 0; i_5 < 2; ++i_5) {
        ...
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_5] = tl::AllReduce<tl::SumOp, 256, 32, 128, tl::NamedBarrier<256>>::run(scores_sum[i_5], (&(((float*)workspace)[0])));
        scores_sum[i_5] = tl::AllReduce<tl::SumOp, 4, 1, 128, tl::NamedBarrier<256>>::run(scores_sum[i_5]);
      }
      tl::ptx_stmatrix_m8n8_x2((&(((half_t*)S_shared)[((((((int)threadIdx.x) & 15) >> 3) * 512) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) + 1) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_s[0]), ((half_t)acc_s[1])), __pack_half2(((half_t)acc_s[2]), ((half_t)acc_s[3])));
      #pragma unroll
      ...
      }
      {
        ...
        for (int ki_2 = 0; ki_2 < 4; ++ki_2) {
          ...
          for (int i_8 = 0; i_8 < 4; ++i_8) {
            tl::ptx_ldmatrix_x4_trans((&(((half_t*)KV_shared)[((((((k_1 & 1) * 32768) + ((((((int)threadIdx.x) >> 5) + 4) & 7) * 4096)) + (ki_2 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_8 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_8 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_2[(i_8 * 8)])));
          }
          for (int j = 0; j < 4; ++j) {
    ...
    for (int i_10 = 0; i_10 < 4; ++i_10) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)O_shared)[((((((((int)threadIdx.x) & 15) * 512) + ((((int)threadIdx.x) >> 5) * 64)) + (i_10 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 256)])), __pack_half2(((half_t)acc_o[(i_10 * 8)]), ((half_t)acc_o[((i_10 * 8) + 1)])), __pack_half2(((half_t)acc_o[((i_10 * 8) + 2)]), ((half_t)acc_o[((i_10 * 8) + 3)])), __pack_half2(((half_t)acc_o[((i_10 * 8) + 4)]), ((half_t)acc_o[((i_10 * 8) + 5)])), __pack_half2(((half_t)acc_o[((i_10 * 8) + 6)]), ((half_t)acc_o[((i_10 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 256);
