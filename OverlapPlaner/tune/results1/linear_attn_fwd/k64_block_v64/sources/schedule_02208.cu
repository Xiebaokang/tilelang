  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ic = 0; ic < 15; ++ic) {
      ...
      overlap_plan_mbar[(((ic + 1) & 1) + 2)].wait((((ic + 1) & 3) >> 1));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_a_4, (((ic + 1) & 1) * 8192));
      ...
      tl::__sync_thread_partial(3, 128);
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_5, (((ic + 1) & 1) * 8192));
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(s + 0), 32);
        tl::warpgroup_arrive();
        tl::fence_proxy_async();
        #pragma unroll
    ...
    for (int ic_1 = 0; ic_1 < 15; ++ic_1) {
      if (1 <= ic_1) {
        overlap_plan_mbar[(((ic_1 + 1) & 1) + 4)].wait((((ic_1 + 3) & 3) >> 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[((ic_1 + 1) & 1)].arrive_and_expect_tx(8192);
        tl::tma_load(K_desc, overlap_plan_mbar[((ic_1 + 1) & 1)], (&(((half_t*)k)[(((ic_1 + 1) & 1) * 4096)])), (((int)blockIdx.y) * 64), ((ic_1 * 64) + 64), (((int)blockIdx.z) & 31), (((int)blockIdx.z) >> 5));
      }
      if (2 <= ic_1) {
