...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(float* __restrict__ FinalState, __grid_constant__ const CUtensorMap K_desc, float* __restrict__ O, const half_t* __restrict__ Q, __grid_constant__ const CUtensorMap V_desc) {
  ...
  void* h_shared = ((void*)((char*)buf_dyn_shmem + 98304));
  ...
  for (int i_3 = 0; i_3 < 4; ++i_3) {
    ...
    *(uint4*)(Q_local_cast_3 + 0) = *(uint4*)(Q + ((((((((((int)blockIdx.z) >> 5) * 4194304) + (i_3 * 65536)) + ((((int)threadIdx.x) >> 3) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.y) * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 262144));
    ...
    *(uint4*)(((half_t*)q) + ((((((i_3 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 4096)) = *(uint4*)(q_local_cast_2 + 0);
  }
  tl::cp_async_commit();
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    overlap_plan_mbar[1].arrive_and_expect_tx(8192);
    tl::fence_proxy_async();
    tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)k)[4096])), (((int)blockIdx.y) * 64), 64, (((int)blockIdx.z) & 31), (((int)blockIdx.z) >> 5));
    overlap_plan_mbar[3].arrive_and_expect_tx(8192);
    tl::fence_proxy_async();
    tl::tma_load(V_desc, overlap_plan_mbar[3], (&(((half_t*)v)[4096])), (((int)blockIdx.x) * 64), 64, (((int)blockIdx.z) & 31), (((int)blockIdx.z) >> 5));
  }
  tl::cp_async_wait<0>();
  __syncthreads();
  ...
  for (int i_4 = 0; i_4 < 32; ++i_4) {
    ...
    ((half_t*)s_shared)[((((((((((((int)threadIdx.x) >> 5) * 1024) + (((i_4 & 3) >> 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((i_4 >> 4) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_4 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((i_4 & 7) >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_4 & 1)) + 4096)] = ((half_t)condval_1);
  }
  ...
  for (int ic = 0; ic < 14; ++ic) {
    ...
    for (int i_7 = 0; i_7 < 4; ++i_7) {
      ...
      *(uint4*)(Q_local_cast_5 + 0) = *(uint4*)(Q + (((((((((((int)blockIdx.z) >> 5) * 4194304) + (ic * 262144)) + (i_7 * 65536)) + ((((int)threadIdx.x) >> 3) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.y) * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 524288));
      ...
      *(uint4*)(((half_t*)q) + (((((((ic & 1) * 4096) + (i_7 * 1024)) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(q_local_cast_4 + 0);
    }
    tl::cp_async_commit();
    overlap_plan_mbar[((ic & 1) + 4)].wait(((ic & 3) >> 1));
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[(ic & 1)].arrive_and_expect_tx(8192);
      tl::fence_proxy_async();
      tl::tma_load(K_desc, overlap_plan_mbar[(ic & 1)], (&(((half_t*)k)[((ic & 1) * 4096)])), (((int)blockIdx.y) * 64), ((ic * 64) + 128), (((int)blockIdx.z) & 31), (((int)blockIdx.z) >> 5));
    }
    overlap_plan_mbar[((ic & 1) + 6)].wait(((ic & 3) >> 1));
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[((ic & 1) + 2)].arrive_and_expect_tx(8192);
      tl::fence_proxy_async();
      tl::tma_load(V_desc, overlap_plan_mbar[((ic & 1) + 2)], (&(((half_t*)v)[((ic & 1) * 4096)])), (((int)blockIdx.x) * 64), ((ic * 64) + 128), (((int)blockIdx.z) & 31), (((int)blockIdx.z) >> 5));
    }
    tl::cp_async_wait<0>();
    __syncthreads();
    overlap_plan_mbar[(ic & 1)].wait((((ic >> 1) + 1) & 1));
    {
      ...
      tl::increase_descriptor_offset<int>(desc_a_5, ((ic & 1) * 8192));
      tl::initialize_wgmma_descriptor<1, 1, 64>(desc_b_5, (&(((half_t*)k)[0])));
      tl::increase_descriptor_offset<int>(desc_b_5, ((ic & 1) * 8192));
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(s + 0), 32);
      tl::warpgroup_arrive();
      tl::fence_proxy_async();
      #pragma unroll
    ...
    for (int i_8 = 0; i_8 < 32; ++i_8) {
      float condval_2;
      if ((((((i_8 >> 2) * 8) + ((((int)threadIdx.x) & 3) * 2)) + (i_8 & 1)) <= ((((((int)threadIdx.x) >> 5) * 16) + (((i_8 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
        condval_2 = s[i_8];
      } else {
        condval_2 = 0x0p+0f/*0.000000e+00*/;
      }
      ((half_t*)s_shared)[((((((((((ic & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((i_8 & 3) >> 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((i_8 >> 4) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_8 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((i_8 & 7) >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_8 & 1))] = ((half_t)condval_2);
    }
    overlap_plan_mbar[(((ic + 1) & 1) + 2)].wait((((ic + 1) & 3) >> 1));
    {
      ...
      tl::increase_descriptor_offset<int>(desc_a_6, (((ic + 1) & 1) * 8192));
      tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_6, (&(((half_t*)v)[0])));
      tl::increase_descriptor_offset<int>(desc_b_6, (((ic + 1) & 1) * 8192));
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(o + 0), 32);
      tl::warpgroup_arrive();
      tl::fence_proxy_async();
      #pragma unroll
      for (int ki_6 = 0; ki_6 < 4; ++ki_6) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(uint64_t(desc_a_6 + ((ki_6 * 32) >> 4)), uint64_t(desc_b_6 + ((ki_6 * 2048) >> 4)), ((uint32_t*)(o + 0)), ((0 < ki_6) ? 1 : 0));
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(o + 0), 32);
    ...
    for (int i_9 = 0; i_9 < 4; ++i_9) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)h_shared)[((((((int)threadIdx.x) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_9 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_9 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)h[(i_9 * 8)]), ((half_t)h[((i_9 * 8) + 1)])), __pack_half2(((half_t)h[((i_9 * 8) + 2)]), ((half_t)h[((i_9 * 8) + 3)])), __pack_half2(((half_t)h[((i_9 * 8) + 4)]), ((half_t)h[((i_9 * 8) + 5)])), __pack_half2(((half_t)h[((i_9 * 8) + 6)]), ((half_t)h[((i_9 * 8) + 7)])));
    }
    overlap_plan_mbar[((ic + 1) & 1)].wait((((ic + 1) & 3) >> 1));
    {
      tl::GmmaDescriptor desc_a_7;
      tl::GmmaDescriptor desc_b_7;
      tl::initialize_wgmma_descriptor<1, 0, 64>(desc_a_7, (&(((half_t*)k)[0])));
      ...
      for (int ki_7 = 0; ki_7 < 4; ++ki_7) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, true, true, 1, 1>(uint64_t(desc_a_7 + ((ki_7 * 2048) >> 4)), uint64_t(desc_b_7 + ((ki_7 * 2048) >> 4)), ((uint32_t*)(h + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(h + 0), 32);
    ...
    overlap_plan_mbar[(((ic + 1) & 1) + 6)].arrive();
    {
      ...
      tl::increase_descriptor_offset<int>(desc_a_8, (((ic + 1) & 1) * 8192));
    ...
    for (int i_10 = 0; i_10 < 16; ++i_10) {
      *(float2*)(((float*)o_shared) + ((((((((ic + 1) & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_10 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_10 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(o + (i_10 * 2));
    }
    #pragma unroll
    for (int i_11 = 0; i_11 < 8; ++i_11) {
      AtomicAddx4((&(O[((((((((((int)blockIdx.z) >> 5) * 4194304) + (ic * 262144)) + (i_11 * 32768)) + ((((int)threadIdx.x) >> 4) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 15) * 4))])), *(float4*)(((float*)o_shared) + ((((ic & 1) * 4096) + (i_11 * 512)) + (((int)threadIdx.x) * 4))));
    }
  }
  overlap_plan_mbar[3].wait(1);
  {
    ...
    for (int ki_9 = 0; ki_9 < 4; ++ki_9) {
      tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(uint64_t(desc_a_9 + ((ki_9 * 32) >> 4)), uint64_t(desc_b_9 + ((ki_9 * 2048) >> 4)), ((uint32_t*)(o + 0)), ((0 < ki_9) ? 1 : 0));
    }
    tl::warpgroup_commit_batch();
    tl::warpgroup_wait<0>();
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(o + 0), 32);
