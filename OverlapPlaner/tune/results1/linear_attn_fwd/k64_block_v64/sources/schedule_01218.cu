...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(float* __restrict__ FinalState, __grid_constant__ const CUtensorMap K_desc, float* __restrict__ O, const half_t* __restrict__ Q, __grid_constant__ const CUtensorMap V_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ic = 0; ic < 15; ++ic) {
      ...
      overlap_plan_mbar[((ic + 1) % 3)].wait((((ic + 1) % 6) / 3));
      overlap_plan_mbar[(((ic + 1) & 1) + 3)].wait((((ic + 1) & 3) >> 1));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_a_4, (((ic + 1) % 3) * 8192));
        tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_4, (&(((half_t*)v)[0])));
        tl::increase_descriptor_offset<int>(desc_b_4, (((ic + 1) & 1) * 8192));
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(h + 0), 32);
        tl::warpgroup_arrive();
        tl::fence_proxy_async();
        #pragma unroll
      ...
      for (int i_6 = 0; i_6 < 4; ++i_6) {
        ...
        *(uint4*)(Q_local_cast_3 + 0) = *(uint4*)(Q + (((((((((((int)blockIdx.z) >> 5) * 4194304) + (ic * 262144)) + (i_6 * 65536)) + ((((int)threadIdx.x) >> 3) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.y) * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 262144));
        ...
        *(uint4*)(((half_t*)q) + (((((i_6 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(q_local_cast_2 + 0);
      }
      tl::cp_async_commit();
      tl::cp_async_wait<1>();
      tl::__sync_thread_partial(3, 128);
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_5, (((ic + 1) % 3) * 8192));
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(s + 0), 32);
        tl::warpgroup_arrive();
        tl::fence_proxy_async();
        #pragma unroll
      ...
      overlap_plan_mbar[(((ic + 1) % 3) + 5)].arrive();
      #pragma unroll
      for (int i_7 = 0; i_7 < 32; ++i_7) {
        float condval_1;
        if ((((((i_7 >> 2) * 8) + ((((int)threadIdx.x) & 3) * 2)) + (i_7 & 1)) <= ((((((int)threadIdx.x) >> 5) * 16) + (((i_7 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
          condval_1 = s[i_7];
        } else {
          condval_1 = 0x0p+0f/*0.000000e+00*/;
        }
        ((half_t*)s_shared)[(((((((((((int)threadIdx.x) >> 5) * 1024) + (((i_7 & 3) >> 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((i_7 >> 4) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_7 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((i_7 & 7) >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_7 & 1))] = ((half_t)condval_1);
      }
      {
      ...
      overlap_plan_mbar[(((ic + 1) & 1) + 8)].arrive();
      {
        ...
        for (int ki_7 = 0; ki_7 < 4; ++ki_7) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(uint64_t(desc_a_7 + ((ki_7 * 32) >> 4)), uint64_t(desc_b_7 + ((ki_7 * 2048) >> 4)), ((uint32_t*)(o + 0)), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(o + 0), 32);
      ...
      for (int i_8 = 0; i_8 < 16; ++i_8) {
        *(float2*)(((float*)o_shared) + ((((((((ic + 1) & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_8 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_8 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(o + (i_8 * 2));
      }
      #pragma unroll
      for (int i_9 = 0; i_9 < 8; ++i_9) {
        AtomicAddx4((&(O[((((((((((int)blockIdx.z) >> 5) * 4194304) + (ic * 262144)) + (i_9 * 32768)) + ((((int)threadIdx.x) >> 4) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 15) * 4))])), *(float4*)(((float*)o_shared) + ((((ic & 1) * 4096) + (i_9 * 512)) + (((int)threadIdx.x) * 4))));
      }
    }
    tl::__sync_thread_partial(3, 128);
    #pragma unroll
    for (int i_10 = 0; i_10 < 8; ++i_10) {
      AtomicAddx4((&(O[((((((((((int)blockIdx.z) >> 5) * 4194304) + (i_10 * 32768)) + ((((int)threadIdx.x) >> 4) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 15) * 4)) + 3932160)])), *(float4*)(((float*)o_shared) + (((i_10 * 512) + (((int)threadIdx.x) * 4)) + 4096)));
    }
    #pragma unroll
    for (int i_11 = 0; i_11 < 16; ++i_11) {
      *(float2*)(FinalState + ((((((((((int)blockIdx.z) * 16384) + (((int)blockIdx.y) * 8192)) + ((((int)threadIdx.x) >> 5) * 2048)) + ((i_11 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + (((int)blockIdx.x) * 64)) + ((i_11 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(h + (i_11 * 2));
    }
  } else {
