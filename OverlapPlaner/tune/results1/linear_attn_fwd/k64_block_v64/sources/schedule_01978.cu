...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(float* __restrict__ FinalState, __grid_constant__ const CUtensorMap K_desc, float* __restrict__ O, const half_t* __restrict__ Q, __grid_constant__ const CUtensorMap V_desc) {
  ...
  void* k = ((void*)((char*)buf_dyn_shmem + 0));
  void* o_shared = ((void*)((char*)buf_dyn_shmem + 16384));
  void* q = ((void*)((char*)buf_dyn_shmem + 32768));
  void* v = ((void*)((char*)buf_dyn_shmem + 49152));
  void* h_shared = ((void*)((char*)buf_dyn_shmem + 65536));
  ...
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    ...
    tl::tma_load(V_desc, overlap_plan_mbar[2], (&(((half_t*)v)[0])), (((int)blockIdx.x) * 64), 0, (((int)blockIdx.z) & 31), (((int)blockIdx.z) >> 5));
  }
  #pragma unroll
  ...
  overlap_plan_mbar[0].wait(0);
  {
    ...
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(s_v0 + 0), 32);
    tl::warpgroup_arrive();
    tl::fence_proxy_async();
    #pragma unroll
    for (int ki = 0; ki < 4; ++ki) {
      tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, false, 1, 1>(uint64_t(desc_a + ((ki * 32) >> 4)), uint64_t(desc_b + ((ki * 32) >> 4)), ((uint32_t*)(s_v0 + 0)), ((0 < ki) ? 1 : 0));
    }
  ...
  for (int ic = 0; ic < 7; ++ic) {
    if (1 <= ic) {
      overlap_plan_mbar[5].wait(((ic + 1) & 1));
    }
    __syncthreads();
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[1].arrive_and_expect_tx(8192);
      tl::fence_proxy_async();
      tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)k)[4096])), (((int)blockIdx.y) * 64), ((ic * 128) + 64), (((int)blockIdx.z) & 31), (((int)blockIdx.z) >> 5));
    }
    if (1 <= ic) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::fence_proxy_async();
      tl::tma_load(V_desc, overlap_plan_mbar[3], (&(((half_t*)v)[4096])), (((int)blockIdx.x) * 64), ((ic * 128) + 64), (((int)blockIdx.z) & 31), (((int)blockIdx.z) >> 5));
    }
    #pragma unroll
    for (int i_2 = 0; i_2 < 4; ++i_2) {
      half_t Q_local_cast_3[8];
      half_t q_local_cast_2[8];
      *(uint4*)(Q_local_cast_3 + 0) = *(uint4*)(Q + (((((((((((int)blockIdx.z) >> 5) * 4194304) + (ic * 524288)) + (i_2 * 65536)) + ((((int)threadIdx.x) >> 3) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.y) * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 262144));
      ...
      *(uint4*)(((half_t*)q) + ((((((i_2 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 4096)) = *(uint4*)(q_local_cast_2 + 0);
    }
    tl::cp_async_commit();
    tl::cp_async_wait<1>();
    __syncthreads();
    overlap_plan_mbar[1].wait((ic & 1));
    {
      tl::GmmaDescriptor desc_a_1;
      tl::GmmaDescriptor desc_b_1;
      tl::initialize_wgmma_descriptor<1, 1, 64>(desc_a_1, (&(((half_t*)q)[0])));
      tl::increase_descriptor_offset<int>(desc_a_1, 8192);
      tl::initialize_wgmma_descriptor<1, 1, 64>(desc_b_1, (&(((half_t*)k)[0])));
      tl::increase_descriptor_offset<int>(desc_b_1, 8192);
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(s_v1 + 0), 32);
      tl::warpgroup_arrive();
      tl::fence_proxy_async();
      #pragma unroll
      for (int ki_1 = 0; ki_1 < 4; ++ki_1) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, false, 1, 1>(uint64_t(desc_a_1 + ((ki_1 * 32) >> 4)), uint64_t(desc_b_1 + ((ki_1 * 32) >> 4)), ((uint32_t*)(s_v1 + 0)), ((0 < ki_1) ? 1 : 0));
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(s_v1 + 0), 32);
    ...
    overlap_plan_mbar[6].arrive();
    {
      ...
      tl::initialize_wgmma_descriptor<1, 1, 64>(desc_a_4, (&(((half_t*)q)[0])));
      tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_4, (&(((half_t*)h_shared)[0])));
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(o + 0), 32);
      tl::warpgroup_arrive();
      #pragma unroll
      for (int ki_4 = 0; ki_4 < 4; ++ki_4) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(uint64_t(desc_a_4 + ((ki_4 * 32) >> 4)), uint64_t(desc_b_4 + ((ki_4 * 2048) >> 4)), ((uint32_t*)(o + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(o + 0), 32);
    ...
    for (int i_5 = 0; i_5 < 16; ++i_5) {
      *(float2*)(((float*)o_shared) + ((((((((int)threadIdx.x) >> 5) * 1024) + ((i_5 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_5 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(o + (i_5 * 2));
    }
    __syncthreads();
    #pragma unroll
    for (int i_6 = 0; i_6 < 8; ++i_6) {
      AtomicAddx4((&(O[((((((((((int)blockIdx.z) >> 5) * 4194304) + (ic * 524288)) + (i_6 * 32768)) + ((((int)threadIdx.x) >> 4) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 15) * 4))])), *(float4*)(((float*)o_shared) + ((i_6 * 512) + (((int)threadIdx.x) * 4))));
    }
    overlap_plan_mbar[4].wait((ic & 1));
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[0].arrive_and_expect_tx(8192);
      tl::fence_proxy_async();
      tl::tma_load(K_desc, overlap_plan_mbar[0], (&(((half_t*)k)[0])), (((int)blockIdx.y) * 64), ((ic * 128) + 128), (((int)blockIdx.z) & 31), (((int)blockIdx.z) >> 5));
    }
    overlap_plan_mbar[6].wait((ic & 1));
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[2].arrive_and_expect_tx(8192);
      tl::fence_proxy_async();
      tl::tma_load(V_desc, overlap_plan_mbar[2], (&(((half_t*)v)[0])), (((int)blockIdx.x) * 64), ((ic * 128) + 128), (((int)blockIdx.z) & 31), (((int)blockIdx.z) >> 5));
    }
    #pragma unroll
    for (int i_7 = 0; i_7 < 4; ++i_7) {
      half_t Q_local_cast_5[8];
      half_t q_local_cast_4[8];
      *(uint4*)(Q_local_cast_5 + 0) = *(uint4*)(Q + (((((((((((int)blockIdx.z) >> 5) * 4194304) + (ic * 524288)) + (i_7 * 65536)) + ((((int)threadIdx.x) >> 3) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.y) * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 524288));
      ...
      *(uint4*)(((half_t*)q) + (((((i_7 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(q_local_cast_4 + 0);
    }
    tl::cp_async_commit();
    tl::cp_async_wait<1>();
    __syncthreads();
    overlap_plan_mbar[0].wait(((ic + 1) & 1));
    {
      ...
      for (int ki_5 = 0; ki_5 < 4; ++ki_5) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, false, 1, 1>(uint64_t(desc_a_5 + ((ki_5 * 32) >> 4)), uint64_t(desc_b_5 + ((ki_5 * 32) >> 4)), ((uint32_t*)(s_v0 + 0)), ((0 < ki_5) ? 1 : 0));
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(s_v0 + 0), 32);
    ...
    overlap_plan_mbar[1].wait((ic & 1));
    overlap_plan_mbar[3].wait((ic & 1));
    {
      tl::GmmaDescriptor desc_a_6;
      tl::GmmaDescriptor desc_b_6;
      tl::initialize_wgmma_descriptor<1, 0, 64>(desc_a_6, (&(((half_t*)k)[0])));
      tl::increase_descriptor_offset<int>(desc_a_6, 8192);
      ...
      for (int ki_6 = 0; ki_6 < 4; ++ki_6) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, true, true, 1, 1>(uint64_t(desc_a_6 + ((ki_6 * 2048) >> 4)), uint64_t(desc_b_6 + ((ki_6 * 2048) >> 4)), ((uint32_t*)(h + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(h + 0), 32);
    ...
    for (int i_9 = 0; i_9 < 32; ++i_9) {
      ...
      ((half_t*)s_shared)[(((((((((((int)threadIdx.x) >> 5) * 1024) + (((i_9 & 3) >> 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((i_9 >> 4) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_9 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((i_9 & 7) >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_9 & 1))] = ((half_t)condval_1);
    }
    {
      ...
      tl::increase_descriptor_offset<int>(desc_b_7, 8192);
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(o + 0), 32);
      tl::warpgroup_arrive();
      tl::fence_proxy_async();
      __syncthreads();
    ...
    overlap_plan_mbar[7].arrive();
    {
      ...
      tl::initialize_wgmma_descriptor<1, 1, 64>(desc_a_8, (&(((half_t*)q)[0])));
      tl::increase_descriptor_offset<int>(desc_a_8, 8192);
      tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_8, (&(((half_t*)h_shared)[0])));
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(o + 0), 32);
      tl::warpgroup_arrive();
      #pragma unroll
      for (int ki_8 = 0; ki_8 < 4; ++ki_8) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(uint64_t(desc_a_8 + ((ki_8 * 32) >> 4)), uint64_t(desc_b_8 + ((ki_8 * 2048) >> 4)), ((uint32_t*)(o + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(o + 0), 32);
    ...
    for (int i_10 = 0; i_10 < 16; ++i_10) {
      *(float2*)(((float*)o_shared) + ((((((((int)threadIdx.x) >> 5) * 1024) + ((i_10 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_10 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(o + (i_10 * 2));
    }
    __syncthreads();
    #pragma unroll
    for (int i_11 = 0; i_11 < 8; ++i_11) {
      AtomicAddx4((&(O[(((((((((((int)blockIdx.z) >> 5) * 4194304) + (ic * 524288)) + (i_11 * 32768)) + ((((int)threadIdx.x) >> 4) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 15) * 4)) + 262144)])), *(float4*)(((float*)o_shared) + ((i_11 * 512) + (((int)threadIdx.x) * 4))));
    }
  }
  ...
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    overlap_plan_mbar[1].arrive_and_expect_tx(8192);
    tl::fence_proxy_async();
    tl::tma_load(K_desc, overlap_plan_mbar[1], (&(((half_t*)k)[4096])), (((int)blockIdx.y) * 64), 960, (((int)blockIdx.z) & 31), (((int)blockIdx.z) >> 5));
  }
  overlap_plan_mbar[7].wait(0);
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    overlap_plan_mbar[3].arrive_and_expect_tx(8192);
    tl::fence_proxy_async();
    tl::tma_load(V_desc, overlap_plan_mbar[3], (&(((half_t*)v)[4096])), (((int)blockIdx.x) * 64), 960, (((int)blockIdx.z) & 31), (((int)blockIdx.z) >> 5));
  }
  #pragma unroll
  for (int i_12 = 0; i_12 < 4; ++i_12) {
    half_t Q_local_cast_7[8];
    half_t q_local_cast_6[8];
    *(uint4*)(Q_local_cast_7 + 0) = *(uint4*)(Q + ((((((((((int)blockIdx.z) >> 5) * 4194304) + (i_12 * 65536)) + ((((int)threadIdx.x) >> 3) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.y) * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 3932160));
    ...
    *(uint4*)(((half_t*)q) + ((((((i_12 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 4096)) = *(uint4*)(q_local_cast_6 + 0);
  }
  tl::cp_async_commit();
  tl::cp_async_wait<1>();
  __syncthreads();
  overlap_plan_mbar[1].wait(1);
  {
    ...
    tl::increase_descriptor_offset<int>(desc_a_9, 8192);
    ...
    for (int ki_9 = 0; ki_9 < 4; ++ki_9) {
      tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, false, 1, 1>(uint64_t(desc_a_9 + ((ki_9 * 32) >> 4)), uint64_t(desc_b_9 + ((ki_9 * 32) >> 4)), ((uint32_t*)(s_v1 + 0)), ((0 < ki_9) ? 1 : 0));
    }
    tl::warpgroup_commit_batch();
    tl::warpgroup_wait<0>();
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(s_v1 + 0), 32);
  ...
  for (int i_13 = 0; i_13 < 4; ++i_13) {
    tl::ptx_stmatrix_m8n8_x4((&(((half_t*)h_shared)[((((((int)threadIdx.x) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_13 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_13 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)h[(i_13 * 8)]), ((half_t)h[((i_13 * 8) + 1)])), __pack_half2(((half_t)h[((i_13 * 8) + 2)]), ((half_t)h[((i_13 * 8) + 3)])), __pack_half2(((half_t)h[((i_13 * 8) + 4)]), ((half_t)h[((i_13 * 8) + 5)])), __pack_half2(((half_t)h[((i_13 * 8) + 6)]), ((half_t)h[((i_13 * 8) + 7)])));
  }
  ...
  overlap_plan_mbar[2].wait(1);
  {
    ...
    tl::initialize_wgmma_descriptor<1, 0, 64>(desc_a_10, (&(((half_t*)k)[0])));
    ...
    for (int ki_10 = 0; ki_10 < 4; ++ki_10) {
      tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, true, true, 1, 1>(uint64_t(desc_a_10 + ((ki_10 * 2048) >> 4)), uint64_t(desc_b_10 + ((ki_10 * 2048) >> 4)), ((uint32_t*)(h + 0)), 1);
    }
    tl::warpgroup_commit_batch();
    tl::warpgroup_wait<0>();
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(h + 0), 32);
  ...
  for (int i_14 = 0; i_14 < 32; ++i_14) {
    ...
    ((half_t*)s_shared)[(((((((((((int)threadIdx.x) >> 5) * 1024) + (((i_14 & 3) >> 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((i_14 >> 4) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_14 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((i_14 & 7) >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_14 & 1))] = ((half_t)condval_2);
  }
  {
    ...
    for (int ki_11 = 0; ki_11 < 4; ++ki_11) {
      tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(uint64_t(desc_a_11 + ((ki_11 * 32) >> 4)), uint64_t(desc_b_11 + ((ki_11 * 2048) >> 4)), ((uint32_t*)(o + 0)), ((0 < ki_11) ? 1 : 0));
    }
    tl::warpgroup_commit_batch();
    tl::warpgroup_wait<0>();
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(o + 0), 32);
  ...
  overlap_plan_mbar[6].arrive();
  {
    ...
    tl::initialize_wgmma_descriptor<1, 1, 64>(desc_a_12, (&(((half_t*)q)[0])));
    tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_12, (&(((half_t*)h_shared)[0])));
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(o + 0), 32);
    tl::warpgroup_arrive();
    #pragma unroll
    for (int ki_12 = 0; ki_12 < 4; ++ki_12) {
      tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(uint64_t(desc_a_12 + ((ki_12 * 32) >> 4)), uint64_t(desc_b_12 + ((ki_12 * 2048) >> 4)), ((uint32_t*)(o + 0)), 1);
    }
    tl::warpgroup_commit_batch();
    tl::warpgroup_wait<0>();
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(o + 0), 32);
  ...
  for (int i_15 = 0; i_15 < 16; ++i_15) {
    *(float2*)(((float*)o_shared) + ((((((((int)threadIdx.x) >> 5) * 1024) + ((i_15 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_15 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(o + (i_15 * 2));
  }
  __syncthreads();
  #pragma unroll
  for (int i_16 = 0; i_16 < 8; ++i_16) {
    AtomicAddx4((&(O[((((((((((int)blockIdx.z) >> 5) * 4194304) + (i_16 * 32768)) + ((((int)threadIdx.x) >> 4) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 15) * 4)) + 3670016)])), *(float4*)(((float*)o_shared) + ((i_16 * 512) + (((int)threadIdx.x) * 4))));
  }
  #pragma unroll
  for (int i_17 = 0; i_17 < 4; ++i_17) {
    tl::ptx_stmatrix_m8n8_x4((&(((half_t*)h_shared)[((((((int)threadIdx.x) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_17 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_17 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)h[(i_17 * 8)]), ((half_t)h[((i_17 * 8) + 1)])), __pack_half2(((half_t)h[((i_17 * 8) + 2)]), ((half_t)h[((i_17 * 8) + 3)])), __pack_half2(((half_t)h[((i_17 * 8) + 4)]), ((half_t)h[((i_17 * 8) + 5)])), __pack_half2(((half_t)h[((i_17 * 8) + 6)]), ((half_t)h[((i_17 * 8) + 7)])));
  }
  overlap_plan_mbar[1].wait(1);
  overlap_plan_mbar[3].wait(1);
  {
    ...
    tl::initialize_wgmma_descriptor<1, 0, 64>(desc_a_13, (&(((half_t*)k)[0])));
    tl::increase_descriptor_offset<int>(desc_a_13, 8192);
    tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_13, (&(((half_t*)v)[0])));
    tl::increase_descriptor_offset<int>(desc_b_13, 8192);
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(h + 0), 32);
    tl::warpgroup_arrive();
    tl::fence_proxy_async();
    #pragma unroll
    for (int ki_13 = 0; ki_13 < 4; ++ki_13) {
      tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, true, true, 1, 1>(uint64_t(desc_a_13 + ((ki_13 * 2048) >> 4)), uint64_t(desc_b_13 + ((ki_13 * 2048) >> 4)), ((uint32_t*)(h + 0)), 1);
    }
    tl::warpgroup_commit_batch();
    tl::warpgroup_wait<0>();
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(h + 0), 32);
  ...
  for (int i_18 = 0; i_18 < 32; ++i_18) {
    float condval_3;
    if ((((((i_18 >> 2) * 8) + ((((int)threadIdx.x) & 3) * 2)) + (i_18 & 1)) <= ((((((int)threadIdx.x) >> 5) * 16) + (((i_18 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
      condval_3 = s_v1[i_18];
    } else {
      condval_3 = 0x0p+0f/*0.000000e+00*/;
    }
    ((half_t*)s_shared)[(((((((((((int)threadIdx.x) >> 5) * 1024) + (((i_18 & 3) >> 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((i_18 >> 4) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_18 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((i_18 & 7) >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_18 & 1))] = ((half_t)condval_3);
  }
  {
    ...
    tl::increase_descriptor_offset<int>(desc_b_14, 8192);
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(o + 0), 32);
    tl::warpgroup_arrive();
    tl::fence_proxy_async();
    __syncthreads();
    ...
    for (int ki_14 = 0; ki_14 < 4; ++ki_14) {
      tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(uint64_t(desc_a_14 + ((ki_14 * 32) >> 4)), uint64_t(desc_b_14 + ((ki_14 * 2048) >> 4)), ((uint32_t*)(o + 0)), ((0 < ki_14) ? 1 : 0));
    }
    tl::warpgroup_commit_batch();
    tl::warpgroup_wait<0>();
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(o + 0), 32);
  ...
  __syncthreads();
  {
    ...
    tl::increase_descriptor_offset<int>(desc_a_15, 8192);
    tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_15, (&(((half_t*)h_shared)[0])));
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(o + 0), 32);
    tl::warpgroup_arrive();
    #pragma unroll
    for (int ki_15 = 0; ki_15 < 4; ++ki_15) {
      tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(uint64_t(desc_a_15 + ((ki_15 * 32) >> 4)), uint64_t(desc_b_15 + ((ki_15 * 2048) >> 4)), ((uint32_t*)(o + 0)), 1);
    }
    tl::warpgroup_commit_batch();
    tl::warpgroup_wait<0>();
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(o + 0), 32);
  ...
  for (int i_19 = 0; i_19 < 16; ++i_19) {
    *(float2*)(((float*)o_shared) + ((((((((int)threadIdx.x) >> 5) * 1024) + ((i_19 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_19 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(o + (i_19 * 2));
  }
  __syncthreads();
  #pragma unroll
  for (int i_20 = 0; i_20 < 8; ++i_20) {
    AtomicAddx4((&(O[((((((((((int)blockIdx.z) >> 5) * 4194304) + (i_20 * 32768)) + ((((int)threadIdx.x) >> 4) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 15) * 4)) + 3932160)])), *(float4*)(((float*)o_shared) + ((i_20 * 512) + (((int)threadIdx.x) * 4))));
  }
  #pragma unroll
  for (int i_21 = 0; i_21 < 16; ++i_21) {
    *(float2*)(FinalState + ((((((((((int)blockIdx.z) * 16384) + (((int)blockIdx.y) * 8192)) + ((((int)threadIdx.x) >> 5) * 2048)) + ((i_21 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + (((int)blockIdx.x) * 64)) + ((i_21 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(h + (i_21 * 2));
  }
}
