...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(float* __restrict__ FinalState, __grid_constant__ const CUtensorMap K_desc, float* __restrict__ O, const half_t* __restrict__ Q, __grid_constant__ const CUtensorMap V_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ic = 0; ic < 16; ++ic) {
      ...
      if (3 <= ic) {
        overlap_plan_mbar[((ic % 3) + 18)].wait((((ic / 3) + 1) & 1));
      }
      ...
      for (int i_1 = 0; i_1 < 16; ++i_1) {
        ...
        *(uint1*)(((half_t*)h_shared) + (((((((((ic % 3) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_1 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_1 >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_1 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_1 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(h_shared_local_cast + 0);
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[((ic % 3) + 6)].arrive();
    ...
    for (int ic_1 = 0; ic_1 < 16; ++ic_1) {
      overlap_plan_mbar[5].wait((ic_1 & 1));
      #pragma unroll
      ...
      overlap_plan_mbar[((ic_1 % 3) + 6)].wait(((ic_1 % 6) / 3));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_3, ((ic_1 % 3) * 8192));
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(o + 0), 32);
        tl::warpgroup_arrive();
        #pragma unroll
      ...
      overlap_plan_mbar[((ic_1 % 3) + 18)].arrive();
      if (2 <= ic_1) {
