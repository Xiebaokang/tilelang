...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(float* __restrict__ FinalState, __grid_constant__ const CUtensorMap K_desc, float* __restrict__ O, const half_t* __restrict__ Q, __grid_constant__ const CUtensorMap V_desc) {
  ...
  for (int i_4 = 0; i_4 < 4; ++i_4) {
    ...
    *(uint4*)(Q_local_cast_3 + 0) = *(uint4*)(Q + ((((((((((int)blockIdx.z) >> 5) * 4194304) + (i_4 * 65536)) + ((((int)threadIdx.x) >> 3) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.y) * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 262144));
  ...
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    overlap_plan_mbar[1].arrive_and_expect_tx(8192);
    tl::fence_proxy_async();
    tl::tma_load(V_desc, overlap_plan_mbar[1], (&(((half_t*)v)[0])), (((int)blockIdx.x) * 64), 64, (((int)blockIdx.z) & 31), (((int)blockIdx.z) >> 5));
  }
  tl::cp_async_wait<0>();
  __syncthreads();
  ...
  for (int ic = 0; ic < 7; ++ic) {
    ...
    for (int i_8 = 0; i_8 < 4; ++i_8) {
      ...
      *(uint4*)(Q_local_cast_5 + 0) = *(uint4*)(Q + (((((((((((int)blockIdx.z) >> 5) * 4194304) + (ic * 524288)) + (i_8 * 65536)) + ((((int)threadIdx.x) >> 3) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.y) * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 524288));
      ...
      *(uint4*)(((half_t*)q) + (((((i_8 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(q_local_cast_4 + 0);
    }
    tl::cp_async_commit();
    ...
    for (int i_9 = 0; i_9 < 32; ++i_9) {
      ...
      ((half_t*)s_shared)[(((((((((((int)threadIdx.x) >> 5) * 1024) + (((i_9 & 3) >> 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((i_9 >> 4) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_9 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((i_9 & 7) >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_9 & 1))] = ((half_t)condval_2);
    }
    overlap_plan_mbar[1].wait(0);
    {
    ...
    for (int i_10 = 0; i_10 < 4; ++i_10) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)h_shared)[((((((int)threadIdx.x) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_10 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_10 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)h[(i_10 * 8)]), ((half_t)h[((i_10 * 8) + 1)])), __pack_half2(((half_t)h[((i_10 * 8) + 2)]), ((half_t)h[((i_10 * 8) + 3)])), __pack_half2(((half_t)h[((i_10 * 8) + 4)]), ((half_t)h[((i_10 * 8) + 5)])), __pack_half2(((half_t)h[((i_10 * 8) + 6)]), ((half_t)h[((i_10 * 8) + 7)])));
    }
    {
    ...
    for (int i_12 = 0; i_12 < 8; ++i_12) {
      AtomicAddx4((&(O[((((((((((int)blockIdx.z) >> 5) * 4194304) + (ic * 524288)) + (i_12 * 32768)) + ((((int)threadIdx.x) >> 4) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 15) * 4))])), *(float4*)(((float*)o_shared) + ((i_12 * 512) + (((int)threadIdx.x) * 4))));
    }
    #pragma unroll
    for (int i_13 = 0; i_13 < 4; ++i_13) {
      half_t Q_local_cast_7[8];
      half_t q_local_cast_6[8];
      *(uint4*)(Q_local_cast_7 + 0) = *(uint4*)(Q + (((((((((((int)blockIdx.z) >> 5) * 4194304) + (ic * 524288)) + (i_13 * 65536)) + ((((int)threadIdx.x) >> 3) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.y) * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 786432));
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[0].arrive_and_expect_tx(8192);
      tl::fence_proxy_async();
      tl::tma_load(K_desc, overlap_plan_mbar[0], (&(((half_t*)k)[0])), (((int)blockIdx.y) * 64), ((ic * 128) + 192), (((int)blockIdx.z) & 31), (((int)blockIdx.z) >> 5));
    }
    overlap_plan_mbar[3].wait(0);
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[1].arrive_and_expect_tx(8192);
      tl::fence_proxy_async();
      tl::tma_load(V_desc, overlap_plan_mbar[1], (&(((half_t*)v)[0])), (((int)blockIdx.x) * 64), ((ic * 128) + 192), (((int)blockIdx.z) & 31), (((int)blockIdx.z) >> 5));
    }
    tl::cp_async_wait<0>();
    __syncthreads();
    overlap_plan_mbar[0].wait(1);
    ...
    for (int i_15 = 0; i_15 < 4; ++i_15) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)h_shared)[((((((int)threadIdx.x) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_15 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_15 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)h[(i_15 * 8)]), ((half_t)h[((i_15 * 8) + 1)])), __pack_half2(((half_t)h[((i_15 * 8) + 2)]), ((half_t)h[((i_15 * 8) + 3)])), __pack_half2(((half_t)h[((i_15 * 8) + 4)]), ((half_t)h[((i_15 * 8) + 5)])), __pack_half2(((half_t)h[((i_15 * 8) + 6)]), ((half_t)h[((i_15 * 8) + 7)])));
    }
    {
    ...
    for (int i_16 = 0; i_16 < 16; ++i_16) {
      *(float2*)(((float*)o_shared) + ((((((((int)threadIdx.x) >> 5) * 1024) + ((i_16 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_16 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(o_v0 + (i_16 * 2));
    }
    #pragma unroll
    for (int i_17 = 0; i_17 < 8; ++i_17) {
      AtomicAddx4((&(O[(((((((((((int)blockIdx.z) >> 5) * 4194304) + (ic * 524288)) + (i_17 * 32768)) + ((((int)threadIdx.x) >> 4) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 15) * 4)) + 262144)])), *(float4*)(((float*)o_shared) + (((i_17 * 512) + (((int)threadIdx.x) * 4)) + 4096)));
    }
  }
  __syncthreads();
  #pragma unroll
  for (int i_18 = 0; i_18 < 16; ++i_18) {
    *(float2*)(((float*)o_shared) + (((((((((int)threadIdx.x) >> 5) * 1024) + ((i_18 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((i_18 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 4096)) = *(float2*)(o_v1 + (i_18 * 2));
  }
  #pragma unroll
  for (int i_19 = 0; i_19 < 8; ++i_19) {
    AtomicAddx4((&(O[((((((((((int)blockIdx.z) >> 5) * 4194304) + (i_19 * 32768)) + ((((int)threadIdx.x) >> 4) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 15) * 4)) + 3670016)])), *(float4*)(((float*)o_shared) + ((i_19 * 512) + (((int)threadIdx.x) * 4))));
  }
  __syncthreads();
  #pragma unroll
