    ...
    if (((int)threadIdx.x) < 256) {
      ...
      for (int ic_2 = 0; ic_2 < 16; ++ic_2) {
        ...
        for (int i_6 = 0; i_6 < 4; ++i_6) {
          AtomicAddx4((&(O[(((((((((((int)blockIdx.z) >> 5) * 4194304) + (ic_2 * 262144)) + (i_6 * 65536)) + ((((int)threadIdx.x) >> 4) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 15) * 4)) - 65536)])), *(float4*)(((float*)o_shared) + (((((ic_2 & 1) * 4096) + (i_6 * 1024)) + (((int)threadIdx.x) * 4)) - 1024)));
        }
