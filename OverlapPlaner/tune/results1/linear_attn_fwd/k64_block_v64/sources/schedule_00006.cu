  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ic_1 = 0; ic_1 < 16; ++ic_1) {
      ...
      for (int i_6 = 0; i_6 < 8; ++i_6) {
        AtomicAddx4((&(O[(((((((((((int)blockIdx.z) >> 5) * 4194304) + (ic_1 * 262144)) + (i_6 * 32768)) + ((((int)threadIdx.x) >> 4) * 4096)) + ((((int)blockIdx.z) & 31) * 128)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 15) * 4)) - 32768)])), *(float4*)(((float*)o_shared) + (((((ic_1 & 1) * 4096) + (i_6 * 512)) + (((int)threadIdx.x) * 4)) - 512)));
      }
