  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ic = 0; ic < 15; ++ic) {
      ...
      for (int i_4 = 0; i_4 < 4; ++i_4) {
        ...
        *(uint4*)(((half_t*)q) + ((((((((ic + 1) % 3) * 4096) + (i_4 * 1024)) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(q_local_cast_3 + 0);
      }
      tl::fence_proxy_async();
      ...
      overlap_plan_mbar[3].wait(((ic + 1) & 1));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_a_2, (((ic + 1) % 3) * 8192));
      ...
      overlap_plan_mbar[(((ic + 1) & 1) + 4)].wait((((ic + 1) & 3) >> 1));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_3, (((ic + 1) & 1) * 8192));
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(h + 0), 32);
        tl::warpgroup_arrive();
        #pragma unroll
