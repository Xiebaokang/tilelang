  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int k_1 = 0; k_1 < 32; ++k_1) {
      ...
      for (int i_11 = 0; i_11 < 4; ++i_11) {
        ...
        *(float4*)(dsT + (i_11 * 4)) = make_float4(broadcast_var_5, broadcast_var_5, broadcast_var_5, broadcast_var_5);
      }
      if (k_1 == 0) {
      ...
      for (int i_12 = 0; i_12 < 8; ++i_12) {
        *(float2*)(((float*)dsT_wsp_handoff_6) + (((((((((int)threadIdx.x) >> 5) * 512) + ((i_12 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_12 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096)) = *(float2*)(dsT + (i_12 * 2));
      }
      tl::fence_proxy_async();
