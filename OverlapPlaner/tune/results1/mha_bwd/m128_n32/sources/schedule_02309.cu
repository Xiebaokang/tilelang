...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(const float* __restrict__ Delta, __grid_constant__ const CUtensorMap K_desc, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc, __grid_constant__ const CUtensorMap dK_desc, __grid_constant__ const CUtensorMap dO_desc, float* __restrict__ dQ, __grid_constant__ const CUtensorMap dV_desc, const float* __restrict__ lse) {
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int k = 0; k < 32; ++k) {
      ...
      overlap_plan_mbar[((k % 3) + 2)].wait(((k % 6) / 3));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b, ((k % 3) * 4096));
      ...
      for (int i_3 = 0; i_3 < 8; ++i_3) {
        ...
        float2 __2;
          float2 __3;
            ...
            __3.x = (v_.x*v__1.x);
            __3.y = (v_.y*v__1.y);
          float2 v__2 = *(float2*)(((float*)lse_shared) + ((((k & 1) * 32) + ((i_3 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
          __2.x = (__3.x-v__2.x);
          __2.y = (__3.y-v__2.y);
        __1.x = exp2f(__2.x);
        __1.y = exp2f(__2.y);
      ...
      overlap_plan_mbar[((k & 1) + 17)].arrive();
      #pragma unroll
      ...
      overlap_plan_mbar[((k & 1) + 19)].arrive();
      ...
      overlap_plan_mbar[((k & 1) + 21)].arrive();
      {
        tl::GmmaDescriptor desc_b_3;
        tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_3, (&(((half_t*)q)[0])));
        tl::increase_descriptor_offset<int>(desc_b_3, ((k % 3) * 4096));
      ...
      overlap_plan_mbar[((k % 3) + 14)].arrive();
