...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(const float* __restrict__ Delta, __grid_constant__ const CUtensorMap K_desc, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc, __grid_constant__ const CUtensorMap dK_desc, __grid_constant__ const CUtensorMap dO_desc, float* __restrict__ dQ, __grid_constant__ const CUtensorMap dV_desc, const float* __restrict__ lse) {
  ...
  void* do_1 = ((void*)((char*)buf_dyn_shmem + 40960));
  void* q = ((void*)((char*)buf_dyn_shmem + 45056));
  void* delta = ((void*)((char*)buf_dyn_shmem + 49152));
  void* lse_shared = ((void*)((char*)buf_dyn_shmem + 50176));
  ...
  if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
    ...
    tl::tma_load((&(((float*)lse_shared)[0])), (&(lse[(((int)blockIdx.x) * 1024)])), overlap_plan_mbar[3], 128);
    ...
    tl::tma_load((&(((float*)delta)[0])), (&(Delta[(((int)blockIdx.x) * 1024)])), overlap_plan_mbar[5], 128);
  }
  #pragma unroll
  ...
  if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
    ...
    tl::tma_load(Q_desc, overlap_plan_mbar[2], (&(((half_t*)q)[0])), 0, 32, ((int)blockIdx.x), 0);
  }
  ...
  if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
    overlap_plan_mbar[3].arrive_and_expect_tx(128);
    tl::fence_proxy_async();
    tl::tma_load((&(((float*)lse_shared)[0])), (&(lse[((((int)blockIdx.x) * 1024) + 32)])), overlap_plan_mbar[3], 128);
  }
  overlap_plan_mbar[8].wait(0);
  if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
    overlap_plan_mbar[4].arrive_and_expect_tx(4096);
    tl::fence_proxy_async();
    tl::tma_load(dO_desc, overlap_plan_mbar[4], (&(((half_t*)do_1)[0])), 0, 32, ((int)blockIdx.x), 0);
  }
  overlap_plan_mbar[9].wait(0);
  if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
    overlap_plan_mbar[5].arrive_and_expect_tx(128);
    tl::fence_proxy_async();
    tl::tma_load((&(((float*)delta)[0])), (&(Delta[((((int)blockIdx.x) * 1024) + 32)])), overlap_plan_mbar[5], 128);
  }
  #pragma unroll
  ...
  for (int i_9 = 0; i_9 < 8; ++i_9) {
    float broadcast_var_7 = 0x1.7154764ee6c2fp-3f/*1.803369e-01*/;
    float2 __9;
    float2 __10;
      float2 __11;
        float2 v__8 = *(float2*)(qkT + (i_9 * 2));
        float2 v__9 = make_float2(broadcast_var_7, broadcast_var_7);
        __11.x = (v__8.x*v__9.x);
        __11.y = (v__8.y*v__9.y);
      float2 v__10 = *(float2*)(((float*)lse_shared) + (((i_9 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)));
      __10.x = (__11.x-v__10.x);
      __10.y = (__11.y-v__10.y);
    __9.x = exp2f(__10.x);
    __9.y = exp2f(__10.y);
    *(float2*)(qkT + (i_9 * 2)) = __9;
  }
  overlap_plan_mbar[7].arrive();
  #pragma unroll
  for (int i_10 = 0; i_10 < 4; ++i_10) {
    uint2 __12;
    float4 v__11 = *(float4*)(qkT + (i_10 * 4));
    ((half2*)(&__12))[0] = __float22half2_rn(((float2*)(&v__11))[0]);
    ((half2*)(&__12))[1] = __float22half2_rn(((float2*)(&v__11))[1]);
    *(uint2*)(qkT_cast + (i_10 * 4)) = __12;
  }
  overlap_plan_mbar[4].wait(1);
  {
    ...
    for (int ki_5 = 0; ki_5 < 2; ++ki_5) {
      tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(qkT_cast + (ki_5 * 8)), uint64_t(desc_b_5 + ((ki_5 * 2048) >> 4)), reinterpret_cast<uint32_t*>(dv + 0), 1);
    }
    tl::warpgroup_commit_batch();
    tl::warpgroup_wait<0>();
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(dv + 0), 64);
  ...
  }
  {
    ...
    tl::initialize_wgmma_descriptor<1, 1, 64>(desc_b_6, (&(((half_t*)do_1)[0])));
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(dsT + 0), 32);
    tl::warpgroup_arrive();
    #pragma unroll
    for (int ki_6 = 0; ki_6 < 4; ++ki_6) {
      tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_3 + ((((((int)threadIdx.x) >> 7) * 8192) + (ki_6 * 32)) >> 4)), uint64_t(desc_b_6 + ((ki_6 * 32) >> 4)), ((uint32_t*)(dsT + 0)), 1);
    }
    tl::warpgroup_commit_batch();
    tl::warpgroup_wait<0>();
    tl::warpgroup_fence_operand(reinterpret_cast<float*>(dsT + 0), 32);
  ...
  for (int i_12 = 0; i_12 < 8; ++i_12) {
    ...
    *(float2*)(delta_local_cast_1 + 0) = *(float2*)(((float*)delta) + (((i_12 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)));
  ...
  for (int i_13 = 0; i_13 < 2; ++i_13) {
    ...
    *(float4*)(dq_v0 + (i_13 * 4)) = make_float4(broadcast_var_10, broadcast_var_10, broadcast_var_10, broadcast_var_10);
  }
  {
    half_t A_local[8];
    half_t B_local[8];
  ...
  for (int k = 0; k < 15; ++k) {
    ...
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[3].arrive_and_expect_tx(128);
      tl::fence_proxy_async();
      tl::tma_load((&(((float*)lse_shared)[0])), (&(lse[(((((int)blockIdx.x) * 1024) + (k * 64)) + 64)])), overlap_plan_mbar[3], 128);
    }
    ...
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[5].arrive_and_expect_tx(128);
      tl::fence_proxy_async();
      tl::tma_load((&(((float*)delta)[0])), (&(Delta[(((((int)blockIdx.x) * 1024) + (k * 64)) + 64)])), overlap_plan_mbar[5], 128);
    }
    #pragma unroll
    for (int i_15 = 0; i_15 < 4; ++i_15) {
      float broadcast_var_11 = 0x0p+0f/*0.000000e+00*/;
      *(float4*)(qkT + (i_15 * 4)) = make_float4(broadcast_var_11, broadcast_var_11, broadcast_var_11, broadcast_var_11);
    }
    overlap_plan_mbar[2].wait(0);
    {
      ...
      tl::initialize_wgmma_descriptor<1, 1, 64>(desc_b_8, (&(((half_t*)q)[0])));
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(qkT + 0), 32);
      tl::warpgroup_arrive();
      tl::fence_proxy_async();
      #pragma unroll
      for (int ki_9 = 0; ki_9 < 4; ++ki_9) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_4 + ((((((int)threadIdx.x) >> 7) * 8192) + (ki_9 * 32)) >> 4)), uint64_t(desc_b_8 + ((ki_9 * 32) >> 4)), ((uint32_t*)(qkT + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(qkT + 0), 32);
    ...
    for (int i_16 = 0; i_16 < 8; ++i_16) {
      float broadcast_var_12 = 0x1.7154764ee6c2fp-3f/*1.803369e-01*/;
      float2 __17;
      float2 __18;
        float2 __19;
          float2 v__16 = *(float2*)(qkT + (i_16 * 2));
          float2 v__17 = make_float2(broadcast_var_12, broadcast_var_12);
          __19.x = (v__16.x*v__17.x);
          __19.y = (v__16.y*v__17.y);
        float2 v__18 = *(float2*)(((float*)lse_shared) + (((i_16 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)));
        __18.x = (__19.x-v__18.x);
        __18.y = (__19.y-v__18.y);
      __17.x = exp2f(__18.x);
      __17.y = exp2f(__18.y);
      *(float2*)(qkT + (i_16 * 2)) = __17;
    }
    overlap_plan_mbar[7].arrive();
    #pragma unroll
    for (int i_17 = 0; i_17 < 4; ++i_17) {
      uint2 __20;
      float4 v__19 = *(float4*)(qkT + (i_17 * 4));
      ((half2*)(&__20))[0] = __float22half2_rn(((float2*)(&v__19))[0]);
      ((half2*)(&__20))[1] = __float22half2_rn(((float2*)(&v__19))[1]);
      *(uint2*)(qkT_cast + (i_17 * 4)) = __20;
    }
    overlap_plan_mbar[4].wait(0);
    {
      ...
      for (int ki_10 = 0; ki_10 < 2; ++ki_10) {
        tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(qkT_cast + (ki_10 * 8)), uint64_t(desc_b_9 + ((ki_10 * 2048) >> 4)), reinterpret_cast<uint32_t*>(dv + 0), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dv + 0), 64);
    ...
    }
    {
      ...
      tl::initialize_wgmma_descriptor<1, 1, 64>(desc_b_10, (&(((half_t*)do_1)[0])));
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dsT + 0), 32);
      tl::warpgroup_arrive();
      #pragma unroll
      for (int ki_11 = 0; ki_11 < 4; ++ki_11) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_5 + ((((((int)threadIdx.x) >> 7) * 8192) + (ki_11 * 32)) >> 4)), uint64_t(desc_b_10 + ((ki_11 * 32) >> 4)), ((uint32_t*)(dsT + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dsT + 0), 32);
    ...
    for (int i_19 = 0; i_19 < 8; ++i_19) {
      ...
      *(float2*)(delta_local_cast_2 + 0) = *(float2*)(((float*)delta) + (((i_19 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)));
      float broadcast_var_14 = 0x1p-3f/*1.250000e-01*/;
      uint1 __21;
      float2 __22;
        float2 __23;
          float2 v__20 = *(float2*)(qkT + (i_19 * 2));
          float2 __24;
            float2 v__21 = *(float2*)(dsT + (i_19 * 2));
        ...
        float2 v__23 = make_float2(broadcast_var_14, broadcast_var_14);
        __22.x = (__23.x*v__23.x);
        __22.y = (__23.y*v__23.y);
      ((half2*)(&__21))[0] = __float22half2_rn(((float2*)(&__22))[0]);
      *(uint1*)(dsT_cast + (i_19 * 2)) = __21;
    }
    overlap_plan_mbar[9].arrive();
    {
      tl::GmmaDescriptor desc_b_11;
      tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_11, (&(((half_t*)q)[0])));
      tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(dsT_cast + 0), 8);
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dk + 0), 64);
      tl::warpgroup_arrive();
      #pragma unroll
      for (int ki_12 = 0; ki_12 < 2; ++ki_12) {
        tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(dsT_cast + (ki_12 * 8)), uint64_t(desc_b_11 + ((ki_12 * 2048) >> 4)), reinterpret_cast<uint32_t*>(dk + 0), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dk + 0), 64);
    ...
    for (int i_20 = 0; i_20 < 2; ++i_20) {
      ...
      *(float4*)(dq_v1 + (i_20 * 4)) = make_float4(broadcast_var_15, broadcast_var_15, broadcast_var_15, broadcast_var_15);
    }
    {
      half_t A_local_1[8];
      half_t B_local_1[8];
      for (int ki_13 = 0; ki_13 < 8; ++ki_13) {
        tl::ptx_ldmatrix_x4_trans((&(((half_t*)dsT_shared)[(((((ki_13 * 512) + (((((int)threadIdx.x) & 31) >> 4) * 256)) + ((((int)threadIdx.x) & 7) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), (&(A_local_1[0])));
        tl::ptx_ldmatrix_x4_trans((&(((half_t*)K_shared)[(((ki_13 * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_1[0])));
    ...
    for (int i_22 = 0; i_22 < 8; ++i_22) {
      AtomicAdd((&(dQ[((((((((k * 65536) + (((((int)threadIdx.x) & 63) >> 5) * 16384)) + (((i_22 & 3) >> 1) * 8192)) + (((int)blockIdx.x) * 512)) + ((((int)threadIdx.x) >> 6) * 128)) + ((i_22 >> 2) * 64)) + ((i_22 & 1) * 32)) + (((int)threadIdx.x) & 31))])), dq_v0[i_22]);
    }
    overlap_plan_mbar[6].wait(0);
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[2].arrive_and_expect_tx(4096);
      tl::fence_proxy_async();
      tl::tma_load(Q_desc, overlap_plan_mbar[2], (&(((half_t*)q)[0])), 0, ((k * 64) + 96), ((int)blockIdx.x), 0);
    }
    overlap_plan_mbar[7].wait(0);
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[3].arrive_and_expect_tx(128);
      tl::fence_proxy_async();
      tl::tma_load((&(((float*)lse_shared)[0])), (&(lse[(((((int)blockIdx.x) * 1024) + (k * 64)) + 96)])), overlap_plan_mbar[3], 128);
    }
    overlap_plan_mbar[8].wait(0);
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[4].arrive_and_expect_tx(4096);
      tl::fence_proxy_async();
      tl::tma_load(dO_desc, overlap_plan_mbar[4], (&(((half_t*)do_1)[0])), 0, ((k * 64) + 96), ((int)blockIdx.x), 0);
    }
    overlap_plan_mbar[9].wait(0);
    if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[5].arrive_and_expect_tx(128);
      tl::fence_proxy_async();
      tl::tma_load((&(((float*)delta)[0])), (&(Delta[(((((int)blockIdx.x) * 1024) + (k * 64)) + 96)])), overlap_plan_mbar[5], 128);
    }
    #pragma unroll
    for (int i_23 = 0; i_23 < 4; ++i_23) {
      float broadcast_var_16 = 0x0p+0f/*0.000000e+00*/;
      *(float4*)(qkT + (i_23 * 4)) = make_float4(broadcast_var_16, broadcast_var_16, broadcast_var_16, broadcast_var_16);
    }
    overlap_plan_mbar[2].wait(1);
    {
      ...
      tl::initialize_wgmma_descriptor<1, 1, 64>(desc_b_12, (&(((half_t*)q)[0])));
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(qkT + 0), 32);
      tl::warpgroup_arrive();
      tl::fence_proxy_async();
      #pragma unroll
      for (int ki_14 = 0; ki_14 < 4; ++ki_14) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_6 + ((((((int)threadIdx.x) >> 7) * 8192) + (ki_14 * 32)) >> 4)), uint64_t(desc_b_12 + ((ki_14 * 32) >> 4)), ((uint32_t*)(qkT + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(qkT + 0), 32);
    ...
    for (int i_24 = 0; i_24 < 8; ++i_24) {
      float broadcast_var_17 = 0x1.7154764ee6c2fp-3f/*1.803369e-01*/;
      float2 __25;
      float2 __26;
        float2 __27;
          float2 v__24 = *(float2*)(qkT + (i_24 * 2));
          float2 v__25 = make_float2(broadcast_var_17, broadcast_var_17);
          __27.x = (v__24.x*v__25.x);
          __27.y = (v__24.y*v__25.y);
        float2 v__26 = *(float2*)(((float*)lse_shared) + (((i_24 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)));
        __26.x = (__27.x-v__26.x);
        __26.y = (__27.y-v__26.y);
      __25.x = exp2f(__26.x);
      __25.y = exp2f(__26.y);
      *(float2*)(qkT + (i_24 * 2)) = __25;
    }
    overlap_plan_mbar[7].arrive();
    #pragma unroll
    for (int i_25 = 0; i_25 < 4; ++i_25) {
      uint2 __28;
      float4 v__27 = *(float4*)(qkT + (i_25 * 4));
      ((half2*)(&__28))[0] = __float22half2_rn(((float2*)(&v__27))[0]);
      ((half2*)(&__28))[1] = __float22half2_rn(((float2*)(&v__27))[1]);
      *(uint2*)(qkT_cast + (i_25 * 4)) = __28;
    }
    overlap_plan_mbar[4].wait(1);
    {
      ...
      for (int ki_15 = 0; ki_15 < 2; ++ki_15) {
        tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(qkT_cast + (ki_15 * 8)), uint64_t(desc_b_13 + ((ki_15 * 2048) >> 4)), reinterpret_cast<uint32_t*>(dv + 0), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dv + 0), 64);
    ...
    }
    {
      ...
      tl::initialize_wgmma_descriptor<1, 1, 64>(desc_b_14, (&(((half_t*)do_1)[0])));
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dsT + 0), 32);
      tl::warpgroup_arrive();
      #pragma unroll
      for (int ki_16 = 0; ki_16 < 4; ++ki_16) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_7 + ((((((int)threadIdx.x) >> 7) * 8192) + (ki_16 * 32)) >> 4)), uint64_t(desc_b_14 + ((ki_16 * 32) >> 4)), ((uint32_t*)(dsT + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dsT + 0), 32);
    ...
    for (int i_27 = 0; i_27 < 8; ++i_27) {
      ...
      *(float2*)(delta_local_cast_3 + 0) = *(float2*)(((float*)delta) + (((i_27 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)));
      float broadcast_var_19 = 0x1p-3f/*1.250000e-01*/;
      uint1 __29;
      float2 __30;
        float2 __31;
          float2 v__28 = *(float2*)(qkT + (i_27 * 2));
          float2 __32;
            float2 v__29 = *(float2*)(dsT + (i_27 * 2));
    ...
    overlap_plan_mbar[9].arrive();
    {
      ...
      for (int ki_17 = 0; ki_17 < 2; ++ki_17) {
        tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(dsT_cast + (ki_17 * 8)), uint64_t(desc_b_15 + ((ki_17 * 2048) >> 4)), reinterpret_cast<uint32_t*>(dk + 0), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dk + 0), 64);
    ...
    for (int i_28 = 0; i_28 < 2; ++i_28) {
      ...
      *(float4*)(dq_v0 + (i_28 * 4)) = make_float4(broadcast_var_20, broadcast_var_20, broadcast_var_20, broadcast_var_20);
    }
    {
      half_t A_local_2[8];
      half_t B_local_2[8];
      for (int ki_18 = 0; ki_18 < 8; ++ki_18) {
        tl::ptx_ldmatrix_x4_trans((&(((half_t*)dsT_shared)[(((((ki_18 * 512) + (((((int)threadIdx.x) & 31) >> 4) * 256)) + ((((int)threadIdx.x) & 7) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), (&(A_local_2[0])));
        tl::ptx_ldmatrix_x4_trans((&(((half_t*)K_shared)[(((ki_18 * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_2[0])));
    ...
    for (int i_30 = 0; i_30 < 8; ++i_30) {
      AtomicAdd((&(dQ[(((((((((k * 65536) + (((((int)threadIdx.x) & 63) >> 5) * 16384)) + (((i_30 & 3) >> 1) * 8192)) + (((int)blockIdx.x) * 512)) + ((((int)threadIdx.x) >> 6) * 128)) + ((i_30 >> 2) * 64)) + ((i_30 & 1) * 32)) + (((int)threadIdx.x) & 31)) + 32768)])), dq_v1[i_30]);
    }
  }
  #pragma unroll
  ...
  }
  {
    ...
    half_t B_local_3[8];
    __syncthreads();
    for (int ki_19 = 0; ki_19 < 8; ++ki_19) {
      tl::ptx_ldmatrix_x4_trans((&(((half_t*)dsT_shared)[(((((ki_19 * 512) + (((((int)threadIdx.x) & 31) >> 4) * 256)) + ((((int)threadIdx.x) & 7) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), (&(A_local_3[0])));
      tl::ptx_ldmatrix_x4_trans((&(((half_t*)K_shared)[(((ki_19 * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local_3[0])));
