...
extern "C" __global__ void __launch_bounds__(512, 1) main_kernel(const float* __restrict__ Delta, __grid_constant__ const CUtensorMap K_desc, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc, __grid_constant__ const CUtensorMap dK_desc, __grid_constant__ const CUtensorMap dO_desc, float* __restrict__ dQ, __grid_constant__ const CUtensorMap dV_desc, const float* __restrict__ lse) {
  ...
  void* dsT_cast_wsp_handoff_7 = ((void*)((char*)buf_dyn_shmem + 32768));
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int k = 0; k < 32; ++k) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((k & 1) + 2)].arrive_and_expect_tx(4096);
        tl::fence_proxy_async();
        tl::tma_load(Q_desc, overlap_plan_mbar[((k & 1) + 2)], (&(((half_t*)q)[((k & 1) * 2048)])), 0, (k * 32), ((int)blockIdx.x), 0);
      }
      if (1 <= k) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::fence_proxy_async();
        tl::tma_load((&(((float*)lse_shared)[0])), (&(lse[((((int)blockIdx.x) * 1024) + (k * 32))])), overlap_plan_mbar[4], 128);
      }
      if (1 <= k) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::fence_proxy_async();
        tl::tma_load(dO_desc, overlap_plan_mbar[5], (&(((half_t*)do_1)[0])), 0, (k * 32), ((int)blockIdx.x), 0);
      }
      if (1 <= k) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::fence_proxy_async();
        tl::tma_load((&(((float*)delta)[0])), (&(Delta[((((int)blockIdx.x) * 1024) + (k * 32))])), overlap_plan_mbar[6], 128);
      }
      #pragma unroll
      for (int i_1 = 0; i_1 < 4; ++i_1) {
        float broadcast_var_1 = 0x0p+0f/*0.000000e+00*/;
        *(float4*)(qkT + (i_1 * 4)) = make_float4(broadcast_var_1, broadcast_var_1, broadcast_var_1, broadcast_var_1);
      }
      if (k == 0) {
      ...
      for (int i_2 = 0; i_2 < 8; ++i_2) {
        ...
        float2 __2;
          float2 __3;
            ...
            float2 v__1 = make_float2(broadcast_var_2, broadcast_var_2);
            __3.x = (v_.x*v__1.x);
            __3.y = (v_.y*v__1.y);
          float2 v__2 = *(float2*)(((float*)lse_shared) + (((i_2 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)));
          __2.x = (__3.x-v__2.x);
          __2.y = (__3.y-v__2.y);
        __1.x = exp2f(__2.x);
        __1.y = exp2f(__2.y);
        *(float2*)(qkT + (i_2 * 2)) = __1;
      }
      overlap_plan_mbar[15].arrive();
      #pragma unroll
      for (int i_3 = 0; i_3 < 4; ++i_3) {
        uint2 __4;
        float4 v__3 = *(float4*)(qkT + (i_3 * 4));
        ((half2*)(&__4))[0] = __float22half2_rn(((float2*)(&v__3))[0]);
        ((half2*)(&__4))[1] = __float22half2_rn(((float2*)(&v__3))[1]);
        *(uint2*)(qkT_cast + (i_3 * 4)) = __4;
      }
      ...
      for (int i_4 = 0; i_4 < 4; ++i_4) {
        ...
        *(float4*)(dsT + (i_4 * 4)) = make_float4(broadcast_var_3, broadcast_var_3, broadcast_var_3, broadcast_var_3);
      }
      if (k == 0) {
      ...
      for (int i_5 = 0; i_5 < 8; ++i_5) {
        ...
        *(float2*)(delta_local_cast + 0) = *(float2*)(((float*)delta) + (((i_5 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)));
        float broadcast_var_4 = 0x1p-3f/*1.250000e-01*/;
        uint1 __5;
        float2 __6;
          float2 __7;
            float2 v__4 = *(float2*)(qkT + (i_5 * 2));
            float2 __8;
              float2 v__5 = *(float2*)(dsT + (i_5 * 2));
              float2 v__6 = *(float2*)(delta_local_cast + 0);
              __8.x = (v__5.x-v__6.x);
              __8.y = (v__5.y-v__6.y);
            __7.x = (v__4.x*__8.x);
            __7.y = (v__4.y*__8.y);
          float2 v__7 = make_float2(broadcast_var_4, broadcast_var_4);
          __6.x = (__7.x*v__7.x);
          __6.y = (__7.y*v__7.y);
        ((half2*)(&__5))[0] = __float22half2_rn(((float2*)(&__6))[0]);
        *(uint1*)(dsT_cast + (i_5 * 2)) = __5;
      }
      #pragma unroll
      for (int i_6 = 0; i_6 < 2; ++i_6) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)dsT_cast_wsp_handoff_7)[(((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (i_6 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(dsT_cast[(i_6 * 8)], dsT_cast[((i_6 * 8) + 1)]), __pack_half2(dsT_cast[((i_6 * 8) + 2)], dsT_cast[((i_6 * 8) + 3)]), __pack_half2(dsT_cast[((i_6 * 8) + 4)], dsT_cast[((i_6 * 8) + 5)]), __pack_half2(dsT_cast[((i_6 * 8) + 6)], dsT_cast[((i_6 * 8) + 7)]));
      }
      tl::fence_proxy_async();
      ...
      for (int i_8 = 0; i_8 < 2; ++i_8) {
        ...
        *(float4*)(dq + (i_8 * 4)) = make_float4(broadcast_var_5, broadcast_var_5, broadcast_var_5, broadcast_var_5);
      }
      {
        half_t A_local[8];
        half_t B_local[8];
    ...
    for (int i_11 = 0; i_11 < 8; ++i_11) {
      ...
      *(float4*)(dk + (i_11 * 4)) = make_float4(broadcast_var_6, broadcast_var_6, broadcast_var_6, broadcast_var_6);
    }
    for (int k_1 = 0; k_1 < 32; ++k_1) {
      ...
      for (int i_12 = 0; i_12 < 2; ++i_12) {
        tl::ptx_ldmatrix_x4((&(((half_t*)dsT_cast_wsp_handoff_7)[((((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (i_12 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 4096)])), (&(dsT_cast[(i_12 * 8)])));
      }
      {
        ...
        for (int ki_4 = 0; ki_4 < 2; ++ki_4) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(dsT_cast + (ki_4 * 8)), uint64_t(desc_b_3 + ((ki_4 * 2048) >> 4)), reinterpret_cast<uint32_t*>(dk + 0), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(dk + 0), 64);
    ...
    for (int i_13 = 0; i_13 < 4; ++i_13) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)gradient_shared)[(((((((int)threadIdx.x) & 255) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_13 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_13 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)dk[(i_13 * 8)]), ((half_t)dk[((i_13 * 8) + 1)])), __pack_half2(((half_t)dk[((i_13 * 8) + 2)]), ((half_t)dk[((i_13 * 8) + 3)])), __pack_half2(((half_t)dk[((i_13 * 8) + 4)]), ((half_t)dk[((i_13 * 8) + 5)])), __pack_half2(((half_t)dk[((i_13 * 8) + 6)]), ((half_t)dk[((i_13 * 8) + 7)])));
    }
    tl::fence_proxy_async();
