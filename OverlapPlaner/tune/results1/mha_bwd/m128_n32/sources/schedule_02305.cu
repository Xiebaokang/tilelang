  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int k = 0; k < 15; ++k) {
      ...
      for (int i_14 = 0; i_14 < 8; ++i_14) {
        ...
        *(float2*)(delta_local_cast_1 + 0) = *(float2*)(((float*)delta) + ((((i_14 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)) + 32));
    ...
    for (int i_30 = 0; i_30 < 8; ++i_30) {
      ...
      *(float2*)(delta_local_cast_3 + 0) = *(float2*)(((float*)delta) + ((((i_30 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)) + 32));
