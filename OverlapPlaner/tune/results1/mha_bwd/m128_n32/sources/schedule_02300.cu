...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(const float* __restrict__ Delta, __grid_constant__ const CUtensorMap K_desc, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc, __grid_constant__ const CUtensorMap dK_desc, __grid_constant__ const CUtensorMap dO_desc, float* __restrict__ dQ, __grid_constant__ const CUtensorMap dV_desc, const float* __restrict__ lse) {
  ...
  float qkT[16];
  float dsT[16];
  half_t qkT_cast_v0[16];
  half_t dsT_cast_v0[16];
  float dq_v0[8];
  half_t qkT_cast_v1[16];
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    }
    {
      ...
      for (int ki_2 = 0; ki_2 < 8; ++ki_2) {
        tl::ptx_ldmatrix_x4_trans((&(((half_t*)dsT_shared)[(((((ki_2 * 512) + (((((int)threadIdx.x) & 31) >> 4) * 256)) + ((((int)threadIdx.x) & 7) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), (&(A_local[0])));
        tl::ptx_ldmatrix_x4_trans((&(((half_t*)K_shared)[(((ki_2 * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(B_local[0])));
    ...
    for (int k = 0; k < 15; ++k) {
      ...
      overlap_plan_mbar[3].wait((k & 1));
      {
        ...
        tl::initialize_wgmma_descriptor<1, 1, 64>(desc_b_2, (&(((half_t*)q)[0])));
        tl::increase_descriptor_offset<int>(desc_b_2, 4096);
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(qkT + 0), 32);
        tl::warpgroup_arrive();
        tl::fence_proxy_async();
        #pragma unroll
        for (int ki_3 = 0; ki_3 < 4; ++ki_3) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_2 + ((((((int)threadIdx.x) >> 7) * 8192) + (ki_3 * 32)) >> 4)), uint64_t(desc_b_2 + ((ki_3 * 32) >> 4)), ((uint32_t*)(qkT + 0)), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(qkT + 0), 32);
      ...
      for (int i_10 = 0; i_10 < 8; ++i_10) {
        ...
        float2 __10;
          ...
          float2 v__10 = *(float2*)(((float*)lse_shared) + ((((i_10 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)) + 32));
      ...
      overlap_plan_mbar[7].wait((k & 1));
      {
        ...
        tl::initialize_wgmma_descriptor<1, 1, 64>(desc_b_3, (&(((half_t*)do_1)[0])));
        tl::increase_descriptor_offset<int>(desc_b_3, 4096);
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(dsT + 0), 32);
        tl::warpgroup_arrive();
        #pragma unroll
        for (int ki_4 = 0; ki_4 < 4; ++ki_4) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_3 + ((((((int)threadIdx.x) >> 7) * 8192) + (ki_4 * 32)) >> 4)), uint64_t(desc_b_3 + ((ki_4 * 32) >> 4)), ((uint32_t*)(dsT + 0)), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(dsT + 0), 32);
      ...
      for (int i_12 = 0; i_12 < 4; ++i_12) {
        ...
        *(uint2*)(qkT_cast_v1 + (i_12 * 4)) = __12;
      }
      overlap_plan_mbar[6].wait((k & 1));
      {
        tl::GmmaDescriptor desc_b_4;
        tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_4, (&(((half_t*)do_1)[0])));
        tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(qkT_cast_v0 + 0), 8);
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(dv + 0), 64);
        tl::warpgroup_arrive();
        #pragma unroll
        for (int ki_5 = 0; ki_5 < 2; ++ki_5) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(qkT_cast_v0 + (ki_5 * 8)), uint64_t(desc_b_4 + ((ki_5 * 2048) >> 4)), reinterpret_cast<uint32_t*>(dv + 0), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(dv + 0), 64);
      ...
      for (int i_13 = 0; i_13 < 8; ++i_13) {
        ...
        *(float2*)(delta_local_cast_1 + 0) = *(float2*)(((float*)delta) + ((((i_13 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)) + 32));
      ...
      overlap_plan_mbar[2].wait((k & 1));
      {
        ...
        for (int ki_6 = 0; ki_6 < 2; ++ki_6) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(dsT_cast_v0 + (ki_6 * 8)), uint64_t(desc_b_5 + ((ki_6 * 2048) >> 4)), reinterpret_cast<uint32_t*>(dk + 0), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(dk + 0), 64);
      ...
      overlap_plan_mbar[2].wait(((k + 1) & 1));
      {
        ...
        tl::initialize_wgmma_descriptor<1, 1, 64>(desc_b_6, (&(((half_t*)q)[0])));
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(qkT + 0), 32);
        tl::warpgroup_arrive();
        tl::fence_proxy_async();
        #pragma unroll
        for (int ki_8 = 0; ki_8 < 4; ++ki_8) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_4 + ((((((int)threadIdx.x) >> 7) * 8192) + (ki_8 * 32)) >> 4)), uint64_t(desc_b_6 + ((ki_8 * 32) >> 4)), ((uint32_t*)(qkT + 0)), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(qkT + 0), 32);
      ...
      overlap_plan_mbar[6].wait(((k + 1) & 1));
      {
        ...
        tl::initialize_wgmma_descriptor<1, 1, 64>(desc_b_7, (&(((half_t*)do_1)[0])));
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(dsT + 0), 32);
        tl::warpgroup_arrive();
        #pragma unroll
        for (int ki_9 = 0; ki_9 < 4; ++ki_9) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_5 + ((((((int)threadIdx.x) >> 7) * 8192) + (ki_9 * 32)) >> 4)), uint64_t(desc_b_7 + ((ki_9 * 32) >> 4)), ((uint32_t*)(dsT + 0)), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(dsT + 0), 32);
      ...
      for (int i_20 = 0; i_20 < 4; ++i_20) {
        ...
        *(uint2*)(qkT_cast_v0 + (i_20 * 4)) = __20;
      }
      overlap_plan_mbar[7].wait((k & 1));
      {
        tl::GmmaDescriptor desc_b_8;
        tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_8, (&(((half_t*)do_1)[0])));
        tl::increase_descriptor_offset<int>(desc_b_8, 4096);
        tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(qkT_cast_v1 + 0), 8);
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(dv + 0), 64);
        tl::warpgroup_arrive();
        #pragma unroll
        for (int ki_10 = 0; ki_10 < 2; ++ki_10) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(qkT_cast_v1 + (ki_10 * 8)), uint64_t(desc_b_8 + ((ki_10 * 2048) >> 4)), reinterpret_cast<uint32_t*>(dv + 0), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(dv + 0), 64);
      ...
      overlap_plan_mbar[3].wait((k & 1));
      {
        ...
        tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_9, (&(((half_t*)q)[0])));
        ...
        for (int ki_11 = 0; ki_11 < 2; ++ki_11) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(dsT_cast_v1 + (ki_11 * 8)), uint64_t(desc_b_9 + ((ki_11 * 2048) >> 4)), reinterpret_cast<uint32_t*>(dk + 0), 1);
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(dk + 0), 64);
    ...
    overlap_plan_mbar[3].wait(1);
    {
      ...
      tl::initialize_wgmma_descriptor<1, 1, 64>(desc_b_10, (&(((half_t*)q)[0])));
      ...
      for (int ki_13 = 0; ki_13 < 4; ++ki_13) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_6 + ((((((int)threadIdx.x) >> 7) * 8192) + (ki_13 * 32)) >> 4)), uint64_t(desc_b_10 + ((ki_13 * 32) >> 4)), ((uint32_t*)(qkT + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(qkT + 0), 32);
    ...
    for (int i_26 = 0; i_26 < 8; ++i_26) {
      ...
      float2 __26;
        ...
        float2 v__26 = *(float2*)(((float*)lse_shared) + ((((i_26 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)) + 32));
    ...
    overlap_plan_mbar[7].wait(1);
    {
      ...
      tl::initialize_wgmma_descriptor<1, 1, 64>(desc_b_11, (&(((half_t*)do_1)[0])));
      tl::increase_descriptor_offset<int>(desc_b_11, 4096);
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dsT + 0), 32);
      tl::warpgroup_arrive();
      #pragma unroll
      for (int ki_14 = 0; ki_14 < 4; ++ki_14) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_7 + ((((((int)threadIdx.x) >> 7) * 8192) + (ki_14 * 32)) >> 4)), uint64_t(desc_b_11 + ((ki_14 * 32) >> 4)), ((uint32_t*)(dsT + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dsT + 0), 32);
    ...
    overlap_plan_mbar[6].wait(1);
    {
      ...
      for (int ki_15 = 0; ki_15 < 2; ++ki_15) {
        tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(qkT_cast_v0 + (ki_15 * 8)), uint64_t(desc_b_12 + ((ki_15 * 2048) >> 4)), reinterpret_cast<uint32_t*>(dv + 0), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dv + 0), 64);
    ...
    for (int i_29 = 0; i_29 < 8; ++i_29) {
      ...
      *(float2*)(delta_local_cast_3 + 0) = *(float2*)(((float*)delta) + ((((i_29 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)) + 32));
    ...
    overlap_plan_mbar[2].wait(1);
    {
      ...
      tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_13, (&(((half_t*)q)[0])));
      tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(dsT_cast_v0 + 0), 8);
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dk + 0), 64);
      tl::warpgroup_arrive();
      #pragma unroll
      for (int ki_16 = 0; ki_16 < 2; ++ki_16) {
        tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(dsT_cast_v0 + (ki_16 * 8)), uint64_t(desc_b_13 + ((ki_16 * 2048) >> 4)), reinterpret_cast<uint32_t*>(dk + 0), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dk + 0), 64);
    ...
    overlap_plan_mbar[7].wait(1);
    {
      ...
      for (int ki_18 = 0; ki_18 < 2; ++ki_18) {
        tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(qkT_cast_v1 + (ki_18 * 8)), uint64_t(desc_b_14 + ((ki_18 * 2048) >> 4)), reinterpret_cast<uint32_t*>(dv + 0), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dv + 0), 64);
