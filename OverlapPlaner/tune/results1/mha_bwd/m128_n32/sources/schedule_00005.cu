...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(const float* __restrict__ Delta, __grid_constant__ const CUtensorMap K_desc, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc, __grid_constant__ const CUtensorMap dK_desc, __grid_constant__ const CUtensorMap dO_desc, float* __restrict__ dQ, __grid_constant__ const CUtensorMap dV_desc, const float* __restrict__ lse) {
  ...
  void* q = ((void*)((char*)buf_dyn_shmem + 53248));
  ...
  for (int i_7 = 0; i_7 < 8; ++i_7) {
    *(uint1*)(((half_t*)dsT_shared) + (((((((((int)threadIdx.x) >> 5) * 512) + ((i_7 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_7 >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_7 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(dsT_cast + (i_7 * 2));
  }
  ...
  for (int i_13 = 0; i_13 < 8; ++i_13) {
    *(uint1*)(((half_t*)dsT_shared) + ((((((((((int)threadIdx.x) >> 5) * 512) + ((i_13 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_13 >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_13 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 4096)) = *(uint1*)(dsT_cast + (i_13 * 2));
  }
  #pragma unroll
  for (int i_14 = 0; i_14 < 2; ++i_14) {
    float broadcast_var_10 = 0x0p+0f/*0.000000e+00*/;
    *(float4*)(dq_v0 + (i_14 * 4)) = make_float4(broadcast_var_10, broadcast_var_10, broadcast_var_10, broadcast_var_10);
  }
  {
    half_t A_local[8];
    half_t B_local[8];
  ...
  for (int k = 0; k < 15; ++k) {
    ...
    for (int i_17 = 0; i_17 < 4; ++i_17) {
      ...
      *(float4*)(dsT + (i_17 * 4)) = make_float4(broadcast_var_13, broadcast_var_13, broadcast_var_13, broadcast_var_13);
    }
    overlap_plan_mbar[4].wait(0);
    {
      ...
      for (int ki_10 = 0; ki_10 < 4; ++ki_10) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_5 + ((((((int)threadIdx.x) >> 7) * 8192) + (ki_10 * 32)) >> 4)), uint64_t(desc_b_9 + ((ki_10 * 32) >> 4)), ((uint32_t*)(dsT + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dsT + 0), 32);
    ...
    for (int i_18 = 0; i_18 < 4; ++i_18) {
      uint2 __20;
      float4 v__19 = *(float4*)(qkT + (i_18 * 4));
      ((half2*)(&__20))[0] = __float22half2_rn(((float2*)(&v__19))[0]);
      ((half2*)(&__20))[1] = __float22half2_rn(((float2*)(&v__19))[1]);
      *(uint2*)(qkT_cast + (i_18 * 4)) = __20;
    }
    {
      tl::GmmaDescriptor desc_b_10;
      tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_10, (&(((half_t*)do_1)[0])));
      tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(qkT_cast + 0), 8);
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dv + 0), 64);
      tl::warpgroup_arrive();
      #pragma unroll
      for (int ki_11 = 0; ki_11 < 2; ++ki_11) {
        tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(qkT_cast + (ki_11 * 8)), uint64_t(desc_b_10 + ((ki_11 * 2048) >> 4)), reinterpret_cast<uint32_t*>(dv + 0), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dv + 0), 64);
    ...
    for (int i_20 = 0; i_20 < 8; ++i_20) {
      *(uint1*)(((half_t*)dsT_shared) + (((((((((int)threadIdx.x) >> 5) * 512) + ((i_20 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_20 >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_20 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(dsT_cast + (i_20 * 2));
    }
    #pragma unroll
    for (int i_21 = 0; i_21 < 2; ++i_21) {
      float broadcast_var_15 = 0x0p+0f/*0.000000e+00*/;
      *(float4*)(dq_v1 + (i_21 * 4)) = make_float4(broadcast_var_15, broadcast_var_15, broadcast_var_15, broadcast_var_15);
    }
    {
      half_t A_local_1[8];
      half_t B_local_1[8];
      for (int ki_13 = 0; ki_13 < 8; ++ki_13) {
        tl::ptx_ldmatrix_x4_trans((&(((half_t*)dsT_shared)[((((((ki_13 * 512) + (((((int)threadIdx.x) & 31) >> 4) * 256)) + ((((int)threadIdx.x) & 7) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8)) + 4096)])), (&(A_local_1[0])));
    ...
    for (int i_25 = 0; i_25 < 4; ++i_25) {
      ...
      *(float4*)(dsT + (i_25 * 4)) = make_float4(broadcast_var_18, broadcast_var_18, broadcast_var_18, broadcast_var_18);
    }
    overlap_plan_mbar[4].wait(1);
    {
      ...
      for (int ki_15 = 0; ki_15 < 4; ++ki_15) {
        tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a_7 + ((((((int)threadIdx.x) >> 7) * 8192) + (ki_15 * 32)) >> 4)), uint64_t(desc_b_13 + ((ki_15 * 32) >> 4)), ((uint32_t*)(dsT + 0)), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dsT + 0), 32);
    ...
    for (int i_26 = 0; i_26 < 4; ++i_26) {
      uint2 __28;
      float4 v__27 = *(float4*)(qkT + (i_26 * 4));
      ((half2*)(&__28))[0] = __float22half2_rn(((float2*)(&v__27))[0]);
      ((half2*)(&__28))[1] = __float22half2_rn(((float2*)(&v__27))[1]);
      *(uint2*)(qkT_cast + (i_26 * 4)) = __28;
    }
    {
      tl::GmmaDescriptor desc_b_14;
      tl::initialize_wgmma_descriptor<1, 0, 64>(desc_b_14, (&(((half_t*)do_1)[0])));
      tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(qkT_cast + 0), 8);
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dv + 0), 64);
      tl::warpgroup_arrive();
      #pragma unroll
      for (int ki_16 = 0; ki_16 < 2; ++ki_16) {
        tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(qkT_cast + (ki_16 * 8)), uint64_t(desc_b_14 + ((ki_16 * 2048) >> 4)), reinterpret_cast<uint32_t*>(dv + 0), 1);
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(dv + 0), 64);
    ...
    for (int i_28 = 0; i_28 < 8; ++i_28) {
      *(uint1*)(((half_t*)dsT_shared) + ((((((((((int)threadIdx.x) >> 5) * 512) + ((i_28 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_28 >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_28 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 4096)) = *(uint1*)(dsT_cast + (i_28 * 2));
    }
    #pragma unroll
    for (int i_29 = 0; i_29 < 2; ++i_29) {
      float broadcast_var_20 = 0x0p+0f/*0.000000e+00*/;
      *(float4*)(dq_v0 + (i_29 * 4)) = make_float4(broadcast_var_20, broadcast_var_20, broadcast_var_20, broadcast_var_20);
    }
    {
      half_t A_local_2[8];
      half_t B_local_2[8];
  ...
  }
  {
    ...
    for (int ki_19 = 0; ki_19 < 8; ++ki_19) {
      tl::ptx_ldmatrix_x4_trans((&(((half_t*)dsT_shared)[((((((ki_19 * 512) + (((((int)threadIdx.x) & 31) >> 4) * 256)) + ((((int)threadIdx.x) & 7) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8)) + 4096)])), (&(A_local_3[0])));
