...
extern "C" __global__ void __launch_bounds__(512, 1) main_kernel(const float* __restrict__ Delta, __grid_constant__ const CUtensorMap K_desc, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc, __grid_constant__ const CUtensorMap dK_desc, __grid_constant__ const CUtensorMap dO_desc, float* __restrict__ dQ, __grid_constant__ const CUtensorMap dV_desc, const float* __restrict__ lse) {
  ...
  void* qkT_wsp_handoff_3 = ((void*)((char*)buf_dyn_shmem + 32768));
  void* qkT_wsp_handoff_5 = ((void*)((char*)buf_dyn_shmem + 49152));
  void* dsT_shared = ((void*)((char*)buf_dyn_shmem + 65536));
  void* do_1 = ((void*)((char*)buf_dyn_shmem + 73728));
  void* q = ((void*)((char*)buf_dyn_shmem + 77824));
  void* lse_shared = ((void*)((char*)buf_dyn_shmem + 81920));
  void* delta = ((void*)((char*)buf_dyn_shmem + 82944));
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int k = 0; k < 32; ++k) {
      ...
      for (int i_3 = 0; i_3 < 8; ++i_3) {
        *(float2*)(((float*)qkT_wsp_handoff_3) + ((((((((int)threadIdx.x) >> 5) * 512) + ((i_3 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_3 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(qkT + (i_3 * 2));
      }
      tl::fence_proxy_async();
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((k & 1) + 4)].arrive_and_expect_tx(128);
        tl::tma_load((&(((float*)lse_shared)[((k & 1) * 32)])), (&(lse[((((int)blockIdx.x) * 1024) + (k * 32))])), overlap_plan_mbar[((k & 1) + 4)], 128);
      }
      if (1 <= k) {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(dO_desc, overlap_plan_mbar[7], (&(((half_t*)do_1)[0])), 0, (k * 32), ((int)blockIdx.x), 0);
      }
      #pragma unroll
      ...
      for (int i_5 = 0; i_5 < 8; ++i_5) {
        *(float2*)(qkT + (i_5 * 2)) = *(float2*)(((float*)qkT_wsp_handoff_5) + ((((((((int)threadIdx.x) >> 5) * 512) + ((i_5 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_5 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      }
      #pragma unroll
      for (int i_6 = 0; i_6 < 4; ++i_6) {
        uint2 __1;
        float4 v_ = *(float4*)(qkT + (i_6 * 4));
        ((half2*)(&__1))[0] = __float22half2_rn(((float2*)(&v_))[0]);
        ((half2*)(&__1))[1] = __float22half2_rn(((float2*)(&v_))[1]);
        *(uint2*)(qkT_cast + (i_6 * 4)) = __1;
      }
      {
      ...
      if (tl::tl_shuffle_elect<256>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load((&(((float*)delta)[0])), (&(Delta[((((int)blockIdx.x) * 1024) + (k * 32))])), overlap_plan_mbar[8], 128);
      }
      ...
      for (int i_7 = 0; i_7 < 8; ++i_7) {
        ...
        *(float2*)(delta_local_cast + 0) = *(float2*)(((float*)delta) + (((i_7 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)));
        float broadcast_var_4 = 0x1p-3f/*1.250000e-01*/;
        uint1 __2;
        float2 __3;
          float2 __4;
            float2 v__1 = *(float2*)(qkT + (i_7 * 2));
            float2 __5;
              float2 v__2 = *(float2*)(dsT + (i_7 * 2));
              float2 v__3 = *(float2*)(delta_local_cast + 0);
              __5.x = (v__2.x-v__3.x);
              __5.y = (v__2.y-v__3.y);
            __4.x = (v__1.x*__5.x);
            __4.y = (v__1.y*__5.y);
          float2 v__4 = make_float2(broadcast_var_4, broadcast_var_4);
          __3.x = (__4.x*v__4.x);
          __3.y = (__4.y*v__4.y);
        ((half2*)(&__2))[0] = __float22half2_rn(((float2*)(&__3))[0]);
        *(uint1*)(dsT_cast + (i_7 * 2)) = __2;
      }
      ...
      for (int i_8 = 0; i_8 < 2; ++i_8) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)dsT_shared)[(((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + i_8) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(dsT_cast[(i_8 * 8)], dsT_cast[((i_8 * 8) + 1)]), __pack_half2(dsT_cast[((i_8 * 8) + 2)], dsT_cast[((i_8 * 8) + 3)]), __pack_half2(dsT_cast[((i_8 * 8) + 4)], dsT_cast[((i_8 * 8) + 5)]), __pack_half2(dsT_cast[((i_8 * 8) + 6)], dsT_cast[((i_8 * 8) + 7)]));
      }
      #pragma unroll
    ...
    for (int k_1 = 0; k_1 < 32; ++k_1) {
      ...
      overlap_plan_mbar[((k_1 & 1) + 4)].wait(((k_1 & 3) >> 1));
      #pragma unroll
      for (int i_13 = 0; i_13 < 8; ++i_13) {
        *(float2*)(qkT + (i_13 * 2)) = *(float2*)(((float*)qkT_wsp_handoff_3) + (((((((((int)threadIdx.x) >> 5) * 512) + ((i_13 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_13 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
      }
      #pragma unroll
      for (int i_14 = 0; i_14 < 8; ++i_14) {
        float broadcast_var_6 = 0x1.7154764ee6c2fp-3f/*1.803369e-01*/;
        float2 __6;
        float2 __7;
          float2 __8;
            float2 v__5 = *(float2*)(qkT + (i_14 * 2));
            float2 v__6 = make_float2(broadcast_var_6, broadcast_var_6);
            __8.x = (v__5.x*v__6.x);
            __8.y = (v__5.y*v__6.y);
          float2 v__7 = *(float2*)(((float*)lse_shared) + ((((k_1 & 1) * 32) + ((i_14 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
          __7.x = (__8.x-v__7.x);
          __7.y = (__8.y-v__7.y);
        __6.x = exp2f(__7.x);
        __6.y = exp2f(__7.y);
        *(float2*)(qkT + (i_14 * 2)) = __6;
      }
      #pragma unroll
      for (int i_15 = 0; i_15 < 8; ++i_15) {
        *(float2*)(((float*)qkT_wsp_handoff_5) + (((((((((int)threadIdx.x) >> 5) * 512) + ((i_15 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + ((i_15 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096)) = *(float2*)(qkT + (i_15 * 2));
      }
      tl::fence_proxy_async();
