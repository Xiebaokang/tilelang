...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(const float* __restrict__ Delta, __grid_constant__ const CUtensorMap K_desc, __grid_constant__ const CUtensorMap Q_desc, __grid_constant__ const CUtensorMap V_desc, __grid_constant__ const CUtensorMap dK_desc, __grid_constant__ const CUtensorMap dO_desc, float* __restrict__ dQ, __grid_constant__ const CUtensorMap dV_desc, const float* __restrict__ lse) {
  ...
  void* do_1 = ((void*)((char*)buf_dyn_shmem + 45056));
  void* dsT_shared = ((void*)((char*)buf_dyn_shmem + 53248));
  ...
  if (((int)threadIdx.x) < 256) {
    ...
    for (int k = 0; k < 15; ++k) {
      ...
      overlap_plan_mbar[((((k * 2) + 1) % 3) + 2)].wait(((((k % 3) * 2) + 1) / 3));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_3, ((((k * 2) + 1) % 3) * 4096));
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(qkT + 0), 32);
        tl::warpgroup_arrive();
      ...
      overlap_plan_mbar[22].arrive();
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_6, ((((k * 2) + 1) % 3) * 4096));
        tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(dsT_cast + 0), 8);
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(dk + 0), 64);
        tl::warpgroup_arrive();
        #pragma unroll
      ...
      overlap_plan_mbar[((((k * 2) + 1) % 3) + 14)].arrive();
      tl::__sync_thread_partial(3, 256);
      #pragma unroll
      ...
      overlap_plan_mbar[((((k * 2) + 2) % 3) + 2)].wait(((((k * 2) + 2) % 6) / 3));
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_7, ((((k * 2) + 2) % 3) * 4096));
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(qkT + 0), 32);
        tl::warpgroup_arrive();
        tl::fence_proxy_async();
        #pragma unroll
      ...
      overlap_plan_mbar[21].arrive();
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_10, ((((k * 2) + 2) % 3) * 4096));
        tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(dsT_cast + 0), 8);
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(dk + 0), 64);
        tl::warpgroup_arrive();
        #pragma unroll
      ...
      overlap_plan_mbar[((((k * 2) + 2) % 3) + 14)].arrive();
      tl::__sync_thread_partial(3, 256);
      #pragma unroll
    ...
    for (int k_1 = 0; k_1 < 32; ++k_1) {
      if (3 <= k_1) {
        overlap_plan_mbar[((k_1 % 3) + 14)].wait((((k_1 / 3) + 1) & 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 8)) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 8)) {
        overlap_plan_mbar[((k_1 & 1) + 5)].arrive_and_expect_tx(128);
        tl::tma_load((&(((float*)lse_shared)[((k_1 & 1) * 32)])), (&(lse[((((int)blockIdx.x) * 1024) + (k_1 * 32))])), overlap_plan_mbar[((k_1 & 1) + 5)], 128);
      }
      if (2 <= k_1) {
        overlap_plan_mbar[((k_1 & 1) + 19)].wait((((k_1 >> 1) + 1) & 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 8)) {
        overlap_plan_mbar[((k_1 & 1) + 7)].arrive_and_expect_tx(4096);
        tl::tma_load(dO_desc, overlap_plan_mbar[((k_1 & 1) + 7)], (&(((half_t*)do_1)[((k_1 & 1) * 2048)])), 0, (k_1 * 32), ((int)blockIdx.x), 0);
      }
      if (2 <= k_1) {
        overlap_plan_mbar[((k_1 & 1) + 21)].wait((((k_1 >> 1) + 1) & 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 8)) {
