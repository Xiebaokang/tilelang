...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int i_13 = 0; i_13 < 128; ++i_13) {
      half_t condval;
      if (((((((i_13 >> 4) * 16) + (((i_13 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_13 & 1)) <= (((((((int)blockIdx.y) * 128) + (((i_13 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_13 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    for (int i_22 = 0; i_22 < 32; ++i_22) {
      ...
      *(uint1*)(residual_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)residual_shared) + (((((((((i_22 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_22 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_22 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_22 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_22 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __26;
