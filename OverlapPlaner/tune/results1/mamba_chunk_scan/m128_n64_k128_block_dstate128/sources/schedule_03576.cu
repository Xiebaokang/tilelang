...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* x_shared = ((void*)((char*)buf_dyn_shmem + 114688));
  void* da_k_shared = ((void*)((char*)buf_dyn_shmem + 147456));
  void* dt_shared = ((void*)((char*)buf_dyn_shmem + 148480));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int i_5 = 0; i_5 < 64; ++i_5) {
      *(uint1*)(cb_local_v0 + (i_5 * 2)) = *(uint1*)(((half_t*)cb_shared) + (((((((((((((i_5 >> 3) * 16) + (((i_5 & 3) >> 1) * 8)) >> 6) * 8192) + (((i_5 & 7) >> 2) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_5 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((((i_5 & 31) >> 3) * 16) + (((i_5 & 3) >> 1) * 8)) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_5 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_5 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    }
    ...
    for (int ik = 0; ik < ((int)blockIdx.y); ++ik) {
      ...
      for (int i_11 = 0; i_11 < 64; ++i_11) {
        *(uint1*)(cb_local_v1 + (i_11 * 2)) = *(uint1*)(((half_t*)cb_shared) + (((((((((((ik * 16384) + (((((i_11 >> 3) * 16) + (((i_11 & 3) >> 1) * 8)) >> 6) * 8192)) + (((i_11 & 7) >> 2) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_11 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((((i_11 & 31) >> 3) * 16) + (((i_11 & 3) >> 1) * 8)) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_11 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_11 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 16384));
      }
      ...
      for (int i_12 = 0; i_12 < 16; ++i_12) {
        ...
        *(uint1*)(da_k_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)da_k_shared) + ((((ik * 128) + (i_12 * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 128));
        float2 __12;
      ...
      for (int i_16 = 0; i_16 < 128; ++i_16) {
        half_t condval_1;
        if ((((((((ik * 128) + ((i_16 >> 4) * 16)) + (((i_16 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_16 & 1)) + 128) <= (((((((int)blockIdx.y) * 128) + (((i_16 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_16 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    if (((int)blockIdx.y) == 0) {
      {
        ...
        for (int i_18 = 0; i_18 < 2; ++i_18) {
          ...
          for (int ki_2 = 0; ki_2 < 8; ++ki_2) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v0 + ((ki_2 * 16) + (i_18 * 8))), uint64_t(desc_b_2 + ((ki_2 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_18 * 32)), 1);
          }
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
    ...
    } else {
      {
        ...
        for (int i_19 = 0; i_19 < 2; ++i_19) {
          ...
          for (int ki_3 = 0; ki_3 < 8; ++ki_3) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v1 + ((ki_3 * 16) + (i_19 * 8))), uint64_t(desc_b_3 + ((ki_3 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_19 * 32)), 1);
          }
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
    ...
    overlap_plan_mbar[(((int)blockIdx.y) + 19)].arrive();
    ...
    for (int i_20 = 0; i_20 < 32; ++i_20) {
      ...
      *(uint1*)(residual_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)residual_shared) + (((((((((i_20 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_20 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_20 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_20 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_20 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __23;
      uint1 v__16 = *(uint1*)(residual_shared_local_cast_4 + 0);
      ((float2*)(&__23))[0] = __half22float2(((half2*)(&v__16))[0]);
      *(float2*)(residual_local + (i_20 * 2)) = __23;
    }
    #pragma unroll
    ...
    for (int i_22 = 0; i_22 < 8; ++i_22) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((i_22 >> 2) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_22 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_22 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc[(i_22 * 8)]), ((half_t)acc[((i_22 * 8) + 1)])), __pack_half2(((half_t)acc[((i_22 * 8) + 2)]), ((half_t)acc[((i_22 * 8) + 3)])), __pack_half2(((half_t)acc[((i_22 * 8) + 4)]), ((half_t)acc[((i_22 * 8) + 5)])), __pack_half2(((half_t)acc[((i_22 * 8) + 6)]), ((half_t)acc[((i_22 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 128);
    ...
    for (int ik_1 = 0; ik_1 < ((int)blockIdx.y); ++ik_1) {
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[(ik_1 + 3)].arrive_and_expect_tx(32768);
        tl::tma_load(CB_desc, overlap_plan_mbar[(ik_1 + 3)], (&(((half_t*)cb_shared)[((ik_1 * 16384) + 16384)])), ((ik_1 * 128) + 128), (((int)blockIdx.y) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
        tl::tma_load(CB_desc, overlap_plan_mbar[(ik_1 + 3)], (&(((half_t*)cb_shared)[((ik_1 * 16384) + 24576)])), ((ik_1 * 128) + 192), (((int)blockIdx.y) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
        overlap_plan_mbar[(ik_1 + 5)].arrive_and_expect_tx(256);
        tl::tma_load((&(((half_t*)da_k_shared)[((ik_1 * 128) + 128)])), (&(DA[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik_1 * 128)) + 128)])), overlap_plan_mbar[(ik_1 + 5)], 256);
