  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < (((int)blockIdx.y) + 1); ++ik) {
      ...
      for (int i_5 = 0; i_5 < 64; ++i_5) {
        *(uint1*)(cb_local + (i_5 * 2)) = *(uint1*)(((half_t*)cb_shared) + ((((((((((ik * 16384) + (((((i_5 >> 3) * 16) + (((i_5 & 3) >> 1) * 8)) >> 6) * 8192)) + (((i_5 & 7) >> 2) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_5 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((((i_5 & 31) >> 3) * 16) + (((i_5 & 3) >> 1) * 8)) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_5 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_5 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      }
      ...
      for (int i_6 = 0; i_6 < 16; ++i_6) {
        ...
        *(uint1*)(da_k_shared_local_cast + 0) = *(uint1*)(((half_t*)da_k_shared) + (((ik * 128) + (i_6 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __1;
      ...
      for (int i_8 = 0; i_8 < 16; ++i_8) {
        ...
        *(uint1*)(dt_shared_local_cast_1 + 0) = *(uint1*)(((half_t*)dt_shared) + (((ik * 128) + (i_8 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __8;
      ...
      for (int i_10 = 0; i_10 < 128; ++i_10) {
        half_t condval;
        if (((((((ik * 128) + ((i_10 >> 4) * 16)) + (((i_10 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_10 & 1)) <= (((((((int)blockIdx.y) * 128) + (((i_10 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_10 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    for (int i_12 = 0; i_12 < 32; ++i_12) {
      ...
      *(uint1*)(residual_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)residual_shared) + (((((((((i_12 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_12 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_12 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_12 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_12 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __12;
    ...
    for (int i_14 = 0; i_14 < 8; ++i_14) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((i_14 >> 2) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_14 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_14 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc[(i_14 * 8)]), ((half_t)acc[((i_14 * 8) + 1)])), __pack_half2(((half_t)acc[((i_14 * 8) + 2)]), ((half_t)acc[((i_14 * 8) + 3)])), __pack_half2(((half_t)acc[((i_14 * 8) + 4)]), ((half_t)acc[((i_14 * 8) + 5)])), __pack_half2(((half_t)acc[((i_14 * 8) + 6)]), ((half_t)acc[((i_14 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 128);
