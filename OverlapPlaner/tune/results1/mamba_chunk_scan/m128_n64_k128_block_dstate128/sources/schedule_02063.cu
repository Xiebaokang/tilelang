...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int i_5 = 0; i_5 < 64; ++i_5) {
      *(uint1*)(cb_local + (i_5 * 2)) = *(uint1*)(((half_t*)cb_shared) + (((((((((((((i_5 >> 3) * 16) + (((i_5 & 3) >> 1) * 8)) >> 6) * 8192) + (((i_5 & 7) >> 2) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_5 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((((i_5 & 31) >> 3) * 16) + (((i_5 & 3) >> 1) * 8)) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_5 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_5 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    }
    ...
    for (int ik = 0; ik < ((int)blockIdx.y); ++ik) {
      ...
      overlap_plan_mbar[(ik + 4)].wait(0);
      #pragma unroll
      for (int i_12 = 0; i_12 < 64; ++i_12) {
        *(uint1*)(cb_local + (i_12 * 2)) = *(uint1*)(((half_t*)cb_shared) + (((((((((((ik * 16384) + (((((i_12 >> 3) * 16) + (((i_12 & 3) >> 1) * 8)) >> 6) * 8192)) + (((i_12 & 7) >> 2) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_12 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + ((((((((i_12 & 31) >> 3) * 16) + (((i_12 & 3) >> 1) * 8)) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_12 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_12 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 16384));
      }
      ...
      for (int i_13 = 0; i_13 < 16; ++i_13) {
        ...
        *(uint1*)(da_k_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)da_k_shared) + ((((ik * 128) + (i_13 * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 128));
        float2 __12;
      ...
      for (int i_14 = 0; i_14 < 16; ++i_14) {
        ...
        *(uint1*)(dt_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)dt_shared) + ((((ik * 128) + (i_14 * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 128));
        float2 __13;
      ...
      for (int i_17 = 0; i_17 < 128; ++i_17) {
        half_t condval_1;
        if ((((((((ik * 128) + ((i_17 >> 4) * 16)) + (((i_17 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_17 & 1)) + 128) <= (((((((int)blockIdx.y) * 128) + (((i_17 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_17 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    overlap_plan_mbar[(((int)blockIdx.y) + 9)].wait(0);
    {
    ...
    overlap_plan_mbar[(((int)blockIdx.y) + 18)].arrive();
    d_local[0] = ((float)D[((int)blockIdx.x)]);
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[11].arrive_and_expect_tx(16384);
      tl::tma_load(X_desc, overlap_plan_mbar[11], (&(((half_t*)residual_shared)[0])), 0, (((((int)blockIdx.z) >> 3) * 256) + (((int)blockIdx.y) * 128)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
    ...
    if (((int)threadIdx.x) < 256) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        ...
        tl::tma_load(CB_desc, overlap_plan_mbar[3], (&(((half_t*)cb_shared)[8192])), 64, (((int)blockIdx.y) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
        overlap_plan_mbar[5].arrive_and_expect_tx(256);
        tl::tma_load((&(((half_t*)da_k_shared)[0])), (&(DA[((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256))])), overlap_plan_mbar[5], 256);
        overlap_plan_mbar[7].arrive_and_expect_tx(256);
        tl::tma_load((&(((half_t*)dt_shared)[0])), (&(Dt[((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256))])), overlap_plan_mbar[7], 256);
      }
      for (int ik_1 = 0; ik_1 < ((int)blockIdx.y); ++ik_1) {
        if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
          overlap_plan_mbar[(ik_1 + 4)].arrive_and_expect_tx(32768);
          tl::tma_load(CB_desc, overlap_plan_mbar[(ik_1 + 4)], (&(((half_t*)cb_shared)[((ik_1 * 16384) + 16384)])), ((ik_1 * 128) + 128), (((int)blockIdx.y) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
          tl::tma_load(CB_desc, overlap_plan_mbar[(ik_1 + 4)], (&(((half_t*)cb_shared)[((ik_1 * 16384) + 24576)])), ((ik_1 * 128) + 192), (((int)blockIdx.y) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
          overlap_plan_mbar[(ik_1 + 6)].arrive_and_expect_tx(256);
          tl::tma_load((&(((half_t*)da_k_shared)[((ik_1 * 128) + 128)])), (&(DA[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik_1 * 128)) + 128)])), overlap_plan_mbar[(ik_1 + 6)], 256);
          overlap_plan_mbar[(ik_1 + 8)].arrive_and_expect_tx(256);
          tl::tma_load((&(((half_t*)dt_shared)[((ik_1 * 128) + 128)])), (&(Dt[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik_1 * 128)) + 128)])), overlap_plan_mbar[(ik_1 + 8)], 256);
          overlap_plan_mbar[(ik_1 + 9)].arrive_and_expect_tx(16384);
          tl::tma_load(X_desc, overlap_plan_mbar[(ik_1 + 9)], (&(((half_t*)x_shared)[(ik_1 * 8192)])), 0, (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 128)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
        }
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[(((int)blockIdx.y) + 9)].arrive_and_expect_tx(16384);
        tl::tma_load(X_desc, overlap_plan_mbar[(((int)blockIdx.y) + 9)], (&(((half_t*)x_shared)[(((int)blockIdx.y) * 8192)])), 0, (((((int)blockIdx.z) >> 3) * 256) + (((int)blockIdx.y) * 128)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
    } else {
      tl::warpgroup_reg_dealloc<24>();
      ((half_t*)da_m_shared)[(((int)threadIdx.x) - 256)] = DA[(((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (((int)blockIdx.y) * 128)) + ((int)threadIdx.x)) - 256)];
      tl::fence_proxy_async();
