...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    overlap_plan_mbar[(((int)blockIdx.y) + 8)].wait(0);
    if (((int)blockIdx.y) == 0) {
      {
    ...
    overlap_plan_mbar[(((int)blockIdx.y) + 17)].arrive();
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      ...
      tl::tma_load((&(((half_t*)dt_shared)[0])), (&(Dt[((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256))])), overlap_plan_mbar[6], 256);
    }
    for (int ik_1 = 0; ik_1 < ((int)blockIdx.y); ++ik_1) {
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        ...
        tl::tma_load((&(((half_t*)dt_shared)[((ik_1 * 128) + 128)])), (&(Dt[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik_1 * 128)) + 128)])), overlap_plan_mbar[(ik_1 + 7)], 256);
        overlap_plan_mbar[(ik_1 + 8)].arrive_and_expect_tx(16384);
        tl::tma_load(X_desc, overlap_plan_mbar[(ik_1 + 8)], (&(((half_t*)x_shared)[(ik_1 * 8192)])), 0, (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 128)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      overlap_plan_mbar[(((int)blockIdx.y) + 8)].arrive_and_expect_tx(16384);
      tl::tma_load(X_desc, overlap_plan_mbar[(((int)blockIdx.y) + 8)], (&(((half_t*)x_shared)[(((int)blockIdx.y) * 8192)])), 0, (((((int)blockIdx.z) >> 3) * 256) + (((int)blockIdx.y) * 128)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
  }
}
