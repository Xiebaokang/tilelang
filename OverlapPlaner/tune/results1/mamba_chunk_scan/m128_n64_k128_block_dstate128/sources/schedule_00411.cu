  ...
  if (((int)threadIdx.x) < 128) {
    ...
    if (((int)blockIdx.y) == 0) {
      ...
      for (int i_19 = 0; i_19 < 32; ++i_19) {
        *(float2*)(((float*)acc_wsp_handoff_6) + (((((((i_19 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_19 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((i_19 & 15) >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(acc + (i_19 * 2));
      }
    } else {
      {
    ...
    for (int i_22 = 0; i_22 < 32; ++i_22) {
      ...
      *(float2*)(residual_local + (i_22 * 2)) = __23;
    }
    overlap_plan_mbar[7].wait(0);
    #pragma unroll
    for (int i_23 = 0; i_23 < 32; ++i_23) {
      *(float2*)(acc + (i_23 * 2)) = *(float2*)(((float*)acc_wsp_handoff_6) + ((((((((i_23 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_23 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((i_23 & 15) >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
    }
    #pragma unroll
    for (int i_24 = 0; i_24 < 64; ++i_24) {
      acc[i_24] = (acc[i_24] + (residual_local[i_24] * d_local[0]));
    }
    #pragma unroll
    for (int i_25 = 0; i_25 < 8; ++i_25) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((i_25 >> 2) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_25 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_25 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) - 4096)])), __pack_half2(((half_t)acc[(i_25 * 8)]), ((half_t)acc[((i_25 * 8) + 1)])), __pack_half2(((half_t)acc[((i_25 * 8) + 2)]), ((half_t)acc[((i_25 * 8) + 3)])), __pack_half2(((half_t)acc[((i_25 * 8) + 4)]), ((half_t)acc[((i_25 * 8) + 5)])), __pack_half2(((half_t)acc[((i_25 * 8) + 6)]), ((half_t)acc[((i_25 * 8) + 7)])));
    }
