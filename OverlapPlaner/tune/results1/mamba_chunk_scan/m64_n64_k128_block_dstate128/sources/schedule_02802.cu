  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < ((((int)blockIdx.y) >> 1) + 1); ++ik) {
      ...
      for (int i_4 = 0; i_4 < 32; ++i_4) {
        *(uint1*)(cb_local + (i_4 * 2)) = *(uint1*)(((half_t*)cb_shared) + (((((((((ik * 8192) + ((i_4 >> 4) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_4 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_4 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_4 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_4 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      }
      ...
      for (int i_5 = 0; i_5 < 16; ++i_5) {
        ...
        *(uint1*)(da_k_shared_local_cast + 0) = *(uint1*)(((half_t*)da_k_shared) + (((ik * 128) + (i_5 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __1;
