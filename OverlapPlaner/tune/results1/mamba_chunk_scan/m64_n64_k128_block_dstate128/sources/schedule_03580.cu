...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc, __grid_constant__ const CUtensorMap X_desc_1) {
  ...
  for (int i_12 = 0; i_12 < 16; ++i_12) {
    ...
    *(uint1*)(dt_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)dt_shared) + ((((((int)blockIdx.y) >> 1) * 128) + (i_12 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    float2 __19;
  ...
  if ((((int)blockIdx.y) >> 1) == 0) {
    ...
    for (int i_15 = 0; i_15 < 64; ++i_15) {
      half_t condval;
      if ((((((i_15 >> 2) * 8) + ((((int)threadIdx.x) & 3) * 2)) + (i_15 & 1)) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_15 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    for (int i_16 = 0; i_16 < 64; ++i_16) {
      half_t condval_1;
      if (((((((i_16 >> 2) * 8) + ((((int)threadIdx.x) & 3) * 2)) + (i_16 & 1)) + 128) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_16 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
  ...
  for (int i_17 = 0; i_17 < 16; ++i_17) {
    ...
    *(uint1*)(residual_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)residual_shared) + ((((((((((int)threadIdx.x) >> 5) * 1024) + ((i_17 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_17 >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_17 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_17 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    float2 __26;
