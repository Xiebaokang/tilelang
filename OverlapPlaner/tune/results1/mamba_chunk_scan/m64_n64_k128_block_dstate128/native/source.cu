...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(const half_t* __restrict__ C, __grid_constant__ const CUtensorMap CB_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, const half_t* __restrict__ Prev, const half_t* __restrict__ X, __grid_constant__ const CUtensorMap X_desc) {
  ...
  #pragma unroll
  for (int i = 0; i < 4; ++i) {
    *(uint4*)(((half_t*)c_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i * 1024)) + ((((int)threadIdx.x) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(C + ((((((((int)blockIdx.z) & 7) * 524288) + ((((int)blockIdx.z) >> 3) * 32768)) + (((int)blockIdx.y) * 8192)) + (i * 2048)) + (((int)threadIdx.x) * 8)));
  }
  #pragma unroll
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < ((((int)blockIdx.y) >> 1) + 1); ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>()) {
        mbarrier[ik].arrive_and_expect_tx(16384);
        tl::tma_load(CB_desc, mbarrier[ik], (&(((half_t*)cb_shared)[(ik * 8192)])), (ik * 128), (((int)blockIdx.y) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
        tl::tma_load(CB_desc, mbarrier[ik], (&(((half_t*)cb_shared)[((ik * 8192) + 4096)])), ((ik * 128) + 64), (((int)blockIdx.y) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      }
    ...
    for (int ik_1 = 0; ik_1 < ((((int)blockIdx.y) >> 1) + 1); ++ik_1) {
      ...
      for (int i_6 = 0; i_6 < 32; ++i_6) {
        *(uint1*)(cb_local + (i_6 * 2)) = *(uint1*)(((half_t*)cb_shared) + ((((((((((ik_1 * 8192) + ((i_6 >> 4) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_6 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_6 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_6 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_6 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
      }
      ...
      for (int i_7 = 0; i_7 < 16; ++i_7) {
        ...
        *(uint1*)(da_k_shared_local_cast + 0) = *(uint1*)(((half_t*)da_k_shared) + (((ik_1 * 128) + (i_7 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __1;
      ...
      for (int i_9 = 0; i_9 < 16; ++i_9) {
        ...
        *(uint1*)(dt_shared_local_cast_1 + 0) = *(uint1*)(((half_t*)dt_shared) + (((ik_1 * 128) + (i_9 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __8;
      ...
      for (int i_11 = 0; i_11 < 64; ++i_11) {
        half_t condval;
        if (((((((ik_1 * 128) + ((i_11 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_11 & 1)) + 64) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_11 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    for (int i_12 = 0; i_12 < 4; ++i_12) {
      *(uint4*)(((half_t*)residual_shared) + ((((((i_12 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) - 1024)) = *(uint4*)(X + (((((((((((int)blockIdx.z) & 7) * 20971520) + ((((int)blockIdx.z) >> 3) * 1310720)) + (((int)blockIdx.y) * 327680)) + (i_12 * 81920)) + ((((int)threadIdx.x) >> 3) * 5120)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 7) * 8)) - 81920));
    }
    tl::__sync_thread_partial(3, 128);
    #pragma unroll
    for (int i_13 = 0; i_13 < 16; ++i_13) {
      half_t residual_shared_local_cast_2[2];
      *(uint1*)(residual_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)residual_shared) + (((((((((((int)threadIdx.x) >> 5) * 1024) + ((i_13 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_13 >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_13 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_13 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
      float2 __12;
