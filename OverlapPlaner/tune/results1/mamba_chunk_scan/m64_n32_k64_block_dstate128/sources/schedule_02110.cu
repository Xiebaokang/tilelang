  ...
  if (((int)threadIdx.x) < 128) {
    ...
    if (1 < ((int)blockIdx.y)) {
      ...
      for (int i_15 = 0; i_15 < 32; ++i_15) {
        half_t condval_1;
        if (((((((i_15 >> 2) * 8) + ((((int)threadIdx.x) & 3) * 2)) + (i_15 & 1)) + 64) <= (((((((int)blockIdx.y) >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_15 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    for (int ik = 0; ik < ((((int)blockIdx.y) >> 1) - 1); ++ik) {
      ...
      if (ik == 0) {
        ...
        for (int i_24 = 0; i_24 < 32; ++i_24) {
          half_t condval_2;
          if (((((((ik * 64) + ((i_24 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_24 & 1)) + 128) <= (((((((int)blockIdx.y) >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_24 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
        ...
        for (int i_25 = 0; i_25 < 32; ++i_25) {
          half_t condval_3;
          if (((((((ik * 64) + ((i_25 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_25 & 1)) + 128) <= (((((((int)blockIdx.y) >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_25 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    if (2 <= ((int)blockIdx.y)) {
      overlap_plan_mbar[((((((int)blockIdx.y) >> 1) + 1) & 1) + 8)].wait(((((((int)blockIdx.y) >> 1) + 3) & 3) >> 1));
      ...
      overlap_plan_mbar[((((((int)blockIdx.y) >> 1) + 1) & 1) + 17)].arrive();
    }
    overlap_plan_mbar[(((((int)blockIdx.y) & 3) >> 1) + 8)].wait((((int)blockIdx.y) >> 2));
    ...
    overlap_plan_mbar[(((((int)blockIdx.y) & 3) >> 1) + 17)].arrive();
    ...
    for (int i_26 = 0; i_26 < 8; ++i_26) {
      ...
      *(uint1*)(residual_shared_local_cast_6 + 0) = *(uint1*)(((half_t*)residual_shared) + (((((((((int)threadIdx.x) >> 5) * 512) + ((i_26 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_26 >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_26 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __43;
    ...
    for (int i_28 = 0; i_28 < 2; ++i_28) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((((int)threadIdx.x) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + i_28) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(((half_t)acc[(i_28 * 8)]), ((half_t)acc[((i_28 * 8) + 1)])), __pack_half2(((half_t)acc[((i_28 * 8) + 2)]), ((half_t)acc[((i_28 * 8) + 3)])), __pack_half2(((half_t)acc[((i_28 * 8) + 4)]), ((half_t)acc[((i_28 * 8) + 5)])), __pack_half2(((half_t)acc[((i_28 * 8) + 6)]), ((half_t)acc[((i_28 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 128);
    ...
    for (int ik_1 = 0; ik_1 < (((int)blockIdx.y) >> 1); ++ik_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        ...
        tl::tma_load(CB_desc, overlap_plan_mbar[(((ik_1 + 1) & 1) + 2)], (&(((half_t*)cb_shared)[(((ik_1 + 1) & 1) * 4096)])), ((ik_1 * 64) + 64), ((((int)blockIdx.y) >> 1) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      }
      if (1 <= ik_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[((ik_1 & 1) + 8)].arrive_and_expect_tx(4096);
        tl::tma_load(X_desc, overlap_plan_mbar[((ik_1 & 1) + 8)], (&(((half_t*)x_shared)[((ik_1 & 1) * 2048)])), ((((int)blockIdx.y) & 1) * 32), (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
    }
    if (4 <= ((int)blockIdx.y)) {
      overlap_plan_mbar[(((((int)blockIdx.y) & 3) >> 1) + 17)].wait(0);
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      overlap_plan_mbar[(((((int)blockIdx.y) & 3) >> 1) + 8)].arrive_and_expect_tx(4096);
      tl::tma_load(X_desc, overlap_plan_mbar[(((((int)blockIdx.y) & 3) >> 1) + 8)], (&(((half_t*)x_shared)[(((((int)blockIdx.y) & 3) >> 1) * 2048)])), ((((int)blockIdx.y) & 1) * 32), (((((int)blockIdx.z) >> 3) * 256) + ((((int)blockIdx.y) >> 1) * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
  }
}
