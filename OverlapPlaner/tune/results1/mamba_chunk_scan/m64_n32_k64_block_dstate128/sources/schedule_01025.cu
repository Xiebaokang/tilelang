  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < (((int)blockIdx.y) >> 1); ++ik) {
      ...
      for (int i_11 = 0; i_11 < 8; ++i_11) {
        ...
        *(uint1*)(da_k_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)da_k_shared) + (((((ik + 1) & 1) * 64) + (i_11 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __12;
      ...
      for (int i_12 = 0; i_12 < 8; ++i_12) {
        ...
        *(uint1*)(dt_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)dt_shared) + (((((ik + 1) & 1) * 64) + (i_12 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __13;
    ...
    for (int ik_1 = 0; ik_1 < ((((int)blockIdx.y) >> 1) + 1); ++ik_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        ...
        tl::tma_load(CB_desc, overlap_plan_mbar[((ik_1 & 1) + 2)], (&(((half_t*)cb_shared)[((ik_1 & 1) * 4096)])), (ik_1 * 64), ((((int)blockIdx.y) >> 1) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      }
      if (2 <= ik_1) {
