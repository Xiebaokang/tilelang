...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* residual_shared = ((void*)((char*)buf_dyn_shmem + 56320));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < (((int)blockIdx.y) >> 1); ++ik) {
      ...
      overlap_plan_mbar[(((ik + 1) & 1) + 14)].arrive();
      overlap_plan_mbar[(((ik + 1) % 3) + 5)].wait(((ik + 1) / 3));
      #pragma unroll
      for (int i_12 = 0; i_12 < 8; ++i_12) {
        half_t da_k_shared_local_cast_2[2];
        *(uint1*)(da_k_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)da_k_shared) + (((((ik + 1) % 3) * 64) + (i_12 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __12;
        uint1 v__8 = *(uint1*)(da_k_shared_local_cast_2 + 0);
        ((float2*)(&__12))[0] = __half22float2(((half2*)(&v__8))[0]);
        *(float2*)(da_k_local + (i_12 * 2)) = __12;
      }
      overlap_plan_mbar[(((ik + 1) % 3) + 16)].arrive();
      if (((ik + 1) % 2) == 0) {
        #pragma unroll
      ...
      overlap_plan_mbar[(((ik + 1) & 1) + 8)].wait(((ik + 1) >> 1));
      #pragma unroll
      ...
      overlap_plan_mbar[(((ik + 1) & 1) + 19)].arrive();
      if (((ik + 1) % 2) == 0) {
        #pragma unroll
    ...
    overlap_plan_mbar[(((((int)blockIdx.y) & 3) >> 1) + 10)].wait((((int)blockIdx.y) >> 2));
    ...
    overlap_plan_mbar[(((((int)blockIdx.y) & 3) >> 1) + 21)].arrive();
    ...
    for (int ik_1 = 0; ik_1 < ((((int)blockIdx.y) >> 1) + 1); ++ik_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[((ik_1 & 1) + 10)].arrive_and_expect_tx(4096);
        tl::tma_load(X_desc, overlap_plan_mbar[((ik_1 & 1) + 10)], (&(((half_t*)x_shared)[((ik_1 & 1) * 2048)])), ((((int)blockIdx.y) & 1) * 32), (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      overlap_plan_mbar[12].arrive_and_expect_tx(4096);
      tl::tma_load(X_desc, overlap_plan_mbar[12], (&(((half_t*)residual_shared)[0])), ((((int)blockIdx.y) & 1) * 32), (((((int)blockIdx.z) >> 3) * 256) + ((((int)blockIdx.y) >> 1) * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
