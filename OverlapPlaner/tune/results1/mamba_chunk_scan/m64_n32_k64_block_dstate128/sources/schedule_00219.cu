...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* da_k_shared = ((void*)((char*)buf_dyn_shmem + 36864));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < ((((int)blockIdx.y) >> 1) - 1); ++ik) {
      ...
      if (ik == 0) {
        ...
        for (int i_26 = 0; i_26 < 32; ++i_26) {
          half_t condval_2;
          if (((((((ik * 64) + ((i_26 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_26 & 1)) + 128) <= (((((((int)blockIdx.y) >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_26 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    if (((((int)blockIdx.y) % 6) >> 1) == 0) {
      ...
      for (int i_31 = 0; i_31 < 32; ++i_31) {
        half_t condval_3;
        if ((((((((((int)blockIdx.y) >> 1) * 64) + ((i_31 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_31 & 1)) + 64) <= (((((((int)blockIdx.y) >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_31 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
      ...
      if (((((int)blockIdx.y) % 6) >> 1) == 1) {
        ...
        for (int i_32 = 0; i_32 < 32; ++i_32) {
          half_t condval_4;
          if ((((((((((int)blockIdx.y) >> 1) * 64) + ((i_32 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_32 & 1)) + 64) <= (((((((int)blockIdx.y) >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_32 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
        ...
        for (int i_33 = 0; i_33 < 32; ++i_33) {
          half_t condval_5;
          if ((((((((((int)blockIdx.y) >> 1) * 64) + ((i_33 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_33 & 1)) + 64) <= (((((((int)blockIdx.y) >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_33 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    for (int i_34 = 0; i_34 < 8; ++i_34) {
      ...
      *(uint1*)(residual_shared_local_cast_7 + 0) = *(uint1*)(((half_t*)residual_shared) + ((((((((((int)threadIdx.x) >> 5) * 512) + ((i_34 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_34 >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_34 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 2048));
      float2 __53;
    ...
    for (int i_36 = 0; i_36 < 2; ++i_36) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((((int)threadIdx.x) & 127) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + i_36) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(((half_t)acc[(i_36 * 8)]), ((half_t)acc[((i_36 * 8) + 1)])), __pack_half2(((half_t)acc[((i_36 * 8) + 2)]), ((half_t)acc[((i_36 * 8) + 3)])), __pack_half2(((half_t)acc[((i_36 * 8) + 4)]), ((half_t)acc[((i_36 * 8) + 5)])), __pack_half2(((half_t)acc[((i_36 * 8) + 6)]), ((half_t)acc[((i_36 * 8) + 7)])));
    }
    tl::fence_proxy_async();
