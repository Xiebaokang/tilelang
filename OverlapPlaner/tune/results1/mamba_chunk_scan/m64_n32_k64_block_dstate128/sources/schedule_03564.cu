...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  __shared__ __align__(16) uint64_t overlap_plan_mbar_mem[25];
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < ((((int)blockIdx.y) >> 1) + 1); ++ik) {
      overlap_plan_mbar[((ik % 3) + 3)].wait((ik / 3));
      #pragma unroll
      for (int i_4 = 0; i_4 < 16; ++i_4) {
        *(uint1*)(cb_local + (i_4 * 2)) = *(uint1*)(((half_t*)cb_shared) + (((((((((ik % 3) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_4 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_4 >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_4 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_4 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      }
      overlap_plan_mbar[((ik % 3) + 15)].arrive();
      overlap_plan_mbar[((ik % 3) + 6)].wait((ik / 3));
      #pragma unroll
      for (int i_5 = 0; i_5 < 8; ++i_5) {
        half_t da_k_shared_local_cast[2];
        *(uint1*)(da_k_shared_local_cast + 0) = *(uint1*)(((half_t*)da_k_shared) + ((((ik % 3) * 64) + (i_5 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __1;
        uint1 v_ = *(uint1*)(da_k_shared_local_cast + 0);
        ((float2*)(&__1))[0] = __half22float2(((half2*)(&v_))[0]);
        *(float2*)(da_k_local + (i_5 * 2)) = __1;
      }
      overlap_plan_mbar[((ik % 3) + 18)].arrive();
      overlap_plan_mbar[((ik & 1) + 9)].wait((ik >> 1));
      #pragma unroll
      for (int i_6 = 0; i_6 < 8; ++i_6) {
        half_t dt_shared_local_cast_1[2];
        *(uint1*)(dt_shared_local_cast_1 + 0) = *(uint1*)(((half_t*)dt_shared) + ((((ik & 1) * 64) + (i_6 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __2;
      ...
      for (int i_9 = 0; i_9 < 32; ++i_9) {
        half_t condval;
        if ((((((ik * 64) + ((i_9 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_9 & 1)) <= (((((((int)blockIdx.y) >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_9 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
      ...
      overlap_plan_mbar[((ik & 1) + 11)].wait((ik >> 1));
      {
      ...
      overlap_plan_mbar[((ik & 1) + 23)].arrive();
    }
    ...
    for (int ik_1 = 0; ik_1 < ((((int)blockIdx.y) >> 1) + 1); ++ik_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[((ik_1 % 3) + 3)].arrive_and_expect_tx(8192);
        tl::tma_load(CB_desc, overlap_plan_mbar[((ik_1 % 3) + 3)], (&(((half_t*)cb_shared)[((ik_1 % 3) * 4096)])), (ik_1 * 64), ((((int)blockIdx.y) >> 1) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      }
      if (ik_1 == 3) {
        overlap_plan_mbar[((ik_1 % 3) + 18)].wait(0);
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[((ik_1 % 3) + 6)].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)da_k_shared)[((ik_1 % 3) * 64)])), (&(DA[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik_1 * 64))])), overlap_plan_mbar[((ik_1 % 3) + 6)], 128);
      }
      if (2 <= ik_1) {
        overlap_plan_mbar[((ik_1 & 1) + 21)].wait(0);
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[((ik_1 & 1) + 9)].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)dt_shared)[((ik_1 & 1) * 64)])), (&(Dt[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik_1 * 64))])), overlap_plan_mbar[((ik_1 & 1) + 9)], 128);
      }
      if (2 <= ik_1) {
        overlap_plan_mbar[((ik_1 & 1) + 23)].wait(0);
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[((ik_1 & 1) + 11)].arrive_and_expect_tx(4096);
        tl::tma_load(X_desc, overlap_plan_mbar[((ik_1 & 1) + 11)], (&(((half_t*)x_shared)[((ik_1 & 1) * 2048)])), ((((int)blockIdx.y) & 1) * 32), (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      overlap_plan_mbar[13].arrive_and_expect_tx(4096);
      tl::tma_load(X_desc, overlap_plan_mbar[13], (&(((half_t*)residual_shared)[0])), ((((int)blockIdx.y) & 1) * 32), (((((int)blockIdx.z) >> 3) * 256) + ((((int)blockIdx.y) >> 1) * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
