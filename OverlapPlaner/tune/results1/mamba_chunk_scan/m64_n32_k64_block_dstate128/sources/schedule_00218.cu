...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* da_k_shared = ((void*)((char*)buf_dyn_shmem + 37888));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    if (((int)threadIdx.x) < 192) {
      ((half_t*)da_m_shared)[(((int)threadIdx.x) - 128)] = DA[(((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + ((((int)blockIdx.y) >> 1) * 64)) + ((int)threadIdx.x)) - 128)];
    }
    ...
    for (int i_13 = 0; i_13 < 32; ++i_13) {
      half_t condval;
      if (((((((i_13 >> 2) * 8) + ((((int)threadIdx.x) & 3) * 2)) + (i_13 & 1)) + 64) <= (((((((int)blockIdx.y) >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_13 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    for (int ik = 0; ik < ((((int)blockIdx.y) >> 1) - 1); ++ik) {
      ...
      if (((ik + 1) % 2) == 0) {
        ...
        for (int i_23 = 0; i_23 < 32; ++i_23) {
          half_t condval_1;
          if (((((((ik * 64) + ((i_23 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_23 & 1)) + 128) <= (((((((int)blockIdx.y) >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_23 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    if (2 <= ((int)blockIdx.y)) {
      if (4 <= ((int)blockIdx.y)) {
        overlap_plan_mbar[11].wait(((((int)blockIdx.y) & 3) >> 1));
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[5].arrive_and_expect_tx(4096);
        tl::tma_load(X_desc, overlap_plan_mbar[5], (&(((half_t*)x_shared)[0])), ((((int)blockIdx.y) & 1) * 32), ((((((int)blockIdx.z) >> 3) * 256) + ((((int)blockIdx.y) >> 1) * 64)) - 64), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
      overlap_plan_mbar[5].wait((((((int)blockIdx.y) >> 1) + 1) & 1));
    ...
    if (((((int)blockIdx.y) & 3) >> 1) == 0) {
      ...
      for (int i_27 = 0; i_27 < 32; ++i_27) {
        half_t condval_3;
        if ((((((((((int)blockIdx.y) >> 1) * 64) + ((i_27 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_27 & 1)) + 64) <= (((((((int)blockIdx.y) >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_27 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
      ...
      for (int i_28 = 0; i_28 < 32; ++i_28) {
        half_t condval_4;
        if ((((((((((int)blockIdx.y) >> 1) * 64) + ((i_28 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_28 & 1)) + 64) <= (((((((int)blockIdx.y) >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_28 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    if (2 <= ((int)blockIdx.y)) {
      overlap_plan_mbar[11].wait((((((int)blockIdx.y) >> 1) + 1) & 1));
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      overlap_plan_mbar[5].arrive_and_expect_tx(4096);
      tl::tma_load(X_desc, overlap_plan_mbar[5], (&(((half_t*)x_shared)[0])), ((((int)blockIdx.y) & 1) * 32), (((((int)blockIdx.z) >> 3) * 256) + ((((int)blockIdx.y) >> 1) * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
    overlap_plan_mbar[5].wait(((((int)blockIdx.y) & 3) >> 1));
    if (((((int)blockIdx.y) & 3) >> 1) == 0) {
      {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      ...
      tl::tma_load(X_desc, overlap_plan_mbar[6], (&(((half_t*)residual_shared)[0])), ((((int)blockIdx.y) & 1) * 32), (((((int)blockIdx.z) >> 3) * 256) + ((((int)blockIdx.y) >> 1) * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
    overlap_plan_mbar[6].wait(0);
    #pragma unroll
    for (int i_29 = 0; i_29 < 8; ++i_29) {
      half_t residual_shared_local_cast_7[2];
      *(uint1*)(residual_shared_local_cast_7 + 0) = *(uint1*)(((half_t*)residual_shared) + ((((((((((int)threadIdx.x) >> 5) * 512) + ((i_29 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_29 >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_29 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 2048));
      float2 __47;
    ...
    for (int i_31 = 0; i_31 < 2; ++i_31) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((((int)threadIdx.x) & 127) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + i_31) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(((half_t)acc[(i_31 * 8)]), ((half_t)acc[((i_31 * 8) + 1)])), __pack_half2(((half_t)acc[((i_31 * 8) + 2)]), ((half_t)acc[((i_31 * 8) + 3)])), __pack_half2(((half_t)acc[((i_31 * 8) + 4)]), ((half_t)acc[((i_31 * 8) + 5)])), __pack_half2(((half_t)acc[((i_31 * 8) + 6)]), ((half_t)acc[((i_31 * 8) + 7)])));
    }
    tl::fence_proxy_async();
