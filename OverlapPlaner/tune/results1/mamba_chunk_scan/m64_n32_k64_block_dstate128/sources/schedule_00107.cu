...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* residual_shared = ((void*)((char*)buf_dyn_shmem + 43008));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int i_9 = 0; i_9 < 32; ++i_9) {
      half_t condval;
      if (((((((i_9 >> 2) * 8) + ((((int)threadIdx.x) & 3) * 2)) + (i_9 & 1)) + 64) <= (((((((int)blockIdx.y) >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_9 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    if (1 < ((int)blockIdx.y)) {
      ...
      for (int i_15 = 0; i_15 < 32; ++i_15) {
        half_t condval_1;
        if (((((((i_15 >> 2) * 8) + ((((int)threadIdx.x) & 3) * 2)) + (i_15 & 1)) + 128) <= (((((((int)blockIdx.y) >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_15 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    for (int ik = 0; ik < ((((int)blockIdx.y) >> 1) - 1); ++ik) {
      ...
      if (((ik + 2) % 3) == 0) {
        ...
        for (int i_27 = 0; i_27 < 32; ++i_27) {
          half_t condval_2;
          if (((((((ik * 64) + ((i_27 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_27 & 1)) + 192) <= (((((((int)blockIdx.y) >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_27 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
        ...
        if (((ik + 2) % 3) == 1) {
          ...
          for (int i_29 = 0; i_29 < 32; ++i_29) {
            half_t condval_4;
            if (((((((ik * 64) + ((i_29 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_29 & 1)) + 192) <= (((((((int)blockIdx.y) >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_29 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    if (4 <= ((int)blockIdx.y)) {
      overlap_plan_mbar[(((((int)blockIdx.y) & 3) >> 1) + 11)].wait(0);
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
    ...
    if (2 <= ((int)blockIdx.y)) {
      ...
      overlap_plan_mbar[((((((int)blockIdx.y) >> 1) + 1) & 1) + 11)].arrive();
    }
    ...
    for (int i_30 = 0; i_30 < 8; ++i_30) {
      ...
      *(uint1*)(residual_shared_local_cast_6 + 0) = *(uint1*)(((half_t*)residual_shared) + ((((((((((int)threadIdx.x) >> 5) * 512) + ((i_30 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_30 >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_30 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 2048));
      float2 __43;
    ...
    for (int i_32 = 0; i_32 < 2; ++i_32) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((((int)threadIdx.x) & 127) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + i_32) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(((half_t)acc[(i_32 * 8)]), ((half_t)acc[((i_32 * 8) + 1)])), __pack_half2(((half_t)acc[((i_32 * 8) + 2)]), ((half_t)acc[((i_32 * 8) + 3)])), __pack_half2(((half_t)acc[((i_32 * 8) + 4)]), ((half_t)acc[((i_32 * 8) + 5)])), __pack_half2(((half_t)acc[((i_32 * 8) + 6)]), ((half_t)acc[((i_32 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 128);
