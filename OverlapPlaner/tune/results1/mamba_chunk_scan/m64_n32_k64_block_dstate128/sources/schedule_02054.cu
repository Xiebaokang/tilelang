...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* cb_local_wsp_handoff_6 = ((void*)((char*)buf_dyn_shmem + 43008));
  void* x_shared = ((void*)((char*)buf_dyn_shmem + 51200));
  void* da_k_shared = ((void*)((char*)buf_dyn_shmem + 55296));
  void* dt_shared = ((void*)((char*)buf_dyn_shmem + 56320));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < ((((int)blockIdx.y) >> 1) + 1); ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(CB_desc, overlap_plan_mbar[((ik & 1) + 4)], (&(((half_t*)cb_shared)[((ik & 1) * 4096)])), (ik * 64), ((((int)blockIdx.y) >> 1) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      }
      if (2 <= ik) {
      ...
      for (int i_6 = 0; i_6 < 32; ++i_6) {
        half_t condval;
        if ((((((ik * 64) + ((i_6 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_6 & 1)) <= (((((((int)blockIdx.y) >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_6 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
