...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* dt_shared = ((void*)((char*)buf_dyn_shmem + 76800));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < ((int)blockIdx.y); ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(CB_desc, overlap_plan_mbar[(((ik + 1) & 1) + 4)], (&(((half_t*)cb_shared)[(((ik + 1) & 1) * 4096)])), ((ik * 64) + 64), (((int)blockIdx.y) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      }
      if (1 <= ik) {
      ...
      for (int i_8 = 0; i_8 < 4; ++i_8) {
        tl::ptx_ldmatrix_x4((&(((half_t*)cb_local_wsp_handoff_6)[(((((((int)threadIdx.x) >> 5) * 1024) + ((((int)threadIdx.x) & 15) * 64)) + (i_8 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), (&(cb_local[(i_8 * 8)])));
      }
      #pragma unroll
      ...
      for (int i_10 = 0; i_10 < 32; ++i_10) {
        half_t condval_1;
        if (((((((ik * 64) + ((i_10 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_10 & 1)) + 64) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_10 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    overlap_plan_mbar[((((int)blockIdx.y) & 1) + 10)].wait((((int)blockIdx.y) >> 1));
    {
    ...
    for (int ik_1 = 0; ik_1 < (((int)blockIdx.y) + 1); ++ik_1) {
      ...
      for (int i_17 = 0; i_17 < 16; ++i_17) {
        *(uint1*)(cb_local + (i_17 * 2)) = *(uint1*)(((half_t*)cb_shared) + ((((((((((ik_1 & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_17 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_17 >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_17 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_17 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
      }
      ...
      for (int i_18 = 0; i_18 < 8; ++i_18) {
        ...
        *(uint1*)(da_k_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)da_k_shared) + ((((ik_1 & 1) * 64) + (i_18 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __10;
      ...
      for (int i_20 = 0; i_20 < 4; ++i_20) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)cb_local_wsp_handoff_6)[((((((((int)threadIdx.x) >> 5) * 1024) + ((((int)threadIdx.x) & 15) * 64)) + (i_20 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 4096)])), __pack_half2(cb_local[(i_20 * 8)], cb_local[((i_20 * 8) + 1)]), __pack_half2(cb_local[((i_20 * 8) + 2)], cb_local[((i_20 * 8) + 3)]), __pack_half2(cb_local[((i_20 * 8) + 4)], cb_local[((i_20 * 8) + 5)]), __pack_half2(cb_local[((i_20 * 8) + 6)], cb_local[((i_20 * 8) + 7)]));
      }
      tl::fence_proxy_async();
