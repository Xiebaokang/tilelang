  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < (((int)blockIdx.y) - 1); ++ik) {
      ...
      if (((ik + 2) % 3) == 0) {
        ...
        for (int i_12 = 0; i_12 < 4; ++i_12) {
          tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[((((((int)threadIdx.x) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_12 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_12 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(cb_local_v0[(i_12 * 8)])));
        }
      } else {
        if (((ik + 2) % 3) == 1) {
          #pragma unroll
          for (int i_13 = 0; i_13 < 4; ++i_13) {
            tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[((((((int)threadIdx.x) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_13 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_13 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(cb_local_v1[(i_13 * 8)])));
          }
        } else {
          #pragma unroll
          for (int i_14 = 0; i_14 < 4; ++i_14) {
            tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[((((((int)threadIdx.x) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_14 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_14 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(cb_local_v2[(i_14 * 8)])));
          }
        }
      }
      overlap_plan_mbar[9].arrive();
      ...
      if (((ik + 2) % 3) == 0) {
        ...
        for (int i_16 = 0; i_16 < 16; ++i_16) {
          ...
          float2 __19;
            float2 __20;
            uint1 v__13 = *(uint1*)(cb_local_v0 + (i_16 * 2));
            ((float2*)(&__20))[0] = __half22float2(((half2*)(&v__13))[0]);
            float2 __21;
            float2 __22;
              float2 __23;
                float2 v__14 = make_float2(da_m_local[(i_16 & 1)], da_m_local[(i_16 & 1)]);
                float2 v__15 = *(float2*)(da_k_local + ((i_16 >> 1) * 2));
                __23.x = (v__14.x-v__15.x);
                __23.y = (v__14.y-v__15.y);
              float2 v__16 = make_float2(broadcast_var_3, broadcast_var_3);
              __22.x = (__23.x*v__16.x);
              __22.y = (__23.y*v__16.y);
            __21.x = exp2f(__22.x);
            __21.y = exp2f(__22.y);
            __19.x = (__20.x*__21.x);
            __19.y = (__20.y*__21.y);
          ((half2*)(&__18))[0] = __float22half2_rn(((float2*)(&__19))[0]);
          *(uint1*)(cb_local_v0 + (i_16 * 2)) = __18;
        }
      } else {
        if (((ik + 2) % 3) == 1) {
          #pragma unroll
          for (int i_17 = 0; i_17 < 32; ++i_17) {
            cb_local_v1[i_17] = ((half_t)(((float)cb_local_v1[i_17]) * exp2f(((da_m_local[((i_17 & 3) >> 1)] - da_k_local[(((i_17 >> 2) * 2) + (i_17 & 1))]) * 0x1.7154764ee6c2fp+0f/*1.442695e+00*/))));
          }
        } else {
          #pragma unroll
          for (int i_18 = 0; i_18 < 16; ++i_18) {
            ...
            float2 __25;
              float2 __26;
              uint1 v__17 = *(uint1*)(cb_local_v2 + (i_18 * 2));
              ((float2*)(&__26))[0] = __half22float2(((half2*)(&v__17))[0]);
              float2 __27;
              float2 __28;
                float2 __29;
                  float2 v__18 = make_float2(da_m_local[(i_18 & 1)], da_m_local[(i_18 & 1)]);
                  float2 v__19 = *(float2*)(da_k_local + ((i_18 >> 1) * 2));
                  __29.x = (v__18.x-v__19.x);
                  __29.y = (v__18.y-v__19.y);
                float2 v__20 = make_float2(broadcast_var_4, broadcast_var_4);
      ...
      if (((ik + 2) % 3) == 0) {
        ...
        for (int i_19 = 0; i_19 < 8; ++i_19) {
          ...
          *(float2*)(dt_local_v0 + (i_19 * 2)) = __30;
        }
      } else {
        if (((ik + 2) % 3) == 1) {
          #pragma unroll
          ...
          for (int i_21 = 0; i_21 < 8; ++i_21) {
            ...
            *(uint1*)(dt_shared_local_cast_6 + 0) = *(uint1*)(((half_t*)dt_shared) + ((i_21 * 8) + ((((int)threadIdx.x) & 3) * 2)));
            float2 __31;
            uint1 v__22 = *(uint1*)(dt_shared_local_cast_6 + 0);
            ((float2*)(&__31))[0] = __half22float2(((half2*)(&v__22))[0]);
            *(float2*)(dt_local_v2 + (i_21 * 2)) = __31;
          }
        }
      }
      overlap_plan_mbar[11].arrive();
      if (ik == 0) {
        ...
        for (int i_22 = 0; i_22 < 16; ++i_22) {
          ...
          float2 __33;
            float2 __34;
            uint1 v__23 = *(uint1*)(cb_local_v0 + (i_22 * 2));
            ((float2*)(&__34))[0] = __half22float2(((half2*)(&v__23))[0]);
            float2 v__24 = *(float2*)(dt_local_v0 + ((i_22 >> 1) * 2));
            __33.x = (__34.x*v__24.x);
            __33.y = (__34.y*v__24.y);
          ((half2*)(&__32))[0] = __float22half2_rn(((float2*)(&__33))[0]);
          *(uint1*)(cb_local_v0 + (i_22 * 2)) = __32;
        }
      } else {
        #pragma unroll
      ...
      if (ik == 0) {
        ...
        for (int i_24 = 0; i_24 < 32; ++i_24) {
          half_t condval;
          if ((((((ik * 64) + ((i_24 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_24 & 1)) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_24 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
        ...
        for (int i_25 = 0; i_25 < 32; ++i_25) {
          half_t condval_1;
          if ((((((ik * 64) + ((i_25 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_25 & 1)) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_25 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    if ((((int)blockIdx.y) % 3) == 0) {
      ...
      for (int i_29 = 0; i_29 < 16; ++i_29) {
        ...
        float2 __48;
          float2 __49;
          uint1 v__33 = *(uint1*)(cb_local_v0 + (i_29 * 2));
      ...
      if ((((int)blockIdx.y) % 3) == 1) {
        ...
        for (int i_30 = 0; i_30 < 16; ++i_30) {
          ...
          float2 __51;
            float2 __52;
            uint1 v__35 = *(uint1*)(cb_local_v1 + (i_30 * 2));
        ...
        for (int i_31 = 0; i_31 < 16; ++i_31) {
          ...
          float2 __54;
            float2 __55;
            uint1 v__37 = *(uint1*)(cb_local_v2 + (i_31 * 2));
            ((float2*)(&__55))[0] = __half22float2(((half2*)(&v__37))[0]);
            float2 v__38 = *(float2*)(dt_local_v2 + ((i_31 >> 1) * 2));
            __54.x = (__55.x*v__38.x);
            __54.y = (__55.y*v__38.y);
          ((half2*)(&__53))[0] = __float22half2_rn(((float2*)(&__54))[0]);
          *(uint1*)(cb_local_v2 + (i_31 * 2)) = __53;
        }
      }
    }
    if ((((int)blockIdx.y) % 3) == 0) {
      ...
      for (int i_32 = 0; i_32 < 32; ++i_32) {
        half_t condval_2;
        if ((((((((int)blockIdx.y) * 64) + ((i_32 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_32 & 1)) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_32 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
      ...
      if ((((int)blockIdx.y) % 3) == 1) {
        ...
        for (int i_33 = 0; i_33 < 32; ++i_33) {
          half_t condval_3;
          if ((((((((int)blockIdx.y) * 64) + ((i_33 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_33 & 1)) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_33 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
            condval_3 = cb_local_v1[i_33];
          } else {
            condval_3 = half_t(0x0p+0f/*0.000000e+00*/);
          }
          cb_local_v1[i_33] = condval_3;
        }
      } else {
        #pragma unroll
        for (int i_34 = 0; i_34 < 32; ++i_34) {
          half_t condval_4;
          if ((((((((int)blockIdx.y) * 64) + ((i_34 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_34 & 1)) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_34 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
            condval_4 = cb_local_v2[i_34];
          } else {
            condval_4 = half_t(0x0p+0f/*0.000000e+00*/);
          }
          cb_local_v2[i_34] = condval_4;
        }
      }
    }
    ...
    for (int i_35 = 0; i_35 < 16; ++i_35) {
      ...
      *(uint1*)(residual_shared_local_cast_7 + 0) = *(uint1*)(((half_t*)residual_shared) + ((((((((((int)threadIdx.x) >> 5) * 1024) + ((i_35 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_35 >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_35 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_35 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __56;
      uint1 v__39 = *(uint1*)(residual_shared_local_cast_7 + 0);
      ((float2*)(&__56))[0] = __half22float2(((half2*)(&v__39))[0]);
      *(float2*)(residual_local + (i_35 * 2)) = __56;
    }
    #pragma unroll
    for (int i_36 = 0; i_36 < 32; ++i_36) {
      acc[i_36] = (acc[i_36] + (residual_local[i_36] * d_local[0]));
    }
    #pragma unroll
    for (int i_37 = 0; i_37 < 4; ++i_37) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((int)threadIdx.x) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_37 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_37 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc[(i_37 * 8)]), ((half_t)acc[((i_37 * 8) + 1)])), __pack_half2(((half_t)acc[((i_37 * 8) + 2)]), ((half_t)acc[((i_37 * 8) + 3)])), __pack_half2(((half_t)acc[((i_37 * 8) + 4)]), ((half_t)acc[((i_37 * 8) + 5)])), __pack_half2(((half_t)acc[((i_37 * 8) + 6)]), ((half_t)acc[((i_37 * 8) + 7)])));
    }
    tl::fence_proxy_async();
