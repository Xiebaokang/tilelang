  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < (((int)blockIdx.y) - 1); ++ik) {
      ...
      if (((ik + 2) % 3) == 0) {
        ...
        if (((ik + 2) % 3) == 1) {
          ...
          for (int i_16 = 0; i_16 < 4; ++i_16) {
            tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_16 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_16 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(cb_local_v2[(i_16 * 8)])));
          }
        }
      }
      overlap_plan_mbar[8].arrive();
      ...
      if (ik == 0) {
        ...
        for (int i_26 = 0; i_26 < 32; ++i_26) {
          half_t condval_2;
          if (((((((ik * 64) + ((i_26 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_26 & 1)) + 128) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_26 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    if ((((int)blockIdx.y) % 3) == 0) {
      ...
      for (int i_31 = 0; i_31 < 32; ++i_31) {
        half_t condval_3;
        if (((((((((int)blockIdx.y) * 64) + ((i_31 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_31 & 1)) + 64) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_31 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
      ...
      if ((((int)blockIdx.y) % 3) == 1) {
        ...
        for (int i_32 = 0; i_32 < 32; ++i_32) {
          half_t condval_4;
          if (((((((((int)blockIdx.y) * 64) + ((i_32 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_32 & 1)) + 64) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_32 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
        ...
        for (int i_33 = 0; i_33 < 32; ++i_33) {
          half_t condval_5;
          if (((((((((int)blockIdx.y) * 64) + ((i_33 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_33 & 1)) + 64) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_33 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    for (int i_34 = 0; i_34 < 16; ++i_34) {
      ...
      *(uint1*)(residual_shared_local_cast_7 + 0) = *(uint1*)(((half_t*)residual_shared) + (((((((((((int)threadIdx.x) >> 5) * 1024) + ((i_34 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_34 >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_34 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_34 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
      float2 __53;
    ...
    for (int i_36 = 0; i_36 < 4; ++i_36) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_36 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_36 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc[(i_36 * 8)]), ((half_t)acc[((i_36 * 8) + 1)])), __pack_half2(((half_t)acc[((i_36 * 8) + 2)]), ((half_t)acc[((i_36 * 8) + 3)])), __pack_half2(((half_t)acc[((i_36 * 8) + 4)]), ((half_t)acc[((i_36 * 8) + 5)])), __pack_half2(((half_t)acc[((i_36 * 8) + 6)]), ((half_t)acc[((i_36 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 128);
