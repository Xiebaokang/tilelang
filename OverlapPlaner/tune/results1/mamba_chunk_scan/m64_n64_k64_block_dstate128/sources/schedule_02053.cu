  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < ((int)blockIdx.y); ++ik) {
      ...
      if (((ik + 1) % 2) == 0) {
        ...
        for (int i_10 = 0; i_10 < 16; ++i_10) {
          *(uint1*)(cb_local_v0 + (i_10 * 2)) = *(uint1*)(((half_t*)cb_shared) + ((((((((((ik + 1) & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_10 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_10 >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_10 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_10 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        }
      } else {
        #pragma unroll
        for (int i_11 = 0; i_11 < 16; ++i_11) {
          *(uint1*)(cb_local_v1 + (i_11 * 2)) = *(uint1*)(((half_t*)cb_shared) + ((((((((((ik + 1) & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_11 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_11 >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_11 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_11 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        }
      }
      ...
      for (int i_15 = 0; i_15 < 8; ++i_15) {
        ...
        *(uint1*)(dt_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)dt_shared) + (((((ik + 1) & 1) * 64) + (i_15 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __25;
      ...
      if (((ik + 1) % 2) == 0) {
        ...
        for (int i_18 = 0; i_18 < 32; ++i_18) {
          half_t condval_1;
          if (((((((ik * 64) + ((i_18 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_18 & 1)) + 64) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_18 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
        ...
        for (int i_19 = 0; i_19 < 32; ++i_19) {
          half_t condval_2;
          if (((((((ik * 64) + ((i_19 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_19 & 1)) + 64) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_19 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    if ((((int)blockIdx.y) % 2) == 0) {
    ...
    } else {
      {
        ...
        tl::increase_descriptor_offset<int>(desc_b_4, ((((int)blockIdx.y) & 1) * 8192));
        tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(cb_local_v1 + 0), 16);
        tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 32);
        tl::warpgroup_arrive();
        #pragma unroll
    ...
    for (int i_20 = 0; i_20 < 16; ++i_20) {
      ...
      *(uint1*)(residual_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)residual_shared) + ((((((((((int)threadIdx.x) >> 5) * 1024) + ((i_20 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_20 >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_20 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_20 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __32;
    ...
    for (int ik_1 = 0; ik_1 < (((int)blockIdx.y) + 1); ++ik_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[((ik_1 & 1) + 2)].arrive_and_expect_tx(8192);
        tl::tma_load(CB_desc, overlap_plan_mbar[((ik_1 & 1) + 2)], (&(((half_t*)cb_shared)[((ik_1 & 1) * 4096)])), (ik_1 * 64), (((int)blockIdx.y) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      }
      if (2 <= ik_1) {
