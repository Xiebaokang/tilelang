...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int i_4 = 0; i_4 < 16; ++i_4) {
      *(uint1*)(cb_local_v0 + (i_4 * 2)) = *(uint1*)(((half_t*)cb_shared) + ((((((((((int)threadIdx.x) >> 5) * 1024) + ((i_4 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_4 >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_4 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_4 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    }
    ...
    if (0 < ((int)blockIdx.y)) {
      ...
      for (int i_10 = 0; i_10 < 16; ++i_10) {
        *(uint1*)(cb_local_v1 + (i_10 * 2)) = *(uint1*)(((half_t*)cb_shared) + (((((((((((int)threadIdx.x) >> 5) * 1024) + ((i_10 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_10 >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_10 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_10 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 4096));
      }
      ...
      for (int i_11 = 0; i_11 < 8; ++i_11) {
        ...
        *(uint1*)(da_k_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)da_k_shared) + (((i_11 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 64));
        float2 __12;
      ...
      for (int i_12 = 0; i_12 < 8; ++i_12) {
        ...
        *(uint1*)(dt_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)dt_shared) + (((i_12 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 64));
        float2 __13;
    ...
    for (int ik = 0; ik < (((int)blockIdx.y) - 1); ++ik) {
      ...
      overlap_plan_mbar[(ik + 2)].wait(1);
      if (ik == 0) {
        #pragma unroll
        for (int i_16 = 0; i_16 < 16; ++i_16) {
          *(uint1*)(cb_local_v0 + (i_16 * 2)) = *(uint1*)(((half_t*)cb_shared) + ((((((((ik * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_16 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_16 >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_16 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_16 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        }
      } else {
        #pragma unroll
        for (int i_17 = 0; i_17 < 16; ++i_17) {
          *(uint1*)(cb_local_v1 + (i_17 * 2)) = *(uint1*)(((half_t*)cb_shared) + ((((((((ik * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_17 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_17 >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_17 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_17 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        }
      }
      overlap_plan_mbar[(ik + 11)].arrive();
      overlap_plan_mbar[(ik + 4)].wait(1);
      #pragma unroll
      for (int i_18 = 0; i_18 < 8; ++i_18) {
        half_t da_k_shared_local_cast_4[2];
        *(uint1*)(da_k_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)da_k_shared) + (((ik * 64) + (i_18 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __23;
      ...
      overlap_plan_mbar[(ik + 6)].wait(1);
      #pragma unroll
      for (int i_19 = 0; i_19 < 8; ++i_19) {
        half_t dt_shared_local_cast_5[2];
        *(uint1*)(dt_shared_local_cast_5 + 0) = *(uint1*)(((half_t*)dt_shared) + (((ik * 64) + (i_19 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __24;
        uint1 v__17 = *(uint1*)(dt_shared_local_cast_5 + 0);
        ((float2*)(&__24))[0] = __half22float2(((half2*)(&v__17))[0]);
        *(float2*)(dt_local + (i_19 * 2)) = __24;
      }
      ...
      if (ik == 0) {
        ...
        for (int i_20 = 0; i_20 < 16; ++i_20) {
          ...
          float2 __26;
            float2 __27;
            uint1 v__18 = *(uint1*)(cb_local_v0 + (i_20 * 2));
            ((float2*)(&__27))[0] = __half22float2(((half2*)(&v__18))[0]);
            float2 __28;
            float2 __29;
              float2 __30;
                float2 v__19 = make_float2(da_m_local[(i_20 & 1)], da_m_local[(i_20 & 1)]);
                float2 v__20 = *(float2*)(da_k_local + ((i_20 >> 1) * 2));
        ...
        for (int i_21 = 0; i_21 < 16; ++i_21) {
          ...
          float2 __32;
            float2 __33;
            uint1 v__22 = *(uint1*)(cb_local_v1 + (i_21 * 2));
            ((float2*)(&__33))[0] = __half22float2(((half2*)(&v__22))[0]);
            float2 __34;
            float2 __35;
              float2 __36;
                float2 v__23 = make_float2(da_m_local[(i_21 & 1)], da_m_local[(i_21 & 1)]);
                float2 v__24 = *(float2*)(da_k_local + ((i_21 >> 1) * 2));
      ...
      if (ik == 0) {
        ...
        for (int i_24 = 0; i_24 < 32; ++i_24) {
          ...
          if (((((((ik * 64) + ((i_24 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_24 & 1)) + 128) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_24 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
            condval_2 = cb_local_v0[i_24];
          } else {
            condval_2 = half_t(0x0p+0f/*0.000000e+00*/);
          }
          cb_local_v0[i_24] = condval_2;
        }
      } else {
        #pragma unroll
        for (int i_25 = 0; i_25 < 32; ++i_25) {
          half_t condval_3;
          if (((((((ik * 64) + ((i_25 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_25 & 1)) + 128) <= ((((((int)blockIdx.y) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_25 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
            condval_3 = cb_local_v1[i_25];
          } else {
            condval_3 = half_t(0x0p+0f/*0.000000e+00*/);
          }
          cb_local_v1[i_25] = condval_3;
        }
      }
    }
    if (1 <= ((int)blockIdx.y)) {
      overlap_plan_mbar[(((((int)blockIdx.y) + 1) & 1) + 8)].wait((((((int)blockIdx.y) + 3) & 3) >> 1));
      ...
      overlap_plan_mbar[(((((int)blockIdx.y) + 1) & 1) + 17)].arrive();
    }
    overlap_plan_mbar[((((int)blockIdx.y) & 1) + 8)].wait((((int)blockIdx.y) >> 1));
    ...
    overlap_plan_mbar[((((int)blockIdx.y) & 1) + 17)].arrive();
    ...
    for (int i_26 = 0; i_26 < 16; ++i_26) {
      ...
      *(uint1*)(residual_shared_local_cast_6 + 0) = *(uint1*)(((half_t*)residual_shared) + ((((((((((int)threadIdx.x) >> 5) * 1024) + ((i_26 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_26 >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_26 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_26 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __43;
      uint1 v__30 = *(uint1*)(residual_shared_local_cast_6 + 0);
      ((float2*)(&__43))[0] = __half22float2(((half2*)(&v__30))[0]);
      *(float2*)(residual_local + (i_26 * 2)) = __43;
    }
    #pragma unroll
    for (int i_27 = 0; i_27 < 32; ++i_27) {
      acc[i_27] = (acc[i_27] + (residual_local[i_27] * d_local[0]));
    }
    tl::__sync_thread_partial(3, 128);
    #pragma unroll
    for (int i_28 = 0; i_28 < 4; ++i_28) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((int)threadIdx.x) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_28 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_28 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc[(i_28 * 8)]), ((half_t)acc[((i_28 * 8) + 1)])), __pack_half2(((half_t)acc[((i_28 * 8) + 2)]), ((half_t)acc[((i_28 * 8) + 3)])), __pack_half2(((half_t)acc[((i_28 * 8) + 4)]), ((half_t)acc[((i_28 * 8) + 5)])), __pack_half2(((half_t)acc[((i_28 * 8) + 6)]), ((half_t)acc[((i_28 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 128);
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      ...
      tl::tma_load((&(((half_t*)dt_shared)[0])), (&(Dt[((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256))])), overlap_plan_mbar[6], 128);
    }
    for (int ik_1 = 0; ik_1 < ((int)blockIdx.y); ++ik_1) {
      if (1 <= ik_1) {
        overlap_plan_mbar[(ik_1 + 10)].wait(0);
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[(((ik_1 + 1) & 1) + 2)].arrive_and_expect_tx(8192);
        tl::tma_load(CB_desc, overlap_plan_mbar[(((ik_1 + 1) & 1) + 2)], (&(((half_t*)cb_shared)[(((ik_1 + 1) & 1) * 4096)])), ((ik_1 * 64) + 64), (((int)blockIdx.y) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      }
      if (1 <= ik_1) {
        overlap_plan_mbar[(ik_1 + 12)].wait(0);
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[(((ik_1 + 1) & 1) + 4)].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)da_k_shared)[(((ik_1 + 1) & 1) * 64)])), (&(DA[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik_1 * 64)) + 64)])), overlap_plan_mbar[(((ik_1 + 1) & 1) + 4)], 128);
      }
      if (1 <= ik_1) {
        overlap_plan_mbar[(ik_1 + 14)].wait(0);
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[(((ik_1 + 1) & 1) + 6)].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)dt_shared)[(((ik_1 + 1) & 1) * 64)])), (&(Dt[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik_1 * 64)) + 64)])), overlap_plan_mbar[(((ik_1 + 1) & 1) + 6)], 128);
      }
      if (ik_1 == 2) {
        overlap_plan_mbar[((ik_1 & 1) + 17)].wait(0);
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[((ik_1 & 1) + 8)].arrive_and_expect_tx(8192);
        tl::tma_load(X_desc, overlap_plan_mbar[((ik_1 & 1) + 8)], (&(((half_t*)x_shared)[((ik_1 & 1) * 4096)])), 0, (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
    }
    if (2 <= ((int)blockIdx.y)) {
      overlap_plan_mbar[((((int)blockIdx.y) & 1) + 17)].wait(0);
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      overlap_plan_mbar[((((int)blockIdx.y) & 1) + 8)].arrive_and_expect_tx(8192);
      tl::tma_load(X_desc, overlap_plan_mbar[((((int)blockIdx.y) & 1) + 8)], (&(((half_t*)x_shared)[((((int)blockIdx.y) & 1) * 4096)])), 0, (((((int)blockIdx.z) >> 3) * 256) + (((int)blockIdx.y) * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
  }
}
