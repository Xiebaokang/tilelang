...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  for (int ik = 0; ik < ((int)blockIdx.y); ++ik) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[2].arrive_and_expect_tx(8192);
      tl::tma_load(CB_desc, overlap_plan_mbar[2], (&(((half_t*)cb_shared)[0])), ((ik * 64) + 64), (((int)blockIdx.y) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
    }
    ...
    if (((ik + 1) % 2) == 0) {
      ...
      for (int i_14 = 0; i_14 < 16; ++i_14) {
        ...
        float2 __15;
          float2 __16;
          uint1 v__10 = *(uint1*)(cb_local_v0 + (i_14 * 2));
          ((float2*)(&__16))[0] = __half22float2(((half2*)(&v__10))[0]);
          float2 __17;
          float2 __18;
            float2 __19;
              float2 v__11 = make_float2(da_m_local[(i_14 & 1)], da_m_local[(i_14 & 1)]);
              float2 v__12 = *(float2*)(da_k_local + ((i_14 >> 1) * 2));
      ...
      for (int i_15 = 0; i_15 < 16; ++i_15) {
        ...
        float2 __21;
          ...
          float2 __24;
            float2 __25;
              float2 v__15 = make_float2(da_m_local[(i_15 & 1)], da_m_local[(i_15 & 1)]);
              float2 v__16 = *(float2*)(da_k_local + ((i_15 >> 1) * 2));
