...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc, __grid_constant__ const CUtensorMap X_desc_1) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < (((((int)blockIdx.y) >> 1) * 2) + 1); ++ik) {
      ...
      if (((ik + 1) % 2) == 0) {
        ...
        for (int i_19 = 0; i_19 < 64; ++i_19) {
          half_t condval_1;
          if ((((((((ik * 64) + ((i_19 >> 4) * 16)) + (((i_19 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_19 & 1)) + 64) <= ((((((((int)blockIdx.y) >> 1) * 128) + (((i_19 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_19 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
        ...
        for (int i_20 = 0; i_20 < 64; ++i_20) {
          half_t condval_2;
          if ((((((((ik * 64) + ((i_20 >> 4) * 16)) + (((i_20 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_20 & 1)) + 64) <= ((((((((int)blockIdx.y) >> 1) * 128) + (((i_20 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_20 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
      ...
      if ((ik % 2) == 0) {
        {
          ...
          for (int i_21 = 0; i_21 < 2; ++i_21) {
            ...
            for (int ki_1 = 0; ki_1 < 4; ++ki_1) {
              tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v0 + ((ki_1 * 16) + (i_21 * 8))), uint64_t(desc_b_1 + ((ki_1 * 1024) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_21 * 16)), 1);
            }
          }
          tl::warpgroup_commit_batch();
          tl::warpgroup_wait<0>();
      ...
      } else {
        {
          ...
          for (int i_22 = 0; i_22 < 2; ++i_22) {
            ...
            for (int ki_2 = 0; ki_2 < 4; ++ki_2) {
              tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v1 + ((ki_2 * 16) + (i_22 * 8))), uint64_t(desc_b_2 + ((ki_2 * 1024) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_22 * 16)), 1);
            }
          }
          tl::warpgroup_commit_batch();
          tl::warpgroup_wait<0>();
    ...
    overlap_plan_mbar[9].wait((((int)blockIdx.y) >> 1));
    {
      ...
      for (int i_23 = 0; i_23 < 2; ++i_23) {
        ...
        for (int ki_3 = 0; ki_3 < 4; ++ki_3) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v1 + ((ki_3 * 16) + (i_23 * 8))), uint64_t(desc_b_3 + ((ki_3 * 1024) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_23 * 16)), 1);
        }
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
    ...
    for (int i_24 = 0; i_24 < 16; ++i_24) {
      ...
      *(uint1*)(residual_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)residual_shared) + ((((((((i_24 >> 3) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((i_24 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_24 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_24 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __32;
    ...
    for (int i_26 = 0; i_26 < 4; ++i_26) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((i_26 >> 1) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + (i_26 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(((half_t)acc[(i_26 * 8)]), ((half_t)acc[((i_26 * 8) + 1)])), __pack_half2(((half_t)acc[((i_26 * 8) + 2)]), ((half_t)acc[((i_26 * 8) + 3)])), __pack_half2(((half_t)acc[((i_26 * 8) + 4)]), ((half_t)acc[((i_26 * 8) + 5)])), __pack_half2(((half_t)acc[((i_26 * 8) + 6)]), ((half_t)acc[((i_26 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 128);
    ...
    for (int ik_1 = 0; ik_1 < (((((int)blockIdx.y) >> 1) * 2) + 2); ++ik_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        ...
        tl::tma_load(CB_desc, overlap_plan_mbar[((ik_1 & 1) + 2)], (&(((half_t*)cb_shared)[((ik_1 & 1) * 8192)])), (ik_1 * 64), ((((int)blockIdx.y) >> 1) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      }
      if (2 <= ik_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        ...
        tl::tma_load(X_desc_1, overlap_plan_mbar[((ik_1 & 1) + 8)], (&(((half_t*)x_shared)[((ik_1 & 1) * 2048)])), ((((int)blockIdx.y) & 1) * 32), (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
    }
  }
}
