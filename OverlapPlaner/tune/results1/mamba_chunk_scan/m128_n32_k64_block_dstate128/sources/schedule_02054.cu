...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc, __grid_constant__ const CUtensorMap X_desc_1) {
  ...
  void* scale_m_wsp_handoff_1 = ((void*)((char*)buf_dyn_shmem + 40960));
  void* da_m_shared = ((void*)((char*)buf_dyn_shmem + 41984));
  void* cb_shared = ((void*)((char*)buf_dyn_shmem + 43008));
  void* cb_local_wsp_handoff_6 = ((void*)((char*)buf_dyn_shmem + 75776));
  void* x_shared = ((void*)((char*)buf_dyn_shmem + 92160));
  void* da_k_shared = ((void*)((char*)buf_dyn_shmem + 96256));
  void* dt_shared = ((void*)((char*)buf_dyn_shmem + 97280));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(C_desc, overlap_plan_mbar[2], (&(((half_t*)c_shared)[0])), 0, (((((int)blockIdx.z) >> 3) * 256) + ((((int)blockIdx.y) >> 1) * 128)), 0, (((int)blockIdx.z) & 7));
      tl::tma_load(C_desc, overlap_plan_mbar[2], (&(((half_t*)c_shared)[8192])), 64, (((((int)blockIdx.z) >> 3) * 256) + ((((int)blockIdx.y) >> 1) * 128)), 0, (((int)blockIdx.z) & 7));
      overlap_plan_mbar[3].arrive_and_expect_tx(8192);
      tl::tma_load(Prev_desc, overlap_plan_mbar[3], (&(((half_t*)prev_shared)[0])), 0, ((((int)blockIdx.y) & 1) * 32), ((int)blockIdx.x), (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      tl::tma_load(Prev_desc, overlap_plan_mbar[3], (&(((half_t*)prev_shared)[2048])), 64, ((((int)blockIdx.y) & 1) * 32), ((int)blockIdx.x), (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
    }
    ...
    overlap_plan_mbar[3].wait(0);
    {
      ...
      for (int i_1 = 0; i_1 < 2; ++i_1) {
        ...
        for (int ki = 0; ki < 8; ++ki) {
          tl::wgmma_ss<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, false, 1, 1>(uint64_t(desc_a + (((((ki >> 2) * 16384) + (i_1 * 8192)) + ((ki & 3) * 32)) >> 4)), uint64_t(desc_b + ((((ki >> 2) * 4096) + ((ki & 3) * 32)) >> 4)), ((uint32_t*)(acc + (i_1 * 16))), 1);
        }
      }
    ...
    for (int ik = 0; ik < (((((int)blockIdx.y) >> 1) * 2) + 2); ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((ik & 1) + 4)].arrive_and_expect_tx(16384);
        tl::tma_load(CB_desc, overlap_plan_mbar[((ik & 1) + 4)], (&(((half_t*)cb_shared)[((ik & 1) * 8192)])), (ik * 64), ((((int)blockIdx.y) >> 1) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      }
      if (2 <= ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(X_desc, overlap_plan_mbar[10], (&(((half_t*)x_shared)[0])), ((((int)blockIdx.y) & 1) * 32), (((((int)blockIdx.z) >> 3) * 256) + (ik * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
      ...
      for (int i_7 = 0; i_7 < 64; ++i_7) {
        half_t condval;
        if (((((((ik * 64) + ((i_7 >> 4) * 16)) + (((i_7 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_7 & 1)) <= ((((((((int)blockIdx.y) >> 1) * 128) + (((i_7 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_7 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
      ...
      overlap_plan_mbar[10].wait((ik & 1));
      {
        ...
        for (int i_8 = 0; i_8 < 2; ++i_8) {
          ...
          for (int ki_1 = 0; ki_1 < 4; ++ki_1) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local + ((ki_1 * 16) + (i_8 * 8))), uint64_t(desc_b_1 + ((ki_1 * 1024) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_8 * 16)), 1);
          }
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
    ...
    for (int i_9 = 0; i_9 < 16; ++i_9) {
      ...
      *(uint1*)(residual_shared_local_cast_1 + 0) = *(uint1*)(((half_t*)residual_shared) + ((((((((i_9 >> 3) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((i_9 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_9 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_9 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __5;
      uint1 v__3 = *(uint1*)(residual_shared_local_cast_1 + 0);
      ((float2*)(&__5))[0] = __half22float2(((half2*)(&v__3))[0]);
      *(float2*)(residual_local + (i_9 * 2)) = __5;
    }
    #pragma unroll
    for (int i_10 = 0; i_10 < 32; ++i_10) {
      acc[i_10] = (acc[i_10] + (residual_local[i_10] * d_local[0]));
    }
    tl::__sync_thread_partial(3, 128);
    #pragma unroll
    for (int i_11 = 0; i_11 < 4; ++i_11) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((i_11 >> 1) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + (i_11 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(((half_t)acc[(i_11 * 8)]), ((half_t)acc[((i_11 * 8) + 1)])), __pack_half2(((half_t)acc[((i_11 * 8) + 2)]), ((half_t)acc[((i_11 * 8) + 3)])), __pack_half2(((half_t)acc[((i_11 * 8) + 4)]), ((half_t)acc[((i_11 * 8) + 5)])), __pack_half2(((half_t)acc[((i_11 * 8) + 6)]), ((half_t)acc[((i_11 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 128);
    ...
    for (int i_12 = 0; i_12 < 4; ++i_12) {
      da_m_local[i_12] = ((float)((half_t*)da_m_shared)[((((((i_12 >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + ((i_12 & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) - 64)]);
    }
    #pragma unroll
    for (int i_13 = 0; i_13 < 4; ++i_13) {
      scale_m[i_13] = exp2f((da_m_local[i_13] * 0x1.7154764ee6c2fp+0f/*1.442695e+00*/));
    }
    if ((((int)threadIdx.x) % 4) == 0) {
      #pragma unroll
      for (int i_14 = 0; i_14 < 4; ++i_14) {
        ((float*)scale_m_wsp_handoff_1)[((((((i_14 >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + ((i_14 & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) - 64)] = scale_m[i_14];
      }
    }
    tl::fence_proxy_async();
    ...
    for (int ik_1 = 0; ik_1 < (((((int)blockIdx.y) >> 1) * 2) + 2); ++ik_1) {
      ...
      for (int i_15 = 0; i_15 < 32; ++i_15) {
        *(uint1*)(cb_local + (i_15 * 2)) = *(uint1*)(((half_t*)cb_shared) + (((((((((((ik_1 & 1) * 8192) + (((i_15 & 7) >> 2) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_15 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((i_15 >> 3) * 16) + (((i_15 & 3) >> 1) * 8)) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_15 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_15 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 4096));
      }
      ...
      for (int i_16 = 0; i_16 < 8; ++i_16) {
        ...
        *(uint1*)(da_k_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)da_k_shared) + ((((ik_1 & 1) * 64) + (i_16 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __6;
        uint1 v__4 = *(uint1*)(da_k_shared_local_cast_2 + 0);
        ((float2*)(&__6))[0] = __half22float2(((half2*)(&v__4))[0]);
        *(float2*)(da_k_local + (i_16 * 2)) = __6;
      }
      ...
      for (int i_17 = 0; i_17 < 32; ++i_17) {
        ...
        float2 __8;
          ...
          float2 __11;
            float2 __12;
              float2 v__6 = make_float2(da_m_local[((((i_17 & 7) >> 2) * 2) + (i_17 & 1))], da_m_local[((((i_17 & 7) >> 2) * 2) + (i_17 & 1))]);
              float2 v__7 = *(float2*)(da_k_local + (((i_17 >> 3) * 4) + (((i_17 & 3) >> 1) * 2)));
