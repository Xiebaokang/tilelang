  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < (((((int)blockIdx.y) >> 1) * 2) + 2); ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::fence_proxy_async();
        tl::tma_load(CB_desc, overlap_plan_mbar[2], (&(((half_t*)cb_shared)[0])), (ik * 64), ((((int)blockIdx.y) >> 1) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      }
      if (1 <= ik) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::fence_proxy_async();
        tl::tma_load((&(((half_t*)da_k_shared)[0])), (&(DA[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 64))])), overlap_plan_mbar[3], 128);
      }
      if (ik == 3) {
        overlap_plan_mbar[((ik % 3) + 17)].wait(0);
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        overlap_plan_mbar[((ik % 3) + 5)].arrive_and_expect_tx(128);
        tl::fence_proxy_async();
        tl::tma_load((&(((half_t*)dt_shared)[((ik % 3) * 64)])), (&(Dt[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 64))])), overlap_plan_mbar[((ik % 3) + 5)], 128);
      }
      overlap_plan_mbar[2].wait((ik & 1));
      #pragma unroll
      for (int i_5 = 0; i_5 < 8; ++i_5) {
        tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[(((((i_5 & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((i_5 >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((i_5 & 3) >> 1) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(cb_local[(i_5 * 8)])));
      }
      ...
      for (int i_7 = 0; i_7 < 32; ++i_7) {
        ...
        float2 __3;
          float2 __4;
          uint1 v__1 = *(uint1*)(cb_local + (i_7 * 2));
        ...
        *(uint1*)(cb_local + (i_7 * 2)) = __2;
      }
      #pragma unroll
      for (int i_8 = 0; i_8 < 8; ++i_8) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)cb_local_wsp_handoff_4)[((((((i_8 & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((((int)threadIdx.x) & 15) * 64)) + ((i_8 >> 1) * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(cb_local[(i_8 * 8)], cb_local[((i_8 * 8) + 1)]), __pack_half2(cb_local[((i_8 * 8) + 2)], cb_local[((i_8 * 8) + 3)]), __pack_half2(cb_local[((i_8 * 8) + 4)], cb_local[((i_8 * 8) + 5)]), __pack_half2(cb_local[((i_8 * 8) + 6)], cb_local[((i_8 * 8) + 7)]));
      }
      tl::fence_proxy_async();
      overlap_plan_mbar[4].arrive();
      overlap_plan_mbar[8].wait((ik & 1));
      overlap_plan_mbar[((ik % 3) + 9)].wait((ik / 3));
      #pragma unroll
      for (int i_9 = 0; i_9 < 8; ++i_9) {
        tl::ptx_ldmatrix_x4((&(((half_t*)cb_local_wsp_handoff_6)[((((((i_9 & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((((int)threadIdx.x) & 15) * 64)) + ((i_9 >> 1) * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), (&(cb_local[(i_9 * 8)])));
      }
      {
        tl::GmmaDescriptor desc_b_1;
        tl::initialize_wgmma_descriptor<2, 0, 32>(desc_b_1, (&(((half_t*)x_shared)[0])));
        tl::increase_descriptor_offset<int>(desc_b_1, ((ik % 3) * 4096));
        ...
        for (int i_10 = 0; i_10 < 2; ++i_10) {
          ...
          for (int ki_1 = 0; ki_1 < 4; ++ki_1) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local + ((ki_1 * 16) + (i_10 * 8))), uint64_t(desc_b_1 + ((ki_1 * 1024) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_10 * 16)), 1);
          }
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
      ...
      if (ik == (((((int)blockIdx.y) >> 1) * 2) + 1)) {
        tl::__sync_thread_partial(3, 128);
        #pragma unroll
        for (int i_11 = 0; i_11 < 16; ++i_11) {
          *(float2*)(((float*)acc_wsp_handoff_8) + (((((((i_11 >> 3) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((i_11 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + (((i_11 & 7) >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(float2*)(acc + (i_11 * 2));
        }
      }
    ...
    for (int ik_1 = 0; ik_1 < (((((int)blockIdx.y) >> 1) * 2) + 2); ++ik_1) {
      if (ik_1 == 3) {
        overlap_plan_mbar[((ik_1 % 3) + 20)].wait(0);
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[((ik_1 % 3) + 9)].arrive_and_expect_tx(4096);
        tl::tma_load(X_desc, overlap_plan_mbar[((ik_1 % 3) + 9)], (&(((half_t*)x_shared)[((ik_1 % 3) * 2048)])), ((((int)blockIdx.y) & 1) * 32), (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
      overlap_plan_mbar[((ik_1 % 3) + 5)].wait((ik_1 / 3));
      #pragma unroll
      for (int i_12 = 0; i_12 < 8; ++i_12) {
        half_t dt_shared_local_cast_1[2];
        *(uint1*)(dt_shared_local_cast_1 + 0) = *(uint1*)(((half_t*)dt_shared) + ((((ik_1 % 3) * 64) + (i_12 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __8;
        uint1 v__5 = *(uint1*)(dt_shared_local_cast_1 + 0);
        ((float2*)(&__8))[0] = __half22float2(((half2*)(&v__5))[0]);
        *(float2*)(dt_local + (i_12 * 2)) = __8;
      }
      overlap_plan_mbar[((ik_1 % 3) + 17)].arrive();
      overlap_plan_mbar[4].wait((ik_1 & 1));
      #pragma unroll
      for (int i_13 = 0; i_13 < 8; ++i_13) {
        tl::ptx_ldmatrix_x4((&(((half_t*)cb_local_wsp_handoff_4)[(((((((i_13 & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((((int)threadIdx.x) & 15) * 64)) + ((i_13 >> 1) * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 4096)])), (&(cb_local[(i_13 * 8)])));
      }
      #pragma unroll
      for (int i_14 = 0; i_14 < 32; ++i_14) {
        ...
        float2 __10;
          float2 __11;
          uint1 v__6 = *(uint1*)(cb_local + (i_14 * 2));
          ((float2*)(&__11))[0] = __half22float2(((half2*)(&v__6))[0]);
          float2 v__7 = *(float2*)(dt_local + (((i_14 >> 3) * 4) + (((i_14 & 3) >> 1) * 2)));
          __10.x = (__11.x*v__7.x);
          __10.y = (__11.y*v__7.y);
        ((half2*)(&__9))[0] = __float22half2_rn(((float2*)(&__10))[0]);
        *(uint1*)(cb_local + (i_14 * 2)) = __9;
      }
      #pragma unroll
      for (int i_15 = 0; i_15 < 64; ++i_15) {
        half_t condval;
        if ((((((((ik_1 * 64) + ((i_15 >> 4) * 16)) + (((i_15 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_15 & 1)) + 64) <= ((((((((int)blockIdx.y) >> 1) * 128) + (((i_15 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_15 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
          condval = cb_local[i_15];
        } else {
          condval = half_t(0x0p+0f/*0.000000e+00*/);
        }
        cb_local[i_15] = condval;
      }
      tl::__sync_thread_partial(4, 128);
      #pragma unroll
      for (int i_16 = 0; i_16 < 8; ++i_16) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)cb_local_wsp_handoff_6)[(((((((i_16 & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((((int)threadIdx.x) & 15) * 64)) + ((i_16 >> 1) * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 4096)])), __pack_half2(cb_local[(i_16 * 8)], cb_local[((i_16 * 8) + 1)]), __pack_half2(cb_local[((i_16 * 8) + 2)], cb_local[((i_16 * 8) + 3)]), __pack_half2(cb_local[((i_16 * 8) + 4)], cb_local[((i_16 * 8) + 5)]), __pack_half2(cb_local[((i_16 * 8) + 6)], cb_local[((i_16 * 8) + 7)]));
      }
      tl::fence_proxy_async();
    ...
    for (int i_17 = 0; i_17 < 16; ++i_17) {
      ...
      *(uint1*)(residual_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)residual_shared) + (((((((((i_17 >> 3) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((i_17 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_17 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_17 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 2048));
      float2 __12;
      uint1 v__8 = *(uint1*)(residual_shared_local_cast_2 + 0);
      ((float2*)(&__12))[0] = __half22float2(((half2*)(&v__8))[0]);
      *(float2*)(residual_local + (i_17 * 2)) = __12;
    }
    overlap_plan_mbar[12].wait(0);
    #pragma unroll
    for (int i_18 = 0; i_18 < 16; ++i_18) {
      *(float2*)(acc + (i_18 * 2)) = *(float2*)(((float*)acc_wsp_handoff_8) + ((((((((i_18 >> 3) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((i_18 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + (((i_18 & 7) >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 2048));
    }
    #pragma unroll
    ...
    for (int i_20 = 0; i_20 < 4; ++i_20) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((((i_20 >> 1) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + (i_20 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8)) - 2048)])), __pack_half2(((half_t)acc[(i_20 * 8)]), ((half_t)acc[((i_20 * 8) + 1)])), __pack_half2(((half_t)acc[((i_20 * 8) + 2)]), ((half_t)acc[((i_20 * 8) + 3)])), __pack_half2(((half_t)acc[((i_20 * 8) + 4)]), ((half_t)acc[((i_20 * 8) + 5)])), __pack_half2(((half_t)acc[((i_20 * 8) + 6)]), ((half_t)acc[((i_20 * 8) + 7)])));
    }
    tl::fence_proxy_async();
