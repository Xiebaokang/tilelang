...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc, __grid_constant__ const CUtensorMap X_desc_1) {
  ...
  void* dt_shared = ((void*)((char*)buf_dyn_shmem + 81920));
  ...
  for (int i_7 = 0; i_7 < 8; ++i_7) {
    tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[(((((i_7 & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((i_7 >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((i_7 & 3) >> 1) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(cb_local_v1[(i_7 * 8)])));
  }
  overlap_plan_mbar[9].arrive();
  ...
  for (int i_8 = 0; i_8 < 8; ++i_8) {
    ...
    *(float2*)(da_k_local_v1 + (i_8 * 2)) = __2;
  }
  overlap_plan_mbar[10].arrive();
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
  ...
  for (int ik = 0; ik < (((int)blockIdx.y) * 2); ++ik) {
    ...
    if (((ik + 2) % 3) == 0) {
      ...
      for (int i_10 = 0; i_10 < 8; ++i_10) {
        tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[(((((i_10 & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((i_10 >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((i_10 & 3) >> 1) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(cb_local_v0[(i_10 * 8)])));
      }
    } else {
      if (((ik + 2) % 3) == 1) {
        #pragma unroll
        ...
        for (int i_12 = 0; i_12 < 8; ++i_12) {
          tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[(((((i_12 & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((i_12 >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((i_12 & 3) >> 1) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(cb_local_v2[(i_12 * 8)])));
        }
      }
    }
    overlap_plan_mbar[9].arrive();
    ...
    if (((ik + 2) % 3) == 0) {
      ...
      for (int i_13 = 0; i_13 < 8; ++i_13) {
        ...
        *(uint1*)(da_k_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)da_k_shared) + ((i_13 * 8) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __4;
        uint1 v__3 = *(uint1*)(da_k_shared_local_cast_3 + 0);
        ((float2*)(&__4))[0] = __half22float2(((half2*)(&v__3))[0]);
        *(float2*)(da_k_local_v0 + (i_13 * 2)) = __4;
      }
    } else {
      if (((ik + 2) % 3) == 1) {
        #pragma unroll
        for (int i_14 = 0; i_14 < 16; ++i_14) {
          da_k_local_v1[i_14] = ((float)((half_t*)da_k_shared)[((((i_14 >> 1) * 8) + ((((int)threadIdx.x) & 3) * 2)) + (i_14 & 1))]);
        }
      } else {
        #pragma unroll
        for (int i_15 = 0; i_15 < 8; ++i_15) {
          half_t da_k_shared_local_cast_4[2];
          *(uint1*)(da_k_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)da_k_shared) + ((i_15 * 8) + ((((int)threadIdx.x) & 3) * 2)));
          float2 __5;
          uint1 v__4 = *(uint1*)(da_k_shared_local_cast_4 + 0);
          ((float2*)(&__5))[0] = __half22float2(((half2*)(&v__4))[0]);
          *(float2*)(da_k_local_v2 + (i_15 * 2)) = __5;
        }
      }
    }
    overlap_plan_mbar[10].arrive();
    if (ik == 0) {
      ...
      for (int i_16 = 0; i_16 < 32; ++i_16) {
        ...
        float2 __7;
          float2 __8;
          uint1 v__5 = *(uint1*)(cb_local_v0 + (i_16 * 2));
          ...
          float2 __10;
            float2 __11;
              ...
              float2 v__7 = *(float2*)(da_k_local_v0 + (((i_16 >> 3) * 4) + (((i_16 & 3) >> 1) * 2)));
      ...
      for (int i_17 = 0; i_17 < 32; ++i_17) {
        ...
        float2 __13;
          float2 __14;
          uint1 v__9 = *(uint1*)(cb_local_v1 + (i_17 * 2));
          ((float2*)(&__14))[0] = __half22float2(((half2*)(&v__9))[0]);
          float2 __15;
          float2 __16;
            float2 __17;
              float2 v__10 = make_float2(da_m_local[((((i_17 & 7) >> 2) * 2) + (i_17 & 1))], da_m_local[((((i_17 & 7) >> 2) * 2) + (i_17 & 1))]);
              float2 v__11 = *(float2*)(da_k_local_v1 + (((i_17 >> 3) * 4) + (((i_17 & 3) >> 1) * 2)));
              __17.x = (v__10.x-v__11.x);
              __17.y = (v__10.y-v__11.y);
            float2 v__12 = make_float2(broadcast_var_2, broadcast_var_2);
            __16.x = (__17.x*v__12.x);
            __16.y = (__17.y*v__12.y);
          __15.x = exp2f(__16.x);
          __15.y = exp2f(__16.y);
          __13.x = (__14.x*__15.x);
          __13.y = (__14.y*__15.y);
        ((half2*)(&__12))[0] = __float22half2_rn(((float2*)(&__13))[0]);
        *(uint1*)(cb_local_v1 + (i_17 * 2)) = __12;
      }
    }
    ...
    if (((ik + 1) % 2) == 0) {
      ...
      for (int i_18 = 0; i_18 < 8; ++i_18) {
        ...
        *(uint1*)(dt_shared_local_cast_5 + 0) = *(uint1*)(((half_t*)dt_shared) + (((((ik + 1) & 1) * 64) + (i_18 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __18;
        uint1 v__13 = *(uint1*)(dt_shared_local_cast_5 + 0);
        ((float2*)(&__18))[0] = __half22float2(((half2*)(&v__13))[0]);
        *(float2*)(dt_local_v0 + (i_18 * 2)) = __18;
      }
    } else {
      #pragma unroll
      for (int i_19 = 0; i_19 < 8; ++i_19) {
        half_t dt_shared_local_cast_6[2];
        *(uint1*)(dt_shared_local_cast_6 + 0) = *(uint1*)(((half_t*)dt_shared) + (((((ik + 1) & 1) * 64) + (i_19 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __19;
        uint1 v__14 = *(uint1*)(dt_shared_local_cast_6 + 0);
        ((float2*)(&__19))[0] = __half22float2(((half2*)(&v__14))[0]);
        *(float2*)(dt_local_v1 + (i_19 * 2)) = __19;
      }
    }
    ...
    if (ik == 0) {
      ...
      for (int i_20 = 0; i_20 < 32; ++i_20) {
        ...
        float2 __21;
          float2 __22;
          uint1 v__15 = *(uint1*)(cb_local_v0 + (i_20 * 2));
          ((float2*)(&__22))[0] = __half22float2(((half2*)(&v__15))[0]);
          float2 v__16 = *(float2*)(dt_local_v0 + (((i_20 >> 3) * 4) + (((i_20 & 3) >> 1) * 2)));
          __21.x = (__22.x*v__16.x);
          __21.y = (__22.y*v__16.y);
        ((half2*)(&__20))[0] = __float22half2_rn(((float2*)(&__21))[0]);
        *(uint1*)(cb_local_v0 + (i_20 * 2)) = __20;
      }
    } else {
      #pragma unroll
      for (int i_21 = 0; i_21 < 32; ++i_21) {
        ...
        float2 __24;
          float2 __25;
          uint1 v__17 = *(uint1*)(cb_local_v1 + (i_21 * 2));
          ((float2*)(&__25))[0] = __half22float2(((half2*)(&v__17))[0]);
          float2 v__18 = *(float2*)(dt_local_v1 + (((i_21 >> 3) * 4) + (((i_21 & 3) >> 1) * 2)));
          __24.x = (__25.x*v__18.x);
          __24.y = (__25.y*v__18.y);
        ((half2*)(&__23))[0] = __float22half2_rn(((float2*)(&__24))[0]);
        *(uint1*)(cb_local_v1 + (i_21 * 2)) = __23;
      }
    }
    if (ik == 0) {
      #pragma unroll
      for (int i_22 = 0; i_22 < 64; ++i_22) {
        half_t condval;
        if (((((((ik * 64) + ((i_22 >> 4) * 16)) + (((i_22 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_22 & 1)) <= (((((((int)blockIdx.y) * 128) + (((i_22 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_22 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
      ...
      for (int i_23 = 0; i_23 < 64; ++i_23) {
        half_t condval_1;
        if (((((((ik * 64) + ((i_23 >> 4) * 16)) + (((i_23 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_23 & 1)) <= (((((((int)blockIdx.y) * 128) + (((i_23 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_23 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[(((ik + 1) & 1) + 6)].arrive_and_expect_tx(8192);
      tl::tma_load(X_desc, overlap_plan_mbar[(((ik + 1) & 1) + 6)], (&(((half_t*)x_shared)[(((ik + 1) & 1) * 4096)])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 64), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
    ...
    if (ik == 0) {
      {
        ...
        for (int i_24 = 0; i_24 < 2; ++i_24) {
          ...
          for (int ki_1 = 0; ki_1 < 4; ++ki_1) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v0 + ((ki_1 * 16) + (i_24 * 8))), uint64_t(desc_b_1 + ((ki_1 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_24 * 32)), 1);
          }
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
    ...
    } else {
      {
        ...
        for (int i_25 = 0; i_25 < 2; ++i_25) {
          ...
          for (int ki_2 = 0; ki_2 < 4; ++ki_2) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v1 + ((ki_2 * 16) + (i_25 * 8))), uint64_t(desc_b_2 + ((ki_2 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_25 * 32)), 1);
          }
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
  ...
  if (((int)blockIdx.y) == 0) {
    ...
    for (int i_26 = 0; i_26 < 32; ++i_26) {
      ...
      float2 __27;
        float2 __28;
        uint1 v__19 = *(uint1*)(cb_local_v0 + (i_26 * 2));
        ((float2*)(&__28))[0] = __half22float2(((half2*)(&v__19))[0]);
        float2 __29;
        float2 __30;
          float2 __31;
            float2 v__20 = make_float2(da_m_local[((((i_26 & 7) >> 2) * 2) + (i_26 & 1))], da_m_local[((((i_26 & 7) >> 2) * 2) + (i_26 & 1))]);
            float2 v__21 = *(float2*)(da_k_local_v0 + (((i_26 >> 3) * 4) + (((i_26 & 3) >> 1) * 2)));
    ...
    for (int i_27 = 0; i_27 < 32; ++i_27) {
      ...
      float2 __33;
        float2 __34;
        uint1 v__23 = *(uint1*)(cb_local_v2 + (i_27 * 2));
        ((float2*)(&__34))[0] = __half22float2(((half2*)(&v__23))[0]);
        float2 __35;
        float2 __36;
          float2 __37;
            float2 v__24 = make_float2(da_m_local[((((i_27 & 7) >> 2) * 2) + (i_27 & 1))], da_m_local[((((i_27 & 7) >> 2) * 2) + (i_27 & 1))]);
            float2 v__25 = *(float2*)(da_k_local_v2 + (((i_27 >> 3) * 4) + (((i_27 & 3) >> 1) * 2)));
  ...
  for (int i_28 = 0; i_28 < 8; ++i_28) {
    half_t dt_shared_local_cast_8[2];
    *(uint1*)(dt_shared_local_cast_8 + 0) = *(uint1*)(((half_t*)dt_shared) + (((i_28 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 64));
    float2 __38;
    uint1 v__27 = *(uint1*)(dt_shared_local_cast_8 + 0);
    ((float2*)(&__38))[0] = __half22float2(((half2*)(&v__27))[0]);
    *(float2*)(dt_local_v1 + (i_28 * 2)) = __38;
  }
  ...
  if (((int)blockIdx.y) == 0) {
    ...
    for (int i_31 = 0; i_31 < 64; ++i_31) {
      half_t condval_2;
      if (((((((((int)blockIdx.y) * 128) + ((i_31 >> 4) * 16)) + (((i_31 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_31 & 1)) <= (((((((int)blockIdx.y) * 128) + (((i_31 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_31 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
        condval_2 = cb_local_v0[i_31];
      } else {
        condval_2 = half_t(0x0p+0f/*0.000000e+00*/);
      }
      cb_local_v0[i_31] = condval_2;
    }
  } else {
    #pragma unroll
    for (int i_32 = 0; i_32 < 64; ++i_32) {
      ...
      if (((((((((int)blockIdx.y) * 128) + ((i_32 >> 4) * 16)) + (((i_32 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_32 & 1)) <= (((((((int)blockIdx.y) * 128) + (((i_32 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_32 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
        condval_3 = cb_local_v2[i_32];
      } else {
        condval_3 = half_t(0x0p+0f/*0.000000e+00*/);
      }
      cb_local_v2[i_32] = condval_3;
    }
  }
  if (((int)blockIdx.y) == 1) {
    overlap_plan_mbar[14].wait(((((int)blockIdx.y) + 1) & 1));
  }
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    overlap_plan_mbar[7].arrive_and_expect_tx(8192);
    tl::tma_load(X_desc, overlap_plan_mbar[7], (&(((half_t*)x_shared)[4096])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (((int)blockIdx.y) * 128)) + 64), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
  }
  ...
  if (((int)blockIdx.y) == 0) {
    {
      ...
      for (int i_33 = 0; i_33 < 2; ++i_33) {
        ...
        for (int ki_3 = 0; ki_3 < 4; ++ki_3) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v0 + ((ki_3 * 16) + (i_33 * 8))), uint64_t(desc_b_3 + ((ki_3 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_33 * 32)), 1);
        }
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
  ...
  } else {
    {
      ...
      for (int i_34 = 0; i_34 < 2; ++i_34) {
        ...
        for (int ki_4 = 0; ki_4 < 4; ++ki_4) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v2 + ((ki_4 * 16) + (i_34 * 8))), uint64_t(desc_b_4 + ((ki_4 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_34 * 32)), 1);
        }
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
  ...
  if ((((((int)blockIdx.y) * 2) + 1) % 3) == 0) {
    ...
    for (int i_35 = 0; i_35 < 32; ++i_35) {
      ...
      float2 __46;
        float2 __47;
        uint1 v__32 = *(uint1*)(cb_local_v0 + (i_35 * 2));
        ((float2*)(&__47))[0] = __half22float2(((half2*)(&v__32))[0]);
        float2 __48;
        float2 __49;
          float2 __50;
            float2 v__33 = make_float2(da_m_local[((((i_35 & 7) >> 2) * 2) + (i_35 & 1))], da_m_local[((((i_35 & 7) >> 2) * 2) + (i_35 & 1))]);
            float2 v__34 = *(float2*)(da_k_local_v0 + (((i_35 >> 3) * 4) + (((i_35 & 3) >> 1) * 2)));
    ...
    for (int i_36 = 0; i_36 < 32; ++i_36) {
      ...
      float2 __52;
        float2 __53;
        uint1 v__36 = *(uint1*)(cb_local_v1 + (i_36 * 2));
        ((float2*)(&__53))[0] = __half22float2(((half2*)(&v__36))[0]);
        float2 __54;
        float2 __55;
          float2 __56;
            float2 v__37 = make_float2(da_m_local[((((i_36 & 7) >> 2) * 2) + (i_36 & 1))], da_m_local[((((i_36 & 7) >> 2) * 2) + (i_36 & 1))]);
            float2 v__38 = *(float2*)(da_k_local_v1 + (((i_36 >> 3) * 4) + (((i_36 & 3) >> 1) * 2)));
  ...
  if ((((((int)blockIdx.y) * 2) + 1) % 3) == 0) {
    ...
    for (int i_39 = 0; i_39 < 64; ++i_39) {
      half_t condval_4;
      if ((((((((((int)blockIdx.y) * 128) + ((i_39 >> 4) * 16)) + (((i_39 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_39 & 1)) + 64) <= (((((((int)blockIdx.y) * 128) + (((i_39 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_39 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
        condval_4 = cb_local_v0[i_39];
      } else {
        condval_4 = half_t(0x0p+0f/*0.000000e+00*/);
      }
      cb_local_v0[i_39] = condval_4;
    }
  } else {
    #pragma unroll
    for (int i_40 = 0; i_40 < 64; ++i_40) {
      ...
      if ((((((((((int)blockIdx.y) * 128) + ((i_40 >> 4) * 16)) + (((i_40 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_40 & 1)) + 64) <= (((((((int)blockIdx.y) * 128) + (((i_40 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_40 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
        condval_5 = cb_local_v1[i_40];
      } else {
        condval_5 = half_t(0x0p+0f/*0.000000e+00*/);
      }
      cb_local_v1[i_40] = condval_5;
    }
  }
  overlap_plan_mbar[7].wait(((int)blockIdx.y));
  if ((((((int)blockIdx.y) * 2) + 1) % 3) == 0) {
    {
      ...
      for (int i_41 = 0; i_41 < 2; ++i_41) {
        ...
        for (int ki_5 = 0; ki_5 < 4; ++ki_5) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v0 + ((ki_5 * 16) + (i_41 * 8))), uint64_t(desc_b_5 + ((ki_5 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_41 * 32)), 1);
        }
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
  ...
  } else {
    {
      ...
      for (int i_42 = 0; i_42 < 2; ++i_42) {
        ...
        for (int ki_6 = 0; ki_6 < 4; ++ki_6) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v1 + ((ki_6 * 16) + (i_42 * 8))), uint64_t(desc_b_6 + ((ki_6 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_42 * 32)), 1);
        }
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
  ...
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    ...
    tl::tma_load(X_desc_1, overlap_plan_mbar[8], (&(((half_t*)residual_shared)[0])), 0, (((((int)blockIdx.z) >> 3) * 256) + (((int)blockIdx.y) * 128)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
  }
  overlap_plan_mbar[8].wait(0);
  #pragma unroll
  for (int i_43 = 0; i_43 < 32; ++i_43) {
    half_t residual_shared_local_cast_9[2];
    *(uint1*)(residual_shared_local_cast_9 + 0) = *(uint1*)(((half_t*)residual_shared) + (((((((((i_43 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_43 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_43 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_43 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_43 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    float2 __63;
    uint1 v__44 = *(uint1*)(residual_shared_local_cast_9 + 0);
    ((float2*)(&__63))[0] = __half22float2(((half2*)(&v__44))[0]);
    *(float2*)(residual_local + (i_43 * 2)) = __63;
  }
  #pragma unroll
  for (int i_44 = 0; i_44 < 64; ++i_44) {
    acc[i_44] = (acc[i_44] + (residual_local[i_44] * d_local[0]));
  }
  __syncthreads();
  #pragma unroll
  for (int i_45 = 0; i_45 < 8; ++i_45) {
    tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((i_45 >> 2) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_45 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_45 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc[(i_45 * 8)]), ((half_t)acc[((i_45 * 8) + 1)])), __pack_half2(((half_t)acc[((i_45 * 8) + 2)]), ((half_t)acc[((i_45 * 8) + 3)])), __pack_half2(((half_t)acc[((i_45 * 8) + 4)]), ((half_t)acc[((i_45 * 8) + 5)])), __pack_half2(((half_t)acc[((i_45 * 8) + 6)]), ((half_t)acc[((i_45 * 8) + 7)])));
  }
