...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc, __grid_constant__ const CUtensorMap X_desc_1) {
  ...
  void* cb_shared = ((void*)((char*)buf_dyn_shmem + 73728));
    ...
    if (ik == 0) {
      {
        ...
        for (int i_28 = 0; i_28 < 2; ++i_28) {
          ...
          for (int ki_1 = 0; ki_1 < 4; ++ki_1) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v0 + ((ki_1 * 16) + (i_28 * 8))), uint64_t(desc_b_1 + ((ki_1 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_28 * 32)), 1);
          }
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
    ...
    } else {
      {
        ...
        for (int i_29 = 0; i_29 < 2; ++i_29) {
          ...
          for (int ki_2 = 0; ki_2 < 4; ++ki_2) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v1 + ((ki_2 * 16) + (i_29 * 8))), uint64_t(desc_b_2 + ((ki_2 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_29 * 32)), 1);
          }
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
  ...
  if ((((((int)blockIdx.y) * 2) + 1) % 3) == 0) {
    ...
    for (int i_32 = 0; i_32 < 64; ++i_32) {
      half_t condval_3;
      if ((((((((((int)blockIdx.y) * 128) + ((i_32 >> 4) * 16)) + (((i_32 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_32 & 1)) + 64) <= (((((((int)blockIdx.y) * 128) + (((i_32 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_32 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    for (int i_33 = 0; i_33 < 64; ++i_33) {
      half_t condval_4;
      if ((((((((((int)blockIdx.y) * 128) + ((i_33 >> 4) * 16)) + (((i_33 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_33 & 1)) + 64) <= (((((((int)blockIdx.y) * 128) + (((i_33 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_33 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
  ...
  if (((int)blockIdx.y) == 0) {
  ...
  } else {
    {
      ...
      tl::increase_descriptor_offset<int>(desc_b_4, (((int)blockIdx.y) * 16384));
  ...
  if ((((((int)blockIdx.y) * 2) + 1) % 3) == 0) {
    {
      ...
      tl::increase_descriptor_offset<int>(desc_b_5, ((((((int)blockIdx.y) * 2) + 1) % 3) * 8192));
      tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(cb_local_v0 + 0), 32);
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 64);
      tl::warpgroup_arrive();
      #pragma unroll
      for (int i_36 = 0; i_36 < 2; ++i_36) {
        ...
        for (int ki_5 = 0; ki_5 < 4; ++ki_5) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v0 + ((ki_5 * 16) + (i_36 * 8))), uint64_t(desc_b_5 + ((ki_5 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_36 * 32)), 1);
        }
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
  ...
  } else {
    {
      ...
      tl::increase_descriptor_offset<int>(desc_b_6, ((((((int)blockIdx.y) * 2) + 1) % 3) * 8192));
      tl::warpgroup_fence_operand(reinterpret_cast<uint32_t*>(cb_local_v1 + 0), 32);
      tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc + 0), 64);
      tl::warpgroup_arrive();
      #pragma unroll
      for (int i_37 = 0; i_37 < 2; ++i_37) {
        ...
        for (int ki_6 = 0; ki_6 < 4; ++ki_6) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v1 + ((ki_6 * 16) + (i_37 * 8))), uint64_t(desc_b_6 + ((ki_6 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_37 * 32)), 1);
        }
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
  ...
  for (int i_38 = 0; i_38 < 32; ++i_38) {
    ...
    *(uint1*)(residual_shared_local_cast_7 + 0) = *(uint1*)(((half_t*)residual_shared) + (((((((((i_38 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_38 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_38 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_38 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_38 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    float2 __47;
  ...
  for (int i_40 = 0; i_40 < 8; ++i_40) {
    tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((i_40 >> 2) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_40 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_40 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc[(i_40 * 8)]), ((half_t)acc[((i_40 * 8) + 1)])), __pack_half2(((half_t)acc[((i_40 * 8) + 2)]), ((half_t)acc[((i_40 * 8) + 3)])), __pack_half2(((half_t)acc[((i_40 * 8) + 4)]), ((half_t)acc[((i_40 * 8) + 5)])), __pack_half2(((half_t)acc[((i_40 * 8) + 6)]), ((half_t)acc[((i_40 * 8) + 7)])));
  }
