...
extern "C" __global__ void main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, __grid_constant__ const CUtensorMap DA_desc, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Dt_desc, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc, __grid_constant__ const CUtensorMap X_desc_1);
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, __grid_constant__ const CUtensorMap DA_desc, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Dt_desc, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc, __grid_constant__ const CUtensorMap X_desc_1) {
  ...
  void* da_m_shared = ((void*)((char*)buf_dyn_shmem + 49152));
  ...
  void* acc_shared = ((void*)((char*)buf_dyn_shmem + 101376));
  void* residual_shared = ((void*)((char*)buf_dyn_shmem + 117760));
  ...
  if (tl::tl_shuffle_elect<0>()) {
    ...
    tl::prefetch_tma_descriptor(DA_desc);
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int i_5 = 0; i_5 < 32; ++i_5) {
      *(uint1*)(cb_local + (i_5 * 2)) = *(uint1*)(((half_t*)cb_shared) + ((((((((((i_5 & 7) >> 2) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_5 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((i_5 >> 3) * 16) + (((i_5 & 3) >> 1) * 8)) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_5 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_5 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    }
    ...
    for (int ik = 0; ik < ((((int)blockIdx.y) * 2) + 1); ++ik) {
      ...
      for (int i_10 = 0; i_10 < 64; ++i_10) {
        half_t condval;
        if (((((((ik * 64) + ((i_10 >> 4) * 16)) + (((i_10 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_10 & 1)) <= (((((((int)blockIdx.y) * 128) + (((i_10 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_10 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
      ...
      overlap_plan_mbar[((ik & 1) + 9)].wait((ik >> 1));
      {
        ...
        for (int i_11 = 0; i_11 < 2; ++i_11) {
          ...
          for (int ki_1 = 0; ki_1 < 4; ++ki_1) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local + ((ki_1 * 16) + (i_11 * 8))), uint64_t(desc_b_1 + ((ki_1 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_11 * 32)), 1);
          }
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
      ...
      overlap_plan_mbar[((ik & 1) + 19)].arrive();
      overlap_plan_mbar[(((ik + 1) & 1) + 3)].wait(((ik + 1) >> 1));
      #pragma unroll
      for (int i_12 = 0; i_12 < 32; ++i_12) {
        *(uint1*)(cb_local + (i_12 * 2)) = *(uint1*)(((half_t*)cb_shared) + (((((((((((ik + 1) & 1) * 8192) + (((i_12 & 7) >> 2) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_12 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((i_12 >> 3) * 16) + (((i_12 & 3) >> 1) * 8)) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_12 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_12 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      }
      ...
      for (int i_13 = 0; i_13 < 8; ++i_13) {
        ...
        *(uint1*)(da_k_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)da_k_shared) + (((((ik + 1) & 1) * 64) + (i_13 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __12;
        uint1 v__8 = *(uint1*)(da_k_shared_local_cast_2 + 0);
        ((float2*)(&__12))[0] = __half22float2(((half2*)(&v__8))[0]);
        *(float2*)(da_k_local + (i_13 * 2)) = __12;
      }
      overlap_plan_mbar[(((ik + 1) & 1) + 15)].arrive();
      overlap_plan_mbar[(((ik + 1) & 1) + 7)].wait(((ik + 1) >> 1));
      #pragma unroll
      for (int i_14 = 0; i_14 < 8; ++i_14) {
        half_t dt_shared_local_cast_3[2];
        *(uint1*)(dt_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)dt_shared) + (((((ik + 1) & 1) * 64) + (i_14 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __13;
        uint1 v__9 = *(uint1*)(dt_shared_local_cast_3 + 0);
        ((float2*)(&__13))[0] = __half22float2(((half2*)(&v__9))[0]);
        *(float2*)(dt_local + (i_14 * 2)) = __13;
      }
      overlap_plan_mbar[(((ik + 1) & 1) + 17)].arrive();
    }
    #pragma unroll
    for (int i_15 = 0; i_15 < 32; ++i_15) {
      ...
      float2 __15;
        float2 __16;
        uint1 v__10 = *(uint1*)(cb_local + (i_15 * 2));
        ((float2*)(&__16))[0] = __half22float2(((half2*)(&v__10))[0]);
        float2 __17;
        float2 __18;
          float2 __19;
            float2 v__11 = make_float2(da_m_local[((((i_15 & 7) >> 2) * 2) + (i_15 & 1))], da_m_local[((((i_15 & 7) >> 2) * 2) + (i_15 & 1))]);
            float2 v__12 = *(float2*)(da_k_local + (((i_15 >> 3) * 4) + (((i_15 & 3) >> 1) * 2)));
    ...
    for (int i_16 = 0; i_16 < 32; ++i_16) {
      ...
      float2 __21;
        float2 __22;
        uint1 v__14 = *(uint1*)(cb_local + (i_16 * 2));
        ((float2*)(&__22))[0] = __half22float2(((half2*)(&v__14))[0]);
        float2 v__15 = *(float2*)(dt_local + (((i_16 >> 3) * 4) + (((i_16 & 3) >> 1) * 2)));
        __21.x = (__22.x*v__15.x);
        __21.y = (__22.y*v__15.y);
      ((half2*)(&__20))[0] = __float22half2_rn(((float2*)(&__21))[0]);
      *(uint1*)(cb_local + (i_16 * 2)) = __20;
    }
    #pragma unroll
    for (int i_17 = 0; i_17 < 64; ++i_17) {
      half_t condval_1;
      if ((((((((((int)blockIdx.y) * 128) + ((i_17 >> 4) * 16)) + (((i_17 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_17 & 1)) + 64) <= (((((((int)blockIdx.y) * 128) + (((i_17 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_17 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
        condval_1 = cb_local[i_17];
      } else {
        condval_1 = half_t(0x0p+0f/*0.000000e+00*/);
      }
      cb_local[i_17] = condval_1;
    }
    overlap_plan_mbar[10].wait(((int)blockIdx.y));
    {
      ...
      for (int i_18 = 0; i_18 < 2; ++i_18) {
        ...
        for (int ki_2 = 0; ki_2 < 4; ++ki_2) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local + ((ki_2 * 16) + (i_18 * 8))), uint64_t(desc_b_2 + ((ki_2 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_18 * 32)), 1);
        }
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
    ...
    for (int i_19 = 0; i_19 < 32; ++i_19) {
      ...
      *(uint1*)(residual_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)residual_shared) + (((((((((i_19 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_19 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_19 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_19 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_19 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __23;
      uint1 v__16 = *(uint1*)(residual_shared_local_cast_4 + 0);
      ((float2*)(&__23))[0] = __half22float2(((half2*)(&v__16))[0]);
      *(float2*)(residual_local + (i_19 * 2)) = __23;
    }
    #pragma unroll
    for (int i_20 = 0; i_20 < 64; ++i_20) {
      acc[i_20] = (acc[i_20] + (residual_local[i_20] * d_local[0]));
    }
    #pragma unroll
    for (int i_21 = 0; i_21 < 8; ++i_21) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((i_21 >> 2) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_21 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_21 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc[(i_21 * 8)]), ((half_t)acc[((i_21 * 8) + 1)])), __pack_half2(((half_t)acc[((i_21 * 8) + 2)]), ((half_t)acc[((i_21 * 8) + 3)])), __pack_half2(((half_t)acc[((i_21 * 8) + 4)]), ((half_t)acc[((i_21 * 8) + 5)])), __pack_half2(((half_t)acc[((i_21 * 8) + 6)]), ((half_t)acc[((i_21 * 8) + 7)])));
    }
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      ...
      tl::tma_load(C_desc, overlap_plan_mbar[1], (&(((half_t*)c_shared)[0])), 0, (((((int)blockIdx.z) >> 3) * 256) + (((int)blockIdx.y) * 128)), 0, (((int)blockIdx.z) & 7));
      tl::tma_load(C_desc, overlap_plan_mbar[1], (&(((half_t*)c_shared)[8192])), 64, (((((int)blockIdx.z) >> 3) * 256) + (((int)blockIdx.y) * 128)), 0, (((int)blockIdx.z) & 7));
      ...
      tl::tma_load(CB_desc, overlap_plan_mbar[3], (&(((half_t*)cb_shared)[0])), 0, (((int)blockIdx.y) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      overlap_plan_mbar[4].arrive_and_expect_tx(16384);
      tl::tma_load(CB_desc, overlap_plan_mbar[4], (&(((half_t*)cb_shared)[8192])), 64, (((int)blockIdx.y) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      overlap_plan_mbar[5].arrive_and_expect_tx(128);
      tl::tma_load((&(((half_t*)da_k_shared)[0])), (&(DA[((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256))])), overlap_plan_mbar[5], 128);
      overlap_plan_mbar[7].arrive_and_expect_tx(128);
      tl::tma_load((&(((half_t*)dt_shared)[0])), (&(Dt[((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256))])), overlap_plan_mbar[7], 128);
    }
    for (int ik_1 = 0; ik_1 < (((int)blockIdx.y) * 2); ++ik_1) {
      overlap_plan_mbar[(ik_1 + 13)].wait(0);
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[(ik_1 + 3)].arrive_and_expect_tx(16384);
        tl::tma_load(CB_desc, overlap_plan_mbar[(ik_1 + 3)], (&(((half_t*)cb_shared)[(ik_1 * 8192)])), ((ik_1 * 64) + 128), (((int)blockIdx.y) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      }
      if (ik_1 == 1) {
        overlap_plan_mbar[(ik_1 + 14)].wait(0);
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[(((ik_1 + 1) & 1) + 5)].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)da_k_shared)[(((ik_1 + 1) & 1) * 64)])), (&(DA[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik_1 * 64)) + 64)])), overlap_plan_mbar[(((ik_1 + 1) & 1) + 5)], 128);
      }
      if (ik_1 == 1) {
        overlap_plan_mbar[(ik_1 + 16)].wait(0);
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[(((ik_1 + 1) & 1) + 7)].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)dt_shared)[(((ik_1 + 1) & 1) * 64)])), (&(Dt[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik_1 * 64)) + 64)])), overlap_plan_mbar[(((ik_1 + 1) & 1) + 7)], 128);
        overlap_plan_mbar[(ik_1 + 9)].arrive_and_expect_tx(8192);
        tl::tma_load(X_desc, overlap_plan_mbar[(ik_1 + 9)], (&(((half_t*)x_shared)[(ik_1 * 4096)])), 0, (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
    }
    if (((int)blockIdx.y) == 1) {
      overlap_plan_mbar[16].wait(((((int)blockIdx.y) + 1) & 1));
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      overlap_plan_mbar[6].arrive_and_expect_tx(128);
      tl::tma_load(DA_desc, overlap_plan_mbar[6], (&(((half_t*)da_k_shared)[64])), ((((int)blockIdx.y) * 128) + 64), (((int)blockIdx.z) >> 3), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
    if (((int)blockIdx.y) == 1) {
      overlap_plan_mbar[18].wait(((((int)blockIdx.y) + 1) & 1));
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      overlap_plan_mbar[8].arrive_and_expect_tx(128);
      tl::tma_load(Dt_desc, overlap_plan_mbar[8], (&(((half_t*)dt_shared)[64])), ((((int)blockIdx.y) * 128) + 64), (((int)blockIdx.z) >> 3), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
    if (((int)blockIdx.y) == 1) {
      overlap_plan_mbar[19].wait((((int)blockIdx.y) - 1));
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      overlap_plan_mbar[9].arrive_and_expect_tx(8192);
      tl::tma_load(X_desc, overlap_plan_mbar[9], (&(((half_t*)x_shared)[0])), 0, (((((int)blockIdx.z) >> 3) * 256) + (((int)blockIdx.y) * 128)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
    if (((int)blockIdx.y) == 1) {
      overlap_plan_mbar[20].wait((((int)blockIdx.y) - 1));
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      overlap_plan_mbar[10].arrive_and_expect_tx(8192);
      tl::tma_load(X_desc, overlap_plan_mbar[10], (&(((half_t*)x_shared)[4096])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (((int)blockIdx.y) * 128)) + 64), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      overlap_plan_mbar[11].arrive_and_expect_tx(16384);
      tl::tma_load(X_desc_1, overlap_plan_mbar[11], (&(((half_t*)residual_shared)[0])), 0, (((((int)blockIdx.z) >> 3) * 256) + (((int)blockIdx.y) * 128)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
