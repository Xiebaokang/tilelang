...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc, __grid_constant__ const CUtensorMap X_desc_1) {
  ...
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    ...
    tl::tma_load(X_desc, overlap_plan_mbar[8], (&(((half_t*)x_shared)[0])), 0, ((((int)blockIdx.z) >> 3) * 256), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
  }
  ...
  for (int ik = 0; ik < ((((int)blockIdx.y) * 2) + 1); ++ik) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[(((ik + 1) & 1) + 3)].arrive_and_expect_tx(16384);
      tl::tma_load(CB_desc, overlap_plan_mbar[(((ik + 1) & 1) + 3)], (&(((half_t*)cb_shared)[(((ik + 1) & 1) * 8192)])), ((ik * 64) + 64), (((int)blockIdx.y) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
    }
    if (1 <= ik) {
      overlap_plan_mbar[(ik + 12)].wait(0);
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[(((ik + 1) & 1) + 5)].arrive_and_expect_tx(128);
      tl::tma_load((&(((half_t*)da_k_shared)[(((ik + 1) & 1) * 64)])), (&(DA[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 64)) + 64)])), overlap_plan_mbar[(((ik + 1) & 1) + 5)], 128);
    }
    overlap_plan_mbar[15].wait((ik & 1));
    __syncthreads();
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[7].arrive_and_expect_tx(128);
      tl::tma_load((&(((half_t*)dt_shared)[0])), (&(Dt[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (ik * 64)) + 64)])), overlap_plan_mbar[7], 128);
    }
    if (1 <= ik) {
      overlap_plan_mbar[(ik + 15)].wait(0);
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[(((ik + 1) & 1) + 8)].arrive_and_expect_tx(8192);
      tl::tma_load(X_desc, overlap_plan_mbar[(((ik + 1) & 1) + 8)], (&(((half_t*)x_shared)[(((ik + 1) & 1) * 4096)])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik * 64)) + 64), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
    ...
    overlap_plan_mbar[((ik & 1) + 11)].arrive();
    ...
    overlap_plan_mbar[((ik & 1) + 13)].arrive();
    #pragma unroll
    ...
    overlap_plan_mbar[((ik & 1) + 8)].wait((ik >> 1));
    {
    ...
    for (int i_12 = 0; i_12 < 8; ++i_12) {
      ...
      *(uint1*)(dt_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)dt_shared) + ((i_12 * 8) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __12;
      uint1 v__8 = *(uint1*)(dt_shared_local_cast_2 + 0);
      ((float2*)(&__12))[0] = __half22float2(((half2*)(&v__8))[0]);
      *(float2*)(dt_local + (i_12 * 2)) = __12;
    }
    overlap_plan_mbar[15].arrive();
  }
  overlap_plan_mbar[4].wait(((int)blockIdx.y));
  #pragma unroll
  for (int i_13 = 0; i_13 < 32; ++i_13) {
    *(uint1*)(cb_local + (i_13 * 2)) = *(uint1*)(((half_t*)cb_shared) + (((((((((((i_13 & 7) >> 2) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_13 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((i_13 >> 3) * 16) + (((i_13 & 3) >> 1) * 8)) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_13 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_13 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 8192));
  }
  ...
  for (int i_14 = 0; i_14 < 8; ++i_14) {
    ...
    *(uint1*)(da_k_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)da_k_shared) + (((i_14 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 64));
    float2 __13;
    uint1 v__9 = *(uint1*)(da_k_shared_local_cast_3 + 0);
    ((float2*)(&__13))[0] = __half22float2(((half2*)(&v__9))[0]);
    *(float2*)(da_k_local + (i_14 * 2)) = __13;
  }
  ...
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    ...
    tl::tma_load(X_desc_1, overlap_plan_mbar[10], (&(((half_t*)residual_shared)[0])), 0, (((((int)blockIdx.z) >> 3) * 256) + (((int)blockIdx.y) * 128)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
  }
