...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc, __grid_constant__ const CUtensorMap X_desc_1) {
  ...
  void* acc_shared = ((void*)((char*)buf_dyn_shmem + 83968));
  void* residual_shared = ((void*)((char*)buf_dyn_shmem + 100352));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int i_10 = 0; i_10 < 64; ++i_10) {
      half_t condval;
      if (((((((i_10 >> 4) * 16) + (((i_10 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_10 & 1)) <= (((((((int)blockIdx.y) * 128) + (((i_10 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_10 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    for (int i_13 = 0; i_13 < 32; ++i_13) {
      ...
      float2 __14;
        float2 __15;
        uint1 v__9 = *(uint1*)(cb_local_v1 + (i_13 * 2));
        ((float2*)(&__15))[0] = __half22float2(((half2*)(&v__9))[0]);
        float2 __16;
        float2 __17;
          float2 __18;
            float2 v__10 = make_float2(da_m_local[((((i_13 & 7) >> 2) * 2) + (i_13 & 1))], da_m_local[((((i_13 & 7) >> 2) * 2) + (i_13 & 1))]);
            float2 v__11 = *(float2*)(da_k_local + (((i_13 >> 3) * 4) + (((i_13 & 3) >> 1) * 2)));
    ...
    for (int i_14 = 0; i_14 < 8; ++i_14) {
      ...
      *(uint1*)(dt_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)dt_shared) + ((i_14 * 8) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __19;
      uint1 v__13 = *(uint1*)(dt_shared_local_cast_3 + 0);
      ((float2*)(&__19))[0] = __half22float2(((half2*)(&v__13))[0]);
      *(float2*)(dt_local + (i_14 * 2)) = __19;
    }
    overlap_plan_mbar[11].arrive();
    #pragma unroll
    ...
    for (int i_16 = 0; i_16 < 64; ++i_16) {
      half_t condval_1;
      if ((((((((i_16 >> 4) * 16) + (((i_16 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_16 & 1)) + 64) <= (((((((int)blockIdx.y) * 128) + (((i_16 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_16 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    for (int ik = 0; ik < (((int)blockIdx.y) * 2); ++ik) {
      ...
      if (((ik + 2) % 3) == 0) {
        ...
        for (int i_17 = 0; i_17 < 8; ++i_17) {
          tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[(((((i_17 & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((i_17 >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((i_17 & 3) >> 1) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(cb_local_v0[(i_17 * 8)])));
        }
      } else {
        if (((ik + 2) % 3) == 1) {
          #pragma unroll
          for (int i_18 = 0; i_18 < 8; ++i_18) {
            tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[(((((i_18 & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((i_18 >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((i_18 & 3) >> 1) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(cb_local_v1[(i_18 * 8)])));
          }
        } else {
          #pragma unroll
          for (int i_19 = 0; i_19 < 8; ++i_19) {
            tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[(((((i_19 & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((i_19 >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((i_19 & 3) >> 1) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(cb_local_v2[(i_19 * 8)])));
          }
        }
      }
      overlap_plan_mbar[9].arrive();
      ...
      if (((ik + 2) % 3) == 0) {
        ...
        for (int i_21 = 0; i_21 < 32; ++i_21) {
          ...
          float2 __25;
            float2 __26;
            uint1 v__17 = *(uint1*)(cb_local_v0 + (i_21 * 2));
            ((float2*)(&__26))[0] = __half22float2(((half2*)(&v__17))[0]);
            float2 __27;
            float2 __28;
              float2 __29;
                float2 v__18 = make_float2(da_m_local[((((i_21 & 7) >> 2) * 2) + (i_21 & 1))], da_m_local[((((i_21 & 7) >> 2) * 2) + (i_21 & 1))]);
                float2 v__19 = *(float2*)(da_k_local + (((i_21 >> 3) * 4) + (((i_21 & 3) >> 1) * 2)));
          ...
          *(uint1*)(cb_local_v0 + (i_21 * 2)) = __24;
        }
      } else {
        if (((ik + 2) % 3) == 1) {
          #pragma unroll
          for (int i_22 = 0; i_22 < 64; ++i_22) {
            cb_local_v1[i_22] = ((half_t)(((float)cb_local_v1[i_22]) * exp2f(((da_m_local[((((i_22 & 15) >> 3) * 2) + ((i_22 & 3) >> 1))] - da_k_local[((((i_22 >> 4) * 4) + (((i_22 & 7) >> 2) * 2)) + (i_22 & 1))]) * 0x1.7154764ee6c2fp+0f/*1.442695e+00*/))));
          }
        } else {
          #pragma unroll
          for (int i_23 = 0; i_23 < 32; ++i_23) {
            ...
            float2 __31;
              float2 __32;
              uint1 v__21 = *(uint1*)(cb_local_v2 + (i_23 * 2));
              ((float2*)(&__32))[0] = __half22float2(((half2*)(&v__21))[0]);
              float2 __33;
              float2 __34;
                float2 __35;
                  float2 v__22 = make_float2(da_m_local[((((i_23 & 7) >> 2) * 2) + (i_23 & 1))], da_m_local[((((i_23 & 7) >> 2) * 2) + (i_23 & 1))]);
                  float2 v__23 = *(float2*)(da_k_local + (((i_23 >> 3) * 4) + (((i_23 & 3) >> 1) * 2)));
      ...
      for (int i_24 = 0; i_24 < 8; ++i_24) {
        ...
        *(uint1*)(dt_shared_local_cast_5 + 0) = *(uint1*)(((half_t*)dt_shared) + ((i_24 * 8) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __36;
        uint1 v__25 = *(uint1*)(dt_shared_local_cast_5 + 0);
        ((float2*)(&__36))[0] = __half22float2(((half2*)(&v__25))[0]);
        *(float2*)(dt_local + (i_24 * 2)) = __36;
      }
      overlap_plan_mbar[11].arrive();
      if (((ik + 2) % 3) == 0) {
        #pragma unroll
        ...
        if (((ik + 2) % 3) == 1) {
          ...
          for (int i_26 = 0; i_26 < 64; ++i_26) {
            cb_local_v1[i_26] = ((half_t)(((float)cb_local_v1[i_26]) * dt_local[((((i_26 >> 4) * 4) + (((i_26 & 7) >> 2) * 2)) + (i_26 & 1))]));
          }
        } else {
          #pragma unroll
      ...
      if (((ik + 2) % 3) == 0) {
        ...
        for (int i_28 = 0; i_28 < 64; ++i_28) {
          half_t condval_2;
          if ((((((((ik * 64) + ((i_28 >> 4) * 16)) + (((i_28 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_28 & 1)) + 128) <= (((((((int)blockIdx.y) * 128) + (((i_28 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_28 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
            condval_2 = cb_local_v0[i_28];
          } else {
            condval_2 = half_t(0x0p+0f/*0.000000e+00*/);
          }
          cb_local_v0[i_28] = condval_2;
        }
      } else {
        if (((ik + 2) % 3) == 1) {
          #pragma unroll
          for (int i_29 = 0; i_29 < 64; ++i_29) {
            half_t condval_3;
            if ((((int)blockIdx.y) == 1)) {
              condval_3 = cb_local_v1[i_29];
            } else {
              condval_3 = half_t(0x0p+0f/*0.000000e+00*/);
            }
            cb_local_v1[i_29] = condval_3;
          }
        } else {
          #pragma unroll
          for (int i_30 = 0; i_30 < 64; ++i_30) {
            half_t condval_4;
            if ((((((((ik * 64) + ((i_30 >> 4) * 16)) + (((i_30 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_30 & 1)) + 128) <= (((((((int)blockIdx.y) * 128) + (((i_30 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_30 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
              condval_4 = cb_local_v2[i_30];
            } else {
              condval_4 = half_t(0x0p+0f/*0.000000e+00*/);
            }
            cb_local_v2[i_30] = condval_4;
          }
        }
      }
      if (ik == 1) {
      ...
      if (ik == 0) {
        {
          ...
          for (int i_31 = 0; i_31 < 2; ++i_31) {
            ...
            for (int ki_1 = 0; ki_1 < 4; ++ki_1) {
              tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v0 + ((ki_1 * 16) + (i_31 * 8))), uint64_t(desc_b_1 + ((ki_1 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_31 * 32)), 1);
            }
          }
          tl::warpgroup_commit_batch();
          tl::warpgroup_wait<0>();
      ...
      } else {
        {
          ...
          for (int i_32 = 0; i_32 < 2; ++i_32) {
            ...
            for (int ki_2 = 0; ki_2 < 4; ++ki_2) {
              tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v1 + ((ki_2 * 16) + (i_32 * 8))), uint64_t(desc_b_2 + ((ki_2 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_32 * 32)), 1);
            }
          }
          tl::warpgroup_commit_batch();
          tl::warpgroup_wait<0>();
    ...
    if (((int)blockIdx.y) == 1) {
      overlap_plan_mbar[13].wait(((((int)blockIdx.y) + 1) & 1));
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    ...
    if ((((((int)blockIdx.y) * 2) + 1) % 3) == 0) {
      {
        ...
        for (int i_35 = 0; i_35 < 2; ++i_35) {
          ...
          for (int ki_5 = 0; ki_5 < 4; ++ki_5) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v0 + ((ki_5 * 16) + (i_35 * 8))), uint64_t(desc_b_5 + ((ki_5 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_35 * 32)), 1);
          }
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
    ...
    } else {
      {
        ...
        for (int i_36 = 0; i_36 < 2; ++i_36) {
          ...
          for (int ki_6 = 0; ki_6 < 4; ++ki_6) {
            tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v1 + ((ki_6 * 16) + (i_36 * 8))), uint64_t(desc_b_6 + ((ki_6 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_36 * 32)), 1);
          }
        }
        tl::warpgroup_commit_batch();
        tl::warpgroup_wait<0>();
    ...
    for (int i_37 = 0; i_37 < 32; ++i_37) {
      ...
      *(uint1*)(residual_shared_local_cast_6 + 0) = *(uint1*)(((half_t*)residual_shared) + (((((((((i_37 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_37 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_37 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_37 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_37 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __43;
      uint1 v__30 = *(uint1*)(residual_shared_local_cast_6 + 0);
      ((float2*)(&__43))[0] = __half22float2(((half2*)(&v__30))[0]);
      *(float2*)(residual_local + (i_37 * 2)) = __43;
    }
    #pragma unroll
    for (int i_38 = 0; i_38 < 64; ++i_38) {
      acc[i_38] = (acc[i_38] + (residual_local[i_38] * d_local[0]));
    }
    #pragma unroll
    for (int i_39 = 0; i_39 < 8; ++i_39) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((i_39 >> 2) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_39 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_39 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc[(i_39 * 8)]), ((half_t)acc[((i_39 * 8) + 1)])), __pack_half2(((half_t)acc[((i_39 * 8) + 2)]), ((half_t)acc[((i_39 * 8) + 3)])), __pack_half2(((half_t)acc[((i_39 * 8) + 4)]), ((half_t)acc[((i_39 * 8) + 5)])), __pack_half2(((half_t)acc[((i_39 * 8) + 6)]), ((half_t)acc[((i_39 * 8) + 7)])));
    }
    tl::fence_proxy_async();
