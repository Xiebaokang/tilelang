...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc, __grid_constant__ const CUtensorMap X_desc_1) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int i_5 = 0; i_5 < 32; ++i_5) {
      *(uint1*)(cb_local_v0 + (i_5 * 2)) = *(uint1*)(((half_t*)cb_shared) + ((((((((((i_5 & 7) >> 2) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_5 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((i_5 >> 3) * 16) + (((i_5 & 3) >> 1) * 8)) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_5 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_5 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    }
    ...
    for (int i_11 = 0; i_11 < 32; ++i_11) {
      *(uint1*)(cb_local_v1 + (i_11 * 2)) = *(uint1*)(((half_t*)cb_shared) + (((((((((((i_11 & 7) >> 2) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_11 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((i_11 >> 3) * 16) + (((i_11 & 3) >> 1) * 8)) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_11 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_11 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 8192));
    }
    ...
    for (int i_12 = 0; i_12 < 8; ++i_12) {
      ...
      *(uint1*)(da_k_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)da_k_shared) + (((i_12 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 64));
      float2 __12;
    ...
    for (int i_13 = 0; i_13 < 8; ++i_13) {
      ...
      *(uint1*)(dt_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)dt_shared) + (((i_13 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 64));
      float2 __13;
    ...
    for (int ik = 0; ik < (((int)blockIdx.y) * 2); ++ik) {
      ...
      if (ik == 0) {
        {
          ...
          for (int i_17 = 0; i_17 < 2; ++i_17) {
            ...
            for (int ki_1 = 0; ki_1 < 4; ++ki_1) {
              tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v0 + ((ki_1 * 16) + (i_17 * 8))), uint64_t(desc_b_1 + ((ki_1 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_17 * 32)), 1);
            }
          }
          tl::warpgroup_commit_batch();
          tl::warpgroup_wait<0>();
      ...
      } else {
        {
          ...
          for (int i_18 = 0; i_18 < 2; ++i_18) {
            ...
            for (int ki_2 = 0; ki_2 < 4; ++ki_2) {
              tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v1 + ((ki_2 * 16) + (i_18 * 8))), uint64_t(desc_b_2 + ((ki_2 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_18 * 32)), 1);
            }
          }
          tl::warpgroup_commit_batch();
          tl::warpgroup_wait<0>();
      ...
      if (ik == 0) {
        ...
        for (int i_19 = 0; i_19 < 32; ++i_19) {
          *(uint1*)(cb_local_v0 + (i_19 * 2)) = *(uint1*)(((half_t*)cb_shared) + (((((((((ik * 8192) + (((i_19 & 7) >> 2) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_19 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((i_19 >> 3) * 16) + (((i_19 & 3) >> 1) * 8)) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_19 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_19 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        }
      } else {
        #pragma unroll
        for (int i_20 = 0; i_20 < 32; ++i_20) {
          *(uint1*)(cb_local_v1 + (i_20 * 2)) = *(uint1*)(((half_t*)cb_shared) + (((((((((ik * 8192) + (((i_20 & 7) >> 2) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_20 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((i_20 >> 3) * 16) + (((i_20 & 3) >> 1) * 8)) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_20 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_20 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        }
      }
      ...
      for (int i_21 = 0; i_21 < 8; ++i_21) {
        ...
        *(uint1*)(da_k_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)da_k_shared) + (((ik * 64) + (i_21 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __23;
      ...
      for (int i_22 = 0; i_22 < 8; ++i_22) {
        ...
        *(uint1*)(dt_shared_local_cast_5 + 0) = *(uint1*)(((half_t*)dt_shared) + (((ik * 64) + (i_22 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __24;
      ...
      if (ik == 0) {
        ...
        for (int i_27 = 0; i_27 < 64; ++i_27) {
          half_t condval_2;
          if ((((((((ik * 64) + ((i_27 >> 4) * 16)) + (((i_27 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_27 & 1)) + 128) <= (((((((int)blockIdx.y) * 128) + (((i_27 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_27 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    overlap_plan_mbar[8].wait(((int)blockIdx.y));
    {
      ...
      for (int i_29 = 0; i_29 < 2; ++i_29) {
        ...
        for (int ki_3 = 0; ki_3 < 4; ++ki_3) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v0 + ((ki_3 * 16) + (i_29 * 8))), uint64_t(desc_b_3 + ((ki_3 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_29 * 32)), 1);
        }
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
    ...
    overlap_plan_mbar[9].wait(((int)blockIdx.y));
    {
      ...
      for (int i_30 = 0; i_30 < 2; ++i_30) {
        ...
        for (int ki_4 = 0; ki_4 < 4; ++ki_4) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 64, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v1 + ((ki_4 * 16) + (i_30 * 8))), uint64_t(desc_b_4 + ((ki_4 * 2048) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_30 * 32)), 1);
        }
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
    ...
    for (int i_31 = 0; i_31 < 32; ++i_31) {
      ...
      *(uint1*)(residual_shared_local_cast_6 + 0) = *(uint1*)(((half_t*)residual_shared) + (((((((((i_31 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_31 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_31 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_31 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_31 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __43;
    ...
    for (int i_33 = 0; i_33 < 8; ++i_33) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((i_33 >> 2) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_33 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_33 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc[(i_33 * 8)]), ((half_t)acc[((i_33 * 8) + 1)])), __pack_half2(((half_t)acc[((i_33 * 8) + 2)]), ((half_t)acc[((i_33 * 8) + 3)])), __pack_half2(((half_t)acc[((i_33 * 8) + 4)]), ((half_t)acc[((i_33 * 8) + 5)])), __pack_half2(((half_t)acc[((i_33 * 8) + 6)]), ((half_t)acc[((i_33 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 128);
    ...
    for (int ik_1 = 0; ik_1 < ((((int)blockIdx.y) * 2) + 1); ++ik_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[(((ik_1 + 1) & 1) + 2)].arrive_and_expect_tx(16384);
        tl::tma_load(CB_desc, overlap_plan_mbar[(((ik_1 + 1) & 1) + 2)], (&(((half_t*)cb_shared)[(((ik_1 + 1) & 1) * 8192)])), ((ik_1 * 64) + 64), (((int)blockIdx.y) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      }
      if (1 <= ik_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        ...
        tl::tma_load(X_desc_1, overlap_plan_mbar[((ik_1 & 1) + 8)], (&(((half_t*)x_shared)[((ik_1 & 1) * 4096)])), 0, (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
    }
    if (((int)blockIdx.y) == 1) {
      overlap_plan_mbar[18].wait((((int)blockIdx.y) - 1));
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      overlap_plan_mbar[9].arrive_and_expect_tx(8192);
      tl::tma_load(X_desc_1, overlap_plan_mbar[9], (&(((half_t*)x_shared)[4096])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (((int)blockIdx.y) * 128)) + 64), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
  }
}
