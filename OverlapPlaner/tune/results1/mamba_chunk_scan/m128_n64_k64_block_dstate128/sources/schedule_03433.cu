...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc, __grid_constant__ const CUtensorMap X_desc_1) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      ...
      tl::tma_load(X_desc, overlap_plan_mbar[9], (&(((half_t*)x_shared)[0])), 0, ((((int)blockIdx.z) >> 3) * 256), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
    for (int ik_1 = 0; ik_1 < ((((int)blockIdx.y) * 2) + 1); ++ik_1) {
      if (1 <= ik_1) {
        overlap_plan_mbar[(ik_1 + 18)].wait(0);
      }
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[(((ik_1 + 1) & 1) + 9)].arrive_and_expect_tx(8192);
        tl::tma_load(X_desc, overlap_plan_mbar[(((ik_1 + 1) & 1) + 9)], (&(((half_t*)x_shared)[(((ik_1 + 1) & 1) * 4096)])), 0, ((((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 64)) + 64), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
      if (ik_1 == 2) {
    ...
    if (((int)blockIdx.y) == 1) {
      overlap_plan_mbar[14].wait((((int)blockIdx.y) - 1));
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      overlap_plan_mbar[4].arrive_and_expect_tx(16384);
      tl::tma_load(CB_desc, overlap_plan_mbar[4], (&(((half_t*)cb_shared)[8192])), ((((int)blockIdx.y) * 128) + 64), (((int)blockIdx.y) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
    }
    if (((int)blockIdx.y) == 1) {
      overlap_plan_mbar[16].wait((((int)blockIdx.y) - 1));
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      overlap_plan_mbar[6].arrive_and_expect_tx(128);
      tl::tma_load((&(((half_t*)da_k_shared)[64])), (&(DA[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (((int)blockIdx.y) * 128)) + 64)])), overlap_plan_mbar[6], 128);
    }
    if (((int)blockIdx.y) == 1) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      ...
      tl::tma_load((&(((half_t*)dt_shared)[64])), (&(Dt[((((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + (((int)blockIdx.y) * 128)) + 64)])), overlap_plan_mbar[8], 128);
