  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik = 0; ik < ((((int)blockIdx.y) * 2) + 2); ++ik) {
      ...
      if (tl::tl_shuffle_elect<128>()) {
        ...
        tl::tma_load(CB_desc, mbarrier[(ik & 1)], (&(((half_t*)cb_shared)[((ik & 1) * 8192)])), (ik * 64), (((int)blockIdx.y) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      }
      ...
      if (tl::tl_shuffle_elect<128>()) {
        ...
        tl::tma_load(X_desc, mbarrier[((ik & 1) + 6)], (&(((half_t*)x_shared)[((ik & 1) * 4096)])), 0, (((((int)blockIdx.z) >> 3) * 256) + (ik * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
    }
  } else {
    #pragma unroll
    ...
    for (int ik_1 = 0; ik_1 < ((((int)blockIdx.y) * 2) + 2); ++ik_1) {
      ...
      for (int i_12 = 0; i_12 < 64; ++i_12) {
        half_t condval;
        if ((((((((ik_1 * 64) + ((i_12 >> 4) * 16)) + (((i_12 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_12 & 1)) + 64) <= (((((((int)blockIdx.y) * 128) + (((i_12 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_12 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
