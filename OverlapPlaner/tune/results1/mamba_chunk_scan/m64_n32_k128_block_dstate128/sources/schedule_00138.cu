  ...
  if (((int)threadIdx.x) < 128) {
    ...
    if (3 < ((int)blockIdx.y)) {
      ...
      for (int i_8 = 0; i_8 < 8; ++i_8) {
        tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[(((((i_8 >> 2) * 4096) + (((((int)threadIdx.x) & 127) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_8 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_8 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(cb_local_v1[(i_8 * 8)])));
      }
      overlap_plan_mbar[9].arrive();
    }
    tl::__sync_thread_partial(3, 128);
    ...
    if ((((int)blockIdx.y) >> 2) == 0) {
      ...
      for (int i_16 = 0; i_16 < 64; ++i_16) {
        half_t condval_1;
        if (((((((i_16 >> 2) * 8) + ((((int)threadIdx.x) & 3) * 2)) + (i_16 & 1)) + 64) <= (((((((int)blockIdx.y) >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_16 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
      ...
      for (int i_17 = 0; i_17 < 64; ++i_17) {
        half_t condval_2;
        if (((((((i_17 >> 2) * 8) + ((((int)threadIdx.x) & 3) * 2)) + (i_17 & 1)) + 192) <= (((((((int)blockIdx.y) >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_17 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    for (int i_18 = 0; i_18 < 8; ++i_18) {
      ...
      *(uint1*)(residual_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)residual_shared) + ((((((((((int)threadIdx.x) >> 5) * 512) + ((i_18 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_18 >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_18 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 2048));
      float2 __26;
    ...
    for (int i_20 = 0; i_20 < 2; ++i_20) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((((int)threadIdx.x) & 127) >> 5) * 512) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + i_20) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(((half_t)acc[(i_20 * 8)]), ((half_t)acc[((i_20 * 8) + 1)])), __pack_half2(((half_t)acc[((i_20 * 8) + 2)]), ((half_t)acc[((i_20 * 8) + 3)])), __pack_half2(((half_t)acc[((i_20 * 8) + 4)]), ((half_t)acc[((i_20 * 8) + 5)])), __pack_half2(((half_t)acc[((i_20 * 8) + 6)]), ((half_t)acc[((i_20 * 8) + 7)])));
    }
    tl::fence_proxy_async();
