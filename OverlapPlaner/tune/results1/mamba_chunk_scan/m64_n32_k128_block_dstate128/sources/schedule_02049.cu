...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc, __grid_constant__ const CUtensorMap X_desc_1) {
  ...
  void* da_k_shared = ((void*)((char*)buf_dyn_shmem + 92160));
  void* dt_shared = ((void*)((char*)buf_dyn_shmem + 93184));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(CB_desc, overlap_plan_mbar[4], (&(((half_t*)cb_shared)[4096])), 64, ((((int)blockIdx.y) >> 1) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      ...
      tl::tma_load(X_desc, overlap_plan_mbar[10], (&(((half_t*)x_shared)[0])), ((((int)blockIdx.y) & 1) * 32), ((((int)blockIdx.z) >> 3) * 256), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
    ...
    for (int i_6 = 0; i_6 < 64; ++i_6) {
      half_t condval;
      if ((((((i_6 >> 2) * 8) + ((((int)threadIdx.x) & 3) * 2)) + (i_6 & 1)) <= (((((((int)blockIdx.y) >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_6 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    for (int ik = 0; ik < (((int)blockIdx.y) >> 2); ++ik) {
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        tl::tma_load(CB_desc, overlap_plan_mbar[(ik + 5)], (&(((half_t*)cb_shared)[((ik * 8192) + 8192)])), ((ik * 128) + 128), ((((int)blockIdx.y) >> 1) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
        tl::tma_load(CB_desc, overlap_plan_mbar[(ik + 5)], (&(((half_t*)cb_shared)[((ik * 8192) + 12288)])), ((ik * 128) + 192), ((((int)blockIdx.y) >> 1) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
        ...
        overlap_plan_mbar[(ik + 11)].arrive_and_expect_tx(8192);
        tl::tma_load(X_desc, overlap_plan_mbar[(ik + 11)], (&(((half_t*)x_shared)[((ik * 4096) + 4096)])), ((((int)blockIdx.y) & 1) * 32), ((((((int)blockIdx.z) >> 3) * 256) + (ik * 128)) + 128), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
      ...
      for (int i_10 = 0; i_10 < 64; ++i_10) {
        half_t condval_1;
        if (((((((ik * 128) + ((i_10 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_10 & 1)) + 128) <= (((((((int)blockIdx.y) >> 1) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_10 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    overlap_plan_mbar[((((int)blockIdx.y) >> 2) + 18)].arrive();
    ...
    for (int i_11 = 0; i_11 < 8; ++i_11) {
      ...
      *(uint1*)(residual_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)residual_shared) + (((((((((int)threadIdx.x) >> 5) * 512) + ((i_11 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_11 >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_11 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __9;
