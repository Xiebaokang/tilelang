  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int ik_1 = 0; ik_1 < ((((int)blockIdx.y) >> 2) + 1); ++ik_1) {
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[(ik_1 + 2)].arrive_and_expect_tx(16384);
        tl::tma_load(CB_desc, overlap_plan_mbar[(ik_1 + 2)], (&(((half_t*)cb_shared)[(ik_1 * 8192)])), (ik_1 * 128), ((((int)blockIdx.y) >> 1) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
        tl::tma_load(CB_desc, overlap_plan_mbar[(ik_1 + 2)], (&(((half_t*)cb_shared)[((ik_1 * 8192) + 4096)])), ((ik_1 * 128) + 64), ((((int)blockIdx.y) >> 1) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
        ...
        tl::tma_load(X_desc_1, overlap_plan_mbar[(ik_1 + 8)], (&(((half_t*)x_shared)[(ik_1 * 4096)])), ((((int)blockIdx.y) & 1) * 32), (((((int)blockIdx.z) >> 3) * 256) + (ik_1 * 128)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
    }
  }
}
