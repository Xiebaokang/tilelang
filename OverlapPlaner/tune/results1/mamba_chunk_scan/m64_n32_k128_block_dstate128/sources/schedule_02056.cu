  ...
  if (((int)threadIdx.x) < 128) {
    ...
    if (3 < ((int)blockIdx.y)) {
      ...
      for (int i_10 = 0; i_10 < 32; ++i_10) {
        *(uint1*)(cb_local_v1 + (i_10 * 2)) = *(uint1*)(((half_t*)cb_shared) + ((((((((((i_10 >> 4) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_10 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_10 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_10 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_10 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 8192));
      }
      ...
      for (int i_11 = 0; i_11 < 16; ++i_11) {
        ...
        *(uint1*)(da_k_shared_local_cast_2 + 0) = *(uint1*)(((half_t*)da_k_shared) + (((i_11 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 128));
        float2 __12;
      ...
      for (int i_12 = 0; i_12 < 16; ++i_12) {
        ...
        *(uint1*)(dt_shared_local_cast_3 + 0) = *(uint1*)(((half_t*)dt_shared) + (((i_12 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 128));
        float2 __13;
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      ...
      tl::tma_load(X_desc, overlap_plan_mbar[11], (&(((half_t*)residual_shared)[0])), ((((int)blockIdx.y) & 1) * 32), (((((int)blockIdx.z) >> 3) * 256) + ((((int)blockIdx.y) >> 1) * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      ...
      tl::tma_load(CB_desc, overlap_plan_mbar[2], (&(((half_t*)cb_shared)[4096])), 64, ((((int)blockIdx.y) >> 1) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
    ...
    for (int ik = 0; ik < (((int)blockIdx.y) >> 2); ++ik) {
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        overlap_plan_mbar[(ik + 3)].arrive_and_expect_tx(16384);
        tl::tma_load(CB_desc, overlap_plan_mbar[(ik + 3)], (&(((half_t*)cb_shared)[((ik * 8192) + 8192)])), ((ik * 128) + 128), ((((int)blockIdx.y) >> 1) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
        tl::tma_load(CB_desc, overlap_plan_mbar[(ik + 3)], (&(((half_t*)cb_shared)[((ik * 8192) + 12288)])), ((ik * 128) + 192), ((((int)blockIdx.y) >> 1) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
        ...
        tl::tma_load(X_desc_1, overlap_plan_mbar[(ik + 9)], (&(((half_t*)x_shared)[(ik * 4096)])), ((((int)blockIdx.y) & 1) * 32), (((((int)blockIdx.z) >> 3) * 256) + (ik * 128)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      overlap_plan_mbar[((((int)blockIdx.y) >> 2) + 9)].arrive_and_expect_tx(8192);
      tl::tma_load(X_desc_1, overlap_plan_mbar[((((int)blockIdx.y) >> 2) + 9)], (&(((half_t*)x_shared)[((((int)blockIdx.y) >> 2) * 4096)])), ((((int)blockIdx.y) & 1) * 32), (((((int)blockIdx.z) >> 3) * 256) + ((((int)blockIdx.y) >> 2) * 128)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
  }
}
