...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  void* x_shared = ((void*)((char*)buf_dyn_shmem + 73728));
  void* dt_shared = ((void*)((char*)buf_dyn_shmem + 98304));
  ...
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    overlap_plan_mbar[0].arrive_and_expect_tx(256);
    tl::tma_load((&(((half_t*)da_m_shared)[0])), (&(DA[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + ((((int)blockIdx.y) >> 1) * 128))])), overlap_plan_mbar[0], 256);
  }
  ...
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    ...
    tl::tma_load(CB_desc, overlap_plan_mbar[3], (&(((half_t*)cb_shared)[0])), 0, ((((int)blockIdx.y) >> 1) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
    tl::tma_load(CB_desc, overlap_plan_mbar[3], (&(((half_t*)cb_shared)[8192])), 64, ((((int)blockIdx.y) >> 1) * 128), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
  }
  overlap_plan_mbar[3].wait(0);
  #pragma unroll
  for (int i_5 = 0; i_5 < 16; ++i_5) {
    tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[((((((i_5 >> 3) * 8192) + ((i_5 & 1) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((i_5 & 7) >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((i_5 & 3) >> 1) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(cb_local_v0[(i_5 * 8)])));
  }
  ...
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    ...
    tl::tma_load(X_desc, overlap_plan_mbar[7], (&(((half_t*)x_shared)[0])), ((((int)blockIdx.y) & 1) * 32), ((((int)blockIdx.z) >> 3) * 256), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
  }
  if (1 < ((int)blockIdx.y)) {
    overlap_plan_mbar[11].wait(0);
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[3].arrive_and_expect_tx(32768);
      tl::tma_load(CB_desc, overlap_plan_mbar[3], (&(((half_t*)cb_shared)[0])), 128, 128, 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      tl::tma_load(CB_desc, overlap_plan_mbar[3], (&(((half_t*)cb_shared)[8192])), 192, 128, 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
    }
    overlap_plan_mbar[3].wait(1);
    #pragma unroll
    for (int i_8 = 0; i_8 < 16; ++i_8) {
      tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[((((((i_8 >> 3) * 8192) + ((i_8 & 1) * 4096)) + ((((int)threadIdx.x) >> 5) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((i_8 & 7) >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((i_8 & 3) >> 1) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), (&(cb_local_v1[(i_8 * 8)])));
    }
    overlap_plan_mbar[11].arrive();
  }
  __syncthreads();
  if (1 < ((int)blockIdx.y)) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[4].arrive_and_expect_tx(256);
      tl::tma_load((&(((half_t*)da_k_shared)[0])), (&(DA[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + 128)])), overlap_plan_mbar[4], 256);
    }
  }
  __syncthreads();
  if (1 < ((int)blockIdx.y)) {
    ...
    for (int i_9 = 0; i_9 < 16; ++i_9) {
      ...
      *(uint1*)(da_k_shared_local_cast_1 + 0) = *(uint1*)(((half_t*)da_k_shared) + ((i_9 * 8) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __8;
      uint1 v__5 = *(uint1*)(da_k_shared_local_cast_1 + 0);
      ((float2*)(&__8))[0] = __half22float2(((half2*)(&v__5))[0]);
      *(float2*)(da_k_local + (i_9 * 2)) = __8;
    }
    overlap_plan_mbar[12].arrive();
    #pragma unroll
    for (int i_10 = 0; i_10 < 64; ++i_10) {
      ...
      float2 __10;
        float2 __11;
        uint1 v__6 = *(uint1*)(cb_local_v1 + (i_10 * 2));
        ((float2*)(&__11))[0] = __half22float2(((half2*)(&v__6))[0]);
        float2 __12;
        float2 __13;
          float2 __14;
            float2 v__7 = make_float2(da_m_local[((((i_10 & 7) >> 2) * 2) + (i_10 & 1))], da_m_local[((((i_10 & 7) >> 2) * 2) + (i_10 & 1))]);
            float2 v__8 = *(float2*)(da_k_local + (((i_10 >> 3) * 4) + (((i_10 & 3) >> 1) * 2)));
      ...
      *(uint1*)(cb_local_v1 + (i_10 * 2)) = __9;
    }
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[6].arrive_and_expect_tx(256);
      tl::tma_load((&(((half_t*)dt_shared)[128])), (&(Dt[(((((((int)blockIdx.z) & 7) * 327680) + (((int)blockIdx.x) * 4096)) + ((((int)blockIdx.z) >> 3) * 256)) + 128)])), overlap_plan_mbar[6], 256);
    }
  }
  ...
  for (int i_11 = 0; i_11 < 16; ++i_11) {
    ...
    *(float2*)(dt_local_v0 + (i_11 * 2)) = __15;
  }
  overlap_plan_mbar[13].arrive();
  if (1 < ((int)blockIdx.y)) {
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
      overlap_plan_mbar[8].arrive_and_expect_tx(8192);
      tl::tma_load(X_desc, overlap_plan_mbar[8], (&(((half_t*)x_shared)[4096])), ((((int)blockIdx.y) & 1) * 32), (((((int)blockIdx.z) >> 3) * 256) + 128), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
  }
  overlap_plan_mbar[((((int)blockIdx.y) >> 1) + 5)].wait(0);
  __syncthreads();
  if ((((int)blockIdx.y) >> 1) == 0) {
    ...
    for (int i_12 = 0; i_12 < 16; ++i_12) {
      ...
      *(float2*)(dt_local_v0 + (i_12 * 2)) = __16;
    }
  } else {
    #pragma unroll
    for (int i_13 = 0; i_13 < 16; ++i_13) {
      half_t dt_shared_local_cast_4[2];
      *(uint1*)(dt_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)dt_shared) + (((i_13 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 128));
      float2 __17;
      uint1 v__12 = *(uint1*)(dt_shared_local_cast_4 + 0);
      ((float2*)(&__17))[0] = __half22float2(((half2*)(&v__12))[0]);
      *(float2*)(dt_local_v1 + (i_13 * 2)) = __17;
    }
  }
    ...
    overlap_plan_mbar[7].wait(0);
    {
      ...
      for (int i_15 = 0; i_15 < 2; ++i_15) {
        ...
        for (int ki_1 = 0; ki_1 < 8; ++ki_1) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v0 + ((ki_1 * 16) + (i_15 * 8))), uint64_t(desc_b_1 + ((ki_1 * 1024) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_15 * 16)), 1);
        }
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
  ...
  if ((((int)blockIdx.y) >> 1) == 0) {
    ...
    for (int i_18 = 0; i_18 < 128; ++i_18) {
      half_t condval;
      if (((((((i_18 >> 4) * 16) + (((i_18 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_18 & 1)) <= ((((((i_18 & 15) >> 3) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_18 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    #pragma unroll
    for (int i_19 = 0; i_19 < 128; ++i_19) {
      half_t condval_1;
      if (((((((i_19 >> 4) * 16) + (((i_19 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_19 & 1)) <= ((((((i_19 & 15) >> 3) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_19 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
        condval_1 = cb_local_v1[i_19];
      } else {
        condval_1 = half_t(0x0p+0f/*0.000000e+00*/);
      }
      cb_local_v1[i_19] = condval_1;
    }
  }
  overlap_plan_mbar[((((int)blockIdx.y) >> 1) + 7)].wait(0);
  if ((((int)blockIdx.y) >> 1) == 0) {
    {
      ...
      for (int i_20 = 0; i_20 < 2; ++i_20) {
        ...
        for (int ki_2 = 0; ki_2 < 8; ++ki_2) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v0 + ((ki_2 * 16) + (i_20 * 8))), uint64_t(desc_b_2 + ((ki_2 * 1024) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_20 * 16)), 1);
        }
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
  ...
  } else {
    {
      ...
      for (int i_21 = 0; i_21 < 2; ++i_21) {
        ...
        for (int ki_3 = 0; ki_3 < 8; ++ki_3) {
          tl::wgmma_rs<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 64, 32, 16, false, true, 1, 1>(reinterpret_cast<const uint32_t*>(cb_local_v1 + ((ki_3 * 16) + (i_21 * 8))), uint64_t(desc_b_3 + ((ki_3 * 1024) >> 4)), reinterpret_cast<uint32_t*>(acc + (i_21 * 16)), 1);
        }
      }
      tl::warpgroup_commit_batch();
      tl::warpgroup_wait<0>();
  ...
  overlap_plan_mbar[((((int)blockIdx.y) >> 1) + 15)].arrive();
  d_local[0] = ((float)D[((int)blockIdx.x)]);
  if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 0)) {
    overlap_plan_mbar[10].arrive_and_expect_tx(8192);
    tl::tma_load(X_desc, overlap_plan_mbar[10], (&(((half_t*)residual_shared)[0])), ((((int)blockIdx.y) & 1) * 32), (((((int)blockIdx.z) >> 3) * 256) + ((((int)blockIdx.y) >> 1) * 128)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
  }
  overlap_plan_mbar[10].wait(0);
  #pragma unroll
  for (int i_22 = 0; i_22 < 16; ++i_22) {
    half_t residual_shared_local_cast_5[2];
    *(uint1*)(residual_shared_local_cast_5 + 0) = *(uint1*)(((half_t*)residual_shared) + ((((((((i_22 >> 3) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((i_22 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_22 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_22 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
    float2 __27;
    uint1 v__19 = *(uint1*)(residual_shared_local_cast_5 + 0);
    ((float2*)(&__27))[0] = __half22float2(((half2*)(&v__19))[0]);
    *(float2*)(residual_local + (i_22 * 2)) = __27;
  }
  #pragma unroll
  for (int i_23 = 0; i_23 < 32; ++i_23) {
    acc[i_23] = (acc[i_23] + (residual_local[i_23] * d_local[0]));
  }
  __syncthreads();
  #pragma unroll
  for (int i_24 = 0; i_24 < 4; ++i_24) {
    tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[((((((i_24 >> 1) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + (i_24 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), __pack_half2(((half_t)acc[(i_24 * 8)]), ((half_t)acc[((i_24 * 8) + 1)])), __pack_half2(((half_t)acc[((i_24 * 8) + 2)]), ((half_t)acc[((i_24 * 8) + 3)])), __pack_half2(((half_t)acc[((i_24 * 8) + 4)]), ((half_t)acc[((i_24 * 8) + 5)])), __pack_half2(((half_t)acc[((i_24 * 8) + 6)]), ((half_t)acc[((i_24 * 8) + 7)])));
  }
