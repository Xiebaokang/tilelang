...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int i_10 = 0; i_10 < 128; ++i_10) {
      half_t condval;
      if ((((((((i_10 >> 4) * 16) + (((i_10 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_10 & 1)) + 64) <= ((((((((int)blockIdx.y) >> 1) * 128) + (((i_10 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_10 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    if (1 < ((int)blockIdx.y)) {
      ...
      for (int i_16 = 0; i_16 < 128; ++i_16) {
        half_t condval_1;
        if ((((((((i_16 >> 4) * 16) + (((i_16 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_16 & 1)) + 64) <= ((((((i_16 & 15) >> 3) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_16 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    for (int i_20 = 0; i_20 < 16; ++i_20) {
      ...
      *(uint1*)(residual_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)residual_shared) + (((((((((i_20 >> 3) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((i_20 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_20 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_20 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 2048));
      float2 __23;
    ...
    for (int i_22 = 0; i_22 < 4; ++i_22) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((((i_22 >> 1) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + (i_22 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8)) - 2048)])), __pack_half2(((half_t)acc[(i_22 * 8)]), ((half_t)acc[((i_22 * 8) + 1)])), __pack_half2(((half_t)acc[((i_22 * 8) + 2)]), ((half_t)acc[((i_22 * 8) + 3)])), __pack_half2(((half_t)acc[((i_22 * 8) + 4)]), ((half_t)acc[((i_22 * 8) + 5)])), __pack_half2(((half_t)acc[((i_22 * 8) + 6)]), ((half_t)acc[((i_22 * 8) + 7)])));
    }
    tl::fence_proxy_async();
