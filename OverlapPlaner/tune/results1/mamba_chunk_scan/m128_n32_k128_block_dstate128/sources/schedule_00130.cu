...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap CB_desc, __grid_constant__ const CUtensorMap C_desc, const half_t* __restrict__ D, const half_t* __restrict__ DA, const half_t* __restrict__ Dt, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap Prev_desc, __grid_constant__ const CUtensorMap X_desc) {
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int i_14 = 0; i_14 < 128; ++i_14) {
      half_t condval;
      if ((((((((i_14 >> 4) * 16) + (((i_14 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_14 & 1)) + 64) <= ((((((((int)blockIdx.y) >> 1) * 128) + (((i_14 & 15) >> 3) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_14 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
      ...
      tl::tma_load(X_desc, overlap_plan_mbar[((((int)blockIdx.y) >> 1) + 5)], (&(((half_t*)x_shared)[((((int)blockIdx.y) >> 1) * 4096)])), ((((int)blockIdx.y) & 1) * 32), (((((int)blockIdx.z) >> 3) * 256) + ((((int)blockIdx.y) >> 1) * 128)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
    }
    if (2 <= ((int)blockIdx.y)) {
    ...
    if ((((int)blockIdx.y) >> 1) == 0) {
      ...
      for (int i_18 = 0; i_18 < 128; ++i_18) {
        half_t condval_1;
        if ((((((((i_18 >> 4) * 16) + (((i_18 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_18 & 1)) + 64) <= ((((((i_18 & 15) >> 3) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_18 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
      ...
      for (int i_19 = 0; i_19 < 128; ++i_19) {
        half_t condval_2;
        if ((((((((i_19 >> 4) * 16) + (((i_19 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_19 & 1)) + 64) <= ((((((i_19 & 15) >> 3) * 64) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_19 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
    ...
    for (int i_22 = 0; i_22 < 16; ++i_22) {
      ...
      *(uint1*)(residual_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)residual_shared) + (((((((((i_22 >> 3) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((i_22 & 1) * 256)) + (((((int)threadIdx.x) & 31) >> 2) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_22 & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_22 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 2048));
      float2 __26;
    ...
    for (int i_24 = 0; i_24 < 4; ++i_24) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)acc_shared)[(((((((i_24 >> 1) * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + (i_24 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8)) - 2048)])), __pack_half2(((half_t)acc[(i_24 * 8)]), ((half_t)acc[((i_24 * 8) + 1)])), __pack_half2(((half_t)acc[((i_24 * 8) + 2)]), ((half_t)acc[((i_24 * 8) + 3)])), __pack_half2(((half_t)acc[((i_24 * 8) + 4)]), ((half_t)acc[((i_24 * 8) + 5)])), __pack_half2(((half_t)acc[((i_24 * 8) + 6)]), ((half_t)acc[((i_24 * 8) + 7)])));
    }
    tl::fence_proxy_async();
