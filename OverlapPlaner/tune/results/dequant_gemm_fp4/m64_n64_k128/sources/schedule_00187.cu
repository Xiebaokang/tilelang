  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int k = 0; k < 32; ++k) {
      ...
      for (int i_1 = 0; i_1 < 8; ++i_1) {
        tl::ptx_ldmatrix_x4((&(((half_t*)B_dequantize_local_wsp_handoff_2)[(((((((int)threadIdx.x) >> 5) * 2048) + ((((int)threadIdx.x) & 15) * 128)) + (i_1 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), (&(B_dequantize_local[(i_1 * 8)])));
      }
      #pragma unroll
      for (int i_2 = 0; i_2 < 8; ++i_2) {
        *(uint4*)(B_dequantize_prev_local + (i_2 * 8)) = *(uint4*)(B_dequantize_local + (i_2 * 8));
      }
    ...
    for (int i_3 = 0; i_3 < 4; ++i_3) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)Ct_shared)[((((((int)threadIdx.x) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + (i_3 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_3 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)Ct_local[(i_3 * 8)]), ((half_t)Ct_local[((i_3 * 8) + 1)])), __pack_half2(((half_t)Ct_local[((i_3 * 8) + 2)]), ((half_t)Ct_local[((i_3 * 8) + 3)])), __pack_half2(((half_t)Ct_local[((i_3 * 8) + 4)]), ((half_t)Ct_local[((i_3 * 8) + 5)])), __pack_half2(((half_t)Ct_local[((i_3 * 8) + 6)]), ((half_t)Ct_local[((i_3 * 8) + 7)])));
    }
    ...
    for (int k_1 = 0; k_1 < 32; ++k_1) {
      ...
      if (tl::tl_shuffle_elect<128>() && ((((int)threadIdx.x) >> 5) == 4)) {
        ...
        tl::tma_load(B_desc, overlap_plan_mbar[1], (&(((uchar*)B_shared)[0])), (k_1 * 64), (((int)blockIdx.x) * 64));
      }
      overlap_plan_mbar[1].wait((k_1 & 1));
      #pragma unroll
      for (int i_4 = 0; i_4 < 32; ++i_4) {
        B_local[i_4] = ((uchar*)B_shared)[(((((((((((int)threadIdx.x) >> 5) * 1024) + ((i_4 >> 4) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_4 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_4 & 7) >> 2)) & 1) * 16)) + ((i_4 & 3) * 4)) + (((int)threadIdx.x) & 3)) - 4096)];
      }
      overlap_plan_mbar[4].arrive();
      #pragma unroll
      for (int i_5 = 0; i_5 < 64; ++i_5) {
        ushort v_ = (((((((((ushort)B_local[((((i_5 & 3) >> 1) * 16) + (i_5 >> 2))]) >> (((ushort)(i_5 & 1)) * (ushort)4)) & (ushort)15) & (ushort)6) >> (ushort)1) + (ushort)14) | ((((((ushort)B_local[((((i_5 & 3) >> 1) * 16) + (i_5 >> 2))]) >> (((ushort)(i_5 & 1)) * (ushort)4)) & (ushort)15) >> (ushort)3) << (ushort)5)) << (ushort)10) | ((((((ushort)B_local[((((i_5 & 3) >> 1) * 16) + (i_5 >> 2))]) >> (((ushort)(i_5 & 1)) * (ushort)4)) & (ushort)15) & (ushort)1) << (ushort)9);
        B_dequantize_local[i_5] = (*(half_t *)(&(v_)));
      }
      #pragma unroll
      for (int i_6 = 0; i_6 < 8; ++i_6) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)B_dequantize_local_wsp_handoff_2)[((((((((int)threadIdx.x) >> 5) * 2048) + ((((int)threadIdx.x) & 15) * 128)) + (i_6 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) - 8192)])), __pack_half2(B_dequantize_local[(i_6 * 8)], B_dequantize_local[((i_6 * 8) + 1)]), __pack_half2(B_dequantize_local[((i_6 * 8) + 2)], B_dequantize_local[((i_6 * 8) + 3)]), __pack_half2(B_dequantize_local[((i_6 * 8) + 4)], B_dequantize_local[((i_6 * 8) + 5)]), __pack_half2(B_dequantize_local[((i_6 * 8) + 6)], B_dequantize_local[((i_6 * 8) + 7)]));
      }
      tl::fence_proxy_async();
