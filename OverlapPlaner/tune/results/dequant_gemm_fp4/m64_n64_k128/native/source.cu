...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(__grid_constant__ const CUtensorMap A_desc, __grid_constant__ const CUtensorMap B_desc, __grid_constant__ const CUtensorMap Ct_desc) {
  ...
  void* Ct_shared = ((void*)((char*)buf_dyn_shmem + 0));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int k = 0; k < 32; ++k) {
      ...
      if (tl::tl_shuffle_elect<128>()) {
        ...
        tl::tma_load(A_desc, mbarrier[(k & 1)], (&(((half_t*)A_shared)[((k & 1) * 8192)])), (k * 128), (((int)blockIdx.y) * 64));
        tl::tma_load(A_desc, mbarrier[(k & 1)], (&(((half_t*)A_shared)[(((k & 1) * 8192) + 4096)])), ((k * 128) + 64), (((int)blockIdx.y) * 64));
      }
      mbarrier[((k & 1) + 6)].wait((((k & 3) >> 1) ^ 1));
      if (tl::tl_shuffle_elect<128>()) {
        mbarrier[((k & 1) + 2)].arrive_and_expect_tx(4096);
        tl::tma_load(B_desc, mbarrier[((k & 1) + 2)], (&(((uchar*)B_shared)[((k & 1) * 4096)])), (k * 64), (((int)blockIdx.x) * 64));
      }
    }
  } else {
    ...
    for (int k_1 = 0; k_1 < 32; ++k_1) {
      ...
      for (int i_1 = 0; i_1 < 32; ++i_1) {
        B_local[i_1] = ((uchar*)B_shared)[((((((((((k_1 & 1) * 4096) + ((((int)threadIdx.x) >> 5) * 1024)) + ((i_1 >> 4) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_1 & 15) >> 3)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + ((i_1 & 7) >> 2)) & 1) * 16)) + ((i_1 & 3) * 4)) + (((int)threadIdx.x) & 3)) - 4096)];
      }
