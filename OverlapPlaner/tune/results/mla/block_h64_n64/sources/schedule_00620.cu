  ...
  if (((int)threadIdx.x) < 256) {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_3, broadcast_var_3);
    ...
    for (int i_1 = 0; i_1 < 2; ++i_1) {
      ...
      scores_max_clear[i_1] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear[i_1], (&(((float*)workspace_2)[0])));
    ...
    for (int i_5 = 0; i_5 < 2; ++i_5) {
      ...
      tl::__sync_thread_partial(3, 256);
      scores_sum[i_5] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_5], (&(((float*)workspace_3)[0])));
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_4, broadcast_var_4);
      ...
      for (int i_7 = 0; i_7 < 2; ++i_7) {
        ...
        for (int rv_2 = 0; rv_2 < 8; ++rv_2) {
          scores_max_clear_1[i_7] = max(scores_max_clear_1[i_7], acc_s_v1[((((rv_2 & 3) * 4) + (i_7 * 2)) + (rv_2 >> 2))]);
        }
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_1[i_7] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_1[i_7], (&(((float*)workspace_4)[0])));
      ...
      for (int i_11 = 0; i_11 < 2; ++i_11) {
        ...
        for (int rv_3 = 0; rv_3 < 8; ++rv_3) {
          scores_sum[i_11] = (scores_sum[i_11] + acc_s_v1[((((rv_3 & 3) * 4) + (i_11 * 2)) + (rv_3 >> 2))]);
        }
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_11] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_11], (&(((float*)workspace_7)[0])));
        scores_sum[i_11] = tl::AllReduce<tl::SumOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_sum[i_11]);
      }
      #pragma unroll
      for (int i_12 = 0; i_12 < 2; ++i_12) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)S_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + i_12) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_s_v0[(i_12 * 8)]), ((half_t)acc_s_v0[((i_12 * 8) + 1)])), __pack_half2(((half_t)acc_s_v0[((i_12 * 8) + 2)]), ((half_t)acc_s_v0[((i_12 * 8) + 3)])), __pack_half2(((half_t)acc_s_v0[((i_12 * 8) + 4)]), ((half_t)acc_s_v0[((i_12 * 8) + 5)])), __pack_half2(((half_t)acc_s_v0[((i_12 * 8) + 6)]), ((half_t)acc_s_v0[((i_12 * 8) + 7)])));
      }
      #pragma unroll
      ...
      *(float2*)(scores_max + 0) = make_float2(broadcast_var_5, broadcast_var_5);
      ...
      for (int i_15 = 0; i_15 < 2; ++i_15) {
        ...
        for (int rv_4 = 0; rv_4 < 8; ++rv_4) {
          scores_max_clear_2[i_15] = max(scores_max_clear_2[i_15], acc_s_v0[((((rv_4 & 3) * 4) + (i_15 * 2)) + (rv_4 >> 2))]);
        }
        tl::__sync_thread_partial(3, 256);
        scores_max_clear_2[i_15] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_2[i_15], (&(((float*)workspace)[0])));
      ...
      for (int i_19 = 0; i_19 < 2; ++i_19) {
        ...
        for (int rv_5 = 0; rv_5 < 8; ++rv_5) {
          scores_sum[i_19] = (scores_sum[i_19] + acc_s_v0[((((rv_5 & 3) * 4) + (i_19 * 2)) + (rv_5 >> 2))]);
        }
        tl::__sync_thread_partial(3, 256);
        scores_sum[i_19] = tl::AllReduce<tl::SumOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_sum[i_19], (&(((float*)workspace_5)[0])));
        scores_sum[i_19] = tl::AllReduce<tl::SumOp, 4, 1, 0, tl::NamedBarrier<256>>::run(scores_sum[i_19]);
      }
      #pragma unroll
      for (int i_20 = 0; i_20 < 2; ++i_20) {
        tl::ptx_stmatrix_m8n8_x4((&(((half_t*)S_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + i_20) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_s_v1[(i_20 * 8)]), ((half_t)acc_s_v1[((i_20 * 8) + 1)])), __pack_half2(((half_t)acc_s_v1[((i_20 * 8) + 2)]), ((half_t)acc_s_v1[((i_20 * 8) + 3)])), __pack_half2(((half_t)acc_s_v1[((i_20 * 8) + 4)]), ((half_t)acc_s_v1[((i_20 * 8) + 5)])), __pack_half2(((half_t)acc_s_v1[((i_20 * 8) + 6)]), ((half_t)acc_s_v1[((i_20 * 8) + 7)])));
      }
      #pragma unroll
      for (int i_21 = 0; i_21 < 2; ++i_21) {
        logsum[i_21] = ((logsum[i_21] * scores_scale_v0[i_21]) + scores_sum[i_21]);
      }
      #pragma unroll
      for (int i_22 = 0; i_22 < 128; ++i_22) {
        acc_o[i_22] = (acc_o[i_22] * scores_scale_v1[((i_22 & 3) >> 1)]);
      }
      overlap_plan_mbar[3].wait((k & 1));
      {
    ...
    *(float2*)(scores_max + 0) = make_float2(broadcast_var_6, broadcast_var_6);
    ...
    for (int i_23 = 0; i_23 < 2; ++i_23) {
      ...
      for (int rv_6 = 0; rv_6 < 8; ++rv_6) {
        scores_max_clear_3[i_23] = max(scores_max_clear_3[i_23], acc_s_v1[((((rv_6 & 3) * 4) + (i_23 * 2)) + (rv_6 >> 2))]);
      }
      tl::__sync_thread_partial(3, 256);
      scores_max_clear_3[i_23] = tl::AllReduce<tl::MaxOp, 256, 128, 0, tl::NamedBarrier<256>>::run(scores_max_clear_3[i_23], (&(((float*)workspace_6)[0])));
    ...
    for (int i_27 = 0; i_27 < 2; ++i_27) {
      ...
      for (int rv_7 = 0; rv_7 < 8; ++rv_7) {
        scores_sum[i_27] = (scores_sum[i_27] + acc_s_v1[((((rv_7 & 3) * 4) + (i_27 * 2)) + (rv_7 >> 2))]);
      }
      tl::__sync_thread_partial(3, 256);
    ...
    for (int i_28 = 0; i_28 < 2; ++i_28) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)S_shared)[(((((((int)threadIdx.x) & 127) >> 5) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + i_28) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511))])), __pack_half2(((half_t)acc_s_v0[(i_28 * 8)]), ((half_t)acc_s_v0[((i_28 * 8) + 1)])), __pack_half2(((half_t)acc_s_v0[((i_28 * 8) + 2)]), ((half_t)acc_s_v0[((i_28 * 8) + 3)])), __pack_half2(((half_t)acc_s_v0[((i_28 * 8) + 4)]), ((half_t)acc_s_v0[((i_28 * 8) + 5)])), __pack_half2(((half_t)acc_s_v0[((i_28 * 8) + 6)]), ((half_t)acc_s_v0[((i_28 * 8) + 7)])));
    }
    #pragma unroll
    for (int i_29 = 0; i_29 < 2; ++i_29) {
      logsum[i_29] = ((logsum[i_29] * scores_scale_v1[i_29]) + scores_sum[i_29]);
    }
    #pragma unroll
    for (int i_30 = 0; i_30 < 128; ++i_30) {
      acc_o[i_30] = (acc_o[i_30] * scores_scale_v0[((i_30 & 3) >> 1)]);
    }
