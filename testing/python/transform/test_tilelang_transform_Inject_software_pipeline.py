...
def test_single_stage_pipeline_honors_non_identity_order():
    @T.prim_func
    def before(
    ...
    assert script.index("C[i] =") < script.index("B[i] =")
    assert "software_pipeline_order" not in script
